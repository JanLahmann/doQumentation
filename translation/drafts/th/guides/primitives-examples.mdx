---
title: "ตัวอย่าง primitives (ส่วนที่ 1)"
sidebar_label: "ตัวอย่าง primitives"
description: "ตัวอย่างการใช้งาน primitives ใน Qiskit Runtime ในทางปฏิบัติ"
...
ตัวอย่างในส่วนนี้แสดงวิธีการทั่วไปในการใช้ primitives ก่อนรันตัวอย่างเหล่านี้ ให้ทำตามคำแนะนำใน [Install and set up.](install-qiskit)

<Admonition type="note">
    ตัวอย่างทั้งหมดใช้ primitives จาก Qiskit Runtime แต่สามารถใช้ base primitives แทนได้เช่นกัน
</Admonition>

## ตัวอย่าง Estimator {#estimator-examples}
...
### รันหลายการทดลองใน job เดียว {#run-multiple-experiments-in-a-single-job}
...
### ใช้ Session และตัวเลือกขั้นสูง {#use-sessions-and-advanced-options}

สำรวจ Session และตัวเลือกขั้นสูงเพื่อออปติไมซ์ประสิทธิภาพ circuit บน QPU

<Admonition type="caution">
โค้ดบล็อคต่อไปนี้จะคืนค่า error สำหรับผู้ใช้แผน Open Plan เนื่องจากใช้ Session workload บน Open Plan สามารถรันได้เฉพาะใน [job mode](/guides/execution-modes#job-mode) หรือ [batch mode](/guides/execution-modes#batch-mode) เท่านั้น
</Admonition>
...
```
---
title: "ตัวอย่าง primitives (ส่วนที่ 2)"
sidebar_label: "ตัวอย่าง primitives (ส่วนที่ 2)"
description: "ตัวอย่างการใช้งาน Sampler primitives ใน Qiskit Runtime ในทางปฏิบัติ"
notebook_path: "guides/primitives-examples.ipynb"
---
...
## ตัวอย่าง Sampler {#sampler-examples}
...
<Admonition type="tip" title="คำแนะนำ">
    - [ระบุตัวเลือก runtime ขั้นสูง](runtime-options-overview)
    ...
    - ลอง [Compare transpiler settings](/guides/circuit-transpilation-settings)
    - อ่าน [Migrate to V2 primitives](/guides/v2-primitives)
    - ทำความเข้าใจ [Job limits](/guides/job-limits) เมื่อส่ง job ไปยัง IBM&reg; QPU
</Admonition>
