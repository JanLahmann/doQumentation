...
บทช่วยสอนนี้ยังถือว่าคุณมีความคุ้นเคยกับวิธีการ QML โดยทั่วไป สำหรับการสำรวจ QML เพิ่มเติม ดูที่คอร์ส [Quantum machine learning](/learning/courses/quantum-machine-learning) ใน IBM Quantum Learning
