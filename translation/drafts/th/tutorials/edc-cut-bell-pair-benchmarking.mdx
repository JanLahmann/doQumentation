...
สำหรับแต่ละ initial layout สี่ Qubit ฟังก์ชันข้างต้นส่งคืน Circuit สองอัน (อันหนึ่งสำหรับ $ZZ$ และอีกอันสำหรับการวัด $XX$ stabilizer) ณ จุดสิ้นสุดของขั้นตอนนี้ เรามีรายการ Circuit ที่ครอบคลุมทุกสายโซ่ Qubit สี่ตัวบนอุปกรณ์ Circuit เหล่านี้รวมถึงการวัดกลางวงจรและการดำเนินการแบบมีเงื่อนไข (if/else) ซึ่งเป็นคำสั่งสำคัญของ dynamic circuit
...
## Step 2: ปรับแต่งปัญหาเพื่อรันบนฮาร์ดแวร์ควอนตัม {#step-2-optimize-the-problem-for-quantum-hardware-execution}
...
## Step 3: รันด้วย Qiskit primitives {#step-3-execute-using-qiskit-primitives}
...
## Step 4: ประมวลผลภายหลังและแสดงผลลัพธ์ในรูปแบบคลาสสิกที่ต้องการ {#step-4-post-process-and-return-result-in-the-desired-classical-format}
