...
---
{/* doqumentation-source-hash: 48624425 */}
...
# تحضير خريطة الميزات لحساب التداخل
...
مش هنشغل بالنا بالتحقق من الأعماق دلوقتي، لأن اللي بيهم فعلًا هو عمق البوابات ثنائية الكيوبت بعد التحويل.
### الخطوة 2: تحسين المسألة للتنفيذ الكمي {#step-2-optimize-problem-for-quantum-execution}

نبدأ باختيار الباكيند الأقل انشغالًا، ثم نحسّن الدائرة للتشغيل عليه.
...
في المهام الصغيرة، غالبًا ما يُعيد مدير التمرير المُعيَّن مسبقًا نفس الدائرة بنفس العمق بشكل موثوق. لكن في الدوائر الكبيرة جدًا والمعقدة، قد يُعيد مدير التمرير دوائر مُحوَّلة مختلفة في كل مرة يعمل فيها. وذلك لأنه يعتمد على الاستدلال، ولأن الدوائر الكبيرة جدًا تمتلك مشهدًا معقدًا من التحسينات الممكنة. كثيرًا ما يكون من المفيد إجراء التحويل عدة مرات واختيار أضحل دائرة. هذا لا يُضيف سوى تكلفة كلاسيكية، وقد يُحسّن النتائج من الحاسوب الكمي بشكل ملحوظ.

هنا، نحوّل دائرة التداخل الأحادي 20 مرة، ونراقب أعماق الدوائر الناتجة.
...
هنا يمكنك أن ترى أن هناك بعض التفاوت في إجمالي عمق البوابات مع تمريرات التحويل المختلفة. دائرتنا ليست بعيدة بما يكفي في العمق أو العرض لنرى تفاوتًا في أعماق التحويل ثنائية الكيوبت. سنستخدم `transpiled_qcs[1]` التي يبلغ عمقها 60، وهو أقل قليلًا من عمق أعمق دائرة تم الحصول عليها والبالغ 77.
...
كلما اقتربنا من نطاق الاستخدام الفعلي، كلما أصبحت المحاكيات أقل جدوى. هنا نعرض فقط الصيغة الخاصة بالحواسيب الكمية الحقيقية.
...
كما وُصف في المقدمة، القياس الأكثر فائدة هنا هو احتمالية قياس الحالة الصفرية $|00000\rangle$.
