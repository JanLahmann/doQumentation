## 모델 개선하기 {#data-generation}

### 1단계 재검토 {#qiskit-patterns-step-1-map-the-problem-to-a-quantum-circuit}
...
2+ qubit depth: 10
```
## Qiskit Patterns Step 3: Execute using Qiskit Primitives {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution}
