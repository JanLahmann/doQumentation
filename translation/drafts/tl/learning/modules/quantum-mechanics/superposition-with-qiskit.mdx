...
---
{/* doqumentation-source-hash: 8747c501 */}
...
# mga bar plot gamit ang get_gaussian_probs function
plt.hist(fliplist)
plt.show()
```
...
# Gamitin ang pinaka-hindi abala na Backend
...
```python
## Gumamit ng lokal na simulator

# from qiskit_aer import AerSimulator

## Gumawa ng simulator na ginagaya ang tunay na quantum system

# backend_sim = AerSimulator.from_backend(backend)

## Mag-import ng estimator, sa pagkakataong ito mula sa qiskit (mag-i-import tayo mula sa Runtime para sa tunay na hardware)
...
# o gamit ang Aer simulator na may noise model mula sa tunay na Backend
...
# para sa Estimator, hindi natin inilalapat ang sukat sa Circuit
```
