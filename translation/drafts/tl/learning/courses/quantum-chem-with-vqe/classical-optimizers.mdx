...
---
{/* doqumentation-source-hash: 21774a9c */}
...
Ang minimize function na ito ay may ilang argumento, ngunit ang pinaka-kaugnay na mga argumento para sa quantum chemistry ay:
- Ang cost function (`cost_func`). Ito ay may kaugnayan sa Hamiltonian, ngunit mayroon ding ilang mga kumplikasyon, tulad ng pagtukoy sa expectation value sa pamamagitan ng paggamit ng Estimator, at sa kaso ng mga excited state na kalkulasyon, maaaring magsama ng mga orthogonality condition.
- Isang paunang estado (x0) para sa sistema, kadalasan ang Hartree-Fock state
- Iba pang mga argumento, kasama ang mga argumento ng cost function mismo
- Ang method na nakatakda sa classical optimizer na pipiliin mo
- Mga opsyon para sa classical optimizer (huwag itong ipagkamaling mga opsyon ng Session na tinalakay sa susunod na seksyon)

Ipinapakita sa ibaba ang ilang halimbawa ng code. Ilililim natin ang ating talakayan dito sa huling dalawang argumento.
