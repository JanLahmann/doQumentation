#### I-visualize ang SLC para sa manu-manong inspeksyon

Maaari mong bigyang-kahulugan ang gawi ng shaded bounds sa pamamagitan ng pagsusuri kung paano nakikipag-ugnayan ang mga sukat at Pauli terms sa mga lokal na error. Ang mga pattern na ito ay katangian ng kicked Ising Hamiltonian time-evolution problem at lumabas din sa papel na [Lightcone Shading for Classically Accelerated Quantum Error Mitigation](https://arxiv.org/abs/2409.04401), na may ilang kapansin-pansing katangian:

- Malinaw nating makikilala ang dalawang cone na nagmumula sa dalawang non-identity Paulis sa observable.
- Makikita natin na ang X measurement sa qubit 6 ay nag-commute sa X error sa pinaka-kanang layer.
- Makikita natin na ang Z Pauli sa qubit 13 ay nag-commute sa Z error sa pinaka-kanang layer.
- Kapag naabot na ang timeout na tinukoy sa itaas, ang mga natitirang layer sa kaliwa ay napupuno ng trivial bounds na dalawa.
...
#### b. I-compute at i-tighten ang forward bounds
Susunod, pinahihigpit natin ang bounds sa pamamagitan ng `tighten_with_speed_limit` function, na sinusubaybayan kung paano kumakalat ang observable pabalik sa circuit at ginagamit ang pagkalat na iyon para maglagay ng upper bounds sa epekto ng bawat noise operator, kinukuha ang mas maliit sa pagitan ng forward bound na kakalkulahin lang, at ng backward-propagation bound.
...
Maaari pa nating pahigpitin ang bounds sa pamamagitan ng pag-account sa limitasyon ng lightcone. Sa prinsipyo, nagbibigay ito ng mas maayos na transisyon mula sa mga computed bounds patungo sa trivial bounds na itinakda pagkatapos maabot ang timeout. Dito, hindi gaanong halata ang epekto dahil naabot na ng mga lightcone ang gilid ng circuit.
