...
### Určení, jak velkou část časové evoluce simulovat klasicky {#určení-jak-velkou-část-časové-evoluce-simulovat-klasicky}
...
### Generování Circuits před a po rozdělení {#generování-circuits-před-a-po-rozdělení}
...
### Generování ansatzu a počátečních parametrů z Trotterova Circuit s menším počtem kroků {#generování-ansatzu-a-počátečních-parametrů-z-trotterova-circuit-s-menším-počtem-kroků}
...
### Výběr nastavení pro simulaci tenzorové sítě {#výběr-nastavení-pro-simulaci-tenzorové-sítě}
...
### Konstrukce reprezentace cílového stavu AQC jako maticového součinu {#konstrukce-reprezentace-cílového-stavu-aqc-jako-maticového-součinu}
...
### Optimalizace parametrů ansatzu pomocí výpočtů MPS {#optimalizace-parametrů-ansatzu-pomocí-výpočtů-mps}
...
### Konstrukce finálního Circuit pro předání Transpileru {#konstrukce-finálního-circuit-pro-předání-transpileru}
...
## Krok 2: Transpilace pro spuštění na cílovém hardware {#krok-2-transpilace-pro-spuštění-na-cílovém-hardware}
...
## Krok 3: Spuštění na kvantovém hardware {#krok-3-spuštění-na-kvantovém-hardware}
