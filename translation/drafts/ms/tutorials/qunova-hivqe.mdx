...
### Langkah 2 dan 3: Optimumkan masalah untuk pelaksanaan perkakasan kuantum dan laksanakan menggunakan fungsi HiVQE Chemistry
...
### Langkah 4: Pasca-proses dan bandingkan dengan kaedah klasik
...
### Memplot lengkung penceraian untuk Li\_2S
...
#### Hantar pengiraan d(Fe-N) = 1.75 $\AA$.
...
#### Hantar pengiraan d(Fe-N) = 2.00 $\AA$.
...
#### Hantar pengiraan d(Fe-N) = 5.00 $\AA$.
