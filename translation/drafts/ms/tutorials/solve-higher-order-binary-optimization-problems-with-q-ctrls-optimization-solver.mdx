...
Takrifkan kelayakan [IBM Quantum Platform](https://quantum.cloud.ibm.com/) anda, yang akan digunakan sepanjang tutorial ini untuk mengesahkan identiti kepada Qiskit Runtime dan Qiskit Functions.
