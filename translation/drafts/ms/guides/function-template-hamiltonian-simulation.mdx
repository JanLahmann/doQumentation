...
# Bina templat fungsi untuk simulasi Hamiltonian {#build-a-function-template-for-hamiltonian-simulation}

Templat ini merangkumi aliran kerja untuk mensimulasikan evolusi masa sesuatu keadaan awal terhadap Hamiltonian berasaskan spin yang ditentukan pengguna, dan mengembalikan set nilai jangkaan yang ditetapkan menggunakan [addon AQC](./qiskit-addons-aqc).
...
Pertama, tulis templat fungsi untuk simulasi Hamiltonian yang menggunakan [addon Qiskit AQC-Tensor](/guides/qiskit-addons-aqc) untuk memetakan huraian masalah kepada litar kedalaman berkurangan untuk dilaksanakan pada perkakasan.
...
<details>
<summary><b>Kod sumber program penuh</b></summary>
