...
service = QiskitRuntimeService(channel=<channel>,
            token=<your-API_KEY>, # Gunakan API_KEY 44 karakter yang sudah kamu buat dan simpan dari dashboard IBM Quantum Platform Home
...
service = QiskitRuntimeService(token=<cloud_api_key>, # Gunakan API_KEY 44 karakter yang sudah kamu buat dan simpan dari dashboard IBM Quantum Platform Home
            instance=<instance_CRN>)
```
...
# jalankan setiap kali kamu membutuhkan layanan
...
# Inisialisasi untuk pengujian lokal
