...
| Referensi Composer                                    | Referensi OpenQASM | Q-sphere | Catatan tentang representasi q-sphere                                                                                                                                                                                                     |
| ----------------------------------------------------- | ------------------ | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![sxdg\_gate](/docs/images/guides/composer/4d5d9638-30af-48c3-a28c-d506a0041f24.avif) | `sxdg q[0];`       | ![sxdg\_qsph](/docs/images/guides/composer/3e258992-baa9-42bb-92b1-6e082eb674c9.avif)                     | Representasi q-sphere menunjukkan keadaan setelah gate beroperasi pada keadaan superposisi merata awal $\frac{1}{\sqrt{2^{n}}}\sum_{i=0}^{2^{n}-1}\vert i\rangle, $ di mana $n$ adalah jumlah qubit yang diperlukan untuk mendukung gate. |
