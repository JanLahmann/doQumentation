...
## 1. Pendahuluan dan tinjauan evolusi waktu
...
## 2. Mendefinisikan Hamiltonian Ising medan transversal
...
#### Atur parameter simulasi evolusi waktu
...
#### Siapkan Circuit kuantum (Keadaan awal)
...
#### Siapkan Circuit kuantum 2 (Circuit tunggal untuk evolusi waktu)
...
#### Atur operator yang akan diukur
...
#### Lakukan simulasi evolusi waktu
...
#### Plot evolusi waktu dari observabel
...
#### Siapkan quantum Circuit 2 (Circuit tunggal untuk time evolution) untuk masalah 70-Qubit
...
#### Tentukan operator yang akan diukur
...
#### Lakukan simulasi time-evolution
...
#### Langkah 3: Jalankan di hardware target
...
## 3. Solusi menggunakan komputer kuantum nyata II

Mari kita kembali ke langkah 1 Qiskit patterns, dan lihat apakah kita bisa mengurangi kedalaman Circuit kita.

###  3.1 Langkah 1. Petakan masalah ke quantum Circuit dan operator
...
### 3.4 Langkah 4. Pasca-pemrosesan
