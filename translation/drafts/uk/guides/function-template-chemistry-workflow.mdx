...
#### 4. Постобробка за допомогою SQD
...
```python
# Ця комірка прихована від користувачів. Вона перевіряє ідентичність обох вихідних лістингів, а потім видаляє робочу теку, яку ми створили
import shutil
