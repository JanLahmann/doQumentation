...
---
{/* doqumentation-source-hash: eb8e2835 */}
...
## 3. Вправа 1. Виконання симуляції з використанням Судзукі–Троттера другого порядку {#3-exercise-1-perform-simulation-using-second-order-suzuki-trotter}
...
### 4.3 Крок 3. Виконання за допомогою примітивів Qiskit Runtime {#43-step-3-execute-with-qiskit-runtime-primitives}
