...
---
{/* doqumentation-source-hash: d2c89a55 */}
...
Завантажимо решту пакетів для запуску самого VQE, зокрема ansatz `efficient_su2` та мінімізатори SciPy:
...
Результати цього виводу обговорюються нижче в розділі постобробки; наразі просто зверни увагу, що симуляція пройшла успішно. Тепер ти готовий запустити це на реальному залізі. Ми встановимо стійкість на `1`, вказуючи на те, що буде використано мітигацію помилок TREX. Оскільки ми тепер працюємо з реальним залізом, ми використаємо Qiskit Runtime і Runtime primitives. Зверни увагу, що і цикл `for` по геометрії, і численні варіаційні спроби — всі вони знаходяться всередині сесії.
