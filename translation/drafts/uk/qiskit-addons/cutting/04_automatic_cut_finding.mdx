...
#### Створення Circuit і спостережуваних
...
#### Пошук місць розрізів за умови максимум 4 Qubit на підсхему. Цей Circuit можна розділити на два, зробивши один розріз проводу та розрізавши один `CRZGate`
...
#### Додавання допоміжних Qubit для розрізів проводів і розширення спостережуваних з урахуванням допоміжних Qubit
...
#### Розбиття Circuit і спостережуваних на підсхеми і під-спостережувані. Розрахунок накладних витрат вибірки від розрізання цих Gate і проводів.
...
#### Генерація експериментів для запуску на Backend.
