#### Переваги кластерів для зменшення накладних витрат на вибірку при заданому часі класичних обчислень
...
### c. Виконання Circuit інтересу з антишумом
#### c.i. Підготовка шаблонного Circuit за допомогою `samplex`
...
#### c.iii. Виконання програми за допомогою примітиву `Executor`
