...
---
{/* doqumentation-source-hash: 4beb4c7b */}
...
Importa le librerie necessarie e configura l'ambiente per eseguire il Circuit quantistico.
...
### Passo 1: mappare il problema in Circuit e operatori quantistici {#step-1-map-problem-to-quantum-circuits-and-operators}
...
### Passo 3: esecuzione del Circuit. {#step-3-executing-the-circuit}
...
Transpilando il Circuit, è stato convertito in un Circuit che utilizza i Gate nativi del dispositivo.
### Passo 3: esecuzione del Circuit. {#step-3-executing-the-circuit-real}
