...
## Step 1: Mappa al problema quantistico
### Mappa l'evoluzione temporale di un modello di Heisenberg quantistico su un esperimento quantistico.
...
## Step 2: Ottimizza il problema
### Crea le slice del circuito da retropropagare
...
### Limita quanto può crescere l'operatore durante la backpropagation
...
### Retropropaga le slice dal circuito
...
### Ora che abbiamo i nostri ansatz ridotti e le osservabili espanse, possiamo transpilare i nostri esperimenti per il Backend.
...
## Step 3: Esegui gli esperimenti quantistici
### Calcola il valore di aspettazione
