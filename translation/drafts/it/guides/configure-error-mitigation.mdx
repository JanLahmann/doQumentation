...
Nel livello 2, il metodo TREX ribalta casualmente i qubit tramite gate X immediatamente prima della misura e ribalta il bit misurato corrispondente se è stato applicato un gate X. Questo approccio è descritto ulteriormente in [Model-free readout-error mitigation for quantum expectation values](https://arxiv.org/abs/2012.09738).
