...
# Installa il nuovo pacchetto Qiskit 1.0 {#install-the-new-qiskit-1.0-package}
...
### Raccomandazioni per i test con Qiskit 1.0 {#recommendations-for-testing-against-qiskit-1.0}
...
#### Crea un ambiente funzionante per Qiskit 1.0 {#create-a-working-environment-for-qiskit-1.0}
...
#### Crea un ambiente funzionante per Qiskit 0.45 o 0.46 {#create-a-working-environment-for-qiskit-0.45-or-0.46}
