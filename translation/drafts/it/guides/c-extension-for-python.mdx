...
Invece di usare `ctypes`, è possibile costruire manualmente un'estensione per Python usando direttamente la [C API di Python](https://docs.python.org/3/c-api/intro.html). Questo ha il potenziale di essere più veloce rispetto all'uso di `ctypes`, anche se richiede più lavoro da implementare.
