...
### Transpilarea Circuit-ului, vizualizarea swap-urilor și notarea adâncimii {#transpilarea-circuit-ului-vizualizarea-swap-urilor-și-notarea-adâncimii}
...
### Înlocuirea Gate-urilor îndepărtate cu `TwoQubitQPDGate` prin specificarea indicilor lor {#înlocuirea-gate-urilor-îndepărtate-cu-twoqubitqpdgate-prin-specificarea-indicilor-lor}
...
### Calcularea costului de eșantionare pentru tăieturile alese {#calcularea-costului-de-eșantionare-pentru-tăieturile-alese}
...
### Demonstrarea că subexperimentele QPD vor fi mai puțin adânci după tăierea Gate-urilor îndepărtate {#demonstrarea-că-subexperimentele-qpd-vor-fi-mai-puțin-adânci-după-tăierea-gate-urilor-îndepărtate}
...
### Reconstituirea valorii așteptate {#reconstituirea-valorii-așteptate}
...
### Compararea valorii așteptate reconstituite cu valoarea așteptată exactă din Circuit-ul și observabilul original {#compararea-valorii-așteptate-reconstituite-cu-valoarea-așteptată-exactă-din-circuit-ul-și-observabilul-original}
