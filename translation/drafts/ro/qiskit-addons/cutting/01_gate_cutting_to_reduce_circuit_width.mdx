...
### Crearea unui Circuit de tăiat {#crearea-unui-circuit-de-tăiat}
...
### Separarea Circuitului și a observabilului conform unei partiționări specificate a Qubiților {#separarea-circuitului-și-a-observabilului}
...
### Calcularea supraîncărcării de eșantionare pentru tăieturile alese {#calcularea-supraîncărcării-de-eșantionare}
...
### Pregătirea subexperimentelor pentru Backend {#pregătirea-subexperimentelor-pentru-backend}
...
## Pasul 3: Execuție {#pasul-3-execuție}
...
### Reconstruirea valorii de așteptare {#reconstruirea-valorii-de-așteptare}
...
### Compararea valorii de așteptare reconstruite cu valoarea de așteptare exactă din Circuitul și observabilul original {#compararea-valorilor-de-așteptare}
