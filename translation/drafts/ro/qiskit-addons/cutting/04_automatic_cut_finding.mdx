---
title: "Găsește tăieturile automat"
sidebar_label: "Găsește tăieturile automat"
...
#### Creează un Circuit și observabile
...
#### Găsește locațiile de tăiere, cu un maxim de 4 Qubiți per subcircuit. Acest Circuit poate fi separat în două printr-o singură tăietură de fir și tăierea unui `CRZGate`
...
#### Adaugă ancile pentru tăieturile de fir și extinde observabilele pentru a ține cont de Qubiții ancilă
...
#### Partiționează Circuit-ul și observabilele în subcircuite și subobservabile. Calculează costul de eșantionare generat de tăierea acestor Gate-uri și fire.
...
#### Generează experimentele care urmează să fie rulate pe Backend.
...
Pașii 3 și 4 dintr-un [tipar Qiskit](https://quantum.cloud.ibm.com/docs/guides/intro-to-patterns) pot fi efectuați apoi ca în tutorialele anterioare.
