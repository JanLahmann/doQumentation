...
Acest tutorial presupune, de asemenea, o familiarizare generală cu metodele QML. Pentru o explorare mai aprofundată a QML, consultă cursul [Quantum machine learning](/learning/courses/quantum-machine-learning) din IBM Quantum Learning.
### Cerințe
...
Principalele componente ale nucleelor cuantice proiectate sunt matricele de densitate redusă (RDM), obținute prin măsurători proiective ale hărții de caracteristici cuantice. În acest pas, obținem toate matricele de densitate redusă pe un singur qubit (1-RDM), care vor fi furnizate ulterior funcției clasice de nucleu exponențial.
