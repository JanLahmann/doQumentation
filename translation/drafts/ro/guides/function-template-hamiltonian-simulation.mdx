...
# Construiește un șablon de funcție pentru simularea Hamiltonian {#build-a-function-template-for-hamiltonian-simulation}
...
#### 1. Colectarea intrărilor și maparea problemei {#1-collecting-input-and-mapping-the-problem}
...
#### 2. Pregătirea circuitelor generate pentru execuție {#2-prepare-the-generated-circuits-for-execution}
...
## Scrie șablonul de funcție {#write-the-function-template}
...
### Colectează și validează intrările {#collect-and-validate-the-inputs}
...
#### Validarea intrărilor {#validate-the-inputs}
...
#### Pregătirea ieșirilor funcției {#prepare-the-function-outputs}
...
### Maparea problemei și preprocesarea circuitului cu AQC {#map-the-problem-and-pre-process-the-circuit-with-aqc}
...
Appending to ./source_files/template_hamiltonian_simulation.py
```
### Optimizează circuitul final pentru execuție {#optimize-the-final-circuit-for-execution}
...
#### Ieșire anticipată în modul dry run {#exit-early-if-using-dry-run-mode}
...
#### Execută circuitul pe hardware {#execute-the-circuit-on-hardware}
...
#### Salvează rezultatul {#save-the-output}
...
## Deployează funcția pe IBM Quantum Platform {#deploy-the-function-to-ibm-quantum-platform}
...
## Rulează șablonul de funcție de la distanță {#run-the-function-template-remotely}
