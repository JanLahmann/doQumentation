...
# définir le nombre de qubits
n = 12

# définir les termes de Pauli simples comme ("Paulis", [indices], coefficient)
interactions = [
...
# créer un circuit, où l'on souhaite mesurer
# q0 dans la base X, q1 dans la base Y et q2 dans la base Z
...
# diagonaliser X avec la porte Hadamard
circuit.h(0)

# diagonaliser Y avec Hadamard comme S^\dagger
circuit.sdg(1)
circuit.h(1)

# la base Z est la base par défaut, aucune action requise ici
