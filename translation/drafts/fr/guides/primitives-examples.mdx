---
title: "Exemples de primitives"
sidebar_label: "Exemples de primitives"
description: "Exemples pratiques d'utilisation des primitives dans Qiskit Runtime."
...
<Admonition type="note" title="Nouveau modèle d'exécution, actuellement en version bêta">
La version bêta d'un nouveau modèle d'exécution est désormais disponible. Le modèle d'exécution dirigée offre plus de flexibilité pour personnaliser ton flux de travail d'atténuation des erreurs. Consulte le guide [Modèle d'exécution dirigée](/guides/directed-execution-model) pour plus d'informations.
</Admonition>
{/*
...
Les exemples de cette section illustrent quelques façons courantes d'utiliser les primitives. Avant d'exécuter ces exemples, suis les instructions de la page [Installer et configurer.](install-qiskit)
...
## Exemples avec Estimator {#estimator-examples}
...
### Exécuter plusieurs expériences dans un seul job {#run-multiple-experiments-in-a-single-job}
...
### Utiliser les sessions et les options avancées {#use-sessions-and-advanced-options}

Explore les sessions et les options avancées pour optimiser les performances des circuits sur les QPU.

<Admonition type="caution">
Le bloc de code suivant renverra une erreur pour les utilisateurs du plan Open, car il utilise des sessions. Les charges de travail du plan Open ne peuvent s'exécuter qu'en [mode job](/guides/execution-modes#job-mode) ou en [mode batch](/guides/execution-modes#batch-mode).
</Admonition>
...
## Exemples avec Sampler {#sampler-examples}
...
### Exécuter une seule expérience {#run-a-single-experiment-sampler}
...
### Exécuter plusieurs expériences dans un seul job {#run-multiple-experiments-in-a-single-job-sampler}
...
### Exécuter des circuits paramétrés {#run-parameterized-circuits-sampler}
...
### Utiliser les sessions et les options avancées {#use-sessions-and-advanced-options-sampler}
...
<Admonition type="tip" title="Recommandations">
    - [Spécifier des options avancées d'exécution.](runtime-options-overview)
    ...
    - Essaie le guide [Comparer les paramètres du transpilateur](/guides/circuit-transpilation-settings).
