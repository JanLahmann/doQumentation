...
Au lieu d'utiliser `ctypes`, il est possible de construire manuellement une extension pour Python en utilisant directement [l'API C
de Python](https://docs.python.org/3/c-api/intro.html). Cela peut être plus rapide que d'utiliser `ctypes`, bien que cela demande plus d'effort à mettre en œuvre.
