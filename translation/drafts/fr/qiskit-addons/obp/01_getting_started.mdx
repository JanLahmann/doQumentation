...
### Contraindre la croissance de l'opérateur pendant la rétropropagation
...
### Rétropropager des tranches depuis le circuit
...
### Maintenant que nous avons nos ansatze réduits et nos observables étendues, nous pouvons transpiler nos expériences vers le Backend.
...
### Calculer la valeur d'espérance
