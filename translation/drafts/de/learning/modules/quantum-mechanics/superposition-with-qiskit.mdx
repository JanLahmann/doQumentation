...
Um die oben genannten Pakete einzurichten und zu installieren, siehe die Anleitung [Install Qiskit](/guides/install-qiskit).
Um Jobs auf echten Quantencomputern auszuführen, müssen Studierende ein Konto bei IBM Quantum&reg; einrichten, indem sie den Schritten in der Anleitung [Set up your IBM Cloud account](/guides/cloud-setup) folgen.
...
Es gibt unten Code zum Speichern deiner Anmeldedaten bei der ersten Nutzung. Stelle sicher, dass du diese Informationen nach dem Speichern in deiner Umgebung aus dem Notebook löschst, damit deine Anmeldedaten nicht versehentlich geteilt werden, wenn du das Notebook teilst. Siehe [Set up your IBM Cloud account](/guides/initialize-account) und [Initialize the service in an untrusted environment](/guides/cloud-setup-untrusted) für weitere Anleitungen.
