...
$100\%$ Genauigkeit auf beiden Sets! Unsere Vermutung, dass eine genaue Erkennung horizontaler Linien ausreicht, war korrekt! Darüber hinaus war unsere Abbildung der benötigten Pixelinformationen auf die CNOT Gates im Quantum Circuit wirksam. Lass uns nun betrachten, wie dieser Prozess für die Ausführung auf echten Quantencomputern skaliert.

## Skalierung und Ausführung auf echten Quantencomputern {#scaling-and-running-on-real-quantum-computers}

### Daten {#data}

Beginnen wir damit, die Größe unserer Bilder zu erhöhen. Die Wahl eines 6x6-Rasters hat nichts Besonderes, außer dass es die Anzahl der Qubits (32) übersteigt, die wir für Circuits mit Nicht-Clifford-Gates simulieren können.
