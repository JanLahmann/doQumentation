...
## Schritt 1: Auf Quantenschaltkreis und Operator abbilden

### Einen Modell-Hamiltonoperator und eine Observable einrichten
...
### Festlegen, wie viel der Zeitentwicklung klassisch simuliert werden soll
...
### Schaltkreise vor und nach der Aufteilung generieren
...
### Einen Ansatz und Anfangsparameter aus einem Trotter-Schaltkreis mit weniger Schritten generieren
...
### Einstellungen für die Tensornetzwerk-Simulation auswählen
...
### Matrixproduktzustand-Darstellung des AQC-Zielzustands konstruieren
...
### Den endgültigen Schaltkreis für die Übergabe an den Transpiler konstruieren
...
## Schritt 2: Für die Ausführung auf Zielhardware transpilieren
...
## Schritt 3: Auf Quantenhardware ausführen
