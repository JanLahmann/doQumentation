...
ZNEは、EstimatorのQiskit Runtimeレジリエンスオプション](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-resilience-options-v2)で`zne_mitigation`を`True`に設定することで有効にできます。
...
PECは、EstimatorのQiskit Runtimeレジリエンスオプション](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-resilience-options-v2)で`pec_mitigation`を`True`に設定することで有効にできます。
