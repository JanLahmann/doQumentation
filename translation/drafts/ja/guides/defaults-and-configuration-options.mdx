...
# トランスパイルのデフォルト設定と構成オプション {#transpilation-default-settings-and-configuration-options}
{/*
...
<Admonition type="tip" title="推奨事項">
    ...
    - [Qiskit Runtime を使用する際の最適化レベルの設定方法](./runtime-options-overview) を学びましょう。
    - [パスマネージャーを使ったトランスパイル](transpile-with-pass-managers) のトピックを参照してください。
    - 例については、[量子コンピューターの表現](./represent-quantum-computers) を参照してください。
