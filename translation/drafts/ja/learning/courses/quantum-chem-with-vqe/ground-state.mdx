...
```python
# 実機で実行するには、キューのジョブ数が最も少ないバックエンドを選択する
...
# Estimatorをインポート（実機には後でRuntimeからインポートする）
from qiskit.primitives import BackendEstimatorV2

# 実際の量子システムを模倣したシミュレーターを生成する
