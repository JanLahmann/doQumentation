...
### Sterowanie rysowaniem obwodów {#sterowanie-rysowaniem-obwodów}
...
### Dostosowywanie wyjścia {#dostosowywanie-wyjścia}

W zależności od wyjścia dostępne są również opcje dostosowywania diagramu obwodu.

#### Wyłączanie barier i odwracanie kolejności bitów {#wyłączanie-barier-i-odwracanie-kolejności-bitów}
...
### Samodzielna funkcja rysowania obwodów {#samodzielna-funkcja-rysowania-obwodów}
