...
## Konfiguracja do używania wsadów {#konfiguracja-do-używania-wsadów}
...
## Ustalanie szczegółów wsadu {#ustalanie-szczegółów-wsadu}
...
## Rekonfiguracja zadań do przetwarzania równoległego {#rekonfiguracja-zadań-do-przetwarzania-równoległego}
