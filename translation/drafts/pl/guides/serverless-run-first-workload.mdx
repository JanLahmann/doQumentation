...
## Wyświetlanie listy dostępnych programów {#wyświetlanie-listy-dostępnych-programów}
...
## Uruchamianie przesłanego programu i przekazywanie danych wejściowych {#uruchamianie-przesłanego-programu}
...
## Pobieranie logów i wyników {#pobieranie-logów-i-wyników}
...
## Wyświetlanie listy wcześniej uruchomionych zadań z Qiskit Serverless {#wyświetlanie-listy-wcześniejszych-zadań}
