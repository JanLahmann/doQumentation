...
Ten samouczek zakłada też ogólną znajomość metod QML. Aby pogłębić wiedzę o QML, zajrzyj do kursu [Kwantowe uczenie maszynowe](/learning/courses/quantum-machine-learning) w IBM Quantum Learning.
...
Głównymi elementami składowymi projektowanych jąder kwantowych są zredukowane macierze gęstości (RDM), uzyskiwane poprzez projekcyjne pomiary kwantowej mapy cech. W tym kroku wyznaczamy wszystkie jednoQubitowe zredukowane macierze gęstości (1-RDM), które następnie zostaną przekazane do klasycznej funkcji wykładniczego jądra.
