...
#### Krok 1: Przygotowanie stanu ansatz {#step-1-prepare-the-ansatz-state}
...
#### Krok 2: Próbkowanie podprzestrzeni {#step-2-sample-the-subspace}
...
#### Krok 3: Rzutowanie i klasyczna diagonalizacja {#step-3-project-and-diagonalize-classically}
...
#### Krok 4: Optymalizacja ansatzu (opcjonalnie) {#step-4-optimize-the-ansatz-optional}
...
#### Krok 1: Zbuduj podprzestrzeń Krylov za pomocą ewolucji czasowej {#step-1-construct-the-krylov-subspace-with-time-evolution}
...
#### Krok 2: Próbkuj ze stanów bazy Krylov {#step-2-sample-from-the-krylov-basis-states}
...
#### Krok 3: Rzutuj i diagonalizuj klasycznie {#step-3-project-and-diagonalize-classically}
