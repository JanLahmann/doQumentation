...
### 1.2 Importowanie bibliotek {#12-import-the-libraries}
...
## 2. Mapowanie Twojego problemu {#2-mapping-your-problem}

### 2.1 Definiowanie hamiltonianu Isinga z poprzecznym polem {#21-defining-the-transverse-field-ising-hamiltonian}
...
exact_energy = np.array(
    [
        ...
        -1.1184402376762168,
        -1.118440237676221,
        -1.118440237676218,        -1.1184402376762148,
        -1.1184402376762106,
        -1.1184402376762173,
        -1.118440237676216,
        -1.118440237676216,
...
![Wynik poprzedniej komórki kodu](/learning/images/courses/utility-scale-quantum-computing/quantum-simulation/extracted-outputs/64d9166e-296a-4a6d-a6d1-0b6fdd49399b-0.avif)

### 4.3 Krok 3. Wykonanie za pomocą prymitywów Qiskit Runtime {#43-step-3-execute-with-qiskit-runtime-primitives}
...
### 4.4 Krok 4. Przetwarzanie wyników {#44-step-4-post-process-results}
...
![Wynik poprzedniej komórki kodu](/learning/images/courses/utility-scale-quantum-computing/quantum-simulation/extracted-outputs/1f4e5fbd-1994-4f4d-8d35-ddf1a37664b7-1.avif)

Przedstawiamy tutaj przykład konstruowania obwodu z użyciem Suzukiego–Trottera wyższego rzędu (czwartego rzędu).
Spróbujmy teraz skonstruować symulację obwodu z Suzukim–Trotterem czwartego rzędu, kierując się powyższymi przykładami.

Suzuki–Trotter czwartego rzędu może być używany w Qiskit za pomocą [klasy SuzukiTrotter](https://docs.quantum.ibm.com/api/qiskit/qiskit.synthesis.SuzukiTrotter). Czwarty rząd można obliczyć przy użyciu następującej relacji rekurencyjnej. Zauważ, że rząd Suzukiego–Trottera jest oznaczany jako „2k” w poniższych równaniach.
...
$$
#### Konstrukcja obwodu dla pojedynczego kroku czasowego {#construct-a-circuit-for-a-single-time-step}
...
![Wynik poprzedniej komórki kodu](/learning/images/courses/utility-scale-quantum-computing/quantum-simulation/extracted-outputs/e20ea669-82d3-42a7-89f6-bab7d41689f1-1.avif)
