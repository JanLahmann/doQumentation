...
### Podstawowa struktura algorytmu Grovera {#the-basic-structure-of-grovers-algorithm}
...
### 2.1 Przygotowanie {#21-preparation}
...
### Krok 1: Odwzoruj problem na obwody i operatory kwantowe {#step-1-map-problem-to-quantum-circuits-and-operators}
...
### 1: Inicjalizacja {#1-initialization}
...
### 3: Operator dyfuzji {#3-diffusion-operator}
...
### 2.2 Przykład wyszukiwania Grovera dla 2 kubitów. {#22-a-2-qubit-grover-search-example}
...
### 2.3 Eksperyment z symulatorami {#23-experiment-with-simulators}
...
#### Co się stanie, jeśli wykonamy 3 iteracje? {#what-happens-if-we-iterate-3-times}
...
#### A co z 4 iteracjami? {#how-about-4-times}
