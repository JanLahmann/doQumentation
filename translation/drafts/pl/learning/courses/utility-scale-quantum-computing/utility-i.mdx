...
def color_coupling_map(backend):
    ...
    # zbuduj mapę z koloru na listę krawędzi
...
```python
backend = fake_provider.FakeTorontoV2()  # 27-kubitowe urządzenie fake.
num_steps = 2
...
angles = [
    ...
    1.0,
    np.pi / 2,
]  # Testujemy 11 kątów dla theta_h.
```
