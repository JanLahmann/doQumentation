...
### 1.1 Obwód kwantowy do generowania próbek: ansatz LUCJ {#11-quantum-circuit-for-sample-generation-the-lucj-ansatz}
...
### 1.2 Inicjalizacja ansatz LUCJ {#12-lucj-ansatz-initialization}
...
### 1.3 Konstruowanie ansatz LUCJ przy użyciu `ffsim` {#13-constructing-the-lucj-ansatz-using-ffsim}
...
### 4.2 Estymacja stanu podstawowego {#41-configuration-recovery-overview}
...
### 4.3 Omówienie wyników {#42-ground-state-estimation}
