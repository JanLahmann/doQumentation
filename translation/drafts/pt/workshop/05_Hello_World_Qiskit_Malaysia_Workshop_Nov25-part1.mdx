---
title: "Prática com Qiskit: Hello World - Qiskit Patterns"
sidebar_label: "Prática com Qiskit: Hello World - Qiskit Patterns"
...
description: "Neste notebook você vai percorrer um fluxo de trabalho do Qiskit Patterns e usar o [primitivo Sampler..."
---
...
Neste notebook você vai percorrer um fluxo de trabalho do Qiskit Patterns e usar o [primitivo Sampler](https://docs.quantum.ibm.com/guides/get-started-with-primitives) do Qiskit.

Este tutorial inclui parcialmente conteúdo de [IBM Quantum Documentation: Hello World](https://docs.quantum.ibm.com/guides/hello-world).

Links úteis:
1. Por favor, [crie uma conta IBM Cloud](https://cloud.ibm.com/registration?utm_content=quantum-trial&target=https%3A%2F%2Fquantum.cloud.ibm.com&error_uri=) para acessar a [IBM Quantum Platform](https://quantum.cloud.ibm.com/).
    - Para quem tem e-mail universitário: [obtenha um código de funcionalidade aqui para estender seu período de avaliação gratuita](https://github.com/academic-initiative/documentation/blob/main/academic-initiative/how-to/How-to-request-and-IBM-Cloud-Feature-Code/readme.md).
    - Para quem não tem e-mail universitário: [instruções para ativar sua conta](https://cloud.ibm.com/docs/account?topic=account-upgrading-account). Ative sua conta completamente registrando um cartão de crédito. Seu cartão de crédito não é cobrado neste processo nem de forma aleatória após o registro. Essa ativação permite que você continue acessando seus recursos gratuitos na IBM Cloud e na plataforma IBM Quantum após o período de avaliação (30 dias).
2. Usaremos uma plataforma baseada em nuvem para configurar um ambiente de programação. Você pode usar o [QBraid](https://www.qbraid.com/) ou o [Google Colab](https://colab.google/).
3. Após este notebook, vamos explorar o [protocolo de Teletransporte Quântico](https://quantum.cloud.ibm.com/learning/en/modules/computer-science/quantum-teleportation).
...
- [Aulas do Qiskit Global Summer School 2025](https://www.youtube.com/watch?v=maJaB4-WfFg&list=PLOFEBzvs-VvoIfbpOb_geVnwFmbW6ij0m)
- [Certificação Qiskit v2.X](https://www.ibm.com/training/certification/ibm-certified-quantum-computation-using-qiskit-v2x-developer-associate-C9008400)
- [Programa de defensores Qiskit](https://www.ibm.com/quantum/blog/qiskit-advocate-program)
- [Estágios de verão em computação quântica](https://www.ibm.com/au-en/careers/search?field_keyword_18[0]=Internship&q=quantum)
- [Qiskit YouTube](https://www.youtube.com/qiskit)
## Instalar o Qiskit <a id="install-qiskit"></a>

Você pode usar um ambiente jupyter lab online (consulte o guia [Ambientes de laboratório online](quantum.cloud.ibm.com/docs/en/guides/online-lab-environments)) ou instalar o Qiskit localmente.

Siga o guia de instalação do Qiskit [Instalar o SDK do Qiskit e o cliente Qiskit Runtime](https://quantum.cloud.ibm.com/docs/en/guides/install-qiskit) para concluir as seguintes etapas:

	- Instalar o Qiskit incluindo os pacotes extras de visualização: `pip install qiskit[visualization]`

	- Instalar o qiskit-ibm-runtime: `pip install qiskit-ibm-runtime`

	- Instalar o jupyter: `pip install jupyter`
Verifique se a versão do Python que você está usando no seu ambiente é python>=3.10, para garantir compatibilidade com a versão mais recente do Qiskit:
...
Se você precisar atualizar o Python e não souber como fazê-lo, consulte este guia sobre como atualizar o Python de acordo com seu sistema operacional: [How to update Python](https://4geeks.com/how-to/how-to-update-python-version)
