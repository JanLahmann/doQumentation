## Requisitos
Antes de começar este tutorial, certifique-se de que você tem os seguintes pacotes instalados:

- Qiskit IBM Runtime com o primitivo Executor (`pip install "qiskit-ibm-runtime @ git+https://github.com/Qiskit/qiskit-ibm-runtime.git"`)
...
- Samplomatic v0.16 ou superior(`pip install samplomatic`)
