...
```python
# Cria o circuito quântico de qubit único
qc = QuantumCircuit(1)
...
```python
qc = QuantumCircuit(1)  # Prepara o circuito quântico de qubit único

# Aplica uma porta X ao qubit 0
qc.x(0)
...
```python
# Veja o vetor de estado
out_vector = Statevector(qc)
print(out_vector)

# Desenha a esfera de Bloch
...
```python
qc = QuantumCircuit(1)  # Cria o circuito quântico de qubit único

# Aplica uma porta Hadamard ao qubit 0
qc.h(0)
...
# Cria o circuito quântico de qubit único
qc = QuantumCircuit(1)  ##seu código aqui##

# Adiciona uma porta X ao qubit 0
qc.x(0)  ##seu código aqui##
...
```python
# Cria um novo circuito com um qubit (primeiro argumento) e um bit clássico (segundo argumento)
qc = QuantumCircuit(1, 1)
qc.h(0)
qc.measure(0, 0)  # Adiciona a porta de medição
...
```python
# Roda o circuito num simulador para obter os resultados
# Define o backend
