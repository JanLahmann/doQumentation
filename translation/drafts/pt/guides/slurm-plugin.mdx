...
```bash
--qpu=names             Lista separada por vírgulas de recursos QPU a serem usados.
```
...
```shell-session
SLURM_INCLUDE_DIRS=<diretório contendo slurm/slurm.h> cmake ..
```
