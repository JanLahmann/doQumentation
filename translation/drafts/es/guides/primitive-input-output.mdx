...
A1     (2d array):      2 x 1
A2     (3d array):  6 x 5 x 4 # Esto funcionaría si la dimensión del medio fuera 2, pero es 5.
```
...
<Tabs>
    ...
    └── PrimitiveResult
        ├── PubResult[0]
        │   ├── metadata
        │   └── data  ## En forma de objeto DataBin
        │       ├── evs
        │       │   └── Lista de valores de expectación estimados con la forma
        |       |         especificada por el primer pub
        │       └── stds
        │           └── Lista de desviaciones estándar calculadas con la
        ...
        |       ├── evs
        |       │   └── Lista de valores de expectación estimados con la forma
        |       |        especificada por el segundo pub
        |       └── stds
        |           └── Lista de desviaciones estándar calculadas con la
        |                misma forma que la anterior
        ├── ...
    ...
    └── PrimitiveResult
        ...
        │   ├── metadata
        │   └── data  ## En forma de objeto DataBin
        │       ├── NOMBRE_DEL_REGISTRO_CLÁSICO
        │       │   └── BitArray de datos de conteo (por defecto es 'meas')
        |       |
        │       └── NOMBRE_DE_OTRO_REGISTRO_CLÁSICO
        │           └── BitArray de datos de conteo (existe solo si se especificó
        |                 más de un ClassicalRegister en el circuito)
        ├── PubResult[1]
        |   ├── metadata
        |   └── data  ## En forma de objeto DataBin
        |       └── NOMBRE_DEL_REGISTRO_CLÁSICO
        |           └── BitArray de datos de conteo para el segundo pub
        ├── ...
        ├── ...
        └── ...
    ```
