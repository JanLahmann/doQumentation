...
Como se mencionó antes, una vez que un programa está en estado `RUNNING`, puedes usar `job.logs()` para obtener los registros generados por las salidas de `print()`:
