...
En el nivel 1, introduce un método llamado Twirled Readout Error eXtinction (T-REX). T-REX usa Pauli twirling, como se discutió en la sección de supresión de errores. Como se mencionó, insertar puertas aleatorias en el circuito puede hacer que incluso el ruido muy complicado y difícil de modelar parezca estocástico y sea mucho más fácil de contabilizar o restar en el post-procesamiento.
