...
Como se mencionó anteriormente, para este experimento nos centramos en la puerta RZZ con el ángulo específico -$\pi$ / 2. Como se muestra en el artículo, se puede realizar con una sola puerta $CX$.
