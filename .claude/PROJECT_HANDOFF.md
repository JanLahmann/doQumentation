...
- **Translate `index.mdx` new sections — partial** — ✅ 17 standard locales done (PR #12, commit `354dec580`): de, es, uk, fr, it, pt, ja, tl, ar, he, ms, id, th, ko, pl, ro, cs. Each got the new "When you're ready for more" section with anchor `#when-youre-ready-for-more`, lead paragraph, 3 bullets (Run on real hardware / Latest content / Develop locally), and an italic acknowledgement. **Still TODO**: 9 German/Austrian dialect locales (swg/bad/bar/ksh/nds/gsw/sax/bln/aut) — these need a contributor fluent in each variant.
...
### Resolved (May 2026)
- **Index "When you're ready for more" translations — 17 locales** (May 5, PR #12 `354dec580`) — Translated the new homepage section (introduced by main's `docs/index.mdx` commit `708d5774c`) into de, es, uk, fr, it, pt, ja, tl, ar, he, ms, id, th, ko, pl, ro, cs. Each adds 10 lines (heading + lead + 3 bullets + acknowledgement) just before the locale's `## Getting started` heading. 9 dialect locales (swg/bad/bar/ksh/nds/gsw/sax/bln/aut) deferred — see TODO.
