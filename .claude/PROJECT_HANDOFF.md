...
### TODO
- **Translation expansion** — **All 17 standard locales now at 100% (408/408)** including KO+PL after the May 5 archive-branch merge (DE, ES, FR, IT, UK, JA, AR, PT, TL, HE, MS, ID, TH, CS, RO, KO, PL). Validation pass rates vary: TH/MS/ID/CS still have 13–213 ✗ files needing fixes despite full structural coverage. Run `python translation/scripts/translation-status.py --all` for current counts. German dialects: KSH 46, NDS 43, GSW 42, SAX 39, BLN 36, AUT 34.
