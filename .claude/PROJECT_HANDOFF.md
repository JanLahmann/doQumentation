...
├── i18n/                       # Translations: de/es/fr/it (387 each — 100% complete), uk (56), ja (56), pt/tl (48 each), he (47), ar (44 — 100% tutorials), ksh (46), nds (43), gsw (42), sax (39), bln (36), aut (34), swg/bad/bar (31 each)
...
| AR | [ar.doqumentation.org](https://ar.doqumentation.org) | **44 + UI (100%)** | Live (RTL) |
...
### TODO
- **Translation expansion** — **DE/ES/FR/IT are 100% complete (387/387 each, zero fallbacks)**. **AR 100% tutorials (44/44)**. Structural validation: all 19 locales at 100% PASS for promoted translations. Draft translations (IT batch) in staging for UK (287/331 PASS), JA (283/331), PT (292/339), TL (268/335), AR (291/342) — remaining failures are heading level mismatches, code block differences, and frontmatter issues needing per-file review. German dialects: KSH 46, NDS 43, GSW 42, SAX 39, BLN 36, AUT 34. New locales: MS, ID, TH (all at 0/387 — English fallbacks only). Run `python translation/scripts/translation-status.py` for current counts, or see `translation/STATUS.md`.
...
*Last updated: March 19, 2026 (full validation audit — all 19 locales 100% PASS on promoted translations)*
