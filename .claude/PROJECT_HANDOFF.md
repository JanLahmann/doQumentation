...
- **Video subtitle translations** — 32 YouTube EN transcripts generated (youtube-transcript-api). 8/33 German translations done, 25 remaining. 1 IBM Video EN transcript extracted via Cowork. 26 IBM Video transcripts remaining (use `scripts/video-subtitle-cowork-prompt.md`). After EN transcripts exist, translate via Claude Code agents (small files, no chunking needed).
...
*Last updated: March 28, 2026 (video subtitles with synced transcript panel, Umami analytics, legal page, admin page, 13 locales at 100%, 4 new locales in progress)*
