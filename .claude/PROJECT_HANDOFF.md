...
- **Update features page** — Review and update `/features` page to reflect current state of the project: Code Engine support, IBM Cloud deployment, improved Binder UX, translation infrastructure, and other features added since the page was last updated.
