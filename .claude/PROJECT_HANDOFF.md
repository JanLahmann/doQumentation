...
- **Video subtitle translations — 22 remaining**: 33/55 videos fully translated (EN + 12 languages). 22 IBM Video transcripts have EN only — need translation into ar, de, es, fr, he, it, ja, ko, pt, th, tl, uk. 4 videos have no transcript at all (guide demos, may lack subtitles). See `.claude/transcript-status.md` for full breakdown by course.
...
- **Video subtitles — remaining work**:
  ...
  - **33/55 fully translated** (EN + 12 languages). Squash-merged from `archive/claude/check-translation-status-aXqD6` on 2026-04-03.
  - **22 IBM Video EN-only** — translate via `scripts/translate-transcripts.py` (chunked Sonnet workflow). EN transcripts exist but are untracked.
...
*Last updated: April 3, 2026 (squash-merged 33 video subtitle translations, updated transcript status)*
