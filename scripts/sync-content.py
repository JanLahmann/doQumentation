...
# Generated sidebar JSONs live under a single .generated/ dir (gitignored) so
# they don't clutter the repo root. sidebars.ts requires them from this path and
# falls back to empty/autogenerated if the dir doesn't exist yet (fresh clone).
...
def generate_guides_sidebar():
    ...
    sidebar_json = GENERATED_DIR / "sidebar-guides.json"
...
def generate_sidebar_from_toc():
    ...
    GENERATED_DIR.mkdir(parents=True, exist_ok=True)
    sidebar_json = GENERATED_DIR / "sidebar-generated.json"
    sidebar_json.write_text(json.dumps(sidebar_items, indent=2))
...
def generate_course_sidebar():
    ...
    GENERATED_DIR.mkdir(parents=True, exist_ok=True)
    sidebar_json = GENERATED_DIR / "sidebar-courses.json"
...
def generate_module_sidebar():
    ...
    GENERATED_DIR.mkdir(parents=True, exist_ok=True)
    sidebar_json = GENERATED_DIR / "sidebar-modules.json"
...
def generate_addons_sidebar():
    ...
    GENERATED_DIR.mkdir(parents=True, exist_ok=True)
    sidebar_json = GENERATED_DIR / "sidebar-addons.json"
    sidebar_json.write_text(json.dumps(sidebar_items, indent=2))
