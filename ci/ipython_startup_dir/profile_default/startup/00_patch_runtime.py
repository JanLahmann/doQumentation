...
class _FakeService:
    ...
    def job(self, job_id, *_, **__):
        # Intentionally raise rather than returning a stub: notebooks that
        # depend on cloud job lookup are surfacing a real limitation of
        # local-mode runtime, which is signal we want to report upstream.
        raise RuntimeError(
