...
**Notă:** Ar fi foarte impresionant dacă ai putea concepe un experiment care ar produce rezultate diferite pentru opțiunile lui Einstein și Born; oamenilor le-a luat decenii să conceapă unul.

<Accordion>
<AccordionItem title="Răspuns">

Rămânând la experimentul descris până acum (adică fără spin net cu pozitronul și electronul anti-aliniați), măsurarea ambelor spinuri de-a lungul axelor $\pm x$, $\pm y$ sau $\pm z$ ar produce întotdeauna semne opuse din cauza conservării momentului cinetic, indiferent de care opțiune este corectă. Măsurarea spinului unei particule (să zicem, electronul) de-a lungul unei direcții (să zicem, $+z$) înseamnă că spinul celeilalte particule, pozitronul, ar fi măsurat de-a lungul $-z$. Dacă în schimb măsori spinul pozitronului de-a lungul direcției $x$, va fi la fel de probabil să iasă $+x$ sau $-x$. Acest lucru s-ar putea datora faptului că așa spun instrucțiunile ascunse (opțiunea 1 a lui Einstein) sau pentru că distribuția de probabilitate a spinului pozitronului se actualizează după măsurarea spinului electronului, iar noua distribuție de probabilitate este consistentă cu o împărțire 50-50 între $\pm x$ (opțiunea 2 a lui Born). Aceste puncte sunt explicate mai detaliat mai jos.
...
Restul acestei lecții este dedicat unui experiment care poate distinge între opțiunile lui Einstein și Born, așa că nu vom intra în prea multe detalii aici. Totuși, o parte din truc constă în măsurarea celor două particule de-a lungul unor direcții diferite (precum $x$ și $z$, sau chiar o direcție între axele carteziene tradiționale). Restul provine din luarea în considerare atentă a probabilității precise de a obține rezultate diferite date fiind predicțiile mecanicii cuantice și cele ale informației clasice ca în variabilele ascunse.

</AccordionItem>
</Accordion>

În oricare dintre opțiuni, dacă cei doi observatori, Lucas și Rihanna, măsoară de-a lungul aceleiași axe, ne-am aștepta să obțină spinuri anti-aliniate, indiferent de care opțiune este adevărată. Pentru a înțelege de ce, ia în considerare diagramele de mai jos.
...
Figura de mai sus arată opțiunea lui Einstein. Direcțiile spinurilor sunt opuse și determinate. Dacă măsurăm de-a lungul axei $z$, unul va fi de-a lungul $+z$, iar celălalt de-a lungul $-z$. Nu avem niciun motiv să presupunem că pozitronul ar fi de-a lungul $+z$, iar electronul de-a lungul $-z$; imaginea arată doar că spinurile vor fi măsurate a fi în direcții opuse. De fapt, un spin dat nu trebuie să aibă neapărat efectiv o componentă a spinului său de-a lungul direcției măsurate în cele din urmă, în cazul opțiunii lui Einstein. Cea mai slabă afirmație a opțiunii lui Einstein este că există un anumit set de instrucțiuni stocate în spin care determină care vor fi rezultatele măsurătorilor atunci când sunt măsurate de-a lungul oricărei axe. Nu este necesar să ne imaginăm că aceste instrucțiuni sunt sub forma unui simplu vector (vezi diagrama de mai jos); ne vom întoarce la acest lucru mai târziu.
...
Figura de mai jos arată opțiunea lui Born, în care direcțiile spinurilor pozitronului și electronului sunt împrăștiate într-o distribuție de probabilitate și nu au o direcție definită. Nu citi prea mult în forma distribuției. Fiecare spin ar putea avea de fapt o probabilitate diferită de zero de a indica orice direcție, atâta timp cât sunt opuse unul altuia; le-am desenat pur și simplu ca fracțiuni din cerc pentru a le putea distinge vizual pentru discuție. Reține că, în cazul opțiunii lui Born, este totuși adevărat că momentul cinetic trebuie conservat. Deci, dacă un val de probabilitate este „colapsat” astfel încât spinul să indice de-a lungul $+z$, celălalt va indica de-a lungul $-z$ și va fi deviat în direcția opusă. Opțiunile par identice.
...
Dar ce se întâmplă când observatorii L și R pot măsura de-a lungul oricăreia dintre trei axe, fiecare pereche fiind la 120 de grade distanță, așa cum se arată în Figurile 4 și 5. Fiecare observator poate decide la întâmplare de-a lungul cărei axe va măsura spinul (a, b sau c). Cei doi nu trebuie să măsoare de-a lungul aceleiași axe. Când fiecare observator măsoară, ar putea găsi o proiecție pozitivă pe axa aleasă sau ar putea găsi o proiecție negativă. De exemplu, Lucas și Rihanna ar putea măsura +a și -b sau +b și +c. Reține că, dacă întâmplător aleg să măsoare de-a lungul aceleiași axe, atunci TREBUIE să obțină semne opuse în proiecțiile lor: +a și -a, +b și -b, sau +c și -c; nu pot găsi ambii, de exemplu, +a. În secțiunea următoare, vom parcurge cum să calculăm probabilitatea ca Lucas și Rihanna să obțină același semn pe axele măsurate (++ sau --) și semne opuse (+-) sau (-+).
...
Cele două figuri de mai sus ilustrează posibile interpretări cu variabile ascunse în acest nou scenariu de măsurare cu trei axe. Adică, fie spinurile sunt deja determinate, ca vectori, fie există un set de instrucțiuni fizice cumva încorporate în sistem astfel încât rezultatele tuturor măsurătorilor posibile sunt predeterminate, chiar dacă sunt necunoscute experimentatorilor înainte de măsurare. Alternativa este ilustrată mai jos. Există o anumită distribuție de probabilitate a rezultatelor, iar această distribuție ne poate spune anumite lucruri despre probabilitatea diferitelor rezultate ale măsurătorilor, dar rezultatele sunt nedeterminate de natură înainte de măsurare.
...
Ne putem întreba: „Cât de des ar trebui ca cei doi jucători să găsească același semn al proiecției spinului?” Adică, nici măcar nu înregistrăm de-a lungul cărei axe au ales să măsoare; înregistrăm pur și simplu dacă au găsit același semn sau un semn diferit. Nu este evident dacă opțiunile lui Einstein și Born vor produce același rezultat în această schemă de măsurare mai complicată. Dar ar trebui să fie clar din Figurile 4 și 5 că este $posibil$ să existe o diferență. Pentru cazul arătat în opțiunea lui Einstein, o măsurare a proiecției spinului $e+$ pe axa $a$ va da cu siguranță $+a$, iar proiecția spinului $e-$ pe axa $b$ va da $-b$ (abia). Dar în opțiunea lui Born, posibilitățile sunt larg deschise. Este adevărat că momentul cinetic este încă conservat. Dar, deoarece cele două câmpuri magnetice nu sunt orientate de-a lungul aceleiași axe, forțăm particulele într-o situație în care trebuie să colapseze pe axe diferite (prin interacțiuni cu câmpul). În secțiunea următoare, vom folosi mecanica cuantică pentru a determina care ar trebui să fie probabilitățile, date fiind opțiunea lui Born, ca Lucas și Rihanna să obțină același semn pe axele lor măsurate (++ sau --), și probabilitățile ca ei să obțină semne opuse (+- sau -+).
...
Acum vom folosi o primitivă Qiskit de referință numită StatevectorSampler. Un sampler este o primitivă concepută pentru a eșantiona toate stările posibile ale unui sistem și a returna probabilitățile (sau în unele cazuri, cvasi-probabilitățile) de a obține fiecare stare. Putem specifica un număr de „shots" și ne uităm la „counts" pentru fiecare stare.
...
### Verifică-ți înțelegerea {#check-your-understanding-6}
...
Două particule precum cele pe care le-am descris sunt cumva „conectate" în sensul că măsurătorile asupra uneia pot influența cealaltă. Ne referim la astfel de particule ca fiind „întricate". Întricarea este mai mult decât simple corelații. De exemplu, am putea construi o mașină clasică care aruncă un magnet pe o parte cu capătul nord în sus și un magnet pe cealaltă parte cu capătul nord în jos. Astfel de magneți ar putea fi perfect anti-corelați. Dar o măsurătoare a unuia nu ar face nimic celuilalt. În întricarea cuantică, particula A ar putea fi într-o stare nedefinită (sau un amestec de mai multe stări), iar noi o putem fixa într-o stare definită prin măsurători efectuate asupra unei particule complet diferite (să zicem, B). Nimic de genul acesta nu există în lumea clasică.

Acest lucru deschide adesea o întreagă lume nouă de întrebări și posibilități. Unele dintre ideile pe care le evocă sunt reale, cum ar fi folosirea întricării pentru a computa, ca în calculatoarele cuantice! Altele sunt înșelător de atrăgătoare, dar se dovedesc a eșua, cum ar fi încercarea de a folosi întricarea pentru a transmite informații mai repede decât lumina. Te încurajăm să pui toate întrebările care îți vin în minte și să citești despre cum alții au investigat aceste fenomene. Există o întreagă lume a mecanicii cuantice de explorat, dar iată câteva resurse pe care le-ai putea consulta:
...
- Întricarea este reală și observabilă.

- Întricarea nu este doar corelații.
...
4. A/F Întricarea cuantică este importantă pentru a face corect calculele matematice, dar nu o poți vedea într-un experiment.
...
6. Care dintre următoarele este un poartă cu doi Qubiți?
...
2. Explică cum fenomene cuantice precum întricarea indică faptul că realitatea este non-locală.


3. Ce experimente suplimentare ai dori să faci pentru a te convinge de rezultatele obținute aici?


4. Ar putea fi explorată inegalitatea lui Bell doar cu 3 axe egal distanțate $a$, $b$ și $c$? S-ar putea face cu orice alt număr de axe? Cum ar arăta acest lucru? Ar produce în continuare o diferență în probabilitățile prezise de variabilele ascunse față de mecanica cuantică probabilistă?
