...
2. Urmează aplicarea Gate-ului $U_f$ asupra Qubiților. Acest poartă preia primii $n$ Qubiți ca intrare (care se află acum în o suprapunere egală a tuturor șirurilor posibile de $n$ biți) și aplică funcția $f(x)=s \cdot x$ Qubitului de ieșire, astfel încât acesta se găsește acum în starea: $ |- \oplus f(x)\rangle$. Datorită mecanismului de retroacțiune de fază, starea acestui qubit rămâne neschimbată, dar unii termeni din starea Qubiților de intrare capătă un semn minus:
