...
- Pasul 3: Execută-ți job-ul pe calculatoarele cuantice IBM folosind IBM Quantum primitives
...
Un „Sampler" este o primitivă concepută pentru a eșantiona stările posibile rezultate dintr-un Circuit cuantic și pentru a colecta statistici despre ce stări ar putea fi măsurate și cu ce probabilitate. Importăm aici Sampler-ul IBM Quantum:
...
### Pasul 1: Mapează problema ta pe un circuit cuantic {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Pasul 3: Execuție {#step-3-execute-1}
