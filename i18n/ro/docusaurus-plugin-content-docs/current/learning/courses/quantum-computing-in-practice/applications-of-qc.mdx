...
### Cazul de utilizare 1: Simularea dinamicii hadronilor {#use-case-1-simulating-hadron-dynamics}
...
![Rezultatele simulărilor de hadroni](/learning/images/courses/quantum-computing-in-practice/applications-of-qc/hadron_paper.avif)
...
Ține minte: calculul cuantic nu este potrivit pentru orice problemă. Și, de fapt, acest lucru este doar o dovadă a cât de buni am devenit la calculul clasic. Doar pentru că crezi că ai putea aplica calculul cuantic la o problemă nu înseamnă că va produce rezultate interesante; trebuie să iei în considerare scalarea.

Adâncimea circuitului este o sabie cu două tăișuri. Avem nevoie ca ea să fie considerabil de mare pentru a face lucruri interesante, pe care calculatoarele clasice nu le pot face, dar în prezent nu putem crește prea mult adâncimea, deoarece zgomotul hardware va face ca fidelitatea să scadă. Totul ține de găsirea acelui punct optim, știind totodată că este o țintă mobilă. Așa că ia-ți puțin timp de acum până la lecția următoare pentru a te gândi la o problemă întâlnită în cercetarea ta și la modul în care ai putea să o abordezi cu ceea ce am învățat până acum. Și, hei, s-ar putea ca soluția ta să nu funcționeze, și e în regulă. De aceea se numește cercetare.
