...
- __Efectuarea optimizărilor Circuit-ului__ pentru a reduce adâncimea Circuit-ului și numărul de poartă-uri. Această optimizare poate fi aplicată și mai devreme, pe Circuit-ul virtual înainte ca qubiții să fie atribuiți conexiunilor specifice de hardware.
