...
## Fluxul general de lucru {#general-workflow}
...
### Pasul 1 Qiskit patterns: Mapare {#qiskit-patterns-step-1-map}
...
### Pasul 2 Qiskit patterns: Optimizare {#qiskit-patterns-step-2-optimize}
...
### Pasul 3 Qiskit patterns: Executare folosind primitive {#qiskit-patterns-step-3-execute-using-primitives}
...
### Pasul 4 Qiskit patterns: Post-procesare {#qiskit-patterns-step-4-post-process}
