...
[Descarcă pdf-ul](https://ibm.ent.box.com/s/blnffu0pd7yzxarq3zc3w0jv90365ny2) al prelegerii originale. Rețineți că unele fragmente de cod ar putea deveni depreciate deoarece acestea sunt imagini statice.
...
* **Suprimarea erorilor** prin adăugarea de poartă-uri pe un singur qubit pentru a suprima zgomotul prin decuplare dinamică.
...
### 3.4 Pasul 3. Execuție folosind primitivele IBM Quantum {#34-step-3-execute-using-ibm-quantum-primitives}
