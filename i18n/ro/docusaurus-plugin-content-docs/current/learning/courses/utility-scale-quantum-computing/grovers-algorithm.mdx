...
### Pasul 2: Optimizare pentru hardware-ul țintă {#step-2-optimize-for-target-hardware-1}
...
### Pasul 3: Executarea circuitului. {#step-3-executing-the-circuit-1}
...
### Pasul 4: Post-procesarea rezultatelor. {#step-4-post-processing-the-results-1}
