...
## 3. Exercițiul 1. Efectuarea simulării cu Suzuki–Trotter de ordinul doi {#3-exercise-1-perform-simulation-using-second-order-suzukitrotter}
...
### 3.3 Reprezentarea grafică a rezultatelor Suzuki–Trotter de ordinul doi {#33-plot-the-second-order-suzukitrotter-results}
...
### 4.3 Pasul 3. Execuția cu primitivele IBM Quantum {#43-step-3-execute-with-ibm-quantum-primitives}
