...
Poți seta opțiunile de supresie a erorilor în Sampler V2. Consultă ghidul [Sampler noise management](/guides/sampler-noise-management) și referința API [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) pentru mai multe informații.
...
- Ar trebui să execuți circuitul GHZ folosind funcția `execute_ghz_fidelity` și să calculezi fidelitatea folosind funcția `check_ghz_fidelity_from_jobs`.
Trebuie să găsești cel mai mare circuit GHZ cu qubiți care îndeplinește criteriile. Scrie codul tău mai jos, arată rezultatul cu funcția `check_ghz_fidelity_from_jobs` .
...
Felicitări pentru finalizarea acestui curs! Te rog să îți iei un moment pentru a ne ajuta să îmbunătățim cursul nostru completând următorul [sondaj rapid](https://your.feedback.ibm.com/jfe/form/SV_5vvmdT5yFFetkgK). Feedback-ul tău va fi folosit pentru a îmbunătăți oferta noastră de conținut și experiența utilizatorului. Mulțumim!
