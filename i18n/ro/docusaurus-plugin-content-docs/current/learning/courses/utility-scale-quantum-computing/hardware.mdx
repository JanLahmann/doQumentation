...
## 2. Backend și Target {#2-backend-and-target}
...
### 2.2 Harta de cuplare {#22-coupling-map}
...
## 3. Proprietățile qubiților {#3-qubit-properties}
...
###  3.2 Erorile Gate-urilor și ale citirilor {#32-gate-and-readout-errors}
