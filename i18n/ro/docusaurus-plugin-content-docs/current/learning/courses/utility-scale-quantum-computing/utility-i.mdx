...
## 1. Introducere în lucrarea de utilitate {#1-introduction-to-the-utility-paper}
...
### 1.1 Obiectivul tău {#11-your-goal}
...
## 2. Pregătire {#2-preparation}

### 2.1 Construiește RZZ(-$\pi$ / 2) {#21-construct-rzz-pi-2}

Mai întâi, observă că poarta RZZ necesită, în general, două porți $CX$.
...
După cum s-a menționat mai sus, ne concentrăm pe poarta RZZ cu un unghi specific, -$\pi$ / 2, pentru acest experiment.  Așa cum se arată în articol, poate fi realizată cu o singură poartă $CX$.
...
Definim o poartă în termenii acestui circuit pentru referință viitoare.
...
### 2.2 Colorează harta de cuplare {#22-color-the-coupling-map}
...
## 3. Rezolvă evoluția temporală Trotterizată a unui model Ising 2D. {#3-solve-the-trotterized-time-evolution-of-a-2d-ising-model}
...
## 4. Rezolvă versiunea cu 27 de qubiți a problemei. {#4-solve-the-27-qubit-version-of-the-problem}
...
### 4.1 Pasul 1: Mapare {#41-step-1-map}
...
### 4.2 Pașii 2 și 3: Optimizare și Execuție (Simulator) {#42-steps-2-and-3-optimize-and-execute-simulator}
...
### 4.3 Pașii 2 și 3: Optimizare și execuție (dispozitiv fals) {#43-steps-2-and-3-optimize-and-execute-fake-device}
...
### 4.4 Pasul 4: Post-procesare {#44-step-4-post-process}
...
## 5. Rezolvă versiunea cu 127 de qubiți a problemei {#5-solve-the-127-qubit-version-of-the-problem}
...
### 5.1 Pasul 1: Mapare {#51-step-1-map}
...
### 5.2 Pașii 2 și 3: Optimizare și execuție {#52-steps-2-and-3-optimize-and-execute}
...
### 5.3 Post-procesare {#53-post-process}
