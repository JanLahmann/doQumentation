...
### Estimarea valorii $r_z$ {#estimate-r-z-value}
...
### Exercițiul 1: Estimarea valorii $r_x$ {#exercise-1-estimate-r-x-value}
...
### Exercițiul 2: Estimarea valorii $r_y$ {#exercise-2-estimate-r-y-value}
