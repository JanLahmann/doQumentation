...
Poți vedea că statul cuantic creat de poartă-ul $U$ al qubit-ului 0 (qubit-ul care deținea inițial statul secret) a fost transferat la qubit-ul 2 (qubit-ul lui Bob).
...
Ca memento, aplicarea inversului Gate-ului $U$ este doar pentru a putea verifica comportamentul așteptat. Nu face parte din trimiterea statului lui Bob, și nu am folosi acel poartă $U$ invers dacă singurul scop ar fi transferul informației cuantice.
