...
![O imagine cu orbitalii atomici și o imagine a unei rețele cu multe noduri și conexiuni între ele.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig1.svg)
...
![O imagine a unui Circuit cuantic cu parametri variaționali etichetați "theta".](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig2.svg)
...
![O imagine care arată o linie curbată reprezentând energia, cu mai multe puncte la care valoarea este testată pentru a găsi minimul.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig3.svg)
...
![Un tabel cu diferite șiruri Pauli, unele dintre care comutează și altele care nu.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig4.svg)
...
![Două imagini ale unei linii curbate cu o valoare minimă. În una, punctele sunt verificate aleatoriu în căutarea unui minim, în cealaltă un gradient este estimat desenând o linie între două puncte adiacente.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig5.svg)
...
* Adesea se folosesc recuperarea configurației [\[16\]](#references) și postselectarea simetriei [\[15\]](#references) ca tehnică de post-procesare.
