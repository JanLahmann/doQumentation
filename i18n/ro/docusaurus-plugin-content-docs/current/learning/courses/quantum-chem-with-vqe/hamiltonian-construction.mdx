...
Hamiltonianul fermionic este scris în termeni de operatori fermionici și, în particular, ține cont de faptul că electronii sunt fermioni indistinguibili. Asta înseamnă că respectă statistici complet diferite față de qubiții distingebili, bosonici. De aceea este nevoie de procesul de mapare.
