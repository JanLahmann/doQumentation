...
__basis__ se referă la funcțiile folosite pentru a modela orbitalii moleculari. Aici 'sto-6g' este o bază minimă comună, denumită pentru potrivirea orbitalilor de tip Slater folosind 6 orbitali gaussieni primitivi.
