...
Fals. Majoritatea problemelor de învățare automată sunt rezolvate foarte eficient de algoritmii clasici, iar algoritmii cuantici nu sunt susceptibili să ofere o accelerare substanțială. Scopul în QML este de a găsi seturi de date cu caracteristici bine descrise de stări cuantice și/sau de a găsi mapări ale caracteristicilor datelor care optimizează acuratețea modelelor.
...
5. Implementeze metode de nucleu cuantic și clasificatori cuantici variaționali folosind primitivele IBM Quantum și urmând tiparele Qiskit.
...
* Pasul 3: Execută folosind primitivele IBM Quantum
...
În procesul de mai sus, am calculat o intrare a matricei kernel pentru al 14-lea și al 19-lea punct de date. Ce valoare ar trebui să obținem dacă folosim același punct de date de două ori, aici (precum al 14-lea și din nou al 14-lea)? Cu alte cuvinte, care ar trebui să fie intrările diagonale din matricea kernel? Răspunde la această întrebare în absența zgomotului, dar reține că sunt posibile abateri de la răspunsul tău în prezența zgomotului.

<Accordion>
<AccordionItem title="Răspuns">

Diagonalele ar trebui să fie 1.0. Acest proces ar trebui să calculeze produsul scalar normalizat al unui vector cu el însuși, care trebuie să fie întotdeauna unu.
