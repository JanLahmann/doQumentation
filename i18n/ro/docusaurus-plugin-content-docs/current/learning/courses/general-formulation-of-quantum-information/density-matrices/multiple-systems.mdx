...
3. *Stări separabile*. Ne putem imagina situații în care avem o corelație clasică între stările cuantice ale două sisteme, astfel:
   ...
   Cu alte cuvinte, pentru fiecare $k$ de la $0$ la $m-1$, avem că, cu probabilitatea $p_k$, sistemul din stânga este în starea $\rho_k$ iar sistemul din dreapta este în starea $\sigma_k$. Stările de acest fel se numesc *stări separabile*. Acest concept poate fi extins și la mai mult de două sisteme.
...
În termeni de matrice bloc de o formă similară cu cea de dinainte, avem această formulă.
...
Pentru a încheia lecția, să aplicăm aceste formule aceleiași stări pe care am considerat-o mai sus.
...
iar starea redusă a celui de-al doilea sistem $\mathsf{B}$ este
