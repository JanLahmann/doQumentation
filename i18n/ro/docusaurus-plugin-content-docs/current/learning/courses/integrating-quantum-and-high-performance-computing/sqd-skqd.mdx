...
SQD a fost deja utilizat pentru a estima energia de disociere a stării fundamentale a N$_2$ și proprietățile electronice ale clusterilor [2Fe-2S] și [4Fe-4S] [[2]](#references), cu circuite de până la 77 de qubiți și 10.570 de poartă-uri.
...
În experimente, SKQD a fost utilizat cu până la 70 de qubiți și mii de poartă-uri pentru a studia starea fundamentală a unor modele Anderson complexe cu 4 impurități, obținând o concordanță excelentă cu metode clasice de ultimă generație, precum DMRG.[[1]](#references)
