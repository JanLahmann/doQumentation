...
În calculul cuantic, se face referire la un „strat" de poartă-uri care pot fi executate simultan. În multe aplicații este util să se efectueze un set de rotații pe toți qubiții și apoi Gate-uri de entanglare între perechi de qubiți. În aceste contexte, se face referire la un „strat de rotație" (un strat de poartă-uri precum `R_x`, `R_y` și/sau `R_z`) și un „strat de entanglare" (cum ar fi unul cu Gate-uri `CNOT`). Numărul de straturi dintr-un Circuit este „adâncimea circuitului", o măsură importantă deoarece o adâncime mai mare înseamnă mai multe straturi de zgomot și erori cumulative.
