...
- Noțiunile de bază ale decuplării dinamice, atenuării erorilor de măsurare, twirling-ului de Gate-uri și extrapolării la zgomot zero, descrise în acest [ghid](/guides/error-mitigation-and-suppression-techniques).
...
- 2 : Se implementează twirling-ul de Gate-uri, atenuarea erorilor de măsurare și ZNE.
...
Circuitul transpilat conține acum doar instrucțiuni ISA. Toate Gate-urile au fost descompuse în termeni de Gate-uri $\sqrt{X}$ și rotații $R_z$, și [Gate-uri CZ](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.library.CZGate).
