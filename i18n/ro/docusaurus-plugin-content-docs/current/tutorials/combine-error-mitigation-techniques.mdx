---
description: 'Combină opțiunile de atenuare a erorilor pentru experimente la scară de utilitate folosind QPU-uri IBM Quantum cu 100+ qubiți și primitiva IBM Quantum Estimator.'
...
Acest tutorial explorează opțiunile de suprimare și atenuare a erorilor disponibile cu primitiva IBM Quantum Estimator. Acest tutorial arată cum să implementezi individual fiecare dintre următoarele metode:
...
#### Circuit oglindă {#mirror-circuit}
...
Aici vei trimite cinci joburi separate, începând fără nicio suprimare sau atenuare a erorilor, și activând succesiv diverse opțiuni de suprimare și atenuare a erorilor disponibile în IBM Quantum Compute Service. Pentru informații despre opțiuni, consultă următoarele pagini:
...
Deoarece aceste joburi pot rula independent unele de altele, poți folosi [modul batch](/guides/run-jobs-batch) pentru a permite Quantum Compute să optimizeze momentul execuției lor.
...
## Exemplu pe hardware la scară largă {#large-scale-hardware-example}
...
- Toate experimentele dau rezultate mai aproape de valoarea ideală și toate barele de eroare sunt mai mici.

- Adăugarea decuplării dinamice ar fi putut înrăutăți performanța față de cazul fără mitigare. Acest lucru nu este surprinzător, deoarece circuitul este foarte dens. Decuplarea dinamică este utilă în principal atunci când există goluri mari în circuit, în care qubiții stau inactivi fără ca Gate-uri să li se aplice. Când aceste goluri nu există, decuplarea dinamică nu este eficientă și poate chiar înrăutăți performanța din cauza erorilor din pulsurile de decuplare dinamică în sine. Este posibil ca circuitul de 10 qubiți să fi fost prea mic pentru a observa acest efect.

- Cu extrapolarea zero-zgomot, rezultatul este foarte aproape de valoarea ideală. Aceasta demonstrează puterea ZNE.


## Pași următori {#next-steps}
<Admonition type="tip" title="Recomandări">
Dacă ați găsit această lucrare interesantă, s-ar putea să vă intereseze următorul material despre câteva tehnici suplimentare de atenuare și suprimare a erorilor care nu au fost menționate în acest tutorial:
...
- [Matrix-free Measurement Mitigation (M3)](https://qiskit.github.io/qiskit-addon-mthree/) (consultați și tutorialul [Readout error mitigation for the Sampler primitive using M3](/tutorials/readout-error-mitigation-sampler/))
