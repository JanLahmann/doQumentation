...
* Cunoștințe de bază despre [Qiskit SDK](https://docs.quantum.ibm.com/guides) și [Qiskit Runtime](/guides/compute-services#qiskit-runtime), și acces la un [cont IBM Quantum&reg;](/guides/cloud-setup).
## Fundal {#background}
...
Înainte de a rula pe QPU-ul real, verificăm că atât circuitele dinamice, cât și cele unitare produc o stare Bell ideală pe un simulator fără zgomot. Folosim Qiskit Runtime `Sampler` cu `AerSimulator` ca mod de backend, la o distanță mică de 6.
...
Acum că am construit atât circuitele dinamice, cât și cele unitare pentru un exemplu la scară mică cu `distance=6`, le transpilăm mai întâi pentru a rula pe un simulator fără zgomot.
...
Generăm acum circuite CX cu rază lungă pentru o gamă de separații între qubiți de până la 60 de qubiți distanță. Pentru fiecare distanță, construim circuite care măsoară în bazele $XX$, $YY$ și $ZZ$, care vor fi folosite ulterior pentru a calcula fidelitățile.
