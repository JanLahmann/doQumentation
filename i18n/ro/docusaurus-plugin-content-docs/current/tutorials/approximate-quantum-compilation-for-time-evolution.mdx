...
* Qiskit SDK v2.0 sau mai nou, cu suport pentru [vizualizare](https://docs.quantum.ibm.com/api/qiskit/visualization)
...
Această secțiune folosește un sistem cu 10 site-uri pentru a ilustra fluxul de lucru AQC-Tensor pas cu pas. Simulăm dinamica unui lanț de spin XXZ cu 10 site-uri, un model larg studiat pentru examinarea interacțiunilor de spin și a proprietăților magnetice.
