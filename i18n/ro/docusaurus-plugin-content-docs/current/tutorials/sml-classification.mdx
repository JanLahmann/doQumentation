...
> **Notă:** Acest sondaj este oferit de **IBM Quantum** și se referă la **conținutul tutorialului** (scris de IBM). doQumentation oferă site-ul web, traducerile și executarea codului — pentru feedback despre acestea, te rog să [deschizi un issue pe GitHub](https://github.com/JanLahmann/doQumentation/issues).
