...
pe QPU-urile IBM&reg; folosind QUICK-PDE, dată de:
...
procesul de rezolvare și soluția. Pentru această alegere a condiției inițiale,
ecuația admite următoarea soluție analitică:

$$u(t, x) = \frac{ax + b}{at + 1},$$

care este valabilă atâta timp cât nu s-a format niciun șoc, adică pentru $t < -1/a$ când $a < 0$.
