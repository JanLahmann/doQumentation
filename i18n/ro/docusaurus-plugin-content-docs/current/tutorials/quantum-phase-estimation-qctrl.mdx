...
În acest tutorial, ilustrăm QPE pentru a recupera eigenphase-ul unui unitar monoQubit cunoscut. Unitarul a cărui fază vrem să o estimăm este poartă-ul de fază monoQubit aplicat qubitului țintă:
