...
Opțiunile personalizate pentru cel care învață zgomotul pot fi de asemenea transmise. Acestea urmează definițiile utilizate în `qiskit-ibm-runtime` [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options):
