...
> **Notă:** Acest sondaj este oferit de **IBM Quantum** și acoperă **conținutul tutorialului** (scris de IBM). doQumentation oferă site-ul web, traducerile și execuția codului — pentru feedback cu privire la acestea, te rugăm să [deschizi un issue pe GitHub](https://github.com/JanLahmann/doQumentation/issues).
