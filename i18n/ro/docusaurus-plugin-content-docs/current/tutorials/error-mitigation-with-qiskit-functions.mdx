...
Trebuie să fim atenți la modul în care proiectăm straturile circuitului nostru. Vom face acest lucru prin colorarea muchiilor hărții de cuplare (adică, gruparea muchiilor disjuncte) și vom folosi acea colorare pentru a plasa mai eficient porțile în Circuit. Aceasta va conduce la un circuit mai puțin adânc, cu straturi de poartă-uri care pot fi executate simultan pe hardware.
...
Rezultatul rulării funcției are același format ca cel al [Estimator-ului](/guides/estimator-input-output).
