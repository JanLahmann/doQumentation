...
Acest tutorial demonstrează cum să rulezi un experiment de atenuare a erorilor la scară utilitară cu Qiskit Runtime, folosind o versiune experimentală a *extrapolării zgomotului zero* (ZNE) cu *amplificarea probabilistică a erorilor* (PEA).
...
**Referință**: Y. Kim et al. *Evidence for the utility of quantum computing before fault tolerance.* [Nature 618.7965 (2023)](https://www.nature.com/articles/s41586-023-06096-3)
...
#### Amplificarea zgomotului pentru ZNE {#amplificarea-zgomotului-pentru-zne}
...
### Învățarea modelului de zgomot pentru PEA {#invatarea-modelului-de-zgomot-pentru-pea}
...
##### Definirea cuplajelor stratului de înlănțuire {#definirea-cuplajelor-stratului-de-inlantuire}
...
##### Eliminarea qubiților defectuoși {#eliminarea-qubitsilor-defectuosi}
...
##### Generarea principalului Circuit Trotter {#generarea-principalului-circuit-trotter}
...
#### Crearea unei liste de valori de parametri pentru atribuire ulterioară {#crearea-unei-liste-de-valori-de-parametri-pentru-atribuire-ulterioara}
