...
__Referință__: Y. Kim et al. *Evidence for the utility of quantum computing before fault tolerance.* [Nature 618.7965 (2023)](https://www.nature.com/articles/s41586-023-06096-3)
...
__Referință__: E. van den Berg, Z. Minev, A. Kandala, and K. Temme, _Probabilistic error cancellation with sparse Pauli-Lindblad models on noisy quantum processors_ [arXiv:2201.09866](https://arxiv.org/abs/2201.09866)
## Cerințe {#cerinte}
...
### Crearea unui Circuit Ising parametrizat {#crearea-unui-circuit-ising-parametrizat}
...
#### Funcții ajutătoare pentru construirea Circuit-ului {#functii-ajutatoare-pentru-construirea-circuit-ului}
...
Observă că fiecare observable este învelit într-o listă în blocul de cod următor. Acest lucru este necesar pentru a realiza _broadcasting_ cu valorile parametrilor, astfel încât fiecare observable de qubit să fie măsurat pentru fiecare valoare theta. Regulile de broadcasting pentru primitive pot fi găsite [aici](/guides/primitives).
...
* __amplifier__: Metoda utilizată pentru amplificarea zgomotului la factorii de zgomot doriți.
    ...
    pentru straturi de porți de bază cu doi qubiți twirled. Există de asemenea opțiunile `"gate_folding_front"` și `"gate_folding_back"` care sunt explicate în [documentația API](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-zne-options#amplifier)
* __extrapolated_noise_factors__: Specifică una sau mai multe valori de factori de zgomot la care se evaluează
...
![Rezultatul celulei de cod anterioare](/docs/images/tutorials/probabilistic-error-amplification/extracted-outputs/2e0f0e84-32ba-4655-91c1-8445016bbeb2-0.avif)
...
![Rezultatul celulei de cod anterioare](/docs/images/tutorials/probabilistic-error-amplification/extracted-outputs/6948475c-bc15-493f-8af9-f8e66d0e467c-0.avif)

## Sondaj tutorial {#tutorial-survey}

Te rugăm să completezi acest scurt sondaj pentru a oferi feedback cu privire la acest tutorial. Opiniile tale ne vor ajuta să îmbunătățim conținutul și experiența utilizatorilor.
