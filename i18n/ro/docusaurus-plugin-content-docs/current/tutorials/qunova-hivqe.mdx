...
Calculele HiVQE vor fi efectuate cu opțiunile definite mai jos. Folosind baza sto3g pentru $Li_2S$, există 19 orbitali spațiali cu 22 de electroni. Pentru a rula cazul (10o,10e) cu calculul HiVQE, poți defini 10 orbitali activi și șase orbitali înghețați. La fiecare iterație, 100 de măsurători vor fi folosite pentru a eșantiona configurația de electroni generată de circuitul cuantic ExcitationPreserving (`epa`) cu entanglement `circular` și două repetări (`reps`). Numărul maxim de iterații este setat la 30 pentru a garanta terminarea iterației la convergența energiei.
...
### Reprezentarea grafică a curbei de disociere pentru Li\_2S {#plotting-the-dissociation-curve-for-li_2s}
...
Rețineți că pentru a rula funcția pe sistemul FeP-NO cu setările prezentate în acest exemplu, aveți nevoie de o licență care să permită utilizarea funcției cu cel puțin 44 de qubiți. Trimiteți un e-mail la [qiskit.support@qunovacomputing.com](mailto:qiskit.support@qunovacomputing.com) pentru a solicita informații despre obținerea unei licențe.
...
### Pașii 2 și 3: Optimizarea problemei pentru execuție pe hardware cuantic și execuția folosind funcția HiVQE Chemistry {#step-2-and-3-optimize-problem-for-quantum-hardware-execution-and-execute-using-the-hivqe-chemistry-function}
...
[Link spre sondaj](https://your.feedback.ibm.com/jfe/form/SV_9AizRyKFHEGzVs2)
