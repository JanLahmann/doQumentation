...
După ce joburile s-au finalizat, putem recupera durata circuitului din metadatele rezultatelor jobului și vizualiza informațiile despre planificarea circuitului. Pentru a citi mai multe despre vizualizarea informațiilor de planificare ale unui circuit, consultă [această pagină](/guides/qiskit-runtime-circuit-timing).
