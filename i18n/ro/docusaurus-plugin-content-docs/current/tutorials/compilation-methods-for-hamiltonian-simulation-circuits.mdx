...
În practică, erorile de poartă se acumulează pe tot parcursul circuitului, astfel încât probabilitatea de a recupera $|0\rangle^{\otimes n}$ scade. O metodă de compilare care produce un circuit mai superficial cu mai puține porți va acumula mai puțin zgomot.
