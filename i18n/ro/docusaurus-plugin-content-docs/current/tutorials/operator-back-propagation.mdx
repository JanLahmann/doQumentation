...
- [Compilare cuantică aproximativă pentru circuite de evoluție în timp](/tutorials/approximate-quantum-compilation-for-time-evolution)
- [Formule multi-produs pentru reducerea erorii Trotter](/tutorials/multi-product-formula)
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop), un pachet accelerat cu Rust pentru propagarea Pauli, cu tutoriale acoperind OBP, estimarea clasică a valorii de așteptare și simularea zgomotoasă
</Admonition>
