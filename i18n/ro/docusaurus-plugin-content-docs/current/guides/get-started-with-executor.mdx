---
description: 'Cum să folosești primitiva Executor din qiskit-ibm-runtime.'
...
Deoarece IBM Quantum Compute Service este un serviciu gestionat, trebuie mai întâi să îți inițializezi contul. Poți apoi selecta QPU-ul pe care dorești să îl folosești pentru a calcula valoarea de așteptare.
...
Rezultatul este de tipul [`QuantumProgramResult`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/results-quantum-program-result). Consultă [Intrarea și ieșirea Executor](/guides/executor-input-output) pentru a afla despre obiectul rezultat.
