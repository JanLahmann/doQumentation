...
Argumentul `fold` stabilește o lățime maximă pentru rezultat. În randerul `text`, acesta setează lungimea liniilor diagramei înainte ca aceasta să fie trecută pe linia următoare. Când folosești randerul 'mpl', acesta reprezintă numărul de straturi (vizuale) înainte de a trece pe linia următoare.
