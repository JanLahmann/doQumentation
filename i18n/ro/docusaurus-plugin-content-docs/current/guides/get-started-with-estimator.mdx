---
description: 'Un ghid de inițiere rapidă despre cum să folosești primitivul IBM Quantum Estimator.'
...
### 3. Inițializarea IBM Quantum Estimator {#3-initialize-the-ibm-quantum-estimator}
