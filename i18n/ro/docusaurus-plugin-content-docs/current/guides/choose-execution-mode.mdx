---
description: 'Alege modul de execuție potrivit pentru sesiuni IBM Quantum Compute, batch sau joburi individuale.'
title: 'Alege modul de execuție potrivit'
---

{/* doqumentation-source-hash: 68cf35ad */}
...
- **Batch**
   ...
   - Dacă îți partiționezi sarcina de lucru în mai multe joburi și le rulezi în modul batch, poți obține rezultate din joburi individuale, ceea ce le face mai flexibile. De exemplu, dacă rezultatele unui job nu corespund așteptărilor tale, poți anula joburile rămase. De asemenea, dacă un job eșuează, îl poți retrimite în loc să rulezi din nou întreaga sarcină de lucru.
...
În acest caz, dacă ai folosi modul job sau batch, fiecare job generat la pasul (2) ar trebui să treacă din nou prin coadă. Aceasta crește dramatic durata experimentului (timpul real, wall-clock) din cauza timpului de așteptare în coadă. De asemenea, ar putea dura mai mult până la convergență din cauza derivei dispozitivului. Adică, fiecare iterație ar trebui să îți ofere un rezultat mai bun, dar deriva dispozitivului ar putea face ca rezultatele ulterioare să fie mai slabe.
...
În acest caz, toate joburile (care sunt corelate, dar independente) sunt disponibile de la început. Dacă folosești modul batch, acestea sunt programate colectiv, deci trebuie să aștepți să treacă prin coadă o singură dată. În plus, deoarece scopul este de a compara efectele diferitelor metode de atenuare a erorilor, este util ca ele să ruleze cât mai apropiat în timp. Astfel, batch ar fi o alegere bună. _Ai putea_ rula aceste joburi într-o sesiune, dar deoarece sesiunile sunt în general mai costisitoare, se recomandă să folosești batch ori de câte ori nu ai nevoie de funcționalitatea suplimentară pe care o oferă sesiunile.
