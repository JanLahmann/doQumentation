...
Acest șablon încapsulează un flux de lucru pentru a simula evoluția în timp a unei stări inițiale față de un Hamiltonian bazat pe spin definit de utilizator și returnează un set de valori de așteptare specificate, folosind [AQC-Tensor](https://qiskit.github.io/qiskit-addon-aqc-tensor/) addon-ul Qiskit.
...
Mai întâi, scrie un șablon de funcție pentru simularea Hamiltonian care folosește [addon-ul AQC-Tensor Qiskit](https://qiskit.github.io/qiskit-addon-aqc-tensor/) pentru a mapa descrierea problemei la un circuit de adâncime redusă pentru execuție pe hardware.

Dacă descarci această pagină și o vizualizezi local într-un editor de notebook-uri, vei vedea că unele celule de cod conțin [comanda magic](https://ipython.readthedocs.io/en/stable/interactive/magics.html#cellmagic-writefile) `%%writefile`. Această comandă magic salvează codul în `./source_files/template_hamiltonian_simulation.py`, care este șablonul de funcție pe care îl poți încărca și rula de la distanță cu Qiskit Serverless.
...
<Accordion>
<AccordionItem title="**Codul sursă complet al programului**">
