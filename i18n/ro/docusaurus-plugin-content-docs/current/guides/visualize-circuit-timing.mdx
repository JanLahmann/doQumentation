...
## Suport Qiskit Runtime {#qiskit-runtime-support}
...
### Activarea recuperării datelor de cronologie {#enable-timing-data-retrieval}
...
### Accesarea datelor de cronologie ale Circuit-ului {#access-the-circuit-timing-data}
...
#### Înțelegerea datelor brute de cronologie {#understand-the-raw-timing-data}
...
### Vizualizarea cronologiilor {#visualize-the-timings}
...
#### Înțelegerea figurii generate {#understand-the-generated-figure}
...
### Exemplu complet {#end-to-end-example}

Acest exemplu îți arată cum să activezi opțiunea, să obții informațiile de sincronizare ale Circuit-ului din metadate și să le afișezi ca imagine.

Mai întâi, configurează mediul, definește Circuit-urile și convertește-le în circuite ISA, apoi definește și trimite job-urile.
...
Apoi, obține sincronizarea programului Circuit-ului:
...
În final, poți vizualiza și salva sincronizarea:
...
<Admonition type="tip" title="Recomandări">
  - [Feedforward clasic și fluxul de control](/guides/classical-feedforward-and-control-flow) (circuite dinamice)
  - [Vizualizează Circuit-urile](/guides/visualize-circuits)
</Admonition>
