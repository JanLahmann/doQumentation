---
title: "Exemple Estimator"
sidebar_label: "Exemple Estimator"
description: "Exemple practice de folosire a primitivei Estimator în Qiskit Runtime."
...
Exemplele din această secțiune ilustrează câteva moduri comune de a folosi Estimator. Înainte de a rula aceste exemple, urmează instrucțiunile din [Instalează Qiskit.](install-qiskit)

<Admonition type="note">
Toate aceste exemple folosesc primitivele din Qiskit Runtime, dar ai putea folosi în schimb primitivele de bază.
</Admonition>

Calculează și interpretează eficient valorile de așteptare ale operatorilor cuantici necesari pentru mulți algoritmi cu Estimator. Explorează utilizările în modelarea moleculară, învățarea automată și problemele complexe de optimizare.
...
Folosește Estimator pentru a rula trei experimente într-un singur job, valorificând valorile de parametri pentru a crește reutilizabilitatea circuitului.
...
## Folosește batch-uri și opțiuni avansate {#use-batches-and-advanced-options}

Explorează [modul de execuție](/guides/execution-modes) batch și opțiunile avansate pentru a optimiza performanța circuitelor pe QPU-uri.
...
- Exersează cu primitivele lucrând prin [lecția despre funcțiile de cost](/learning/courses/variational-algorithm-design/cost-functions) din IBM Quantum&reg; Learning.
- Află cum să transpilezi local în secțiunea [Transpilare](/guides/transpile/).
- Încearcă ghidul [Compară setările transpilerului](/guides/circuit-transpilation-settings).
- Citește [Migrează la primitivele V2](/guides/v2-primitives).
- Înțelege [Limitele joburilor](/guides/job-limits) atunci când trimiți un job la un QPU IBM&reg;.
</Admonition>
