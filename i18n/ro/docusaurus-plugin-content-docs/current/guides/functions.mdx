...
- [Explorează Circuit functions](/guides/algorithmiq-tem) pentru a construi algoritmi și aplicații noi, fără a fi nevoie să gestionezi transpilarea sau tratarea erorilor.
