---
description: 'Răspunsuri la întrebările frecvente despre modurile de execuție'
...
<Accordion>
  <AccordionItem title="Modul de testare locală `qiskit-ibm-runtime` acceptă diferite moduri de execuție?">
