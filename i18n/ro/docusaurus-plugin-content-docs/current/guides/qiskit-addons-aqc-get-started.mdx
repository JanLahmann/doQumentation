...
# Introducere în compilarea cuantică aproximativă cu rețele tensoare (AQC-Tensor) {#getting-started-with-approximate-quantum-compilation-with-tensor-networks-aqc-tensor}
{/*
