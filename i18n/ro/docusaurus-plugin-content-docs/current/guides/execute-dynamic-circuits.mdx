---
description: 'Folosește IBM Quantum Compute Service pentru feedforward clasic și control flow, altfel cunoscut ca circuite dinamice'
...
## Limitările Quantum Compute {#quantum-compute-limitations}

Fii conștient de următoarele constrângeri atunci când rulezi circuite dinamice în Quantum Compute.
...
- Consultă [tabelul de funcționalități OpenQASM 3](/guides/qasm-feature-table) pentru a determina ce funcționalități OpenQASM 3 sunt suportate în Qiskit și Quantum Compute.

- Când OpenQASM 3 (în loc de `QuantumCircuit`) este folosit ca format de intrare pentru a transmite circuite la primitivele IBM Quantum, sunt suportate doar instrucțiunile care pot fi încărcate în Qiskit. Operațiile clasice, de exemplu, nu sunt suportate deoarece nu pot fi încărcate în Qiskit. Consultă [Importă un program OpenQASM 3 în Qiskit](/guides/interoperate-qiskit-qasm3#import-an-openqasm-3-program-into-qiskit) pentru mai multe informații.
...
1. Grupează termenii tuturor observabililor într-o partiție. Acest lucru se poate face folosind [API-ul `PauliList`](https://docs.quantum.ibm.com/api/qiskit/qiskit.quantum_info.PauliList#group_qubit_wise_commuting), de exemplu.
     <Admonition type="note">
      Poți folosi atributul primitiv [`BitArray`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.BitArray#expectation_values) pentru a calcula valorile de așteptare ale observabililor furnizați.
     </Admonition>
...
- Nu toate funcțiile sunt compatibile cu circuitele dinamice. Verifică secțiunea de compatibilitate a funcționalităților pentru [Sampler](/guides/sampler-options#feature-compatibility) pentru detalii.
</Admonition>
