---
description: 'Cum să rulezi joburi de calcul cuantic în modul batch folosind IBM Quantum Compute Service.'
...
Înainte de a porni un batch, trebuie să [configurezi clientul IBM Quantum Compute](/guides/install-qiskit) și să îl inițializezi ca serviciu:
...
Pentru o prezentare completă a configurației și stării unui batch, inclusiv TTL-ul interactiv și maxim, folosește metoda `batch.details() method`.
