...
# Introducere în OpenQASM {#introduction-to-openqasm}
...
Pe măsură ce nevoile dezvoltării QPU-urilor au evoluat, lista de funcționalități a OpenQASM s-a extins în consecință; cea mai recentă versiune, [OpenQASM 3,](https://arxiv.org/abs/2104.14722) incorporează extensii precum controlul fluxului cu feed-forward clasic, modificatori de poartă și implementări la nivel de puls.
