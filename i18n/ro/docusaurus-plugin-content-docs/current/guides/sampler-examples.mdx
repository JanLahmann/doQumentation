---
description: 'Exemple practice de utilizare a primitivei Sampler IBM Quantum.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Exemple Sampler'
title: 'Exemple Sampler'
---
...
Folosește Sampler pentru a returna rezultatul măsurătorii sub formă de șiruri de biți sau numărări ale unui singur circuit.
...
Folosește Sampler pentru a returna rezultatul măsurătorii sub formă de șiruri de biți sau numărări ale mai multor circuite într-un singur job.
...
Rulează mai multe experimente într-un singur job, valorificând valorile parametrilor pentru a crește reutilizabilitatea circuitelor.
...
Explorează [modul de execuție](/guides/execution-modes) în batch și opțiunile avansate pentru a optimiza performanța circuitelor pe QPU-uri.
...
- [Specifică opțiunile avansate de runtime](runtime-options-overview).
- Exersează cu primitivele parcurgând [lecția de funcție cost](/learning/courses/variational-algorithm-design/cost-functions) din IBM Quantum Learning.
...
- Înțelege [Limitele job-urilor](/guides/job-limits) când trimiți un job la un QPU IBM&reg;.
</Admonition>
