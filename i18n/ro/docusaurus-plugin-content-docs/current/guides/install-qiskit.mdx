...
description: Instalează SDK-ul Qiskit pe diverse sisteme de operare
...
<span id="local"></span>
## Instalează SDK-ul Qiskit {#install-the-qiskit-sdk}
...
Dacă plănuiești să lucrezi local și să folosești simulatoarele încorporate în Qiskit, atunci instalarea este completă. Dacă vrei să rulezi joburi pe QPU-urile IBM&reg;, continuă cu [configurarea contului tău IBM Cloud&reg;](cloud-setup).

<Admonition type="note" title="Rămâi la curent cu cele mai recente versiuni">
Verifică periodic [notele de lansare Qiskit](https://docs.quantum.ibm.com/api/qiskit/release-notes) pentru a vedea noile versiuni. Recomandăm să actualizezi frecvent cerințele pentru `qiskit` rulând `pip install -U qiskit`.
</Admonition>
...
<Admonition type="tip" title="Recomandări">
  ...
  -  Urmează pașii din ghidul [Rulează primul tău circuit pe hardware](/guides/hello-world) pentru a scrie și rula un program cuantic.
  -  Încearcă un [tutorial](https://docs.quantum.ibm.com/tutorials) IBM Quantum Learning.
  -  Înțelege politica de [suport pentru versiuni](https://docs.quantum.ibm.com/api/qiskit/providers).
</Admonition>
