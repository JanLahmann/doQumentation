...
Sarcini scurte de monitorizare a parametrilor sunt executate aproximativ o dată pe oră, intercalate automat între sarcinile utilizatorilor, folosind întregul stec de software IBM Quantum Compute Service. Rezultatele acestor sarcini sunt analizate pentru a verifica dacă vreun parametru a început să devieze de la intervalele acceptabile, identificând ideal problemele înainte ca acestea să devină suficient de semnificative pentru a afecta performanța la un nivel perceptibil.
