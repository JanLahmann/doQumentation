...
<Admonition type="tip" title="Recomandări">
  ...
  - Descoperă cum să folosești [interfața primitiva](/guides/primitives) pentru a simplifica programarea cuantică.
</Admonition>
