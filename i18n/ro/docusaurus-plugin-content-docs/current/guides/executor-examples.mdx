---
description: 'Exemple practice de utilizare a primitivului Executor în qiskit-ibm-runtime.'
...
### Configurarea circuitului {#set-up-the-circuit-1}
...
### Executarea circuitelor {#execute-the-circuits-1}
