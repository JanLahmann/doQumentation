...
Fiecare poartă din Qiskit poate interpreta o listă de qubiți în felul său, dar
Gate-urile controlate urmează de obicei convenția `(control, target)`.

De exemplu, următoarea celulă adaugă un poartă controlled-X unde qubitul $0$ este
...
Urmând toate convențiile Qiskit menționate anterior, acest poartă CX
