...
# Implementează și rulează un șablon pentru simularea structurii electronice cu un model de solvent implicit {#deploy-and-run-a-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
<details>
<summary> Click pentru mai multe detalii despre opțiunile necesare: </summary>
...
<details>
<summary> Click pentru mai multe informații despre configurarea opțiunilor SQD:</summary>
