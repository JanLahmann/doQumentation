...
Ajustarea nivelului de optimizare poate schimba și alte aspecte ale circuitului, nu doar numărul de Gate-uri ECR. Pentru exemple despre cum setarea nivelului de optimizare schimbă layout-ul, vezi [Reprezentarea calculatoarelor cuantice](/guides/represent-quantum-computers).
