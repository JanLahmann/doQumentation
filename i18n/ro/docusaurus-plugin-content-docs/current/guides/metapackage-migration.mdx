...
# Înțelege modificările majore ale pachetelor Qiskit v1.0 {#understand-the-breaking-package-changes}
...
* **cale de căutare**: Când încearcă să facă `import something`, Python caută într-o listă predefinită de locuri un modul sau pachet numit `something`.
