...
<Admonition type="tip">
**Qiskit Serverless primește o actualizare și funcțiile sale se schimbă rapid.** În această fază de dezvoltare, găsești notele de lansare și cea mai recentă documentație pe pagina [Qiskit Serverless GitHub](https://qiskit.github.io/qiskit-serverless/index.html).
</Admonition>
...
Asigură-te că ai urmat fluxul de lucru din [Scrie primul tău program Qiskit Serverless](/guides/serverless-first-program) înainte de a începe.

## Listează programele disponibile {#list-programs-available}

Poți folosi `QiskitServerless.list()` pentru a obține o listă a programelor disponibile pe care le poți rula cu Qiskit Serverless. Aceasta include [`transpile_remote_serverless`](/guides/serverless-first-program) încărcat anterior.
...
- Explorează [instrumentele de gestionare a calculului și datelor](/guides/serverless-manage-resources) disponibile pentru programul tău, inclusiv paralelizarea.
