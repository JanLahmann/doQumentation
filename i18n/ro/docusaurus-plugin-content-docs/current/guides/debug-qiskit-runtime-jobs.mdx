---
description: 'Folosește clasa Neat din modulul de instrumente de depanare qiskit-ibm-runtime pentru a depana și analiza joburi.'
notebook_path: guides/debug-qiskit-runtime-jobs.ipynb
sidebar_label: 'Depanează joburi cu NEAT'
title: 'Depanează joburi cu NEAT'
---
...
Mai întâi, importă pachetele relevante și [autentifică-te la IBM Quantum Compute Service](/guides/cloud-setup).
...
## Application 2: Benchmark different strategies {#application-2-benchmark-different-strategies}
...
- Învață despre [opțiunile IBM Quantum Compute](/guides/runtime-options-overview).
...
- Învață [cum să transpilezi Circuit-uri](/guides/circuit-transpilation-settings#compare-transpiler-settings) ca parte a fluxurilor de lucru Qiskit patterns.
