...
* [Încâlcire eficientă pe distanță lungă](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339) între qubiți de pe același cip prin folosirea circuitelor superficiale

* Eșantionare eficientă a [circuitelor de tip IQP](https://arxiv.org/pdf/2505.04705)
Qiskit acceptă patru construcții de flux de control pentru feedforward clasic, fiecare implementată ca o metodă pe [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit). Construcțiile și metodele lor corespunzătoare sunt:
