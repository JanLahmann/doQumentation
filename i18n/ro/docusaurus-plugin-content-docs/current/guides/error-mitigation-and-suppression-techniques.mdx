...
### Activarea TREX folosind opțiunea `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### Activarea TREX folosind opțiunea `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### Activarea ZNE folosind opțiunea `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}
...
### Activarea ZNE folosind opțiunea `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- Explorează alte [opțiuni](/guides/runtime-options-overview) pentru primitivele Qiskit Runtime.
