---
description: 'Opțiuni disponibile pentru lucrul cu primitivele IBM Quantum'
...
Poți folosi opțiuni pentru a personaliza primitivele IBM Quantum în funcție de nevoi.
