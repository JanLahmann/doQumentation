...
## Ce este un circuit cuantic? {#what-is-a-quantum-circuit}

Un circuit cuantic simplu este o colecție de qubiți și o listă de instrucțiuni care acționează asupra acelor qubiți. Pentru a demonstra, următoarea celulă creează un nou circuit cu doi qubiți noi, apoi afișează atributul [`qubits`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#qubits) al circuitului, care este o listă de [`Qubits`](https://docs.quantum.ibm.com/api/qiskit/circuit#qiskit.circuit.Qubit) în ordine de la bitul cel mai puțin semnificativ $q_0$ până la bitul cel mai semnificativ $q_n$.
...
Cel mai simplu mod de a vizualiza aceste informații este prin metoda [`draw`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#draw), care returnează o vizualizare a unui circuit. Consultă [Vizualizează circuite](/guides/visualize-circuits) pentru diferite moduri de afișare a circuitelor cuantice.
...
### Ce este adâncimea unui circuit? {#what-is-circuit-depth}
...
## Construiește circuite {#build-circuits}
...
## Măsoară qubiții {#measure-qubits}

Măsurătorile sunt folosite pentru a eșantiona stările qubiților individuali și a transfera rezultatele într-un registru clasic. Reține că, dacă trimiți circuite către un primitiv [Sampler](/guides/get-started-with-sampler), măsurătorile sunt obligatorii. Cu toate acestea, circuitele trimise către un primitiv [Estimator](/guides/get-started-with-estimator) nu trebuie să conțină măsurători.
...
### Schimbă numele unui parametru {#change-a-parameters-name}
