...
## De ce a introdus Qiskit primitive? {#why-did-qiskit-introduce-primitives}
...
Recunoscând că majoritatea dezvoltatorilor nu ar fi și nici nu ar trebui să fie familiarizați cu distilarea unor astfel de date brute în 0 și 1, Qiskit a introdus `backend.run`, o primă abstractizare pentru accesarea QPU-urilor în cloud. Aceasta le-a permis dezvoltatorilor
...
## Ce este o primitivă? {#what-is-a-primitive}
...
De exemplu, consultă subiectele [Opțiuni Estimator](/guides/estimator-options) și [Opțiuni Sampler](/guides/sampler-options) pentru a afla despre opțiunile primitivelor IBM Quantum, sau vezi [referințele API Qiskit Aer](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html) pentru opțiunile primitivelor Qiskit Aer.

## Beneficiile primitivelor Qiskit {#benefits-of-qiskit-primitives}
...
capabilitățile hardware avansate ale unui anumit furnizor. De exemplu, cu primitivele IBM Quantum,
...
- Află despre [primitivele IBM Quantum](/guides/qiskit-runtime-primitives), care sunt folosite pentru rularea circuitelor pe QPU-uri IBM.
</Admonition>
