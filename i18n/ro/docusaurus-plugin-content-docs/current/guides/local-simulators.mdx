...
# Migrează de la simulatoarele cloud la simulatoare locale {#migrate-from-cloud-simulators-to-local-simulators}
...
<Accordion>
<AccordionItem title="<a>Simulatoarele au limitări</a>">
...
<AccordionItem title="<a>Utilizarea hardware-ului cuantic construiește abilități unice</a>">
...
<AccordionItem title="<a>Algoritmii trebuie adaptați pentru hardware-ul cuantic</a>">
...
Modul de testare locală nu are suprimare sau atenuare a erorilor încorporată. În schimb, trebuie să specifici explicit acele opțiuni. Consultă [Configurează atenuarea erorilor pentru Qiskit Runtime](/guides/error-mitigation-and-suppression-techniques) pentru detalii.
</Admonition>
