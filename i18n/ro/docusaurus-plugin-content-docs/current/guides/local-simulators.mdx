---
description: 'Migrează de la simulatoarele cloud IBM Quantum la modul de testare locală `qiskit-ibm-runtime`.'
title: 'Migrează la simulatoare locale'
---

{/* doqumentation-source-hash: 9db328b8 */}

# Migrează de la simulatoarele cloud la simulatoare locale {#migrate-to-local-simulators}
...
## De ce sunt retrase simulatoarele cloud? {#why-are-the-cloud-simulators-being-retired}

Simulatoarele cloud sunt retrase din mai multe motive:

<Accordion>
<AccordionItem title="Simulatoarele au limitări">
...
<AccordionItem title="Utilizarea hardware-ului cuantic construiește competențe unice">
...
<AccordionItem title="Algoritmii ar trebui adaptați pentru hardware-ul cuantic">
...
## Când ar trebui folosite simulatoarele? {#when-should-simulators-be-used}
...
## Migrează la simulatoare locale {#migrate-to-local-simulators-1}
...
### Îndrumare pentru alegerea unui simulator {#guidance-for-choosing-a-simulator}
