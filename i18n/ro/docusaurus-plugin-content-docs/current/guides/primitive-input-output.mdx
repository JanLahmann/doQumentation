...
Așa cum s-a menționat anterior, datele returnate în `PubResult` pentru primitive-ul Estimator depind de implementare. De exemplu, pot conține un tablou de valori de așteptare (`PubResult.data.evs`) și abaterile standard asociate (`PubResult.data.stds`).
