...
![Această imagine ilustrează mai multe reprezentări vizuale ale broadcasting-ului de array-uri](/docs/images/guides/primitive-input-output/broadcasting.avif "Reprezentare vizuală a broadcasting-ului")
