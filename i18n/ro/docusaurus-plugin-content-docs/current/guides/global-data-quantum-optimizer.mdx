...
## `assets` {#example-dynamic-portfolio-optimization-with-seven-assets}
...
## `qubo_settings` {#2-define-the-problem}
...
## `ansatz_settings` {#3-define-the-optimizer-and-ansatz-settings-optional}
...
## `optimizer_settings` {#4-run-the-problem}
...
### `primitive_options` {#5-retrieve-results}
| Nume              | Tip    | Descriere                                                | Obligatoriu | Implicit                   | Exemplu                    |
|-------------------|--------|----------------------------------------------------------|-------------|----------------------------|----------------------------|
...
### `optimizer_options` {#6-performance-analysis}
| Nume              | Tip      | Descriere                                        | Obligatoriu | Implicit       |
|-------------------|----------|--------------------------------------------------|-------------|----------------|
...
### Descrierea dicționarului `metadata` {#description-of-the-metadata-dictionary}
...
### Descrierea dicționarului `all_samples_metrics` {#description-of-the-all-samples-metrics-dictionary}
