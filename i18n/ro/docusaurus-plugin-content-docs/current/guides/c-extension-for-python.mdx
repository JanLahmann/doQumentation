...
Completează instrucțiunile din secțiunea [Instalare](/guides/install-c-api) pentru a instala următoarele:

- Lanțul de instrumente compilator C standard pentru platforma ta

- O versiune de Python care include headerele API C ale sale. 


Ar trebui, de asemenea, să fii familiarizat cu, sau pregătit să consulți, funcțiile și obiectele disponibile
în [API-ul C Qiskit](https://docs.quantum.ibm.com/api/qiskit-c), și ar trebui să ai o oarecare familiaritate cu programarea în C.
...
Setează versiunea de runtime a lui Qiskit în
`project.dependencies` pentru a se potrivi cu versiunea minoră folosită la momentul build-ului.
