...
În acest tutorial, vei învăța cum să valorifici cele mai noi instrumente din ecosistemul Qiskit pentru a implementa un flux de lucru complet personalizabil, cu reducerea erorilor. Vom prezenta tehnica PNA și o vom folosi pentru a atenua erorile de poartă. Vom utiliza, de asemenea, TREX pentru a atenua erorile de citire și post-selecția pentru a atenua erorile care nu sunt capturate în modelul de zgomot învățat.
...
***O tehnică de atenuare a erorilor de poartă prin propagarea observabilului prin canalul invers de zgomot care afectează porțile cu 2 Qubiți, rezultând un observabil de reducere a zgomotului.***
