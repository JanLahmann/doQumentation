...
### Specificarea unui observabil {#specify-an-observable}
...
## Pasul 2: Optimizare {#step-2-optimize}
...
### Vizualizarea problemei descompuse {#visualize-the-decomposed-problem}
...
### Generarea subexperimentelor de rulat pe Backend {#generate-the-subexperiments-to-run-on-the-backend}
...
### Alegerea unui Backend {#choose-a-backend}
...
### Rularea subexperimentelor cu primitiva Sampler din Qiskit Runtime {#run-the-subexperiments-using-the-qiskit-runtime-sampler-primitive}
