...
### Flux de lucru pentru umbrirea conului de lumină, învățarea zgomotului și injecția de anti-zgomot {#workflow-for-lightcone-shading-noise-learning-and-anti-noise-injection}
...
### Prezentare generală a învățării zgomotului {#noise-learning-overview}
...
|-----------|-----------|-----------|
| Twirl Pauli pe straturile de poartă-uri cu 2 Qubiți | Repetă perechile de identitate ale straturilor și învață zgomotul | Derivă o fidelitate (eroare pentru fiecare canal de zgomot) |
...
### Prezentare generală a post-procesării {#post-processing-overview}
...
## Pasul 0. Configurare {#step-0-setup}
...
În plus, dorim să rulăm un circuit în oglindă, astfel că pentru fiecare poartă din a doua jumătate a Circuitului trebuie să existe un poartă invers în prima jumătate. Deoarece observabilul măsurat **$<X_6 Z_{13}>$** are măsurători în baze non-Z, iar Executorul ține cont de baza dorită la sfârșitul Circuitului, furnizăm o funcție `prepare_basis` care inserează Gate-urile corespunzătoare la începutul Circuitului în oglindă. Acest detaliu este specific demonstrației noastre cu Circuit în oglindă. Funcția `get_measurement_bases` ne permite să identificăm cu ușurință ce poartă-uri sunt necesare și unde să le adăugăm, precum și să urmărim subtilitățile indexului Qubitului ce apar din convențiile adnotărilor `box` discutate în secțiunea „Pregătește măsurătorile canonice ale bazei".
...
![Diagramă circuit cuantic](/img/qiskit-addons/slc/01-getting-started/output_2.png)
...
![Diagramă circuit cuantic](/img/qiskit-addons/slc/01-getting-started/output_3.png)
...
### Flux de lucru pentru umbrirea conului de lumină, învățarea zgomotului și injecția anti-zgomot {#workflow-for-lightcone-shading-noise-learning-and-anti-noise-injection-1}
...
### Vizualizează SLC pentru inspecție manuală {#visualize-the-slc-for-manual-inspection-3}
...
![Diagramă circuit cuantic](/img/qiskit-addons/slc/01-getting-started/output_13.png)

![Diagramă circuit cuantic](/img/qiskit-addons/slc/01-getting-started/output_14.png)

![Diagramă circuit cuantic](/img/qiskit-addons/slc/01-getting-started/output_15.png)
...
![Diagramă circuit cuantic](/img/qiskit-addons/slc/01-getting-started/output_16.png)

![Diagramă circuit cuantic](/img/qiskit-addons/slc/01-getting-started/output_17.png)

![Diagramă circuit cuantic](/img/qiskit-addons/slc/01-getting-started/output_18.png)
...
#### b.ii. Calculează `local_scales` pentru execuția pe hardware {#bii-compute-the-local-scales-for-the-hardware-execution}
...
![Ieșire grafic](/img/qiskit-addons/slc/01-getting-started/output_19.png)
...
![Ieșire grafic](/img/qiskit-addons/slc/01-getting-started/output_20.png)
