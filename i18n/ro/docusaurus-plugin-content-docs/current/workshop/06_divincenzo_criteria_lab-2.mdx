...
3. **Timpi lungi de decoerență** (coerența Qubitului mult mai lungă decât timpul de operare al poartă-ului).

4. **Un set universal de poartă-uri cuantice** (capabil să efectueze operații unitare arbitrare).
...
**Scopul demonstrației:** Utilizează Qiskit pentru a arăta efectul scalării unui Circuit (ca număr de Qubiți sau adâncime de poartă) asupra fidelității rezultatelor. Vom simula un scenariu ideal versus cu zgomot pentru a vedea cum un sistem mai mare sau un circuit mai adânc cedează în fața decoherenței și a erorilor.
