...
*Nutzungsschätzung: weniger als 1 Minute auf eim Heron-Prozessor (HINWEIS: Des isch bloß a Schätzung. Ihre Laufzeit ka variiere.)*

## Hintergrund {#hintergrund}

Um Echtzeit-Quantenfehlerkorrektur (QEC) z'ermögliche, müsset Se in der Lage sei, den Quantenprogrammfluss während dr Ausführung dynamisch z'steuere, sodass Quantengates von Messergebnisse abhängig gmacht werde könnend. Des Tutorial führt den Bit-Flip-Code aus, der a ganz eifache Form von QEC isch. Es zeigt an dynamische Quantenschaltkreis, der a kodiertes Qubit vor eim einzelne Bit-Flip-Fehler schütze ka, und bewertet dann d'Leistung vom Bit-Flip-Code.

Se könnend zusätzliche Hilfs-Qubits und Verschränkung nutze, um *Stabilisatoren* z'messe, die kodierte Quanteninformation ned transformieret, während se Se dennoch über etliche Fehlerklasse informieret, die vielleicht aufgtrette sind. A Quanten-Stabilisator-Code kodiert $k$ logische Qubits in $n$ physische Qubits. Stabilisator-Codes konzentrieret sich vor allem auf d'Korrektur von eim diskreten Fehlersatz mit Unterstützung aus dr Pauli-Gruppe $\Pi^n$.

Für weitere Informatiione über QEC luaget Se bei [Quantum Error Correction for Beginners](https://arxiv.org/abs/0905.2794) nei.

## Anforderungen {#anforderungen}

Stellet Se sicher, bevor Se mit dem Tutorial afangend, dass Se Folgendes installiert hend:
...
Führet Se d'Version mit angewendeter Korrektur und oine ohne Korrektur aus.
...
Se könnend sehe, dass der Bit-Flip-Code viele Fehler erkannt und korrigiert hat, was zu insgesamt weniger Fehlere gführt hat.
...
Bitte machet Se bei derer kurze Umfrage mit, um Feedback zu dem Tutorial z'gebe. Ihre Erkenntnisse helfet uns, unsere Inhaltsangebote und d'Benutzererfahrung z'verbessere.
