...
*Nutzungsschätzung: Nein Sekunde auf am Heron r2 Prozessor (HINWEIS: Des isch nur a Schätzung. Dei Laufzeit ka variiere.)*
## Hintergrund {#hintergrund}

Des Tutorial zeigt, wie die stichprobenbasierte Quantendiagonalisierung (SQD) verwendet wird, um d Grundzustandsenergie vun am fermionische Gittermodell z schätze. Konkret untersuche mir s eindimensionale Einzelstörstellen-Anderson-Modell (SIAM), des zur Beschreibung magnetischer Störstelle in Metalle verwendet wird.
...
Beachde, dass dr Hamiltonian a spezifische Instanz vum generische Wechselwirkungs-Elektronen-Hamiltonian isch,
...
Für a detailliertere Beschreibung vun dem Modell und wie d Schaltkreise entworfe worde sind, luag ["Quantum-Centric Algorithm for Sample-Based Krylov Diagonalization"](https://arxiv.org/abs/2501.09702).
...
Nachdem mir d Schaltkreise erstellt hend, köne mir se für a Ziel-Hardware optimiere. Mir wähle d am wenigste ausgelastete QPU mit mindestens 127 Qubits. Weitere Informationen findet mr in dr [Qiskit IBM&reg; Runtime-Dokumentation](/guides/get-started-with-primitives#get-started-with-sampler).
