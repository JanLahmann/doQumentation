...
다음으로, Trotter화된 양자 회로 집합으로 양자 Krylov 부분 공간을 생성합니다. 여기서는 초기(참조) 상태 생성과 Hamiltonian의 1체 및 2체 부분에 대한 시간 진화를 위한 헬퍼를 만듭니다. 이 모델과 회로 설계 방법에 대한 자세한 설명은 [논문](https://arxiv.org/abs/2501.09702)을 참조하세요.
