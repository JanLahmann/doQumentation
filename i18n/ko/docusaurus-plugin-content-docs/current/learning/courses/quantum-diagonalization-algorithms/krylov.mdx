...
![실제 고유벡터 x, 추정값 x 0, 그리고 두 벡터 사이의 오차를 그래픽으로 나타낸 그림.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig2.svg)
...
![실제 고유벡터와 초기 추정값의 업데이트. 업데이트된 추정값이 실제 고유벡터에 더 가깝습니다.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig3.svg)
