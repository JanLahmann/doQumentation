...
## 2. 고전적 워크플로와의 비교 {#2-comparison-with-classical-workflow}
...
### 2.1 고전적 워크플로 {#21-classical-workflow}
...
### 2.2 양자 워크플로와 교환 가능한 파울리 그룹 {#22-quantum-workflow-and-commuting-pauli-groups}
...
### 2.3 계산 비용을 결정하는 요인 {#23-factors-that-determine-computational-cost}
...
## 4. VQE와 다른 방법들의 관계 {#4-vqes-relationship-to-other-methods}

이 섹션에서는 원래의 VQE 방식이 가진 장단점을 검토하고, 보다 최근에 등장한 알고리즘들과의 관계를 살펴봅니다.

### 4.1 VQE의 강점과 약점 {#41-the-strengths-and-weaknesses-of-vqe}
...
### 4.2 다른 접근법과의 관계 {#42-relationship-to-other-approaches}
