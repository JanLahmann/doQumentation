...
### 상관된 상태 및 얽힌 상태 {#correlated-and-entangled-states}
...
## 축약 상태와 부분 대각합 {#reduced-states-and-the-partial-trace}
...
### 예: e-비트의 축약 상태 {#example-reduced-states-for-an-e-bit}
...
### 일반 양자 상태 벡터에 대한 축약 상태 {#reduced-states-for-a-general-quantum-state-vector}
...
### 부분 대각합의 대체 설명 {#alternative-description-of-the-partial-trace}
...
### 두 Qubit에 대한 부분 대각합 {#the-partial-trace-for-two-qubits}
