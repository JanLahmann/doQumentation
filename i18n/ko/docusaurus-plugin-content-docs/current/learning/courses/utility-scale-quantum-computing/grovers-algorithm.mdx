...
### 2단계: 대상 하드웨어에 맞게 최적화 {#step-2-optimize-for-target-hardware-1}
...
### 3단계: Circuit 실행 {#step-3-executing-the-circuit-1}
...
### 4단계: 결과 후처리 {#step-4-post-processing-the-results-1}
...
이번에는 $|111\rangle$이 "좋은(good)" 상태, 즉 찾고자 하는 정답 상태입니다.
