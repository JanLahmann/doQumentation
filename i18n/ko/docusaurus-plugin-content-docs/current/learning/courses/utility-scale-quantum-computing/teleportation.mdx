...
이 주제들에 관한 배경 지식은 [Entanglement in action](/learning/courses/basics-of-quantum-information/entanglement-in-action/introduction)의 Basics of Quantum Information 레슨 4를 참고해 주세요.
...
## 3. 양자 상태 단층촬영 {#3-quantum-state-tomography}
...
### Exercise 1: $r_x$ 값 추정 {#exercise-1-estimate-r-x-value}
...
### Exercise 2: $r_y$ 값 추정 {#exercise-2-estimate-r-y-value}
...
### 4.4 실제 양자 컴퓨터에서의 텔레포테이션 {#44-teleportation-on-a-real-quantum-computer}
...
### 4.5 양자 텔레포테이션의 핵심 요점 {#45-key-takeaways-on-quantum-teleportation}
