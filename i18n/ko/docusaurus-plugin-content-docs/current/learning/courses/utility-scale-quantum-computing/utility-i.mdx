...
### 2.1 RZZ(-$\pi$ / 2) 구성 {#21-construct-rzz-pi-2}
...
## 4. 27-Qubit 버전의 문제를 풀어봅니다. {#4-solve-the-27-qubit-version-of-the-problem}
...
### 4.2 2단계 및 3단계: 최적화 및 실행 (시뮬레이터) {#42-steps-2-and-3-optimize-and-execute-simulator}
...
### 4.3 2단계 및 3단계: 최적화 및 실행 (가상 디바이스) {#43-steps-2-and-3-optimize-and-execute-fake-device}
...
### 4.4 4단계: 후처리(Post-process) {#44-step-4-post-process}
...
## 5. 127-Qubit 버전의 문제를 풀어봅니다. {#5-solve-the-127-qubit-version-of-the-problem}
...
### 5.2 2단계 및 3단계: 최적화 및 실행 {#52-steps-2-and-3-optimize-and-execute}
...
### 5.3 후처리(Post-process) {#53-post-process}
