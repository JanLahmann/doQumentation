...
이것이 6-Qubit GHZ Circuit의 결과입니다. 보면 알 수 있듯이 모든 $|0\rangle$과 모든 $|1\rangle$ 상태가 지배적이긴 하지만 오류가 상당합니다. Eagle 장치에서 올바른 상태가 최소 50% 이상의 확률로 나타나도록 하면서 얼마나 큰 GHZ Circuit을 만들 수 있는지 살펴봅시다.
### 1.2 목표 {#12-your-goal}
...
보면 알 수 있듯이, 이 결과는 기준을 충족하지 못했습니다.
...
이 과정을 완료하신 것을 축하합니다! 아래 [간단한 설문조사](https://your.feedback.ibm.com/jfe/form/SV_5vvmdT5yFFetkgK)를 통해 과정 개선에 도움을 주세요. 여러분의 의견은 콘텐츠 품질과 사용자 경험을 향상하는 데 활용됩니다. 감사합니다!
