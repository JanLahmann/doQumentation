...
Sampler V2에서 오류 억제 옵션을 설정할 수 있습니다. 자세한 내용은 [Sampler 노이즈 관리](/guides/sampler-noise-management) 가이드와 [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) API 레퍼런스를 참고하세요.
