...
## 샘플 기반 양자 대각화 (Sample-based Quantum Diagonalization) {#sample-based-quantum-diagonalization}
...
더 많은 사용 사례와 알고리즘을 탐구하려면 IBM Quantum Platform의 [문서](https://docs.quantum.ibm.com/guides)와 [튜토리얼](https://docs.quantum.ibm.com/tutorials)을 참고하세요. 또한 다음 레슨에서 공유되는 리소스도 꼭 방문해 보세요. 계산 과학자와 데이터 센터 관리자 모두를 위한 알고리즘 및 소프트웨어에 관한 더 많은 정보를 얻을 수 있습니다.
