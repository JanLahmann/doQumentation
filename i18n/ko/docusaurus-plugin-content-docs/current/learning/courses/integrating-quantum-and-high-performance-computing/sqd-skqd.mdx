...
앤사츠를 구성하는 모든 계산 기저 상태의 집합을 A라고 하고, 시스템의 실제 바닥 상태를 구성하는 모든 계산 기저 상태의 집합을 G라고 합시다. 다음 중 '좋은' 앤사츠에 해당하는 것은 무엇입니까? 해당하는 모든 것을 선택하십시오:
...
#### Step 3: 고전적 투영 및 대각화 {#step-3-project-and-diagonalize-classically-1}
...
### 이해도 점검 {#check-your-understanding-2}
