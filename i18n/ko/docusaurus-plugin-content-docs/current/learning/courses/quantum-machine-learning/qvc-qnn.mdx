...
## Qiskit Patterns 3단계: IBM Quantum primitives를 사용하여 실행 {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
## Qiskit Patterns 2단계: 양자 실행을 위한 문제 최적화 {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution-1}
실행할 Backend를 선택하는 것으로 시작합니다. 여기서는 가장 한가한 Backend를 사용하겠습니다.
...
## Qiskit Patterns 3단계: IBM Quantum primitives를 사용하여 실행 {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
