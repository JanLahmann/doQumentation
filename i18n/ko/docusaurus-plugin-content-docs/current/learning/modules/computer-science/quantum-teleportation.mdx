...
- 3단계: IBM Quantum 프리미티브를 사용하여 IBM 양자 컴퓨터에서 작업 실행하기
- 4단계: 결과 후처리하기
...
Sampler는 양자 Circuit에서 발생할 수 있는 상태를 샘플링하고, 어떤 상태가 어떤 확률로 측정될 수 있는지에 대한 통계를 수집하도록 설계된 Primitive입니다. 여기서 IBM Quantum Sampler를 가져옵니다:
...
### 1단계: 문제를 양자 Circuit으로 매핑하기 {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Step 2: Optimize your circuit {#step-2-optimize-your-circuit}
...
### Step 3: Execute {#step-3-execute-1}
...
### Step 4: Classical post-processing {#step-4-classical-post-processing}
...
### True/False questions {#truefalse-questions}
