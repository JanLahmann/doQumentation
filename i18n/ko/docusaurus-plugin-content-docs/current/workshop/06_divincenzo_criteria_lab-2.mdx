...
## 3. 기준 3 – 긴 결맞음 시간 (결어긋남 대 Gate 시간) {#3-criterion-3-long-coherence-time-decoherence-vs-gate-time}
...
## 4. 기준 4 – 범용 양자 Gate 집합 {#4-criterion-4-universal-set-of-quantum-gates}
