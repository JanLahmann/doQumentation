...
[IBM Quantum Platform API 키](http://quantum.cloud.ibm.com/)를 사용하여 인증하고, 다음과 같이 TEM 함수를 선택하세요. (이 스니펫은 이미 [계정을 로컬 환경에 저장](/guides/functions-get-started#install-qiskit-functions-catalog-client)했다고 가정합니다.)
...
- [Algorithmiq 텐서 네트워크 오류 완화에 대한 접근 요청](https://quantum.ibm.com/functions?id=4b1b9d76-c18b-4788-b70b-15125111fbe6).

- 이 Qiskit Function의 [API 참조](https://docs.quantum.ibm.com/api/functions/algorithmiq-tem)를 방문하세요.
