...
* [GHZ 상태](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339), [W-상태](https://arxiv.org/abs/2403.07604)(W-상태에 대한 자세한 내용은 ["State preparation by shallow circuits using feed forward"](https://arxiv.org/abs/2307.14840)도 참조하세요), 그리고 광범위한 [행렬 곱 상태](https://arxiv.org/abs/2404.16083)와 같은 효율적인 양자 상태 준비

* 얕은 회로를 사용하여 동일 칩 상의 qubit 간 [효율적인 장거리 얽힘](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339)

* [IQP형 회로의 효율적인 샘플링](https://arxiv.org/pdf/2505.04705)
Qiskit은 고전적 피드포워드를 위한 네 가지 제어 흐름 구문을 지원하며, 각각은 [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit)의 메서드로 구현됩니다. 이러한 구문과 해당 메서드는 다음과 같습니다:
