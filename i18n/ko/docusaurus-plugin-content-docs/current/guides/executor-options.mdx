...
다음 표는 최신 버전 `qiskit-ibm-runtime`의 옵션을 정리한 것입니다. 이전 옵션 버전을 보려면 [`qiskit-ibm-runtime` API 참조](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime)를 방문하여 이전 버전을 선택하세요.
...
<Tabs>
  ...
  기타 참고 사항:
  - 게이트 트월링은 동적 Circuit에 적용될 수 있지만 조건부 블록 내부의 게이트에는 적용할 수 없습니다.
  - 측정 트월링은 회로 끝의 최종 측정에만 적용할 수 있습니다.
  ...
  기타 참고 사항:
  - 게이트 트월링은 동적 Circuit에 적용될 수 있지만 조건부 블록 내부의 게이트에는 적용할 수 없습니다. 측정 트월링은 회로 끝의 최종 측정에만 적용할 수 있습니다.
  - 비Clifford 얽힘 게이트와는 작동하지 않습니다.
