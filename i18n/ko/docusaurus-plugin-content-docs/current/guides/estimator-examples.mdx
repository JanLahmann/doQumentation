...
Estimator를 사용하여 단일 Circuit-Observable 쌍의 기댓값을 결정합니다.
...
Estimator를 사용하여 여러 Circuit-Observable 쌍의 기댓값을 결정합니다.
...
- IBM Quantum&reg; Learning의 [비용 함수 레슨](/learning/courses/variational-algorithm-design/cost-functions)을 통해 Primitive 연습을 하세요.
