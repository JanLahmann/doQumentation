---
description: 'IBM Quantum Compute Service Session에서 양자 컴퓨팅 작업을 실행하는 방법.'
...
Session을 시작하기 전에 [IBM Quantum Compute 클라이언트를 설정](/guides/install-qiskit-runtime)하고 서비스로 초기화해야 합니다:
...
Session의 구성 및 상태에 대한 포괄적인 개요를 보려면 `session.details() method`를 사용하세요.
