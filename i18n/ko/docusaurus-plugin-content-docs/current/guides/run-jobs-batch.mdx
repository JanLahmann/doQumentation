---
description: 'IBM Quantum Compute Service를 사용하여 양자 컴퓨팅 작업을 배치 모드로 실행하는 방법입니다.'
...
배치를 시작하기 전에 [IBM Quantum Compute 클라이언트 설정](/guides/install-qiskit)을 완료하고 서비스로 초기화해야 합니다:
...
인터랙티브 및 최대 TTL을 포함하여 배치의 구성 및 상태에 대한 포괄적인 개요를 보려면 `batch.details() method`를 사용하세요.
