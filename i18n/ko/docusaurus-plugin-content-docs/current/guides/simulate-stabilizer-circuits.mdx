...
[Qiskit Aer primitive를 사용한 정확한 시뮬레이션과 노이즈 시뮬레이션](simulate-with-qiskit-aer)에서는 [Qiskit Aer](https://qiskit.org/ecosystem/aer/)를 사용하여 일반적인 양자 회로에 대해 정확한 시뮬레이션과 노이즈 시뮬레이션을 수행하는 방법을 보여줍니다. 해당 문서에서 사용된 예제 회로, 즉 [efficient_su2](../api/qiskit/qiskit.circuit.library.efficient_su2)를 사용해 구축된 8-Qubit 회로를 생각해 보세요.
...
<Admonition type="tip" title="권장 사항">
  - Qiskit Aer로 Circuit을 시뮬레이션하려면 [Qiskit Aer 프리미티브를 사용한 정확한 시뮬레이션 및 노이즈 시뮬레이션](/guides/simulate-with-qiskit-sdk-primitives)을 참고하세요.
