...
QRMI를 빌드하고 배포하기 위한 소스 코드는 이 [GitHub 저장소](https://github.com/qiskit-community/qrmi)에서 확인할 수 있습니다.

양자 하드웨어에 대해 양자 페이로드를 실행하기 위한 선택적 `task_runner` 명령줄 도구가 Python 패키지에 포함되어 있습니다. [전체 문서](https://github.com/qiskit-community/qrmi/blob/main/python/qrmi/tools/task_runner/README.md)는 GitHub 저장소에서 확인할 수 있습니다.
