...
<Admonition type="tip">
**Qiskit Serverless가 업그레이드되고 있으며, 기능이 빠르게 변화하고 있습니다.** 이 개발 단계 동안 릴리스 노트 및 최신 문서는 [Qiskit Serverless GitHub](https://qiskit.github.io/qiskit-serverless/index.html) 페이지에서 확인할 수 있습니다.
</Admonition>
...
시작하기 전에 [첫 번째 Qiskit Serverless 프로그램 작성하기](/guides/serverless-first-program)의 워크플로를 따랐는지 확인해 주세요.

## 사용 가능한 프로그램 나열하기 {#list-programs-available}

`QiskitServerless.list()`를 사용하여 Qiskit Serverless로 실행할 수 있는 사용 가능한 프로그램 목록을 가져올 수 있습니다. 여기에는 이전에 업로드한 [`transpile_remote_serverless`](/guides/serverless-first-program)도 포함됩니다.
...
- 병렬화를 포함하여 프로그램에서 사용할 수 있는 [컴퓨팅 및 데이터 관리 도구](/guides/serverless-manage-resources)를 살펴보세요.
