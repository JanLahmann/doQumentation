...
<Admonition type="tip" title="권장 사항">
  - [파울리 기저에서 관측 가능량을 지정하는 방법](/guides/specify-observables-pauli)을 알아보세요.
  - [Estimator 프리미티브와 오류 완화 옵션 결합하기](/tutorials/combine-error-mitigation-techniques) 튜토리얼에서 연산자를 사용하는 예제를 확인하세요.
  - [Operator 클래스에 대한 자세한 설명](/guides/operator-class)을 읽어보세요.
  - [Operator API](https://docs.quantum.ibm.com/api/qiskit/qiskit.quantum_info.Operator#operator) 참조를 살펴보세요.
</Admonition>
