...
# 암묵적 용매 모델을 사용한 전자 구조 시뮬레이션을 위한 Qiskit Function 템플릿 빌드 및 실행 {#build-and-run-a-qiskit-function-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
이와 동일한 워크플로우를 예제와 함께 단계별로 설명하는 자료는 [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations) 튜토리얼을 참조하세요.
...
<Accordion>
<AccordionItem title="필수 옵션에 대한 자세한 내용을 보려면 클릭하세요:">
...
<Accordion>
<AccordionItem title="SQD 옵션 구성에 대한 자세한 내용은 클릭하세요:">
...
## 이 프로젝트 인용하기 {#cite-this-project}

연구에서 SQD IEF-PCM 템플릿을 사용하는 경우, 자세한 인용 정보는 [저장소](https://github.com/qiskit-community/qiskit-function-templates/tree/main/chemistry/sqd_pcm#citing-this-project)를 참조하세요.

## 다음 단계 {#next-steps}

<Admonition type="info" title="추천 사항">

- 이와 동일한 워크플로우의 실제 예제는 [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations) 튜토리얼을 따라해 보세요

- [Hamiltonian 시뮬레이션](/guides/function-template-hamiltonian-simulation)을 위한 함수 템플릿 구축 가이드를 검토하세요
