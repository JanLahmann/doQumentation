...
AI 기반 Transpiler 패스에 적용되는 제한 사항에 대한 자세한 내용은 [Qiskit Transpiler Service 문서](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service)를 참고하세요.

## 인용 {#citation}

연구에서 Qiskit Transpiler Service의 AI 기반 기능을 사용하는 경우 [권장 인용 방식](/guides/qiskit-transpiler-service#citation)을 사용하세요.
