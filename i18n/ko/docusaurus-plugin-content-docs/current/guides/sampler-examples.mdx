---
description: 'IBM Quantum Sampler Primitive를 사용하는 실용적인 예제.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Sampler 예제'
title: 'Sampler 예제'
---
...
Sampler를 사용하여 단일 Circuit의 측정 결과를 비트 문자열 또는 카운트로 반환해요.
...
Sampler를 사용하여 하나의 Job에서 여러 Circuit의 측정 결과를 비트 문자열 또는 카운트로 반환해요.
...
단일 Job에서 여러 실험을 실행하며, 매개변수 값을 활용하여 Circuit 재사용성을 높여요.
...
배치 [실행 모드](/guides/execution-modes)와 고급 옵션을 탐색하여 QPU에서의 Circuit 성능을 최적화해요.
...
- IBM&reg; QPU에 Job을 보낼 때의 [Job 제한](/guides/job-limits)을 이해하세요.
</Admonition>
