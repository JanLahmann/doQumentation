...
Satu lagi komponen kritikal yang kita tunjuk apabila kita melihat bagaimana komputer kuantum bertambah baik ialah kelajuan. Untuk mengukur kelajuan kita menggunakan sesuatu yang dipanggil Operasi Lapisan Litar per Saat (CLOPS). CLOPS menggabungkan masa untuk menjalankan litar serta pengiraan klasik masa nyata dan hampir-nyata, membolehkannya berfungsi sebagai ukuran kelajuan holistik tunggal.
