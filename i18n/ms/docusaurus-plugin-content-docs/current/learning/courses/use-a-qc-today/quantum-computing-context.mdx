...
Dalam video berikut, Olivia Lanes membimbing Anda melalui kandungan dalam pelajaran ini. Sebagai alternatif, Anda boleh buka [video YouTube](https://youtu.be/y_1SiE1tlTk?si=xzEYyCLSlFHDLdRz) untuk pelajaran ini dalam tetingkap berasingan.
...
Anda mulakan kursus ini dengan terus menjalankan litar kuantum pertama, dan belajar bagaimana undang-undang mekanik kuantum digunakan untuk mencipta keadaan kuantum, get, dan litar. Sekarang, jom kita ambil pandangan yang lebih luas. Dalam bahagian ini, kita akan terokai pengkomputeran kuantum melalui rangka kerja yang berbeza yang akan membantu Anda menavigasi perbualan, berita utama, dan artikel tentang pengkomputeran kuantum dengan lebih kritis.
...
- Ia bukannya tidak berguna sehingga kita mencapai toleransi kesalahan atau pembetulan ralat

- Ia bukan sihir


Harapnya itu tidak membuat Anda mahu tinggalkan kursus ini sepenuhnya atau berfikir tidak ada nilai di sini. Sebaliknya! Pengkomputeran kuantum berpotensi menjadi sangat berkuasa &mdash; tetapi hanya untuk aplikasi tertentu. Nasibnya, aplikasi-aplikasi tersebut merangkumi bidang penyelidikan aktif yang boleh secara asasnya mengubah cara kita menangani masalah penting, seperti simulasi kimia, penerokaan bahan, dan analisis set data yang besar. Sebelum kita terokai bidang aplikasi ini, jom kita gali beberapa salah tanggapan ini dengan lebih terperinci.

## Penskalaan {#scaling}

Satu lagi tanggapan salah yang biasa ialah semakin banyak qubit yang dimiliki komputer kuantum, semakin berkuasa ia mesti jadinya. Walaupun skala pengiraan adalah penting, bilangan qubit sahaja tidak memberikan gambaran lengkap tentang prestasi pengkomputeran kuantum. Perkakasan kuantum moden biasanya dinilai merentasi tiga dimensi: skala, kualiti, dan kelajuan.

Skala diukur dengan bilangan qubit boleh diprogram yang tersedia kepada pengguna. Ini adalah qubit yang boleh dikawal secara langsung, dimanipulasi, diukur, dan dimasukkan ke dalam algoritma kuantum. Meningkatkan bilangan qubit boleh diprogram memperluaskan saiz masalah yang boleh diterokai pada perkakasan kuantum.

Kualiti diukur dengan operasi qubit (QuOps), yang menerangkan berapa banyak operasi kuantum yang paling menuntut secara pengiraan yang boleh dilaksanakan secara boleh dipercayai oleh sistem sebelum ralat yang terkumpul mengatasi pengiraan tersebut. Penambahbaikan dalam masa koheren, ketepatan get, prosedur penentukuran, dan seni bina semuanya menyumbang kepada kualiti pengiraan yang lebih tinggi. Masa koheren dan dephasing (biasa dirujuk sebagai $T_1$ dan $T_2$) kekal sebagai penunjuk penting bagi prestasi qubit.

Kelajuan diukur dengan litar maksimum sesaat, juga dikenali sebagai daya pemprosesan litar. Metrik ini menangkap berapa banyak pengiraan berguna yang boleh dilaksanakan oleh sistem kuantum dari semasa ke semasa dan mencerminkan kedua-dua pemprosesan kuantum dan klasik yang menyokongnya.

Anda juga mungkin menemui metrik penanda aras tambahan seperti CLOPS (Circuit Layer Operations Per Second) dan EPLG (Errors Per Layered Gate). CLOPS mengukur kelajuan pelaksanaan beban kerja penanda aras yang piawai, manakala EPLG memberikan gambaran tentang kadar ralat lapisan get dan ketepatan pemproses. Metrik ini kekal berguna untuk memahami ciri perkakasan tertentu dan beban kerja, tetapi qubit boleh diprogram, operasi qubit, dan litar maksimum sesaat menyediakan rangka kerja yang lebih luas untuk membandingkan sistem.
...
Dalam praktiknya, komputer kuantum hari ini paling baik difahami sebagai sistem hibrid. Komputer klasik mengorkestrakan aliran kerja &mdash; menyediakan input, menyusun litar kuantum, menjadualkan kerja, dan memproses hasil selepas &mdash; sementara QPU hanya melaksanakan bahagian kuantum pengiraan. Walaupun perkakasan kuantum berkembang maju, pembahagian tugas ini dijangka berterusan, dengan kemajuan memberi tumpuan kepada integrasi yang lebih rapat dan komunikasi yang lebih pantas antara sistem klasik dan QPU berbanding menghapuskan komponen klasik sepenuhnya.
...
- Litar kuantum berparameter sebagai model yang boleh dilatih
...
Jika Anda mahu tindak lanjut tentang bagaimana algoritma-algoritma ini sebenarnya berfungsi, pelajaran seterusnya akan menunjukkan ke mana pergi dari sini berdasarkan minat dan matlamat kerjaya Anda.
