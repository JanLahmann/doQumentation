---
description: 'Dalam pelajaran ini kita ubah geometri molekul ringkas, meminimumkan tenaga pada setiap langkah.'
...
# Menentukan geometri molekul {#determining-a-molecular-geometry}
...
Oleh sebab Hamiltonian akan berubah dengan setiap geometri baru, pentranspilan operator juga akan berubah pada setiap langkah. Walaupun begitu, kita masih boleh mentakrifkan pengurus laluan umum untuk digunakan pada setiap langkah, khusus untuk perkakasan yang ingin digunakan.
...
Kita import pengurus laluan dan pakej berkaitan untuk membantu kita mengoptimumkan litar kita. Langkah ini, dan langkah sebelumnya, adalah bebas daripada Hamiltonian, dan oleh itu tidak berubah daripada pelajaran sebelumnya.
...
## Langkah 4: Pasca-pemprosesan {#step-4-post-processing}
...
Ini mengakhiri kursus kita tentang VQE untuk kimia kuantum. Jika anda berminat untuk memahami beberapa teori maklumat asas yang digunakan dalam pengkomputeran kuantum, lihat kursus John Watrous tentang [Asas Maklumat Kuantum](/learning/courses/basics-of-quantum-information). Untuk contoh pendek tambahan aliran kerja VQE, lihat [tutorial Anggaran tenaga keadaan asas rantaian Heisenberg dengan VQE](/tutorials/spin-chain-vqe). Atau layari [tutorial](https://docs.quantum.ibm.com/tutorials) dan [kursus](/learning) untuk mencari lebih banyak bahan pendidikan tentang teknologi terkini dalam pengkomputeran kuantum.

Jangan lupa untuk menduduki peperiksaan kursus ini. Skor 80% atau lebih tinggi akan memperoleh lencana Credly untuk anda, yang akan dihantar secara automatik melalui e-mel kepada anda. Terima kasih kerana menjadi sebahagian daripada Rangkaian IBM Quantum&reg;!
