...
Menjelang akhir pelajaran ini, kita akan membahas:
...
Contohnya, semasa memuat turun perisian dari pelayan jauh, mekanisme yang cekap diperlukan untuk mengesahkan bahawa perisian yang dimuat turun itu tidak diubah sejak dicipta oleh pengarang perisian yang asal. Begitu juga, semasa mengesahkan pengguna aplikasi web, adalah lebih baik menggunakan mekanisme yang tidak melibatkan penyimpanan atau penghantaran kata laluan sebenar secara fizikal, yang boleh mendedahkan kerahsiaannya.
...
3. **Ketidakbolehbalikan:** CHF adalah <DefinitionTooltip definition="A mathematical function that is relatively easy to compute in one direction but extremely difficult to reverse.">*fungsi sehala*</DefinitionTooltip> dalam erti kata bahawa, diberikan sebuah digest, adalah tidak dapat dilaksanakan secara praktikal untuk menyongsangkan pencincangan dan mendapatkan semula input.
...
- **Tandatangan digital:** Hash kriptografi adalah penting untuk fungsi tandatangan digital kerana ia melibatkan perbandingan mesej yang dicincang secara kriptografi untuk membuktikan keaslian dan integriti sambil mengekalkan privasi.
...
*Rintangan pra-imej* bermakna bahawa diberikan sebuah digest, adalah tidak dapat dilaksanakan secara praktikal untuk mencari input.
...
*Perlanggaran hash kriptografi* berlaku apabila dua input menghasilkan digest yang sama. Walaupun perlanggaran tidak dapat dielakkan memandangkan sifat banyak-ke-satu CHF, CHF yang baik tetap menjadikannya tidak dapat dilaksanakan secara praktikal untuk mencari satu secara sesuka hati.
