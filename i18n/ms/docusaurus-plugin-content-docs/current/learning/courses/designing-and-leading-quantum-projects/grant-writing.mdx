...
Had apa yang mungkin dalam pengkomputeran kuantum berubah setiap hari. Tetapi penting untuk sentiasa mengingati kekangan semasa dalam menggariskan projek anda. Untuk maklumat terperinci tentang setiap komputer kuantum, malah setiap Qubit, semak [halaman sumber pengkomputeran](https://quantum.cloud.ibm.com/computers) pada [IBM Quantum Platform](https://quantum.cloud.ibm.com/).
Maklumat teknikal peringkat tinggi berikut mungkin berguna. Ini bukan had ketat yang terpakai kepada semua keadaan, tetapi garis panduan umum untuk disesuaikan dengan kes khusus anda.

**Bilangan Qubit** - Pemproses IBM Nighthawk mempunyai 120 Qubit. Sesetengah sistem mempunyai sedikit lebih banyak. Sistem ini menawarkan penyelidikan berskala utiliti untuk penemuan baharu yang tidak boleh diakses secara klasik.  
**Kedalaman litar** - Kedalaman litar maksimum bergantung pada banyak faktor. Pastikan anda mempertimbangkan kedalaman Gate dua-Qubit yang ditranspilkan sebagai ukuran utama kedalaman. Kedalaman dua-Qubit yang ditranspilkan sekitar 30 selalunya boleh diuruskan dengan teknik penyekatan dan mitigasi ralat moden. Beberapa aplikasi khusus mungkin menghadapi kesukaran pada kedalaman yang lebih rendah, dan sesetengah litar sudah tentu boleh melebihi itu. Ini adalah kedalaman yang baik untuk diterokai.  
