...
* **Kualiti** - Diukur dengan **Quantum Volume**, yang menunjukkan kualiti litar dan seberapa setia litar dilaksanakan dalam perkakasan.
* **Kelajuan** - Diukur dengan **CLOPS (Circuit Layer Operations Per Second)**, yang menunjukkan berapa banyak litar boleh dijalankan pada perkakasan dalam masa yang diberikan.
...
Untuk penerangan lebih terperinci tentang beberapa metrik di atas, lihat [artikel ini](https://www.ibm.com/quantum/blog/quantum-metric-layer-fidelity) di Blog Penyelidikan IBM. Setiap fasa dalam penggunaan pengkomputeran kuantum dalam industri didorong oleh peningkatan Quantum Volume, yang dikira menggunakan pelbagai parameter seperti lebar litar, kesambungan qubit, dan kadar ralat.
...
Menjelang 2029, kami akan menghantar Starling — komputer kuantum toleransi ralat berskala besar yang mampu menjalankan litar kuantum yang terdiri daripada 100 juta get kuantum pada 200 qubit logik. Kami sedang membina sistem ini sekarang di kemudahan bersejarah kami di Poughkeepsie, New York. Ketahui lebih lanjut tentang kemajuan kami dalam [PDF Peta Jalan Berpandu.](http://www.ibm.com/downloads/documents/us-en/131cf87ab63319bf)
