---
description: 'Kenali perbezaan antara gate kuantum, litar kuantum, dan komputer kuantum'
...
*   Mengenali perbezaan antara gate kuantum, litar kuantum, dan komputer kuantum
...
Sama seperti fotografi pra-filem berwarna dinamakan semula sebagai "fotografi hitam putih" selepas penciptaan filem berwarna, pengkomputeran pra-kuantum perlu mendapat nama baru. Istilah yang paling umum untuk pengkomputeran pra-kuantum adalah **pengkomputeran klasikal**. Perkataan "klasikal" dan "kuantum" mula menjadi penerang kepada perkataan "pengkomputeran," kerana begitulah saintis telah menerangkan perkataan "fizik," seperti dalam "fizik klasikal" dan "fizik kuantum."
...
Untuk memahami konsep teras pengkomputeran kuantum dengan lebih baik sehingga boleh membincangkannya, tonton [video](https://www.youtube.com/watch?v=OWJCfOvochA) ini daripada Talia Gershon, Pengarah Infrastruktur Hybrid Cloud di IBM Research&reg;. Gershon menerangkan pengkomputeran kuantum pada lima peringkat — kepada kanak-kanak, remaja, pelajar universiti, pelajar siswazah, dan profesional untuk majalah *WIRED*. Tonton sehingga tanda minit ke-06:17; namun, jangan ragu untuk menonton keseluruhan video.
...
Fizik kuantum mengandungi beberapa idea yang bercanggah dengan intuisi, seperti:

(a)   Sistem fizikal dalam keadaan yang pasti masih boleh bertindak secara rawak.

(b)   Dua sistem yang terlalu jauh untuk saling mempengaruhi antara satu sama lain entah bagaimana berkorelasi secara kuat.

(c)   Adalah mungkin untuk mempunyai keadaan dalam sistem kuantum yang tidak boleh digambarkan sebagai hasil darab komponen bebas qubit yang membentuk keadaan tersebut.
...
### Nilai perniagaan litar kuantum {#business-value-of-quantum-circuits}

Litar kuantum mewakili satu set arahan yang membolehkan kita memanipulasi qubit untuk memanfaatkan superposisi, keterikatan, dan interferens bagi menyelesaikan masalah yang kompleks. Tonton video di bawah untuk melihat bagaimana litar klasikal dan kuantum dibandingkan dan bagaimana litar kuantum boleh membawa nilai kepada perniagaan kamu.

<IBMVideo id="133345141" title="Dario Gil menerangkan litar kuantum dan gate yang membentuknya. Dia memotivasi nilai perniagaan komputer kuantum dengan menunjukkan keadaan pengiraan yang boleh direalisasikan secara serentak pada komputer kuantum."/>

### Semak kefahaman anda {#check-your-understanding-2}

Benar atau salah: litar kuantum bukanlah peranti fizikal.

<Accordion>
<AccordionItem title="Jawapan">

Benar. Litar kuantum adalah perwakilan abstrak satu set arahan yang membentuk algoritma kuantum. Kita boleh menggunakan alat visual seperti [IBM Quantum Composer](https://quantum.cloud.ibm.com/composer) atau kit pembangunan perisian (SDK) seperti [Qiskit](/guides/tools-intro) untuk membina litar kuantum.

</AccordionItem>
</Accordion>

### Mengaturcara litar kuantum {#programming-a-quantum-circuit}
