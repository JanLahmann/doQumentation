...
Benar. Circuit kuantum adalah perwakilan abstrak satu set arahan yang membentuk algoritma kuantum. Kita boleh menggunakan alat visual seperti IBM [Composer](https://quantum.cloud.ibm.com/composer) atau bahasa pengaturcaraan seperti [Qiskit](/guides/tools-intro) untuk membina Circuit kuantum.
