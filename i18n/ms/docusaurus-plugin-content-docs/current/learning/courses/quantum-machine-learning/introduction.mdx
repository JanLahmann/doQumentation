...
Salah. Kebanyakan masalah pembelajaran mesin diselesaikan dengan sangat cekap oleh algoritma klasik dan algoritma kuantum tidak berkemungkinan menawarkan sebarang peningkatan kelajuan yang besar. Matlamat dalam QML adalah untuk mencari set data dengan ciri yang diterangkan dengan baik oleh keadaan kuantum dan/atau mencari pemetaan ciri data yang mengoptimumkan ketepatan model.
...
5. Melaksanakan kaedah kernel kuantum dan pengelas kuantum variasi menggunakan primitif IBM Quantum dan mengikuti corak Qiskit.
...
Dalam proses di atas, kita mengira entri matriks kernel untuk titik data ke-14 dan ke-19. Nilai apakah yang sepatutnya kita perolehi jika kita menggunakan titik data yang sama dua kali, di sini (seperti ke-14 dan ke-14 lagi)? Dengan kata lain, apakah yang sepatutnya menjadi entri pepenjuru dalam matriks kernel? Jawab soalan ini tanpa kehadiran hingar, tetapi ambil perhatian bahawa sisihan daripada jawapan anda mungkin berlaku dengan kehadiran hingar.

<Accordion>
<AccordionItem title="Jawapan">

Pepenjuru sepatutnya bernilai 1.0. Proses ini sepatutnya mengira hasil darab dalam ternormal bagi sesuatu vektor dengan dirinya sendiri, yang mesti sentiasa bernilai satu.
