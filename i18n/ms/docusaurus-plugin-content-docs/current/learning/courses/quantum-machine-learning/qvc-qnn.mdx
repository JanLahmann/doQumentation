...
## Langkah Corak Qiskit 3: Laksanakan menggunakan primitif IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
Di sini kita dapat melihat bahawa sebahagian besar imej yang salah diklasifikasikan mempunyai garisan menegak. Ada sesuatu tentang model kita yang gagal menangkap maklumat tentang itu. Mungkin anda sudah dapat menjangkanya, berdasarkan litar varian pertama. Mari kita lihat lebih dekat.
...
## Langkah Corak Qiskit 3: Laksanakan menggunakan primitif IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
...
Adalah disyorkan untuk menyimpan parameter berat yang dikembalikan daripada pengiraan ini, sekiranya anda memutuskan untuk melakukan iterasi selanjutnya.
...
* Bina ansatz yang mengandungi lapisan putaran dan penghubungan yang sesuai untuk masalah anda.
...
* Jalankan ujian awal pada simulator untuk menyahpepijat dan mengoptimumkan ansatz anda.
