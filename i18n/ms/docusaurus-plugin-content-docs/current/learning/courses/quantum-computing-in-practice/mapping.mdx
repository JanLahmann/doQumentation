...
di mana $\sigma_+$ adalah operator Pauli $X + iY$ dan $\sigma_{-}$ adalah $X - iY.$ Setelah kita mempunyai Hamiltonian yang ditulis dalam format ini, bahagian yang sukar daripada peringkat pemetaan telah selesai, dan ia kini boleh ditulis dengan mudah ke litar dalam operator Pauli.
