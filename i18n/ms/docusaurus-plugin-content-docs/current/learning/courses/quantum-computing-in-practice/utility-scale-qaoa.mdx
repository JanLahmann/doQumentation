...
{/* doqumentation-source-hash: eaa71355 */}
...
1. mensimulasi alam (semula jadi)
...
#### Bina litar kuantum {#bina-circuit-kuantum}
...
1. keadaan percubaan awal, dalam kelabu, yang merupakan keadaan dasar pengadun, dicipta dengan menggunakan get Hadamard yang digunakan pada setiap qubit
