...
Bayangkan kita ingin menggunakan algoritma variational untuk mencari nilai eigen bagi observable berikut:
...
Seperti yang boleh anda lihat, hasilnya amat hampir dengan nilai ideal.
...
Bergantung pada sistem tertentu anda, ini mungkin atau mungkin tidak menghasilkan peningkatan dalam kelajuan atau ketepatan pada contoh berskala sangat kecil ini. Yang penting ialah bermula dengan keadaan rujukan yang bermotivasi secara fizikal menjadi semakin penting dalam meningkatkan kelajuan dan ketepatan apabila masalah berskala lebih besar.
...
Dengan bereksperimen menggunakan titik awal yang berbeza, anda mungkin boleh mencapai penumpuan lebih cepat dengan lebih sedikit penilaian fungsi.
