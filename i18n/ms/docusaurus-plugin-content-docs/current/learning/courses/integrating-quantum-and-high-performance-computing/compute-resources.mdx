...
* Unit pemprosesan kuantum (QPU): QPU merangkumi semua perkakasan yang bertanggungjawab untuk menerima set arahan kuantum yang boleh dilaksanakan, atau litar kuantum, dan mengembalikan jawapan yang tepat.
...
### Lapisan dalam litar kuantum {#layers-in-quantum-circuits}

Dalam pengiraan klasik dan kuantum, proses boleh dilaksanakan secara berurutan atau selari. Kerana qubit mempunyai ruang keadaan yang kaya berbanding bit klasik, kadangkala masuk akal untuk beberapa get satu-qubit dilaksanakan pada qubit secara berurutan (seperti get `R_x` diikuti dengan get `R_z`). Memandangkan keterjeratan antara qubit adalah kritikal dalam pengiraan kuantum, adalah perkara biasa untuk litar kuantum mempunyai set get pembelit yang bertindak merentasi banyak qubit. Faktor-faktor ini dan lainnya menjadikannya perkara biasa untuk mengenal pasti proses yang boleh dilaksanakan secara selari pada skala operasi get individu dalam litar kuantum. Dalam pengiraan klasik, keselarian peringkat bit juga mungkin tetapi kurang lazim dipertimbangkan pada peringkat get; adalah lebih biasa untuk merujuk kepada proses selari dan berurutan pada skala yang lebih besar.

Dalam pengiraan kuantum, seseorang merujuk kepada "lapisan" get yang semua boleh dilaksanakan serentak. Dalam banyak aplikasi, berguna untuk melakukan set putaran pada semua qubit dan kemudian get pembelit antara pasangan qubit. Dalam konteks ini, seseorang merujuk kepada "lapisan putaran" (lapisan get seperti `R_x`, `R_y`, dan/atau `R_z`) dan "lapisan pembelit" (seperti satu dengan get `CNOT`). Bilangan lapisan dalam litar ialah "kedalaman litar", ukuran penting kerana kedalaman yang lebih besar bermakna lebih banyak lapisan hingar dan ralat yang bergabung.

Boleh jadi sukar untuk mengenal pasti lapisan get secara visual apabila lapisan tidak disejajarkan menggunakan penghadang. Dalam Qiskit, penghadang berfungsi sebagai arahan dalam litar kuantum yang bertindak sebagai pemisah visual dan kekangan semasa penyusunan. Baik dalam melukis litar mahupun melaksanakannya, tiada get akan dipindahkan merentasi penghadang. Ini boleh menjadi penting dalam konteks seperti penyahgandingan dinamik, di mana seseorang dengan sengaja melaksanakan get yang memudahkan ke identiti untuk menekan jenis ralat tertentu. Untuk maklumat lanjut tentang penyahgandingan dinamik, lihat [panduan ini](/guides/error-mitigation-and-suppression-techniques). Untuk kesan visual penghadang, bandingkan dua imej litar yang sama ini, yang pertama tanpa penghadang dan yang kedua dengan penghadang untuk memaksa penjajaran lapisan.
...
Ini adalah litar yang sama dan mempunyai bilangan lapisan yang sama. Tetapi dalam yang kedua, penjajaran memudahkan untuk melihat bahawa litar mempunyai:
...
Kedalaman setiap litar ialah 9.

### Unit ukuran {#units-of-measure}

Dalam pengkomputeran kuantum, keupayaan sistem kuantum sering digambarkan menggunakan tiga dimensi asas: skala, kualiti, dan kelajuan. IBM Quantum mencirikan dimensi ini menggunakan tiga metrik perkakasan yang boleh digunakan merentasi modaliti pengkomputeran kuantum: qubit boleh diprogram (skala), operasi qubit (kualiti), dan bilangan maksimum litar per saat (kelajuan). Metrik ini menyediakan pandangan peringkat tinggi tentang keupayaan pengiraan dan kecekapan sesuatu sistem merentasi pelaksanaan perkakasan yang berbeza.

* **Skala** diukur berdasarkan bilangan qubit boleh diprogram. Qubit boleh diprogram ialah qubit yang boleh dikawal, dimanipulasi, diukur, dan digabungkan secara langsung ke dalam algoritma kuantum oleh pengguna.


* **Kualiti** diukur berdasarkan operasi qubit (QuOps), satu metrik yang menggambarkan berapa banyak operasi yang paling menuntut dari segi pengiraan yang boleh dilaksanakan dengan boleh dipercayai oleh sesuatu sistem sebelum ralat terkumpul menenggelamkan pengiraan tersebut. Keupayaan QuOps yang lebih tinggi secara amnya membolehkan litar yang lebih dalam dan algoritma kuantum yang lebih canggih.


* **Kelajuan** diukur berdasarkan bilangan maksimum litar per saat, juga dikenali sebagai throughput litar. Metrik ini menangkap berapa banyak litar kuantum yang berguna yang boleh dilaksanakan oleh sesuatu sistem dalam suatu tempoh masa dan memberikan petunjuk kecekapan pengiraan keseluruhan.


Metrik perkakasan tambahan sering digunakan untuk mencirikan aspek tertentu tingkah laku pemproses. Sebagai contoh, EPLG (errors per layered gate) dan pengukuran layer-fidelity memberikan gambaran tentang kualiti gate dan pengumpulan ralat, manakala CLOPS (Circuit Layer Operations Per Second) mengukur kelajuan pelaksanaan beban kerja penanda aras kuantum yang piawai. Metrik ini kekal berguna untuk menilai beban kerja dan butiran pelaksanaan tertentu, tetapi qubit boleh diprogram, operasi qubit, dan bilangan maksimum litar per saat menyediakan rangka kerja yang lebih luas untuk membandingkan sistem kuantum.

### Perbezaan antara metrik kuantum dan klasik {#differences-between-quantum-and-classical-metrics}

Sistem pengkomputeran klasik sering dicirikan menggunakan metrik seperti FLOPS (floating-point operations per second), kapasiti memori, lebar jalur memori, dan kadar jam pemproses. Beberapa analogi longgar boleh dibuat antara ini dengan metrik untuk komputer kuantum yang diperkenalkan di atas, tetapi perbezaan dalam metrik adalah penting.

Bilangan maksimum litar per saat boleh dilihat sebagai analogi longgar kepada metrik prestasi berorientasikan throughput dalam pengkomputeran klasik kerana ia mengukur berapa banyak kerja berguna yang boleh dilaksanakan oleh sistem kuantum dalam suatu tempoh masa. Namun, tidak seperti FLOPS, ia mengukur pelaksanaan litar kuantum dan bukannya operasi aritmetik.

CLOPS kadangkala dibandingkan dengan penanda aras throughput klasik seperti FLOPS, tetapi ia lebih baik difahami sebagai penanda aras khusus beban kerja dan bukannya ukuran sejagat prestasi pengkomputeran kuantum. EPLG dan pengukuran fideliti berkaitan memberikan gambaran tentang seberapa tepat sesuatu pemproses melaksanakan lapisan gate kuantum. Metrik ini berguna untuk memahami ciri perkakasan tertentu, manakala rangka kerja utama skala-kualiti-kelajuan menyediakan asas yang lebih umum untuk membandingkan sistem kuantum. Banyak penerangan tentang prestasi komputer kuantum boleh didapati pada halaman [Compute resources](https://quantum.cloud.ibm.com/computers) di IBM Quantum Platform. Perhatikan bahawa walaupun bilangan qubit boleh diprogram adalah nombor tetap untuk sesuatu QPU, metrik kelajuan dan kualiti boleh berubah sedikit dari semasa ke semasa disebabkan oleh kemas kini penentukuran, penyelenggaraan, keadaan operasi, dan penambahbaikan kepada infrastruktur perkakasan dan perisian sekeliling.

Secara bersama, metrik pelengkap ini membantu memandu peruntukan sumber, penjadualan, dan reka bentuk aplikasi pada sistem pengkomputeran kuantum.

Dalam banyak kes, keseluruhan sistem kuantum diperlakukan sebagai satu unit. Walau bagaimanapun, apabila tugas melebihi kapasiti satu unit — sama ada dari segi bilangan qubit yang boleh diprogramkan, kedalaman litar, atau lalu lintas litar — teknik seperti pemotongan/penganyaman litar boleh digunakan. Pemotongan litar ialah proses memecahkan tugas kuantum besar kepada sub-tugas yang lebih kecil dan terurus yang boleh diedarkan merentasi berbilang cip kuantum, membolehkan pengiraan kuantum berskala walaupun dengan had perkakasan. Penganyaman litar merujuk kepada proses yang berlaku selepas pemotongan litar — langkah pasca-pemprosesan klasik yang "menganyam" atau menggabungkan semula keputusan daripada sub-litar yang lebih kecil.
...
Satu langkah dalam anggaran sumber yang unik untuk pengiraan kuantum ialah kedalaman litar. Seperti yang dinyatakan sebelum ini, setiap get kuantum dan setiap masa kelewatan antara operasi datang dengan hingar dan kebarangkalian ralat tertentu. Semakin dalam litar kuantum, semakin besar hingarnya. Terdapat dua kerumitan di sini: get dua-qubit mempunyai kadar ralat yang jauh lebih tinggi daripada get satu-qubit, jadi seseorang sering boleh mengabaikan kedalaman satu-qubit. Lebih lanjut, tidak semua qubit pada cip kuantum disambungkan secara langsung. Kadangkala maklumat perlu ditukar dari qubit ke qubit untuk melakukan keterjeratan yang diperlukan dan proses penukaran itu sendiri memerlukan get dua-qubit. Penukaran itu dikendalikan dalam proses yang dipanggil "transpilasi", proses kompleks yang juga mempunyai tujuan lain; ini dibincangkan dengan lebih terperinci dalam pelajaran seterusnya. Kuantiti pengehad yang berkaitan ialah kedalaman dua-qubit yang telah ditranspilasi. Kedalaman maksimum yang tepat di mana keputusan berkesetiaan tinggi boleh diperoleh bergantung pada litar. Tetapi dengan memanfaatkan teknik mitigasi ralat moden, seseorang boleh mendapatkan keputusan berkesetiaan tinggi dengan kedalaman dua-qubit yang telah ditranspilasi sebanyak 80 atau lebih.
...
* Kerja dihantar oleh pengguna, memanfaatkan IBM Quantum Compute Service, dan biasanya menggunakan primitif IBM Quantum, seperti `Sampler`, `Estimator`, atau lainnya.
...
* Lelaran, sama ada untuk memastikan konsistensi diri melalui pertimbangan seperti pemuliharaan cas, dan kemungkinan lelaran litar kuantum jika ia mempunyai parameter variasi.

Perancangan - anggaran sumber

* Petakan orbit elektronik ke qubit untuk menetapkan bilangan qubit yang anda perlukan.

* Gabungkan Hamiltonian sistem yang dipetakan dan keadaan (mungkin variasi) ke dalam litar kuantum dan periksa kedalaman dua-qubit yang telah ditranspilasi. Pastikan ia munasabah.
...
* Pengguna memilih QPU; proses transpilasi secara automatik memetakan qubit dalam litar kuantum abstrak anda ke qubit fizikal pada QPU. Ini penting kerana litar abstrak mungkin mengandaikan sambungan langsung yang tidak wujud pada cip, antara sebab lain.

* Apabila kerja dihantar melalui Quantum Compute, kerja memasuki giliran untuk QPU yang dipilih. Pengguna tidak mempunyai kawalan ke atas masa giliran, walaupun ini mungkin berbeza untuk sistem yang didedikasikan.
...
* Sistem mengatur tertib dan masa langkah kuantum dan klasik sepanjang proses. Sebagai contoh, setelah matriks yang diunjurkan telah didiagonalkan dan tenaga keadaan asas diperoleh, bergantung pada kriteria konvergen, aliran kerja mungkin berulang kembali ke litar kuantum baharu (dengan parameter variasi baharu).
...
(c) Membahagikan ruang carian kepada rantau untuk setiap satu daripada (katakan 10) GPU anda untuk mencari
...
(b) Mengawal/menguruskan

(c) Memperuntukkan/menjadualkan
...
Perhatikan bahawa pada masa ini semua sumber kuantum dan klasik diperuntukkan untuk tempoh keseluruhan eksperimen. Pada masa ini tiada peruntukan berselang-seli sumber campuran. Peringatan terakhir ialah walaupun selepas kerja dilancarkan, sistem kuantum tidak akan dikawal secara langsung seperti yang dijangkakan oleh pengguna HPC yang kerap. Kerja dilancarkan pada nod x86 sewenang-wenangnya, yang melaksanakan IBM Quantum Compute Service dan perkhidmatan masa jalan itu menyambung ke penjadual lain yang tidak berada dalam kawalan langsung pengguna. Aliran kerja dan isu berkaitan ini mungkin diketahui oleh pengguna HPC yang mempunyai pengalaman awal mengejar akses eksklusif ke nod GPU (penggunaan asal `gres`).
...
(d) Ya, ia boleh. Ia menggunakan quantum partition.
...
```
Di sini kita akan menggunakan antara muka pengurusan sumber kuantum (QRMI), plugin Slurm SPANK untuk sokongan sumber dan kerja kuantum yang dibangunkan bersama oleh IBM, Pasqal, The Hartree Center, dan RPI. Kita membuat litar pauli-2-design yang mudah dengan nilai awal rawak dan observable yang mudah, dan kita akan menjalankannya menggunakan Estimator untuk mendapatkan nilai jangkaan. Untuk menjalankannya kita sekali lagi memerlukan skrip penghantaran `hello_qiskit.sh`, yang akan mempunyai sumber kuantum sebagai keperluan.
...
Mari tinjau fail penghantaran dan lihat apa yang berlaku di sana. Kita mempunyai satu pilihan baharu, iaitu `gres`. `gres` ialah pilihan Slurm untuk menentukan sumber pengiraan tambahan. Dalam kes kita, sumber baharu ini ialah sumber kuantum kita. Memandangkan kita menentukan sumber dan partition kluster kita di mana sumber kuantum tersedia, primitif IBM Quantum kita akan menggunakan sumber yang diperuntukkan ini untuk melaksanakan muatan kuantum.
