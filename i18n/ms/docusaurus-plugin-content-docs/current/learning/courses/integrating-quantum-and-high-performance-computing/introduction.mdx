...
{/* doqumentation-source-hash: bf48b61c */}
...
Misi kita jelas tetapi bercita-cita tinggi: untuk membekalkan Anda dengan pengetahuan konsep dan praktikal yang diperlukan untuk menggunakan teknologi-teknologi ini bagi menangani beberapa masalah paling sukar di dunia.
...
## Seni bina baharu {#new-architecture}

IBM telah memperkenalkan seni bina rujukan pengkomputeran super berpusatkan kuantum (QCSC) yang menggariskan bagaimana pemproses kuantum (QPU) boleh diintegrasikan terus dengan CPU dan GPU dalam persekitaran HPC moden. Pendekatan ini didorong oleh aliran kerja hibrid kuantum-klasik yang berjaya&mdash;seperti menggunakan kaedah sample-based quantum diagonalization (SQD) untuk simulasi molekul&mdash;yang sudah menunjukkan ketepatan setanding dengan teknik klasik lanjutan.

Seni bina ini direka untuk menjadi terbuka, modular, dan boleh disusun atur supaya sumber kuantum boleh disambungkan ke dalam aliran kerja HPC sedia ada tanpa memerlukan keseluruhan tindanan yang baharu. Integrasi awal dengan sistem seperti RIKEN dan Fugaku menunjukkan bahawa aliran kerja hibrid peringkat pengeluaran sudah boleh dilaksanakan. Ia menyediakan rangka kerja jangka panjang untuk mengembangkan reka bersama kuantum-klasik dalam dekad akan datang.
...
Tindanan ini merangkumi lapisan aplikasi yang menguraikan masalah merentasi komponen klasik dan kuantum, perisian tengah yang menghubungkan model pengaturcaraan klasik dengan penjanaan litar kuantum (contohnya, melalui antara muka Qiskit yang dikemas kini), dan lapisan pengorkestraan sistem yang mengurus penjadualan sumber hibrid menggunakan alat seperti Quantum Resource Management Interface (QRMI).

Pada peringkat perkakasan, seni bina ini mentakrifkan tiga peringkat:
* Sistem kuantum dengan QPU dan masa jalan klasik kependaman rendah (FPGA/ASIC).
* Sistem skala-naik CPU/GPU yang ditempatkan berhampiran dan disambungkan melalui interhubung hampir-masa untuk tugas seperti pengurangan ralat.
* Sistem skala-keluar yang menyediakan pengkomputeran klasik fleksibel untuk pra-pemprosesan, pasca-pemprosesan, dan beban kerja hibrid.

Secara keseluruhannya, IBM menempatkan seni bina QCSC sebagai peta jalan praktikal untuk pusat HPC mula menggabungkan perkakasan kuantum sebenar, membolehkan algoritma hibrid yang lebih berkuasa, dan menyediakan infrastruktur untuk sistem kuantum toleran-ralat pada masa hadapan. Untuk maklumat lanjut tentang seni bina ini, lihat [artikel ini](https://research.ibm.com/blog/quantum-centric-supercomputing-system-reference-architecture).
...
Kursus ini akan menggunakan alat dan konsep asas daripada pengkomputeran kuantum dengan ulasan pengenalan yang minimum. Kami mengesyorkan agar peserta mempunyai sekurang-kurangnya pengetahuan kerja tentang Qiskit, kebiasaan dengan get kuantum dan litar, dan sedikit pendedahan kepada algoritma berasaskan pensampelan. Sumber yang disenaraikan di bawah sepatutnya memberikan persediaan yang berguna.

* [Panduan IBM Quantum&reg; Composer](/guides/composer): Panduan melalui Composer, alat pengaturcaraan kuantum bergrafik yang membolehkan Anda menyeret dan menjatuhkan operasi untuk membina litar kuantum dan menjalankannya pada perkakasan kuantum.
* [Pengenalan kepada Qiskit](https://docs.quantum.ibm.com/guides): Satu set panduan untuk membantu Anda memasang dan mengkonfigurasi Qiskit.
* [Jalankan litar pertama anda pada perkakasan](/guides/hello-world): Tutorial ringkas mengenai Qiskit di mana Anda menyediakan dan menjalankan program kuantum pertama Anda.
...
Menjelang akhir kursus ini, Anda akan dapat melakukan lebih daripada sekadar mengulang istilah teknikal — Anda akan memahami cara menguruskan aliran kerja hibrid moden yang menugaskan sub-tugas tertentu kepada pemproses kuantum sementara CPU dan GPU mengendalikan kerja yang tinggal. Anda akan belajar cara menulis skrip untuk kerja yang beralih dengan lancar antara nod klasik dan QPU, mentafsir hasilnya dengan tepat, dan mengenal pasti di mana pecutan kuantum benar-benar boleh meningkatkan pengiraan (dan di mana tidak boleh). Sama pentingnya, Anda akan berlatih mengekalkan minda pertumbuhan: dalam bidang yang baru dan berkembang pesat, tiada sesiapa yang mempelajari segalanya sekaligus, dan kemajuan sebenar datang daripada lelaran, bereksperimen, dan bertanya soalan.
...
Anggap kursus ini sebagai landasan pelancaran Anda — tempat di mana Anda membina kit alat mental dan keyakinan diri untuk meneroka sempadan kuantum-klasik lama selepas Anda menamatkan pelajaran terakhir.
## Rujukan {#rujukan}
