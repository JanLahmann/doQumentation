...
{/* doqumentation-source-hash: ee2d80c2 */}
...
![Rajah litar kuantum yang menunjukkan qubit sebagai garis mendatar dan get kuantum sebagai kotak atau sambungan antara qubit.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/circuit.svg)
...
### Semak pemahaman Anda {#semak-pemahaman-kamu}
Berapa banyak qubit dalam litar di bawah?
![Rajah litar dengan empat garis mendatar dan banyak get.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/checkin-circuit.svg)
...
### Semak pemahaman Anda {#semak-pemahaman-kamu-2}
...
![Skema aliran kerja khusus untuk sample-based quantum diagonalization. Langkah-langkah termasuk litar kuantum variasianan, menggunakan pengukuran untuk memproyeksikan Hamiltonian ke dalam subruang, kemudian menggunakan pengoptimum klasik untuk mengemas kini parameter variasianan dalam litar dan mengulangi.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/sqd-workflow.svg)
