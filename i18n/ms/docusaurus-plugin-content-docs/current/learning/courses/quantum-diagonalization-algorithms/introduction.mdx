...
---
{/* doqumentation-source-hash: bfa5e18e */}
...
Kursus ini memberikan gambaran keseluruhan beberapa pendekatan untuk penepatan kuantum. Kami menyediakan latar belakang kaedah klasik yang digunakan, atau yang mendorong algoritma kuantum, dan membimbing anda melalui pelaksanaan algoritma kuantum pada komputer kuantum sebenar. Terdapat perbincangan menyeluruh tentang faktor-faktor yang menentukan skala pendekatan menggunakan algoritma klasik dan kuantum. Ini penting untuk menentukan sama ada masalah anda mendapat manfaat daripada algoritma kuantum tertentu. Dengan menghubungkan pendekatan matematik abstrak dengan perkakasan kuantum terkini, kurikulum ini memperkasakan peserta untuk menavigasi landskap teknik pengkomputeran kuantum yang berkembang pesat.
## Matlamat pembelajaran kursus {#matlamat-pembelajaran-kursus}

Dengan menamatkan kursus ini, anda dijangka membina kemahiran dan kecekapan teras berikut. Pelajar akan dapat:
...
Kursus ini terdiri daripada beberapa pelajaran. Setiap pelajaran mempunyai beberapa soalan semak sepanjang teks, supaya anda boleh mempraktikkan kemahiran baharu atau menyemak pemahaman anda semasa belajar. Ini tidak diwajibkan.

Di penghujung kursus, terdapat kuiz 20 soalan. Anda mesti mendapat sekurang-kurangnya 70% dalam kuiz ini untuk mendapatkan lencana Algoritma Penepatan Kuantum anda, melalui Credly. Jika anda mendapat sekurang-kurangnya 70%, lencana anda akan dihantar secara automatik melalui e-mel kepada anda, tidak lama selepas itu. Terdapat had bilangan kali kuiz ini boleh diambil. Lihat kuiz untuk maklumat lanjut.
