...
Ansatz ditulis menggunakan get yang biasa, tetapi litar kita mesti ditranspilasi untuk menggunakan get asas yang boleh dilaksanakan pada setiap komputer kuantum. Kita pilih Backend yang paling tidak sibuk.
...
Perhatikan bahawa get yang digunakan telah berubah, dan qubit dalam litar abstrak kita telah dipetakan kepada qubit bernombor berbeza pada komputer kuantum. Kita mesti memetakan Hamiltonian kita secara identik agar keputusan kita bermakna.
...
* Litar cetek: VQE sering menggunakan litar kuantum yang agak cetek. Ini menjadikan VQE kurang terdedah kepada ralat get yang terkumpul dan menjadikannya sesuai untuk banyak teknik pengurangan ralat. Sudah tentu, litar tidak selalunya cetek; ini bergantung pada ansatz yang digunakan.
...
1. **Kedalaman Litar yang Berkurang**: Dengan mengembangkan ansatz secara berperingkat dan hanya memberi tumpuan kepada operator yang diperlukan, ADAPT-VQE meminimumkan operasi get berbanding pendekatan VQE tradisional[\[5,7\]](#references).
...
3. **Kebolehskalaan dan Ketahanan Bunyi**: Ansatz yang padat mengurangkan pengumpulan ralat get, mengurangkan overhead pengkomputeran, dan mengehadkan bilangan parameter variasi yang mesti diminimumkan.

ADAPT-VQE masih tidak sempurna. Dalam sesetengah kes ia boleh terperangkap atau diperlahankan oleh minimum tempatan, dan ia mungkin mengalami over-parameterization. Ia juga boleh agak intensif sumber, kerana ia memerlukan pengiraan kecerunan dan pengoptimuman parameter dengan banyak struktur get.
