...
# Eksperimen berskala utility II {#utility-scale-experiment-ii}
...
## 1. Pengenalan dan ulasan evolusi masa {#1-introduction-and-review-of-time-evolution}

Notebook ini mengikuti kaedah dan teknik dalam pelajaran 7. Matlamat kita adalah untuk menyelesaikan persamaan Schrödinger bergantung-masa secara berangka. Seperti yang dibincangkan dalam pelajaran 7, Trotterisasi terdiri daripada aplikasi berturutan satu atau beberapa get kuantum yang dipilih untuk menganggarkan evolusi masa sesuatu sistem bagi satu kepingan masa. Kita ulangi perbincangan tersebut di sini untuk kemudahan. Boleh terus ke sel kod di bawah jika Anda baru sahaja menyemak pelajaran 7.
...
Beberapa eksponen yang sangat asas, seperti $e^{iZ}$, boleh dilaksanakan dengan mudah pada komputer kuantum menggunakan set get kuantum yang padat. Kebanyakan Hamiltonian yang menarik tidak akan mempunyai hanya satu sebutan, sebaliknya akan mempunyai banyak sebutan. Perhatikan apa yang berlaku jika $H = H_1+H_2$:
...
Tetapi apabila pengoperasi tidak bertukar-ganti, sebutan-sebutan tidak boleh disusun semula dalam siri Taylor untuk dipermudahkan dengan cara ini. Oleh itu, mengungkapkan Hamiltonian yang rumit dalam get kuantum adalah satu cabaran.
...
Di sini $t/r$ ialah kepingan masa (langkah evolusi) yang kita pilih. Hasilnya, satu get akan diaplikasikan sebanyak $r$ kali. Langkah masa yang lebih kecil menghasilkan penghampiran yang lebih tepat. Walau bagaimanapun, ini juga menghasilkan litar yang lebih dalam yang, secara praktikal, membawa kepada lebih banyak pengumpulan ralat (kebimbangan yang tidak boleh diabaikan pada peranti kuantum jangka hampir).
...
## 2. Mentakrifkan Hamiltonian Ising medan melintang {#2-defining-the-transverse-field-ising-hamiltonian}
...
#### Takrifkan Hamiltonian {#define-the-hamiltonian}
...
#### Tetapkan parameter simulasi evolusi masa {#set-the-parameters-of-the-time-evolution-simulation}
...
#### Sediakan litar kuantum (Keadaan awal) {#prepare-the-quantum-circuit-initial-state}
...
#### Sediakan litar kuantum 2 (litar tunggal untuk evolusi masa) {#prepare-the-quantum-circuit-2-single-circuit-for-time-evolution}
Di sini kita membina litar untuk satu langkah masa menggunakan Lie–Trotter.
...
$$
Mari kita kira operasi untuk litar ini.
...
#### Tetapkan pengoperasi yang akan diukur {#set-the-operators-to-be-measured}
...
#### Jalankan simulasi evolusi masa {#perform-time-evolution-simulation}
...
#### Plot evolusi masa bagi nilai boleh cerap {#plot-the-time-evolution-of-the-observables}
...
### 2.2 Aktiviti 2 {#22-activity-2}

#### Takrifkan Hamiltonian {#define-the-hamiltonian-1}
...
### 2.4 Aktiviti 4 {#24-activity-4}

#### Sediakan litar kuantum 2 (litar tunggal untuk evolusi masa) bagi masalah 70-qubit {#prepare-the-quantum-circuit-2-single-circuit-for-time-evolution-for-the-70-qubit-problem}
Di sini kita membina litar untuk satu langkah masa menggunakan Lie–Trotter.
...
Cuba sendiri, bina daripada contoh kes 20-qubit. Seperti sebelumnya, kira operasi untuk litar ini.
...
### 2.5 Aktiviti 5 {#25-activity-5}

#### Tetapkan pengoperasi yang akan diukur {#set-the-operators-to-be-measured-1}
...
### 2.6 Aktiviti 6 {#26-activity-6}

#### Jalankan simulasi evolusi masa {#perform-time-evolution-simulation-1}
Kita akan memantau kemagnetan (nilai jangkaan pengoperasi kemagnetan). Kita akan menggunakan simulator MPS untuk mendapatkan nilai rujukan bagi membandingkan keputusan yang dikira dari perkakasan. Anda telah menggunakan simulator MPS sebelum ini dalam tutorial ini. Ubah suai contoh tersebut mengikut keperluan pengiraan baru ini.
...
Seperti dalam semua pelajaran sebelumnya, kita akan melaksanakan rangka kerja corak Qiskit. Pelajaran sehingga titik ini telah difokuskan kepada membina litar kuantum yang betul untuk menerangkan masalah kita. Ini secara efektifnya adalah Langkah 1.
...
Kita transpilkan litar dan kumpulkan dalam satu senarai. Ini mungkin mengambil beberapa minit.
...
#### Langkah 4: Proses pasca keputusan {#step-4-post-process-results}
...
Kita akan menggunakan ini untuk perbandingan di bawah. Pertama, mari kita lihat sama ada kita boleh mengoptimumkan litar kita dengan lebih lanjut.
...
Tahniah! Anda telah melangkah lebih jauh dalam perjalanan kuantum berskala utiliti Anda. Hanya tinggal satu pelajaran lagi!
