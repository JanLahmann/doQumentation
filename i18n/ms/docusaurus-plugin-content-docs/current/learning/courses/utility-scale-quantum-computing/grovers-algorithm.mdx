...
## 1. Pengenalan kepada algoritma Grover {#1-introduction-to-grovers-algorithm}
...
### Struktur Asas Algoritma Grover {#the-basic-structure-of-grovers-algorithm}
...
## 2. Melaksanakan Algoritma Grover {#2-implementing-grovers-algorithm}

### 2.1 Persediaan {#21-preparation}
...
### Langkah 1: Petakan masalah kepada Circuit kuantum dan operator {#step-1-map-problem-to-quantum-circuits-and-operators}
...
### Langkah 2: Optimalkan untuk perkakasan sasaran {#step-2-optimize-for-target-hardware}

### 1: Permulaan {#1-initialization}
...
### 3: Operator Resapan {#3-diffusion-operator}
...
### 2.2 Contoh carian Grover 2-Qubit. {#22-a-2-qubit-grover-search-example}
...
### 2.3 Eksperimen dengan Simulator {#23-experiment-with-simulators}

### Langkah 3: Menjalankan Circuit. {#step-3-executing-the-circuit}
...
### Langkah 4: Memproses keputusan. {#step-4-post-processing-the-results}
...
## 3. Eksperimen dengan Peranti Sebenar {#3-experiment-with-real-devices}

### Langkah 2: Optimalkan untuk perkakasan sasaran {#step-2-optimize-for-target-hardware-1}
...
### Langkah 3: Menjalankan Circuit. {#step-3-executing-the-circuit-1}
...
### Langkah 4: Memproses keputusan. {#step-4-post-processing-the-results-1}
...
## 4. Carian Grover 3-Qubit {#4-a-3-qubit-grover-search}
