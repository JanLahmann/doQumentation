...
Mari gunakan contoh-contoh Backend ini untuk mendapatkan sebahagian maklumat yang Anda lihat pada halaman [Compute resources](https://quantum.cloud.ibm.com/computers)
di IBM Quantum&reg; Platform. Pertama, kita cipta contoh Backend untuk peranti yang diminati. Dalam contoh berikut, kita pilih "ibm_kyoto", "ibm_kawasaki" atau mesin Eagle yang paling kurang sibuk. Akses Anda kepada QPU mungkin berbeza; kemaskini nama Backend mengikut keperluan.
...
Cuba dapatkan maklumat asas tentang peranti Heron, "ibm_strasbourg". Cuba sendiri dulu, tetapi kod telah disediakan di bawah untuk Anda semak.
...
Sekarang kita lukis peta gandingan peranti. Seperti yang dapat Anda lihat, nod adalah qubit yang diberi nombor. Tepi menunjukkan pasangan yang boleh dikenakan gate pembelit 2-qubit secara langsung. Topologi ini dipanggil "kekisi hex berat" (heavy-hex lattice).
...
Kira median masa T2 bagi qubit-qubit tersebut. Cuba sendiri dulu, tetapi kod telah disediakan di bawah untuk Anda semak.
...
###  3.2 Ralat get dan bacaan {#32-gate-and-readout-errors}

Sekarang kita beralih kepada ralat get. Untuk permulaan, kita kaji struktur data bagi contoh Target. Ia adalah kamus yang kuncinya merupakan nama operasi.
...
Seperti yang dapat Anda lihat, ralat bacaan cenderung lebih besar berbanding operasi 2-qubit, yang seterusnya cenderung lebih besar daripada operasi 1-qubit.
...
Salah satu ciri popular Qiskit ialah keupayaan visualisasinya. Ini merangkumi visualizer litar, visualizer keadaan dan taburan, serta visualizer Target. Anda sudah menggunakan dua yang pertama dalam notebook Jupyter sebelumnya. Mari gunakan beberapa keupayaan visualizer Target.
