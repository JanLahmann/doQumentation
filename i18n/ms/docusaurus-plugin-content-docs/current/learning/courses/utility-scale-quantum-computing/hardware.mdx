...
Setelah memahami struktur data, kita sudah bersedia untuk mengira ralat median bagi get 'sx' dan 'ecr'. Sekali lagi, bandingkan hasilnya dengan yang ditunjukkan untuk peranti di [IBM Quantum Platform.](https://quantum.cloud.ibm.com/)
...
Salah satu ciri popular Qiskit ialah keupayaan visualisasinya. Ini merangkumi visualizer litar, visualizer keadaan dan taburan, serta visualizer Target. Kamu sudah menggunakan dua yang pertama dalam notebook Jupyter sebelumnya. Mari gunakan beberapa keupayaan visualizer Target.
