...
Kamu telah menyiapkan litar teleportasi kuantum! Jom tengok keadaan output litar ini menggunakan simulator statevector.
...
Kamu juga boleh semak status tugas dari [papan pemuka IBM Quantum&reg; Anda.](https://quantum.cloud.ibm.com/workloads)
...
Kamu boleh mentafsirkan keputusan di atas secara terus. Atau, menggunakan `marginal_count`, Anda boleh menyingkap keputusan Bob pada qubit 2.
