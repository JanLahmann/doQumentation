...
## 2. Matriks ketumpatan {#2-density-matrices}
...
## 3. Tomografi keadaan kuantum {#3-quantum-state-tomography}
...
### Menganggar nilai $r_z$ {#estimate-r-z-value}
...
### Latihan 1: Menganggar nilai $r_x$ {#exercise-1-estimate-r-x-value}
...
### Latihan 2: Menganggar nilai $r_y$ {#exercise-2-estimate-r-y-value}
