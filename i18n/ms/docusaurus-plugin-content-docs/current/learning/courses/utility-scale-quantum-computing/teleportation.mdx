...
Anda boleh lihat bahawa keadaan kuantum yang dicipta oleh gate $U$ pada qubit 0 (qubit yang pada asalnya menyimpan keadaan rahsia) telah dipindahkan kepada qubit 2 (qubit Bob).
...
### 5.2 litar kuantum yang mensimulasikan pengekodan superdense {#52-quantum-circuit-simulating-the-superdense-coding}

Berdasarkan protokol pengekodan superdense, Anda boleh membina litar pengekodan superdense seperti di bawah. Cuba tukar mesej, `msg`, yang Alice ingin hantar kepada Bob.
