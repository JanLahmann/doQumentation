...
## 2. Simulasi berhingar tanpa pengurangan ralat {#2-noisy-simulation-without-error-mitigation}
...
### 2.1 Bina litar ujian {#21-build-a-test-circuit}
...
### 2.2 Bina model hingar {#22-build-a-noise-model}
...
### 2.3 Bina Sampler berhingar dengan model hingar {#23-build-a-noisy-sampler-with-the-noise-model}
...
### 2.4 Jalankan litar kuantum pada Sampler berhingar {#24-run-quantum-circuits-on-the-noisy-sampler}
...
### 2.5 Plot keputusan {#25-plot-results}
...
### 2.8 Simulasi berhingar yang lebih realistik {#28-more-realistic-noisy-simulation}
