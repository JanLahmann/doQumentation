...
###  1.1 Keadaan GHZ {#11-keadaan-ghz}
...
### 1.2 Matlamat anda {#12-matlamat-anda}
...
Anda boleh tetapkan pilihan penindasan ralat dalam Sampler V2. Rujuk panduan [Konfigurasi pengurangan ralat](/guides/configure-error-mitigation#advanced-error) dan rujukan API [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) untuk maklumat lanjut.
...
Anda perlu mencari Circuit GHZ dengan bilangan Qubit terbesar yang memenuhi kriteria. Tulis kod anda di bawah, tunjukkan keputusan dengan fungsi `check_ghz_fidelity_from_jobs`.
...
Tahniah kerana berjaya menamatkan kursus ini! Sila luangkan masa untuk membantu kami memperbaiki kursus kami dengan mengisi [kaji selidik ringkas](https://your.feedback.ibm.com/jfe/form/SV_5vvmdT5yFFetkgK) berikut. Maklum balas anda akan digunakan untuk meningkatkan kandungan dan pengalaman pengguna kami. Terima kasih!
