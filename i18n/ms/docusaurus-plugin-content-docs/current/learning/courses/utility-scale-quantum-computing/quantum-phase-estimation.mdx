---
description: 'Kursus ini akan mengajar anda tentang QFT, yang memainkan peranan penting dalam banyak algoritma kuantum'
...
Bersama-sama, QFT dan QPE membentuk tulang belakang penting bagi banyak algoritma kuantum yang menyelesaikan masalah yang tidak dapat dilakukan oleh komputer klasik. Menjelang akhir buku nota ini, anda akan memahami bagaimana teknik-teknik ini dilaksanakan.

## 2. Asas Transformasi Fourier Kuantum (QFT) {#2-basic-of-quantum-fourier-transformation-qft}
...
### 2.3 Perwakilan hasil darab QFT {#23-product-representation-of-qft}
...
### 2.4 Contoh: Pembinaan Circuit QFT 3 qubit {#24-example-circuit-construction-of-3-qubits-qft}
...
#### Penyelesaian latihan: QFT {#solution-of-the-exercise-qft}
(1)
...
#### Penyelesaian latihan: $\theta = 1/3$ {#solution-of-the-exercise-theta-13}
...
## 4. Pelaksanaan menggunakan primitif Sampler IBM Quantum {#4-execution-using-the-ibm-quantum-sampler-primitive}
