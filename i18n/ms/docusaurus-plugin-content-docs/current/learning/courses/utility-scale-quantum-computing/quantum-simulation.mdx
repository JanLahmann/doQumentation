...
### 2.3 Sediakan Circuit kuantum 1 (Keadaan awal) {#23-prepare-the-quantum-circuit-1-initial-state}
...
### 2.4 Sediakan Circuit kuantum 2 (Circuit tunggal untuk evolusi masa) {#24-prepare-the-quantum-circuit-2-single-circuit-for-time-evolution}

Di sini kita membina satu Circuit untuk satu langkah masa menggunakan Lie–Trotter.
...
### 2.7 Plot evolusi masa bagi pemerhati {#27-plot-the-time-evolution-of-the-observables}
...
$$
### 3.1 Bina Circuit untuk satu langkah masa {#31-construct-a-circuit-for-a-single-time-step}
Gunakan product_formula_st2 (SuzukiTrotter(order=2)) dan bina Circuit untuk satu langkah masa menggunakan Suzuki–Trotter peringkat kedua. Selain itu, kira bilangan Gate dan kedalaman Circuit serta bandingkan dengan Lie–Trotter.
...
#### Bina Circuit untuk eksperimen perkakasan {#construct-circuit-for-hw-experiment}
...
Kemudian kita transpilkan Circuit untuk Backend yang dipilih.
...
Di sini kita menunjukkan contoh pembinaan Circuit menggunakan Suzuki–Trotter peringkat lebih tinggi (peringkat keempat).
Sekarang mari kita cuba membina simulasi Circuit dengan Suzuki–Trotter peringkat keempat mengikuti contoh yang ditunjukkan di atas.
...
$$
#### Bina Circuit untuk satu langkah masa {#construct-a-circuit-for-a-single-time-step}
Gunakan product_formula_st4 (SuzukiTrotter(order=4)) dan bina Circuit untuk satu langkah masa menggunakan Suzuki–Trotter peringkat keempat. Juga, kira bilangan Gate dan kedalaman Circuit serta bandingkan dengan Lie–Trotter dan Suzuki–Trotter peringkat kedua.
