...
## 3. Latihan 1. Lakukan simulasi menggunakan Suzuki–Trotter peringkat kedua {#3-exercise-1-perform-simulation-using-second-order-suzukitrotter}
...
### 3.3 Plot keputusan Suzuki–Trotter peringkat kedua {#33-plot-the-second-order-suzukitrotter-results}
...
### 4.3 Langkah 3. Laksanakan dengan primitif IBM Quantum {#43-step-3-execute-with-ibm-quantum-primitives}
