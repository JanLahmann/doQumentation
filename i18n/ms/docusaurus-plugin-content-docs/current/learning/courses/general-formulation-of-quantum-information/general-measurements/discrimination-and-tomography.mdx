...
Kita boleh memaksimumkan kebarangkalian tekaan yang betul dengan memilih pengukuran projektif $\{\Pi_0,\Pi_1\}$ seperti berikut.
...
Kita kemudiannya boleh memilih pengukuran *projektif* seperti berikut.
...
Untuk *sebarang* pengukuran $\{P_0,P_1\}$ (tidak semestinya projektif) kita boleh menulis kebarangkalian ketepatan seperti berikut.
