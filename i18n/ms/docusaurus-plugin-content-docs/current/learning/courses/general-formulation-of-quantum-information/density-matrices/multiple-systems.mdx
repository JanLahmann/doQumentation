...
Untuk mengira keadaan teraruh $\rho_{\mathsf{A}}$ misalnya, kita boleh menggunakan sifat linear bersama fakta bahawa
...
Keadaan teraruh $\rho_{\mathsf{B}}$ boleh dikira dengan cara yang sama.
...
Keadaan teraruh sistem pertama $\mathsf{A}$ ialah
...
dan keadaan teraruh sistem kedua $\mathsf{B}$ ialah
