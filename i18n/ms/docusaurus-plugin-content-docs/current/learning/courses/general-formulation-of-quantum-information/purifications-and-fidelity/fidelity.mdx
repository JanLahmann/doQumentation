...
3. Fideliti antara keadaan adalah tidak menurun di bawah tindakan mana-mana saluran. Iaitu, jika $\rho$ dan $\sigma$ adalah matriks ketumpatan dan $\Phi$ adalah saluran yang boleh menerima kedua-dua keadaan ini sebagai input, maka semestinya
kes itu adalah
   $$
   \operatorname{F}(\rho,\sigma) \leq \operatorname{F}(\Phi(\rho),\Phi(\sigma)).
   $$
4. *Ketaksamaan Fuchs-van de Graaf* mewujudkan hubungan rapat (walaupun tidak tepat) antara fideliti dan jarak surih: untuk mana-mana dua keadaan $\rho$ dan $\sigma$ kita mempunyai
   $$
