...
- Langkah 3: Laksanakan kerja anda pada komputer kuantum IBM menggunakan primitif IBM Quantum
...
"Sampler" adalah primitif yang direka untuk mengambil sampel keadaan yang mungkin terhasil dari litar kuantum, dan mengumpulkan statistik tentang keadaan-keadaan yang mungkin diukur dan dengan kebarangkalian berapa. Kita mengimport Sampler IBM Quantum di sini:
...
### Langkah 1: Petakan masalah anda ke litar kuantum {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Langkah 3: Laksanakan {#step-3-execute-1}
...
### Soalan Betul/Salah {#truefalse-questions}
