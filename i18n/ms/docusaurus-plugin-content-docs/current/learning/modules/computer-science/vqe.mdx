...
Gunakan [hukum Coulomb](https://en.wikipedia.org/wiki/Coulomb%27s_law) dan [unit atomik](https://en.wikipedia.org/wiki/Atomic_units) untuk memastikan kamu mendapat nilai dalam `Hartree`.
