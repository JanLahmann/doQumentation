...
Terangkan apa yang anda fikir akan berlaku dalam situasi seperti yang diterangkan di atas. Iaitu, anda mempunyai magnet yang sangat kecil pada tahap atom yang tidak dapat melesapkan sebarang tenaga sebagai haba. Jadi, sebarang tenaga potensi magnet awal mesti kekal dalam sistem. Namun, daya kilas dikenakan oleh medan magnet luaran, yang cuba memutarkan magnet kecil itu untuk menjajarkannya dengan medan luaran. Apakah yang berlaku?

<Accordion>
<AccordionItem title="Answer">

Momen magnet kecil itu akan berputar ke arah penjajaran dengan medan luaran. Tetapi apabila ia menjajar seketika, ia akan mempunyai tenaga kinetik putaran yang akan membuatkannya terus berputar melepasi medan tersebut dan keluar semula daripada penjajaran. Tingkah laku ini boleh dilihat juga dalam magnet klasik yang besar. Tetapi dalam sistem klasik itu, ayunan momen magnet kecil itu akhirnya berhenti apabila tenaga dilesapkan menjadi haba. Tetapi dalam sistem tanpa mekanisme lesapan sedemikian, ayunan itu sepatutnya berterusan tanpa henti.

</AccordionItem>
</Accordion>

Memandangkan tingkah laku yang dijangkakan dalam jawapan di atas, apakah taburan zarah magnet yang anda jangkakan untuk dilihat pada skrin?
...
Untuk menjalankan eksperimen kita pada komputer kuantum sebenar, kita perlu memuatkan Perkhidmatan Pengkomputeran Kuantum IBM Quantum, dan memilih komputer kuantum (atau "Backend"). Di bawah, kita hanya memilih komputer kuantum yang paling kurang sibuk yang tersedia untuk kita.
...
### Langkah 1: Petakan input klasik kepada masalah kuantum {#step-1-map-classical-inputs-to-a-quantum-problem-1}
