...
### Cipta Circuit untuk dipotong {#create-a-circuit-to-cut}
...
### Nyatakan observable {#specify-an-observable}
...
### Cipta Circuit baru di mana arahan `Move` telah diletakkan di lokasi pemotongan yang dikehendaki {#create-a-new-circuit-where-move-instructions-have-been-placed-at-the-desired-cut-locations}
...
### Cipta observable untuk Circuit baru {#create-observable-to-go-with-the-new-circuit}
...
### Kira overhed pensampelan bagi pemotongan yang dipilih {#calculate-the-sampling-overhead-for-the-chosen-cuts}
