...
![Rajah Circuit kuantum](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_1.png)

```python
circuits[-1].draw("mpl", scale=0.4, fold=-1)
```

![Rajah Circuit kuantum](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_2.png)
...
![Rajah Circuit kuantum](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_3.png)
