...
d. QPU — Masukkan anti-bunyi bising dan jalankan. Laksanakan litar yang diminati dengan anti-bunyi bising (bunyi bising songsang) yang ditentukan menggunakan anotasi `Box`.
