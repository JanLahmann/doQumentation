...
Hasilnya ialah litar yang mengekalkan kedalaman satu langkah Trotter tetapi mencapai ketepatan setara banyak langkah Trotter, menjadikannya boleh dilaksanakan pada perkakasan kuantum jangka terdekat.
...
Bahagian ini menggunakan sistem 10-tapak untuk menggambarkan aliran kerja AQC-Tensor langkah demi langkah. Kita mensimulasikan dinamik rantai spin XXZ 10-tapak, satu model yang dikaji secara meluas untuk memeriksa interaksi spin dan sifat magnet.
