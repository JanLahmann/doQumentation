...
#### 1. **Qiskit Transpiler dengan SABRE** {#1-qiskit-transpiler-with-sabre}
...
Circuit yang digunakan dalam penanda aras ini diambil daripada [repositori penanda aras Hamlib](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation), yang mengandungi beban kerja simulasi Hamiltonian yang realistik.
