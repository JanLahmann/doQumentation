...
### Sediakan backend dan peta gandingan {#set-up-backend-and-coupling-map}
...
### Eksperimen pencirian {#characterization-experiments}
...
#### Pencirian ralat persediaan keadaan dan pengukuran (SPAM) {#state-preparation-and-measurement-spam-error-characterization}
...
#### Penandaarasan rawak satu-Qubit dan dua-Qubit {#single-qubit-and-two-qubit-randomized-benchmarking}
...
### Sifat QPU dari masa ke masa {#qpu-properties-over-time}
...
### Laksanakan Circuit kuantum dengan pemilihan qubit lalai {#execute-a-quantum-circuit-with-default-qubit-selection}
...
### Laksanakan Circuit kuantum dengan pemilihan qubit masa nyata {#execute-a-quantum-circuit-with-real-time-qubit-selection}
...
Tidak semua larian akan menunjukkan peningkatan prestasi disebabkan pencirian masa-nyata - dan dengan panjang rantai yang meningkat, dan oleh itu kurang kebebasan untuk memilih qubit fizikal, kepentingan maklumat peranti terkini menjadi kurang substansial. Namun, adalah amalan baik untuk mengumpul data terkini mengenai ciri-ciri peranti untuk memahami prestasinya. Kadang kala, sistem dua-aras sementara boleh menjejaskan prestasi sebahagian qubit. Data masa-nyata boleh memaklumkan kita bila peristiwa sedemikian berlaku dan membantu kita mengelakkan kegagalan eksperimen dalam keadaan sedemikian.
<Admonition type="note" title="Seruan tindakan">
Cuba gunakan kaedah ini pada pelaksanaan anda dan tentukan berapa banyak manfaat yang anda peroleh! Anda juga boleh mencuba dan melihat berapa banyak penambahbaikan yang anda peroleh daripada backend yang berbeza.
</Admonition>
...
> **Nota:** Kajian ini adalah oleh **IBM Quantum** dan meliputi **kandungan tutorial** (ditulis oleh IBM). doQumentation menyediakan laman web, terjemahan, dan pelaksanaan kod — untuk maklum balas mengenai perkara tersebut, sila [buka isu GitHub](https://github.com/JanLahmann/doQumentation/issues).

[Pautan ke kajian](https://your.feedback.ibm.com/jfe/form/SV_0w6FZ9QrWkKfTQq)
