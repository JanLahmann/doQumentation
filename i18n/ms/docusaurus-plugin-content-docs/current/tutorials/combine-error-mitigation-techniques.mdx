---
description: 'Gabungkan pilihan mitigasi ralat untuk eksperimen skala utiliti menggunakan QPU IBM Quantum 100Q+ dan primitif Estimator IBM Quantum.'
...
Tutorial ini meneroka pilihan penindasan ralat dan mitigasi ralat yang tersedia dengan primitif Estimator IBM Quantum. Tutorial ini menunjukkan cara melaksanakan setiap kaedah berikut secara individu:
...
Di sini anda akan menghantar lima kerja berasingan, bermula tanpa penindasan atau mitigasi ralat, kemudian menghidupkan pelbagai pilihan penindasan dan mitigasi ralat secara berurutan yang tersedia dalam Perkhidmatan Pengkomputeran Kuantum IBM Quantum. Untuk maklumat tentang pilihan tersebut, rujuk halaman berikut:
...
Kerana kerja-kerja ini boleh dijalankan secara bebas antara satu sama lain, anda boleh menggunakan [mod batch](/guides/run-jobs-batch) untuk membolehkan Quantum Compute mengoptimumkan masa pelaksanaannya.
