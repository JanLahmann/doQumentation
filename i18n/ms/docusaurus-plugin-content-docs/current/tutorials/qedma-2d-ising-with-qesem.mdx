...
* Menunjukkan penggunaan [operator backpropagation (OBP)](https://qiskit.github.io/qiskit-addon-obp/) untuk mengurangkan kedalaman litar. Teknik ini memangkas operasi dari penghujung litar dengan kos pengukuran operator yang lebih banyak.
...
Sekarang kita akan menggunakan operator backpropagation (OBP). (Lihat dokumentasi [OBP](https://qiskit.github.io/qiskit-addon-obp/) untuk maklumat lanjut tentang tambahan OBP Qiskit.) Kita akan mencipta fungsi yang menjana hirisan litar untuk backpropagation:
