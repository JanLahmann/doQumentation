...
{/* doqumentation-source-hash: 440bdc90 */}
...
> **Nota:** Kaji selidik ini disediakan oleh **IBM Quantum** dan merangkumi **kandungan tutorial** (ditulis oleh IBM). doQumentation menyediakan laman web, terjemahan, dan pelaksanaan kod — untuk maklum balas tentang perkara-perkara tersebut, sila [buka isu GitHub](https://github.com/JanLahmann/doQumentation/issues).
