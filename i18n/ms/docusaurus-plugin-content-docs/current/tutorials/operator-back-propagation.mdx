...
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop), pakej berakselerasi Rust untuk perambatan Pauli, dengan tutorial yang merangkumi OBP, anggaran nilai jangkaan klasik, dan simulasi berlingar
</Admonition>
