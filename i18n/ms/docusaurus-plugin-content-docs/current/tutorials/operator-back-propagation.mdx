...
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop), pakej berakselerasi Rust untuk perambatan Pauli, dengan [tutorial](https://github.com/Qiskit/pauli-prop/tree/main/docs/tutorials) yang merangkumi OBP, anggaran nilai jangkaan klasik, dan simulasi berlingar
</Admonition>
