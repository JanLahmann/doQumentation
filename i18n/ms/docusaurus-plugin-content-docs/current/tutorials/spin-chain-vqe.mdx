...
# Penganggaran tenaga keadaan asas rantaian Heisenberg dengan VQE {#ground-state-energy-estimation-of-the-heisenberg-chain-with-vqe}
...
## Deploy corak Qiskit ke awan {#deploy-the-qiskit-pattern-to-the-cloud}
