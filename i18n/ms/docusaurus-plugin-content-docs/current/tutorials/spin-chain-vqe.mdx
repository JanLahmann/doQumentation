...
- Cara melaksanakan aliran kerja variatif pada perkakasan kuantum IBM&reg; menggunakan primitif dan sesi IBM Quantum
...
Minimumkan tenaga keadaan-asas sistem yang dianggarkan dengan mengoptimumkan parameter Circuit. Gunakan primitif IBM Quantum `Estimator` untuk menilai fungsi kos semasa pengoptimuman.

Memandangkan kita telah mengoptimumkan Circuit untuk backend dalam Langkah 2, kita boleh mengelak transpilasi pada pelayan Quantum Compute dengan menetapkan `skip_transpilation=True` dan menghantar Circuit yang telah dioptimumkan. Untuk demo ini, kita akan jalankan pada QPU menggunakan primitif IBM Quantum. Untuk menjalankan dengan primitif berasaskan statevector `qiskit`, gantikan blok kod yang menggunakan primitif IBM Quantum dengan blok yang dikomentari.
