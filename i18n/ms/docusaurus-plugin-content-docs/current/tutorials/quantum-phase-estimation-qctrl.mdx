...
## Persediaan {#setup}
Mula-mula, sahkan diri menggunakan [kunci API IBM Quantum](http://quantum.cloud.ibm.com/). Kemudian, pilih Fungsi Qiskit seperti berikut. (Kod ini mengandaikan anda telah [menyimpan akaun anda](/guides/functions-get-started#install-qiskit-functions-catalog-client) ke persekitaran tempatan anda.)
...
Simulasi menetapkan garis dasar untuk eigenphase yang betul. Larian perkakasan lalai menunjukkan hingar yang mengaburkan keputusan ini, kerana hingar menyebarkan kebarangkalian merentasi banyak bitstring yang salah. Dengan Pengurusan Prestasi Q-CTRL, taburan menjadi lebih tajam dan keputusan yang betul dapat dipulihkan, membolehkan QPE yang boleh dipercayai pada skala ini.
...
Ambil masa sebentar untuk memberi maklum balas tentang tutorial ini. Pandangan anda akan membantu kami memperbaiki kandungan dan pengalaman pengguna kami.
