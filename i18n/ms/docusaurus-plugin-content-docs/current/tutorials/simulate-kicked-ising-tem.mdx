...
- **`default_shots`**: Sebagai ganti `precision`, anda boleh menentukan bilangan shots yang digunakan dalam kerja pengukuran.
...
Pilihan tersuai juga boleh dihantar kepada pembelajaran hingar. Definisi yang digunakan mengikut yang terdapat dalam [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options) `qiskit-ibm-runtime`:
