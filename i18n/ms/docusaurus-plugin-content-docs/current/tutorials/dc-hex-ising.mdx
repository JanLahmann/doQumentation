...
Selepas kerja selesai, kita boleh ambil semula tempoh litar daripada metadata keputusan kerja dan visualisasikan maklumat jadual litar. Untuk baca lebih lanjut tentang visualisasi maklumat penjadualan litar, rujuk [halaman ini](/guides/qiskit-runtime-circuit-timing).
