---
description: 'Gunakan fractional gate, gate berparameter yang secara langsung melaksanakan putaran sudut sewenang-wenangnya, untuk mengurangkan kedalaman dan tempoh litar kernel quantum.'
notebook_path: tutorials/fractional-gates.ipynb
sidebar_label: 'Kernel quantum dengan fractional gates'
title: 'Kernel quantum dengan fractional gates'
---
...
Selepas melalui tutorial ini, anda sepatutnya memahami:
- Apakah fractional gates dan bagaimana ia mengurangkan kedalaman dan tempoh litar pada QPU IBM&reg;
...
Kami mencadangkan anda biasa dengan topik berikut sebelum melalui tutorial ini:
- Aliran kerja [Qiskit patterns](/guides/intro-to-patterns)
- Panduan [Fractional gates](/guides/fractional-gates)
- Tutorial [Quantum kernel training](/tutorials/quantum-kernel-training) dan pelajaran [Quantum kernels](/learning/courses/quantum-machine-learning/quantum-kernel-methods) dalam kursus Quantum machine learning

## Latar belakang {#background}

### Fractional gates pada IBM QPUs {#fractional-gates-on-ibm-qpus}
...
Dengan memanfaatkan interaksi asli antara qubit fizikal, kamu boleh melaksanakan beberapa unitari dengan lebih cekap pada perkakasan.
...
### Pendekatan aliran kerja untuk kekangan sudut RZZ {#workflow-approaches-for-the-rzz-angle-constraint}
...
Terdapat dua pendekatan untuk memastikan syarat ini dipenuhi, seperti yang kita bincangkan di bawah. Kita mengesyorkan pendekatan kedua, dan dalam tutorial ini, kita menunjukkannya melalui contoh yang diilhamkan oleh kaedah kernel quantum.
Untuk lebih memahami di mana kernel quantum berkemungkinan berguna, kami mengesyorkan membaca [Liu, Arunachalam & Temme (2021)](https://www.nature.com/articles/s41567-021-01287-z).

Kamu juga boleh melalui tutorial [Quantum kernel training](/tutorials/quantum-kernel-training) dan pelajaran [Quantum kernels](/learning/courses/quantum-machine-learning/quantum-kernel-methods) dalam kursus Quantum machine learning di IBM Quantum&reg; Learning.
...
#### 1. Jana nilai parameter yang memenuhi kekangan sudut RZZ {#1-generate-parameter-values-that-satisfy-the-rzz-angle-constraint}
...
#### 2. Tetapkan nilai parameter kepada litar sebelum transpilasi {#2-assign-parameter-values-to-circuits-before-transpilation}
...
Lihat [qiskit-ibm-runtime#2441](https://github.com/Qiskit/qiskit-ibm-runtime/issues/2441) untuk menjejaki kemajuan isu ini.
Kami mengesyorkan penyelesaian sementara berikut sehingga ia diselesaikan.
...
### Aktifkan fractional gates dan semak basis gates {#enable-fractional-gates-and-check-basis-gates}
...
Dalam bahagian ini, kita melalui empat langkah aliran kerja [Qiskit patterns](/guides/intro-to-patterns) pada simulator, menggunakan litar kernel quantum sebagai contoh praktikal.

### Langkah 1: Petakan input klasikal kepada masalah quantum {#step-1-map-classical-inputs-to-a-quantum-problem}

#### Circuit kernel quantum {#quantum-kernel-circuit}
...
Walaupun Qiskit menyediakan `zz_feature_map` terbina dalam, ia tidak menyokong RZZ gates setakat Qiskit v2.4.1 ([lihat isu](https://github.com/Qiskit/qiskit/issues/14469)).
...
### Langkah 2: Optimumkan masalah untuk pelaksanaan perkakasan quantum {#step-2-optimize-problem-for-quantum-hardware-execution}
...
### Perbandingan aliran kerja dan Circuit tanpa fractional gates {#comparison-of-workflow-and-circuit-without-fractional-gates}
...
### Perbandingan kedalaman, tempoh, dan fidelity {#comparison-of-depths-durations-and-fidelities}
...
Kita transpilasikan litar menggunakan hanya fractional RX gates, mengecualikan gate RZZ.
Dengan memperkenalkan peraturan penguraian tersuai, seperti yang ditunjukkan berikut,
...
- Panduan [Fractional gates](/guides/fractional-gates)
- [Bila *tidak* menggunakan fractional gates](/guides/fractional-gates#when-not-to-use)
- Rujukan API laluan transpiler [`FoldRzzAngle`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/transpiler-passes-fold-rzz-angle)
