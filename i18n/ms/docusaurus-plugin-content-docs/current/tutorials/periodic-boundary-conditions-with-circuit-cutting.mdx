...
> **Nota:** Kaji selidik ini dijalankan oleh **IBM Quantum** dan meliputi **kandungan tutorial** (ditulis oleh IBM). doQumentation menyediakan laman web, terjemahan, dan pelaksanaan kod — untuk maklum balas mengenai perkara tersebut, sila [buka isu GitHub](https://github.com/JanLahmann/doQumentation/issues).

[Pautan ke kaji selidik](https://your.feedback.ibm.com/jfe/form/SV_3fQQYAIjTxvIChg)
