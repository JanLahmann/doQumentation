...
### Penyediaan dataset {#dataset-preparation}
...
### Langkah 4: Pasca-proses dan kembalikan keputusan dalam format klasikal yang dikehendaki {#step-4-post-process-and-return-result-in-desired-classical-format}

### Takrifkan projected quantum kernel {#define-the-projected-quantum-kernel}
...
### Penanda aras klasikal {#classical-benchmarking}
...
## Lampiran: Sahkan potensi kelebihan kuantum dataset dalam tugasan pembelajaran {#appendix-verify-the-datasets-potential-quantum-advantage-in-learning-tasks}
