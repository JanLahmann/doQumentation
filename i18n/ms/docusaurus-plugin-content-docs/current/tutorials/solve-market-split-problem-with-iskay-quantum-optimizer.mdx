...
**Kaedah penalti:**
Oleh sebab $Ax = b$ perlu dipenuhi dengan tepat, kita meminimumkan pelanggaran kuasa dua:
$$f(x) = ||Ax - b||^2$$
...
**Penyelesaiannya**: bf-DCQO menggunakan protokol counterdiabatic untuk membolehkan evolusi cepat sambil mengekalkan kesetiaan (fidelity) keadaan asas, mengurangkan kedalaman circuit secara dramatik.
...
Dalam pengoptimuman kuantum adiabatik, kita mengevolusikan sistem mengikut Hamiltonian bergantung masa:
...
Sel ini akan tersekat (menunggu) sehingga kerja selesai. Proses pengoptimuman merangkumi:
...
**Sebutan counterdiabatic**: Membolehkan evolusi kuantum yang cepat sambil mengekalkan kesetiaan (fidelity) keadaan asas, menjadikan pengoptimuman kuantum praktikal pada perkakasan yang bising hari ini [\[1\]](#references).
