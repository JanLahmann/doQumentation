...
- **`pm_2` (lebih banyak ujian)**: Meneroka sepuluh kali lebih banyak calon mendapati susun atur yang sedikit lebih cetek, tetapi purata ketepatan agak rata (dan boleh jatuh di bawah garis dasar dalam lingkungan bunyi) kerana peningkatan kedalaman adalah kecil pada skala ini.
...
- **`decay`** (lalai): Menimbang qubit secara dinamik berdasarkan aktiviti terkini, mengecilkan swap berulang pada qubit yang sama.
