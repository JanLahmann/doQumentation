...
# Migrasi ke primitif Qiskit Runtime V2 {#migrate-to-the-qiskit-runtime-v2-primitives}
...
<Admonition type="tip" title="Cadangan">
    - Ketahui lebih lanjut tentang menetapkan pilihan dalam panduan [Pilihan Sampler](/guides/sampler-options), [Pilihan Estimator](/guides/estimator-options), dan [Pilihan Executor](/guides/executor-options).
    - Ketahui lebih lanjut tentang [Input dan output primitif](/guides/primitive-input-output#pubs).
