...
Langkah-langkah dalam topik ini menerangkan cara menyediakan Sampler, meneroka pilihan yang boleh kamu gunakan untuk mengkonfigurasinya, dan memanggilnya dalam program.
{/*
...
Ikuti langkah-langkah dalam topik [Sediakan akaun IBM Cloud kamu](/guides/cloud-setup) jika kamu belum menyediakan akaun.
...
- Ketahui cara mentransail secara tempatan dalam bahagian [Transpil](transpile/).
