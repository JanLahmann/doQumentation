---
description: 'Cara menjalankan kerja pengkomputeran kuantum dalam Session IBM Quantum Compute Service.'
...
Sebelum memulakan Session, anda perlu [menyediakan klien IBM Quantum Compute](/guides/install-qiskit-runtime) dan memulakannya sebagai perkhidmatan:
...
Untuk gambaran keseluruhan komprehensif konfigurasi dan status Session, gunakan `session.details() method`.
