...
Qiskit Runtime ialah perkhidmatan berasaskan awan untuk melaksanakan pengiraan kuantum pada perkakasan IBM Quantum. Pakej `qiskit-ibm-runtime` adalah klien untuk perkhidmatan tersebut, dan merupakan pengganti kepada Qiskit IBM Provider. Perkhidmatan Qiskit Runtime memperkemas pengiraan kuantum dan menyediakan implementasi optimum primitif Qiskit untuk perkakasan IBM Quantum. Untuk memulakan dengan primitif, layari [dokumentasi](/guides/primitives).
