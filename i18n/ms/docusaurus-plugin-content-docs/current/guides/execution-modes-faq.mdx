---
description: 'Jawapan kepada soalan yang kerap ditanya tentang mod pelaksanaan'
...
<Accordion>
  <AccordionItem title="Adakah `qiskit-ibm-runtime` mod pengujian setempat menyokong mod pelaksanaan yang berbeza?">
