...
Backend tiruan `FakeSherbrooke` daripada `qiskit_ibm_runtime` digunakan dalam contoh ini, tetapi anda boleh mencubanya pada mana-mana Backend sebenar atau tiruan yang serasi dengan Qiskit. Keputusan anda mungkin berbeza.
</Admonition>

Pertama, mari transpil menggunakan tahap pengoptimuman 0.
...
Melaraskan tahap pengoptimuman juga boleh mengubah aspek lain Circuit, bukan sekadar bilangan Gate ECR. Untuk contoh bagaimana menetapkan tahap pengoptimuman mengubah susun atur, lihat [Mewakili komputer kuantum](/guides/represent-quantum-computers).
