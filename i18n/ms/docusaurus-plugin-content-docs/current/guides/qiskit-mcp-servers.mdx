...
Menyediakan akses kepada perkhidmatan awan IBM Quantum melalui IBM Quantum Compute Service. Ini membolehkan pembantu AI berinteraksi dengan backend kuantum, menghantar kerja, dan mendapatkan keputusan.
...
Untuk IBM Quantum Compute Service, atau Pelayan MCP Qiskit IBM Transpiler:
