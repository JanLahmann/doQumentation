...
* [Keterikatan jarak jauh yang cekap](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339) antara qubit pada cip yang sama dengan menggunakan shallow circuits

* [Persampelan cekap bagi circuit seperti-IQP](https://arxiv.org/pdf/2505.04705)
Qiskit menyokong empat konstruk aliran kawalan untuk maklum balas hadapan klasik, setiap satu dilaksanakan sebagai kaedah pada [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit). Konstruk dan kaedah yang sepadan adalah:
