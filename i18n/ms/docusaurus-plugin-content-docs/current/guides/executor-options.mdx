...
<Tabs>
  ...
  - Twirling ukuran tidak serasi dengan arahan [`store`](https://docs.quantum.ibm.com/api/qiskit/circuit#store).
  ...
  <TabItem value="Fractional" label="Get pecahan">
  Tidak serasi dengan:
  - Twirling get
  - PEA
  - PEC
  ...
  <TabItem value="ZNE" label="ZNE lipatan get">
    Tidak serasi dengan:
  - Litar dinamik
  - PEA
  - PEC
  ...
  <TabItem value="Twirling" label="Twirling get">
