---
description: 'Panduan permulaan pantas tentang cara menggunakan primitif IBM Quantum Estimator.'
...
### 3. Mulakan IBM Quantum Estimator {#3-initialize-the-ibm-quantum-estimator}
...
- Ketahui cara mentranspil secara tempatan dalam bahagian [Transpil](/guides/transpile/).
