...
`Operators` unitari boleh dimasukkan terus ke dalam `QuantumCircuit` menggunakan kaedah `QuantumCircuit.append`. Ini menukar `Operator` kepada objek `UnitaryGate`, yang ditambah ke dalam Circuit.
