...
![litar quantum](/docs/images/guides/composer/2H-circuit.svg "Litar yang terdiri daripada lajur Hadamard yang mencipta superposisi sama rata bagi keadaan asas pengiraan, diikuti oleh Gate controlled-Z (CZ) dua Qubit.")

![Paparan kebarangkalian bagi litar sebelumnya](/docs/images/guides/composer/probabilities.svg "Paparan kebarangkalian bagi litar sebelumnya.")
...
![litar quantum](/docs/images/guides/composer/2H-circuit.svg)

![paparan q-sphere](/docs/images/guides/composer/q-sphere.avif)
...
![paparan statevector](/docs/images/guides/composer/state-vector.svg "Statevector di penghujung litar di atas. Roda warna memetakan sudut fasa kepada warna. Keadaan output dinyatakan sebagai senarai nombor kompleks.")
