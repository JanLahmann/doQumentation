...
## Apa yang boleh ia lakukan? {#what-can-it-do}
...
## Lawatan antara muka {#tour-of-the-interface}
...
## Bina, edit, dan semak Circuit kuantum {#build-edit-and-inspect-quantum-circuits}
...
### 2. Bina Circuit anda dengan seret dan lepas {#2-build-your-circuit-with-drag-and-drop}
...
#### Bina operasi tersuai menggunakan ciri kumpulan {#build-a-custom-operation-using-the-group-feature}
...
#### Nyahkumpul operasi tersuai atau pra-takrifan {#ungroup-a-custom-or-predefined-operation}
...
#### Kembangkan takrifan operasi {#expand-an-operations-definition}
...
#### Namakan semula atau padam operasi tersuai {#rename-or-delete-a-custom-operation}
...
#### Tambah atau buang daftar {#add-or-remove-registers}
...
#### Tambah syarat bersyarat {#add-a-conditional}
...
#### Tambah pengubah kawalan {#add-a-control-modifier}
...
#### Gambaran visual dengan cakera fasa sepanjang Circuit anda {#visualize-with-phase-disks-throughout-your-circuit}
...
#### Eksport imej Circuit {#export-a-circuit-image}
...
### 3. Bina Circuit anda dengan kod OpenQASM {#3-build-your-circuit-with-openqasm-code}
...
Jejari cincin hitam mewakili kemurnian terkurang keadaan Qubit, yang untuk Qubit $j$ dalam keadaan $N$-Qubit $|\psi\rangle$ diberikan oleh $\mathrm{Tr}\left[\mathrm{Tr}_{i\neq j}[\left|\psi\rangle\langle\psi\right|\right]^{2}]$. Kemurnian terkurang untuk Qubit tunggal berada dalam julat $[0.5, 1]$; nilai satu menunjukkan bahawa Qubit tidak terjalin dengan mana-mana pihak lain. Sebaliknya, kemurnian terkurang sebesar $0.5$ menunjukkan bahawa Qubit berada dalam keadaan campuran sepenuhnya, dan mempunyai tahap keterjalinan tertentu ke atas baki $N-1$ Qubit, dan mungkin juga persekitaran.
