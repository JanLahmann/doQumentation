...
Lengkapkan arahan dalam topik [Install](/guides/install-c-api) untuk memasang perkara berikut:

- Rangkaian alat penyusun C standard untuk platform anda

- Versi Python yang merangkumi header C API-nya. 


Anda juga seharusnya biasa dengan, atau bersedia untuk mencari, fungsi dan objek yang tersedia
dalam [Qiskit C API](https://docs.quantum.ibm.com/api/qiskit-c), dan seharusnya mempunyai sedikit kebiasaan dengan pengaturcaraan C.
...
Tetapkan versi masa jalan Qiskit dalam
`project.dependencies` supaya sepadan dengan versi minor yang digunakan semasa waktu binaan.
