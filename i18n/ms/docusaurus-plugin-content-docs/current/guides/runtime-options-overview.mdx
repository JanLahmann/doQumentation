---
description: 'Pilihan yang tersedia untuk membina dengan primitif IBM Quantum'
...
Anda boleh menggunakan pilihan untuk menyesuaikan primitif IBM Quantum mengikut keperluan anda.
