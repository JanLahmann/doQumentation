...
Akaun ini mengandungi pelbagai **pengguna** dan **instans perkhidmatan** (seperti IBM Quantum Compute Service). Setiap instans perkhidmatan wujud dalam **rantau** tertentu dan mempunyai satu **pelan**, jadi jika anda ingin mempunyai beberapa pelan yang tersedia untuk pengguna anda, anda akan mempunyai beberapa instans perkhidmatan, setiap satu dikaitkan dengan pelan yang berbeza.
...
Peranan **akses perkhidmatan** mentakrifkan tindakan yang dibenarkan, seperti memanggil API perkhidmatan atau mengakses papan pemuka perkhidmatan. Peranan ini disesuaikan berdasarkan perkhidmatan yang dipilih dalam polisi. Dalam konteks panduan-panduan ini, perkhidmatan sentiasa Quantum Compute.
...
Jadual berikut memberikan contoh untuk beberapa tindakan pengurusan platform yang boleh dilakukan oleh pengguna dalam konteks IBM Quantum Compute Service.
...
<Admonition type="tip" title="Cadangan">
  ...
  -  Fahami [Peranan IAM](https://cloud.ibm.com/iam/roles) (pilih Quantum Compute dari menu lungsur di bahagian atas halaman).
</Admonition>
