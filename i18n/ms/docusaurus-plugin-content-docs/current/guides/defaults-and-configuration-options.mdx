...
- Pelajari cara [Tetapkan tahap pengoptimuman](/guides/runtime-options-overview).
...
- Pelajari [cara mentranspil litar](/guides/circuit-transpilation-settings) sebagai sebahagian daripada aliran kerja corak Qiskit.
