---
description: 'Contoh praktikal penggunaan primitif Sampler IBM Quantum.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Contoh Sampler'
title: 'Contoh Sampler'
---
...
Gunakan Sampler untuk mengembalikan hasil ukuran sebagai bitstring atau kiraan bagi satu Circuit.
...
Gunakan Sampler untuk mengembalikan hasil ukuran sebagai bitstring atau kiraan bagi berbilang Circuit dalam satu kerja.
...
## Gunakan kumpulan dan pilihan lanjutan {#use-batches-and-advanced-options}

Terokai [mod pelaksanaan](/guides/execution-modes) kumpulan dan pilihan lanjutan untuk mengoptimumkan prestasi Circuit pada QPU.
...
- Fahami [Had kerja](/guides/job-limits) apabila menghantar kerja kepada QPU IBM&reg;.
</Admonition>
