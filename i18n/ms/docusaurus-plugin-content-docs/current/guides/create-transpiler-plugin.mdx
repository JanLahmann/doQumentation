...
Dalam contoh ini, kami akan mencipta plugin sintesis unitar yang hanya menggunakan laluan transpilasi terbina dalam [UnitarySynthesis](https://docs.quantum.ibm.com/api/qiskit/qiskit.transpiler.passes.UnitarySynthesis#unitarysynthesis) untuk mensintesis get. Sudah tentu, plugin anda sendiri akan melakukan sesuatu yang lebih menarik daripada itu.
...
dan mengembalikan [DAGCircuit](https://docs.quantum.ibm.com/api/qiskit/qiskit.dagcircuit.DAGCircuit) yang mewakili litar yang disintesis daripada matriks unitar tersebut.
...
seperti peta gandingan, set get yang disokong, dan sebagainya
...
objek peringkat tinggi ditakrifkan, sekiranya sintesis dilakukan pada litar fizikal.
...
yang mewakili litar yang disintesis daripada objek peringkat tinggi tersebut.
...
<Admonition type="tip" title="Cadangan">
    ...
    - Semak [tutorial](https://docs.quantum.ibm.com/tutorials) untuk contoh-contoh mentranspil dan menjalankan litar kuantum.
</Admonition>
