...
| -----| -----------| -------- | ------- |
| `estimate_time_only` |  `"analytical"`  / `"empirical"` / None  | Apabila ditetapkan, kerja QESEM hanya akan mengira anggaran masa QPU. Sila lihat penerangan berikut untuk maklumat lanjut. Apabila ditetapkan kepada None, litar akan dilaksanakan dengan QESEM| None |
