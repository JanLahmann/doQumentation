...
Qiskit tidak mempunyai fungsi terbina untuk memplot keputusan Estimator, tetapi anda boleh menggunakan plot [`bar`](https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.bar.html) Matplotlib untuk visualisasi pantas.

Untuk demonstrasi, sel berikut menganggar nilai jangkaan tujuh kebolehcerap berbeza pada keadaan kuantum.
