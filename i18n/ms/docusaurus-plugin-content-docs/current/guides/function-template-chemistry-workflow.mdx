...
Yang penting, pengguna perlu menentukan `number_of_shots`, yang sepadan dengan bilangan pengukuran dalam litar LUCJ. Bilangan shot perlu mencukupi kerana langkah pertama prosedur S-CORE bergantung pada sampel dalam sektor zarah yang betul untuk mendapatkan anggaran awal taburan nombor pekerjaan keadaan asas.
