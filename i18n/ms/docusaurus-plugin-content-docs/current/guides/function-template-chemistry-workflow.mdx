...
# Gunakan dan jalankan templat untuk simulasi struktur elektronik dengan model pelarut tersirat {#deploy-and-run-a-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
Templat ini, yang dibangunkan bersama Cleveland Clinic, terdiri daripada aliran kerja untuk mengira tenaga keadaan asas dan tenaga solvasi bebas bagi sesuatu molekul dalam pelarut tersirat [[1]](#references). Simulasi ini berasaskan kaedah diagonalisasi kuantum berasaskan sampel (SQD) [[2-6]](#references) dan model kontinum boleh polarisasi formalisme persamaan kamiran (IEF-PCM) bagi pelarut [[7]](#references).
...
#### 2. Optimumkan Circuit {#2-optimize-the-circuit}
...
<details>
<summary> Klik untuk maklumat lanjut tentang pilihan yang diperlukan: </summary>
...
<details>
<summary> Klik untuk maklumat lanjut tentang mengkonfigurasi pilihan SQD:</summary>
...
- Semak panduan membina templat fungsi untuk [simulasi Hamiltonian](./function-template-hamiltonian-simulation)
