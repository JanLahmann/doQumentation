...
## Kamus Output: {#output-dictionaries}
...
### Penerangan kamus `metadata` {#description-of-the-metadata-dictionary}
...
### Penerangan kamus `all_samples_metrics` {#description-of-the-all-samples-metrics-dictionary}
