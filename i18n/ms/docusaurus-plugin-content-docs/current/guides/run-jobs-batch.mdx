---
description: 'Cara menjalankan kerja pengkomputeran kuantum dalam mod batch menggunakan IBM Quantum Compute Service.'
...
Sebelum memulakan batch, anda perlu [menyediakan klien IBM Quantum Compute](/guides/install-qiskit) dan memulakannya sebagai perkhidmatan:
...
Untuk gambaran keseluruhan komprehensif konfigurasi dan status batch, termasuk TTL interaktif dan maksimumnya, gunakan `batch.details() method`.
