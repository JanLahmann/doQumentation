---
title: "Contoh-contoh primitif"
sidebar_label: "Contoh-contoh primitif"
description: "Contoh praktikal menggunakan primitif dalam Qiskit Runtime."
...
Contoh-contoh dalam bahagian ini menggambarkan beberapa cara biasa untuk menggunakan primitif. Sebelum menjalankan contoh-contoh ini, ikuti arahan dalam [Pasang dan sediakan.](install-qiskit)
...
## Contoh-contoh Estimator {#estimator-examples}
...
Blok kod berikut akan mengembalikan ralat bagi pengguna Pelan Terbuka kerana ia menggunakan Session. Beban kerja Pelan Terbuka hanya boleh dijalankan dalam [mod kerja](/guides/execution-modes#job-mode) atau [mod kelompok](/guides/execution-modes#batch-mode).
</Admonition>
...
## Contoh-contoh Sampler {#sampler-examples}
...
<Admonition type="tip" title="Cadangan">
    ...
    - Pelajari cara mentranspil secara tempatan dalam bahagian [Transpiler](./transpile/).
