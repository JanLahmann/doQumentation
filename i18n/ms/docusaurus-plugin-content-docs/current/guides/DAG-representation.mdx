...
Dalam DAG, terdapat tiga jenis nod graf: nod input Qubit/clbit (hijau), nod operasi (biru), dan nod output (merah). Setiap tepi menunjukkan aliran data (atau kebergantungan) antara dua nod. Gunakan fungsi qiskit.tools.visualization.dag_drawer() untuk melihat DAG Circuit ini. (Pasang [pustaka Graphviz](https://graphviz.org/download/) untuk menjalankan ini.)
