...
Apabila mencipta litar kuantum, anda juga mesti mempertimbangkan jenis data yang anda mahu dikembalikan selepas pelaksanaan. Qiskit menyediakan dua cara untuk mengembalikan data: anda boleh mendapatkan output pensampelan untuk set qubit yang anda pilih untuk diukur, atau anda boleh mendapatkan nilai jangkaan bagi sesebuah boleh cerap. Sediakan beban kerja anda untuk mengukur litar anda dengan salah satu daripada dua cara ini menggunakan primitif Qiskit (diterangkan secara terperinci dalam [Langkah 3](#step-3-execute-using-the-quantum-primitives)).
