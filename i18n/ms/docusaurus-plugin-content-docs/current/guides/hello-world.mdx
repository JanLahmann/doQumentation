...
1. Jika anda belum memasang Qiskit, cari arahan dalam panduan [Quickstart](/guides/quick-start).
    ...
    - Pasang klien IBM Quantum Compute untuk menjalankan kerja pada perkakasan kuantum:
...
2. Sediakan pengesahan anda untuk akses ke perkakasan kuantum melalui [Pelan Terbuka](/guides/plans-overview#open-plan) percuma.
    ...
    - Pergi ke [IBM Quantum Platform](https://quantum.cloud.ibm.com/) untuk log masuk atau membuat akaun.
         ...
         Jika anda menyambung melalui pelayan proksi, anda mesti menggunakan `qiskit-ibm-runtime` v0.44.0 atau lebih baharu.
         </Admonition>
...
3. Kini anda boleh menggunakan kod Python ini bila-bila masa anda mahu mengesahkan diri ke IBM Quantum Compute Service:
...
Apabila mencipta litar kuantum, anda juga mesti mempertimbangkan jenis data yang anda mahu dikembalikan selepas pelaksanaan. Qiskit menyediakan dua cara untuk mengembalikan data: anda boleh mendapatkan output pensampelan untuk set qubit yang anda pilih untuk diukur, atau anda boleh mendapatkan nilai jangkaan bagi sesebuah boleh cerap. Sediakan beban kerja anda untuk mengukur litar anda dengan salah satu daripada dua cara ini menggunakan primitif (diterangkan secara terperinci dalam [Langkah 3](#step-3-execute-using-the-quantum-primitives)).
...
### Langkah 2. Optimumkan litar dan operator {#step-2-optimize-the-circuits-and-operators}
