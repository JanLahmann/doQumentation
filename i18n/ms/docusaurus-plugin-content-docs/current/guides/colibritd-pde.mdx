...
$u$ mewakili medan kelajuan cecair. Kes penggunaan ini mempunyai syarat sempadan temporal: anda boleh memilih keadaan awal dan kemudian membenarkan sistem mencapai keseimbangan. Buat masa ini, satu-satunya syarat awal yang diterima ialah fungsi linear: $ax + b$.
