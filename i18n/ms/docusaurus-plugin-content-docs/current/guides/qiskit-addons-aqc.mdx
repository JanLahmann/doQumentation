...
# Pengkompilan kuantum anggaran dengan rangkaian tensor (AQC-Tensor) {#approximate-quantum-compilation-with-tensor-networks-aqc-tensor}
...
## Pasang pakej AQC-Tensor {#install-the-aqc-tensor-package}
...
### Penjanaan ansatz {#ansatz-generation}
...
### Simulasi rangkaian tensor {#tensor-network-simulation}
