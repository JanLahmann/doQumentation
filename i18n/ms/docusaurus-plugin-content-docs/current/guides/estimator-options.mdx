...
Nota :
<Admonition type="note" title="Nota tentang menentukan pilihan dalam primitif Estimator">
...
### Kemas kini pilihan selepas inisialisasi {#update-options-after-initialization}
...
Kelas pilihan `EstimatorV2` ([`EstimatorOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-estimator-options)) tidak perlu dipasang jika kamu menetapkan pilihan selepas menginisialisasi primitif.
...
Parameter ketepatan ini hanya untuk menentukan ketepatan _sasaran_, dan keputusan tidak dijamin akan mencapai ketepatan yang dinyatakan.
</Admonition>
