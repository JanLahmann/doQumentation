...
Kod berikut mengandaikan bahawa anda telah mengikuti proses untuk menyimpan kelayakan anda dengan menggunakan `QiskitRuntimeService.save_account`, dan akan memuatkan akaun lalai yang anda simpan melainkan anda menyatakan sebaliknya. Lihat [Simpan kelayakan log masuk anda](/guides/save-credentials) dan [Mulakan akaun IBM Quantum Compute Service anda](/guides/initialize-account) untuk maklumat lanjut.
