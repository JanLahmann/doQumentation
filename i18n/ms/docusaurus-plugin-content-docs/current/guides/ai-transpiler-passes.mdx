...
Rujuk [dokumentasi Perkhidmatan Transpiler Qiskit](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) untuk maklumat lanjut tentang had yang terpakai pada transpiler passes berkuasa AI.

## Petikan {#citation}

Jika anda menggunakan sebarang ciri berkuasa AI daripada Perkhidmatan Transpiler Qiskit dalam penyelidikan anda, gunakan [petikan yang disyorkan](/guides/qiskit-transpiler-service#citation).
