...
## Circuit N-tempatan {#n-local-circuits}
...
Anda juga boleh menggunakan ini untuk menetapkan parameter ini kepada nilai sebenar menggunakan kamus dalam bentuk `{ Parameter: number }`. Untuk menunjukkan, sel kod berikut menetapkan setiap parameter dalam circuit kepada `0`.
...
## Circuit pengekodan data {#data-encoding-circuits}
...
## Circuit evolusi masa {#time-evolution-circuits}
...
## Circuit penanda aras dan teori kerumitan {#benchmarking-and-complexity-theory-circuits}
...
## Circuit aritmetik {#arithmetic-circuits}
...
<Admonition type="tip" title="Cadangan">
  -  Pelajari kaedah lanjutan untuk mencipta Circuit dalam topik [Bina Circuit](/guides/construct-circuits).
