---
description: 'Contoh praktikal penggunaan primitif Executor dalam qiskit-ibm-runtime.'
...
### Sediakan litar {#set-up-the-circuit-1}
...
### Laksanakan litar-litar {#execute-the-circuits-1}
