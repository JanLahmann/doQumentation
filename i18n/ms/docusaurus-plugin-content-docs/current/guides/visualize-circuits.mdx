...
Argumen `fold` menetapkan lebar maksimum untuk output. Dalam penderia `text`, ini menetapkan panjang baris rajah sebelum ia dibalut ke baris seterusnya. Apabila menggunakan penderia 'mpl', ini adalah bilangan lapisan (visual) sebelum dibalut ke baris seterusnya.
