---
description: 'Migrasi daripada penggunaan simulator awan IBM Quantum kepada mod ujian tempatan `qiskit-ibm-runtime`.'
...
<Accordion>
<AccordionItem title="Simulator mempunyai batasan">
...
<AccordionItem title="Penggunaan perkakasan kuantum membina kemahiran unik">
...
<AccordionItem title="Algoritma perlu disesuaikan untuk perkakasan kuantum">
...
## Migrasi ke simulator tempatan {#migrate-to-local-simulators-1}
