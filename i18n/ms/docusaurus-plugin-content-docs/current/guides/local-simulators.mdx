...
# Migrasi daripada simulator awan kepada simulator tempatan {#migrate-from-cloud-simulators-to-local-simulators}
...
## Mengapa simulator awan ditamatkan? {#why-are-the-cloud-simulators-being-retired}
...
## Bilakah simulator patut digunakan? {#when-should-simulators-be-used}
...
## Migrasi ke simulator tempatan {#migrate-to-local-simulators}
