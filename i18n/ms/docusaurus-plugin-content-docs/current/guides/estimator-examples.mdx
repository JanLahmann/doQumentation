---
title: "Contoh Estimator"
sidebar_label: "Contoh Estimator"
description: "Contoh praktikal menggunakan primitif Estimator dalam Qiskit Runtime."
...
Contoh-contoh dalam bahagian ini menggambarkan beberapa cara biasa menggunakan Estimator. Sebelum menjalankan contoh-contoh ini, ikuti arahan dalam [Pasang Qiskit.](install-qiskit)

<Admonition type="note">
Semua contoh ini menggunakan primitif daripada Qiskit Runtime, tetapi kamu boleh menggunakan primitif asas sebagai gantinya.
</Admonition>

Kira dan tafsirkan nilai jangkaan pengendali kuantum yang diperlukan oleh banyak algoritma dengan cekap menggunakan Estimator. Terokai penggunaannya dalam pemodelan molekular, pembelajaran mesin, dan masalah pengoptimuman yang kompleks.

## Jalankan satu eksperimen {#run-a-single-experiment}

Gunakan Estimator untuk menentukan nilai jangkaan bagi pasangan Circuit-observable tunggal.
...
## Jalankan berbilang eksperimen dalam satu kerja {#run-multiple-experiments-in-a-single-job}

Gunakan Estimator untuk menentukan nilai jangkaan bagi berbilang pasangan Circuit-observable.
...
Gunakan Estimator untuk menjalankan tiga eksperimen dalam satu kerja, dengan memanfaatkan nilai parameter bagi meningkatkan kebolehgunaan semula Circuit.
...
## Guna batch dan pilihan lanjutan {#use-batches-and-advanced-options}

Terokai [mod pelaksanaan](/guides/execution-modes) batch dan pilihan lanjutan untuk mengoptimumkan prestasi Circuit pada QPU.
...
- [Tentukan pilihan runtime lanjutan](runtime-options-overview).
