...
- Langkah 3: Jalankan pekerjaanmu di komputer kuantum IBM menggunakan primitif IBM Quantum
...
"Sampler" adalah primitive yang dirancang untuk mengambil sampel kemungkinan state yang dihasilkan dari Circuit kuantum, dan mengumpulkan statistik tentang state apa saja yang mungkin diukur beserta probabilitasnya. Kita mengimpor Sampler IBM Quantum di sini:
...
### Langkah 1: Petakan masalahmu ke Circuit kuantum {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Langkah 3: Eksekusi {#step-3-execute-1}
