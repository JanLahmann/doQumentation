...
(a)   Sebuah sistem fisik dalam keadaan yang pasti tetap dapat berperilaku secara acak.

(b)   Dua sistem yang terlalu jauh untuk saling memengaruhi entah bagaimana berkorelasi kuat.

(c)   Mungkin untuk memiliki suatu keadaan dalam sistem kuantum yang tidak dapat digambarkan sebagai hasil kali dari komponen-komponen independen qubit yang membentuk keadaan tersebut.
...
Benar. Circuit kuantum adalah representasi abstrak dari serangkaian instruksi yang membentuk algoritma kuantum. Kita bisa menggunakan alat visual seperti [IBM Quantum Composer](https://quantum.cloud.ibm.com/composer) atau software development kit (SDK) seperti [Qiskit](/guides/tools-intro) untuk membuat Circuit kuantum.
