...
Benar. Circuit kuantum adalah representasi abstrak dari serangkaian instruksi yang membentuk algoritma kuantum. Kita bisa menggunakan alat visual seperti IBM [Composer](https://quantum.cloud.ibm.com/composer) atau bahasa pemrograman seperti [Qiskit](/guides/tools-intro) untuk membuat Circuit kuantum.
