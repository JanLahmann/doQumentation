...
## Langkah 3 Qiskit Patterns: Eksekusi menggunakan primitif IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
## Langkah 2 Qiskit Patterns: Optimalkan masalah untuk eksekusi kuantum {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution-1}
Kita mulai dengan memilih Backend untuk eksekusi. Dalam kasus ini, kita akan menggunakan Backend yang paling tidak sibuk.
...
## Langkah 3 Qiskit Patterns: Eksekusi menggunakan primitif IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
