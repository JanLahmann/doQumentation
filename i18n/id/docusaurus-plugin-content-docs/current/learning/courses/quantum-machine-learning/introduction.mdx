...
Salah. Sebagian besar masalah machine learning diselesaikan dengan sangat efisien oleh algoritma klasik dan algoritma kuantum kemungkinan tidak akan menawarkan peningkatan kecepatan yang substansial. Tujuan dalam QML adalah menemukan dataset dengan fitur-fitur yang dideskripsikan dengan baik oleh state kuantum dan/atau menemukan pemetaan fitur data yang mengoptimalkan akurasi model.
...
5. Mengimplementasikan metode quantum kernel dan variational quantum classifiers menggunakan IBM Quantum primitives dan mengikuti pola Qiskit.
...
Dalam proses di atas, kita menghitung entri matriks kernel untuk titik data ke-14 dan ke-19. Nilai apa yang seharusnya kita peroleh jika kita menggunakan titik data yang sama dua kali, di sini (seperti ke-14 dan ke-14 lagi)? Dengan kata lain, apa yang seharusnya menjadi entri diagonal dalam matriks kernel? Jawab pertanyaan ini tanpa adanya noise, tetapi perhatikan bahwa deviasi dari jawabanmu mungkin terjadi dengan adanya noise.

<Accordion>
<AccordionItem title="Jawaban">

Diagonal seharusnya 1.0. Proses ini seharusnya menghitung inner product ternormalisasi dari sebuah vektor dengan dirinya sendiri, yang harus selalu satu.
