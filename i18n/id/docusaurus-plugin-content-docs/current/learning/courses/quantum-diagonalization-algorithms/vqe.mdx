...
![Gambar orbital atom dan gambar jaringan yang terdiri dari banyak simpul dan koneksi di antaranya.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig1.svg)
...
![Gambar Circuit kuantum dengan parameter variasional berlabel "theta".](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig2.svg)
...
![Gambar yang menunjukkan garis melengkung yang mewakili energi dengan beberapa titik di mana nilainya diuji untuk menemukan minimum.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig3.svg)
...
![Tabel string Pauli yang berbeda, beberapa di antaranya komutasi dan yang lainnya tidak.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig4.svg)
...
![Dua gambar garis melengkung dengan nilai minimum. Pada satu gambar, titik-titik diperiksa secara acak dalam pencarian minimum, pada gambar lainnya gradien diestimasi dengan menggambar garis antara dua titik yang berdekatan.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig5.svg)
