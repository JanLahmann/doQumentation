...
## 1. Pengenalan algoritma Grover {#1-introduction-to-grovers-algorithm}
...
### Struktur Dasar Algoritma Grover {#the-basic-structure-of-grovers-algorithm}
...
## 2. Mengimplementasikan Algoritma Grover {#2-implementing-grovers-algorithm}

### 2.1 Persiapan {#21-preparation}
...
### 1: Inisialisasi {#1-initialization}
...
### 3: Operator Difusi {#3-diffusion-operator}
...
### 2.2 Contoh pencarian Grover dengan 2 qubit. {#22-a-2-qubit-grover-search-example}
...
### Langkah 4: Pemrosesan hasil. {#step-4-post-processing-the-results}
...
## 3. Eksperimen dengan Perangkat Nyata {#3-experiment-with-real-devices}
...
### Langkah 4: Pemrosesan hasil. {#step-4-post-processing-the-results-1}
...
## 4. Pencarian Grover dengan 3 qubit {#4-a-3-qubit-grover-search}
...
#### Apa yang terjadi jika kita iterasi 3 kali? {#what-happens-if-we-iterate-3-times}
...
#### Bagaimana kalau 4 kali? {#how-about-4-times}
