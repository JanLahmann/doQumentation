...
Kamu bisa mengatur opsi error suppression di Sampler V2. Lihat panduan [Sampler noise management](/guides/sampler-noise-management) dan referensi API [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) untuk informasi lebih lanjut.
