...
### Estimasi nilai $r_z$ {#estimate-r-z-value}
...
### Latihan 1: Estimasi nilai $r_x$ {#exercise-1-estimate-r-x-value}
...
### Latihan 2: Estimasi nilai $r_y$ {#exercise-2-estimate-r-y-value}
