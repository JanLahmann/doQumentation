...
# Algoritma kuantum: Estimasi fase {#quantum-algorithms-phase-estimation}
...
## 2. Dasar-dasar Quantum Fourier Transformation (QFT) {#2-basic-of-quantum-fourier-transformation-qft}
...
### 2.1. Intuisi <a id="intuition"></a> {#21-intuition}
...
### 2.2 Contoh: QFT 1-qubit {#22-example-1-qubit-qft}
...
### 2.3 Representasi produk dari QFT {#23-product-representation-of-qft}
...
### 2.4 Contoh: Konstruksi Circuit QFT 3 qubit {#24-example-circuit-construction-of-3-qubits-qft}
...
### 2.5 Latihan: QFT {#25-exercise-qft}
...
#### Solusi latihan: QFT {#solution-of-the-exercise-qft}
(1)
...
## 3. Dasar-dasar Quantum Phase Estimation (QPE) {#3-basics-of-quantum-phase-estimation-qpe}
...
#### 3. Operasi Controlled Unitary {#3-controlled-unitary-operations}
...
### 3.2 Contoh: T-gate QPE {#32-example-t-gate-qpe}
...
$$
Kita menginisialisasi $\vert\psi\rangle = \vert1\rangle$ dari eigenvector gate $T$ dengan menerapkan gate $X$:
...
Selanjutnya, kita menerapkan gate Hadamard pada qubit penghitung:
...
Kita melakukan operasi unitary terkontrol:
...
Kita menerapkan transformasi Fourier kuantum invers untuk mengonversi state dari register penghitung, kemudian mengukur register penghitung:
...
Kita melihat kita mendapatkan satu hasil (`001`) dengan pasti, yang diterjemahkan ke desimal: `1`. Kita sekarang perlu membagi hasil kita (`1`) dengan $2^n$ untuk mendapatkan $\theta$:

$$
\theta = \frac{1}{2^3} = \frac{1}{8}
$$
 Algoritma Shor memungkinkan kita untuk memfaktorkan sebuah angka dengan membangun circuit dengan $\theta$ tidak diketahui dan memperoleh $\theta$.
...
#### Solusi latihan: $\theta = 1/3$ {#solution-of-the-exercise-theta-13}
...
## 4. Eksekusi menggunakan primitif Sampler IBM Quantum {#4-execution-using-the-ibm-quantum-sampler-primitive}
