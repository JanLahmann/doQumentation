...
### 1.1 Persyaratan {#11-requirements}
...
### 1.2 Impor pustaka {#12-import-the-libraries}
...
## 2. Memetakan masalah {#2-mapping-your-problem}
...
### 2.2 Atur parameter simulasi evolusi waktu {#22-set-the-parameters-of-the-time-evolution-simulation}
...
### 2.3 Siapkan Circuit kuantum 1 (Keadaan awal) {#23-prepare-the-quantum-circuit-1-initial-state}
...
### 2.4 Siapkan Circuit kuantum 2 (Circuit tunggal untuk evolusi waktu) {#24-prepare-the-quantum-circuit-2-single-circuit-for-time-evolution}
...
### 2.5 Atur operator yang akan diukur {#25-set-the-operators-to-measure}
...
### 2.6 Lakukan simulasi evolusi waktu {#26-perform-time-evolution-simulation}
...
### 2.7 Plot evolusi waktu dari observabel {#27-plot-the-time-evolution-of-the-observables}
...
## 3. Latihan 1. Lakukan simulasi menggunakan Suzuki–Trotter orde kedua {#3-exercise-1-perform-simulation-using-second-order-suzukitrotter}
...
### 3.1 Bangun Circuit untuk satu langkah waktu {#31-construct-a-circuit-for-a-single-time-step}
...
### 3.2 Lakukan simulasi evolusi waktu {#32-perform-time-evolution-simulation}
...
### 3.3 Plot hasil Suzuki–Trotter orde kedua {#33-plot-the-second-order-suzukitrotter-results}
...
### 3.4 Bandingkan dengan hasil eksak {#34-compare-with-exact-results}
...
### 4.3 Langkah 3. Eksekusi dengan primitif IBM Quantum {#43-step-3-execute-with-ibm-quantum-primitives}
