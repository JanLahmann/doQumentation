...
## 2. Menghitung nilai eigen minimum dari Hamiltonian sederhana {#2-computing-the-minimum-eigenvalue-of-a-simple-hamiltonian}
...
#### Solusi latihan {#solutions-of-the-exercise}
...
#### Masalah optimisasi &rarr; Hamiltonian {#optimization-problem-hamiltonian}
...
### 3.4 Langkah 3. Eksekusi menggunakan primitif IBM Quantum {#34-step-3-execute-using-ibm-quantum-primitives}
...
2. Instansiasi sebuah `Session` baru yang berisi loop optimisasi dan primitif yang digunakan untuk mengambil sampel circuit
...
Gunakan **IBM Quantum primitives** untuk berinteraksi dengan Backend IBM&reg;. Dua primitive tersebut adalah Sampler dan Estimator, dan pilihan primitive bergantung pada jenis pengukuran yang ingin kamu jalankan di komputer kuantum. Untuk minimisasi $H_C$, gunakan Estimator karena pengukuran fungsi biaya hanyalah nilai ekspektasi dari $\langle H_C \rangle$.
