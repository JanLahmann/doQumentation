...
{/* doqumentation-source-hash: 9e534572 */}
...
Mengatur resilience level (`estimator.options.resilience_level`) adalah cara termudah untuk menerapkan mitigasi error saat menggunakan Qiskit Estimator. Estimator mendukung resilience level berikut (per 2024/06/28). Lihat detail lebih lanjut di panduan [Configure error mitigation](/guides/error-mitigation-and-suppression-techniques).
