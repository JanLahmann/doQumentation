...
#### Definisikan Hamiltonian {#define-the-hamiltonian-1}
...
Di sini kita membangun sebuah circuit untuk satu langkah waktu tunggal menggunakan Lie–Trotter.
Sama seperti pada kasus 20-qubit, formula produk Lie (orde pertama) diimplementasikan dalam kelas [LieTrotter](https://docs.quantum.ibm.com/api/qiskit/qiskit.synthesis.LieTrotter). Sekali lagi, formula orde pertama terdiri dari aproksimasi yang dinyatakan di atas:
...
#### Tentukan operator yang akan diukur {#set-the-operators-to-be-measured-1}
...
#### Lakukan simulasi time-evolution {#perform-time-evolution-simulation-1}
