...
![Diagram Circuit dengan empat garis horizontal dan banyak Gate.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/checkin-circuit.avif)
...
Anggaplah Anda memodelkan elektron dalam sebuah molekul. Anda ingin mengaproksimasi (a) energi ground state molekul, dan (b) basis states komputasi mana yang paling dominan dalam ground state molekul tersebut. Dalam setiap kasus, apakah Anda akan menggunakan primitive Estimator atau Sampler?
