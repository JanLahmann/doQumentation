...
#### Langkah 1: Siapkan state Ansatz {#step-1-prepare-the-ansatz-state}
...
#### Langkah 3: Proyeksikan dan diagonalisasi secara klasikal {#step-3-project-and-diagonalize-classically}
...
#### Langkah 4: Optimalkan ansatz (opsional) {#step-4-optimize-the-ansatz-optional}
...
### Keunggulan utama SQD {#key-advantages-of-sqd}
...
Sebut himpunan semua basis states komputasi yang membentuk ansatz Anda sebagai A. Sebut himpunan semua basis states komputasi yang membentuk ground state sebenarnya dari sistem Anda sebagai G. Mana dari berikut ini yang sesuai dengan ansatz yang 'baik'? Pilih semua yang berlaku:
...
#### Langkah 1: Bangun subruang Krylov dengan evolusi waktu {#step-1-construct-the-krylov-subspace-with-time-evolution}
...
#### Langkah 2: Ambil sampel dari state basis Krylov {#step-2-sample-from-the-krylov-basis-states}
...
#### Langkah 3: Proyeksikan dan diagonalisasi secara klasik {#step-3-project-and-diagonalize-classically-1}
...
### Keunggulan utama dan jaminan SKQD {#key-advantages-and-guarantees-of-skqd}
...
## SQD dan SKQD sebagai komputasi heterogen {#sqd-and-skqd-as-heterogeneous-computing}
...
### Optimasi (`optimization.py` dan `optimization.sh`) {#optimization-optimizationpy-and-optimizationsh}
...
### Eksekusi (`execution.py` dan `execution.sh`) {#execution-executionpy-and-executionsh}
...
### Post-processing (`postprocessing.py` dan `postprocessing.sh`) {#post-processing-postprocessingpy-and-postprocessingsh}
