...
Kamu juga akan memiliki kesempatan, jika Anda mau, untuk menjalankan beberapa contoh kode Python yang mendemonstrasikan beberapa pendekatan.

Akhirnya Anda bisa mendaftar untuk lencana dengan lulus ujian.

## Tips navigasi kursus ini {#tips-for-navigating-this-course}

Dalam kursus ini, Anda bisa mengatur kecepatan belajar sesukamu. Total durasi adalah sekitar 6–7 jam termasuk presentasi tambahan, dan menjalankan kode contoh, meskipun waktu ini akan bervariasi tergantung pada pengetahuan yang sudah Anda miliki dan tautan yang Anda ikuti. Jika Anda perlu meninggalkan kursus, Anda bisa dengan mudah kembali nanti.

Kamu bisa melihat di mana Anda berada dalam materi kursus menggunakan navigasi di sisi kiri konten utama. Pelajaran individual dapat diperluas untuk melihat sekumpulan topik, dan Anda bisa klik untuk kembali ke topik sebelumnya.
...
Presentasi telah disediakan (lihat **Materi yang Berguna** di gambaran umum kursus) yang meninjau isi yang tercakup dalam kursus ini. Kamu mungkin ingin mengunduhnya sehingga Anda bisa merujuknya di lain waktu.
