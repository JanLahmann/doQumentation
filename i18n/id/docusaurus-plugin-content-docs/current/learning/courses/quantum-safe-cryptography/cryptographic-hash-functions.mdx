...
Fakta bahwa ukuran domain input $Σ^*$ dari $H$ tidak terbatas sementara ko-domain $\{0,1\}^n$ terbatas berarti bahwa $H$ secara inheren merupakan pemetaan banyak-ke-satu yang memetakan infinitely banyak input ke string n-bit mana pun.
