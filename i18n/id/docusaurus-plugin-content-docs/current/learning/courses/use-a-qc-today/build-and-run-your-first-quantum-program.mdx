...
Pelajaran pertama ini adalah pengenalan praktis yang lembut tentang komputasi kuantum, cocok untuk pemula yang penasaran maupun para pemimpin yang sibuk. Kamu akan belajar tentang Circuit kuantum dan menulis program kuantum kecil yang menciptakan **entanglement**, lalu menjalankannya di komputer kuantum IBM&reg; yang sungguhan. Kamu juga punya opsi untuk menjalankan program yang sama di simulator, jika memilih untuk melewati eksekusi di komputer kuantum sungguhan.
...
Untuk menjalankan di komputer kuantum IBM sungguhan, kamu juga perlu (gratis) [**akun IBM Quantum&reg; Platform**](https://quantum.cloud.ibm.com/signin?redirectTo=%2F). Kamu bisa membuka instance menggunakan Open Plan untuk mendapatkan 10 menit waktu quantum processor unit (QPU) per jendela bergulir 28 hari, yang sebenarnya cukup banyak! *Jika ada masalah dengan akunmu, lihat [halaman Support](/guides/support).*
...
Buka Composer [di sini](https://quantum.cloud.ibm.com/composer).
...
<Accordion>
<AccordionItem title="Jawaban">
Dalam satu pengukuran kamu hanya melihat satu hasil klasik: 0 atau 1. Kamu membutuhkan banyak shots karena "superposisi" muncul sebagai distribusi probabilitas, yang hanya bisa kamu perkirakan dengan mengumpulkan statistik dari banyak pengulangan.
</AccordionItem>
</Accordion>
...
Kenapa simulator sempurna tidak akan selalu memiliki jumlah hitungan 00 yang sama persis dengan hitungan 11?
<Accordion>
<AccordionItem title="Jawaban">
Meskipun sebuah simulator "sempurna" dan menghasilkan Bell state yang sempurna, ia tetap mensimulasikan proses yang secara inheren acak, jadi fluktuasi statistik akan tetap terjadi. Ini seperti melempar koin 1000 kali: meskipun ada peluang tepat 50-50 koin akan jatuh pada sisi kepala atau ekor, itu tidak berarti kamu akan selalu mendapatkan tepat 500 kali kepala dan 500 kali ekor.
</AccordionItem>
</Accordion>
...
<Accordion>
<AccordionItem title="Jawaban">
Komputer kuantum bisa melibatkan waktu antrean, ketersediaan terbatas, dan batasan khusus perangkat yang memengaruhi cara circuit berjalan.
</AccordionItem>
</Accordion>
