...
<Accordion>
<AccordionItem title="Klik di sini untuk membaca cara menginstal paket ini secara manual">

Kalau Anda ingin berkontribusi pada paket ini atau ingin menginstalnya secara manual, pertama-tama clone repositorinya:

```bash
git clone git@github.com:Qiskit/qiskit-addon-sqd.git
```

lalu instal paketnya melalui `pip`. Repositori juga berisi contoh notebook yang bisa Anda jalankan. Kalau Anda berencana untuk mengembangkan di repositori tersebut, Anda bisa menginstal dependensi `dev`.
