...
### Aktifkan TREX dengan menggunakan opsi `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### Aktifkan TREX dengan menggunakan opsi `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### Aktifkan ZNE dengan menggunakan opsi `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}
...
### Aktifkan ZNE dengan menggunakan opsi `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- Jelajahi [opsi](/guides/runtime-options-overview) lain untuk primitif Qiskit Runtime.
