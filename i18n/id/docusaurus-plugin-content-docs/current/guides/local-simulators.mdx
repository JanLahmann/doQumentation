---
description: 'Migrasi dari simulator cloud IBM Quantum ke mode pengujian lokal `qiskit-ibm-runtime`.'
title: 'Migrasi ke simulator lokal'
---

{/* doqumentation-source-hash: 9db328b8 */}

# Migrasi dari simulator cloud ke simulator lokal {#migrate-to-local-simulators}
...
<Accordion>
<AccordionItem title="Simulator memiliki keterbatasan">
...
<AccordionItem title="Menggunakan hardware kuantum membangun skill yang unik">
...
<AccordionItem title="Algoritma harus disesuaikan untuk hardware kuantum">
...
## Migrasi ke simulator lokal {#migrate-to-local-simulators-1}
