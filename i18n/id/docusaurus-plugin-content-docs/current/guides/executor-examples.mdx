---
description: 'Contoh praktis penggunaan primitif Executor di qiskit-ibm-runtime.'
notebook_path: guides/executor-examples.ipynb
sidebar_label: 'Contoh Executor'
title: 'Contoh Executor'
---

{/* doqumentation-source-hash: 6589d7c0 */}
...
### Siapkan sirkuit {#set-up-the-circuit-1}
...
### Eksekusi sirkuit {#execute-the-circuits-1}
