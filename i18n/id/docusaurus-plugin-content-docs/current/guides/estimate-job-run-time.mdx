...
* Mode job atau batch: Jika kegagalan atau pembatalan terjadi karena kesalahan sistem, usage yang dilaporkan adalah nol. Untuk job yang gagal karena kesalahan pengguna atau ketika pengguna membatalkan job, usage yang dilaporkan adalah konsumsi apa pun yang telah terjadi hingga titik tersebut.
