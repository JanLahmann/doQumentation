...
### 2. Buat sebuah Circuit {#2-create-a-circuit}

Kamu membutuhkan setidaknya satu Circuit sebagai input ke primitif Sampler.
...
circuit.measure_all()
# Circuit ini terparameterisasi, jadi kami akan mendefinisikan nilai parameter untuk eksekusi
