...
![Gambar yang mengilustrasikan circuit berikut](/docs/images/guides/stretch/stretch.svg)
...
:::note
 ...
 Saat menggunakan `stretch` dengan IBM Quantum Compute Service, sisa apapun yang dihasilkan dari resolusi stretch ditambahkan ke delay pertama yang menggunakan stretch tersebut.
...
Meskipun total waktu circuit dikembalikan dalam metadata "compilation", ini BUKAN waktu yang digunakan untuk penagihan (QPU time).
</Admonition>
...
Untuk detail lengkap, lihat topik [Visualize circuit timing](/guides/qiskit-runtime-circuit-timing).

<span id="qiskit-runtime-limitations"></span>

## Keterbatasan Quantum Compute {#quantum-compute-limitations}

Dukungan untuk `stretch` di Quantum Compute saat ini masih eksperimental dan memiliki constraint berikut:
...
- Area yang dikelilingi oleh sekumpulan barrier disebut _barrier region_. Variabel stretch tidak bisa digunakan di beberapa barrier region.
    <Tabs>
        ...
        ![Ilustrasi output kode sebelumnya](/docs/images/guides/stretch/bad-barrier-region.svg 'Penggunaan stretch yang tidak valid di barrier region')
     ...
     <TabItem value="Valid" label="Valid">
        ...
        ![Ilustrasi output kode sebelumnya](/docs/images/guides/stretch/good-barrier-region.svg 'Penggunaan stretch yang valid di barrier region')
