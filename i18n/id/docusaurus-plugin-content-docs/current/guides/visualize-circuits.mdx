...
{/* doqumentation-source-hash: f657a70d */}
...
## Gambar quantum circuit {#draw-a-quantum-circuit}
...
### Renderer alternatif {#alternative-renderers}
...
### Kontrol penggambaran circuit {#control-circuit-drawings}
...
#### Nonaktifkan plot barriers dan balik urutan bit {#disable-plot-barriers-and-reverse-bit-order}
...
### Kustomisasi khusus renderer {#renderer-specific-customizations}
...
### Fungsi penggambaran circuit mandiri {#standalone-circuit-drawing-function}
