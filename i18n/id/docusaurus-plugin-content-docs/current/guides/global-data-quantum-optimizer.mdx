...
# Mulai {#get-started}
Autentikasi menggunakan [kunci API](https://quantum.cloud.ibm.com/) kamu dan pilih Qiskit Function sebagai berikut. (Cuplikan ini mengasumsikan kamu sudah [menyimpan akunmu](/guides/functions-get-started#install-qiskit-functions-catalog-client) ke lingkungan lokal.)
...
![Visualisasi solusi optimasi](/docs/images/guides/global-data-quantum-optimizer/cost_distribution.avif)
