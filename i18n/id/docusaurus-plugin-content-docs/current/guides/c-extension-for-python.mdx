...
Selesaikan instruksi di topik [Install](/guides/install-c-api) untuk menginstall hal berikut:

- Toolchain compiler C standar untuk platform-mu

- Versi Python yang menyertakan header C API-nya. 


Kamu juga sebaiknya familier dengan, atau siap untuk mencari, fungsi dan objek yang tersedia
di [Qiskit C API](https://docs.quantum.ibm.com/api/qiskit-c), dan sebaiknya memiliki sedikit kemampuan dalam pemrograman C.
...
Tetapkan versi runtime Qiskit di
`project.dependencies` agar sesuai dengan versi minor yang digunakan saat build.
