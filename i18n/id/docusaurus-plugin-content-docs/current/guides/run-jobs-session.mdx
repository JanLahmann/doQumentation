---
description: 'Cara menjalankan job komputasi kuantum dalam IBM Quantum Compute Service session.'
...
Sebelum memulai sebuah Session, kamu harus [menyiapkan klien IBM Quantum Compute](/guides/install-qiskit-runtime) dan menginisialisasinya sebagai layanan:
...
Untuk gambaran umum yang komprehensif tentang konfigurasi dan status sebuah Session, gunakan `session.details() method`.
