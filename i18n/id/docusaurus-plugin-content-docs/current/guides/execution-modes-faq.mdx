...
- Ada sedikit overhead untuk menjalankan setiap job, sehingga kamu membayar sedikit lebih banyak untuk job yang di-batch dibandingkan saat semua Circuit dijalankan dalam satu job.
