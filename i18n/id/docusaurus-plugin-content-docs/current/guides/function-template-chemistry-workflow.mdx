...
# Bangun dan jalankan template Qiskit Function untuk simulasi struktur elektronik dengan model pelarut implisit {#build-and-run-a-qiskit-function-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
Untuk panduan langkah demi langkah dari workflow yang sama ini dengan contoh yang dikerjakan, lihat tutorial [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations).
...
<Accordion>
<AccordionItem title="Klik untuk memperluas demi detail lebih lanjut tentang opsi yang diperlukan:">
...
<Accordion>
<AccordionItem title="Klik untuk memperluas demi info lebih lanjut tentang konfigurasi opsi SQD:">
...
## Kutip proyek ini {#cite-this-project}

Jika kamu menggunakan template SQD IEF-PCM dalam risetmu, silakan merujuk ke [repositori](https://github.com/qiskit-community/qiskit-function-templates/tree/main/chemistry/sqd_pcm#citing-this-project) untuk informasi sitasi yang detail.

## Langkah selanjutnya {#next-steps}

<Admonition type="info" title="Rekomendasi">

- Ikuti tutorial [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations) untuk contoh yang dikerjakan dari workflow yang sama ini

- Baca panduan tentang membangun function template untuk [simulasi Hamiltonian](/guides/function-template-hamiltonian-simulation)
