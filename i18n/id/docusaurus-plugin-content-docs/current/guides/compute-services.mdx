...
## Layanan Transpiler Qiskit {#qiskit-transpiler-service}
Layanan Transpiler Qiskit ([nama paket `qiskit-ibm-transpiler`](https://pypi.org/project/qiskit-ibm-transpiler/)) adalah layanan eksperimental baru yang menyediakan kemampuan transpilasi jarak jauh di cloud untuk pengguna IBM Quantum Premium Plan, Flex Plan, dan On-Prem (melalui IBM Quantum Platform API) Plan. Selain kemampuan Transpiler Qiskit SDK lokal, tugas transpilasi kamu dapat memanfaatkan sumber daya cloud IBM Quantum dan pass Transpiler bertenaga AI menggunakan layanan ini. Untuk mempelajari lebih lanjut tentang cara mengintegrasikan transpilasi berbasis cloud ke dalam alur kerja Qiskit kamu, kamu bisa [melihat dokumentasinya](/guides/qiskit-transpiler-service).

Layanan transpiler dapat diinstal dengan pip:
```bash
