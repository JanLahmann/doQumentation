---
description: 'Pilih mode eksekusi yang tepat untuk IBM Quantum Compute — Session, batch, atau job tunggal.'
...
# Pilih mode eksekusi yang tepat {#choose-the-right-execution-mode}
...
- **Batch**
   ...
   - Biasanya ada jeda minimal antar job, yang dapat membantu menghindari drift.
...
- **Job**
   ...
   - Mungkin mulai berjalan lebih awal dibandingkan batch mode.


<span id="best-practices"></span>

## Rekomendasi dan praktik terbaik {#recommendations-and-best-practices}
...
### Jalankan algoritma variasional kuantum {#run-a-quantum-variational-algorithm}
...
### Bandingkan pengaturan mitigasi error {#compare-error-mitigation-settings}
