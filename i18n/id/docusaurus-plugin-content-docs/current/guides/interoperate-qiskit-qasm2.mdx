...
## Impor program OpenQASM 2 ke Qiskit {#import-an-openqasm-2-program-into-qiskit}
...
### Impor program sederhana {#import-simple-programs}
...
#### Contoh: impor program OpenQASM 2 sebagai string {#example-import-an-openqasm-2-program-as-a-string}
...
#### Contoh: impor program OpenQASM 2 dari file {#example-import-an-openqasm-2-program-from-a-file}
...
#### Contoh: impor program yang dibuat oleh exporter lama Qiskit {#example-import-a-program-created-by-qiskits-legacy-exporter}
...
#### Contoh: gunakan kelas Gate tertentu saat mengimpor program OpenQASM 2 {#example-use-a-particular-gate-class-when-importing-an-openqasm-2-program}
...
#### Contoh: definisikan Gate bawaan baru dalam program OpenQASM 2 {#example-define-a-new-built-in-gate-in-an-openqasm-2-program}
...
### Definisikan fungsi klasik khusus {#define-custom-classical-functions}
...
#### Contoh: gunakan instruksi klasik khusus {#example-use-custom-classical-instructions}
...
## Ekspor Circuit Qiskit ke OpenQASM 2 {#export-a-qiskit-circuit-to-openqasm-2}
...
### Contoh: ekspor Circuit ke OpenQASM 2 {#example-export-a-circuit-to-openqasm-2}
