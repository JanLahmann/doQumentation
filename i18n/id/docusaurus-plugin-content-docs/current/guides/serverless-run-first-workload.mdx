...
<Admonition type="tip">
**Qiskit Serverless sedang mendapatkan pembaruan, dan fitur-fiturnya berubah dengan cepat.** Selama fase pengembangan ini, temukan catatan rilis dan dokumentasi terbaru di halaman [Qiskit Serverless GitHub](https://qiskit.github.io/qiskit-serverless/index.html).
</Admonition>
...
Pastikan kamu sudah mengikuti alur kerja di [Tulis program Qiskit Serverless pertamamu](/guides/serverless-first-program) sebelum kamu mulai.

## Daftar program yang tersedia {#list-programs-available}

Kamu bisa menggunakan `QiskitServerless.list()` untuk mengambil daftar program yang tersedia untuk dijalankan dengan Qiskit Serverless. Ini termasuk [`transpile_remote_serverless`](/guides/serverless-first-program) yang sebelumnya sudah diunggah.
...
- Jelajahi [alat manajemen komputasi dan data](/guides/serverless-manage-resources) yang tersedia untuk programmu, termasuk paralelisasi.
