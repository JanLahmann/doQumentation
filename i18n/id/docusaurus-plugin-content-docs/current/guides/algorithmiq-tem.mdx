...
Autentikasi menggunakan [kunci API IBM Quantum Platform](http://quantum.cloud.ibm.com/) kamu, dan pilih fungsi TEM sebagai berikut. (Cuplikan ini mengasumsikan kamu sudah [menyimpan akun](/guides/functions-get-started#install-qiskit-functions-catalog-client) ke lingkungan lokal kamu.)
