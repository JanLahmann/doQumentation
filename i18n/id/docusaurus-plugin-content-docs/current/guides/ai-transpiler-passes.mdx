...
Lihat [dokumentasi Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) untuk informasi lebih lanjut tentang batasan yang berlaku untuk pass Transpiler berbasis AI.

## Sitasi {#citation}

Jika kamu menggunakan fitur berbasis AI dari Qiskit Transpiler Service dalam penelitianmu, gunakan [sitasi yang direkomendasikan](/guides/qiskit-transpiler-service#citation).
