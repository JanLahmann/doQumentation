...
4. Jalankan template Circuit dan samplex dengan primitif [Executor](#executor), yang akan menghasilkan dan mengeksekusi varian Circuit sesuai instruksi.

5. Post-process hasil eksekusi. Misalnya, kamu bisa menerapkan postselection, atau mengekstrapolasi nilai ekspektasi yang telah dimitigasi dari hasil eksekusi.
