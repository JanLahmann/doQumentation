...
![sebuah quantum circuit](/docs/images/guides/composer/2H-circuit.svg "Circuit yang terdiri dari kolom Hadamard yang menciptakan superposisi merata dari keadaan basis komputasi, diikuti oleh Gate controlled-Z (CZ) dua qubit.")

![Tampilan Probabilities dari circuit sebelumnya](/docs/images/guides/composer/probabilities.svg "Tampilan Probabilities dari circuit sebelumnya.")
...
![sebuah quantum circuit](/docs/images/guides/composer/2H-circuit.svg)

![tampilan q-sphere](/docs/images/guides/composer/q-sphere.avif)
...
![tampilan statevector](/docs/images/guides/composer/state-vector.svg "Statevector di ujung circuit di atas. Roda warna memetakan sudut phase ke warna. Keadaan keluaran dinyatakan sebagai daftar bilangan kompleks.")
