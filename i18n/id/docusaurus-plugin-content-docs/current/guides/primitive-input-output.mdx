...
![Gambar ini mengilustrasikan beberapa representasi visual dari broadcasting array](/docs/images/guides/primitive-input-output/broadcasting.avif "Representasi visual dari broadcasting")
