---
description: 'Pahami format input dan output (termasuk Primitive Unified Blocs atau PUB) dari primitif Qiskit SDK'
...
Setelah satu atau lebih PUB dikirim ke QPU untuk dieksekusi dan sebuah job berhasil selesai, data dikembalikan sebagai objek container [`PrimitiveResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PrimitiveResult). `PrimitiveResult` berisi daftar iterable objek [`PubResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PubResult) yang berisi hasil eksekusi untuk setiap PUB. Misalnya, job yang dikirim dengan 20 PUB akan mengembalikan objek `PrimitiveResult` yang berisi daftar 20 `PubResults`, satu untuk setiap PUB.
...
<Admonition type="tip" title="Rekomendasi">
  ...
  -  Tinjau API [primitif Qiskit SDK](https://docs.quantum.ibm.com/api/qiskit/primitives).

  -  Tinjau API [primitif Qiskit Aer](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html).

  -  Pelajari lebih lanjut tentang [primitif IBM Quantum](/guides/qiskit-runtime-primitives).

  -  Tinjau API [Estimator `qiskit-ibm-runtime`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2).

  -  Tinjau API [Sampler `qiskit-ibm-runtime`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2).
</Admonition>
