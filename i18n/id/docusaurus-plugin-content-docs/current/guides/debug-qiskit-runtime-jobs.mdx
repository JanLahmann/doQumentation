---
description: 'Gunakan kelas Neat dari modul alat debugging qiskit-ibm-runtime untuk men-debug dan menganalisis pekerjaan.'
notebook_path: guides/debug-qiskit-runtime-jobs.ipynb
sidebar_label: 'Debug pekerjaan dengan NEAT'
title: 'Debug pekerjaan dengan NEAT'
---
...
Pertama, impor paket yang relevan dan [autentikasi ke IBM Quantum Compute Service](/guides/cloud-setup).
...
Pertimbangkan sebuah sirkuit enam-Qubit yang memiliki properti berikut:
...
- Baca gambaran umum tentang [alat debugging Qiskit](/guides/debugging-tools).
- Pelajari tentang [Simulasi eksak dan berisik dengan Qiskit Aer primitives](/guides/simulate-with-qiskit-aer).
- Pelajari tentang [opsi IBM Quantum Compute yang tersedia](/guides/runtime-options-overview).
...
- Pelajari [cara melakukan transpile pada Circuit](/guides/circuit-transpilation-settings#compare-transpiler-settings) sebagai bagian dari alur kerja Qiskit patterns.
