...
Kode berikut mengasumsikan kamu sudah mengikuti proses untuk menyimpan kredensialmu menggunakan `QiskitRuntimeService.save_account`, dan akan memuat akun tersimpan default-mu kecuali kamu menentukan lain. Lihat [Simpan kredensial login-mu](/guides/save-credentials) dan [Inisialisasi akun IBM Quantum Compute Service-mu](/guides/initialize-account) untuk informasi lebih lanjut.
