...
### 1. Buat fungsi objektif {#1-create-the-objective-function-1}
...
### 2. Jalankan Optimizer {#2-run-the-optimizer-1}
...
### 3. Ambil hasilnya {#3-retrieve-the-result-1}
...
Contoh berikut menjalankan instance Maxcut dengan 150 node.
...
- Kunjungi [referensi API](https://docs.quantum.ibm.com/api/functions/kipu-optimization) untuk Qiskit Function ini.
