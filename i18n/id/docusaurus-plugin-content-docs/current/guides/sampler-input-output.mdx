...
Kode berikut mendemonstrasikan contoh kumpulan input vectorized ke primitif `Sampler` dan mengeksekusinya pada backend IBM&reg; sebagai satu objek `RuntimeJobV2 ` tunggal.
