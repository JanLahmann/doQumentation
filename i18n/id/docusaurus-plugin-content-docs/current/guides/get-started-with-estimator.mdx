---
description: 'Panduan quickstart tentang cara menggunakan primitive IBM Quantum Estimator.'
...
### 3. Inisialisasi IBM Quantum Estimator {#3-initialize-the-ibm-quantum-estimator}
