...
### Alur kerja untuk lightcone shading, pembelajaran noise, dan injeksi anti-noise {#workflow-for-lightcone-shading-noise-learning-and-anti-noise-injection}
...
### Alur kerja untuk shading lightcone, pembelajaran noise, dan injeksi anti-noise {#workflow-for-lightcone-shading-noise-learning-and-anti-noise-injection-1}
...
#### b. Hitung dan perketat batas maju {#b-compute-and-tighten-forward-bounds}
...
#### Visualisasi SLC untuk inspeksi manual {#visualize-the-slc-for-manual-inspection-1}
...
#### c. Hitung batas mundur {#c-compute-backward-bounds}
...
#### Visualisasi SLC untuk inspeksi manual {#visualize-the-slc-for-manual-inspection-2}
...
#### Pratinjau batas yang digabungkan tanpa tingkat noise yang dipelajari {#preview-merged-bounds-without-learned-noise-rates}
...
### Visualisasi SLC untuk inspeksi manual {#visualize-the-slc-for-manual-inspection-3}
...
#### Sumber daya tingkat cluster {#cluster-level-resources}
...
#### b.ii. Hitung `local_scales` untuk eksekusi hardware {#bii-compute-the-local-scales-for-the-hardware-execution}
