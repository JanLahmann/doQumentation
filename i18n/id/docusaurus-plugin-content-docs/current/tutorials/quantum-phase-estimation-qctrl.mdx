...
## Pengaturan {#setup}
Pertama, autentikasi menggunakan [API key IBM Quantum](http://quantum.cloud.ibm.com/) kamu. Kemudian, pilih Qiskit Function seperti berikut. (Kode ini mengasumsikan kamu sudah [menyimpan akun](/guides/functions-get-started#install-qiskit-functions-catalog-client) ke lingkungan lokal kamu.)
