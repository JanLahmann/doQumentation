...
Sebuah sirkuit **GHZ (Greenberger-Horne-Zeilinger)** adalah Circuit kuantum yang mempersiapkan keadaan terjalin di mana semua qubit berada dalam keadaan `|0...0⟩` atau `|1...1⟩`. Keadaan GHZ untuk $n$ qubit direpresentasikan secara matematis sebagai:
