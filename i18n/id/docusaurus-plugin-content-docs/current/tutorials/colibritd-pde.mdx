...
pada QPU IBM&reg; menggunakan QUICK-PDE, yang dinyatakan dengan:
...
proses penyelesaian dan solusinya. Untuk pilihan kondisi awal ini,
persamaan tersebut memiliki solusi analitik berikut:

$$u(t, x) = \frac{ax + b}{at + 1},$$

yang berlaku selama belum terbentuk shock, yaitu, untuk $t < -1/a$ ketika $a < 0$.
