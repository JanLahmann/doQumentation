---
description: 'Gunakan algoritma Grover untuk mencari database tak terstruktur dengan percepatan kuadratik.'
...
- Cara mengeksekusi algoritma Grover menggunakan primitif Sampler IBM Quantum

## Prasyarat {#prerequisites}
Disarankan agar kamu terlebih dahulu memahami topik-topik berikut:
- [Dasar-dasar algoritma kuantum: Algoritma Grover](/learning/courses/fundamentals-of-quantum-algorithms/grover-algorithm/introduction)
...
Amplifikasi amplitudo adalah masalah sampling yang cocok untuk dieksekusi dengan primitif [`SamplerV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2). Di sini kita menggunakan `StatevectorSampler` dari `qiskit.primitives` untuk simulasi lokal.
...
Seperti yang ditunjukkan oleh plot, kedalaman Gate dua-Qubit tumbuh sangat cepat seiring bertambahnya jumlah qubit &mdash; kira-kira secara eksponensial. Ini membuat algoritma Grover tidak praktis pada hardware kuantum noisy saat ini untuk ukuran masalah yang lebih dari sangat kecil. Algoritma ini tetap menjadi target penting bagi komputer kuantum fault-tolerant di masa depan, di mana koreksi kesalahan akan memungkinkan Circuit yang dalam untuk dieksekusi secara andal.
...
- [Pustaka Circuit Qiskit: referensi API `grover_operator()`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.library.grover_operator)
- [Tutorial QAOA](/tutorials/quantum-approximate-optimization-algorithm) dan [pelajaran QAOA skala utilitas](/learning/courses/quantum-computing-in-practice/utility-scale-qaoa) memberikan contoh optimasi jangka pendek dengan komputer kuantum
- Untuk tinjauan lebih mendalam tentang algoritma jangka pendek, lihat kursus [Komputasi kuantum dalam praktik](/learning/courses/quantum-computing-in-practice)
</Admonition>
