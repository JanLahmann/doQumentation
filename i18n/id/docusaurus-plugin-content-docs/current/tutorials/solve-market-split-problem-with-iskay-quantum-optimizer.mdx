...
### Tantangan Market Split {#the-market-split-challenge}
...
### Apa yang membuat pendekatan Iskay unik? {#what-makes-iskays-approach-unique}
...
### Konfigurasi kredensial IBM Quantum {#configure-ibm-quantum-credentials}
...
### Hubungkan ke Iskay Quantum Optimizer {#connect-to-iskay-quantum-optimizer}
...
### Muat dan formulasikan masalah {#load-and-formulate-the-problem}

#### Pahami format data masalah {#understand-the-problem-data-format}
...
## Dari kendala ke QUBO: transformasi matematis {#from-constraints-to-qubo-the-mathematical-transformation}
...
### Implementasi fungsi pemuatan data dan konversi QUBO {#implement-data-loading-and-qubo-conversion-functions}
...
### Muat instans masalah {#load-the-problem-instance}
...
### Konversi ke format QUBO {#convert-to-qubo-format}
...
### Konversi QUBO ke format Iskay {#convert-qubo-to-iskay-format}
...
### Pahami algoritma bf-DCQO {#understand-the-bf-dcqo-algorithm}
...
#### Apa itu bf-DCQO? {#what-is-bf-dcqo}
...
#### Kerangka matematis {#mathematical-framework}
...
#### Peran suku-suku counterdiabatic {#the-role-of-counterdiabatic-terms}
...
#### Optimasi iteratif berbasis bias-field {#bias-field-iterative-optimization}
...
#### Post-processing klasikal terintegrasi {#integrated-classical-post-processing}
...
#### Mengapa bf-DCQO unggul pada perangkat keras saat ini {#why-bf-dcqo-excels-on-current-hardware}
