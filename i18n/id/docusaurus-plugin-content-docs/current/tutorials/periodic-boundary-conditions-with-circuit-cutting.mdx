...
> **Catatan:** Survei ini dibuat oleh **IBM Quantum** dan mencakup **konten tutorial** (ditulis oleh IBM). doQumentation menyediakan website, terjemahan, dan eksekusi kode — untuk umpan balik mengenai hal tersebut, silakan [buka issue GitHub](https://github.com/JanLahmann/doQumentation/issues).

[Tautan ke survei](https://your.feedback.ibm.com/jfe/form/SV_3fQQYAIjTxvIChg)
