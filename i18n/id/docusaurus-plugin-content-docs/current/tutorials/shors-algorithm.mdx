...
- Latar belakang matematis algoritma Shor untuk faktorisasi bilangan bulat
- Cara menjalankan contoh instansi algoritma ini di hardware
...
- [Phase estimation and factoring](/learning/courses/fundamentals-of-quantum-algorithms/phase-estimation-and-factoring/introduction). Kami membahas sebagian materi ini dalam tutorial ini.
