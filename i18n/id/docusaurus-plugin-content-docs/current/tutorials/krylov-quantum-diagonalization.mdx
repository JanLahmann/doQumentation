...
> **Catatan:** Survei ini disediakan oleh IBM Quantum dan berkaitan dengan konten asli bahasa Inggris. Untuk memberikan masukan tentang website, terjemahan, atau eksekusi kode doQumentation, silakan [buka masalah GitHub](https://github.com/JanLahmann/doQumentation/issues).
