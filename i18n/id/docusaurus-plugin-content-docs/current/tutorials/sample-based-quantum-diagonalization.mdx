...
- Cara menggunakan [SQD Qiskit addon](https://docs.quantum.ibm.com/addons/qiskit-addon-sqd) untuk mengaproksimasi energi ground state sistem molekuler menggunakan bitstring yang disampling dari unit pemrosesan kuantum (QPU).
...
Dalam tutorial ini, kita akan menunjukkan cara memproses sampel kuantum yang berisik untuk mengaproksimasi ground state molekul nitrogen $\text{N}_2$ pada panjang ikatan kesetimbangan, dengan menggunakan [SQD Qiskit addon](https://github.com/Qiskit/qiskit-addon-sqd) untuk mengimplementasikan [algoritma diagonalisasi kuantum berbasis sampel (SQD)](https://arxiv.org/abs/2405.05068). Detail lebih lanjut tentang perangkat lunaknya dapat ditemukan di [dokumentasi](https://docs.quantum.ibm.com/addons/qiskit-addon-sqd) yang sesuai, termasuk [contoh sederhana](https://docs.quantum.ibm.com/addons/qiskit-addon-sqd/guides/quickstart) untuk memulai.
...
Setelah mengoptimalkan Circuit untuk eksekusi hardware, kita siap menjalankannya di hardware target dan mengumpulkan sampel untuk estimasi energi ground state. Karena kita hanya memiliki satu sirkuit, kita akan menggunakan [mode eksekusi Job](/guides/execution-modes) dari IBM Quantum Compute Service dan mengeksekusi Circuit kita.
...
- [Skalakan alur kerja kimia SQD dengan pemecah Dice](https://docs.quantum.ibm.com/addons/qiskit-addon-sqd/guides/integrate-dice-solver) - halaman yang menunjukkan cara menggunakan perangkat lunak Dice yang lebih efisien untuk diagonalisasi
- [Dokumentasi API addon SQD](https://docs.quantum.ibm.com/api/qiskit-addon-sqd/fermion#diagonalize_fermionic_hamiltonian) - referensi untuk fungsi `diagonalize_fermionic_hamiltonian`
