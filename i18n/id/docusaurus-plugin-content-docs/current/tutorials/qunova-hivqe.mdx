...
Perlu dicatat bahwa untuk menjalankan fungsi ini pada sistem FeP-NO dengan pengaturan yang ditampilkan dalam contoh ini, kamu memerlukan lisensi yang mengizinkan penggunaan fungsi dengan minimal 44 qubit. Kirim email ke [qiskit.support@qunovacomputing.com](mailto:qiskit.support@qunovacomputing.com) untuk menanyakan cara mendapatkan lisensi.
