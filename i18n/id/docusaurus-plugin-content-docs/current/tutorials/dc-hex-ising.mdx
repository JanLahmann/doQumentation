...
Setelah job selesai, kita bisa mengambil durasi circuit dari metadata hasil job dan memvisualisasikan informasi jadwal circuit. Untuk membaca lebih lanjut tentang memvisualisasikan informasi penjadwalan circuit, lihat [halaman ini](/guides/qiskit-runtime-circuit-timing).
