...
> **Catatan:** Survei ini dibuat oleh **IBM Quantum** dan mencakup **konten tutorial** (ditulis oleh IBM). doQumentation menyediakan situs web, terjemahan, dan eksekusi kode — untuk masukan mengenai hal tersebut, silakan [buka isu GitHub](https://github.com/JanLahmann/doQumentation/issues).
