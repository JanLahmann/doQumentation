...
{/* doqumentation-source-hash: b9eca0a6 */}
...
Bagian ini menggunakan sistem 10-site untuk mengilustrasikan alur kerja AQC-Tensor langkah demi langkah. Kita mensimulasikan dinamika rantai spin XXZ 10-site, sebuah model yang banyak dipelajari untuk mengkaji interaksi spin dan sifat magnetik.
...
### Langkah 1–4 digabungkan {#steps-14-combined}
