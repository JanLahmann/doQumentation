...
- Cara menggunakan [SQD Qiskit addon](https://github.com/Qiskit/qiskit-addon-sqd) untuk mendekati energi ground state dari model kisi menggunakan bitstring yang diambil dari unit pemrosesan kuantum (QPU).
- Cara menggunakan [ffsim](https://github.com/qiskit-community/ffsim) untuk membangun Circuit evolusi waktu untuk simulasi fermionik.
- Cara menggabungkan sampel dari beberapa Circuit untuk pasca-pemrosesan dengan algoritma diagonalisasi Krylov berbasis sampel (SKQD).

## Prasyarat {#prerequisites}
Kami menyarankan pengguna untuk familiar dengan topik-topik berikut sebelum mengikuti tutorial ini:
- [Diagonalisasi kuantum berbasis sampel untuk Hamiltonian kimia](/tutorials/sample-based-quantum-diagonalization)
- [Diagonalisasi kuantum Krylov untuk Hamiltonian kisi](/tutorials/krylov-quantum-diagonalization)
...
### Verifikasi energi {#verify-the-energy}
...
Sekarang, kita menjalankan contoh yang lebih besar pada QPU nyata.
Sebagai energi referensi, kita menggunakan hasil perhitungan [DMRG](https://en.wikipedia.org/wiki/Density_matrix_renormalization_group) yang dilakukan secara terpisah.
...
- [Diagonalisasi kuantum berbasis sampel untuk Hamiltonian kimia](/tutorials/sample-based-quantum-diagonalization) - tutorial terkait yang menggunakan ansatz variasional heuristik alih-alih Circuit Trotter
- [Diagonalisasi kuantum Krylov untuk Hamiltonian kisi](/tutorials/krylov-quantum-diagonalization) - tutorial tentang metode KQD
- [Dokumentasi API SQD addon](https://qiskit.github.io/qiskit-addon-sqd/apidocs/qiskit_addon_sqd.fermion.html#qiskit_addon_sqd.fermion.diagonalize_fermionic_hamiltonian) - referensi untuk fungsi `diagonalize_fermionic_hamiltonian`
- [*Quantum-Centric Algorithm for Sample-Based Krylov Diagonalization*](https://arxiv.org/abs/2501.09702) - makalah yang menjadi dasar tutorial ini
</Admonition>
