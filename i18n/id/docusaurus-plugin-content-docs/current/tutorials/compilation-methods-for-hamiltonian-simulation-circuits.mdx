...
---
{/* doqumentation-source-hash: 0b195319 */}
...
### Yang akan Anda pelajari {#yang-akan-anda-pelajari}
...
Sebelum memulai tutorial ini, pastikan Anda sudah menginstal yang berikut:
...
Circuit yang digunakan dalam benchmark ini diambil dari [repositori benchmark Hamlib](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation), yang berisi workload simulasi Hamiltonian yang realistis.
