...
### Gambaran umum metode kompilasi {#compilation-methods-overview}

#### Transpiler Qiskit dengan SABRE {#qiskit-transpiler-with-sabre}
...
#### Transpiler bertenaga AI {#ai-powered-transpiler}
...
### Sambungkan ke backend {#connect-to-a-backend}
...
### Definisikan pass manager {#define-pass-managers}
...
### Definisikan fungsi pembantu {#define-helper-functions}
...
### Muat sirkuit Hamiltonian dari Hamlib {#load-hamiltonian-circuits-from-hamlib}
...
### Langkah 2: Optimasi masalah untuk eksekusi perangkat keras kuantum {#step-2-optimize-problem-for-quantum-hardware-execution}
...
#### Visualisasi hasil {#visualize-results}
...
#### Metode terbaik per metrik {#best-performing-method-by-metric}
...
## Analisis hasil kompilasi {#analysis-of-compilation-results}
...
### Kedalaman dua-Qubit dan jumlah gate {#two-qubit-depth-and-gate-count}
...
### Hasil mirror circuit {#mirror-circuit-results}
