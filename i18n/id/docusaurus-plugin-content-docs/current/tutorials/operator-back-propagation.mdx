...
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop), paket berakselerasi Rust untuk propagasi Pauli, dengan tutorial yang mencakup OBP, estimasi nilai ekspektasi klasikal, dan simulasi berisik
</Admonition>
