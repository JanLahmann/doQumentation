...
Sebelum menjalankan pada QPU nyata, kita memverifikasi bahwa sirkuit dinamis maupun unitary menghasilkan Bell state ideal pada simulator tanpa noise. Kita menggunakan Qiskit Runtime `Sampler` dengan `AerSimulator` sebagai mode backend, pada jarak kecil yaitu 6.
