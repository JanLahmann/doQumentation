...
> **Catatan:** Survei ini dibuat oleh **IBM Quantum** dan mencakup **konten tutorial** (ditulis oleh IBM). doQumentation menyediakan situs web, terjemahan, dan eksekusi kode — untuk masukan tentang hal tersebut, silakan [buka issue GitHub](https://github.com/JanLahmann/doQumentation/issues).
