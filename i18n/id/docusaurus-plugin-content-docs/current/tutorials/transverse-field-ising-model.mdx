...
## Pengaturan {#setup}
Pertama, autentikasi menggunakan [API key IBM Quantum](http://quantum.cloud.ibm.com/). Kemudian, pilih Qiskit Function sebagai berikut. (Kode ini mengasumsikan kamu sudah [menyimpan akunmu](/guides/functions-get-started#install-qiskit-functions-catalog-client) ke lingkungan lokal.)
...
### Estimasi magnetisasi single-Qubit $\langle Z_i \rangle$ {#estimate-single-qubit-magnetizations-langle-z-i-rangle}
