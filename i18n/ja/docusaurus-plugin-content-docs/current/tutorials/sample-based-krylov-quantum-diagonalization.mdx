...
回路を作成したので、ターゲットハードウェアに合わせて最適化します。127量子ビット以上を持つ最も空いているQPUを選択します。詳細については、[Qiskit IBM&reg; Runtimeドキュメント](/guides/get-started-with-primitives#get-started-with-sampler)を参照してください。
