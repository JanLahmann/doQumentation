...
## パート2：ハミルトニアンシミュレーション回路 {#part-2-hamiltonian-simulation-circuit}

### ステップ1：`PauliEvolutionGate` を用いた回路の調査 {#step-1-investigate-circuits-with-paulievolutiongate}
...
#### ベンチマークで使用されるハミルトニアン {#hamiltonians-used-in-the-benchmark}
...
参考として、より広範なハミルトニアンのセットについては、こちらの論文を参照してください：[Efficient Hamiltonian Simulation on Noisy Quantum Devices](https://arxiv.org/pdf/2306.13126)。

#### ベンチマークの出典：Hamlib と Benchpress {#hamiltonians-used-in-the-benchmark}

このベンチマークで使用される回路は、現実的なハミルトニアンシミュレーションのワークロードを含む [Hamlib ベンチマークリポジトリ](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation) から取得されています。
...
#### ハミルトニアン回路コンパイル結果の分析 {#analysis-of-hamiltonian-circuit-compilation-results}
