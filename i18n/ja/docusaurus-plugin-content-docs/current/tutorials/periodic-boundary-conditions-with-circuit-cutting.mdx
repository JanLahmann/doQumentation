...
#### バックエンドと初期レイアウトの選択 {#select-backend-and-initial-layout}
...
#### TwoLocal回路のエンタングラーマップの構築 {#build-the-entangler-map-for-the-twolocal-circuit}
...
#### 回路のトランスパイル {#transpile-the-circuit}
...
#### 長距離周期的接続のカット {#cut-the-long-range-periodic-connectivities}
...
#### サブ実験のトランスパイル {#transpile-the-subexperiments}
