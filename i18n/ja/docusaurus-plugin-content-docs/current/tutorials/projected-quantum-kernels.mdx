...
このチュートリアルでは、QML 手法に関する一般的な知識があることを前提としています。QML についてさらに学びたい方は、IBM Quantum Learning の [Quantum machine learning](/learning/courses/quantum-machine-learning) コースを参照してください。
### 前提条件 {#requirements}
