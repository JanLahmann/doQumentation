...
<TabItem value="LaTeX" label="LaTeX">
  厳密には「プロット」ではありませんが、Qiskitは `Statevector` オブジェクトと `DensityMatrix` オブジェクトの両方について、Jupyterノートブックで見やすいLaTeX表現をレンダリングできます。これらは量子状態を記述するための標準的な数学的記法に従っています。詳細は [量子情報の基礎：単一システム](/learning/courses/basics-of-quantum-information/single-systems/introduction) を参照してください。
...
<TabItem value="City" label="City">
  ...
  詳細については [APIドキュメント](https://docs.quantum.ibm.com/api/qiskit/qiskit.visualization.plot_state_city) を参照してください。
...
<TabItem value="Hinton" label="Hinton">
  ...
  詳細については [APIドキュメント](https://docs.quantum.ibm.com/api/qiskit/qiskit.visualization.plot_state_hinton) を参照してください。
...
<TabItem value="Pauli vector" label="Pauli vector">
  ...
  詳細については [APIドキュメント](https://docs.quantum.ibm.com/api/qiskit/qiskit.visualization.plot_state_paulivec) を参照してください。
...
<TabItem value="Qsphere" label="Qsphere">
  ...
  詳細については [APIドキュメント](https://docs.quantum.ibm.com/api/qiskit/qiskit.visualization.plot_state_qsphere) を参照してください。
...
<TabItem value="Bloch" label="Bloch">
  ...
  詳細については [APIドキュメント](https://docs.quantum.ibm.com/api/qiskit/qiskit.visualization.plot_bloch_multivector) を参照してください。
...
`plot_state_city` 関数と `plot_state_paulivec` 関数は、棒の色を指定する **color** 引数（文字列のリスト）も受け付けます。詳細については [APIドキュメント](https://docs.quantum.ibm.com/api/qiskit/visualization) を参照してください。
...
<Admonition type="tip" title="推奨事項">
  ...
  - オープンソースのQiskit SDKにコントリビュートしたい場合は、[コントリビューションガイドライン](https://github.com/Qiskit/qiskit/blob/main/CONTRIBUTING.md) を読んでください。
</Admonition>
