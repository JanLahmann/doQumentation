...
`Neat`クラスを使用してEstimatorワークロードへのノイズの影響を分析できます。構文の確認には、[ローカルテストモード](/guides/local-testing-mode)を使用してください。
## `Neat`クラスの使用方法 {#neat-class-usage}
...
- [Qiskitデバッグツール](/guides/debugging-tools)の概要を読みます。
