...
<Admonition type="tip" title="サポートされている命令セット">
バックエンドのサポートされている命令セットを確認するには、[こちらのコード](/guides/qpu-information#native-gates-ops)を使用してください。すべてのサポートされている命令は[こちらの表](/guides/qpu-information#native-gates)で確認できます。
</Admonition>

新しいプロセッサーファミリーが追加されると、古いファミリーは廃止されます。詳細については、[廃止されたプロセッサーファミリー](retired-qpus#families)のセクションを参照してください。
...
<Admonition type="info" title="リビジョン">
  ...
  - `r2`（2026年9月）Nighthawk の第2バージョンで、120個のプログラム可能な qubit と458個の物理 qubit を備え、各 qubit に高速リセットを含みます。これにより、1秒あたりの最大 Circuit 数が大幅に向上します。
