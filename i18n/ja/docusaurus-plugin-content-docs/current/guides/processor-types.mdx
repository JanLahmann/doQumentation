...
バックエンドのネイティブゲートとオペレーションを確認するには、[こちらのコード](/guides/qpu-information#native-gates-ops)をご使用ください。すべてのネイティブゲートとオペレーションは[こちらの表](/guides/qpu-information#native-gates)でご確認いただけます。
</Admonition>
