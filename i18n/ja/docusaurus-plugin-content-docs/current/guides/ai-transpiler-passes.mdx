...
AI搭載Transpilerパスに適用される制限の詳細については、[Qiskit Transpiler Serviceドキュメント](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service)を参照してください。

## 引用 {#citation}

Qiskit Transpiler ServiceのAI搭載機能を研究で使用する場合は、[推奨される引用](/guides/qiskit-transpiler-service#citation)を使用してください。