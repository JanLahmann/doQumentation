...
AQC-Tensor Qiskitアドオンの詳細については、[近似量子コンパイルによる改善されたトロッター化時間発展](/tutorials/approximate-quantum-compilation-for-time-evolution)チュートリアルまたは[qiskit-addon-aqc-tensorリポジトリ](https://github.com/Qiskit/qiskit-addon-aqc-tensor)をご覧ください。
