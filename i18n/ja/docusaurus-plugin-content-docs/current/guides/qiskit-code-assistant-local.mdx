...
<Admonition type="note" title="Notes">
    ...
    - フィードバックがある場合や開発チームに連絡したい場合は、[Qiskit Slack Workspaceチャンネル](https://qiskit.enterprise.slack.com/archives/C07LYA6PL83)または関連するパブリックGitHubリポジトリを使ってください。
</Admonition>
...
Qiskitモデルが正常に機能するよう、HF GGUFリポジトリで提供されているシステムプロンプトを使用することを推奨します：[mistral-small-3.2-24b-qiskit-GGUF](https://huggingface.co/Qiskit/mistral-small-3.2-24b-qiskit-GGUF/blob/main/system)、[Qwen2.5-Coder-14B-Qiskit-GGUF](https://huggingface.co/Qiskit/Qwen2.5-Coder-14B-Qiskit-GGUF/blob/main/system)、[granite-3.3-8b-qiskit-GGUF](https://huggingface.co/Qiskit/granite-3.3-8b-qiskit-GGUF/blob/main/system)、および[granite-3.2-8b-qiskit-GGUF](https://huggingface.co/Qiskit/granite-3.2-8b-qiskit-GGUF/blob/main/system)のシステムプロンプトを参照してください。
