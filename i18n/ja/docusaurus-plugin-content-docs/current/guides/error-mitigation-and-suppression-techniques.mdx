...
### `measure_mitigation`オプションによるTREXの有効化 {#enable-trex-by-using-the-measure_mitigation-option}
...
### `resilience_level`オプションによるTREXの有効化 {#enable-trex-by-using-the-resilience_level-option}
...
### `zne_mitigation`オプションによるZNEの有効化 {#enable-zne-by-using-the-zne_mitigation-option}
...
### `resilience_level`オプションによるZNEの有効化 {#enable-zne-by-using-the-resilience_level-option}
...
- Qiskit Runtimeプリミティブの他の[オプション](/guides/runtime-options-overview)を探索してください。
