...
Qiskit Code Assistantの使用例として、[回路](/guides/circuit-library)、[エラー抑制の設定](/guides/error-mitigation-and-suppression-techniques)、[パスマネージャーを使ったトランスパイル](/guides/transpile-with-pass-managers)を参照してください。
</Admonition>
