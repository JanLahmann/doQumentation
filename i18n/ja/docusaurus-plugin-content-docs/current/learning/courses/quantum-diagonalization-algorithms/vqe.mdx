...
![原子軌道の画像と、多数のノードとその間の接続からなるネットワークの画像。](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig1.svg)
...
![変分パラメータ「theta」とラベルされた量子回路の画像。](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig2.svg)
...
![エネルギーを表す曲線上で、最小値を見つけるためにいくつかの点でテストされている様子を示す画像。](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig3.svg)
...
![異なるパウリ文字列の表。一部は可換で、一部は非可換です。](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig4.svg)
...
![最小値を持つ曲線の2つの画像。一方ではランダムに点をチェックして最小値を検索し、もう一方では隣接する2点間に直線を引いて勾配を推定しています。](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig5.svg)
...
![古典的・量子的変分アプローチを比較した表。どちらも良い初期推測が必要です。古典的にはコストが行列の次元の2乗にスケールし、量子的アプローチでは可換パウリ演算子のグループ数に依存します。](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig6.svg)
