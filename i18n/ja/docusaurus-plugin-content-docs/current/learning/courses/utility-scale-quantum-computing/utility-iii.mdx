...
Sampler V2でエラー抑制オプションを設定できます。詳細については、[Samplerノイズ管理](/guides/sampler-noise-management)ガイドおよび [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) APIリファレンスを参照してください。
