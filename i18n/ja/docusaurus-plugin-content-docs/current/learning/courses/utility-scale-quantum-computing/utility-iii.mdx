...
# ユーティリティスケール実験 III {#utility-scale-experiment-iii}
...
Sampler V2でエラー抑制オプションを設定できます。詳細については、[エラー緩和の設定](/guides/configure-error-mitigation#advanced-error)ガイドおよび [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) APIリファレンスを参照してください。
