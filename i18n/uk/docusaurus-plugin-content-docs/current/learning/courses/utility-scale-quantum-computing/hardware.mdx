...
PDF-файл лекції цього уроку було розбито на дві частини. [Завантажити частину 1](https://ibm.ent.box.com/public/static/ruz8wf353hncenmaywjlfjilflaumnzt.zip) та [завантажити частину 2](https://ibm.ent.box.com/public/static/tg8vv00ern2bmxmm033xt9oe0fcvwamc.zip). Зверніть увагу, що деякі фрагменти коду можуть застаріти, оскільки це статичні зображення.
