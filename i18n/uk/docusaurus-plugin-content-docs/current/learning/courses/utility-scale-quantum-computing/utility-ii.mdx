...
Спробуй це самостійно, спираючись на приклад з 20 кубітами. Як і раніше, порахуй операції для цієї схеми.
...
#### Визначення операторів для вимірювання {#set-the-operators-to-be-measured}
...
###  3.1 Крок 1. Відображення задачі на квантові схеми та оператори {#step-1-map-the-problem-to-quantum-circuits-and-operators}
