...
# Квантові алгоритми: Оцінка фази {#quantum-algorithms-phase-estimation}
...
QFT можна реалізувати за допомогою $O(N^2)$ операцій з квантовими Gate, такими як Gate Адамара та вентиль керованої фази для $N$ кубітів, що забезпечує експоненційне прискорення порівняно з класичним перетворенням Фур'є.
