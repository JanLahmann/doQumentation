...
## Патерни Qiskit, крок 3: Виконання за допомогою примітивів IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
## Крок 2 патернів Qiskit: Оптимізація задачі для квантового виконання {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution-1}
Починаємо з вибору бекенду для виконання. У цьому випадку використаємо найменш завантажений бекенд.
...
Тепер ми застосуємо менеджер проходів кілька разів. Для дуже широких або дуже глибоких схем може бути велика варіативність у транспільованих двокубітних глибинах. Для таких схем важливо спробувати менеджер проходів багато разів і використати найкращий (найменш глибокий) результат.
...
## Патерни Qiskit, крок 3: Виконання за допомогою примітивів IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
