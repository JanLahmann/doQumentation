...
__basis__ означає функції, що використовуються для моделювання молекулярних орбіталей. Тут 'sto-6g' є поширеним мінімальним базисом, названим за підгонку орбіталей типу Слейтера за допомогою 6 примітивних гауссових орбіталей.
...
__symmetry__ - точкова група симетрії молекули, вказана або рядком, або автоматично визначена шляхом встановлення "symmetry = True". Тут "Dooh" є відповідною групою симетрії для двоатомних молекул із двома атомами одного виду.
