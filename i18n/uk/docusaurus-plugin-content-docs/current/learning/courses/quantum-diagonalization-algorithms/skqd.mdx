...
## 0. Простір Крилова {#0-the-krylov-space}
...
## 2. Оптимізація для цільового апаратного забезпечення {#2-optimize-for-target-hardware}
...
## 3. Виконання на цільовому апаратному забезпеченні {#3-execute-on-target-hardware}
...
<Accordion>
<AccordionItem title="Що можна зробити, щоб покращити збіжність на графіку вище?">
...
<AccordionItem title="Які основні переваги SKQD над (a) SQD та (b) KQD?">

__Answer:__

Які основні переваги SKQD порівняно з (a) SQD та (b) KQD?

   (a) SKQD має гарантії збіжності, яких немає у SQD. У SQD потрібно або зробити дуже хороше припущення для анзацу, що має чудове перекриття з основним станом у обчислювальному базисі, або потрібно ввести варіаційний компонент у обчислення, щоб семплювати сім'ю анзаців.
