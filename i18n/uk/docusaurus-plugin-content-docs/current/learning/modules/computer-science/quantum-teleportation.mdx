...
- Крок 3: Виконай своє завдання на квантових комп'ютерах IBM за допомогою IBM Quantum primitives
...
«Sampler» — це примітив, призначений для вибірки можливих станів, що виникають у результаті квантової схеми, і збирання статистики про те, які стани можуть бути виміряні та з якою ймовірністю. Імпортуємо тут IBM Quantum Sampler:
...
### Крок 1: Відобразь задачу на квантову схему {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Крок 2: Оптимізуй свою схему {#step-2-optimize-your-circuit}
...
### Крок 3: Виконання {#step-3-execute-1}
...
2. Чи є щось унікальне в початковому заплутаному стані між Алісою та Бобом: $\frac{1}{\sqrt{2}}\left(|0\rangle_B|0\rangle_A+|1\rangle_B|1\rangle_A\right)?$ Якщо так, що саме унікальне в ньому? Якщо ні, які інші заплутані стани ми могли б використати?
