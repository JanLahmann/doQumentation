...
## Ступінь апроксимації {#approximation-degree}
...
## Зерно генератора випадкових чисел {#random-number-generator-seed}
...
## Початкове розміщення {#initial-layout}
...
Мок-Backend `FakeSherbrooke` з `qiskit_ibm_runtime` використовується в цих прикладах, але ти можеш спробувати його на будь-якому сумісному з Qiskit реальному або мок-Backend. Результати можуть відрізнятися.
</Admonition>
...
## Параметри етапів Transpiler та плагінів {#transpiler-stage-and-plugin-options}
