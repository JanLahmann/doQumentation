...
<Admonition type="tip">
**Qiskit Serverless оновлюється, і його можливості швидко змінюються.** На цьому етапі розробки примітки до випусків і найактуальнішу документацію можна знайти на сторінці [Qiskit Serverless GitHub](https://qiskit.github.io/qiskit-serverless/index.html).
</Admonition>

З допомогою Qiskit Serverless можна керувати обчислювальними та інформаційними ресурсами у межах свого [патерну Qiskit](/guides/intro-to-patterns), включаючи CPU, QPU та інші обчислювальні прискорювачі.
...
Якщо ти читаєш клітинки коду локально в ноутбуці, ти побачиш [магічну команду](https://ipython.readthedocs.io/en/stable/interactive/magics.html#cellmagic-writefile) `%%writefile`. Виконання клітинок із цією магічною командою зберігає їх на диск замість виконання.
</Admonition>
...
Нижче показано, як завантажувати файли. Переконайся, що ти авторизований у Qiskit Serverless за допомогою свого облікового запису IBM Quantum (інструкції — у розділі [Завантаження до Qiskit Serverless](/guides/serverless-first-program#upload-to-qiskit-serverless)).
...
- Переглянь повний приклад [перенесення існуючого коду до Qiskit Serverless](/guides/serverless-port-code).
