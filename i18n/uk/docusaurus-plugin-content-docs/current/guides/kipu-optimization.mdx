...
### 1. Створення цільової функції {#1-create-the-objective-function-1}
...
### 2. Запуск Оптимізатора {#2-run-the-optimizer-1}
...
### 3. Отримання результату {#3-retrieve-the-result-1}
