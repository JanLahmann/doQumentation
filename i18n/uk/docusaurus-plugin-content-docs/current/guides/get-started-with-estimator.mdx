---
description: 'Короткий вступний посібник з використання примітиву IBM Quantum Estimator.'
...
Тобі потрібна щонайменше одна схема та один спостережуваний як вхідні дані для примітива Estimator.
...
Схема та спостережуваний потребують перетворення для використання лише інструкцій, підтримуваних QPU (що називаються схемами *instruction set architecture (ISA)*). Використовуй транспілятор для цього.
...
### 3. Ініціалізація IBM Quantum Estimator {#3-initialize-the-ibm-quantum-estimator}
