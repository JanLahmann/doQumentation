...
- [Досліджуй circuit functions](/guides/algorithmiq-tem), щоб будувати нові алгоритми та застосунки без необхідності керувати транспіляцією або обробкою помилок.
