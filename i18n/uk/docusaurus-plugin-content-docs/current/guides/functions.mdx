...
|---|---|---|---|
| Tensor-Network Error Mitigation<br/><br/><ul><li>[Посібник](/guides/algorithmiq-tem)</li><li>[Довідник API](https://docs.quantum.ibm.com/api/functions/algorithmiq-tem)</li></ul>      | Algorithmiq  | Робочі навантаження з малими за вагою спостережуваними та схема без циклів. | Знижує накладні витрати на вимірювання та дисперсію, перевершуючи стандартні базові методи пом'якшення помилок, такі як Zero Noise Extrapolation (ZNE) та Probabilistic Error Cancellation (PEC) для відповідних класів Circuit. |
