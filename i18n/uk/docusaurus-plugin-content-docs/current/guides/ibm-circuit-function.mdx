...
Переглянь таблицю нижче, де наведено всі вхідні параметри, які приймає IBM Circuit function. Подальший розділ [Параметри](#options) детальніше описує доступні `options`.
...
Звернись до [підтримки IBM Quantum](/guides/support) та надайте наступну інформацію:
