...
<Admonition type="tip">
**Qiskit Serverless оновлюється, і його функції швидко змінюються.** У цей період розробки нотатки до версій і найновіша документація доступні на сторінці [Qiskit Serverless GitHub](https://qiskit.github.io/qiskit-serverless/index.html).
</Admonition>
...
Переконайся, що ти виконав робочий процес із розділу [Напиши свою першу програму Qiskit Serverless](/guides/serverless-first-program), перш ніж розпочати.

## Перегляд доступних програм {#list-programs-available}

Ти можеш використовувати `QiskitServerless.list()`, щоб отримати список доступних програм для запуску через Qiskit Serverless. Це включає раніше завантажену програму [`transpile_remote_serverless`](/guides/serverless-first-program).
...
- Досліди [інструменти керування обчислювальними ресурсами та даними](/guides/serverless-manage-resources), доступні у твоїй програмі, включно з паралелізацією.
