...
*Дивись [довідник API](https://docs.quantum.ibm.com/api/functions/algorithmiq-tem)*
...
Автентифікуйся за допомогою свого [ключа API IBM Quantum Platform](http://quantum.cloud.ibm.com/) та вибери функцію TEM наступним чином. (Цей фрагмент коду передбачає, що ти вже [зберіг свій акаунт](/guides/functions-get-started#install-qiskit-functions-catalog-client) у локальному середовищі.)
...
Використовуй API Qiskit Serverless для перевірки статусу твого робочого навантаження Qiskit Function:
...
- [Запросити доступ до Algorithmiq Tensor-network error mitigation](https://quantum.ibm.com/functions?id=4b1b9d76-c18b-4788-b70b-15125111fbe6).

- Відвідай [довідник API](https://docs.quantum.ibm.com/api/functions/algorithmiq-tem) для цієї функції Qiskit.
