---
description: 'Зрозумій формат вхідних і вихідних даних (включно з Primitive Unified Blocs або PUB) примітивів Qiskit SDK'
...
<Admonition type="tip" title="Рекомендації">
  ...
  -  Ознайомся з API [примітивів Qiskit SDK](https://docs.quantum.ibm.com/api/qiskit/primitives).

  -  Ознайомся з API [Qiskit Aer primitives](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html).

  -  Дізнайся більше про [примітиви IBM Quantum](/guides/qiskit-runtime-primitives).

  -  Ознайомся з API [`qiskit-ibm-runtime` Estimator](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2).

  -  Ознайомся з API [`qiskit-ibm-runtime` Sampler](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2).
</Admonition>
