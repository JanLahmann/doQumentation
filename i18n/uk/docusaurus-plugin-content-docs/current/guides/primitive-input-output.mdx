...
![Це зображення ілюструє кілька візуальних представлень трансляції масивів.](/docs/images/guides/primitive-input-output/broadcasting.avif "Візуальне представлення трансляції")
