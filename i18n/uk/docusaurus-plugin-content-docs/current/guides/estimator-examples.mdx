---
title: "Приклади Estimator"
sidebar_label: "Приклади Estimator"
description: "Практичні приклади використання примітива Estimator у Qiskit Runtime."
...
Приклади в цьому розділі ілюструють деякі поширені способи використання Estimator. Перед запуском цих прикладів дотримуйся інструкцій із [Встановлення Qiskit.](install-qiskit)

<Admonition type="note">
Всі ці приклади використовують примітиви з Qiskit Runtime, але замість них можна використовувати базові примітиви.
</Admonition>
...
Досліджуй [режим виконання](/guides/execution-modes) batch та розширені опції для оптимізації продуктивності схем на QPU.
...
- [Вкажи розширені опції виконання](runtime-options-overview).
- Практикуйся з примітивами, виконуючи [урок функції втрат](/learning/courses/variational-algorithm-design/cost-functions) в IBM Quantum&reg; Learning.
...
- Зрозумій [обмеження завдань](/guides/job-limits) при відправці завдання на IBM&reg; QPU.
</Admonition>
