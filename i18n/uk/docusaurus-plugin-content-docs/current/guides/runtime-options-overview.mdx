---
description: 'Доступні параметри для роботи з примітивами IBM Quantum'
...
Ти можеш використовувати параметри для налаштування примітивів IBM Quantum відповідно до своїх потреб.
