...
These instructions use the standard Python distribution from [pypi.org](https://pypi.org/). However, you can use other Python distributions, such as [Anaconda](https://docs.anaconda.com/anaconda/) or [miniconda](https://docs.anaconda.com/miniconda/), along with other dependency management workflows like [Poetry](https://python-poetry.org/docs/).
    ...
    <Accordion>
    <AccordionItem title="Натисни, щоб дізнатися більше про **віртуальні середовища**.">
    - Використовуй [віртуальні середовища Python](https://docs.python.org/3.10/tutorial/venv.html), щоб відокремити Qiskit від інших застосунків.
    Віртуальне середовище Python — це ізольований простір для роботи з Python для конкретної мети, тому ти можеш встановлювати будь-які потрібні пакети та налаштовувати бібліотеки, залежності тощо, не впливаючи на «базове» середовище Python на своєму пристрої.
