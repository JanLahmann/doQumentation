...
4. Якщо `twirling` увімкнено, використовується добуток `num_randomizations` та `shots_per_randomization`, вказаний як [параметри `twirling`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-twirling-options).
