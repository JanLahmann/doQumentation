...
* Ефективна підготовка квантового стану, наприклад [стан GHZ](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339), [W-стан](https://arxiv.org/abs/2403.07604) (для отримання додаткової інформації про W-стан, також дивись ["State preparation by shallow circuits using feed forward"](https://arxiv.org/abs/2307.14840)), та широкий клас [станів матричного добутку](https://arxiv.org/abs/2404.16083)

* [Ефективна заплутаність на великих відстанях](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339) між кубітами на одному чипі за допомогою неглибоких схем

* Ефективна [вибірка схем, подібних до IQP](https://arxiv.org/pdf/2505.04705)
Qiskit підтримує чотири конструкції керування потоком для класичного зворотного зв'язку, кожна з яких реалізована як метод у [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit). Ці конструкції та відповідні їм методи такі:
...
Оператору `with` можна надати ціль присвоєння, яка сама є контекстним менеджером, який можна зберегти та згодом використати для створення блоку else, що виконується щоразу, коли вміст блоку `if` *не* виконується.
