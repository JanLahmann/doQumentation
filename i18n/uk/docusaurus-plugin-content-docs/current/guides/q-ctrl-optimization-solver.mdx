...
![Вихід попередньої комірки коду](/docs/images/guides/q-ctrl-optimization-solver/extracted-outputs/0a7255e1-0.svg)
...
### 1. Визнач задачу {#1-define-the-problem-mvc}
...
### 2. Запусти задачу {#2-run-the-problem-mvc}
