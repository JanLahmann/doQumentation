...
Ти можеш встановлювати параметри під час ініціалізації Estimator, після ініціалізації Estimator або оновлювати їх після ініціалізації. Для інструкцій щодо використання цих технік дивись тему [Вступ до параметрів](/guides/runtime-options-overview#options-precedence).

Крім того, ти можеш встановлювати значення `precision` у методі `run()`, як описано в наступному розділі.
...
<Tabs>
  ...
  <TabItem value="ZNE" label="ZNE зі складанням вентилів">
    Несумісне з:
  - PEA
  - PEC
  ...
  <TabItem value="Twirling" label="Twirling вентилів">
  Несумісне з дробовими вентилями або зі stretch.
