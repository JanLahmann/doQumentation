---
description: 'Перейди від хмарних симуляторів IBM Quantum до локального режиму тестування `qiskit-ibm-runtime`.'
title: 'Перехід до локальних симуляторів'
---

{/* doqumentation-source-hash: 9db328b8 */}

# Перехід на локальні симулятори {#migrate-to-local-simulators}
...
## Перехід на локальні симулятори {#migrate-to-local-simulators-1}
