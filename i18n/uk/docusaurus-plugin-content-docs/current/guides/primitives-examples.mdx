---
title: "Приклади використання примітивів"
sidebar_label: "Приклади використання примітивів"
description: "Практичні приклади використання примітивів у Qiskit Runtime."
...
Бета-версія нової моделі виконання тепер доступна. Спрямована модель виконання забезпечує більшу гнучкість під час налаштування робочого процесу зменшення помилок. Дивись посібник [Спрямована модель виконання](/guides/directed-execution-model) для отримання додаткової інформації.
</Admonition>
{/*
...
Приклади в цьому розділі ілюструють кілька поширених способів використання примітивів. Перш ніж запускати ці приклади, дотримуйся інструкцій у розділі [Встановлення та налаштування.](install-qiskit)
...
## Приклади Estimator {#estimator-examples}
...
### Використання сесій та розширених параметрів {#use-sessions-and-advanced-options}

Вивчай сесії та розширені параметри для оптимізації продуктивності схем на QPU.

<Admonition type="caution">
Наступний блок коду поверне помилку для користувачів тарифного плану Open Plan, оскільки він використовує сесії. Робочі навантаження на тарифному плані Open Plan можуть виконуватися лише в [режимі завдання](/guides/execution-modes#job-mode) або в [пакетному режимі](/guides/execution-modes#batch-mode).
</Admonition>
...
## Приклади Sampler {#sampler-examples}
...
### Використання сесій та розширених параметрів {#use-sessions-and-advanced-options-sampler}
...
<Admonition type="tip" title="Рекомендації">
    - [Вкажи розширені параметри середовища виконання.](runtime-options-overview)
    - Практикуйся з примітивами, опрацювавши [урок з функцій витрат](/learning/courses/variational-algorithm-design/cost-functions) у IBM Quantum Learning.
    - Дізнайся, як транспілювати локально, у розділі [Транспіляція](./transpile/).
    ...
    - Ознайомся з [Обмеженнями завдань](/guides/job-limits) під час надсилання завдання на QPU IBM&reg;.
</Admonition>
