...
2. Налаштуйте автентифікацію для доступу до квантового обладнання через безкоштовний [Відкритий План](/guides/plans-overview#open-plan).
    ...
    - Перейдіть на [IBM Quantum Platform](https://quantum.cloud.ibm.com/), щоб увійти або створити обліковий запис.
         ...
         Якщо Випідключаєтеся через проксі-сервер, Виповинні використовувати Qiskit Runtime v0.44.0 або пізнішу версію.
         </Admonition>
...
Якщо Вивикористовуєте публічний комп'ютер або інше незахищене середовище, натомість виконайте [інструкції ручної автентифікації](/guides/cloud-setup-untrusted), щоб зберегти Ваші облікові дані в безпеці.
</Admonition>
...
Після подання завдання Виможете почекати, поки завдання буде завершено у Вашому поточному екземплярі python, або використовувати `job_id` для отримання даних пізніше. (Докладніше дивіться [розділ про отримання завдань](/guides/monitor-job#retrieve-job-results-at-a-later-time).)
...
<Admonition type="note" title="Альтернатива: запуск прикладу за допомогою симулятора">
  Коли Визапускаєте свою квантову програму на реальному пристрої, Ваше завдання повинно чекати в черзі перед запуском. Щоб заощадити час, Виможете натомість використовувати наступний код для запуску цього невеликого завдання на [`fake_provider`](../api/qiskit-ibm-runtime/fake-provider) з режимом локального тестування Qiskit Runtime. Зверніть увагу, що це можливо лише для невеликої схеми. Коли Вимасштабуватимете в наступному розділі, Вам потрібно буде використовувати реальний пристрій.
...
Наступний код перетворює схему та спостережувані величини відповідно до ISA backend. Це вимагає, щоб Вивже [зберегли свої облікові дані](/guides/cloud-setup)
...
<Admonition type="tip" title="Рекомендації">
  ...
  - Якщо Вине бажаєте встановлювати Qiskit локально, прочитайте про варіанти використання Qiskit в [онлайн-середовищі розробки.](/guides/online-lab-environments)
