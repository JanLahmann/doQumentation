...
Ти можеш встановлювати параметри під час ініціалізації примітива, після ініціалізації або в методі `run()`. Переглянь розділ [правила пріоритетності](runtime-options-overview#options-precedence), щоб зрозуміти, що відбувається, коли той самий параметр вказано в кількох місцях.
