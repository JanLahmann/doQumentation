...
Найпростіший спосіб почати роботу з Qiskit Code Assistant у локальному режимі — скористатися автоматизованими скриптами налаштування для розширень VS Code або JupyterLab. Ці скрипти автоматично встановлять [Ollama](https://ollama.com/) для запуску LLM, завантажать рекомендовану модель і налаштують розширення.
...
#### Моделі GGUF (рекомендовано для особистих середовищ/ноутбуків) {#gguf-models-recommended-for-personal-environmentslaptops}
...
<Admonition type="tip" title="Рекомендації">
  ...
  - Дивись приклади використання Qiskit Code Assistant для [схем](/guides/circuit-library), [налаштування придушення помилок](/guides/error-mitigation-and-suppression-techniques) і [транспіляції з менеджерами проходів](/guides/transpile-with-pass-managers).
</Admonition>
