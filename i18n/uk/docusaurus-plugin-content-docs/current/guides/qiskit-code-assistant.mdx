...
Також можна додати параметри генерації тексту до моделі, щоб налаштувати LLM-виведення:
...
- Збери з вихідного коду, [клонувавши цей репозиторій](https://github.com/ggml-org/llama.cpp/blob/master/docs/build.md)
...
1. [Qiskit/mistral-small-3.2-24b-qiskit](https://huggingface.co/Qiskit/mistral-small-3.2-24b-qiskit) - Випущено в жовтні 2025 р.
2. [Qiskit/Qwen2.5-Coder-14B-Qiskit](https://huggingface.co/Qiskit/Qwen2.5-Coder-14B-Qiskit) - Випущено в червні 2025 р.
3. [qiskit/granite-3.3-8b-qiskit](https://huggingface.co/Qiskit/granite-3.3-8b-qiskit) - Випущено в червні 2025 р.
4. [qiskit/granite-3.2-8b-qiskit](https://huggingface.co/Qiskit/granite-3.2-8b-qiskit) - Випущено в червні 2025 р.

#### GGUF-моделі (рекомендовано для персональних середовищ/ноутбуків)

Моделі у форматі GGUF оптимізовані для локального використання і потребують менше обчислювальних ресурсів:

1. [mistral-small-3.2-24b-qiskit-GGUF](https://huggingface.co/Qiskit/mistral-small-3.2-24b-qiskit-GGUF) – Випущено **в жовтні 2025 р.**  
   *Навчено на даних Qiskit до версії **2.1***  

2. [Qiskit/Qwen2.5-Coder-14B-Qiskit-GGUF](https://huggingface.co/Qiskit/Qwen2.5-Coder-14B-Qiskit-GGUF) – Випущено **в червні 2025 р.**  
   *Навчено на даних Qiskit до версії **2.0***  

3. [qiskit/granite-3.3-8b-qiskit-GGUF](https://huggingface.co/Qiskit/granite-3.3-8b-qiskit-GGUF) – Випущено **в червні 2025 р.**  
   *Навчено на даних Qiskit до версії **2.0***  

4. [qiskit/granite-3.2-8b-qiskit-GGUF](https://huggingface.co/Qiskit/granite-3.2-8b-qiskit-GGUF) – Випущено **в червні 2025 р.**  
   *Навчено на даних Qiskit до версії **2.0***  
...
| **Модель** | &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; | **Показники бенчмарку** | &nbsp; | &nbsp; | &nbsp; | &nbsp; | **Дата випуску** | **Навчено на версії Qiskit** |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
*Примітка: усі моделі, перелічені в таблиці бенчмарку, оцінювалися з використанням відповідного системного промпту, визначеного в їхній моделі на Hugging Face.*

#### Застарілі моделі

Ці моделі більше не підтримуються активно, але залишаються доступними:

1. [qiskit/granite-8b-qiskit-rc-0.10](https://huggingface.co/Qiskit/granite-8b-qiskit-rc-0.10) - Випущено в лютому 2025 р. (застаріла)
2. [qiskit/granite-8b-qiskit](https://huggingface.co/Qiskit/granite-8b-qiskit) - Випущено в листопаді 2024 р. (застаріла)

## Додаткова інформація та цитування {#more-information-and-citations}

Щоб дізнатися більше про Qiskit Code Assistant, бенчмарки Qiskit HumanEval і Qiskit HumanEval Hard, а також процитувати їх у своїх наукових публікаціях, ознайомся з цими рекомендованими цитуваннями:
