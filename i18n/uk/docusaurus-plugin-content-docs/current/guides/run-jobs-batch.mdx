---
description: 'Як запускати завдання квантових обчислень у пакетному режимі за допомогою IBM Quantum Compute Service.'
...
Перед запуском пакета потрібно [налаштувати клієнт IBM Quantum Compute](/guides/install-qiskit) та ініціалізувати його як сервіс:
...
Для повного огляду конфігурації та статусу пакета, включно з його інтерактивним та максимальним TTL, використовуй метод `batch.details() method`.
