...
Пройди автентифікацію за допомогою свого [API-ключа](https://quantum.cloud.ibm.com/) та вибери Qiskit Function таким чином. (Цей фрагмент передбачає, що ти вже [зберіг свій обліковий запис](/guides/functions-get-started#install-qiskit-functions-catalog-client) у локальному середовищі.)
...
![Візуалізація рішення оптимізації](/docs/images/guides/global-data-quantum-optimizer/cost_distribution.avif)
