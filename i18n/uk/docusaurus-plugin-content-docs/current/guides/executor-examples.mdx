---
description: 'Практичні приклади використання примітиву Executor у qiskit-ibm-runtime.'
...
### Налаштування кола {#set-up-the-circuit-1}
...
### Виконання кіл {#execute-the-circuits-1}
