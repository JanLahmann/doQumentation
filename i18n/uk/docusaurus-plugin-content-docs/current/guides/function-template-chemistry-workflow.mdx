...
# Розгортання та запуск шаблону для симуляції електронної структури з моделлю неявного розчинника {#deploy-and-run-a-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
<details>
<summary> Натисни для отримання детальнішої інформації про необхідні параметри: </summary>
...
<details>
<summary> Натисни для отримання додаткової інформації про налаштування параметрів SQD:</summary>
...
- Ознайомся з посібником зі створення шаблону функції для [симуляції гамільтоніана](./function-template-hamiltonian-simulation)
