...
Наступний код демонструє приклад набору векторизованих вхідних даних для примітива `Estimator` та виконує їх на бекенді IBM&reg; як єдиний об'єкт `RuntimeJobV2 `.
