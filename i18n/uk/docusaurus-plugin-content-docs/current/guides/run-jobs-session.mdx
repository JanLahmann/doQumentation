---
description: 'Як запускати завдання квантових обчислень у сесії IBM Quantum Compute Service.'
...
Перед запуском сесії потрібно [налаштувати клієнт IBM Quantum Compute](/guides/install-qiskit-runtime) та ініціалізувати його як сервіс:
...
Для повного огляду конфігурації та статусу сесії використовуй метод `session.details() method`.
