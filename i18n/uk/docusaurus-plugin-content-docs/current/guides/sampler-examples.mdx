---
description: 'Практичні приклади використання примітива Sampler від IBM Quantum.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Приклади використання Sampler'
title: 'Приклади використання Sampler'
---
...
## Запуск одиночного експерименту {#run-a-single-experiment}

Використовуй Sampler для повернення результату вимірювання у вигляді бітових рядків або підрахунків однієї схеми.
...
Використовуй Sampler для повернення результату вимірювання у вигляді бітових рядків або підрахунків кількох схем в одному завданні.
...
Запускай кілька експериментів в одному завданні, використовуючи значення параметрів для підвищення повторного використання схем.
...
## Використання пакетів та розширених опцій {#use-batches-and-advanced-options}

Вивчай пакетний [режим виконання](/guides/execution-modes) та розширені опції для оптимізації продуктивності схем на QPU.
...
- [Вкажи розширені опції середовища виконання](runtime-options-overview).
...
- Зрозумій [Обмеження завдань](/guides/job-limits) при надсиланні завдання на IBM&reg; QPU.
</Admonition>
