...
Наступний блок використовує оцінену [стандартну похибку](https://en.wikipedia.org/wiki/Standard_error) кожного результату та додає їх як стовпці похибок. Переглянь [документацію стовпчастого графіка `bar`](https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.bar.html) для повного опису графіка.
