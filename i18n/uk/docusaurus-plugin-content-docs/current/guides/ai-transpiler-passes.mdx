...
Докладнішу інформацію про обмеження, що застосовуються до проходів транспілятора на основі ШІ, можна знайти в [документації Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service).

## Цитування {#citation}

Якщо ти використовуєш будь-яку функцію на основі ШІ з Qiskit Transpiler Service у своїх дослідженнях, скористайся [рекомендованим цитуванням](/guides/qiskit-transpiler-service#citation).
