---
description: 'Побудуй шаблон Qiskit для розрізання вентилів у квантовій схемі з метою зменшення глибини схеми.'
...
Цей посібник демонструє, як побудувати `Qiskit pattern` для розрізання вентилів у квантовій схемі з метою зменшення глибини схеми. Для більш детального обговорення розрізання схем відвідай [документацію додатка Qiskit для розрізання схем](https://qiskit.github.io/qiskit-addon-cutting/).
...
Виконай цільові схеми ("підексперименти") за допомогою примітива Sampler.
...
Використай результати підексперименів, підспостережувані величини та коефіцієнти семплювання для реконструкції очікуваного значення оригінальної схеми.
...
> **Примітка:** Це опитування проводиться **IBM Quantum** і охоплює **зміст підручника** (написаний IBM). doQumentation надає вебсайт, переклади та виконання коду — для відгуків щодо них, будь ласка, [створи GitHub issue](https://github.com/JanLahmann/doQumentation/issues).
