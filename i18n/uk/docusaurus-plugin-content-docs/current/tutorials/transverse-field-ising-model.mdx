...
*Оцінка використання: 2 хвилини на процесорі Heron r2. (ПРИМІТКА: Це лише оцінка. Твій час виконання може відрізнятися.)*
...
## Налаштування {#setup}
Спочатку виконай автентифікацію, використовуючи твій [ключ API IBM Quantum](http://quantum.cloud.ibm.com/). Потім вибери функцію Qiskit наступним чином. (Цей код передбачає, що ти вже [зберіг свій обліковий запис](/guides/functions-get-started#install-qiskit-functions-catalog-client) у твоєму локальному середовищі.)
...
### Запуск на обладнанні {#run-on-hardware}
...
### Запуск на обладнанні з Fire Opal {#run-on-hardware-with-fire-opal}
Ми оцінюємо динаміку намагніченості на реальному квантовому обладнанні. Fire Opal надає функцію Qiskit, яка розширює стандартний примітив Estimator з IBM Quantum автоматичним придушенням помилок та керуванням продуктивністю. Ми надсилаємо троттеризовані схеми безпосередньо на бекенд IBM&reg;, тоді як Fire Opal обробляє виконання з урахуванням шуму.
...
Нарешті, ми порівнюємо криву намагніченості з симулятора з результатами, отриманими на реальному обладнанні. Побудова обох поруч показує, наскільки близько виконання на обладнанні з Fire Opal відповідає базовій лінії без шуму на кроках Троттера.
...
Будь ласка, приділи хвилину, щоб надати відгук про цей навчальний посібник. Твої думки допоможуть нам покращити наші пропозиції контенту та досвід користувачів.
