...
## Налаштування {#setup}
Спочатку виконай автентифікацію, використовуючи твій [ключ API IBM Quantum](http://quantum.cloud.ibm.com/). Потім вибери функцію Qiskit наступним чином. (Цей код передбачає, що ти вже [зберіг свій обліковий запис](/guides/functions#install-qiskit-functions-catalog-client) у твоєму локальному середовищі.)
...
Ми оцінюємо динаміку намагніченості на реальному квантовому обладнанні. Fire Opal надає функцію Qiskit, яка розширює стандартний примітив Estimator з Qiskit Runtime автоматичним придушенням помилок та керуванням продуктивністю. Ми надсилаємо троттеризовані схеми безпосередньо на бекенд IBM&reg;, тоді як Fire Opal обробляє виконання з урахуванням шуму.
