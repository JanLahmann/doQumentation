...
*Оцінка використання: менше 1 хвилини на процесорі Heron (ПРИМІТКА: Це лише оцінка. Твій час виконання може відрізнятися.)*
...
Для отримання додаткової інформації про QEC звернись до [Quantum Error Correction for Beginners.](https://arxiv.org/abs/0905.2794)
## Вимоги {#requirements}
...
### Побудова схеми стабілізатора перевертання біта {#build-a-bit-flip-stabilizer-circuit}

Код перевертання біта є одним з найпростіших прикладів коду стабілізатора. Він захищає стан від однієї помилки перевертання біта (X) на будь-якому з кодувальних кубітів. Розглянемо дію помилки перевертання біта $X$, яка відображає $|0\rangle \rightarrow |1\rangle$ і $|1\rangle \rightarrow |0\rangle$ на будь-якому з наших кубітів, тоді ми маємо $\epsilon = \{E_0, E_1, E_2 \} = \{IIX, IXI, XII\}$. Код вимагає п'яти кубітів: три використовуються для кодування захищеного стану, а два інші використовуються як допоміжні для вимірювання стабілізатора.
...
## Крок 2. Оптимізація задачі для квантового виконання {#step-2-optimize-the-problem-for-quantum-execution}
...
Запусти версію з застосованим виправленням та одну без виправлення.
...
Ти можеш побачити, що код перевертання біта виявив і виправив багато помилок, що призвело до меншої кількості помилок загалом.
...
[Посилання на опитування](https://your.feedback.ibm.com/jfe/form/SV_5onAlfA2Y7ac1FA)
