...
Ланцюги, використані в цьому тесті продуктивності, взяті з [репозиторію тестів продуктивності Hamlib](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation), який містить реалістичні робочі навантаження для симуляції гамільтоніанів.
...
Хоча транспілятор на основі штучного інтелекту зазвичай дає кращі результати, ніж SABRE, особливо в глибині ланцюга, висновок не повинен бути просто «завжди використовуй транспілятор на основі штучного інтелекту». Є важливі нюанси, які слід враховувати:
