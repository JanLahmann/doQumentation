...
Також можна передати власні параметри для навчання шуму. Вони відповідають визначенням, що використовуються в `qiskit-ibm-runtime` [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options):
