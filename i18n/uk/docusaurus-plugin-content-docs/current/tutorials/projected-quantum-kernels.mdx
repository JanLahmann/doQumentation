...
Цей навчальний посібник також передбачає загальне знайомство з методами QML. Для подальшого вивчення QML звернись до курсу [Quantum machine learning](/learning/courses/quantum-machine-learning) в IBM Quantum Learning.
### Вимоги {#requirements}
...
Основними будівельними блоками проєктованих квантових ядер є зведені матриці густини (RDM), які отримуються через проєктивні вимірювання квантової карти ознак. На цьому кроці ми отримуємо всі однокубітні зведені матриці густини (1-RDM), які пізніше будуть передані в класичну експоненціальну функцію ядра.
