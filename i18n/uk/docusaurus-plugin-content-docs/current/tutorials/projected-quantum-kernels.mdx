...
Цей навчальний посібник також передбачає загальне знайомство з методами QML. Для подальшого вивчення QML зверніться до курсу [Quantum machine learning](/learning/courses/quantum-machine-learning) в IBM Quantum Learning.
### Вимоги {#requirements}
