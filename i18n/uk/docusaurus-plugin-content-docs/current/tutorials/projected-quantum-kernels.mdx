...
Ви можете запустити цей навчальний посібник, виконавши наступну комірку, яка автоматично створює необхідну структуру папок і завантажує як навчальні, так і тестові файли безпосередньо у Ваше середовище. Якщо у Вас вже є ці файли локально, цей крок безпечно перезапише їх, щоб забезпечити узгодженість версій.
...
Іншим варіантом квантового вбудовування є ансатц еволюції гамільтоніану 1D-Heisenberg. Ви можете пропустити виконання цього розділу, якщо хочете продовжити з `ZZFeatureMap`.
...
Потім ми запускаємо квантову схему і вимірюємо проєкції. Зверніть увагу, що ми вмикаємо пом'якшення помилок, включаючи екстраполяцію з нульовим шумом (ZNE).
...
Ми також надаємо результати з експерименту, який ми запустили на квантовому обладнанні. Ви можете або запустити навчання самостійно, встановивши прапорець нижче на `True`, або використати результати проєкцій, які ми надаємо.
...
Зверніть увагу, що обробка всього набору даних може зайняти близько 80 хвилин на QPU. Щоб переконатися, що решта посібника легко виконується, ми додатково надаємо проєкції з раніше виконаного експерименту (які включені у файли, що Ви завантажили в блоці коду `Download dataset`). Якщо Ви виконували навчання самостійно, Ви можете продовжити посібник зі своїми власними результатами.
