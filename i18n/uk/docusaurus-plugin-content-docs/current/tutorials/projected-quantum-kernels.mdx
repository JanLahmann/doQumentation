...
### Визначення проєктованого квантового ядра
...
### Класичне порівняльне тестування
...
## Додаток: Перевірка потенційної квантової переваги набору даних у задачах навчання
