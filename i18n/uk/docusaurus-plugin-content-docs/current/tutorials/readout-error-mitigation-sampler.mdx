...
Це має сенс, коли ти пригадуєш, що зчитування вимагає виявлення мікроскопічного
...
- При оцінюванні ${M}$, ми припускали, що сталися лише помилки зчитування. Зокрема,
  ...
  схема вноситиме шум, наприклад, помилки вентилів. "Справжній" розподіл
...
Для технічних деталей про M3 ти можеш звернутися до [*Scalable Mitigation of Measurement Errors on Quantum Computers*](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.2.040326).
...
Додаткове ускладнення полягає в тому, що для того, щоб мати простішу (до транспіляції) схему, ми вставили необхідні вентилі CZ між
...
Давай запишемо ймовірність найбільш ймовірного бітового рядка перед застосуванням пом'якшення помилок зчитування за допомогою M3.
...
Результати показують, що похибка зчитування була домінантним джерелом похибки і пом'якшення M3 було ефективним.
