...
Цей посібник демонструє, як запустити експеримент з пом'якшення помилок промислового масштабу з Qiskit Runtime, використовуючи експериментальну версію *екстраполяції нульового шуму* (ZNE) з *ймовірнісним підсиленням помилок* (PEA).
...
**Посилання**: Y. Kim et al. *Evidence for the utility of quantum computing before fault tolerance.* [Nature 618.7965 (2023)](https://www.nature.com/articles/s41586-023-06096-3)
