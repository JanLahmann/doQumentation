...
### Крок 1: Зіставлення класичних вхідних даних з квантовою задачею {#step-1-map-classical-inputs-to-a-quantum-problem}
...
#### Створення та розширення спостережуваних величин {#create-and-expand-the-observables}
...
#### Транспіляція кожного підексперименту {#transpile-each-subexperiment}
...
#### Перехресна перевірка {#cross-verify}
...
## Частина II. Збільшення масштабу! {#part-ii-scale-it-up}
...
## Додаток: міркування щодо масштабування ресурсів {#appendix-resource-scaling-consideration}
...
### По одному прикладу схем, сприятливих і несприятливих для розрізання {#one-example-of-cut-friendly-and-cut-unfriendly-circuits-each}

#### Схема, сприятлива для розрізання {#cut-friendly-circuit}
...
#### Схема, несприятлива для розрізання {#cut-unfriendly-circuit}
