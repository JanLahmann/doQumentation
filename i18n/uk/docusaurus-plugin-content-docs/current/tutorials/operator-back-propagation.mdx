...
## Частина I: Малий спіновий ланцюг Гейзенберга
### Крок 1: Відображення класичних вхідних даних на квантову задачу
#### Відобразіть еволюцію в часі квантової моделі Гейзенберга на квантовий експеримент.
...
#### Створіть зрізи ланцюга для зворотного поширення
...
#### Обмежте, наскільки може зрости оператор під час зворотного поширення
...
#### Виконайте зворотне поширення зрізів з ланцюга
...
#### Тепер, коли ми маємо наш зменшений анзац та розширені спостережувані величини, ми можемо транспілювати наші експерименти до бекенду.
...
### Крок 4: Постобробка і повернення результату у бажаному класичному форматі
