...
- [Наближена квантова компіляція для кіл еволюції в часі](/tutorials/approximate-quantum-compilation-for-time-evolution)
- [Мультипродуктові формули для зменшення похибки Троттера](/tutorials/multi-product-formula)
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop), прискорений на Rust пакет для поширення Паулі, з підручниками, що охоплюють OBP, класичне оцінювання очікуваних значень та шумну симуляцію
</Admonition>
