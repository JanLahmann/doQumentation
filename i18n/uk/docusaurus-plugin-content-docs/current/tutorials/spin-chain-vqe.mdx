...
Побудуй анзац та гамільтоніан, які моделюють ланцюг Гайзенберга з 10 спінами. Спочатку ми імпортуємо деякі загальні пакети та створюємо кілька допоміжних функцій.
...
- Знайди енергію основного стану розрідженого гамільтоніана, дотримуючись [посібника SQD](/tutorials/sample-based-quantum-diagonalization)
- Пройди курс [Variational algorithm design](/learning/courses/variational-algorithm-design) на IBM Learning
</Admonition>
