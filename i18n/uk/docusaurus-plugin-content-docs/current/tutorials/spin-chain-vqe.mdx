...
- Як виконувати варіаційні робочі процеси на квантовому обладнанні IBM&reg; за допомогою IBM Quantum примітивів та сесій
...
Мінімізуй оцінену енергію основного стану системи шляхом оптимізації параметрів схеми. Використовуй IBM Quantum примітив `Estimator` для обчислення функції вартості під час оптимізації.

Оскільки ми оптимізували схему для бекенду на кроці 2, ми можемо уникнути транспіляції на сервері Quantum Compute, встановивши `skip_transpilation=True` та передавши оптимізовану схему. Для цієї демонстрації ми будемо виконувати обчислення на QPU за допомогою примітивів IBM Quantum. Щоб виконати обчислення з примітивами на основі вектора стану `qiskit`, заміни блок коду, що використовує примітиви IBM Quantum, на закоментований блок.
