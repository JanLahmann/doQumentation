...
Однак, якщо ти використовуєш лише дробові RX гейти та виключаєш дробові RZZ гейти, ти можеш продовжувати дотримуватися стандартного робочого процесу Qiskit patterns.
...
У цьому розділі ми демонструємо, як оптимізувати твої схеми, використовуючи лише дробові RX гейти, виключаючи RZZ гейти.

Для підтримки цього ми надаємо допоміжну функцію, яка дозволяє тобі вимкнути конкретний базовий гейт в об'єкті Target.
...
Якщо твоя схема включає певні гейти, такі як `XXPlusYYGate`, транспілер Qiskit може генерувати RZZ гейти з недійсними кутами.
