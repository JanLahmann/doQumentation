...
- Дізнайтеся, як реалізувати [далекодіюче заплутування з динамічними схемами](/tutorials/long-range-entanglement)
- Дізнайтеся, як симулювати [гамільтоніан kicked Ising з динамічними схемами](/tutorials/dc-hex-ising)
</Admonition>
