...
На рисунку лінії та сірі області обмежують межі; найзовнішні (пунктирні) лінії обмежують квантові межі ($\pm 2\sqrt{2}$), тоді як внутрішні (штрихові) лінії обмежують класичні межі ($\pm 2$). Ти можеш побачити, що є регіони, де величини-свідки CHSH перевищують класичні межі. Вітаємо! Ти успішно продемонстрував порушення нерівності CHSH у реальній квантовій системі!
