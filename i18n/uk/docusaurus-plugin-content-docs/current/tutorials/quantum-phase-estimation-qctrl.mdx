...
## Налаштування {#setup}
Спочатку автентифікуйся за допомогою твого [API-ключа IBM Quantum](http://quantum.cloud.ibm.com/). Потім вибери Qiskit-функцію наступним чином. (Цей код передбачає, що ти вже [зберіг свій обліковий запис](/guides/functions#install-qiskit-functions-catalog-client) у локальному середовищі.)
