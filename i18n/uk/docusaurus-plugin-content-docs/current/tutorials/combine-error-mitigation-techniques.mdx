...
description: "Поєднуй методи пом'якшення помилок для експериментів утилітарного масштабу з використанням квантових процесорів IBM Quantum на 100+ кубітів та примітива Qiskit Runtime Estimator."
...
Оскільки ці завдання можуть виконуватися незалежно одне від одного, ти можеш використовувати [пакетний режим](/guides/run-jobs-batch), щоб дозволити Qiskit Runtime оптимізувати час їх виконання.
