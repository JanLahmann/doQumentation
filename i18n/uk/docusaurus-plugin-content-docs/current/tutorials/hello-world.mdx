...
**Пропустіть цю комірку**, якщо ви зберегли облікові дані в [Налаштуваннях](/jupyter-settings#ibm-quantum) або увімкнули Режим симулятора — вони автоматично впроваджуються, коли ви натискаєте Run. Виконання цієї комірки з тимчасовими значеннями перезапише вашу конфігурацію.

На інших платформах спочатку виконайте це, щоб зберегти облікові дані для сесії:
