...
Після завершення завдань ми можемо отримати тривалість ланцюга з метаданих результатів завдання та візуалізувати інформацію про розклад ланцюга. Щоб дізнатися більше про візуалізацію інформації про планування ланцюга, звернись до [цієї сторінки](/guides/qiskit-runtime-circuit-timing).
