...
Тут ми гарантуємо, що менеджер пропусків анотує блоки з ``Twirl`` та ``InjectNoise`` анотаціями, що дозволяє нам вивчити шум, який впливатиме на наш схема, і пов'язати цей шум з відповідним шаром Circuit.
