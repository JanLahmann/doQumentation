---
title: "Покращення оцінки енергії фермійонної ґраткової моделі за допомогою SQD"
sidebar_label: "Покращення оцінки енергії фермійонної ґраткової моделі за допомогою SQD"
...
***Примітка: [Qiskit Aer](https://qiskit.github.io/qiskit-aer/index.html) необхідний для симуляції зразків із транспільованих Circuit.***
...
Тепер ми запускаємо алгоритм SQD за допомогою функції `diagonalize_fermionic_hamiltonian`. Пояснення аргументів цієї функції дивись у [документації API](../apidocs/qiskit_addon_sqd.fermion.rst#qiskit_addon_sqd.fermion.diagonalize_fermionic_hamiltonian).
