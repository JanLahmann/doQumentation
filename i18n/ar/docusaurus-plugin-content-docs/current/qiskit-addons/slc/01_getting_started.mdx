...
##  الخلفية {#background}
يوضح هذا البرنامج التعليمي كيفية تخفيف الأخطاء باستخدام إضافة مخروط الضوء المظلل (SLC). هذه الإضافة هي تطور لـ[تقنية إلغاء الأخطاء الاحتمالي (PEC)](https://quantum.cloud.ibm.com/docs/guides/error-mitigation-and-suppression-techniques#probabilistic-error-cancellation-pec)، حيث يتعلم المستخدم ضوضاء الطبقات الفريدة في الدائرة ثم يلغي الضوضاء بتطبيق بوابات qubit أحادية وتقنيات المعالجة اللاحقة. مقارنةً بالطرق الأخرى، يوفر PEC حدوداً أكثر صرامة على التحيز في النتيجة المخففة، غير أنه يعاني في الغالب من تكلفة أعلى من حيث وقت وحدة معالجة الكم (QPU). خلال PEC، ولتعويض تخفيف القيمة المتوقعة بسبب الضوضاء، يُعاد قياس المتوسط بضرب عامل $\gamma = \exp(\sum_{l,\sigma} 2\lambda_{l,\sigma})$، حيث $\lambda_{l,\sigma}$ هو معدل الضوضاء المكتسب لخطأ Pauli $\sigma$ في الطبقة $l$ من الدائرة. يزيد هذا إعادة القياس التباين بمقدار $\gamma^2$، ومن ثم يضرب أيضاً عدد تنفيذات الدائرة المطلوبة على QPU في $\gamma^2$، وهو ما نسميه تكلفة أخذ العينات أو العبء الإضافي لأخذ العينات. نظراً لأن $\gamma$ يتنامى أسياً، فإن PEC غالباً ما يقتصر على الدوائر الضحلة أو قليلة qubit. تعرف على المزيد حول PEC في [إلغاء الأخطاء الاحتمالي بنماذج Pauli-Lindblad المتفرقة على المعالجات الكمية الصاخبة.](https://arxiv.org/abs/2201.09866)
...
سنقوم بتحسين التفاصيل المتعلقة بالدائرة المراد تشغيلها، والعنصر القابل للرصد المراد قياسه، ومعاملات تعلم الضوضاء. كنقطة انطلاق، نتأكد من إنشاء Backend مع تفعيل البوابات الكسرية كخيار. ستتيح هذه البوابات الكسرية حساسية أكبر في بعض عمليات تصفية ما بعد الاختيار.
