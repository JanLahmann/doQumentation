---
title: "قطع الـ Gates لتقليل عمق الدائرة"
sidebar_label: "قطع الـ Gates لتقليل عمق الدائرة"
...
![مخطط دائرة كمومية](/img/qiskit-addons/cutting/02-gate-cutting-to-reduce-circuit-depth/output_1.png)
...
![مخطط دائرة كمومية](/img/qiskit-addons/cutting/02-gate-cutting-to-reduce-circuit-depth/output_2.png)
...
![مخطط دائرة كمومية](/img/qiskit-addons/cutting/02-gate-cutting-to-reduce-circuit-depth/output_3.png)
...
لمحاكاة القيمة المتوقعة للدائرة كاملة الحجم، يُولَّد عدد كبير من التجارب الفرعية من التوزيع شبه الاحتمالي المشترك للـ Gates المُحلَّلة ثم تُنفَّذ على Backend واحد أو أكثر. يتحكم `num_samples` في عدد العينات المأخوذة من التوزيع، ويُعطى معامل مدمج واحد لكل عينة فريدة. لمزيد من المعلومات حول طريقة حساب المعاملات، راجع [المواد الشارحة](../explanation/index.rst).
...
### إثبات أن التجارب الفرعية لـ QPD ستكون أقل عمقًا بعد قطع الـ Gates البعيدة {#demonstrate-that-the-qpd-subexperiments-will-be-shallower-after-cutting-distant-gates}

فيما يلي مثال على تجربة فرعية مختارة اعتباطيًا مُولَّدة من دائرة QPD. لقد تقلص عمقها بأكثر من النصف. يجب توليد عدد كبير من هذه التجارب الفرعية الاحتمالية وتقييمها لإعادة بناء القيمة المتوقعة للدائرة الأعمق.
...
![مخطط دائرة كمومية](/img/qiskit-addons/cutting/02-gate-cutting-to-reduce-circuit-depth/output_4.png)
