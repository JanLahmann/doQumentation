...
## استيراد برنامج OpenQASM 2 إلى Qiskit {#import-an-openqasm-2-program-into-qiskit}
...
بالنسبة لمعظم برامج OpenQASM 2، يمكنك ببساطة استخدام `qasm2.load` و`qasm2.loads` مع وسيط واحد فقط.
...
### ربط بوابات OpenQASM 2 ببوابات Qiskit {#link-openqasm-2-gates-with-qiskit-gates}
...
#### مثال: استيراد برنامج أنشأه مُصدِّر Qiskit القديم {#example-import-a-program-created-by-qiskits-legacy-exporter}
...
### تعريف دوال كلاسيكية مخصصة {#define-custom-classical-functions}
...
## تصدير دائرة Qiskit إلى OpenQASM 2 {#export-a-qiskit-circuit-to-openqasm-2}
...
<Admonition type="tip" title="توصيات">
    ...
    - اطلع على موضوع [التحقق من برنامجك](/guides/debugging-tools).
