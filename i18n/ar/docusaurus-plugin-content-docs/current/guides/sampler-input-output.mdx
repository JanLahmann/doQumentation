...
يوضح الكود التالي مجموعة مثال من المدخلات المتجهية للأداة البدائية `Sampler` وتنفيذها على Backend IBM&reg; كـ `RuntimeJobV2` واحد.
