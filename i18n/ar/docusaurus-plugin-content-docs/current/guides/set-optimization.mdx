...
هنا، سنجرب مستويات التحسين المختلفة على دائرة مدخلة تتكون من متجه عشوائي موحد يعقبه بوابة SWAP.
...
ضبط مستوى التحسين يمكن أن يُغيّر جوانب أخرى من الدائرة أيضاً، ليس فقط عدد بوابات ECR. للاطلاع على أمثلة حول كيفية تأثير مستوى التحسين على التخطيط، راجع [تمثيل الحواسيب الكمومية](./represent-quantum-computers).
