...
عند استخدام [samplex](/guides/directed-execution-model)، كل عنصر في الشكل الخارجي يتوافق مع تنفيذ مستقل للـ دائرة. عادةً ما يُدخل الـ samplex عشوائية (مثلًا، تدوير البوابات) في كل تنفيذ، لذا حتى بدون طلب عشوائيات متعددة صراحةً، يحصل كل عنصر على تحقق عشوائي مستقل.
