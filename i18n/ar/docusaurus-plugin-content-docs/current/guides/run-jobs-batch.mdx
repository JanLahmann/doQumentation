---
description: 'كيفية تشغيل مهام الحوسبة الكمية في وضع الدُفعات باستخدام IBM Quantum Compute Service.'
...
قبل بدء دُفعة، عليك [إعداد عميل IBM Quantum Compute](/guides/install-qiskit) وتهيئته كخدمة:
...
للحصول على نظرة عامة شاملة على تهيئة الدُفعة وحالتها، بما في ذلك مدة البقاء (TTL) التفاعلية والقصوى، استخدم `batch.details() method`.
...
<Admonition type="tip" title="Recommendations">
  ...
  - تعرّف على [حدود المهام](/guides/job-limits) عند إرسال مهمة إلى QPU من IBM&reg;.
