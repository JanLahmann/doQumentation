...
## درجة التقريب {#approximation-degree}
...
## بذرة مولّد الأعداد العشوائية {#random-number-generator-seed}
...
يُستخدم في هذه الأمثلة الـ Backend المحاكي `FakeSherbrooke` من `qiskit_ibm_runtime`، غير أنه يمكنك تجربته على أي Backend حقيقي أو وهمي متوافق مع Qiskit. قد تختلف نتائجك.
</Admonition>
...
## خيارات مراحل المحوّل والإضافات {#transpiler-stage-and-plugin-options}
