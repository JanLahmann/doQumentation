...
sidebar_label: "Port code to Qiskit Serverless"
description: "How to port existing code to leverage Qiskit Serverless"
notebook_path: "docs/guides/serverless-port-code.ipynb"
---
...
<OpenInLabBanner notebookPath="docs/guides/serverless-port-code.ipynb" />
...
The following code assumes that you have saved your credentials. If you have not, follow the instructions in [Set up your IBM Cloud account](/guides/cloud-setup-untrusted) to authenticate with your API key.
</Admonition>
