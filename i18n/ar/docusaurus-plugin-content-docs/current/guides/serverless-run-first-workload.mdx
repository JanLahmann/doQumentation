...
<Admonition type="tip">
**Qiskit Serverless يمرّ بترقية، وميزاته تتطور بسرعة.** خلال مرحلة التطوير هذه، يمكنك الاطلاع على ملاحظات الإصدار وأحدث الوثائق في صفحة [Qiskit Serverless على GitHub](https://qiskit.github.io/qiskit-serverless/index.html).
</Admonition>
...
تأكد من أنك اتّبعت سير العمل الوارد في [كتابة أول برنامج لك على Qiskit Serverless](/guides/serverless-first-program) قبل البدء.

## عرض البرامج المتاحة {#list-programs-available}

يمكنك استخدام `QiskitServerless.list()` لجلب قائمة بالبرامج المتاحة للتشغيل عبر Qiskit Serverless. وهذا يشمل البرنامج الذي رفعته مسبقاً [`transpile_remote_serverless`](/guides/serverless-first-program).
...
- استكشف [أدوات إدارة الحوسبة والبيانات](/guides/serverless-manage-resources) المتاحة لبرنامجك، بما في ذلك المعالجة المتوازية.
