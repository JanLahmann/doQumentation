...
- تعلم كيفية [ضبط مستوى التحسين](/guides/runtime-options-overview).
...
- تعلم [كيفية transpile الدوائر](/guides/circuit-transpilation-settings) كجزء من سير عمل أنماط Qiskit.
