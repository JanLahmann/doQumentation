...
اطلع على أمثلة لاستخدام Qiskit Code Assistant مع [الدوائر الكمومية](/guides/circuit-library) و[ضبط قمع الأخطاء](/guides/error-mitigation-and-suppression-techniques) و[النقل باستخدام pass managers](/guides/transpile-with-pass-managers).
</Admonition>
