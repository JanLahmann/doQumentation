...
* تحضير حالة كمومية فعّال، مثل [حالة GHZ](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339)، و[حالة W](https://arxiv.org/abs/2403.07604) (لمزيد من المعلومات حول حالة W، راجع أيضًا ["State preparation by shallow circuits using feed forward"](https://arxiv.org/abs/2307.14840))، وفئة واسعة من [حالات المصفوفة الحاصلة (matrix product states)](https://arxiv.org/abs/2404.16083)

* [تشابك بعيد المدى فعّال](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339) بين الكيوبتات على نفس الرقاقة باستخدام دوائر ضحلة

* [أخذ عينات فعّال لدوائر شبيهة بـ IQP](https://arxiv.org/pdf/2505.04705)
يدعم Qiskit أربع بنى للتحكم بالتدفق للتغذية الأمامية الكلاسيكية، كل منها مُطبَّق كطريقة على [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit). البنى وطرقها المقابلة هي:
