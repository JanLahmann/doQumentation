...
| 2 | تكاليف تخفيف متوسطة. يُقلِّل عادةً من الانحياز في المُقدِّرات، لكن غير مضمون أن يكون خالٍ من الانحياز. | المستوى 1 + [الاستقراء إلى الضوضاء الصفرية (ZNE)](/guides/error-mitigation-and-suppression-techniques#zne) وتدوير البوابات

<Admonition type="info" title="انتباه">

مستويات المرونة في مرحلة بيتا حاليًا لذا سيتفاوت الحمل الزائد في أخذ العينات وجودة الحل من دارة إلى أخرى. ستُطلَق ميزات جديدة وخيارات متقدمة وأدوات إدارة بشكل تدريجي. لا يُضمَن تطبيق طرق محددة لإدارة الضوضاء عند كل مستوى مرونة.
</Admonition>
...
ليست كل الخيارات متوافقة معًا على جميع أنواع الدارات. راجع [جدول توافق الميزات](estimator-options#options-compatibility-table) للاطلاع على التفاصيل.
</Admonition>
