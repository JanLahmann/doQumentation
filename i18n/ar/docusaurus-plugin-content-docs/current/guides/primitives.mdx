...
الإصدار التجريبي من نموذج تنفيذ جديد متاح الآن. يوفر نموذج التنفيذ الموجّه مرونة أكبر عند تخصيص سير عمل تخفيف الأخطاء. راجع دليل [نموذج التنفيذ الموجّه](/guides/directed-execution-model) للمزيد من المعلومات.
</Admonition>
