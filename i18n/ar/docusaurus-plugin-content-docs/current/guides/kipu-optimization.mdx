...
جميع حالات القياس المعياري متاحة على GitHub (راجع [حالات قياس Kipu المعيارية](https://github.com/Kipu-Quantum-GmbH/benchmark-instances)). يمكن العثور على مثال لتشغيل هذه الحالات في [المثال 3: حالات القياس المعياري](#example-3-benchmark-instances).
...
### 1. إنشاء دالة الهدف {#1-create-the-objective-function-1}
...
### 2. تشغيل المُحسِّن {#2-run-the-optimizer-1}
...
### 3. استرجاع النتيجة {#3-retrieve-the-result-1}
