...
استخدم Estimator لتشغيل ثلاث تجارب في مهمة واحدة، مستفيدًا من قيم المعاملات لزيادة إمكانية إعادة استخدام الدائرة.
...
استكشف [وضع التنفيذ](/guides/execution-modes) batch والخيارات المتقدمة لتحسين أداء الدائرة على معالجات الكم (QPUs).
