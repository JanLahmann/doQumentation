...
استخدم Estimator لتحديد قيم التوقع لأزواج متعددة من دائرة-مراقِب.
...
استخدم Estimator لتشغيل ثلاث تجارب في مهمة واحدة، مستفيدًا من قيم المعاملات لزيادة إمكانية إعادة استخدام الـ دائرة.
...
استكشف [وضع التنفيذ](/guides/execution-modes) batch والخيارات المتقدمة لتحسين أداء الـ دائرة على معالجات الكم (QPUs).
