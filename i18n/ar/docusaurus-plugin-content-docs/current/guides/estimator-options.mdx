...
3. إذا كان `twirling` مفعّلًا (True بشكل افتراضي)، فيُستخدم ناتج `num_randomizations` و`shots_per_randomization`، كما هو محدد في [خيارات `twirling`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-twirling-options).
