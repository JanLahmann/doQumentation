...
Notes :
<Admonition type="note" title="ملاحظات حول تحديد الخيارات في أدوات Estimator البدائية">
...
### تهيئة الأداة البدائية {#primitive-initialization}
...
لا تحتاج إلى إنشاء مثيل من فئة خيارات `EstimatorV2` ([`EstimatorOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-estimator-options)) إذا كنت تضبط الخيارات بعد تهيئة الأداة البدائية.
...
معاملات الدقة هذه مخصصة فقط لتحديد الدقة _المستهدفة_، ولا يُضمن أن تصل النتائج إلى الدقة المحددة.
</Admonition>
...
<Accordion>
  <AccordionItem title="البوابات الكسرية">
    غير متوافق مع:
  - Gate twirling
  - PEA
  - PEC
