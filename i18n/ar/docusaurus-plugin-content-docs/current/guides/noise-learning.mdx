...
تحتوي نتيجة مهمة `NoiseLearnerV3` على قائمة من كائنات [`NoiseLearnerV3Result`](https://qiskit.github.io/qiskit-ibm-runtime/stubs/qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3Result.html)، واحدة لكل تعليمة مُدخَلة.
