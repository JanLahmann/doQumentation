---
title: "تصوير النتائج"
sidebar_label: "تصوير النتائج"
description: "رسم نتائج تنفيذ الدوائر الكمومية باستخدام Qiskit"
...
## رسم المدرج التكراري {#plot-histogram}
...
### خيارات رسم المدرج التكراري {#options-when-plotting-a-histogram}
...
## رسم نتائج Estimator {#plotting-estimator-results}

لا يوجد في Qiskit دالة مدمجة لرسم نتائج Estimator، لكن يمكنك استخدام [رسم `bar`](https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.bar.html) في Matplotlib للحصول على تصوير سريع.
...
الخلية التالية تستخدم [الخطأ المعياري](https://en.wikipedia.org/wiki/Standard_error) المُقدَّر لكل نتيجة وتضيفه كأشرطة خطأ. راجع [توثيق رسم `bar`](https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.bar.html) للاطلاع على وصف كامل للرسم.
