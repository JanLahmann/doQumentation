...
ابدأ بتحضير الـ Circuit للتنفيذ وعمل الـ Transpile مقابل Backend يدعم البوابات الكسرية.
...
بعد ذلك، حضِّر كائن `QuantumProgram` يحتوي على الـ Circuit المُراد تنفيذها.
