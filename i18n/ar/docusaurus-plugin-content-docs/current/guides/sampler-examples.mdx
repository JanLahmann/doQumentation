---
description: 'أمثلة عملية لاستخدام IBM Quantum Sampler primitive.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'أمثلة على Sampler'
title: 'أمثلة على Sampler'
---
...
## تشغيل الدوائر ذات المعاملات {#run-parameterized-circuits}
...
## استخدام الدُّفعات والخيارات المتقدمة {#use-batches-and-advanced-options}

استكشف [وضع التنفيذ](/guides/execution-modes) بالدُّفعة والخيارات المتقدمة لتحسين أداء الدائرة على وحدات QPU.
...
- [حدِّد خيارات الـ runtime المتقدمة](runtime-options-overview).
...
- جرِّب دليل [مقارنة إعدادات الـ Transpiler](/guides/circuit-transpilation-settings).
- افهم [حدود المهمة](/guides/job-limits) عند إرسال مهمة إلى IBM&reg; QPU.
</Admonition>
