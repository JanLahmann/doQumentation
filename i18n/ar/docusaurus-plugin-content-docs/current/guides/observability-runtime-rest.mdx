---
description: 'تعرّف على أحداث تتبع النشاط الخاصة بـ IBM Quantum Compute Service.'
title: 'أحداث تتبع النشاط لـ IBM Quantum Compute Service'
---

{/* doqumentation-source-hash: 94aed435 */}

# أحداث تتبع النشاط لـ IBM Quantum Compute Service {#activity-tracking-events-for-ibm-quantum-compute-service}

تُولّد خدمات IBM Cloud&reg;، مثل IBM Quantum&reg; Compute Service، أحداث تتبع النشاط.
...
يُرسل IBM Quantum Compute Service أحداث تتبع النشاط في المناطق التالية:
...
## عرض أحداث تتبع النشاط لـ IBM Quantum Compute Service {#viewing-activity-tracking-events-for-ibm-quantum-compute-service}
