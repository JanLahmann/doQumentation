...
تُنفِّذ الـ primitives المرجعية في Qiskit SDK محاكاة statevector محلية. لا تدعم هذه المحاكاة نمذجة ضوضاء الأجهزة، لكنها مفيدة لنمذجة الخوارزميات بسرعة قبل الانتقال إلى تقنيات محاكاة أكثر تقدمًا ([باستخدام Qiskit Aer](/guides/simulate-stabilizer-circuits)) أو التشغيل على أجهزة حقيقية ([Qiskit Runtime primitives](primitives)).
