---
description: 'افهم تنسيق المدخلات والمخرجات (بما فيها Primitive Unified Blocs أو PUBs) الخاص بـ Qiskit SDK primitives'
...
بمجرد إرسال واحد أو أكثر من PUBs إلى QPU للتنفيذ واكتمال المهمة بنجاح، تُعاد البيانات ككائن حاوٍ (container object) من نوع [`PrimitiveResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PrimitiveResult). تحتوي `PrimitiveResult` على قائمة قابلة للتكرار (iterable) من كائنات [`PubResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PubResult) التي تحتوي على نتائج التنفيذ لكل PUB. على سبيل المثال، ستُعيد مهمة مُرسَلة بـ 20 PUB كائن `PrimitiveResult` يحتوي على قائمة من 20 `PubResults`، واحد يقابل كل PUB.
...
<Admonition type="tip" title="توصيات">
  ...
  -  راجع واجهة برمجة تطبيقات [Qiskit SDK primitives](https://docs.quantum.ibm.com/api/qiskit/primitives).

  -  راجع واجهة برمجة تطبيقات [Qiskit Aer primitives](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html).

  -  تعرّف أكثر على [IBM Quantum primitives](/guides/qiskit-runtime-primitives).

  -  راجع واجهة برمجة تطبيقات [`qiskit-ibm-runtime` Estimator](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2).

  -  راجع واجهة برمجة تطبيقات [`qiskit-ibm-runtime` Sampler](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2).
</Admonition>
