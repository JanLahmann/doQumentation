...
في حضور خطأ القراءة، يُحوِّل تلوية القياس مصفوفة نقل خطأ القراءة إلى صيغة قُطرية، مما يسهّل عكسها. يتطلب تقدير مصفوفة نقل خطأ القراءة تنفيذ دوائر معايرة إضافية، مما يُضيف عبئًا صغيرًا.
