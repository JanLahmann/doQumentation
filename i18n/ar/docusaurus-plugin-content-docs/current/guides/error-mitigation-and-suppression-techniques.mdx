...
### تفعيل TREX باستخدام خيار `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### تفعيل TREX باستخدام خيار `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### تفعيل ZNE باستخدام خيار `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}
...
### تفعيل ZNE باستخدام خيار `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- استكشف [خيارات](/guides/runtime-options-overview) أخرى لـ primitives الخاصة بـ Qiskit Runtime.
