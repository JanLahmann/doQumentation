...
يُستخدم الـ Backend الوهمي `FakeSherbrooke` من `qiskit_ibm_runtime` في هذه الأمثلة، لكن يمكنك تجربته على أي Backend حقيقي أو وهمي متوافق مع Qiskit. قد تختلف نتائجك.
</Admonition>
