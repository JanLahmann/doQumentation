---
title: "تمثيل أجهزة الحوسبة الكمومية للمترجم"
sidebar_label: "تمثيل أجهزة الحوسبة الكمومية للمترجم"
...
- يحتوي [`Target`](https://docs.quantum.ibm.com/api/qiskit/qiskit.transpiler.Target) على جميع القيود ذات الصلة بالجهاز، مثل مجموعة التعليمات المدعومة، وترابط الكيوبتات، ومعلومات النبضات أو التوقيت.
- يمتلك [`Backend`](https://docs.quantum.ibm.com/api/qiskit/qiskit.providers.BackendV2) `Target` افتراضيًا، ويحتوي على معلومات إضافية — مثل [`InstructionScheduleMap`](https://docs.quantum.ibm.com/api/qiskit/1.4/qiskit.pulse.InstructionScheduleMap)، ويوفر الواجهة لإرسال مهام الدوائر الكمومية.
...
تعرض هذه الصفحة عدة أمثلة على تمرير معلومات QPU إلى المترجم.
...
يعرض هذا الموضوع عدة أمثلة على تمرير المعلومات إلى المترجم.

<Admonition type="note">
تستخدم هذه الأمثلة الـ target من الـ backend الوهمي [`FakeSherbrooke`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/fake-provider-fake-sherbrooke#fakesherbrooke) في `qiskit_ibm_runtime`.  غير أنه يمكنك تجربة ذلك على أي backend حقيقي أو وهمي متوافق مع Qiskit.  قد تختلف نتائجك.
</Admonition>
...
يُستخدم هذا المثال في الأقسام اللاحقة من هذا الموضوع لتوضيح أن خريطة الاقتران ومجموعة التعليمات المدعومة هما المعلومتان الجوهريتان اللتان يجب تمريرهما إلى المترجم لبناء دائرة مثلى. يستطيع QPU عادةً اختيار الإعدادات الافتراضية للمعلومات الأخرى التي لم يتم تمريرها، كالتوقيت والجدولة.
...
كل حاسوب كمومي يدعم مجموعة محدودة من التعليمات. يجب ترجمة كل بوابة في الدائرة إلى عناصر هذه المجموعة. ينبغي أن تتكون هذه المجموعة من بوابات أحادية وثنائية الكيوبت توفر مجموعة بوابات شاملة، بمعنى أنه يمكن تحليل أي عملية كمومية إلى تلك البوابات. يتولى هذا [BasisTranslator](https://docs.quantum.ibm.com/api/qiskit/qiskit.transpiler.passes.BasisTranslator)، ويمكن تحديد `basis_gates` كوسيطة كلمة مفتاحية للمترجم لتقديم هذه المعلومات.
