---
title: "صيغ متعددة الحدود (MPF)"
sidebar_label: "صيغ متعددة الحدود (MPF)"
description: "صفحة نظرة عامة على إضافة Qiskit التي تُنشئ صيغ متعددة الحدود (MPF)"
...
صيغ متعددة الحدود (MPF) يمكن استخدامها لمحاكاة ديناميكيات نظام كمي بدقة أعلى، على حساب زيادة عدد تنفيذات الدوائر. وهي تقنية معالجة لاحقة تُخفف من خطأ قيم الانتظار للحالات المتطورة زمنياً.
