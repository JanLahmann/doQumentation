...
هذا القالب، الذي طُوِّر بالتعاون مع كليفلاند كلينك، يتضمن سير عملٍ لحساب طاقة الحالة الأساسية وطاقة حرية الذوبان لجزيء في مذيب ضمني [[1]](#references). تعتمد هذه المحاكاة على طريقة التقطير الكمي القائمة على العينات (SQD) [[2-6]](#references) ونموذج المتصل المستقطب لصياغة معادلات التكاملات (IEF-PCM) للمذيب [[7]](#references).
