...
# إعداد أدوار مخصصة {#set-up-custom-roles}
...
1. من [Manage → IAM → Roles](https://cloud.ibm.com/iam/roles)، انقر على `Create` (تظهر فقط لمسؤولي الحساب).

2. أدخل اسماً ومعرفاً ووصفاً، واختر `Quantum Compute` للخدمة.
...
1. اذهب إلى [Manage → IAM → Roles](https://cloud.ibm.com/iam/roles) في IBM Cloud. اختر Quantum Compute من القائمة المنسدلة لرؤية الأدوار الموجودة حالياً لهذه الخدمة.
...
6. في القائمة المنسدلة للخدمة، اختر Quantum Compute. ستظهر جدول يحتوي على جميع الإجراءات التي يمكنك ربطها بالدور.
...
10. تحت Service، اختر Quantum Compute، ثم انقر على Next.
