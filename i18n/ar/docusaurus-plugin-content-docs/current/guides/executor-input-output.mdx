...
كما ذُكِر سابقًا، المدخل لـ Executor primitive هو [`QuantumProgram`](https://qiskit.github.io/qiskit-ibm-runtime/stubs/QuantumProgram.html#QuantumProgram)، وهو قابل للتكرار من كائنات [`QuantumProgramItem`](https://qiskit.github.io/qiskit-ibm-runtime/stubs/QuantumProgramItem.html). يمكن أن تكون هذه الكائنات من نوعين:
