...
راجع [توثيق Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) للاطلاع على مزيد من المعلومات حول الحدود المطبَّقة على تمريرات المُحوِّل المدعومة بالذكاء الاصطناعي.

## الاستشهاد {#citation}

إذا استخدمت أي ميزة مدعومة بالذكاء الاصطناعي من Qiskit Transpiler Service في أبحاثك، استخدم [الاستشهاد الموصى به](/guides/qiskit-transpiler-service#citation).
