---
description: 'أمثلة عملية على استخدام الأداة البدائية Executor في qiskit-ibm-runtime.'
...
### إعداد الدائرة {#set-up-the-circuit-1}
...
### تنفيذ الدوائر {#execute-the-circuits-1}
