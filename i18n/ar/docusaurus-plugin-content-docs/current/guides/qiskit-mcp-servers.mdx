...
Provides intelligent quantum code completion and assistance through the [Qiskit Code Assistant](/guides/qiskit-code-assistant). This server integrates the Qiskit Code Assistant capabilities directly into MCP-compatible AI tools.
...
Provides AI-powered circuit optimization through the [AI-powered transpiler passes](/guides/ai-transpiler-passes). This server enables AI assistants to optimize quantum circuits using advanced routing and optimization algorithms.
...
- An IBM Quantum account and API token (see [Set up your IBM Cloud&reg; account](/guides/cloud-setup) for instructions)
...
- Learn about [Qiskit Code Assistant](/guides/qiskit-code-assistant) to understand the AI code completion capabilities.
- Learn about [AI-powered transpiler passes](/guides/ai-transpiler-passes) to understand the AI-powered circuit optimization capabilities.
- Set up your [IBM Quantum account](/guides/cloud-setup) if you haven't already.
