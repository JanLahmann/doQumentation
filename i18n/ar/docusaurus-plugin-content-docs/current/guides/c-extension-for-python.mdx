...
أكمل التعليمات الواردة في موضوع [التثبيت](/guides/install-c-api) لتثبيت ما يلي:

- سلسلة أدوات مترجم C القياسية لمنصتك

- إصدار من Python يتضمن رؤوس C API الخاصة به.


ينبغي أيضاً أن تكون على دراية بـ، أو مستعداً للبحث عن، الدوال والكائنات المتاحة في [Qiskit C API](https://docs.quantum.ibm.com/api/qiskit-c)، وينبغي أن يكون لديك بعض الإلمام ببرمجة C.
...
عيّن إصدار وقت تشغيل Qiskit في
`project.dependencies` بحيث يطابق الإصدار الفرعي المستخدم في وقت البناء.
