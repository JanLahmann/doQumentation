---
description: 'كيفية تشغيل مهمة حوسبة كمومية في جلسة IBM Quantum Compute Service.'
...
قبل بدء الجلسة، يجب أن [تُعدّ عميل IBM Quantum Compute](/guides/install-qiskit-runtime) وتُهيّئه كخدمة:
