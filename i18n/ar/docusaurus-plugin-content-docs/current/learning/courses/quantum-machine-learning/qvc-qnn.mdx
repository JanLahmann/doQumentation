...
هنا نحسّن الدارة للتشغيل على backend حقيقي عن طريق تحديد optimization_level وإضافة فك الاقتران الديناميكي. تُنشئ الشفرة أدناه مدير تمريرات باستخدام مديري التمريرات المُعدّين مسبقًا من qiskit.transpiler.
...
## أنماط Qiskit الخطوة 3: التنفيذ باستخدام أوليات IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
## خطوة أنماط Qiskit الثانية: تحسين المسألة للتنفيذ الكمومي {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution-1}
نبدأ باختيار backend للتنفيذ. في هذه الحالة، سنستخدم أقل backend انشغالاً.
...
الآن سنطبق مدير التمريرات عدة مرات. بالنسبة للدارات الواسعة جدًا أو العميقة جدًا، يمكن أن يكون هناك تباين كبير في أعماق التمرير الثنائي القيوبت. بالنسبة لهذه الدارات، من المهم تجربة مدير التمريرات عدة مرات واستخدام أفضل نتيجة (الأضحل).
...
## أنماط Qiskit الخطوة 3: التنفيذ باستخدام أوليات IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
