...
للتشغيل على حاسوب كمومي حقيقي من IBM، ستحتاج أيضاً إلى [**حساب IBM Quantum&reg; Platform**](https://quantum.cloud.ibm.com/signin?redirectTo=%2F) (مجاني). يمكنك فتح نسخة باستخدام الخطة المفتوحة للحصول على 10 دقائق من وقت وحدة المعالجة الكمومية (QPU) لكل نافذة دوّارة مدتها 28 يوماً، وهو في الواقع وقت كافٍ جداً! *إذا واجهت مشكلة في حسابك، راجع [صفحة الدعم](/guides/support).*
...
افتح Composer [هنا](https://quantum.cloud.ibm.com/composer).
...
الآن دعنا نُعرّف دالة مساعدة تتعامل مع عملية تشغيل دارة كمومية واسترداد نتائج القياس. تتولى هذه الدالة ترجمة الدارة لتطابق مجموعة تعليمات backend، وتشغيلها من خلال أداة `Sampler` البدائية، واستخراج العدّات من النتائج.
