...
ثمة أيضاً مقاربات كمومية أخرى لدراسة طاقات الحالة الأرضية تتجاوز الأساليب التغايرية. لا تُغطى هذه الأساليب هنا، لكنها مُقدَّمة في دورة [خوارزميات التقطير الكمومي](/learning/courses/quantum-diagonalization-algorithms) إذا أردت التعلم أكثر.
