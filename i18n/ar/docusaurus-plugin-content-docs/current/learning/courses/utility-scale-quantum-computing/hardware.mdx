...
## 2. الواجهة الخلفية والهدف {#2-backend-and-target}
...
### 2.2 خريطة الاقتران {#22-coupling-map}
...
## 3. خصائص الكيوبت {#3-qubit-properties}
...
###  3.2 أخطاء البوابة والقراءة {#32-gate-and-readout-errors}
