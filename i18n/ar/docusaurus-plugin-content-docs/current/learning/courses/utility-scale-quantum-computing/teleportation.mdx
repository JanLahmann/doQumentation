...
## 2. مصفوفات الكثافة {#2-density-matrices}
...
## 3. التوصيف الكمومي للحالة {#3-quantum-state-tomography}
...
### تقدير قيمة $r_z$ {#estimate-r-z-value}
...
### التمرين 1: تقدير قيمة $r_x$ {#exercise-1-estimate-r-x-value}
...
### التمرين 2: تقدير قيمة $r_y$ {#exercise-2-estimate-r-y-value}
...
## 4. الإرسال الكمومي عن بُعد {#4-quantum-teleportation}
...
### 4.1 بروتوكول الإرسال الكمومي عن بُعد {#41-the-protocol-of-quantum-teleportation}
...
هنا نوجز الإجراء دون شرح. سيتم تنفيذها بالتفصيل أدناه.
1. تتشابك أليس $|\psi \rangle$  مع جزئها من زوج e-bit باستخدام بوابة CNOT.
2. تطبق أليس بوابة هادامارد على $|\psi \rangle$، وتقيس كلا كيوبتيها في الأساس الحسابي.
3. ترسل أليس لبوب نتائج قياسها (إما "00" أو "01" أو "10" أو "11")
4. يقوم بوب بتطبيق مؤثر *تصحيح* بناءً على معلومات أليس ذات البتين على جزئه من زوج e-bit.
    - إذا كانت "00"، لا يفعل بوب شيئًا
    - إذا كانت "01"، يطبق بوب بوابة X
    - إذا كانت "10"، يطبق بوب بوابة Z
    - إذا كانت "11"، يطبق بوب بوابة iY = ZX
5. يصبح جزء بوب من زوج e-bit هو $|\psi \rangle$.
...
### 4.2 الدائرة الكمومية التي تحاكي الإرسال الكمومي عن بُعد {#42-quantum-circuit-simulating-the-quantum-teleportation}
...
### 4.3 تنفيذه والتحقق من النتيجة بتطبيق معكوس U {#43-execute-it-and-confirm-the-result-by-applying-u-inverse}
...
### 4.4 الإرسال الكمومي عن بُعد على حاسوب كمومي حقيقي {#44-teleportation-on-a-real-quantum-computer}
...
### 4.5 النقاط الرئيسية حول الإرسال الكمومي عن بُعد {#45-key-takeaways-on-quantum-teleportation}
...
## 5. الترميز فائق الكثافة {#5-superdense-coding}
...
### 5.1 بروتوكول الترميز فائق الكثافة {#51-the-protocol-of-superdense-coding}
...
### 5.2 الدائرة الكمومية التي تحاكي الترميز فائق الكثافة {#52-quantum-circuit-simulating-the-superdense-coding}
