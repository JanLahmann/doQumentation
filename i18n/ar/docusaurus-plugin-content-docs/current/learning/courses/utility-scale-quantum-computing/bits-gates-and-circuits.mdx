...
تُمثَّل حالة الكيوبت كتراكب لـ $|0\rangle$ و$|1\rangle$. تُمثَّل الحالة الكمومية العشوائية كـ
...
$|0\rangle$ و$|1\rangle$ هما متجهان في فضاء متجهي مركب ثنائي الأبعاد:
...
لذلك، تُمثَّل الحالة الكمومية العشوائية أيضًا كـ
...
من هذا، يمكننا أن نرى أن حالة بت كمومي هي متجه وحدة في فضاء ضرب داخلي مركب ثنائي الأبعاد بأساس متعامد نظامي من $|0\rangle$ و$|1\rangle$. وهو مُطبَّع إلى 1.
...
تُمثَّل الحالة الكمومية أحادية الكيوبت أيضًا كـ
...
حيث $\theta$ و$\varphi$ هما زاويتا كرة بلوخ في الشكل التالي.
...
الحالة المتشابكة هي حالة $|\psi_{AB}\rangle$ تتكون من حالتين كموميتين $|\psi_A\rangle$ و$|\psi_B\rangle$ لا يمكن تمثيلهما بحاصل ضرب موتري لحالات كمومية فردية.
...
حاصل الضرب الموتري لهاتين الحالتين هو التالي

$$
|\psi\rangle _A\otimes |\psi\rangle _B = a_0 b_0|00\rangle+a_0 b_1|01\rangle+a_1 b_0|10\rangle+a_1 b_1|11\rangle
$$

لكن لا توجد معاملات $a_0, a_1, b_0, $ و$b_1$ لتحقيق هاتين المعادلتين. لذلك، لا يمكن تمثيل $|\psi_{AB}\rangle$ بحاصل ضرب موتري لحالة كمومية فردية، $|\psi\rangle_A$ و$|\psi\rangle_B$، وهذا يعني أن $|\psi_{AB}\rangle =  \frac{1}{\sqrt{2}}(|00\rangle +|11\rangle)$ هي حالة متشابكة.

لننشئ حالة بل ونشغلها على حاسوب كمومي حقيقي. الآن سنتبع الخطوات الأربع لكتابة برنامج كمومي، تسمى **أنماط Qiskit**:
...
إن لم يكن لديك `qiskit-ibm-runtime`، ستحتاج إلى تثبيته أولًا. لمزيد من المعلومات، [راجع مرجع API.](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/runtime-service)
