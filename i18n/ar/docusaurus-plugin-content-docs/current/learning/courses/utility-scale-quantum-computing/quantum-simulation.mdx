...
## 3. التمرين الأول: تنفيذ المحاكاة باستخدام Suzuki–Trotter من الرتبة الثانية {#3-exercise-1-perform-simulation-using-second-order-suzukitrotter}
...
### 3.3 رسم نتائج Suzuki–Trotter من الرتبة الثانية {#33-plot-the-second-order-suzukitrotter-results}
...
## 4. التنفيذ على العتاد الكمي {#4-executing-on-the-quantum-hardware}
...
### 4.1 الخطوة 1. تحويل المدخلات الكلاسيكية إلى مسألة كمية {#41-step-1-map-classical-inputs-to-a-quantum-problem}
...
### 4.2 الخطوة 2. التحسين لاستهداف العتاد المطلوب {#42-step-2-optimize-for-target-hardware}
...
### 4.3 الخطوة 3. التنفيذ باستخدام أوليات IBM Quantum {#43-step-3-execute-with-ibm-quantum-primitives}
...
### 4.4 الخطوة 4. معالجة النتائج {#44-step-4-post-process-results}
