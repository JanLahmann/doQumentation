...
## 1. مقدمة إلى خوارزمية غروفر {#1-introduction-to-grovers-algorithm}
...
## 2. تطبيق خوارزمية غروفر {#2-implementing-grovers-algorithm}

### 2.1 الإعداد {#21-preparation}
...
### 3: عامل الانتشار {#3-diffusion-operator}
...
### 2.2 مثال على بحث غروفر بكيوبتين {#22-a-2-qubit-grover-search-example}
...
### 2.3 التجربة على المحاكيات {#23-experiment-with-simulators}
...
## 3. التجربة على الأجهزة الحقيقية {#3-experiment-with-real-devices}

### الخطوة 2: التحسين لأجهزة العتاد المستهدفة {#step-2-optimize-for-target-hardware-1}
...
### الخطوة 3: تنفيذ الدائرة {#step-3-executing-the-circuit-1}
...
### الخطوة 4: معالجة النتائج {#step-4-post-processing-the-results-1}
...
## 4. بحث غروفر بثلاثة كيوبتات {#4-a-3-qubit-grover-search}
