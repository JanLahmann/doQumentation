...
يمكنك ضبط خيارات قمع الأخطاء في Sampler V2. راجع دليل [Sampler noise management](/guides/sampler-noise-management) ومرجع واجهة برمجة التطبيقات [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) لمزيد من المعلومات.
...
تهانينا على إتمام هذه الدورة! يرجى تخصيص لحظة للمساعدة في تحسين دورتنا بملء [الاستبيان السريع](https://your.feedback.ibm.com/jfe/form/SV_5vvmdT5yFFetkgK) التالي. سيُستخدم ملاحظاتك لتحسين محتوانا وتجربة المستخدم. شكراً لك!
