...
تتمتع QAOA بإمكانية تقديم الحلول المثلى للمسائل المستهدفة على نطاق المنفعة، بفضل تطبيق تقنيات مختلفة لتخفيف الأخطاء وقمعها. لدى VQE تطبيقات عديدة (مثل الكيمياء الكمية) حيث يكون أقل قابلية للتوسع. لكن ظهر عدد من المناهج المتعلقة بالقيم الذاتية لتكمل وتعزز VQE، بما في ذلك قطرنة فضاء Krylov الفرعي والقطرنة الكمومية القائم على أخذ العينات (SQD). يُعد فهم VQE خطوة أولى مهمة في فهم النطاق الواسع من الخوارزميات الهجينة الكلاسيكية-الكمية التي ظهرت.
...
### 3.4 الخطوة 3. التنفيذ باستخدام أوليات IBM Quantum {#34-step-3-execute-using-ibm-quantum-primitives}
...
استخدم **بدائيات IBM Quantum** للتفاعل مع خلفيات IBM&reg;. البدائيتان هما Sampler و Estimator، واختيار البدائية يعتمد على نوع القياس الذي تريد تشغيله على الحاسوب الكمي. لتصغير $H_C$، استخدم Estimator لأن قياس دالة التكلفة هو ببساطة القيمة المتوقعة لـ $\langle H_C \rangle$.
