...
---
{/* doqumentation-source-hash: 328c46ac */}
...
بمجرد تعريف هذا الفضاء الجزئي الصغير بمجموعة من حالات الأساس $\{|b_i\rangle\}$، يُسقَط الهاميلتوني الكامل عليه لإنشاء المصفوفة الصغيرة الجديدة $\tilde{H}$. يُحسَب كل عنصر من عناصر هذه المصفوفة من حالات الأساس للفضاء الجزئي والهاميلتوني الأصلي على شكل $\langle b_i | H | b_j \rangle$. ثم يمكن قطرنة هذه المصفوفة الصغيرة بسهولة على حاسوب كلاسيكي، وتكون القيم الذاتية الناتجة هي طاقاتنا المقدَّرة.

كما قد تخمن، يعتمد نجاح هذا الأسلوب برمته على اختيار فضاء جزئي "جيد". فإذا لم يمثل فضاؤنا الجزئي الحالة الأساسية الحقيقية بدقة، ستكون إجابتنا النهائية خاطئة. هنا يكمن دور الحواسيب الكمومية: فهي تتيح لنا تهيئة عينات من حالات كمومية معقدة مصممة للكشف عن هذه الفضاءات الجزئية المهمة. وللمسائل الضخمة حقاً، كالتراكيب الكيميائية المعقدة أو مواقع الارتباط، قد تظل المصفوفة المُسقَطة تحدياً في القطرنة حتى بعد الإسقاط. وبالتالي، تلك المسائل هي الأنسب للاستفادة من نقاط قوة الحوسبة الكمومية والكلاسيكية معاً.
...
القطرنة الكمومية القائمة على العينات (SQD) هي خوارزمية تباينية قوية تُطبّق أسلوب الفضاء الجزئي بطريقة كمومية. تتجنب الإجراءات المكلفة والمعقدة كاختبارات هادامار، إذ تستخدم الحاسوب الكمومي لتهيئة حالة تجريبية وأخذ عينات من _سلاسل البتات_ التي تُعرّف الفضاء الجزئي للقطرنة الكلاسيكي.
...
يوضح هذا المخطط هدف الأنساتز الجيد. يُهيئ الأنساتز حالة كمومية يجب أن يتداخل مجال دعمها (مجموعة حالات الأساس المكوِّنة لها) بشكل كبير مع مجال دعم الحالة الأساسية الحقيقية. تتيح لنا هذه الدارة إسقاط الأنساتز بسرعة على حالات الأساس الحسابي، التي ستُستخدم لاحقاً في القطرنة الكلاسيكي. بمعنى آخر: لا يجب أن نخمن أنساتزاً يكون هو الحالة الأساسية؛ نحتاج فقط أن يحتوي على نفس حالات الأساس. ثم سيمنحنا القطرنة الكلاسيكي للهاميلتوني المُسقَط التراكب الخطي لحالات الأساس الذي يُقرّب الحالة الأساسية أفضل تقريب.
...
#### الخطوة 3: الإسقاط والقطرنة كلاسيكياً {#step-3-project-and-diagonalize-classically}
...
القطرنة الكمومية القائمة على عينات كريلوف (SKQD) هي خوارزمية كمومية قائمة على العينات قوية أخرى تبني على مبادئ SQD. وبينما هدفها واحد — إيجاد فضاء جزئي جيد للقطرنة — تعتمد SKQD أسلوباً أكثر منهجية لتوليد سلاسل البتات، خاصةً للمسائل كهاميلتونيات الشبكة.
...
#### الخطوة 3: الإسقاط والقطرنة كلاسيكياً {#step-3-project-and-diagonalize-classically-skqd}
...
* فوائد مشتركة مع SQD: مشابهاً لـ SQD، تمتلك SKQD أيضاً خاصية المتانة أمام الضوضاء. بمعنى آخر، طالما امتلكنا جميع سلاسل البتات الجيدة في مجموعة السلاسل المأخوذة عينات منها، فإن القطرنة يُسند وزناً قريباً من الصفر لسلاسل البتات الخاطئة، مما يجعل الإجراء متيناً أمام الضوضاء. علاوة على ذلك، بما أن الحل يُنتَج من HPC كلاسيكي، فإن طاقة الحل قابلة للتحقق كلاسيكياً.
