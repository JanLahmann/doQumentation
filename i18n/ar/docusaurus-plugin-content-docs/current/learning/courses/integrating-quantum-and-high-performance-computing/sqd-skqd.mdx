...
{/* doqumentation-source-hash: d4a14482 */}
...
لنسمِّ مجموعة كل حالات الأساس الحسابية التي تشكّل الـ ansatz الخاص بك A. ولنسمِّ مجموعة كل حالات الأساس الحسابية التي تشكّل الحالة الأرضية الحقيقية لنظامك G. أي مما يلي يقابل ansatz 'جيد'؟ اختر كل ما ينطبق:
...
#### الخطوة 3: الإسقاط والقطرنة كلاسيكياً {#step-3-project-and-diagonalize-classically-1}
