...
لاحظ بشكل خاص أن البوابات مرقّمة، ولا تظهر مؤثرات الهوية. وهذا يتناقض مع الهاميلتونيات المستخدمة في Qiskit، والتي تكتب الحد `[Z2 Z3]` على شكل `ZZII` (الكيوبتات 0 و1 يعمل عليها مؤثر الهوية، والكيوبتات 2 و3 يعمل عليها مؤثر Z، مرتبة بحيث يكون الكيوبت 0 في أقصى اليمين).

لتلبية أي مسارات عمل موجودة لديك، تقوم كتلة الشيفرة البرمجية أدناه بالتحويل من إحدى الصياغتين إلى الأخرى. تأخذ الدالة `convert_openfermion_to_qiskit` كوسيطات لها هاميلتوني تم إنشاؤه في OpenFermion أو Tangelo (وتم بالفعل تعيينه على مؤثرات باولي باستخدام أي مُعيِّن متاح)، وعدد الكيوبتات المطلوبة للجزيء.
...
علاوة على ذلك، يحتوي [دفتر بايثون هذا](https://ibm.ent.box.com/s/fh3xele1e7k0nrgd1imivvq52hy3wz9c) على شيفرة برمجية نموذجية كاملة لترحيل الهاميلتونيات من مسارات عمل برمجية أخرى إلى Qiskit، بما في ذلك التحويل أعلاه.

يجب أن يكون لديك الآن ترسانة من الأدوات للحصول على الهاميلتوني الذي تحتاجه لإجراء حسابات الكيمياء الكمومية على حواسيب IBM&reg; الكمومية.
