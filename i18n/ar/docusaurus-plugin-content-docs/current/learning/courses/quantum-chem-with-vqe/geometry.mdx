...
## الخطوة 3: التنفيذ باستخدام أدوات IBM Quantum البدائية {#step-3-execute-using-ibm-quantum-primitives}
...
بما أننا نعمل الآن مع عتاد حقيقي، سنستخدم IBM Quantum Compute Service و IBM Quantum
primitives. لاحظ أن كلاً من حلقة التكرار المتعلقة بالهندسة والتجارب
