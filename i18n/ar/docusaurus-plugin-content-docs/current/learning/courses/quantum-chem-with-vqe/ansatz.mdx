...
تحتوي مكتبة دوائر Qiskit على فئات متعددة من الدوائر التي يمكن استخدامها كـ ansatz. هنا سنقصر نقاشنا على دوائر ثنائية الموضع (دوائر تتكون من بوابات تعمل على كيوبتين بحد أقصى في كل مرة). **الـ Efficient SU2** هو ansatz شائع الاستخدام.
...
هذه الدائرة الأولى يُرجَّح أن تكون اختياراً سيئاً لأن الكيوبت الأخير غير متشابك مع الكيوبتات الأخرى على الإطلاق. في الواقع، لا يوجد أي إجراء حسابي ذو معنى على الكيوبت الأخير. في الغالب، ينبغي إما تشابك الكيوبت الأخير مع الآخرين أو حذفه من الحساب.
