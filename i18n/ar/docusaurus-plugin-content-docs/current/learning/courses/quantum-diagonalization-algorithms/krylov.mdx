...
![صورة توضح شعاعاً ذاتياً حقيقياً يُرمز له بـ x، وتخميناً يُرمز له بـ x 0، وتمثيلاً بيانياً للخطأ بين الاثنين.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig2.svg)
...
![صورة توضح شعاعاً ذاتياً حقيقياً وتحديثاً للتخمين الأولي. التخمين المحدَّث أقرب إلى الشعاع الذاتي الحقيقي.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig3.svg)
