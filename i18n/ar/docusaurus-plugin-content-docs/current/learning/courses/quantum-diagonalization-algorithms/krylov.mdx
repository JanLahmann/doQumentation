...
description: "يُشرح قطرنة كريلوف الكمومية (QKD)، بدءاً من أساليب كريلوف الكلاسيكية. ويتم مناقشة التقارب وكثافة الموارد المطلوبة."
...
$$
هذا هو إسقاط المصفوفة على فضاء كريلوف الجزئي حين يحتوي متجهاً واحداً فقط، $|v_0\rangle$. القيمة الذاتية لهذه المصفوفة هي 4 بشكل بديهي. يمكننا اعتبار ذلك تقديراً من الدرجة الصفرية للقيم الذاتية (قيمة واحدة فقط في هذه الحالة) للمصفوفة $A$. رغم أنه تقدير ضعيف، إلا أنه في الرتبة الصحيحة للحجم.
...
للتلخيص، نبدأ بحالة مرجعية، ثم نطوّرها لفترات زمنية مختلفة لتوليد الفضاء الجزئي الوحداني لـ Krylov. نسقط مؤثرنا الهاميلتوني على هذا الفضاء الجزئي، ونُقدّر كذلك تداخلات متجهات الفضاء الجزئي، وأخيراً نحل مسألة القيمة الذاتية المعممة ذات الأبعاد الأصغر بصورة كلاسيكية.
...
يُعرَّف فضاء Krylov الوحداني على النحو الآتي
