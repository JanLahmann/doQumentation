...
سننتقل للنظر في لعبة CHSH بعد قليل، لكن قبل ذلك دعنا نُقر بإيجاز بأن من المثير للاهتمام أيضًا النظر في ألعاب غير محلية أخرى. بل إنه مثير للاهتمام إلى حد بعيد؛ فهناك ألعاب غير محلية بسيطة جدًا لا يُعرف حتى الآن مدى قدرة أليس وبوب على اللعب فيها باستخدام التشابك الكمي. الإعداد بسيط، لكن ثمة تعقيدًا دفينًا — وفي بعض الألعاب قد يكون من المستحيل حسابيًا إيجاد أفضل الاستراتيجيات أو الاستراتيجيات القريبة من الأفضل. هذه هي الطبيعة المدهشة وغير البديهية لنموذج الألعاب غير المحلية.
...
هذا هو إذن احتمال فوزهما الإجمالي. وهو أفضل بكثير مما تستطيع أي استراتيجية كلاسيكية تحقيقه في هذه اللعبة؛ إذ لا يتجاوز احتمال الفوز في الاستراتيجيات الكلاسيكية $3/4.$ وهذا ما يجعل هذا المثال مثيرًا جدًا للاهتمام.
...
في الوقت الحالي، لنفترض أن $\alpha$ و$\beta$ قيمتان كيفيّتان (اعتباطيتان).
باختيار $\alpha,$ تُعرّف أليس فعلياً أساساً متعامداً ومعيارياً يبدو هكذا:
