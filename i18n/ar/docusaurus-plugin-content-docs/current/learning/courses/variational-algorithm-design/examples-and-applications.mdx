...
لهذا المرصود القيم الذاتية التالية:
...
هذه النتائج قريبة إلى حدٍّ ما من النتائج المتوقعة، باستثناء خطأ التقريب والطور العام. يمكننا ضبط مستوى التسامح في المحسِّن الكلاسيكي و/أو عقوبات تداخل متجهات الحالة للحصول على قيم أكثر دقة.
...
لتشغيل هذا على عتاد حقيقي، يجب علينا تحسين الدوائر الكمية لجهاز الحوسبة الكمية الذي اخترناه. لأغراضنا هنا، سنستخدم ببساطة الـ backend الأقل انشغالًا.
