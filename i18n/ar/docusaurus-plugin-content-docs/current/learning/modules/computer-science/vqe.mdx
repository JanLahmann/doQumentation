...
هنا، $\hat{H}$ هو الهاملتوني الذي يمثل الطاقة الكلية للنظام، و$|\psi\rangle$ هي دالة الموجة التي تحتوي على جميع المعلومات المتعلقة بالحالة الكمومية للنظام. (ملاحظة: $\frac{d}{dt}$ هو المشتق الكلي بالنسبة للزمن، ولا نُدرج هنا بشكل صريح قيمة القيمة الذاتية للطاقة $E$.)
...
في هذه الصيغة، تمثل $E$ القيمة الذاتية للطاقة المقابلة للحالة الكمومية $|\psi\rangle$. يشمل الهاملتوني مساهمات طاقة متنوعة، كالطاقة الحركية للإلكترونات والنوى، والقوى الجاذبة بين الإلكترونات والنوى، والقوى التنافرية بين الإلكترونات.
...
(b) احسب القيمة المتوقعة للهاملتوني $\hat{H}$ المعطى بـ $$ \hat{H} = -\frac{\hbar^2}{2m} \frac{d^2}{dx^2} + V(x)$$ حيث $V(x)  = \frac{1}{2}m\omega^2x^2$، وهو ما يقابل كمون المذبذب التوافقي البسيط.
...
#### (كمي) المؤثر الرصدي: هاملتوني الجزيء (طاقة الجزيء) {#quantum-observable-the-molecular-hamiltonian-energy-of-a-molecule}

في VQE، يُعدّ هاملتوني الجزيء/الذرة مؤثراً رصدياً، أي أننا نستطيع قياس قيمته من خلال تجربة. هدفنا هو إيجاد أدنى طاقة ممكنة (طاقة الحالة الأساسية) للجزيء. لتحقيق ذلك، نستخدم حالة كمية تجريبية، يُولّدها دائرة كمية ذات معاملات قابلة للضبط (ansatz). نقيس المؤثر الرصدي ونحسّن الحالة الكمية حتى نصل إلى أدنى طاقة ممكنة.
...
بما أننا سنستخدم هاملتونياً أحادي الكيوبت في هذه الوحدة، نحتاج إلى دائرة كمية ذات معاملات أحادية الكيوبت كـ ansatz. سنرى ثلاثة أنواع من ansätze أحادية الكيوبت في القسم التالي. سنقارنها ونناقش الاعتبارات الرئيسية في اختيار الـ ansatz.
...
تهانيّ! لقد أتممت للتو أول تجربة كيمياء كمية لك بنجاح. يمكننا ملاحظة فارق بين طاقة الحالة الأساسية الدقيقة للهاملتوني وطاقتنا المحسوبة، لكن لأننا استخدمنا تقنية تخفيف أخطاء افتراضية (تصحّح أخطاء القراءة)، فإن الفارق طفيف. هذه بداية ممتازة جدًا!
...
## حساب طاقة الحالة الأساسية لجزيء الهيدروجين باستخدام VQE {#compute-the-ground-state-energy-of-the-hydrogen-molecule-with-vqe}

الآن بعد أن نظرنا في العملية الكلية لـ VQE باستخدام ذرات $H$، سنحسب طاقة الحالة الأساسية لجزيء $H_2$ بشكل أسرع.
...
على خلاف حساب ذرة الهيدروجين المفردة ($H$)، لحساب الحالة الأساسية لجزيء الهيدروجين ($H_2$)، يجب علينا أيضًا مراعاة قوة التنافر المؤثرة بين نواتَي ذرتَي الهيدروجين، بالإضافة إلى الطاقة المرتبطة بالمدارات الإلكترونية. في هذه الخطوة، سنعطي هذه القيمة كثابت، وسنحسب هذه القيمة فعليًا في مسألة التحقق.
...
نظرنا أولاً في تقنيتين تقريبيتين مهمتين ضروريتين لحل مشاكل الكيمياء الكمية: المبدأ التباديلي واختيارات مجموعة الأساس، وكلاهما أساسي لـ VQE. استكشفنا المبدأ التباديلي يدوياً، وحسبنا طاقة الحالة الأساسية للمتذبذب التوافقي البسيط.

بعد ذلك، استكشفنا VQE، وهي خوارزمية واسعة الاستخدام لحساب طاقة الحالة الأساسية لنظام كمي. شغّلنا كوداً لحساب طاقات الحالة الأساسية للهيدروجين الذري ($H$) وجزيئة الهيدروجين ($H_2$). على وجه الخصوص، تعلمنا أنه من الضروري الحصول على الهاملتوني الجزيئي المناسب للنظام وتحويله إلى شكل قابل للتنفيذ على الحاسوب الكمي. رأينا أيضاً أن الـ ansatz، وهو دائرة كمية مُعلمَّة، ضروري لإعداد حالات كمية تجريبية داخل VQE، وناقشنا أهمية اختيار بنية دائرة ansatz مناسبة. تعلمنا أيضاً أن VQE تعتمد على عملية تحسين تكرارية باستخدام حاسوب كلاسيكي، توجه الدائرة الكمية للعثور على حالة الطاقة الأدنى، ورأينا كيف تتقارب العملية.
...
- في VQE، نبدأ بهاملتوني نظامنا ونقوم بتخطيطه على الكيوبتات للتنفيذ على الحاسوب الكمي. نختار دائرة كمية مُعلمَّة، وهي الـ ansatz، ونجري قياسات متكررة، مع تغيير معاملات الـ ansatz، حتى نصل إلى أدنى قيمة للطاقة. يتم البحث في فضاء المعاملات باستخدام محسِّن كلاسيكي. لتحقيق نتائج جيدة، من الضروري اختيار ansatz جيد ومحسِّن مناسب.
- طاقة التفاعل هي إجمالي تغيّر الطاقة في التفاعل الكيميائي، تُحدَّد بالفرق بين طاقة المتفاعلات والنواتج.

### صح/خطأ {#truefalse}
1. ينص المبدأ التباديلي على أن القيمة المتوقعة للطاقة لأي دالة موجية تجريبية تكون دائماً أكبر من أو تساوي طاقة الحالة الأساسية الحقيقية.
2. مجموعة الأساس هي مجموعة من الدوال تُستخدم لتقريب الدوال الموجية الكمية.
3. VQE هي خوارزمية كمية تُستخدم لحل معادلة شرودنغر بشكل دقيق لهاملتوني معين.
...
6. `Estimator` من Qiskit يُستخدم لحساب القيم المتوقعة للهاملتونيين في VQE مباشرةً.

### أسئلة الاختيار من متعدد: {#multiple-choice-questions}

1. ما هو الغرض من الهاملتوني في VQE؟
...
3. كم عدد الحالات الكمية التي تم توليدها في هذا الدفتر لمقارنة الـ ansatz؟
- أ) 100
- ب) 1000
- ج) 5000
- د) 10,000
...
5. لماذا صُمِّم الـ ansatz ليكون مُعلمَّاً؟
...
6. أي من العبارات التالية هي الأكثر صحة حول اختيار ansatz جيد؟
...
## (اختياري) ملحق: عبء المحسِّن حسب تعقيد الـ ansatz {#optional-appendix-optimizer-overhead-by-ansatz-complexity}
...
هنا سنلقي نظرة على هذه التحديات باستخدام VQE لجزيئة $H_2$، مع نوعين مختلفين من الـ ansätze.
...
بدلاً من الاعتماد على دوائر كيوبت واحد بسيطة وansatz مباشر، يزداد تعقيد التحسين عند الحاجة إلى دوائر كمية أكبر وansätze ذات بنية أكثر تعقيداً. يبرز هذا تحدياً معروفاً في VQEs: عبء المحسِّن.
