...
**ملاحظة:** سيكون من المثير للإعجاب جداً لو تمكنت من ابتكار تجربة تعطي نتائج مختلفة لخياري آينشتاين وبورن؛ لقد استغرق البشر عقوداً للتوصل إلى واحدة.

<Accordion>
<AccordionItem title="الإجابة">

مع الالتزام بالتجربة الموصوفة حتى الآن (أي، عدم وجود لف صافٍ مع البوزيترون والإلكترون في حالة تعاكس)، فإن قياس كلا اللفين على طول $\pm x$ أو $\pm y$ أو $\pm z$ سيعطي دائماً إشارات متعاكسة بسبب حفظ الزخم الزاوي، بغض النظر عن الخيار الصحيح. قياس لف جسيم واحد (مثلاً، الإلكترون) على طول اتجاه واحد (مثلاً، $+z$) يعني أن لف الجسيم الآخر، البوزيترون، سيُقاس على طول $-z$. إذا قست بدلاً من ذلك لف البوزيترون على طول اتجاه $x$، فسيكون من المرجح بالتساوي أن تكون النتيجة $+x$ أو $-x$. قد يكون هذا لأن هذا ما تقوله التعليمات الخفية (خيار آينشتاين الأول) أو لأن توزيع الاحتمال للف البوزيترون يتحدث بعد قياس لف الإلكترون، والتوزيع الاحتمالي الجديد متسق مع تقسيم 50-50 بين $\pm x$ (خيار بورن الثاني). هذه النقاط موضحة بتفصيل أكبر أدناه.
...
بقية هذا الدرس مخصصة لتجربة يمكنها التمييز بين خياري آينشتاين وبورن، لذا لن نخوض في التفاصيل هنا كثيراً. لكن جزءاً من الحيلة هو قياس الجسيمين على طول اتجاهين مختلفين (مثل $x$ و $z$، أو حتى اتجاه ما بين المحاور الديكارتية التقليدية). أما الباقي فيأتي من الدراسة الدقيقة للاحتمال الدقيق للحصول على نتائج مختلفة بناءً على تنبؤات ميكانيكا الكم وتلك الخاصة بالمعلومات الكلاسيكية كما في المتغيرات الخفية.

</AccordionItem>
</Accordion>

في كلا الخيارين، إذا قام المراقبان، لوكاس وريهانا، بالقياس على طول نفس المحور، فمن المتوقع أن يحصلا على لفوف متعاكسة، بغض النظر عن الخيار الصحيح. لفهم السبب، انظر إلى المخططات أدناه.
...
يوضح الشكل أعلاه خيار آينشتاين. اتجاهات اللفوف متعاكسة ومحددة. إذا قسنا على طول المحور $z$، سيكون أحدهما على طول $+z$، والآخر على طول $-z$. ليس لدينا سبب لافتراض أن البوزيترون سيكون على طول $+z$، والإلكترون على طول $-z$؛ الصورة توضح فقط أن اللفوف ستُقاس في اتجاهين متعاكسين. في الواقع، لا يلزم أن يكون للف معين فعلياً مركبة للفه على طول الاتجاه الذي سيتم قياسه في النهاية، في حالة خيار آينشتاين. أضعف صياغة لخيار آينشتاين هي أن هناك مجموعة من التعليمات المخزنة في اللف تحدد ما ستكون عليه نتائج القياس عند القياس على طول أي محور. لسنا بحاجة إلى تصور أن هذه التعليمات في شكل متجه بسيط (انظر المخطط أدناه)؛ سنعود إلى هذا لاحقاً.
...
يوضح الشكل أدناه خيار بورن، حيث تكون اتجاهات لفي البوزيترون والإلكترون ممتدة في توزيع احتمالي وليس لها اتجاه محدد. لا تقرأ الكثير في شكل التوزيع. يمكن أن يكون لكل لف احتمال غير صفري للإشارة في أي اتجاه طالما أنهما متعاكسان لبعضهما؛ لقد رسمناهما ببساطة كأجزاء من الدائرة حتى نتمكن من تمييزهما بصرياً لأغراض النقاش. لاحظ أنه في حالة خيار بورن، لا يزال صحيحاً أن الزخم الزاوي يجب أن يُحفظ. لذا إذا "انهارت" إحدى موجات الاحتمال بحيث يشير اللف على طول $+z$، فسيشير الآخر على طول $-z$ وينحرف في الاتجاه المعاكس. يبدو الخياران متطابقين.
...
لكن ماذا يحدث عندما يمكن للمراقبين L و R القياس على طول أي من ثلاثة محاور، مع فصل كل زوج منها بمقدار 120 درجة، كما هو موضح في الشكلين 4 و5. يمكن لكل مراقب أن يقرر عشوائياً على طول أي محور سيقيس اللف (a أو b أو c). ولا يحتاج الاثنان إلى القياس على طول نفس المحور. عندما يقيس كل مراقب، قد يجد إسقاطاً موجباً على المحور الذي اختاره، أو قد يجد إسقاطاً سالباً. على سبيل المثال، قد يقيس لوكاس وريهانا +a و-b أو +b و+c. لاحظ أنه إذا صادف أنهما اختارا القياس على طول نفس المحور، فيجب أن يحصلا على إشارتين متعاكستين في إسقاطاتهما: +a و-a، أو +b و-b، أو +c و-c؛ ولا يمكن أن يجدا كلاهما، على سبيل المثال، +a. في القسم التالي، سنعمل على كيفية حساب احتمال حصول لوكاس وريهانا على نفس الإشارة على محوريهما المقاسين (++ أو --) والإشارات المتعاكسة (+-) أو (-+).
...
يوضح الشكلان أعلاه تفسيرات ممكنة للمتغيرات الخفية في سيناريو القياس الجديد ذي المحاور الثلاثة. أي، إما أن اللفوف محددة مسبقاً، كمتجهات، أو أن مجموعة من التعليمات الفيزيائية موجودة بطريقة ما مضمّنة في النظام بحيث تكون نتائج جميع القياسات الممكنة محددة مسبقاً، حتى لو كانت غير معروفة للتجريبيين قبل القياس. البديل موضح أدناه. يوجد توزيع احتمالي ما للنتائج، ويمكن لهذا التوزيع أن يخبرنا ببعض الأشياء حول احتمالية نتائج القياس المختلفة، لكن النتائج غير محددة من قبل الطبيعة قبل القياس.
...
يمكننا أن نسأل أنفسنا: «كم مرة يجب أن يجد اللاعبان نفس إشارة إسقاط اللف المغزلي؟» أي أننا لا نسجل حتى على أي محور اختارا القياس؛ بل نسجل ببساطة ما إذا وجدا نفس الإشارة أو إشارة مختلفة. ليس واضحاً ما إذا كانت خيارات أينشتاين وبورن ستُعطي نفس النتيجة في مخطط القياس الأكثر تعقيداً هذا. لكن يجب أن يتضح من الشكلين 4 و5 أنه من $possible$ أن يكون هناك فرق. في الحالة الموضحة في خيار أينشتاين، سيُعطي قياس إسقاط لف $e+$ على المحور $a$ بالتأكيد $+a$، وسيُعطي إسقاط لف $e-$ على المحور $b$ القيمة $-b$ (بالكاد). لكن في خيار بورن، تكون الاحتمالات مفتوحة تماماً. صحيح أن الزخم الزاوي لا يزال محفوظاً. لكن بما أن المجالين المغناطيسيين غير موجهين على نفس المحور، فإننا نُجبر الجسيمات على وضع يجب فيه أن تنهار على محاور مختلفة (عبر التفاعلات مع المجال). في القسم التالي، سنستخدم ميكانيكا الكم لتحديد ما يجب أن تكون عليه الاحتمالات، بافتراض خيار بورن، لأن يحصل لوكاس وريحانا على نفس الإشارة على محاوريهما المقيسة (++ أو --)، واحتمالات أن يحصلا على إشارتين متعاكستين (+- أو -+).
...
بدت خيارات أينشتاين وبورن وكأنها ستُعطي دائماً نفس النتائج، لأنهما يختلفان فقط في وصفهما لما يحدث قبل القياس. ومع ذلك، بافتراض وجود تعليمات تُحدد مسبقاً إشارة قياس اللف المغزلي على محاور معينة، حصلنا على قيد على احتمال أن يُعطي القياسان نفس الإشارة $(P_{\text{same}})_\text{Einstein}\leq\frac{4}{9}$. ثم افترضنا توزيعات احتمالية كما في ميكانيكا الكم... وحصلنا على قيمة مختلفة $(P_{\text{same}})_\text{Born}=\frac{1}{2}$. التنبؤ من ميكانيكا الكم أعلى مما تسمح به معالجة المتغيرات الخفية. لذا يمكننا فعلياً إجراء تجربة واكتشاف ما إذا كانت الحالات الكمومية مُحددة من قبل الطبيعة قبل القياس، أو ما إذا كانت في تراكب احتمالي حقيقي للحالات الممكنة.

أُجريت هذه التجربة مرات عديدة باستخدام أنظمة فيزيائية مختلفة كثيرة، غالباً باستخدام الفوتونات. هناك اعتبارات دقيقة عديدة، مثل التحيزات في القياس، وتوقيت (تزامن) القياسات، وغيرها الكثير. على مر العقود، تلاشت المخاوف بشأن هذه الدقائق تدريجياً. لا تزال الاختبارات تُنفذ، بينما نتعلم المزيد عن الواقع، لكن هناك الآن اتفاق واسع على أن الإجابة التي ستحصل عليها هنا، باستخدام حواسيب IBM&reg; الكمومية، صحيحة.
...
سنستخدم الآن Qiskit primitive مرجعي يسمى StatevectorSampler. المُعيِّن (Sampler) هو primitive مصمَّم لأخذ عينات من جميع الحالات الممكنة للنظام وإرجاع احتمالات (أو في بعض الحالات شبه احتمالات) الحصول على كل حالة. يمكننا تحديد عدد من "التصويبات" (shots) والاطلاع على "العدّات" (counts) لكل حالة.
...
1. افترض أن جسيماً عديم الدوران يتحلل إلى جسيمَين A وB لكل منهما دوران 1/2. أُجري قياس على الجسيم A أظهر أن دورانه له إسقاط على $+z$. الجسيم B الآن

    - أ. يمتلك بالتأكيد إسقاط دوران على $-z$

    - ب. يمتلك بالتأكيد إسقاط دوران على $-x$

    - ج. يمتلك بالتأكيد إسقاط دوران على $-y$

    - د. يمتلك بالتأكيد إسقاط دوران سالب على أي محور يُقاس.


2. جسيم عديم الدوران يتحلل إلى جسيمَين A وB لكل منهما دوران 1/2. إذا قِيس أن الجسيم A له إسقاط على $+z$، فأيٌّ من الإسقاطات التالية ممكنة لقياس الجسيم B؟ اختر كل ما ينطبق.
...
3. افترض أن جسيماً عديم الدوران يتحلل إلى جسيمَين A وB لكل منهما دوران 1/2. ما الذي يصف بشكل أفضل حالة الجسيم A قبل أي قياس.

    - أ. دوران الجسيم A على $+z$.

    - ب. دوران الجسيم A على $-z$.

    - ج. دوران الجسيم A على $+x$.

    - د. دوران الجسيم A محدد في بعض الاتجاهات لكن ليس في اتجاهات أخرى.

    - هـ. توجه الدوران للجسيم A غير محدد بطبيعته قبل أي قياسات.
...
1. الأصدقاء A وB وC يناقشون نتائج هذا المختبر المتعلقة بمتراجحة بيل. تحديداً، يتأملون الصورة التي تظهر أن الاحتمال الكمي لقياس الإشارة ذاتها على المحاور أكبر مما تسمح به معالجة المتغيرات الخفية: $(P_\text{same})_\text{max,QM}>(P_\text{same})_\text{max,HV}$. يقول الصديق A: "هذا يعني أننا لم نكن نعرف حالات الدوران قبل القياس." يقول الصديق B: "لا، الأمر أكثر من ذلك. هذا يعني أن الدورانات لم تكن تشير في اتجاه معين قبل القياس. وإن كانت حالة الدوران ربما تكون محددة أو مخزنة بطريقة ما." يقول الصديق C: "لا، الأمر أكثر من ذلك بكثير. هذا يعني أن حالة الدوران المستقبلية لم تكن الطبيعة قد حددتها أصلاً قبل القياس." مع من تتفق، ولماذا؟
...
4. هل يمكن استكشاف متراجحة بيل فقط باستخدام 3 محاور متساوية التباعد $a$ و$b$ و$c$؟ هل يمكن إجراؤها بأي عدد آخر من المحاور؟ كيف سيبدو ذلك؟ هل ستُعطي فرقاً في الاحتمالات التي تتنبأ بها المتغيرات الخفية مقابل ميكانيكا الكم الاحتمالية؟
