...
لن تُظهر جميع التشغيلات تحسناً في الأداء بسبب التوصيف في الوقت الحقيقي - ومع زيادة طول السلسلة، وبالتالي حرية أقل لاختيار الكيوبتات الفيزيائية، تصبح أهمية معلومات الجهاز المحدّثة أقل جوهرية. مع ذلك، من الممارسات الجيدة جمع بيانات جديدة عن خصائص الجهاز لفهم أدائه. أحياناً، قد تؤثر أنظمة ثنائية المستوى العابرة على أداء بعض الكيوبتات. يمكن أن تُعلمنا البيانات في الوقت الحقيقي عند حدوث مثل هذه الأحداث وتساعدنا على تجنب فشل التجارب في مثل هذه الحالات.
<Admonition type="note" title="دعوة للعمل">
حاول تطبيق هذه الطريقة على تنفيذاتك وحدد مقدار الفائدة التي تحصل عليها! يمكنك أيضاً تجربة رؤية مقدار التحسينات التي تحصل عليها من خلفيات مختلفة.
</Admonition>
...
> **ملاحظة:** هذا الاستطلاع من **IBM Quantum** ويغطي **محتوى الدرس** (الذي كتبته IBM). توفّر doQumentation الموقع والترجمات وتنفيذ الكود — للتعليق على هذه الجوانب، يرجى [فتح مشكلة على GitHub](https://github.com/JanLahmann/doQumentation/issues).
