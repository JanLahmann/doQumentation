...
## الخلفية {#background}
يوضح هذا البرنامج التعليمي كيفية تحقيق انتقال طور نيشيموري على معالج كم IBM&reg;. وُصفت هذه التجربة في الأصل في [*Realizing the Nishimori transition across the error threshold for constant-depth quantum circuits*](https://arxiv.org/abs/2309.02863).
