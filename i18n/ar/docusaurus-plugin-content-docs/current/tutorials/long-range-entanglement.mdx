...
* معرفة أساسية بـ [Qiskit SDK](https://docs.quantum.ibm.com/guides) و[Qiskit Runtime](/guides/compute-services#qiskit-runtime)، والوصول إلى [حساب IBM Quantum&reg;](/guides/cloud-setup).
## الخلفية {#background}
...
قبل التشغيل على وحدة المعالجة الكمومية الفعلية، نتحقق من أن كلًّا من الدوائر الديناميكية والموحدة تُنتجان حالة بيل مثالية على محاكٍ غير مُضوَّش. نستخدم Qiskit Runtime `Sampler` مع `AerSimulator` كوضع للخلفية، عند مسافة صغيرة قدرها 6.
