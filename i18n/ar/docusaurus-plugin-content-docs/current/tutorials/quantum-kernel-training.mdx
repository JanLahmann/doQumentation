...
للقيام بذلك، انقل الكود المصدري أعلاه إلى ملف باسم `./source/generate_kernel_entry.py`، ولف الكود في نص برمجي يأخذ مدخلات ويعيد الحل النهائي، ثم ارفعه إلى مجموعة بعيدة باستخدام الفئة `QiskitFunction` من `Qiskit Serverless`. للاطلاع على إرشادات حول تحديد التبعيات الخارجية وتمرير وسيطات الإدخال وما إلى ذلك، راجع [أدلة Qiskit Serverless](https://qiskit.github.io/qiskit-serverless/function_features/index.html#function-features).
