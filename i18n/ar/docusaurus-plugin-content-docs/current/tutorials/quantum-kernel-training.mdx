...
*   المدخل: دائرة مجردة.
*   المخرج: توزيع شبه احتمالي.

استخدم العنصر الأولي `StatevectorSampler` من Qiskit لإعادة بناء توزيع شبه احتمالي للحالات الناتجة عن أخذ عينات من الدائرة. لغرض توليد مصفوفة النواة، نهتم بشكل خاص باحتمال قياس الحالة |0>.
...
لملء مصفوفة النواة بأكملها، سنُشغِّل تجربة كمية لكل عنصر من عناصرها الفريدة البالغة $N(N+1)/2$. يُظهر الشكل أدناه المصفوفة الناتجة لمجموعة البيانات هذه؛ يدل اللون الأحمر الداكن على قيم دقة أقرب إلى 1.0.
