...
description: "يمكن استخدام صيغ المنتجات المتعددة في تقدير المؤثرات للحد من خطأ تروتر أو لتنفيذ التطور الزمني بخطأ تروتر ثابت في عمق أقل."
...
## الخلفية {#background}
يستعرض هذا البرنامج التعليمي كيفية استخدام صيغة المنتجات المتعددة (MPF) لتحقيق خطأ Trotter أقل في الرصدة مقارنةً بالخطأ الناجم عن أعمق دائرة Trotter التي سننفذها فعلياً.
...
#### إعداد دوائر Trotter {#set-up-the-trotter-circuits}
...
### الخطوة 1: تعيين المدخلات الكلاسيكية إلى مسألة كمية {#step-1-map-classical-inputs-to-a-quantum-problem-1}
...
#### اختيار خطوات Trotter {#choose-trotter-steps}
...
#### إعداد نظام المعادلات الخطية (LSE) {#set-up-the-lse-1}
...
#### إنشاء كل دائرة Trotter في تحليل MPF الخاص بنا {#construct-each-of-the-trotter-circuits-in-our-mpf-decomposition}
...
#### إنشاء دائرة Trotter ذات خطأ Trotter مماثل لـ MPF {#construct-trotter-circuit-with-comparable-trotter-error-to-mpf}
...
### الخطوة 2: تحسين المسألة لتنفيذها على الأجهزة الكمومية {#step-2-optimize-problem-for-quantum-hardware-execution-1}
...
### الخطوة 3: التنفيذ باستخدام Qiskit primitives {#step-3-execute-using-qiskit-primitives-1}
...
### الخطوة 4: المعالجة اللاحقة وإرجاع النتيجة بالتنسيق الكلاسيكي المطلوب {#step-4-post-process-and-return-result-in-desired-classical-format-1}
