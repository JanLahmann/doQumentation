...
يمكن أيضاً تمرير خيارات مخصصة لمتعلم الضوضاء. تتبع التعريفات المستخدمة في `qiskit-ibm-runtime` [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options):
