...
* توضيح استخدام [الانتشار العكسي للمؤثرات (OBP)](https://qiskit.github.io/qiskit-addon-obp/) لتقليل عمق الدائرة. تُتيح هذه التقنية اختصار العمليات من نهاية الدائرة على حساب قياسات مؤثرات أكثر.
...
الآن نُصوِّر تخطيط الكيوبتات على جهاز Heron للرسم البياني الجزئي المختار:
...
لاحظ أن اتصالية تخطيط الكيوبتات المختار ليست بالضرورة خطية، وقد تغطي مناطق واسعة من جهاز Heron تبعاً لعدد الكيوبتات المحددة.

الآن نُولِّد دائرة Trotter ومراقِب المغنطة المتوسط للعدد المختار من الكيوبتات والمعاملات:
...
في كلتا الحالتين، تُخرج QESEM تقدير الوقت اللازم للوصول إلى الدقة المطلوبة لـ**جميع** المراقِبات.
...
الآن سنستخدم backpropagation للعوامل (OBP). (راجع توثيق [OBP](https://qiskit.github.io/qiskit-addon-obp/) للاطلاع على مزيد من التفاصيل حول إضافة OBP لـ Qiskit.) سننشئ دالةً تُولِّد شرائح الدائرة للـ backpropagation:
...
والآن بعد أن حصلنا على الدائرة المخفَّضة والمراقِبات الموسَّعة، لنُجرِ تقدير الوقت للدائرة الناتجة عن backpropagation:
...
الآن نُشغِّل التجربة الكاملة على عدد من خطوات Trotter. يمكن تعديل عدد الكيوبتات والدقة المطلوبة والحد الأقصى لوقت QPU وفقاً لموارد QPU المتاحة. لاحظ أن تقييد الحد الأقصى لوقت QPU سيؤثر على الدقة النهائية، كما ستُلاحظ في الرسم البياني الأخير أدناه.
