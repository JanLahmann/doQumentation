...
**تخطَّ هذه الخلية** إذا كنت قد حفظت بيانات الاعتماد في [الإعدادات](/jupyter-settings#ibm-quantum) أو فعَّلت وضع المحاكاة — فسيتم حقنها تلقائياً عند الضغط على تشغيل. تشغيل هذه الخلية بقيم عشوائية سيُطغي على إعداداتك.
