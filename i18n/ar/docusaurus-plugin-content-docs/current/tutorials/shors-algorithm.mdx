...
بعد اجتياز هذا البرنامج التعليمي، ينبغي للمستخدمين أن يفهموا:
- الخلفية الرياضية لخوارزمية شور للتحليل إلى عوامل
- كيفية تشغيل مثال تطبيقي لهذه الخوارزمية على عتاد حقيقي

## المتطلبات الأساسية {#prerequisites}
نقترح أن يكون المستخدمون على دراية بالمواضيع التالية قبل البدء بهذا البرنامج التعليمي:
- [أساسيات الخوارزميات الكمية](/learning/courses/fundamentals-of-quantum-algorithms).
- [تقدير الطور والتحليل إلى عوامل](/learning/courses/fundamentals-of-quantum-algorithms/phase-estimation-and-factoring/introduction). نتناول بعض هذه المادة في هذا البرنامج التعليمي.
