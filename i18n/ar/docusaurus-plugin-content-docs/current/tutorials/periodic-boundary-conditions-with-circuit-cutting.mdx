...
للتحقق من جودة النتيجة باستخدام قطع الدائرة، نحتاج إلى معرفة النتيجة المثالية. الدائرة الحالية تتجاوز إمكانيات المحاكاة الكلاسيكية المباشرة (brute force). لذلك، نُحدد المعاملات بعناية لجعلها Clifford.
...
<ul>
    ...
    <li>المخرج: توزيعات شبه الاحتمالية (Quasi-probability distributions)</li>
</ul>
...
<ul>
    <li>المدخل: توزيعات شبه الاحتمالية</li>
...
> **ملاحظة:** هذا الاستطلاع مقدّم من **IBM Quantum** ويغطي **محتوى الدرس التطبيقي** (المكتوب من قبل IBM). توفر doQumentation الموقع والترجمات وتنفيذ الشيفرة — للتعليقات على تلك الجوانب، يرجى [فتح مشكلة على GitHub](https://github.com/JanLahmann/doQumentation/issues).
