...
## الإعداد {#setup}
أولاً، قم بالمصادقة باستخدام [مفتاح IBM Quantum API](http://quantum.cloud.ibm.com/). ثم اختر دالة Qiskit كما يلي. (يفترض هذا الكود أنك قد [حفظت حسابك](/guides/functions-get-started#install-qiskit-functions-catalog-client) مسبقاً في بيئتك المحلية.)
...
نُقيّم ديناميكيات المغنطة على عتاد كمومي حقيقي. تُوفّر Fire Opal دالة Qiskit تُوسّع primitive المقدِّر القياسي في IBM Quantum بقمع الأخطاء الآلي وإدارة الأداء. نُرسل دوائر Trotter مباشرةً إلى خلفية IBM&reg; بينما تتولى Fire Opal التنفيذ مع الوعي بالضجيج.
