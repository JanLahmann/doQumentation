...
الدوائر المستخدمة في هذا المقياس مستقاة من [مستودع مقياس Hamlib المرجعي](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation)، الذي يحتوي على أعباء عمل واقعية لمحاكاة هاميلتونيان.
