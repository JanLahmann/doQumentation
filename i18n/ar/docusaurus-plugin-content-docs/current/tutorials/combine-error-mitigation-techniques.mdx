---
description: 'دمج خيارات تخفيف الأخطاء للتجارب على نطاق المنفعة باستخدام معالجات IBM Quantum QPU التي تتجاوز 100 كيوبت وأداة IBM Quantum Estimator الأساسية.'
...
يستكشف هذا الدرس التعليمي خيارات قمع الأخطاء وتخفيفها المتاحة مع أداة Estimator الأساسية من IBM Quantum. يوضح هذا الدرس التعليمي كيفية تطبيق كل من الأساليب التالية بشكل مستقل:
...
ستُرسل هنا خمس مهام منفصلة، تبدأ بدون أي قمع أو تخفيف للأخطاء، ثم تُمكِّن تدريجياً خيارات متنوعة لقمع الأخطاء وتخفيفها المتاحة في IBM Quantum Compute Service. للاطلاع على معلومات حول الخيارات، ارجع إلى الصفحات التالية:
...
نظراً لإمكانية تشغيل هذه المهام بشكل مستقل عن بعضها، يمكنك استخدام [وضع الدُفعات](/guides/run-jobs-batch) للسماح لـ Quantum Compute بتحسين توقيت تنفيذها.
