...
لمحاكاة قيمة التوقع للدائرة الكاملة الحجم، يتم توليد تجارب فرعية عديدة من التوزيع شبه الاحتمالي للبوابات المحللة، ثم تنفيذها على خلفية أو أكثر. يتحكم `num_samples` في عدد العينات المأخوذة من التوزيع، ويُعطى معامل مشترك واحد لكل عينة فريدة. لمزيد من المعلومات حول كيفية حساب المعاملات، راجع [المواد التوضيحية](https://qiskit.github.io/qiskit-addon-cutting/explanation/index.html).
...
> **ملاحظة:** هذا الاستطلاع من **IBM Quantum** ويغطي **محتوى البرنامج التعليمي** (المكتوب من قبل IBM). توفر doQumentation الموقع، والترجمات، وتنفيذ الشيفرة — للتعليقات على هذه الجوانب، يرجى [فتح مشكلة على GitHub](https://github.com/JanLahmann/doQumentation/issues).
