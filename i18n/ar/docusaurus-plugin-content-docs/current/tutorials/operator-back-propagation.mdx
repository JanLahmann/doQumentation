...
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop)، حزمة مُسرَّعة بـ Rust لانتشار Pauli، مع tutorials تُغطي OBP وتقدير قيمة التوقع الكلاسيكية والمحاكاة الضوضائية
</Admonition>
