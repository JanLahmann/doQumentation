...
يوضح هذا البرنامج التعليمي كيفية تشغيل تجربة تخفيف أخطاء على نطاق الاستخدام باستخدام Qiskit Runtime، مع إصدار تجريبي من *استقراء الضوضاء الصفرية* (ZNE) مع *تضخيم الخطأ الاحتمالي* (PEA).
...
**المرجع**: Y. Kim et al. *Evidence for the utility of quantum computing before fault tolerance.* [Nature 618.7965 (2023)](https://www.nature.com/articles/s41586-023-06096-3)
