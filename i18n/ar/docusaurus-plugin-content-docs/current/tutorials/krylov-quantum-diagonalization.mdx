...
يمكن أن تكون دائرة اختبار Hadamard دائرة عميقة بمجرد تحليلها إلى البوابات الأصلية (وهو ما سيزداد أكثر عند مراعاة طوبولوجيا الجهاز)
...
افترض أنه يمكننا حساب $E_0$ كلاسيكياً، وهو القيمة الذاتية لـ $|0\rangle^N$ تحت الهاميلتوني $H$.
يتحقق هذا الشرط عندما يحافظ الهاميلتوني على تماثل U(1). وعلى الرغم من أن هذا قد يبدو افتراضاً قوياً، إلا أن هناك حالات كثيرة يمكن فيها افتراض وجود حالة فراغ (تُرسَم على الحالة $|0\rangle^N$ في هذه الحالة) لا يؤثر فيها فعل الهاميلتوني. ينطبق هذا على سبيل المثال على هاميلتونيات الكيمياء التي تصف جزيءً مستقراً (حيث يكون عدد الإلكترونات محفوظاً).
...
وعندئذ تُنفذ الدارة أعلاه الحالة التالية قبل القياس:
...
ثم نُحوِّل الدارة الافتراضية إلى أفضل تخطيط فيزيائي في هذا الهدف الجديد
...
### حساب مصفوفة الهاميلتوني الفعّال ومصفوفة التراكب {#calculate-effective-hamiltonian-and-overlap-matrices}
...
أخيراً، يمكننا حل مسألة القيمة الذاتية المعممة لـ $\tilde{H}$:
...
بالنسبة لقطاع الجسيم الواحد، يمكننا حساب الحالة الأساسية لهذا القطاع من الهاميلتوني بكفاءة كلاسيكياً
...
## ملحق: الفضاء الجزئي لكريلوف من التطورات الزمنية الحقيقية {#appendix-krylov-subspace-from-real-time-evolutions}

يُعرَّف فضاء كريلوف الأحادي بالصيغة التالية:

$$
\mathcal{K}_U(H, |\psi\rangle) = \text{span}\left\{ |\psi\rangle,  e^{-iH\,dt} |\psi\rangle, \dots, e^{-irH\,dt} |\psi\rangle \right\}
$$

لخطوة زمنية $dt$ سنحددها لاحقاً. لنفترض مؤقتاً أن $r$ عدد زوجي، ونعرّف $d=r/2$. لاحظ أنه عند إسقاط الهاميلتوني على فضاء كريلوف أعلاه، فإنه لا يمكن تمييزه عن فضاء كريلوف
...
تبقى ثابتة تحت الإزاحات الكلية لزمن التطور، إذ إن التطورات الزمنية تتبادل مع الهاميلتوني. وبالنسبة للأعداد الفردية $r$، يمكننا استخدام تحليل $r-1$.

نريد أن نُثبت أنه في مكان ما داخل فضاء كريلوف هذا، يُضمَن وجود حالة منخفضة الطاقة. ونفعل ذلك عن طريق النتيجة التالية، المشتقة من النظرية 3.1 في [\[3\]](#references):

**الادعاء 1:** توجد دالة $f$ بحيث أنه للطاقات $E$ ضمن النطاق الطيفي للهاميلتوني (أي بين طاقة الحالة الأساسية والطاقة القصوى)...
1. $f(E_0)=1$
2. $|f(E)|\le2\left(1 + \delta\right)^{-d}$ لجميع قيم $E$ التي تبعد مسافة $\ge\delta$ عن $E_0$، أي أنها تتناقص أسياً
3. $f(E)$ هي تركيبة خطية من $e^{ijE\,dt}$ بحيث $j=-d,-d+1,...,d-1,d$

نُقدّم إثباتاً لذلك أدناه، غير أنه يمكن تخطيه بأمان ما لم يُرد المرء فهم الحجة الكاملة الصارمة. نركّز الآن على مضامين الادعاء أعلاه. بموجب الخاصية 3 أعلاه، يتضح أن فضاء كريلوف المُزاح أعلاه يحتوي على الحالة $f(H)|\psi\rangle$. وهذه هي حالتنا منخفضة الطاقة. لمعرفة السبب، نكتب $|\psi\rangle$ في أساس القيم الذاتية للطاقة:
...
لتحويل هذا إلى حدٍّ أعلى أسهل في الفهم، نفصل أولاً مجموع البسط إلى حدود تحقق $E_k-E_0\le\delta$ وحدود تحقق $E_k-E_0>\delta$:
...
حيث تنبثق الخطوة الأولى من كون $E_k-E_0\le\delta$ لكل $E_k$ في المجموع، وتنبثق الخطوة الثانية من كون المجموع في البسط جزءاً من المجموع في المقام. أما الحد الثاني، فنُقيّد المقام بحد أدنى هو $|\gamma_0|^2$، إذ إن $f(E_0)^2=1$: وبجمع كل شيء معاً، يعطينا ذلك
...
يسري هذا لأي $\delta>0$، لذا إذا ضبطنا $\delta$ مساوياً لهدف الخطأ المنشود، فإن الحد الأعلى للخطأ يتقارب نحوه أسياً مع بُعد فضاء كريلوف $2d=r$. ولاحظ أيضاً أنه إذا كان $\delta<E_1-E_0$ فإن حد $\delta$ يختفي كلياً من الحد الأعلى أعلاه.

لإتمام الحجة، نشير أولاً إلى أن ما سبق ليس سوى خطأ الطاقة للحالة المحددة $f(H)|\psi\rangle$، لا خطأ الطاقة لأدنى حالة طاقة في فضاء كريلوف. غير أنه بموجب مبدأ التنويع (Rayleigh-Ritz)، يكون خطأ الطاقة لأدنى حالة طاقة في فضاء كريلوف مقيداً بحد أعلى هو خطأ الطاقة لأي حالة في فضاء كريلوف، وبالتالي فإن ما سبق يُعدّ أيضاً حداً أعلى لخطأ الطاقة لأدنى حالة طاقة، أي ناتج خوارزمية تقطير كريلوف الكمي.

يمكن إجراء تحليل مشابه لما سبق يأخذ في الحسبان أيضاً الضوضاء وإجراء العتبة (thresholding) المُناقَش في هذا الدفتر. راجع [\[2\]](#references) و [\[4\]](#references) لهذا التحليل.

## ملحق: إثبات الادعاء 1 {#appendix-proof-of-claim-1}
يُشتق ما يلي في معظمه من [\[3\]](#references)، النظرية 3.1: ليكن $ 0 < a < b $ وليكن $ \Pi^*_d $ فضاء المتعددات الحدية المتبقية (أي المتعددات الحدية التي قيمتها عند 0 تساوي 1) ذات الدرجة الأكثر $ d $. الحل لـ
...
نريد تحويل هذا إلى دالة يمكن التعبير عنها بصورة طبيعية من خلال الأسيات المركبة، لأن تلك هي التطورات الزمنية الحقيقية التي تولّد فضاء كريلوف الكمي.
لتحقيق ذلك، من المناسب تقديم التحويل التالي للطاقات ضمن النطاق الطيفي للهاميلتوني إلى أعداد في المدى $[0,1]$: نعرّف
...
حيث $E_0$ هي طاقة الحالة الأساسية. يمكننا أن نرى بإدراج $\cos(x)=\frac{e^{ix}+e^{-ix}}{2}$ أن $f(E)$ هي متعددة حدية مثلثية من الدرجة $d$، أي تركيبة خطية من $e^{ijE\,dt}$ بحيث $j=-d,-d+1,...,d-1,d$. فضلاً عن ذلك، من تعريف $p^*(x)$ أعلاه لدينا أن $f(E_0)=p(0)=1$، وأنه لأي $E$ في النطاق الطيفي بحيث $\vert E-E_0 \vert > \delta$ يكون
