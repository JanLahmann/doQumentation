...
## 1. المعيار 1 – كيوبتات قابلة للتوسع ومحددة الخصائص جيداً {#criterion-1-scalable-well-characterized-qubits}
...
## 2. المعيار 2 – تهيئة الكيوبت {#criterion-2-qubit-initialization}
