---
title: "Dissoziationskurve met Qunova HiVQE"
sidebar_label: "Dissoziationskurve met Qunova HiVQE"
description: "Bruuch Qunova HiVQE för et Ußrächne vun Dissoziations-Potentialkurve (PES)."
...
Qiskit Functions sin en experimentelle Funkzjon, die blooß för IBM Quantum&reg; Premium Plan, Flex Plan un On-Prem (övver IBM Quantum Platform API) Plan Nutzer verfögbar es. Se sin em Vorschau-Status un künne sich noch ändere.
</Admonition>
...
## Deil 1: Li2S (20Q) {#part-1-li2s-20q}

### Schrett 1: Klassische Injaben op e Quanteproblem affbilde {#step-1-map-classical-inputs-to-a-quantum-problem}

Deffinier $Li_2S$ Jeometrie em Dictionary-Format för verschiedene Bindungsabstände vun Li-S för et Ußrächne vun de PES-Kurve. Die Jeometrie sin optimiert met B3LYP/631g Rächnunge.
...
### Schrett 2 un 3: Optimier et Problem för Quantehardware-Ußführung un führ et uss met de HiVQE Chemistry Funkzjon {#step-2-and-3-optimize-problem-for-quantum-hardware-execution-and-execute-using-the-hivqe-chemistry-function}
...
De jesampte QPU-Laufzick, die em Job jebruucht wood, kann jetracked wääde durch Enlogge op [IBM Quantum Platform](https://quantum.cloud.ibm.com/) un et Aanluure vun enjereichte Jobs met dem `qunova-chemistry-hivqe` Tag.
### Schrett 4: Nohbearbeitung un Verjlich met klassische Methode {#step-4-post-process-and-compare-with-classical-methods}
...
### Et Plotte vun de Dissoziationskurve för Li\_2S {#plotting-the-dissociation-curve-for-li_2s}

Lommer plotte un HiVQE Erjebnisse met HF un CASCI verjliche.
Do kanns luure, dat all HiVQE Rächnunge joot met dem klassische Referenzerjebniss (CASCI) övverensteimme.
...
## Deil 2: FeP-NO (44Q) {#part-2-fep-no-44q}

### Schrett 1: Klassische Injaben op e Quanteproblem affbilde {#step-1-map-classical-inputs-to-a-quantum-problem-1}
...
### Schrett 2 un 3: Optimier et Problem för Quantehardware-Ußführung un führ et uss met de HiVQE Chemistry Funkzjon {#step-2-and-3-optimize-problem-for-quantum-hardware-execution-and-execute-using-the-hivqe-chemistry-function-1}

Basierend op dem Setup vun HiVQE un de Jeometrie, kriss de Erjebnisse sequenziell.
#### Reiche d(Fe-N) = 1.75 $\AA$ Rächnung en. {#submit-dfe-n-175-aa-calculation}
...
Verfolg der Job un ruf et Erjebniss av för d(Fe-N) = 1.75 $\AA$ Rächnung.
...
#### Reiche d(Fe-N) = 2.00 $\AA$ Rächnung en. {#submit-dfe-n-200-aa-calculation}
...
Verfolg der Job un ruf et Erjebniss av för d(Fe-N) = 2.00 $\AA$ Rächnung.
...
#### Reiche d(Fe-N) = 5.00 $\AA$ Rächnung en. {#submit-dfe-n-500-aa-calculation}
...
Verfolg der Job un ruf et Erjebniss av för d(Fe-N) = 5.00 $\AA$ Rächnung.
...
### Schrett 4: Nohbearbeitung un Verjlich met klassische Methode {#step-4-post-process-and-compare-with-classical-methods-1}
...
[Link zu de Ömfrog](https://your.feedback.ibm.com/jfe/form/SV_9AizRyKFHEGzVs2)
