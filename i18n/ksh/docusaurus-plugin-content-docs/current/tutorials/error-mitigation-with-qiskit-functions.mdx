...
#### De Schaltkreis konstruiere {#construct-the-circuit}
...
#### Dat Observable konstruiere {#construct-the-observable}
...
#### De global Magnetisierung berechne {#compute-the-global-magnetization}
