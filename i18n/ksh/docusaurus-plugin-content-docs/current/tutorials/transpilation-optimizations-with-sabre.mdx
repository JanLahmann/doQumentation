...
### Wat liers do hee {#what-youll-learn}
...
## Deel I. SABRE met Qiskit-Mustern bruche {#part-i-using-sabre-with-qiskit-patterns}
...
### Schritt 1: Klassische Engänge op en Quanteproblem abbilden {#step-1-map-classical-inputs-to-a-quantum-problem}
...
### Schritt 2: Problem för Quantehardware-Ömsetung optimiere {#step-2-optimize-problem-for-quantum-hardware-execution}
...
#### Woröm sin Schaltkreisjröße un Deefe wichtig? {#why-are-circuit-size-and-depth-important}
...
### Schritt 3: Met Qiskit-Primitives ömsetze {#step-3-execute-using-qiskit-primitives}
...
### Schritt 4: Nohverarbeitung un Ergebnis em gewünschte klassische Format zoröckgäve {#step-4-post-process-and-return-result-in-desired-classical-format}
...
## Deel II. De Heuristik en SABRE konfiguriere un Serverless bruche {#part-ii-configuring-the-heuristic-in-sabre-and-using-serverless}
...
### Ergebnisse ohne Serverless-Runtime (1 Layout-Versuch): {#results-without-serverless-runtime-1-layout-trial}
...
### Ergebnisse met Serverless-Runtime (mehrere Layout-Versuche) {#results-with-serverless-runtime-multiple-layout-trials}
