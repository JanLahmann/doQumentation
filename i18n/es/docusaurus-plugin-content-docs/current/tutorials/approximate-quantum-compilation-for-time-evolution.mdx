...
### Hamiltoniano del modelo y observable
...
#### Configurar el hamiltoniano y el observable
...
#### Determinar la porción de la evolución temporal a simular clásicamente
...
#### Generar un ansatz y parámetros iniciales a partir de un circuito Trotter con menos pasos
...
#### Elegir la configuración para la simulación de redes de tensores
...
#### Optimizar los parámetros del ansatz utilizando cálculos MPS
