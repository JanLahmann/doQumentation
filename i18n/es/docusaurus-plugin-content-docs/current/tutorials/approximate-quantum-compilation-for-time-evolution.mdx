...
Esta sección utiliza un sistema de 10 sitios para ilustrar el flujo de trabajo de AQC-Tensor paso a paso. Simulamos la dinámica de una cadena de espín XXZ de 10 sitios, un modelo ampliamente estudiado para examinar interacciones de espín y propiedades magnéticas.
