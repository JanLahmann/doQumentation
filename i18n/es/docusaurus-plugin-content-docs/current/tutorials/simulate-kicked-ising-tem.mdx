...
También se pueden pasar opciones personalizadas para el aprendiz de ruido. Siguen las definiciones utilizadas en el `qiskit-ibm-runtime` [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options):
