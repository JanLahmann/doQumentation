...
Si tienes la certeza de que todos los ángulos RZZ se encuentran dentro del rango válido, puede seguir el flujo de trabajo estándar de patrones de Qiskit.
...
Sin embargo, si utilizas únicamente las puertas RX fraccionarias y excluye las puertas RZZ fraccionarias, puede continuar siguiendo el flujo de trabajo estándar de patrones de Qiskit.
