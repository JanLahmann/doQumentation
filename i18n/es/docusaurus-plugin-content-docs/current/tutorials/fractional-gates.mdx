...
Ten en cuenta que este flujo de trabajo tiene un costo computacional mayor que el primer enfoque, ya que implica asignar valores de parámetros a los circuitos cuánticos y almacenar los circuitos con parámetros asignados localmente.
Además, existe un problema conocido en Qiskit donde la transformación de puertas RZZ puede fallar en ciertos escenarios. Para una solución alternativa, consulta la sección de [Solución de problemas](#troubleshooting).
...
Aunque Qiskit proporciona un `zz_feature_map` incorporado, actualmente no admite puertas RZZ a partir de Qiskit v2.0.2 ([consulta el issue](https://github.com/Qiskit/qiskit/issues/14469)).
...
Necesitarás instalar el [paquete](https://github.com/Qiskit/qiskit-basis-constructor) `qiskit-basis-constructor` para esta sección.
...
Consulta [este issue](https://github.com/Qiskit/qiskit/issues/14318) para más detalles.
...
Si encuentra este problema, consulta este [issue de GitHub](https://github.com/Qiskit/qiskit-ibm-runtime/issues/2256#issuecomment-2889487152) para una solución alternativa.
## Encuesta del tutorial {#tutorial-survey}

Por favor, responde esta breve encuesta para proporcionar comentarios sobre este tutorial. Tus opiniones nos ayudarán a mejorar nuestras ofertas de contenido y la experiencia del usuario.

[Enlaza a la encuesta](https://your.feedback.ibm.com/jfe/form/SV_cCNiGkGX5xZMzoG)
