...
En la figura, las líneas y áreas grises delimitan los límites; las líneas más externas (de puntos y rayas) delimitan los límites cuánticos ($\pm 2\sqrt{2}$), mientras que las líneas internas (discontinuas) delimitan los límites clásicos ($\pm 2$). Puede ver que hay regiones donde las cantidades testigo CHSH exceden los límites clásicos. ¡Felicitaciones! ¡Ha demostrado exitosamente la violación de la desigualdad CHSH en un sistema cuántico real!
