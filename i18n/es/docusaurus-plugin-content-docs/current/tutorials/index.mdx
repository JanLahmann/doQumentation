---
description: 'Explora los tutoriales de IBM Quantum — ejecutables en RasQberry, a través de Binder o en su propio servidor Jupyter.'
...
Utiliza estos tutoriales para aprender cómo aplicar Qiskit a casos de uso comunes de computación cuántica.

- Comienza con el conjunto de tutoriales en la sección [Primeros pasos](#get-started) si es la primera vez que ejecutas código en una computadora cuántica.
...
## Explora flujos de trabajo hacia la ventaja cuántica {#explore-workflows-toward-advantage}

Los tutoriales de esta sección cubren demostraciones a gran escala de algoritmos cuánticos.

<Accordion>
<AccordionItem title="**Algoritmos de muestreo verificable**">
...
* [Warm-start QAOA con el addon de Qiskit Optimization Mapper](/tutorials/warm-start-qaoa)


* [Codificación de correlación de Pauli para reducir los requisitos de max-cut](/tutorials/pauli-correlation-encoding-for-qaoa)
...
<AccordionItem title="**Estimación de observables**">
...
* [Simula la dispersión de neutrones en materiales cuánticos con circuitos cuánticos](/tutorials/simulate-neutron-scattering)


* [Simula la dispersión de neutrones con un flujo de trabajo Serverless de dinámica AQC + Trotter](/tutorials/simulate-neutron-scattering-with-a-serverless-workflow)
...
* [Observación de dinámica de hadrones no abeliana robusta y coherente en procesadores cuánticos con ruido](/tutorials/loop-string-hadron-dynamics)


</AccordionItem>

<AccordionItem title="**Algoritmos tolerantes a fallos**">
...
## Aprovecha las capacidades de Qiskit {#leverage-qiskit-capabilities}
...
<Accordion>
<AccordionItem title="**Optimización de cargas de trabajo**">
...
* [Kernels cuánticos con puertas fraccionarias](/tutorials/fractional-gates)


* [Introducción a la transpilación con IA de Qiskit](/tutorials/ai-transpiler-introduction)


* [Optimización de transpilación con SABRE](/tutorials/transpilation-optimizations-with-sabre)
...
<AccordionItem title="**Funciones de Qiskit**">
...
- Diseña nuevos algoritmos con **Funciones de circuito** &mdash; con pipelines preconstruidos de transpilación, supresión de errores y mitigación de errores.
  ...
  * [Simula Ising 2D con campo inclinado con la función QESEM](/tutorials/qedma-2d-ising-with-qesem)


  * [Simula un modelo de Ising pulsado con la función TEM](/tutorials/simulate-kicked-ising-tem)


  * [Evalúa la fidelidad de proceso de QFT+M con Orbit, una Qiskit Function de Quantum Elements](/tutorials/quantum-elements-orbit-qft-with-dynamic-circuits)


- Experimenta con problemas específicos de dominio con **Funciones de aplicación** &mdash; con entradas y salidas familiares para solucionadores clásicos.


  * [Optimización dinámica de cartera con el Optimizador de Cartera de Global Data Quantum](/tutorials/global-data-quantum-optimizer)
  ...
  * [Resuelve el problema de división de mercado con el optimizador cuántico Iskay de Kipu Quantum](/tutorials/solve-market-split-problem-with-iskay-quantum-optimizer)


</AccordionItem>

<AccordionItem title="**Complementos de Qiskit**">
...
<AccordionItem title="**Mitigación de errores**">
...
* [Combina opciones de mitigación de errores con la primitiva Estimator](/tutorials/combine-error-mitigation-techniques)


* [Cancelación probabilística de errores con conos de luz sombreados](/tutorials/pec-with-shaded-lightcones)

  
* [Mejora los valores esperados con absorción de ruido propagado (PNA)](/tutorials/propagated-noise-absorption)


* [Evaluación comparativa en tiempo real para la selección de qubits](/tutorials/real-time-benchmarking-for-qubit-selection)


* [Actualiza las propiedades del backend con evaluación comparativa en tiempo real](/tutorials/refresh-backend-properties-with-real-time-benchmarking)


</AccordionItem>

<AccordionItem title="**Detección de errores**">
...
* [Detección de errores de baja sobrecarga con códigos de espacio-tiempo](/tutorials/spacetime-codes)
