...
También necesitarás obtener acceso a la función Optimization Solver. [Complete el formulario](https://quantum.cloud.ibm.com/functions?id=q-ctrl-optimization-solver) para solicitar acceso.
## Configuración {#setup}
...
Verifica que el dispositivo elegido ten al menos 156 qubits.
