...
Genera 20 semillas diferentes para representar 20 pruebas de disposición diferentes.
...
Obtén los resultados del entorno de ejecución serverless y compare los resultados de las heurísticas lookahead y decay. Compararemos los tamaños y las profundidades.
...
[Enlaza a la encuesta](https://your.feedback.ibm.com/jfe/form/SV_d9YWUSQIAvU9HXE)
