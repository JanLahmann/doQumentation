...
## Parte 2: Circuito de simulación hamiltoniana {#part-2-hamiltonian-simulation-circuit}

### Paso 1: Investigar circuitos con `PauliEvolutionGate` {#step-1-investigate-circuits-with-paulievolutiongate}
...
#### Hamiltonianos utilizados en la comparación {#hamiltonians-used-in-the-benchmark}
...
Los circuitos utilizados en esta comparación provienen del [repositorio de comparación Hamlib](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation), que contiene cargas de trabajo realistas de simulación hamiltoniana.
...
#### Análisis de los resultados de compilación de circuitos hamiltonianos {#analysis-of-hamiltonian-circuit-compilation-results}
