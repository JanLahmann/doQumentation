...
- Cómo usar el [complemento SQD de Qiskit](https://docs.quantum.ibm.com/addons/qiskit-addon-sqd) para aproximar la energía del estado fundamental de un sistema molecular usando cadenas de bits muestreadas desde una unidad de procesamiento cuántico (QPU).
...
En este tutorial, mostramos cómo post-procesar muestras cuánticas ruidosas para aproximar el estado fundamental de la molécula de nitrógeno $\text{N}_2$ en la longitud de enlace de equilibrio, usando el [complemento SQD de Qiskit](https://github.com/Qiskit/qiskit-addon-sqd) para implementar el [algoritmo de diagonalización cuántica basada en muestras (SQD)](https://arxiv.org/abs/2405.05068). Más detalles sobre el software se pueden encontrar en la [documentación](https://docs.quantum.ibm.com/addons/qiskit-addon-sqd) correspondiente, incluyendo un [ejemplo sencillo](https://docs.quantum.ibm.com/addons/qiskit-addon-sqd/guides/quickstart) para comenzar.
...
Como solo tenemos un circuito, usaremos el [modo de ejecución de trabajos](/guides/execution-modes) de IBM Quantum Compute Service y ejecutaremos nuestro circuito.
...
- [Escalar flujos de trabajo de química SQD con el solver Dice](https://docs.quantum.ibm.com/addons/qiskit-addon-sqd/guides/integrate-dice-solver) - una página que muestra cómo usar el software Dice más eficiente para la diagonalización
- [Documentación de la API del complemento SQD](https://docs.quantum.ibm.com/api/qiskit-addon-sqd/fermion#diagonalize_fermionic_hamiltonian) - referencia de la función `diagonalize_fermionic_hamiltonian`
