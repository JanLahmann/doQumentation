...
*Estimación de uso: 40 segundos en un procesador Heron r2. (NOTA: Esto es solo una estimación. Tu tiempo de ejecución puede variar.)*
...
## Configuración {#setup}
Primero, autentícate utilizando tu [clave de API de IBM Quantum](http://quantum.cloud.ibm.com/). Luego, selecciona la función de Qiskit de la siguiente manera. (Este código asume que ya has [guardado tu cuenta](/guides/functions-get-started#install-qiskit-functions-catalog-client) en tu entorno local.)
