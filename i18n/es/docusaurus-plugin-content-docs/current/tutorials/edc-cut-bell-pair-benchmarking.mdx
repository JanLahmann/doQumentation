...
* Conocimientos básicos del [SDK de Qiskit](https://docs.quantum.ibm.com/guides) y [Qiskit Runtime](/guides/compute-services#qiskit-runtime), y acceso a una [cuenta de IBM Quantum&reg;](/guides/cloud-setup).
...
Antes de ejecutar en la QPU real, verificamos que el circuito produce un par de Bell probándolo en un simulador sin ruido con una cadena de cuatro qubits `[0, 1, 2, 3]`. Usamos el `Sampler` de Qiskit Runtime con `AerSimulator` como modo del backend para ejecutar los circuitos.
