...
*Estimación de uso: 20 minutos de tiempo de QPU para cada trabajo en un procesador Eagle r3. (NOTA: Esto es solo una estimación. Tu tiempo de ejecución puede variar.)*
...
- Opciones del optimizador: simulador versus QPU, repeticiones, optimizador clásico y sus opciones, profundidad de transpilación, y configuraciones del Sampler o Estimator de IBM Quantum
...
Con Qiskit Serverless, puedes ejecutar flujos de trabajo híbridos cuántico-clásicos en la infraestructura de nube gestionada por IBM sin preocuparte por la gestión de recursos.
Necesitarás una clave API de IBM Quantum Platform y el nombre de tu recurso en la nube (CRN) para autenticarte y acceder a las funciones Qiskit.
...
### Conéctate a IBM Quantum y carga la función Singularity {#connect-to-ibm-quantum-and-load-the-singularity-function}
...
### Aumenta el número de aprendices {#increase-the-number-of-learners}
...
## Paso 4: Post-procesa y devuelve el resultado en el formato clásico deseado {#step-4-post-process-and-return-result-in-desired-classical-format}
...
- Emplea **α-regularización adaptativa** para mantener la dispersión y la generalización sin aumentar el ancho del circuito.
...
### Evalúa las métricas para cada configuración {#evaluate-metrics-for-each-configuration}
...
Por favor, tómate un minuto para proporcionar retroalimentación sobre este tutorial. Tus comentarios nos ayudarán a mejorar nuestras ofertas de contenido y la experiencia del usuario.
