...
# Realiza la optimización dinámica de portafolios con el Optimizador de Portafolios de Global Data Quantum {#perform-dynamic-portfolio-optimization-with-global-data-quantums-portfolio-optimizer}
...
## Configuración {#setup}
Para utilizar el Optimizador Cuántico de Portafolios, selecciona la función a través del Catálogo de Funciones de Qiskit. Necesita una cuenta del Plan Premium o Plan Flex de IBM Quantum con una licencia de Global Data Quantum para ejecutar esta función.

Primero, autentíquese con su [clave de API.](https://quantum.cloud.ibm.com) Luego, carga la función deseada desde el Catálogo de Funciones de Qiskit. Aquí, accedes a la función `quantum_portfolio_optimizer` del catálogo utilizando la clase `QiskitFunctionsCatalog`. Esta función nos permite utilizar el solucionador predefinido de Optimización Cuántica de Portafolios.
