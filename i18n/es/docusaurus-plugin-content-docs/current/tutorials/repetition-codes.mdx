...
Para más información sobre QEC, consulta [Quantum Error Correction for Beginners.](https://arxiv.org/abs/0905.2794)
...
Ejecuta la versión con corrección aplicada y una sin corrección.
...
Puedes ver que el código de bit-flip detectó y corrigió muchos errores, resultando en menos errores en general.
...
Por favor, responde esta breve encuesta para proporcionar comentarios sobre este tutorial. Tus opiniones nos ayudarán a mejorar nuestras ofertas de contenido y experiencia de usuario.
