...
Defina las geometrías de $Li_2S$ en formato de diccionario para diferentes distancias de enlace Li-S con el fin de calcular la curva PES. Estas geometrías están optimizadas mediante cálculos B3LYP/631g.
