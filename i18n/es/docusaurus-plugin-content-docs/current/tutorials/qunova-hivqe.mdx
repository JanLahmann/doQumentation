...
Puede observar que todos los cálculos de HiVQE coinciden adecuadamente con el resultado de referencia clásico (CASCI).
...
Rastree el trabajo y recupere el resultado del cálculo de d(Fe-N) = 1.75 $\AA$.
...
Rastree el trabajo y recupere el resultado del cálculo de d(Fe-N) = 2.00 $\AA$.
...
Rastree el trabajo y recupere el resultado del cálculo de d(Fe-N) = 5.00 $\AA$.
