...
Selecciona un estado de referencia $\vert \psi \rangle$ que tenga cierta superposición con el estado fundamental. Para este Hamiltoniano, utilizamos un estado con una excitación en el qubit central $\vert 00..010...00 \rangle$ como nuestro estado de referencia.
...
### Calcular las matrices del Hamiltoniano efectivo y de superposición {#calculate-effective-hamiltonian-and-overlap-matrices}
