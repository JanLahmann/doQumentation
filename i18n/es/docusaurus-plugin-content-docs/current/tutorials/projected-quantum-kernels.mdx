...
Este tutorial también asume familiaridad general con los métodos de QML. Para una exploración más profunda del QML, consulte el curso [Quantum machine learning](/learning/courses/quantum-machine-learning) en IBM Quantum Learning.
...
Luego ejecutamos el circuito cuántico y medimos las proyecciones. Tenga en cuenta que activamos la mitigación de errores, incluyendo la Extrapolación de Ruido Cero (ZNE, por sus siglas en inglés).
...
También proporcionamos los resultados de un experimento que ejecutamos en hardware cuántico. Puede ejecutar el entrenamiento usted mismo estableciendo la bandera a continuación en `True`, o utilizar los resultados de proyección que proporcionamos.
