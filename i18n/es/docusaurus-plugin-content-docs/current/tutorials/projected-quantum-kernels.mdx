...
Este tutorial también asume familiaridad general con los métodos de QML. Para una exploración más profunda del QML, consulta el curso [Quantum machine learning](/learning/courses/quantum-machine-learning) en IBM Quantum Learning.
...
Los principales bloques de construcción de los núcleos cuánticos proyectados son las matrices de densidad reducidas (RDM), que se obtienen mediante mediciones proyectivas del mapa de características cuántico. En este paso, obtenemos todas las matrices de densidad reducidas de un solo cúbit (1-RDM), que posteriormente se proporcionarán a la función de núcleo exponencial clásica.
