...
Otra opción de incorporación cuántica es el ansatz de evolución del Hamiltoniano de Heisenberg unidimensional. Puede omitir la ejecución de esta sección si desea continuar con el `ZZFeatureMap`.
...
También proporcionamos los resultados de un experimento que ejecutamos en hardware cuántico. Puede ejecutar el entrenamiento tú mismo estableciendo la bandera a continuación en `True`, o utilizar los resultados de proyección que proporcionamos.
