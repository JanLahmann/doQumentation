...
* **extrapolated\_noise\_factors**: Especifique uno o más valores de factor de ruido en los cuales evaluar los
...
Si este trabajo le ha parecido interesante, es posible que le interese el siguiente material:
