...
## Configuración {#setup}
Primero, autentíquese utilizando su [clave API de IBM Quantum](http://quantum.cloud.ibm.com/). Luego, seleccione la función de Qiskit de la siguiente manera. (Este código asume que ya ha [guardado su cuenta](/guides/functions#install-qiskit-functions-catalog-client) en su entorno local.)
...
[Enlaza a la encuesta](https://your.feedback.ibm.com/jfe/form/SV_3BLFkNVEuh0QBWm)
