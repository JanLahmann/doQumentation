...
## Configuración {#setup}
Primero, autentíquese utilizando su [clave API de IBM Quantum](http://quantum.cloud.ibm.com/). Luego, selecciona la función de Qiskit de la siguiente manera. (Este código asume que ya has [guardado tu cuenta](/guides/functions#install-qiskit-functions-catalog-client) en tu entorno local.)
