...
Este tutorial explora las opciones de supresión y mitigación de errores disponibles con la primitiva Estimator de Qiskit Runtime. Este tutorial muestra cómo implementar cada uno de los siguientes métodos de forma individual:
...
Aquí enviarás cinco trabajos separados, comenzando sin supresión ni mitigación de errores, y habilitando sucesivamente varias opciones de supresión y mitigación de errores disponibles en Qiskit Runtime. Para información sobre las opciones, consulta las siguientes páginas:
...
Dado que estos trabajos pueden ejecutarse independientemente unos de otros, puedes usar el [modo batch](/guides/run-jobs-batch) para permitir que Qiskit Runtime optimice el momento de su ejecución.
