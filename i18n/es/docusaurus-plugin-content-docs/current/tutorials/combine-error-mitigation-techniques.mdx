...
description: "Combine opciones de mitigación de errores para experimentos a escala de utilidad usando QPUs de IBM Quantum de más de 100 qubits y la primitiva Estimator de Qiskit Runtime."
...
Cuando compare los resultados de 50 qubits con los resultados de 10 qubits anteriores, podría notar lo siguiente (sus resultados podrían diferir entre ejecuciones):
...
En esta guía, usted investigó diferentes opciones de mitigación de errores disponibles para la primitiva Estimator de Qiskit Runtime. Desarrolló un flujo de trabajo utilizando un circuito de 10 qubits y luego lo escaló a 50 qubits. Podría haber observado que habilitar más opciones de supresión y mitigación de errores no siempre mejora el rendimiento (específicamente, habilitar el desacoplamiento dinámico en este caso). La mayoría de las opciones aceptan configuraciones adicionales, que puede probar en su propio trabajo.