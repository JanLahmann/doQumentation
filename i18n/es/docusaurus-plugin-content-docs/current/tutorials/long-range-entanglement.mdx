...
* Conocimiento básico del [SDK de Qiskit](https://docs.quantum.ibm.com/guides) y [Qiskit Runtime](/guides/compute-services#qiskit-runtime), y acceso a una [cuenta de IBM Quantum&reg;](/guides/cloud-setup).
...
Antes de ejecutar en el QPU real, verificamos que tanto los circuitos dinámicos como los unitarios produzcan un estado de Bell ideal en un simulador sin ruido. Usamos el `Sampler` de Qiskit Runtime con `AerSimulator` como modo de backend, con una distancia pequeña de 6.
