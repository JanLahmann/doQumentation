...
**Omita esta celda** si ha guardado credenciales en [Configuración](/jupyter-settings#ibm-quantum) o activado el Modo Simulador: se inyectan automáticamente cuando hace clic en Run. Ejecutar esta celda con valores de marcador de posición sobrescribirá su configuración.

En otras plataformas, ejecute esto primero para guardar las credenciales para la sesión:
