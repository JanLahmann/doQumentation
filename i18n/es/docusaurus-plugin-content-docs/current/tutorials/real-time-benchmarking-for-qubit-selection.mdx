...
description: "Ejecute experimentos de caracterización en tiempo real y actualice las propiedades del backend para mejorar la selección de qubits al mapear un circuito a los qubits físicos en una QPU."
...
Este tutorial muestra cómo ejecutar experimentos de caracterización en tiempo real y actualizar las propiedades del backend para mejorar la selección de qubits al mapear un circuito a los qubits físicos en una QPU. Usted aprenderá los experimentos básicos de caracterización que se utilizan para determinar las propiedades de la QPU, cómo realizarlos en Qiskit y cómo actualizar las propiedades guardadas en el objeto backend que representa la QPU en función de estos experimentos.
...
Luego obtenga su mapa de acoplamiento
...
Puede observar que a lo largo de varios días algunas de las propiedades de los qubits pueden cambiar considerablemente. Esto resalta la importancia de tener información actualizada del estado de la QPU, para poder seleccionar los qubits con mejor rendimiento para un experimento.
...
Tenga en cuenta que algunos de los experimentos de caracterización pueden fallar cuando la rutina de ajuste no puede ajustar una curva a los datos medidos. Si observa advertencias provenientes de estos experimentos, inspecciónelas para comprender qué caracterización falló en qué qubits, e intente ajustar los parámetros del experimento (como los tiempos para $T_1$, $T_2$, o las longitudes de los experimentos de RB).
</Admonition>
...
Intente aplicar este método a sus ejecuciones y determine cuánto beneficio obtiene. También puede intentar ver cuánta mejora obtiene con diferentes backends.
</Admonition>
...
[Enlace a la encuesta](https://your.feedback.ibm.com/jfe/form/SV_0w6FZ9QrWkKfTQq)
