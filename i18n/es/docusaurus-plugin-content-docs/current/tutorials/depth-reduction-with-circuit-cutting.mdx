---
description: 'Construye un patrón de Qiskit para cortar gates en un circuito cuántico y reducir la profundidad del circuito.'
...
> **Nota:** Esta encuesta es de **IBM Quantum** y cubre el **contenido del tutorial** (escrito por IBM). doQumentation proporciona el sitio web, las traducciones y la ejecución de código — para comentarios sobre esos aspectos, por favor [abre un issue en GitHub](https://github.com/JanLahmann/doQumentation/issues).
