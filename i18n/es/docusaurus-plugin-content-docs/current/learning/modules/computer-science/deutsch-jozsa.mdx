...
Esta es la función oráculo, que puede ser balanceada o constante. ¿Puedes ver, mirando el Circuit, si la salida del último Qubit depende de los valores introducidos en los primeros $n$ qubits? Si la salida del último Qubit depende de los primeros $n$ qubits, ¿puedes determinar si esa salida dependiente es balanceada o no?
