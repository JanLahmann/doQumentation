...
---
{/* doqumentation-source-hash: 63ceb912 */}
...
### Compruebe su comprensión {#check-your-understanding}
...
Hay código a continuación para guardar sus credenciales en el primer uso. Asegúrese de eliminar esta información del notebook después de guardarla en su entorno, para que sus credenciales no se compartan accidentalmente cuando comparta el notebook. Consulta [Configura tu cuenta de IBM Cloud](/guides/initialize-account) y [Inicializa el servicio en un entorno no confiable](/guides/cloud-setup-untrusted) para más orientación.
