...
Aquí, demostramos cómo construir oráculos de Grover y usar el `GroverOperator` de la biblioteca de circuitos de Qiskit para configurar fácilmente una instancia de búsqueda de Grover. La primitiva `Sampler` de IBM Quantum permite la ejecución sin problemas de circuitos de Grover.
...
Queremos hacer muchas mediciones y ver qué estado es el más probable. Tal amplificación de amplitud es un problema de muestreo que es adecuado para ejecución con la primitiva `Sampler` de IBM Quantum.

Nota que el método `run()` de IBM Quantum SamplerV2 toma un iterable de bloques unificados primitivos (PUBs). Para Sampler, cada PUB es un iterable en el formato (circuit, parameter_values). Sin embargo, como mínimo, toma una lista de circuitos cuánticos.
...
### Paso 2: Optimizar el problema para ejecución en hardware cuántico {#step-2-optimize-problem-for-quantum-hardware-execution-1}
...
### Paso 3: Ejecutar usando primitivas de IBM Quantum {#step-3-execute-using-ibm-quantum-primitives-1}
...
### Paso 4: Post-procesar y devolver resultado en formato clásico deseado {#step-4-post-process-and-return-result-in-desired-classical-format-1}
...
<Accordion>
<AccordionItem title="Sugerencias">
...
<Accordion>
<AccordionItem title="Orientación">
...
### Paso 2: Optimizar el problema para ejecución en hardware cuántico {#step-2-optimize-problem-for-quantum-hardware-execution-2}
...
### Paso 3: Ejecutar usando primitivas de IBM Quantum {#step-3-execute-using-ibm-quantum-primitives-2}
...
### Paso 4: Post-procesar y devolver resultado en formato clásico deseado {#step-4-post-process-and-return-result-in-desired-classical-format-2}
