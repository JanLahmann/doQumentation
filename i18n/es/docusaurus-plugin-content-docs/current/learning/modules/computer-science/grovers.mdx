...
## Advertencia obvia {#obvious-caveat}
...
## Ejecutar usando primitivas Qiskit {#execute-using-qiskit-primitives}
...
## Actividad 3: Criterio distinto a una cadena de bits específica {#activity-3-criterion-other-than-a-specific-bitstring}
...
![Salida de la celda de código anterior](/learning/images/modules/computer-science/grovers/extracted-outputs/5f5e4675-1.avif)
...
![Salida de la celda de código anterior](/learning/images/modules/computer-science/grovers/extracted-outputs/cf8b6be8-0.avif)
