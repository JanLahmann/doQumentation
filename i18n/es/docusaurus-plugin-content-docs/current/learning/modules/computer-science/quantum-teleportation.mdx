...
- Paso 3: Ejecuta tu trabajo en computadoras cuánticas de IBM usando primitivas de IBM Quantum
...
### Paso 1: Transforma tu problema en un circuito cuántico {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Paso 3: Ejecución {#step-3-execute-1}
...
2. ¿Hay algo único sobre el estado entrelazado inicial entre Alice y Bob: $\frac{1}{\sqrt{2}}\left(|0\rangle_B|0\rangle_A+|1\rangle_B|1\rangle_A\right)?$ Si es así, ¿qué tiene de único? Si no, ¿qué otros estados entrelazados podríamos haber usado?
