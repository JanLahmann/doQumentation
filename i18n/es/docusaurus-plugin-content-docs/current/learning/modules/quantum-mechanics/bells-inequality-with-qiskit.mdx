---
description: 'Aprende qué estadísticas de medición predicen las variables ocultas y la mecánica cuántica, y comprueba cuál es correcta usando una computadora cuántica real.'
...
# La naturaleza de los estados cuánticos: variables ocultas frente a la desigualdad de Bell {#the-nature-of-quantum-states-hidden-variables-versus-bells-inequality}
...
<IBMVideo id="134413665" title="Katie McCormick explora el teorema de Bell usando una computadora cuántica real. Aprende si la incertidumbre de la mecánica cuántica se debe a variables ocultas aún por descubrir, o a una naturaleza fundamentalmente probabilística."/>
...
Cuando el mesón se desintegra, un electrón sale disparado en una dirección y un positrón en la otra. Cada una de estas dos partículas viajará a través de un campo magnético inhomogéneo, lo que hará que se desvíe en la dirección del campo magnético o en la dirección opuesta.
...
Sería genial poder distinguir entre las opciones de Einstein y Born experimentalmente. ¿Cuáles son algunos experimentos que producirían los mismos resultados independientemente de cuál opción sea verdadera? ¿Puedes pensar en un experimento que produciría resultados diferentes para las dos opciones?
...
### Comprueba tu comprensión {#check-your-understanding-6}
...
2. V/F "Variables ocultas" se refiere a la idea de que dos partículas cuánticas pueden estar entrelazadas.

3. V/F Cualquier par de sistemas correlacionados están cuánticamente entrelazados.

4. V/F El entrelazamiento mecanocuántico es importante para que las matemáticas sean correctas, pero no se puede ver en un experimento.
...
4. ¿Podría explorarse la desigualdad de Bell solo con 3 ejes igualmente espaciados $a$, $b$ y $c$? ¿Podría hacerse con cualquier otro número de ejes? ¿Cómo se vería esto? ¿Seguiría produciendo una diferencia en las probabilidades predichas por variables ocultas frente a la mecánica cuántica probabilística?
