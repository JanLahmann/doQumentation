...
Ahora, ¿qué pasaría si le diéramos al turista más tiempo pero siguiéramos limitando el espacio a Nueva York? En otras palabras, ¿qué pasa si mantenemos el número de qubits igual pero reducimos la tasa de error? Entonces no habría beneficio para el turista, ya que este ya ha explorado la ciudad y simplemente estaría visitando los mismos lugares una y otra vez. El volumen turístico permanece igual. En cambio, con más tiempo, lo más inteligente sería que el turista ampliara el número de lugares a visitar.
