...
## 2. Fundamentos de la transformada cuántica de Fourier (QFT) {#2-basic-of-quantum-fourier-transformation-qft}
...
Demostraremos la QFT solo con simuladores y, por tanto, no utilizaremos el framework Qiskit Patterns hasta que pasemos a la estimación de fase cuántica.
...
## 3. Fundamentos de la estimación de fase cuántica (QPE) {#3-basics-of-quantum-phase-estimation-qpe}
...
#### Solución del ejercicio: $\theta = 1/3$ {#solution-of-the-exercise-theta-13}
...
## 4. Ejecución con la primitiva Sampler de IBM Quantum {#4-execution-using-the-ibm-quantum-sampler-primitive}
