...
Ahora que entendemos las estructuras de datos, podemos calcular los errores medianos para las puertas 'sx' y 'ecr'. Compara nuevamente los resultados con los del dispositivo en la [Plataforma IBM Quantum](https://quantum.cloud.ibm.com/).
