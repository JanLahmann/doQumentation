...
#### Definición del Hamiltoniano {#define-the-hamiltonian-1}
...
Aquí construimos un circuito para un solo paso de tiempo usando Lie–Trotter.
Exactamente como en el caso de 20 qubits, la fórmula de producto de Lie (primer orden) está implementada en la clase [LieTrotter](https://docs.quantum.ibm.com/api/qiskit/qiskit.synthesis.LieTrotter). De nuevo, la fórmula de primer orden consiste en la aproximación indicada anteriormente:
...
#### Definición de los operadores a medir {#set-the-operators-to-be-measured-1}
...
#### Ejecución de la simulación de evolución temporal {#perform-time-evolution-simulation-1}
