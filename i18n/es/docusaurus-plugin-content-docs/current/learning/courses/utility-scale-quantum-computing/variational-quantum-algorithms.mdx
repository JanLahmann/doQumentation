...
### 3.4 Paso 3. Ejecutar con primitivas de IBM Quantum {#34-step-3-execute-using-ibm-quantum-primitives}
...
Usa las **primitivas de IBM Quantum** para interactuar con los backends de IBM&reg;. Las dos primitivas son Sampler y Estimator, y la elección de la primitiva depende del tipo de medición que quieras realizar en la computadora cuántica. Para la minimización de $H_C$, usa el Estimator, ya que la medición de la función de costo es simplemente el valor esperado de $\langle H_C \rangle$.
