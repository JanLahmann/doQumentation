...
Puedes configurar las opciones de supresión de errores en Sampler V2. Consulta la guía [Gestión de ruido del Sampler](/guides/sampler-noise-management) y la referencia de la API [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) para más información.
