...
1. Cada $P_a$ es obviamente positiva semidefinida, ya que es un estado puro dividido por dos.
   Es decir, cada $P_a$ es una matriz hermítica con un valor propio $1/2$ y todos los demás valores propios iguales a cero.
...
Una forma simple de expresar que una matriz de densidad dada $\sigma$ es diagonal es$:\sigma = \Delta_m(\sigma)$.
