...
# Diagonalización cuántica de Krylov basada en muestreo (SKQD) {#sample-based-krylov-quantum-diagonalization-skqd}
...
<Accordion>
<AccordionItem title="What could be done to improve the convergence in the plot above?">
...
¿Cuáles son las principales ventajas de SKQD frente a (a) SQD y (b) KQD?
   ...
   (a) SKQD viene con garantías de convergencia que SQD no tiene. En SQD necesitas hacer una muy buena estimación para tu ansatz que tenga una excelente superposición con el soporte del estado base en la base computacional, o necesitas introducir un componente variacional en el cálculo para muestrear una familia de ansätze.
