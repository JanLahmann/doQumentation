...
description: "Se describe la diagonalización cuántica de Krylov (KQD), partiendo de los métodos clásicos de Krylov. Se analizan la convergencia y la intensidad de recursos."
...
Supongamos que un colega investigador está demostrando el método de Krylov aplicado a una pequeña matriz de juguete. ¿Hay algo incorrecto en su elección de la matriz $A$ y el vector inicial $|\psi\rangle$?
$$
...
![Un vector propio real etiquetado como x, una estimación etiquetada como x 0 y una representación gráfica del error entre los dos.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig2.svg)
...
![Un vector propio real y una actualización de la estimación inicial. La estimación actualizada está más cerca del vector propio real.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig3.svg)
