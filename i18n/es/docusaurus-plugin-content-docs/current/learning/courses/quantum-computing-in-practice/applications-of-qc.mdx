...
1.	Simulaciones de la naturaleza. Los métodos clásicos actuales de simulaciones atómicas y moleculares están limitados por descripciones matemáticas ineficientes de la estructura atómica. Almacenar y manipular un estado cuántico requiere exponencialmente muchos recursos en una computadora clásica, pero puede hacerse de manera eficiente en una computadora cuántica. Esto podría llevar a desarrollos en la captura de dióxido de carbono, baterías alternativas o la invención de nuevos fármacos. Algunos algoritmos que son especialmente relevantes en esta área son: el Variational Quantum Eigensolver (VQE), que se usa para estimar ciertas propiedades de un material, como estados de equilibrio o de energía mínima; el algoritmo de Simulación de Dinámica Temporal (TDS), que se usa para estimar funciones de respuesta o propiedades espectrales de materiales; y un recién llegado, [Sample-based Quantum Diagonalization (SQD)](/learning/courses/quantum-diagonalization-algorithms/sqd-overview), del que creemos que oiremos hablar mucho más en un futuro cercano.


2.	Optimización. Esta área es ubicua en la computación, por lo que los casos de uso son numerosos y variados. Algunos ejemplos de los que oímos hablar mucho son la optimización de carteras en finanzas, el diseño industrial y la distribución y cadena de suministro. El algoritmo más común que probablemente escucharás relacionado con las finanzas es el que ya hemos cubierto con cierta profundidad: el algoritmo de optimización aproximada cuántica, o QAOA.


3.	Aprendizaje automático cuántico. Esta área ha generado mucha emoción en los últimos años, pero es probable que QML no sea útil tan pronto como lo será la simulación. Sin embargo, existen algunos algoritmos impresionantes en los que se está trabajando para abordar algunos casos de uso muy importantes. Algunos de estos posibles casos de uso son el procesamiento del lenguaje natural, el análisis del tráfico de red e incluso la detección de fraude en transacciones financieras. Los algoritmos relevantes en esta área son la máquina de vectores de soporte cuántica (QSVM), las redes neuronales cuánticas (QNN) y las redes generativas antagónicas cuánticas.
...
Pero recuerda: lo importante al trabajar con QPUs ruidosos es mantener la profundidad del circuito manejable. Para ello, el protocolo SC-ADAPT-VQE utiliza simetrías y jerarquías en escalas de longitud para determinar circuitos cuánticos de baja profundidad para la preparación de estados. Esto produce un ansatz con un número menor de parámetros y por lo tanto una menor profundidad.
...
Este experimento se realizó con el llamado Conditional Value at Risk Variational Quantum Eigensolver, que es una modificación de un algoritmo VQE tradicional y del que se espera lograr una mejor convergencia.
