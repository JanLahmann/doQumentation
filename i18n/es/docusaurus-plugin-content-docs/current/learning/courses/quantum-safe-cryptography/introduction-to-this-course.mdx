...
A lo largo del curso, los participantes aprenderán que incluso los datos actuales están en riesgo, ya que pueden ser recopilados ahora y descifrados más tarde. Se mostrará cómo nuestros algoritmos existentes pueden ser comprometidos y se presentarán técnicas innovadoras que abordan tales amenazas mediante un enfoque <DefinitionTooltip definition="Conjunto de principios y prácticas utilizados en el desarrollo de software y la gestión de proyectos. Enfatiza la flexibilidad, la colaboración, el desarrollo iterativo y la participación del cliente a lo largo del ciclo de vida del proyecto. El objetivo del enfoque ágil es responder rápidamente a los requisitos cambiantes, entregar mejoras incrementales y lograr una mejor alineación con las necesidades del cliente.">ágil</DefinitionTooltip>.
