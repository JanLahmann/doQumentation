...
Como se menciónó en la lección anterior, los valores de $\vec{\beta}$ deben ser mayores que la diferencia entre autovalores. Veamos qué ocurre cuando no se cumple esa condición con $\hat{O}_2$:
