...
# Circuitos cuánticos variacionales y redes neuronales cuánticas {#quantum-variational-circuits-and-quantum-neural-networks}
...
Aquí optimizamos el circuito para ejecutarlo en un backend real especificando el optimization_level y añadiendo desacoplamiento dinámico. El siguiente código genera un pass manager usando pass managers preestablecidos de qiskit.transpiler.
...
## Qiskit Patterns Paso 3: Ejecutar con primitivas de IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
## Paso 2 de Qiskit Patterns: Optimizar el problema para la ejecución cuántica {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution-1}
Comenzamos seleccionando un backend para la ejecución. En este caso, usaremos el backend menos ocupado.
...
## Qiskit Patterns Paso 3: Ejecutar con primitivas de IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
