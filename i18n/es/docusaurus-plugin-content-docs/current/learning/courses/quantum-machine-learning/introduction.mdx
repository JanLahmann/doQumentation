...
Incluso si un algoritmo no puede ser descuantizado, eso no significa que sea más eficiente o escalable que todos los algoritmos clásicos. Como un ejemplo extremo y artificial: imagina un algoritmo para seleccionar los j elementos más grandes de un conjunto de tamaño k. Uno podría escribir un algoritmo cuántico que use el algoritmo de Shor para factorizar cada uno de los k elementos en factores primos, y luego determinar los elementos más grandes usando los factores primos. Es probable que tal algoritmo no pueda descuantizarse, pero es drásticamente menos eficiente que los algoritmos clásicos para lograr la misma selección de elementos más grandes (aunque no la parte innecesaria de factorización).

## Prueba de existencia {#existence-proof}

En 2021, los investigadores de IBM Quantum&reg; Yunchao Liu, Srinivasan Arunachalam y Kristan Temme publicaron un artículo en Nature: [A rigorous and robust quantum speed-up in supervised machine learning.](https://www.nature.com/articles/s41567-021-01287-z) De manera consistente con las limitaciones anteriores, para este trabajo se selecciónó cuidadosamente un problema de clasificación que (1) es demostrablemente difícil clásicamente y (2) es adecuado para que los algoritmos cuánticos demuestren una ventaja de velocidad.
...
Falso. La mayoría de los problemas de aprendizaje automático son resueltos de manera muy eficiente por algoritmos clásicos, y es poco probable que los algoritmos cuánticos ofrezcan una mejora sustancial de velocidad. El objetivo en QML es encontrar conjuntos de datos con características que estén bien descritas por estados cuánticos y/o encontrar mapeos de características de datos que optimicen la precisión de los modelos.
...
5. Implementar métodos de kernel cuántico y clasificadores cuánticos variacionales usando primitivas de IBM Quantum y siguiendo patrones de Qiskit.
...
* Paso 3: Ejecutar con primitivas de IBM Quantum
