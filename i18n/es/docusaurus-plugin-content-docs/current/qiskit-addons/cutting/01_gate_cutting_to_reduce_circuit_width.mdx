...
![Diagrama del Circuit cuántico](/img/qiskit-addons/cutting/01-gate-cutting-to-reduce-circuit-width/output_1.png)
...
![Diagrama del Circuit cuántico](/img/qiskit-addons/cutting/01-gate-cutting-to-reduce-circuit-width/output_2.png)

```python
subcircuits["B"].draw("mpl", scale=0.8)
```

![Diagrama del Circuit cuántico](/img/qiskit-addons/cutting/01-gate-cutting-to-reduce-circuit-width/output_3.png)
