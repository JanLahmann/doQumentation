# Translation Feedback — es

**387 files** validated: 383 PASS, 4 FAIL

## Files needing fixes

### `guides/algorithmiq-tem.mdx` — FAIL

- **Paragraph inflation**: 4 inflated paragraph(s)
  - Line 55: 99 EN words → 346 TR words (ratio 3.5x, max 2.5x)
  - Line 62: 164 EN words → 893 TR words (ratio 5.4x, max 2.5x)
  - Line 69: 79 EN words → 535 TR words (ratio 6.8x, max 2.5x)
  - Line 191: 124 EN words → 532 TR words (ratio 4.3x, max 2.5x)

### `guides/choose-execution-mode.mdx` — FAIL

- **Paragraph inflation**: 1 inflated paragraph(s)
  - Line 71: 100 EN words → 269 TR words (ratio 2.7x, max 2.5x)

### `guides/circuit-transpilation-settings.mdx` — FAIL

- **Paragraph inflation**: 2 inflated paragraph(s)
  - Line 161: 40 EN words → 488 TR words (ratio 12.2x, max 2.5x)
  - Line 177: 43 EN words → 505 TR words (ratio 11.7x, max 2.5x)

### `guides/cloud-account-structure.mdx` — FAIL

- **Paragraph inflation**: 1 inflated paragraph(s)
  - Line 41: 48 EN words → 711 TR words (ratio 14.8x, max 2.5x)
