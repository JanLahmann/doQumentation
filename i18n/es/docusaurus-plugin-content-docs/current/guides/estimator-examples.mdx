---
title: "Ejemplos de Estimator"
sidebar_label: "Ejemplos de Estimator"
description: "Ejemplos prácticos de uso del primitivo Estimator en Qiskit Runtime."
...
Los ejemplos de esta sección ilustran algunas formas comunes de usar Estimator. Antes de ejecutar estos ejemplos, sigue las instrucciones en [Instalar Qiskit.](install-qiskit)
...
- Practica con los primitivos trabajando en la [lección de función de costo](/learning/courses/variational-algorithm-design/cost-functions) en IBM Quantum&reg; Learning.
