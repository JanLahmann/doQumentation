...
## Compatibilidad de prestaciones {#options-compatibility-table}

Ciertas prestaciones (características) de runtime no pueden usarse juntas en un solo trabajo. Haz clic en la pestaña correspondiente para ver una lista de prestaciones incompatibles con la prestación seleccionada:
...
<Tabs>
  ...
  Incompatible con gates fraccionales o con stretches.
