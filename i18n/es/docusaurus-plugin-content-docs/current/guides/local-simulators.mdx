---
description: 'Migra del uso de los simuladores en la nube de IBM Quantum a usar el modo de prueba local de `qiskit-ibm-runtime`.'
...
## Migrar a simuladores locales {#migrate-to-local-simulators-1}
