...
<summary>Desplegar manualmente los modelos de Qiskit Code Assistant en local mediante llama.cpp</summary>
...
- Ejecutar con Docker: Consulte la [documentación de Docker del equipo de `llama.cpp`](https://github.com/ggml-org/llama.cpp/blob/master/docs/docker.md)
- Descargar binarios precompilados de la [página de lanzamientos](https://github.com/ggml-org/llama.cpp/releases)
