---
description: 'Comprende el formato de entrada y salida (incluidos los Primitive Unified Blocs o PUBs) de las primitivas de Qiskit SDK'
...
Las siguientes listas de operadores, aunque equivalentes en cuanto a la información que contienen, tienen formas diferentes:
...
<Admonition type="tip" title="Recomendaciones">
  ...
  -  Revisa la API de las [primitivas de Qiskit SDK](https://docs.quantum.ibm.com/api/qiskit/primitives).

  -  Revisa la API de las [primitivas de Qiskit Aer](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html).

  -  Obtén más información sobre las [primitivas de IBM Quantum](/guides/qiskit-runtime-primitives).

  -  Revisa la API del [Estimator de `qiskit-ibm-runtime`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2).

  -  Revisa la API del [Sampler de `qiskit-ibm-runtime`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2).
</Admonition>
