...
![Esta imagen ilustra varias representaciones visuales del broadcasting de arreglos.](/docs/images/guides/primitive-input-output/broadcasting.avif "Representación visual del broadcasting")
