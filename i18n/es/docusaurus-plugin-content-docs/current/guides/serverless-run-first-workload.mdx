...
<Admonition type="tip">
**Qiskit Serverless está siendo actualizado y sus características están cambiando rápidamente.** Durante esta fase de desarrollo, encuentra las notas de la versión y la documentación más reciente en la página de [Qiskit Serverless en GitHub](https://qiskit.github.io/qiskit-serverless/index.html).
</Admonition>
...
Asegúrate de haber seguido el flujo de trabajo en [Escribe tu primer programa de Qiskit Serverless](/guides/serverless-first-program) antes de comenzar.

## Listar los programas disponibles {#list-programs-available}

Puedes usar `QiskitServerless.list()` para obtener una lista de los programas disponibles para ejecutar con Qiskit Serverless. Esto incluye el programa [`transpile_remote_serverless`](/guides/serverless-first-program) que subiste anteriormente.
...
- Explora las [herramientas de gestión de cómputo y datos](/guides/serverless-manage-resources) disponibles para tu programa, incluyendo la paralelización.
