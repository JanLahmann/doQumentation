---
description: 'Cómo configurar la gestión de ruido con el primitivo Estimator de IBM Quantum.'
...
## Nivel de resiliencia {#resilience-level}
...
## Configuración personalizada de gestión de ruido {#custom-noise-management-settings}
