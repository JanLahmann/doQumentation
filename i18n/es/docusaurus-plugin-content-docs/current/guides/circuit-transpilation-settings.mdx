...
Puedes confirmar esto calculando la [fidelidad de Hellinger (Hellinger fidelity)](https://docs.quantum.ibm.com/api/qiskit/quantum_info) entre cada conjunto de resultados y la distribución ideal (un valor más alto es mejor, y 1 indica fidelidad perfecta).
