...
sidebar_label: 'Construye y ejecuta una plantilla de Qiskit Function para simulación de química'
title: 'Construye y ejecuta una plantilla de Qiskit Function para simulación de química'
---
...
# Construye y ejecuta una plantilla de Qiskit Function para simulación de estructura electrónica con un modelo de solvente implícito {#build-and-run-a-qiskit-function-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
Para un recorrido paso a paso de este mismo flujo de trabajo con un ejemplo completo, consulta el tutorial [Cálculos de solvente implícito usando Qiskit Serverless](/tutorials/implicit-solvent-calculations).
...
<Accordion>
<AccordionItem title="Haz clic para expandir y ver más detalles sobre las opciones requeridas:">
...
<Accordion>
<AccordionItem title="Haz clic para expandir y ver más información sobre cómo configurar las opciones de SQD:">
...
## Citar este proyecto {#cite-this-project}

Si utilizas la plantilla SQD IEF-PCM en tu investigación, consulta el [repositorio](https://github.com/qiskit-community/qiskit-function-templates/tree/main/chemistry/sqd_pcm#citing-this-project) para obtener información detallada de citación.

## Próximos pasos {#next-steps}

<Admonition type="info" title="Recomendaciones">

- Sigue el tutorial [Cálculos de solvente implícito usando Qiskit Serverless](/tutorials/implicit-solvent-calculations) para ver un ejemplo práctico de este mismo flujo de trabajo

- Revisa la guía sobre cómo construir una plantilla de función para [simulación hamiltoniana](/guides/function-template-hamiltonian-simulation)
