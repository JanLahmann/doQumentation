...
![Imagen que ilustra el siguiente circuito](/docs/images/guides/stretch/stretch.svg)
...
:::note
 ...
 Al usar `stretch` con IBM Quantum Compute Service, cualquier resto resultante de una resolución de stretch se añade al primer delay que usa el stretch.
...
## Ver los valores de stretch en IBM Quantum Compute Service {#view-stretch-values-in-ibm-quantum-compute-service}

El valor real de una duración stretch se resuelve en tiempo de compilación, después de que el circuito haya sido planificado. Al ejecutar un trabajo Sampler en IBM Quantum Compute Service, puedes ver los valores de stretch resueltos en los metadatos del resultado del trabajo. El soporte de `stretch` en Quantum Compute es actualmente experimental, por lo que primero debes establecer una opción experimental para habilitarlo, y luego acceder a los datos directamente desde los metadatos de la siguiente manera:
...
Aunque el tiempo total del circuito se devuelve en los metadatos de "compilation", este NO es el tiempo usado para la facturación (QPU time).
</Admonition>
...
Para obtener más detalles, consulta el tema [Visualizar la temporización del circuito](/guides/qiskit-runtime-circuit-timing).

<span id="qiskit-runtime-limitations"></span>

## Limitaciones de Quantum Compute {#quantum-compute-limitations}

El soporte de `stretch` en Quantum Compute es actualmente experimental y tiene las siguientes restricciones:
...
- El área rodeada por un conjunto de barreras se denomina _región de barrera_. Una variable stretch no puede usarse en múltiples regiones de barrera.
    <Tabs>
        ...
        ![Ilustración de la salida del código anterior](/docs/images/guides/stretch/bad-barrier-region.svg 'Uso no válido de stretch en regiones de barrera')
     ...
     <TabItem value="Valid" label="Válido">
        ...
        ![Ilustración de la salida del código anterior](/docs/images/guides/stretch/good-barrier-region.svg 'Uso válido de stretch en una región de barrera')
