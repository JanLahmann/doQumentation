---
description: 'Ejemplos prácticos del uso de la primitiva Executor en qiskit-ibm-runtime.'
...
### Configurar el circuito {#set-up-the-circuit-1}
...
### Ejecutar los circuitos {#execute-the-circuits-1}
