...
### Habilitar TREX usando la opción `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### Habilitar TREX usando la opción `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### Habilitar ZNE usando la opción `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}
...
### Habilitar ZNE usando la opción `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- Explora otras [opciones](/guides/runtime-options-overview) para los primitivos de Qiskit Runtime.
