...
La forma más fácil de ver esta información es a través del método [`draw`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#draw), que devuelve una visualización de un circuito. Consulta [Visualizar circuitos](./visualize-circuits) para diferentes formas de mostrar circuitos cuánticos.
