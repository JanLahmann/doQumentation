...
### 1. Crear la función objetivo {#1-create-the-objective-function-1}
...
### 2. Ejecutar el Optimizer {#2-run-the-optimizer-1}
...
### 3. Obtener el resultado {#3-retrieve-the-result-1}
...
Iskay, al igual que el nombre de nuestra empresa Kipu Quantum, es una palabra peruana. Aunque somos una startup de Alemania, estas palabras provienen del país natal de uno de nuestros cofundadores, donde el Quipu fue una de las primeras máquinas de cálculo desarrolladas por la humanidad en el año 2000 a. C.
