---
description: 'Cómo usar el primitivo Executor en qiskit-ibm-runtime.'
...
Dado que IBM Quantum Compute Service es un servicio gestionado, primero debes inicializar tu cuenta. Luego puedes seleccionar la QPU que quieres usar para calcular el valor de expectación.
