...
El resultado de un trabajo `NoiseLearnerV3` contiene una lista de objetos [`NoiseLearnerV3Result`](https://qiskit.github.io/qiskit-ibm-runtime/stubs/qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3Result.html), uno por cada instrucción de entrada.
