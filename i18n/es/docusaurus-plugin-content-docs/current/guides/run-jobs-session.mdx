...
Los usuarios del Plan Abierto no pueden enviar trabajos de sesión. Los workloads deben ejecutarse en [modo de trabajo](/guides/execution-modes#job-mode) o [modo por lotes](/guides/execution-modes#batch-mode).
</Admonition>
...
Antes de iniciar una sesión, debes [configurar el cliente de IBM Quantum Compute](/guides/install-qiskit-runtime) e inicializarlo como servicio:
...
Este temporizador comienza cuando la sesión se inicia. Cuando se alcanza ese valor, la sesión se cierra. Los trabajos que estén en ejecución terminarán, pero los trabajos aún en cola fallarán.
...
Para obtener una visión general completa de la configuración y el estado de una sesión, usa el método `session.details() method`.
