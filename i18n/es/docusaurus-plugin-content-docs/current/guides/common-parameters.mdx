...
El backend simulado `FakeSherbrooke` de `qiskit_ibm_runtime` se usa en estos ejemplos, pero puedes probarlo con cualquier backend real o simulado compatible con Qiskit. Tus resultados pueden ser diferentes.
</Admonition>
