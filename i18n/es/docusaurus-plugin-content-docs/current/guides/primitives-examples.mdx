---
title: "Ejemplos de primitivas"
sidebar_label: "Ejemplos de primitivas"
description: "Ejemplos prácticos del uso de primitivas en Qiskit Runtime."
...
La versión beta de un nuevo modelo de ejecución ya está disponible. El modelo de ejecución dirigida ofrece mayor flexibilidad para personalizar tu flujo de mitigación de errores. Consulta la guía del [Modelo de ejecución dirigida](/guides/directed-execution-model) para más información.
</Admonition>
{/*
...
Los ejemplos de esta sección ilustran algunas formas comunes de usar primitivas. Antes de ejecutar estos ejemplos, sigue las instrucciones de [Instalar y configurar.](install-qiskit)

<Admonition type="note">
    Todos estos ejemplos usan las primitivas de Qiskit Runtime, aunque también podrías usar las primitivas base.
</Admonition>

## Ejemplos de Estimator {#estimator-examples}

Calcula e interpreta de manera eficiente los valores esperados de los operadores cuánticos requeridos por muchos algoritmos con Estimator. Explora sus usos en modelado molecular, aprendizaje automático y problemas de optimización complejos.
...
Usa Estimator para ejecutar tres experimentos en un único trabajo, aprovechando valores de parámetros para aumentar la reutilización de circuitos.
...
El siguiente bloque de código devolverá un error para los usuarios del Plan Abierto porque usa sesiones. Las cargas de trabajo del Plan Abierto solo pueden ejecutarse en [modo trabajo](/guides/execution-modes#job-mode) o en [modo por lotes](/guides/execution-modes#batch-mode).
</Admonition>
...
## Ejemplos de Sampler {#sampler-examples}

Genera distribuciones de cuasiprobabilidad con mitigación de errores completa, muestreadas a partir de las salidas de circuitos cuánticos. Aprovecha las capacidades de Sampler para algoritmos de búsqueda y clasificación como Grover y QVSM.

### Ejecutar un único experimento {#run-a-single-experiment-sampler}

Usa Sampler para devolver el resultado de la medición como cadenas de bits o conteos de un único circuito.
...
### Ejecutar múltiples experimentos en un único trabajo {#run-multiple-experiments-in-a-single-job-sampler}

Usa Sampler para devolver el resultado de la medición como cadenas de bits o conteos de múltiples circuitos en un único trabajo.
...
### Ejecutar circuitos parametrizados {#run-parameterized-circuits-sampler}

Ejecuta varios experimentos en un único trabajo, aprovechando valores de parámetros para aumentar la reutilización de circuitos.
...
<Admonition type="tip" title="Recomendaciones">
    - [Especifica opciones avanzadas de runtime.](runtime-options-overview)
    - Practica con primitivas siguiendo la [lección sobre funciones de coste](/learning/courses/variational-algorithm-design/cost-functions) en IBM Quantum Learning.
    ...
    - Conoce los [Límites de trabajos](/guides/job-limits) al enviar un trabajo a un QPU de IBM&reg;.
</Admonition>
