    ...
    <tr>
      ...
      <td>
        ...
        - Pasadas que rompen la unitariedad:
          ...
          * `RemoveDiagonalGatesBeforeMeasure`: elimina puertas antes de las mediciones que no afectarían a las mediciones
      </td>
    </tr>
  </tbody>
</table>
...
Como las puertas de dos qubits son típicamente la fuente de errores más significativa, podemos cuantificar aproximadamente la "eficiencia del hardware" de la transpilación contando el número de puertas de dos qubits en el circuito resultante.
...
Primero, transpilemos usando el nivel de optimización 0.
...
Repite para el nivel de optimización 1:
...
Repite para el nivel de optimización 2:
...
Repite de nuevo, con el nivel de optimización 3:
...
Ajustar el nivel de optimización también puede cambiar otros aspectos del circuito, no solo el número de puertas ECR. Para ver ejemplos de cómo el nivel de optimización afecta al layout, consulta [Representación de computadoras cuánticas](/guides/represent-quantum-computers).
