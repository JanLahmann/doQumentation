...
Ajustar el nivel de optimización también puede cambiar otros aspectos del circuito, no solo el número de puertas ECR. Para ver ejemplos de cómo establecer el nivel de optimización cambia el layout, consulta [Representación de computadoras cuánticas](/guides/represent-quantum-computers).
