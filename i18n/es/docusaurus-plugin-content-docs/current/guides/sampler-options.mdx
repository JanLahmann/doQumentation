...
4. Si `twirling` está habilitado, entonces se usa el producto de `num_randomizations` y `shots_per_randomization`, tal como se especifica en las [opciones de `twirling`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-twirling-options).
