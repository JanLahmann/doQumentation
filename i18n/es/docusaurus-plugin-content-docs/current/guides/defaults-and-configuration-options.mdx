...
- Aprende a [establecer el nivel de optimización](/guides/runtime-options-overview).
...
- Aprende [cómo transpilar circuitos](/guides/circuit-transpilation-settings) como parte del flujo de trabajo de patrones de Qiskit.
