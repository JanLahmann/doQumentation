---
description: 'Cómo ejecutar trabajos de computación cuántica en modo lote usando IBM Quantum Compute Service.'
...
Antes de iniciar un lote, debes [configurar el cliente de IBM Quantum Compute](/guides/install-qiskit) e inicializarlo como servicio:
...
Para obtener una visión general completa de la configuración y el estado de un lote, incluidos su TTL interactivo y máximo, usa el método `batch.details() method`.
...
<Admonition type="tip" title="Recomendaciones">
  ...
  - Comprende los [límites de trabajos](/guides/job-limits) al enviar un trabajo a una QPU de IBM&reg;.
