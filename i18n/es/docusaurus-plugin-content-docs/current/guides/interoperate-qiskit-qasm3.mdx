...
Debes instalar el paquete `qiskit_qasm3_import ` para usar esta función. Instálalo usando el siguiente comando.
...
- Revisa la referencia de la [API de Qiskit OpenQASM 3](https://docs.quantum.ibm.com/api/qiskit/qasm3).
- Visita el tema [Verifica tu programa](/guides/debugging-tools).
- Revisa la [especificación en vivo de OpenQASM](https://openqasm.com/).
</Admonition>
