...
Los trabajos breves de monitoreo de parámetros se ejecutan aproximadamente una vez por hora, intercalados automáticamente entre los trabajos de los usuarios, usando la pila completa de software de IBM Quantum Compute Service. Los resultados de estos trabajos se analizan para comprobar si algún parámetro ha comenzado a desviarse de los rangos aceptables, idealmente detectando problemas antes de que sean lo suficientemente significativos como para afectar el rendimiento de manera notable.

Algunos de los parámetros monitoreados incluyen los siguientes:

* Ángulos de lectura, amplitudes y umbral discriminador, asegurando una discriminación precisa del estado, baja fuga y operación estable. Esto incluye los parámetros operacionales de nuestros amplificadores limitados cuánticamente (limitados por el ruido cuántico).
...
* Indicios (firmas) de actividad TLS.
...
Estas calibraciones aseguran la implementación precisa de las puertas de un solo qubit: sx, x, rx (fraccionaria). Ajustamos:
...
Estas calibraciones se ejecutan en lotes de qubits que no son vecinos inmediatos, para minimizar la diafonía (crosstalk).
...
* [Randomized benchmarking](/guides/qpu-information#median-sx-error) (RB) por lotes de qubits
...
* [EPG de puertas fraccionarias CZ y RZZ (Heron), ECR (Eagle)](/guides/qpu-information#2q-error-median) medido por RB en esas puertas
