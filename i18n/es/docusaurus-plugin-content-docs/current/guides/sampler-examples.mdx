---
description: 'Ejemplos prácticos de uso de la primitiva Sampler de IBM Quantum.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Ejemplos de Sampler'
title: 'Ejemplos de Sampler'
---
...
## Ejecutar un solo experimento {#run-a-single-experiment}

Usa Sampler para devolver el resultado de la medición como cadenas de bits o conteos de un solo circuit.
...
## Ejecutar múltiples experimentos en un solo trabajo {#run-multiple-experiments-in-a-single-job}

Usa Sampler para devolver el resultado de la medición como cadenas de bits o conteos de múltiples circuits en un trabajo.
...
## Ejecutar circuits parametrizados {#run-parameterized-circuits}

Ejecuta varios experimentos en un solo trabajo, aprovechando los valores de parámetros para aumentar la reutilización del circuit.
...
## Usar lotes y opciones avanzadas {#use-batches-and-advanced-options}

Explora el [modo de ejecución](/guides/execution-modes) de lote y las opciones avanzadas para optimizar el rendimiento del circuit en las QPUs.
