...
## Importar un programa OpenQASM 2 en Qiskit {#import-an-openqasm-2-program-into-qiskit}
...
#### Ejemplo: importar un programa OpenQASM 2 como cadena de texto {#example-import-an-openqasm-2-program-as-a-string}
...
#### Ejemplo: importar un programa OpenQASM 2 desde un archivo {#example-import-an-openqasm-2-program-from-a-file}
...
### Vincular gates de OpenQASM 2 con gates de Qiskit {#link-openqasm-2-gates-with-qiskit-gates}
...
Si especificas qué clases de Gate usar para sentencias `gate` fuera de `"qelib1.inc"`, normalmente será más eficiente trabajar con el circuito resultante.
...
#### Ejemplo: importar un programa creado por el exportador heredado de Qiskit {#example-import-a-program-created-by-qiskits-legacy-exporter}
...
#### Ejemplo: usar una clase de gate particular al importar un programa OpenQASM 2 {#example-use-a-particular-gate-class-when-importing-an-openqasm-2-program}
...
#### Ejemplo: definir un nuevo gate integrado en un programa OpenQASM 2 {#example-define-a-new-built-in-gate-in-an-openqasm-2-program}
...
### Definir funciones clásicas personalizadas {#define-custom-classical-functions}
...
#### Ejemplo: usar instrucciones clásicas personalizadas {#example-use-custom-classical-instructions}

Aquí proporcionamos dos funciones clásicas personalizadas.
La primera es sencilla: solo suma uno a su entrada.
La segunda es la función ``math.atan2``, que calcula la operación matemática $\arctan(y/x)$ teniendo en cuenta el cuadrante.
...
## Exportar un circuito de Qiskit a OpenQASM 2 {#export-a-qiskit-circuit-to-openqasm-2}
...
### Ejemplo: exportar un circuito a OpenQASM 2 {#example-export-a-circuit-to-openqasm-2}
...
<Admonition type="tip" title="Recomendaciones">
    ...
    - Revisa el tema [Verificar tu programa](/guides/debugging-tools).
