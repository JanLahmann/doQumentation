---
description: 'Respuestas a preguntas frecuentes sobre los modos de ejecución'
title: 'Preguntas frecuentes sobre modos de ejecución'
---

{/* doqumentation-source-hash: 2e5f325b */}

# Preguntas frecuentes sobre modos de ejecución {#execution-modes-faqs}

<Accordion>
  <AccordionItem title="¿El modo de prueba local de `qiskit-ibm-runtime` admite diferentes modos de ejecución?">
