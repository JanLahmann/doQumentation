...
description: "Cómo configurar la gestión de ruido con la primitiva Estimator de Qiskit Runtime."
...
No todas las opciones funcionan juntas en todos los tipos de circuits. Consulta la guía de la [tabla de compatibilidad de características](/guides/sampler-options#options-compatibility-table) para más detalles.
</Admonition>
