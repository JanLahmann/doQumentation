...
#### De Schaltchreis konstruiere {#construct-the-circuit}
...
#### S'Observable konstruiere {#construct-the-observable}
...
#### D'globali Magnetisierig berechne {#compute-the-global-magnetization}
