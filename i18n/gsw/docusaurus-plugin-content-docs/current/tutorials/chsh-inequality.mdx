...
I de Abbildig gränzed d'Liniie und grau Beriich d'Gränze ab; d'üsserste (strich-punktierte) Liniie begränzed d'Quantegränze ($\pm 2\sqrt{2}$), während d'innere (gstrichleti) Liniie d'klassische Gränze ($\pm 2$) begränzed. Dir chönnt gseh, dass es Beriich git, wo d'CHSH-Züügegrössi d'klassische Gränze überschryytet. Härzliche Glückwunsch! Dir händ erfolgriich d'Verletzig vo de CHSH-Ungliichig i eme echte Quantesystem demonstriert!
