...
## บทนำสู่คอร์ส {#course-introduction}
...
## สิ่งสำคัญที่ได้จากคอร์สนี้ {#key-takeaways-for-this-course}
...
## เคล็ดลับในการนำทางคอร์สนี้ {#tips-for-navigating-this-course}
...
## การรัน Python examples {#running-the-python-examples}
...
## ขั้นตอนต่อไปหลังจากคอร์สนี้ {#next-steps-after-this-course}
