...
## บทนำสู่ cryptographic hashing {#introduction-to-cryptographic-hashing}
...
## หลักการพื้นฐานและการออกแบบของ hash functions {#basic-rationale-and-design-of-hash-functions}
...
## ตัวอย่าง cryptographic hashing ใน Python ด้วย SHA-256 {#example-of-cryptographic-hashing-in-python-with-sha-256}
...
## การประยุกต์ใช้ cryptographic hashing {#applications-of-cryptographic-hashing}
...
![รูปที่ 1: Secure hashing สำหรับการตรวจสอบ data integrity](/learning/images/courses/quantum-safe-cryptography/cryptographic-hash-functions/data-integrity.svg)
...
![รูปที่ 2: Digital signatures](/learning/images/courses/quantum-safe-cryptography/cryptographic-hash-functions/digital-signature.svg)
...
## ความปลอดภัยของ cryptographic hashing {#security-of-cryptographic-hashing}
...
### การทนทานต่อ pre-image {#pre-image-resistance}
...
### การทนทานต่อ collision {#collision-resistance}
...
## Cryptographic hash functions ที่ใช้กันทั่วไป {#commonly-used-cryptographic-hash-functions}
...
### ความเสี่ยงของ quantum ต่อ cryptographic hashing แบบดั้งเดิม {#quantum-risks-to-traditional-cryptographic-hashing}
...
#### อัลกอริทึมของ Grover {#grovers-algorithm}
