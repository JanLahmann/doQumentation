...
sidebar_label: 'Geometry ของโมเลกุล'
title: 'Geometry ของโมเลกุล'
---
...
# การกำหนด molecular geometry {#determining-a-molecular-geometry}
...
ผลลัพธ์ของ output นี้จะพูดถึงในส่วน post-processing ด้านล่าง สำหรับตอนนี้เพียงสังเกตว่าการ simulation สำเร็จแล้ว ตอนนี้คุณพร้อมที่จะรันบน real hardware เราจะตั้ง resilience เป็น `1` ซึ่งระบุว่าจะใช้ TREX error mitigation ตอนนี้ที่ทำงานกับ real hardware เราจะใช้ IBM Quantum Compute Service และ IBM Quantum primitives สังเกตว่าทั้ง for loop ที่เกี่ยวข้องกับ geometry และการทดลอง variational หลายครั้งอยู่ภายใน Session
...
## ขั้นตอนที่ 4: Post-processing {#step-4-post-processing}
...
นี่เป็นการสิ้นสุดคอร์ส VQE สำหรับเคมีควอนตัมของเรา หากคุณสนใจทำความเข้าใจทฤษฎีสารสนเทศพื้นฐานที่ใช้ในการคำนวณควอนตัม ดูคอร์สของ John Watrous เรื่อง [Basics of Quantum Information](/learning/courses/basics-of-quantum-information) สำหรับตัวอย่าง VQE workflow แบบสั้นเพิ่มเติม ดู [Ground-state energy estimation of the Heisenberg chain with VQE tutorial](/tutorials/spin-chain-vqe) ของเรา หรือเรียกดู [tutorials](https://docs.quantum.ibm.com/tutorials) และ [courses](/learning) เพื่อค้นหาสื่อการเรียนรู้เพิ่มเติมเกี่ยวกับเทคโนโลยีล่าสุดในการคำนวณควอนตัม

อย่าลืมทำข้อสอบของคอร์สนี้ คะแนน 80% หรือสูงกว่าจะทำให้คุณได้รับ Credly badge ซึ่งจะถูกส่งให้ทางอีเมลโดยอัตโนมัติ ขอบคุณที่เป็นส่วนหนึ่งของ IBM Quantum&reg; Network!
