...
เราจะเริ่มต้นด้วยวงจร `efficient_su2` ตัวอย่างสี่คิวบิตที่มีเกต SU(2) สองประเภท คือ `rx` และ `y` เรายังระบุแผนการพัวพันและจำนวนการทำซ้ำด้วย หากคุณเพียงแค่ `.draw()` วงจร คุณจะได้การแสดงผลที่ค่อนข้างเป็นนามธรรม แผนภาพวงจรที่เข้าใจได้ง่ายกว่านั้นได้มาจากการใช้ `.decompose().draw()` และในที่นี้เราจะใช้ `output = "mpl"'
