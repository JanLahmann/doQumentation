...
การเข้ารหัสฐาน (basis encoding) เข้ารหัสสตริง $P$-bit แบบดั้งเดิมเข้าไปในสถานะฐานเชิงคำนวณของระบบ $P$-qubit ตัวอย่างเช่น $\vec{x}^{(1)}_3 = 5 = 0(2^3)+1(2^2)+0(2^1)+1(2^0)$ สิ่งนี้สามารถแสดงเป็นสตริง $4$-bit ได้เป็น $(0101)$ และโดยระบบ $4$-qubit เป็นสถานะควอนตัม $|0101\rangle$ โดยทั่วไปแล้ว สำหรับสตริง $P$-bit: $\vec{x}^{(j)}_k = (b_1, b_2, ... , b_P)$ สถานะ $P$-qubit ที่สอดคล้องกันคือ $|x^{(j)}_k\rangle = | b_1, b_2, ... , b_P \rangle$ โดยที่ $b_n \in \{0,1\}$ สำหรับ $n = 1 , \dots , P$ โปรดทราบว่านี่เป็นเพียงสำหรับฟีเจอร์เดียว
...
วิธีหนึ่งในการเข้าใจยูนิทารีข้างต้นคือผ่านการเปรียบเทียบกับตัวขยายพันธุ์ (propagator) ในระบบทางฟิสิกส์ ยูนิทารีข้างต้นคือตัวดำเนินการวิวัฒนาการแบบยูนิทารี $\exp(it\mathcal{H})$ สำหรับแฮมิลโทเนียน $\mathcal{H}$ คล้ายกับแบบจำลอง Ising ซึ่งพารามิเตอร์เวลา $t$ ถูกแทนที่ด้วยค่าข้อมูลเพื่อขับเคลื่อนวิวัฒนาการ การขยายของตัวดำเนินการยูนิทารีนี้ให้วงจร PFM การเชื่อมต่อที่พัวพันใน $S$ สามารถตีความได้ว่าเป็นการควบคู่ Ising ในโครงตาข่ายสปิน
ลองพิจารณาตัวอย่างของตัวดำเนินการ Pauli $Y$ และ $XX$ ที่แสดงถึงปฏิสัมพันธ์ประเภท Ising เหล่านั้น Qiskit มีคลาส `pauli_feature_map` สำหรับการสร้างอินสแตนซ์ PFM ด้วยตัวเลือกของเกตแบบเดี่ยวและ $n$-qubit ซึ่งในตัวอย่างนี้จะถูกส่งเป็นสตริง Pauli `‘Y’` และ `‘XX’` โดยทั่วไป $n$ คือ 1 หรือ 2 สำหรับปฏิสัมพันธ์แบบคิวบิตเดี่ยวและสองคิวบิตตามลำดับ แผนการพัวพันคือ "linear" หมายความว่ามีเพียงคิวบิตเพื่อนบ้านที่ใกล้ที่สุดในวงจรควอนตัมเท่านั้นที่จะถูกจับคู่กัน โปรดทราบว่านี่ไม่ได้สอดคล้องกับคิวบิตเพื่อนบ้านที่ใกล้ที่สุดบนคอมพิวเตอร์ควอนตัมเอง เนื่องจากวงจรควอนตัมนี้เป็นชั้นนามธรรม
...
โค้ดด้านล่างใช้แผนที่ฟีเจอร์ในตัวทั้งสี่นี้กับการเข้ารหัสของชุดฟีเจอร์ และพล็อตความลึกสองคิวบิตของวงจรที่ได้ เนื่องจากอัตราความผิดพลาดของเกตสองคิวบิตสูงกว่าอัตราความผิดพลาดของเกตคิวบิตเดี่ยวมาก จึงอาจสมเหตุสมผลที่จะสนใจความลึกของเกตสองคิวบิตมากที่สุด ในโค้ดด้านล่าง เราจะได้จำนวนของเกตทั้งหมดในวงจรโดยการแยกวงจรก่อนแล้วใช้ count_ops() ดังที่แสดงด้านล่าง ในที่นี้ เกตสองคิวบิตที่เราสนใจคือเกต 'cx':
