...
# ทบทวนวิธีการ machine learning ที่เกี่ยวข้อง {#review-of-relevant-machine-learning-methods}
...
## ประเภทของ machine learning {#types-of-machine-learning}
...
### การนำ "ควอนตัม" เข้าสู่ machine learning {#introducing-quantum-to-machine-learning}
...
$$
## Kernel methods และบทบาทของควอนตัม {#kernel-methods-and-how-quantum-can-play-a-role}
...
### การย้ายไปยังพื้นที่มิติสูง {#moving-to-higher-dimensional-spaces}
...
### ทำไม dual form จึงมีประโยชน์? {#why-is-the-dual-form-useful}
...
## Variational quantum classifiers และ neural networks {#variational-quantum-classifiers-and-neural-networks}
