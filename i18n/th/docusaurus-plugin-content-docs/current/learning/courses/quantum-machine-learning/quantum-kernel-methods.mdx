...
### ขั้นตอนที่ 3: ประมวลผลโดยใช้ IBM Quantum primitives {#step-3-execute-using-ibm-quantum-primitives}
...
### ขั้นตอนที่ 1: แมปอินพุตคลาสสิกเป็นปัญหาควอนตัม {#step-1-map-classical-inputs-to-a-quantum-problem-1}
...
### ขั้นตอนที่ 2: ปรับปัญหาให้เหมาะสมสำหรับการประมวลผลควอนตัม {#step-2-optimize-problem-for-quantum-execution-1}
...
### ขั้นตอนที่ 3: ประมวลผลโดยใช้ IBM Quantum primitives {#step-3-execute-using-ibm-quantum-primitives-1}
...
### ขั้นตอนที่ 4: ประมวลผลหลังการวัด คืนผลลัพธ์ในรูปแบบคลาสสิก {#step-4-post-process-return-result-in-classical-format-1}
...
สมมติว่าผู้ที่เพิ่งเริ่มเรียนรู้คอมพิวเตอร์ควอนตัมพยายามใช้วงจรควอนตัมที่มีความลึกสองคิวบิตสูงมาก และไม่ใช้การลดความผิดพลาด สมมติต่อไปว่าสิ่งนี้ส่งผลให้เกิดอัตราความผิดพลาด 10% บนแต่ละคิวบิต หากค่าเมทริกซ์เคอร์เนลที่แท้จริง (ไม่มีความผิดพลาด) ที่สอดคล้องกับวงจรนี้มีค่ามาก เช่น 1.0 ความน่าจะเป็นในการวัดคิวบิตทั้ง 10 ตัวให้อยู่ในสถานะที่ทุกคิวบิตเป็น $|0\rangle$ จะเป็นเท่าใด?
...
### ขั้นตอนที่ 1: แมปอินพุตคลาสสิกเป็นปัญหาควอนตัม {#step-1-map-classical-inputs-to-a-quantum-problem-2}
...
### ขั้นตอนที่ 4: ประมวลผลหลังการวัด คืนผลลัพธ์ในรูปแบบคลาสสิก {#step-4-post-process-return-result-in-classical-format-2}
...
### ขั้นตอนที่ 1: แมปอินพุตคลาสสิกเป็นปัญหาควอนตัม {#step-1-map-classical-inputs-to-a-quantum-problem-3}
...
### ขั้นตอนที่ 2: ปรับปัญหาให้เหมาะสมสำหรับการประมวลผลควอนตัม {#step-2-optimize-problem-for-quantum-execution-2}
...
### ขั้นตอนที่ 3: ประมวลผลโดยใช้ IBM Quantum primitives {#step-3-execute-using-ibm-quantum-primitives-2}
...
### ขั้นตอนที่ 4: ประมวลผลหลังการวัด คืนผลลัพธ์ในรูปแบบคลาสสิก {#step-4-post-process-return-result-in-classical-format-3}
