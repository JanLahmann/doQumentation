...
บทเรียนแรกนี้เป็นการแนะนำการคำนวณควอนตัมแบบลงมือปฏิบัติจริง ที่เหมาะสำหรับทั้งผู้เริ่มต้นที่อยากรู้และผู้บริหารที่มีเวลาจำกัด คุณจะได้เรียนรู้เกี่ยวกับ Circuit ควอนตัม และเขียนโปรแกรมควอนตัมเล็กๆ ที่สร้าง **entanglement** แล้วรันบนคอมพิวเตอร์ควอนตัม IBM&reg; จริง นอกจากนี้ยังมีตัวเลือกให้รันโปรแกรมเดียวกันบน Simulator หากต้องการข้ามการรันบนคอมพิวเตอร์ควอนตัมจริง
...
ในการรันบนคอมพิวเตอร์ควอนตัม IBM จริง คุณยังต้องมี [**บัญชี IBM Quantum&reg; Platform**](https://quantum.cloud.ibm.com/signin?redirectTo=%2F) (ฟรี) ด้วย สามารถเปิด Instance โดยใช้ Open Plan เพื่อรับเวลา quantum processor unit (QPU) 10 นาทีต่อหน้าต่าง 28 วัน ซึ่งจริงๆ แล้วค่อนข้างมาก! *หากมีปัญหากับบัญชี ดูที่ [หน้า Support](/guides/support)*
...
เปิด Composer [ที่นี่](https://quantum.cloud.ibm.com/composer)
...
ตอนนี้ มากำหนดฟังก์ชันช่วยเหลือที่จัดการกระบวนการรันวงจรควอนตัมและดึงผลลัพธ์การวัด ฟังก์ชันนี้จะจัดการการแปล (transpile) วงจรให้ตรงกับชุดคำสั่งของ backend รันผ่าน primitive `Sampler` และดึงจำนวนนับ (counts) จากผลลัพธ์
