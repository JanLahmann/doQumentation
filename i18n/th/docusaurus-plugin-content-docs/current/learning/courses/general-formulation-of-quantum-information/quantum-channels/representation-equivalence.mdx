...
อย่างไรก็ตาม เนื่องจาก eigenvalue เป็นจำนวนจริงไม่ติดลบ จึงมีรากที่สองที่ไม่ติดลบ ดังนั้นเราเลือก
...
Choi representation เป็นการแทนที่แบบหนึ่งต่อหนึ่ง (faithful) ดังนั้น $\Psi = \Phi$ ก็ต่อเมื่อ $J(\Phi) = J(\Psi)$
...
ดังนั้น ถ้าสมมติโดยปริยายว่า $mN/n$ เป็นจำนวนเต็ม ซึ่งเทียบเท่ากับ $N$ เป็นพหุคูณของ $n/\operatorname{gcd}(n,m)$ เราก็เลือก $\mathsf{G}$ เพื่อให้ชุดสถานะคลาสสิกของมันเป็น $\{0,\ldots,N-1\}$ ได้
