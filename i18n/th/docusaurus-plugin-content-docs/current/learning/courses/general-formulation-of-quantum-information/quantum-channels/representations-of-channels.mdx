...
เราจะเห็นด้วยว่าการแทนค่าแบบ Stinespring ไม่ซ้ำกัน จะมีวิธีต่าง ๆ ในการนำช่องเดียวกันไปใช้งานในลักษณะที่อธิบายไว้เสมอ
...
### ช่อง dephasing แบบสมบูรณ์ {#completely-dephasing-channel-1}
...
### ช่อง reset ของ qubit {#qubit-reset-channel-1}
...
ในทางตรงกันข้าม การแทนค่าแบบ Stinespring และ Kraus ไม่ซ้ำกันในลักษณะนี้ ดังที่เราเห็นมาแล้ว
...
### ช่อง dephasing แบบสมบูรณ์ {#completely-dephasing-channel-2}
...
### ช่อง depolarizing แบบสมบูรณ์ {#completely-depolarizing-channel-1}
...
### ช่อง reset ของ qubit {#qubit-reset-channel-2}
