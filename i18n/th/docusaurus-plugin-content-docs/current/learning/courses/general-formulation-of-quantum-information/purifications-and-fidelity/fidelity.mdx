...
เพื่อทำความเข้าใจสูตรในนิยาม ให้สังเกตก่อนว่า $\sqrt{\rho} \sigma \sqrt{\rho}$ เป็นเมทริกซ์กึ่งนิยามบวก:
...
สำหรับทุกเมทริกซ์จัตุรัส $M$ ค่าเจาะจงของเมทริกซ์กึ่งนิยามบวกสองตัว $M^{\dagger} M$ และ $M M^{\dagger}$ จะเหมือนกันเสมอ และดังนั้นสิ่งเดียวกันจะเป็นจริงสำหรับรากที่สองของเมทริกซ์เหล่านี้
...
3. fidelity ระหว่างสถานะไม่ลดลงภายใต้การกระทำของ channel ใดๆ นั่นคือ ถ้า $\rho$ และ $\sigma$ เป็น density matrices และ $\Phi$ เป็น channel ที่สามารถรับสถานะทั้งสองนี้เป็นอินพุตได้ ก็จำเป็นต้องเป็นกรณี
ที่
   $$
   \operatorname{F}(\rho,\sigma) \leq \operatorname{F}(\Phi(\rho),\Phi(\sigma)).
   $$
4. *อสมการ Fuchs-van de Graaf* กำหนดความสัมพันธ์ที่ใกล้เคียง (แม้จะไม่แน่นอน) ระหว่าง fidelity และ trace distance: สำหรับสถานะสองสถานะใดๆ $\rho$ และ $\sigma$ เรามี
   $$
...
การตั้งค่ามีดังนี้
ให้ $\mathsf{X}$ เป็นระบบในสถานะ $\rho$ และ $\{P_0,\ldots,P_{m-1}\}$ เป็นกลุ่มเมทริกซ์กึ่งนิยามบวกที่แทนการวัดทั่วไปของ $\mathsf{X}$
...
เมทริกซ์การวัด $P_0, \ldots, P_{m-1}$ เป็นกึ่งนิยามบวกและรวมกันได้เป็นเมทริกซ์เอกลักษณ์ ซึ่งช่วยให้เราสรุปได้ว่าค่าเจาะจงทั้งหมดของ $P_0$ เป็นจำนวนจริงระหว่าง $0$ กับ $1$
สิ่งนี้ตามมาจากข้อเท็จจริงที่ว่าสำหรับเวกเตอร์หน่วยใดๆ $\vert\psi\rangle$ ค่า
$\langle \psi \vert P_a \vert \psi \rangle$ เป็นจำนวนจริงไม่เป็นลบสำหรับแต่ละ $a\in\{0,\ldots,m-1\}$ (เพราะแต่ละ $P_a$ เป็นกึ่งนิยามบวก) รวมกับค่าเหล่านี้รวมกันได้หนึ่ง
