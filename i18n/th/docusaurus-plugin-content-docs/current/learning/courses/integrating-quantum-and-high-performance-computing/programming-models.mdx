...
![ไดอะแกรม circuit ที่มีสี่เส้นแนวนอนและ Gate หลายตัว](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/checkin-circuit.avif)
...
สมมติว่าคุณกำลังจำลองอิเล็กตรอนในโมเลกุล คุณต้องการประมาณ (a) พลังงานสถานะพื้นของโมเลกุล และ (b) สถานะพื้นฐานเชิงคำนวณใดที่โดดเด่นที่สุดในสถานะพื้นของโมเลกุล ในแต่ละกรณี คุณจะใช้ Estimator หรือ Sampler primitive?
...
* การควบคุมการไหลหลักของโปรแกรมถูกกำหนดโดยอันดับ (rank) ของโปรเซส นี่คือหลักการ SPMD ในทางปฏิบัติ โปรแกรมใช้ตรรกะเงื่อนไข (ตัวอย่างเช่น if (rank == 0)) เพื่อให้แน่ใจว่าเฉพาะส่วนที่ขนานกันบางส่วนของโค้ดเท่านั้นที่ถูกรันโดยโปรเซสผู้ปฏิบัติงาน ในขณะที่โปรเซสหลัก (มักเป็น Rank 0) จัดการการเริ่มต้นและการรวบรวมผลลัพธ์สุดท้าย
