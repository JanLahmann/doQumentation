...
เรียกเซตของสถานะพื้นฐานเชิงคำนวณทั้งหมดที่ประกอบเป็น ansatz ของคุณว่า A เรียกเซตของสถานะพื้นฐานเชิงคำนวณทั้งหมดที่ประกอบเป็นสถานะพื้นที่แท้จริงของระบบของคุณว่า G ข้อใดต่อไปนี้สอดคล้องกับ ansatz ที่ 'ดี' เลือกทั้งหมดที่เกี่ยวข้อง:
