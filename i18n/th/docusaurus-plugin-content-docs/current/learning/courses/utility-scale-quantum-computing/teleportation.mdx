...
## 3. การทำ quantum state tomography {#3-quantum-state-tomography}
...
### ประมาณค่า $r_z$ {#estimate-r-z-value}
...
### แบบฝึกหัดที่ 1: ประมาณค่า $r_x$ {#exercise-1-estimate-r-x-value}
...
### แบบฝึกหัดที่ 2: ประมาณค่า $r_y$ {#exercise-2-estimate-r-y-value}
