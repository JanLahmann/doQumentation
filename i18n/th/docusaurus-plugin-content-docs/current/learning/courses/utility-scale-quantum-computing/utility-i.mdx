...
โดยเฉพาะ คุณจะถูกขอให้สร้างและรันวงจรที่สอดคล้องกับรูปที่ 4b ของบทความ และพล็อตจุด "unmitigated" ของคุณเอง ดังที่คุณเห็น มันเป็นวงจร 127 คิวบิต $\times$ 60 เลเยอร์ (20 ขั้นตอน Trotter) โดยมี $\langle Z_{62} \rangle$ เป็น observable
![image.png](/learning/images/courses/utility-scale-quantum-computing/utility-i/utility1.avif)
ฟังดูเป็นเรื่องใหญ่ใช่ไหม? &nbsp; ไม่ต้องกังวล บทเรียนสามบทสุดท้ายของหลักสูตรนี้จะเป็นบันไดขั้นแรก เริ่มต้น เราจะสาธิตการทดลองขนาดเล็กกว่าซึ่งเป็นการสร้างและรันบนอุปกรณ์จำลอง วงจร 27 คิวบิต $\times$ 6 เลเยอร์ (2 ขั้นตอน Trotter) โดยมี $\langle Z_{13} \rangle$ เป็น observable
...
ลองฝึกฝนวิธีการเหล่านี้ คุณควรเห็นวงจร 27 คิวบิต $\times$ 15 เลเยอร์ (5 ขั้นตอน Trotter) เนื่องจากอุปกรณ์จำลองมี 28 edges ควรมีเกตพัวพัน 28*5 ตัว
...
เมื่อผู้ใช้คนเดียวกันรันเซลล์ถัดไปด้วยสภาพแวดล้อมเดียวกันกับข้างต้น ใช้เวลา 2 นาที 19 วินาที ตามเวลาจริง (Wall Time) การรันวงจรบนอุปกรณ์จำลองจะเรียกใช้การจำลองที่มีสัญญาณรบกวนซึ่งใช้เวลานานกว่าการจำลองที่แม่นยำมาก เราแนะนำว่าอย่ารันวงจรที่ใหญ่กว่านี้ (เช่น 27 คิวบิต $\times$ 9 เลเยอร์ ด้วย 3 ขั้นตอน Trotter) บนอุปกรณ์จำลอง
