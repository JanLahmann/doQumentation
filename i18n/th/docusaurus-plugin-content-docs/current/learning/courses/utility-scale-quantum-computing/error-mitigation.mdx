...
การตั้งค่า resilience level (`estimator.options.resilience_level`) เป็นวิธีที่ง่ายที่สุดในการใช้การลดข้อผิดพลาดเมื่อใช้ Qiskit Estimator Estimator รองรับ resilience levels ต่อไปนี้ (ณ วันที่ 2024/06/28) ดูรายละเอียดเพิ่มเติมในคู่มือ [Configure error mitigation](/guides/configure-error-mitigation)
