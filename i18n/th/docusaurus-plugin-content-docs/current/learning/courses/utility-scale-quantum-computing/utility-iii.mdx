...
คุณสามารถตั้งค่าตัวเลือก error suppression ใน Sampler V2 ได้ ดูข้อมูลเพิ่มเติมได้ที่คู่มือ [Sampler noise management](/guides/sampler-noise-management) และ API reference [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2)
