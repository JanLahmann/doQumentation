...
## 3. แบบฝึกหัดที่ 1 ดำเนินการจำลองโดยใช้ Suzuki–Trotter อันดับที่สอง {#3-exercise-1-perform-simulation-using-second-order-suzukitrotter}
...
### 3.3 พล็อตผลลัพธ์ Suzuki–Trotter อันดับที่สอง {#33-plot-the-second-order-suzukitrotter-results}
...
### 4.3 ขั้นตอนที่ 3 รันด้วย IBM Quantum primitives {#43-step-3-execute-with-ibm-quantum-primitives}
