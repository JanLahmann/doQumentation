...
**Circuit depth** - ความลึกสูงสุดของ Circuit ขึ้นอยู่กับหลายปัจจัย ตรวจสอบให้แน่ใจว่าคุณกำลังพิจารณาความลึกของ two-qubit gate หลัง transpile เป็นตัววัดความลึกหลัก ความลึกของ two-qubit หลัง transpile ที่ประมาณ 30 มักจัดการได้ด้วยเทคนิคการระงับและบรรเทาข้อผิดพลาดสมัยใหม่ แอปพลิเคชันเฉพาะกลุ่มบางส่วนอาจพบความยากลำบากที่ความลึกต่ำกว่านี้ และ circuit บางส่วนก็สามารถไปได้ไกลกว่านั้นแน่นอน นี่เป็นความลึกที่ดีสำหรับการสำรวจ  
**QPU time** - สิ่งนี้ขึ้นอยู่กับแอปพลิเคชันของคุณโดยสิ้นเชิง เราประมาณว่าต้องใช้อย่างน้อย 400 นาทีสำหรับงานวิจัยควอนตัมคอมพิวเตอร์แบบใหม่ คุณอาจตรวจสอบเวลา QPU ที่จำเป็นสำหรับการรันแต่ละครั้งของโปรเจกต์ที่แสดงอยู่ใน advantage tracker ส่วนใหญ่จะอยู่ระหว่าง 30-120 นาที เมื่อเราคำนึงถึงการทดลอง การทำ benchmark ของปัญหาของคุณ และการพยายามหลายครั้ง ช่วงเวลานี้จะสอดคล้องกับค่าต่ำสุดที่กล่าวไว้ข้างต้น  
...
เอกสารอ้างอิงต่อไปนี้อาจมีประโยชน์อย่างยิ่งในการสร้างเรื่องราวที่มีข้อมูลครบถ้วนเกี่ยวกับโปรเจกต์ควอนตัม โดยถูกจัดเรียงตามหัวข้อก่อน แล้วจึงตามประเภทของสื่อ เพื่อให้ตรงกับมาตรฐานของหน่วยงานให้ทุน
