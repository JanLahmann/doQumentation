...
Layer coupling กำหนดวิธีที่ Qubit มีปฏิกิริยากับ Qubit ที่อยู่ติดกันระหว่างการจำลอง อุปกรณ์ควอนตัมของเราใช้ heavy-hexagonal layout ซึ่งเป็นรูปแบบที่โดดเด่นสำหรับการเชื่อมต่อ Qubit ภายใน layout นี้ การเชื่อมต่อระหว่าง Qubit ที่รู้จักกันในชื่อ "edge" สามารถแบ่งออกเป็นสามชุดที่แตกต่างกัน ที่สำคัญคือ ไม่มีสองการเชื่อมต่อในชุดเดียวกันที่ใช้ Qubit ร่วมกัน สิ่งนี้แก้ข้อจำกัดฮาร์ดแวร์สำคัญ: บนคอมพิวเตอร์ควอนตัมจริง Qubit สามารถมีส่วนร่วมในเพียงหนึ่ง two-qubit Gate ในเวลาใด ๆ
