...
## Local และ Global Optimizers {#local-and-global-optimizers}
...
## Gradient-Based และ Gradient-Free Optimizers {#gradient-based-and-gradient-free-optimizers}
...
- **การทดลองกับ error suppression และ error mitigation**: IBM Quantum primitives มี interface ง่าย ๆ สำหรับทดลองกับค่าต่าง ๆ ของ `optimization_level` และ `resilience_setting` ตามลำดับ ซึ่งช่วยลดผลกระทบของสัญญาณรบกวนและทำให้กระบวนการปรับแต่งมีประสิทธิภาพมากขึ้น
