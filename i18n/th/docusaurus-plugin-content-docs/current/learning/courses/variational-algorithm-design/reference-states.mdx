...
## การสร้าง Reference States โดยใช้ template circuits {#constructing-reference-states-using-template-circuits}
...
## Reference states เฉพาะแอปพลิเคชัน {#application-specific-reference-states}
