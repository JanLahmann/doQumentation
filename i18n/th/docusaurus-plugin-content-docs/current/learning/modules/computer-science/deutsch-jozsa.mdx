...
เริ่มต้นด้วยการโหลดแพ็กเกจที่จำเป็น รวมถึง IBM Quantum primitives เราจะเลือกคอมพิวเตอร์ควอนตัมที่ไม่ยุ่งที่สุดที่เราสามารถใช้งานได้ด้วย
...
## อัลกอริทึม Deutsch-Jozsa {#the-deutsch-jozsa-algorithm-1}
...
2. ถัดไป เกต $U_f$ ถูกนำไปใช้กับคิวบิต เกตนี้จะรับคิวบิต n ตัวแรกเป็นอินพุต (ซึ่งตอนนี้อยู่ในสภาวะซ้อนทับที่เท่ากันของสตริง n-bit ที่เป็นไปได้ทั้งหมด) และใช้ฟังก์ชัน $f(x)=s \cdot x$ กับคิวบิตเอาต์พุต ดังนั้นคิวบิตนี้จึงอยู่ในสถานะ: $ |- \oplus f(x)\rangle$ ขอบคุณกลไก phase kickback สถานะของคิวบิตนี้ไม่เปลี่ยนแปลง แต่บางพจน์ในสถานะคิวบิตอินพุตจะได้เครื่องหมายลบ:
