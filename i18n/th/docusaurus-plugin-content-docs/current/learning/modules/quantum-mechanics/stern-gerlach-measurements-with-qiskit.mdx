...
# การทดลอง Stern-Gerlach บนคอมพิวเตอร์ควอนตัม {#the-stern-gerlach-experiment-using-quantum-computers}
...
### ขั้นตอนที่ 3: รันโดยใช้ IBM Quantum primitives {#step-3-execute-using-ibm-quantum-primitives}
...
### ขั้นตอนที่ 1: แมป input แบบคลาสสิกไปยังปัญหาควอนตัม {#step-1-map-classical-inputs-to-a-quantum-problem-1}
