---
description: 'เรียนรู้การทแยงเมตริกซ์เชิงควอนตัมแบบ Krylov สำหรับ lattice Hamiltonians ด้วยแนวคิดของฟังก์ชัน Hamiltonian'
notebook_path: tutorials/krylov-quantum-diagonalization.ipynb
sidebar_label: 'การทแยงเมตริกซ์เชิงควอนตัมแบบ Krylov ของ Lattice Hamiltonians'
title: 'การทแยงเมตริกซ์เชิงควอนตัมแบบ Krylov ของ Lattice Hamiltonians'
---
...
*ประมาณการเวลาใช้งาน: 70 นาทีบนโปรเซสเซอร์ Heron หรือ Nighthawk (หมายเหตุ: นี่เป็นการประมาณเท่านั้น เวลาจริงอาจแตกต่างออกไป)*

## ผลลัพธ์การเรียนรู้ {#learning-outcomes}
หลังจากทำบทเรียนนี้เสร็จแล้ว คุณจะเข้าใจข้อมูลต่อไปนี้:
- วิธีตีความ Krylov quantum diagonalization (KQD) ว่าเป็นการเรียนรู้ฟังก์ชัน Hamiltonian จำกัดที่ทำหน้าที่เป็นตัวกรองสเปกตรัม
- วิธีสร้างเมทริกซ์ Hamiltonian แบบฉายภาพและเมทริกซ์ overlap ด้วยการวัดแบบ extended swap-test
- วิธีแก้ปัญหา generalized eigenvalue problem (GEVP) ที่ได้ และกู้คืนค่าประมาณพลังงานสถานะพื้นสำหรับ lattice Hamiltonian

## ข้อกำหนดเบื้องต้น {#prerequisites}
แนะนำให้คุณทำความคุ้นเคยกับหัวข้อเหล่านี้:
- [Qiskit primitives](/guides/primitives)
- [การประมาณพลังงานสถานะพื้นของ Heisenberg chain ด้วย VQE](/tutorials/spin-chain-vqe)
- [คอร์สอัลกอริทึม Quantum diagonalization](/learning/courses/quantum-diagonalization-algorithms/krylov)
...
การประมาณคุณสมบัติพลังงานต่ำของ Hamiltonian แบบหลายวัตถุเป็นงานหลักในการจำลองควอนตัม
ตัวอย่างเช่น พลังงานสถานะพื้นและการกระตุ้นระดับต่ำเกี่ยวข้องโดยตรงกับความเสถียรทางเคมี การจัดเรียงแม่เหล็ก การเปลี่ยนเฟสควอนตัม และการตอบสนองของวัสดุ
บนคอมพิวเตอร์แบบคลาสสิก มิติของ Hilbert space เติบโตแบบเอกซ์โพเนนเชียลตามจำนวนออร์บิทัลหรือสปิน ดังนั้นการทแยงเมตริกซ์โดยตรงจึงกลายเป็นสิ่งที่ทำไม่ได้ในทางปฏิบัติอย่างรวดเร็ว

มีแนวทางการคำนวณควอนตัมหลายวิธีสำหรับปัญหานี้
วิธีการแบบ variational ระยะใกล้ เช่น [variational quantum eigensolver (VQE)](/tutorials/spin-chain-vqe) ใช้ Circuit แบบมีพารามิเตอร์ที่ตื้นค่อนข้างมาก แต่ต้องการลูปการปรับให้เหมาะสมแบบคลาสสิกที่ไม่เป็นเชิงเส้นพร้อมกับการประเมิน Circuit ควอนตัมจำนวนมาก
ในอีกด้านหนึ่ง [quantum phase estimation (QPE)](https://arxiv.org/abs/quant-ph/0604193) ให้เส้นทางที่ตรงกว่าไปยังการประมาณค่า eigenvalue พร้อมการรับประกันที่เข้มงวด แต่ QPE มาตรฐานต้องการ Circuit ที่สอดคล้องกันยาว และเหมาะสำหรับคอมพิวเตอร์ควอนตัมแบบทนทานต่อความผิดพลาดเป็นหลัก
KQD อยู่ระหว่างสองแนวทางนี้: ใช้วิวัฒนาการ Hamiltonian แบบเรียลไทม์ เช่นเดียวกับอัลกอริทึมที่อิงตาม phase estimation แต่แทนที่ phase estimation แบบเต็มด้วยปัญหา eigenvalue แบบฉายภาพที่กะทัดรัด ซึ่งสามารถแก้ได้แบบคลาสสิก

พิจารณา Hamiltonian $H$ ขนาด $n$-qubit และสถานะอ้างอิง $\lvert \psi_{0}\rangle$
วิธี KQD สร้าง Krylov subspace จากสถานะที่วิวัฒนาการแบบเรียลไทม์
...
โดยที่ $r$ คือมิติของ Krylov และ $\Delta t$ คือขั้นตอนเวลา
สถานะใดๆ ใน Krylov subspace จะถูกแทนเป็นการรวมเชิงเส้นของสถานะพื้นฐานเหล่านี้
...
ด้วยพีชคณิตอย่างง่าย เราจะเห็นได้ว่าพลังงานที่สอดคล้องกันเขียนเป็น Rayleigh quotient
...
ที่นี่ เมทริกซ์ $\mathcal{S}$ และ $\mathcal{H}$
...
กำหนดเมทริกซ์ overlap และ Hamiltonian แบบฉายภาพ
ค่าของมันประมาณโดยใช้การวัด Circuit ควอนตัม

เรามุ่งหาสัมประสิทธิ์ $\mathbf{c}$ ที่ให้ค่า $E(\mathbf{c})$ น้อยที่สุด:
...
ตามทฤษฎีบท Rayleigh-Ritz การหาค่าน้อยที่สุดนี้เทียบเท่ากับการแก้ generalized eigenvalue problem (GEVP)
...
โปรดสังเกตว่ามิติ $r$ สามารถเล็กพอที่คอมพิวเตอร์แบบคลาสสิกจะแก้ GEVP ได้

นี่คือหลักการ variational เดียวกันกับที่ใช้ในการทแยงเมตริกซ์ subspace แบบคลาสสิก แต่ที่นี่สถานะพื้นฐานถูกสร้างขึ้นโดยวิวัฒนาการเวลาเชิงควอนตัม
เมื่อเทียบกับ VQE, KQD มักต้องการ Circuit ที่ลึกกว่าเพราะอาศัยวิวัฒนาการเรียลไทม์
ในทางกลับกัน KQD หลีกเลี่ยงการปรับพารามิเตอร์ไม่เป็นเชิงเส้นและการรันฮาร์ดแวร์ควอนตัมแบบวนซ้ำ และปรับปรุงอย่างเป็นระบบเมื่อ subspace แบบฉายภาพขยายใหญ่ขึ้น
อัลกอริทึมนี้ได้รับการสาธิตในระดับใหญ่บนฮาร์ดแวร์ควอนตัมที่มีอยู่ [\[2\]](#references) และประสิทธิภาพของมันสามารถวิเคราะห์ได้ด้วยการรับประกันที่พิสูจน์ได้ [\[1\]](#references)
...
การรันบนฮาร์ดแวร์ต้องการ `qiskit-ibm-runtime` และการเข้าถึงบัญชี IBM Quantum&reg;

## การตั้งค่า {#setup}

เซลล์การตั้งค่านำเข้าโมดูลที่จำเป็นและกำหนดฟังก์ชันช่วยสำหรับ workflow:

1. สร้าง Heisenberg Hamiltonian;

2. แก้ thresholded GEVP;

3. ประเมินตัวกรอง Krylov ที่เรียนรู้แล้ว;

4. แปลงค่าตัวกรองเป็นน้ำหนักสเปกตรัม;

5. พล็อตการกระจายพลังงานอ้างอิงและพลังงานที่กรองแล้ว
...
ในส่วนแรกของบทเรียนนี้ เราสาธิตวิธี KQD โดยใช้ statevector simulator ในเครื่อง หลังจากนั้น เราใช้ Backend ควอนตัมจริงเพื่อจัดการปัญหาระดับ utility-scale

เรายังกำหนด Backend จำลอง (fake backend) เพื่อสาธิตการ transpile เฉพาะ Backend และตรวจสอบ Circuit ที่ได้
...
#### Hamiltonian และสถานะอ้างอิง {#hamiltonian-and-reference-state}
ตัวอย่างนี้ใช้ Heisenberg chain แบบ open-boundary ขนาด 12 qubit ($n=12$)
...
ด้วยสถานะผลคูณแบบ single-excitation
...
เป็นสถานะอ้างอิง
เนื่องจาก Heisenberg Hamiltonian ที่กำหนดข้างต้นรักษาจำนวนการกระตุ้นทั้งหมด สถานะอ้างอิงจึงอยู่ใน single-excitation subspace ซึ่งมิติของมันเติบโตแบบเชิงเส้นตามจำนวน qubit เท่านั้น เราจึงสามารถคำนวณพลังงานสถานะพื้นที่แน่นอนได้อย่างมีประสิทธิภาพ โดยการทแยงเมตริกซ์ Hamiltonian ที่จำกัดให้อยู่ใน subspace นั้น และใช้มันเป็นเพียงเกณฑ์วัดเชิงวินิจฉัยสำหรับค่าประมาณ KQD workflow ของ KQD เองจะประมาณสมาชิกเมทริกซ์แบบฉายภาพโดยใช้ Qiskit primitives และแก้ปัญหาแบบฉายภาพที่ได้ด้วยวิธีคลาสสิก
...
#### กำหนดพารามิเตอร์สำหรับอัลกอริทึม {#set-the-parameters-for-the-algorithm}

จากขอบเขตบนของ Hamiltonian norm เอกสารอ้างอิง [\[1\]](#references) แนะนำโดยฮิวริสติกให้ขั้นตอนเวลา $\Delta t$ เป็น $\pi/\|H\|$
เนื่องจาก spectral norm $\|H\|$ คำนวณได้ยาก เราจึงใช้ขอบเขตบนของมันแทน:
...
เรากำหนดมิติ Krylov เป็น $r=10$ และจำนวนขั้นตอน Trotter ต่อขั้นตอนเวลาเป็น $5$: Krylov space ที่ใหญ่พอที่จะแยกแยะสเปกตรัมระดับต่ำได้ ในขณะที่ยังคง Circuit ที่ลึกที่สุด ($t_{\max}=(r-1)\Delta t$) ให้อยู่ในระดับที่ทำได้จริง และมีขั้นตอน Trotter เพียงพอที่จะรักษาความคลาดเคลื่อนจากการแยกส่วนให้เล็กที่ Circuit ที่ลึกที่สุดนั้น
...
#### สร้าง Circuit {#build-circuit}

ที่นี่ เราสร้าง Circuit เพื่อประมาณสมาชิกเมทริกซ์ $\mathcal{H}_{k\ell}$ และ $\mathcal{S}_{k\ell}$
เนื่องจากกำลังทั้งหมดของ $H$ สลับที่กันได้ เรามี
$$
\begin{equation*}
\mathcal{H}_{k\ell}
=
...
ที่นี่ เรานำเสนอ Circuit ที่เรียกว่า **extended-swap-test** ซึ่งเตรียม
$$
\begin{equation*}
|\Phi_{0d}\rangle=
...
\end{equation*}
$$
โดยที่ $|\psi_d\rangle=e^{-id\Delta tH}|\psi_{0}\rangle$

#### สถานะอ้างอิง {#reference-state}

เราเตรียมสถานะอ้างอิง $|\psi_0\rangle$
...
#### วิวัฒนาการตามเวลา {#time-evolution}

ทำให้ตัวดำเนินการวิวัฒนาการตามเวลาที่สร้างโดย Hamiltonian เป็นจริง โดยประมาณด้วย [Lie-Trotterization](https://docs.quantum.ibm.com/api/qiskit/qiskit.synthesis.LieTrotter) แบบง่าย
...
Circuit จะเตรียมสถานะอ้างอิงบน register ระบบก่อน ในขณะที่ ancilla ยังคงอยู่ที่ $|0\rangle$:
...
จากนั้น การใช้ Hadamard gate กับ ancilla จะสร้างการซ้อนทับ (superposition) แบบสอดคล้องกันของสองแขนง:
...
สุดท้าย gate วิวัฒนาการตามเวลาแบบมีเงื่อนไขจะถูกใช้:
...
เฉพาะเมื่อ ancilla อยู่ในแขนง $|1\rangle$ เท่านั้น ดังนั้น
...
ในบล็อกโค้ดถัดไป เราจะ implement:
$$
\begin{equation*}
|\Psi(t)\rangle = \frac{|0\rangle|\psi_0\rangle + |1\rangle U(t)|\psi_0\rangle}{\sqrt{2}},
\end{equation*}
$$
ซึ่งจะถูกกำหนดเป็น $t=d\Delta t$ สำหรับ $d=1,\cdots r-1$ ในขั้นตอนการรัน
...
สำหรับ Hermitian observable ของระบบใดๆ $O$ ที่นี่เรากำหนด observables ที่จะคำนวณ:
...
นี่เป็นเพราะ $O=I$ ให้สมาชิก overlap $\mathcal{S}_{0d}=\langle\psi_0|\psi_d\rangle$ ในขณะที่ $O=H$ ให้สมาชิก Hamiltonian $\mathcal{H}_{0d}=\langle\psi_0|H|\psi_d\rangle$

ใช้ $X=|0\rangle\langle 1|+|1\rangle\langle 0|$ เรามี
...
ในทำนองเดียวกัน ใช้ $Y=-i|0\rangle\langle 1|+i|1\rangle\langle 0|$,
...
สุดท้าย สำหรับแต่ละสถานะ $|\Psi_{0d}\rangle$ เราต้องวัด:
$$
\begin{align*}
...
สำหรับการประมาณสมาชิกเมทริกซ์ $\mathcal{H}$ จำนวนพจน์ Pauli มีมากกว่าของสมาชิกเมทริกซ์ $\mathcal{S}$ อย่างมาก

ตอนนี้เราสามารถลดจำนวนพจน์ Hamiltonian ที่วัดได้โดยใช้เทคนิคการเลื่อน (shifting) [\[4\]](#references)
เราแบ่ง Hamiltonian เป็น:
...
โดยที่ $T$ ถูกเลือกให้สถานะอ้างอิงเป็น eigenstate ของมัน
...
คือสมาชิกเมทริกซ์ Hamiltonian แบบเลื่อน
ดังนั้น เราจึงต้องวัดเพียง $X\otimes (H-T)$ และ $Y\otimes (H-T)$ เท่านั้น
การมีส่วนร่วมจาก $T$ ถูกสร้างขึ้นใหม่แบบคลาสสิกโดยใช้สมาชิกเมทริกซ์ overlap $\mathcal{S}_{0d}$ ที่วัดไปแล้ว

ในตัวอย่างนี้ ตัวเลือกที่เป็นธรรมชาติคือส่วนแนวทแยงของ Heisenberg Hamiltonian
...
เนื่องจากสถานะอ้างอิงเป็นสถานะฐานเชิงคำนวณ (computational-basis state) มันจึงเป็นสถานะเฉพาะ (eigenstate) ของเทอม $Z_iZ_{i+1}$ ทุกตัว

อย่างไรก็ตาม ทางเลือกที่ดีกว่าคือการรวมไม่เพียงแค่เทอมแนวทแยง $ZZ$ แต่รวมเทอม $XX+YY$ ที่ทำให้สถานะอ้างอิงเป็นศูนย์ (annihilate) ด้วย

สำหรับแต่ละคู่ที่อยู่ติดกัน ตัวดำเนินการ $XX+YY$ สอดคล้องกับ
...
ดังนั้น เทอม $XX+YY$ จะมีส่วนร่วมก็ต่อเมื่อ qubit สองตัวที่อยู่ติดกันมีค่า occupation ต่างกันในบิตสตริงอ้างอิง
ถ้า qubit ทั้งสองเป็น $0$ ทั้งคู่หรือ $1$ ทั้งคู่ เทอมนี้จะทำให้สถานะอ้างอิงเป็นศูนย์ และสามารถย้ายออกไปได้เช่นกัน

ให้ $|\psi_{\rm ref}\rangle = |z_0\cdots z_{n-1}\rangle$ โดยที่ $z_i \in \{0,1\}$
ดังนั้น เราสามารถเลือก
$$
\begin{equation*}
...
ตัวดำเนินการนี้ยังคงสอดคล้องกับ
...
เนื่องจากเทอม $ZZ$ กระทำในแนวทแยงบน $|\psi_0\rangle$ ในขณะที่เทอม $XX+YY$ ที่ถูกย้ายให้ค่าเป็นศูนย์
ค่าเฉพาะ (eigenvalue) ที่สอดคล้องกันจึงถูกกำหนดโดยเทอม $ZZ$ เท่านั้น
$$
\begin{equation*}
\tau = \sum_{i=0}^{n-2}
(-1)^{z_i}
...
ด้วยทางเลือกนี้ Hamiltonian ที่ถูกเลื่อนจะกลายเป็น:
$$
\begin{equation*}
H-T = \sum_{z_i\ne z_{i+1}}
\left(
...
ผลลัพธ์คือ มีเพียงขอบ (edge) ที่มีค่า occupation ต่างกันในสถานะอ้างอิงเท่านั้นที่ต้องวัด
เทอม $ZZ$ ทั้งหมดและเทอม $XX+YY$ ที่ไม่ทำงานทั้งหมดจะถูกสร้างขึ้นใหม่ผ่านส่วนร่วมของการทับซ้อน $\tau \mathcal{S}_{0d}$ หรือให้ผลลัพธ์เป็นศูนย์โดยธรรมชาติของโครงสร้าง

สิ่งนี้ทำให้ได้ observable ที่เล็กกว่าการเลื่อนเฉพาะส่วนแนวทแยงเท่านั้น
โดยเฉพาะอย่างยิ่ง สำหรับสถานะอ้างอิงฐานเชิงคำนวณที่มีการกระตุ้นเฉพาะจุด มีเพียงขอบที่อยู่ติดกับการกระตุ้นเท่านั้นที่ยังคงอยู่ใน $H-T$
ดังนั้น จำนวนเทอม Pauli ใน $X\otimes(H-T)$ และ $Y\otimes(H-T)$ จึงสามารถลดลงได้อย่างมาก ในขณะที่องค์ประกอบเมทริกซ์ที่สร้างขึ้นใหม่
$$
\begin{equation*}
\widetilde{\mathcal{H}}_{0d}
+
...
ตอนนี้เราจะเปลี่ยนวงจร extended-swap-test เชิงนามธรรมให้กลายเป็นเทมเพลตที่มุ่งเน้นฮาร์ดแวร์
ก่อนอื่น เราจะปรับให้วงจรเหมาะสมยิ่งขึ้นในระดับนามธรรมก่อน

#### เปรียบเทียบลำดับเทอมของ Hamiltonian {#compare-hamiltonian-term-ordering}

อันดับแรก เราจะเปรียบเทียบลำดับที่แตกต่างกันของเทอม Pauli ใน Heisenberg Hamiltonian สำหรับการจำลอง Hamiltonian
ตัว Hamiltonian เองไม่เปลี่ยนแปลง แต่ลำดับส่งผลต่อวิธีสร้างวงจร product-formula และปริมาณที่โครงสร้างสามารถขนานกันได้ในวงจร
ตัวอย่างเช่น ลำดับแบบไร้เดียงสาจะแสดงเทอม $XX$ ระหว่างเพื่อนบ้านที่ใกล้ที่สุดทั้งหมดก่อน ตามด้วยเทอม $YY$ ทั้งหมด แล้วจึงเป็นเทอม $ZZ$ ทั้งหมด
วิธีนี้วางขอบที่อยู่ติดกัน เช่น $(0,1)$ และ $(1,2)$ ไว้ใกล้กัน จึงไม่สามารถทำงานแบบขนานได้
ลำดับแบบเลขคู่แล้วเลขคี่จะเยี่ยมชมขอบเลขคู่ที่แยกจากกันก่อน ตามด้วยขอบเลขคี่ ซึ่งเผยให้เห็นชั้นสองคิวบิตที่ทำงานแบบขนานได้
ลำดับแบบจัดกลุ่มขอบเลขคู่-เลขคี่ไปไกลกว่านั้นอีกขั้น: สำหรับแต่ละขอบ จะเก็บเทอม $XX$, $YY$, และ $ZZ$ ในท้องถิ่นไว้ด้วยกัน ในขณะที่ยังคงเยี่ยมชมขอบเลขคู่ก่อนขอบเลขคี่
เราคาดหวังว่าลำดับแบบเลขคู่แล้วเลขคี่และแบบจัดกลุ่มขอบเลขคู่-เลขคี่จะลดความลึกของวงจรโดยการเผยให้เห็นชั้นสองคิวบิตที่ทำงานแบบขนานได้ และลำดับแบบจัดกลุ่มขอบจะลดความคลาดเคลื่อนของ Trotter เพิ่มเติมด้วย เนื่องจากปฏิสัมพันธ์สองคิวบิตในท้องถิ่นบนขอบเดียวกันถูกจัดการเป็นบล็อกที่กะทัดรัด

![Pauli evolutions with different term ordering](/docs/images/tutorials/krylov-quantum-diagonalization/ham_ordering.avif)

ลำดับของ Hamiltonian ยังส่งผลต่อความคลาดเคลื่อนของ Trotter ด้วย
ถ้าเราวางเทอมที่ไม่สลับที่กัน (noncommuting) ไว้ใกล้กัน การเปลี่ยนฐาน (basis transition) จะเกิดขึ้นบ่อยขึ้น ซึ่งก่อให้เกิดความคลาดเคลื่อนของ Trotter มากขึ้น
โดยการจัดกลุ่มเทอมที่ต้องการการแปลงฐาน Pauli แบบเดียวกัน การเปลี่ยนฐานที่ซ้ำซ้อนสามารถหลีกเลี่ยงได้

ในที่นี้ การเปรียบเทียบใช้เวลาวิวัฒนาการที่มากที่สุดที่ปรากฏในค่าประมาณ Krylov แถวแรก
$t_{\max} = (r-1)\Delta t,$
โดยใช้เงื่อนไขการ transpile เดียวกัน

เพื่อวัดความคลาดเคลื่อนของ Trotter เราใช้ **process infidelity** ระหว่างวงจรที่ผ่าน Trotterization กับวิวัฒนาการ Hamiltonian ที่แม่นยำ
$$
\begin{equation*}
\text{Infidelity}(U,V)
=
...
การวินิจฉัยนี้ใช้เมทริกซ์แบบหนาแน่น จึงเหมาะสำหรับตัวอย่าง 12 คิวบิตขนาดเล็กนี้ แต่ไม่ได้ตั้งใจให้เป็นซับรูทีนที่ขยายขนาดได้
...
อันดับแรก เราจะคงกฎการสังเคราะห์ไว้คงที่ที่ขั้น Trotter ลำดับที่หนึ่งขั้นเดียว และเปลี่ยนเฉพาะลำดับเทอม Pauli เท่านั้น
เป้าหมายของการเปรียบเทียบนี้ส่วนใหญ่คือเพื่อดูว่าความลึกของวงจรและต้นทุนสองคิวบิตสามารถลดลงได้มากเพียงใดโดยการเปิดเผยขอบเพื่อนบ้านที่ใกล้ที่สุดที่แยกจากกันแก่ transpiler
...
ที่ `reps=1` เราสังเกตว่าทั้งลำดับแบบเลขคู่แล้วเลขคี่และแบบจัดกลุ่มขอบเลขคู่-เลขคี่ต่างลดความลึกจาก 15 เหลือ 6 โดยการเผยให้เห็นชั้นสองคิวบิตที่ทำงานแบบขนานได้ ในขณะที่จำนวนเกตสองคิวบิตยังคงเท่าเดิมในทั้งสามลำดับ
อย่างไรก็ตาม ทั้งสามลำดับมี infidelity ใกล้ 1 ดังนั้นเราจึงกวาดจำนวนการทำซ้ำของ Trotter เพื่อแยกความแตกต่างของลำดับให้ชัดเจนยิ่งขึ้น
เมื่อจำนวนการทำซ้ำเพิ่มขึ้น infidelity ของลำดับ `even-odd edge-grouped` ลดลงเร็วกว่าอีกสองแบบ โดยถึง 0.045 ที่ `reps=8` เทียบกับ 0.075 สำหรับลำดับแบบไร้เดียงสาและแบบเลขคู่แล้วเลขคี่

#### เปรียบเทียบการสังเคราะห์ product-formula {#compare-product-formula-synthesis}

ต่อไป เราจะสำรวจการตั้งค่าขั้นสูงที่แตกต่างกันของ Trotterization โดยกำหนดลำดับ Hamiltonian ให้เป็นแบบจัดกลุ่มขอบเลขคู่-เลขคี่
เราพิจารณา Lie-Trotter ลำดับที่หนึ่ง, Suzuki-Trotter ลำดับที่สอง, และ Suzuki-Trotter ลำดับที่สี่
...
Lie-Trotter ให้วงจรที่ตื้นที่สุดแต่มีความคลาดเคลื่อนมากที่สุด ในขณะที่ Suzuki-Trotter ลำดับที่สี่มีความแม่นยำมากกว่าแต่เพิ่มความลึกของวงจร
สำหรับส่วนที่เหลือของบทเรียนนี้ เราเลือก Suzuki-Trotter ลำดับที่สอง เพราะให้วงจรที่มีความลึกน้อยในขณะที่ลดความคลาดเคลื่อนของ Trotter ลงอย่างมากเมื่อเทียบกับสูตรลำดับที่หนึ่ง

#### ลบเกตวิวัฒนาการเวลาแบบมีเงื่อนไข {#remove-the-controlled-time-evolution-gate}

ใน extended swap test การควบคุมวิวัฒนาการเวลาด้วย ancilla qubit ตัวเดียวต้องการให้ ancilla ควบคุมเกตจำนวนมากทั่วทั้งระบบ
สิ่งนี้อาจก่อให้เกิดค่าใช้จ่ายในการจัดเส้นทาง (routing) จำนวนมาก และในกรณีที่แย่ที่สุด อาจต้องการการเชื่อมต่อแบบ all-to-one อย่างมีประสิทธิผล
เพื่อหลีกเลี่ยงสิ่งนี้ การปรับให้เหมาะสมเพิ่มเติมสามารถทำได้โดยแทนที่เกตวิวัฒนาการเวลาแบบมีเงื่อนไขด้วยเวอร์ชันที่ไม่มีเงื่อนไข โดยใช้ประโยชน์จากความสมมาตรของ Hamiltonian
ลองสังเกตวงจรต่อไปนี้

![circuit optimization](/docs/images/tutorials/krylov-quantum-diagonalization/circuit_opt.avif)

ในที่นี้ $B_{\rm ref}$ เตรียมสถานะอ้างอิง $B_{\rm ref}|0^n\rangle = |\psi_{0}\rangle$

แทนที่จะเตรียม $\frac{1}{\sqrt{2}}(|0\rangle+|1\rangle)|\psi_0\rangle$ ก่อนแล้วจึงใช้ $U(t)$ เฉพาะกับกิ่ง $|1\rangle$ วงจรนี้เตรียมทั้งสองกิ่งโดยตรงเป็น
...
วงจรใช้เกต Hadamard กับ ancilla ก่อน แล้วเตรียมสถานะอ้างอิงเฉพาะกับกิ่ง $|1\rangle$:
...
จากนั้นตัวดำเนินการวิวัฒนาการเวลาที่ไม่มีเงื่อนไขจะถูกใช้กับทั้งสองกิ่ง:
...
เนื่องจาก Hamiltonian รักษาจำนวนการกระตุ้นไว้ เราจึงเห็นได้ว่า $|0^n\rangle$ เป็นสถานะเฉพาะของมัน ดังนั้น
ตัวดำเนินการวิวัฒนาการจึงสะสมเพียงเฟสภายใต้ Hamiltonian เท่านั้น:
$$
\begin{equation*}
U(t)|0^n\rangle
=
...
ต่อไป $B_{\rm ref}$ จะถูกใช้เฉพาะกับกิ่ง $|0\rangle$
...
ณ จุดนี้ ทั้งสองกิ่งมีเฟสสัมพัทธ์เพิ่มเติม เพื่อลบมันออกไป เราใช้เกตเฟส ancilla
...
ดังนั้น หากไม่นับเฟสโกลบอลที่ไม่เกี่ยวข้อง เราจึงเตรียมได้ในที่สุด
...
ในบล็อกโค้ดถัดไป เราจะนำวงจรที่ไม่มีเงื่อนไขนี้ไปใช้งาน
...
ตอนนี้ เราจะ transpile วงจรแบบมีเงื่อนไขและไม่มีเงื่อนไขให้สามารถรันได้บนฮาร์ดแวร์
ลองเปรียบเทียบผลลัพธ์ของวงจรที่ผ่านการ transpile แล้ว
...
ขั้นตอนถัดไปคือการส่งวงจรที่มีพารามิเตอร์เดียวกันสำหรับค่า $d$ หลายค่า สำหรับแต่ละ $d$ เราประมาณค่าคาดหวังสี่ค่า: $X\otimes I$, $Y\otimes I$, $X\otimes (H-T)$, และ $Y\otimes (H-T)$ จากนั้นตัวเลขทั้งสี่นี้จะถูกรวมเข้าเป็นองค์ประกอบแถวแรกเชิงซ้อน $\mathcal{S}_{0d}$ และ $\mathcal{H}_{0d}$

ในที่นี้ $\mathcal{S}_{00}=1$ และ $\mathcal{H}_{00}=\langle\psi_{0}|(H-T)|\psi_{0}\rangle=\langle\psi_{0}|H|\psi_{0}\rangle-\tau$ สามารถคำนวณแบบคลาสสิกได้เนื่องจาก $\lvert\psi_0\rangle$ เป็นแบบ sparse ดังนั้นเราจึงข้ามกรณี $d=0$
...
### ขั้นตอนที่ 4: ประมวลผลหลังการรันและคืนค่าผลลัพธ์ในรูปแบบคลาสสิกที่ต้องการ {#step-4-post-process-and-return-result-in-desired-classical-format}
หลังจากประมาณค่าเมทริกซ์ที่ถูกฉายแล้ว เราจะทำ regularize และแก้ GEVP
$$
\begin{equation*}
\mathcal{H}\mathbf{c} = E\mathcal{S}\mathbf{c}.
\end{equation*}
$$
ค่าเฉพาะทั่วไป (generalized eigenvalue) ที่เล็กที่สุดให้ค่าประมาณ KQD ของพลังงานสถานะพื้น
...
ตอนนี้เราแก้ปัญหาค่าเฉพาะทั่วไป (generalized eigenvalue problem) โดยใช้เมทริกซ์ที่สร้างขึ้นใหม่จากการประมาณค่าของวงจร
ในการคำนวณ statevector ในอุดมคติที่มีวิวัฒนาการเวลาจริงที่แม่นยำ สิ่งนี้ควรให้ผลลัพธ์ที่ถูกฉายที่แม่นยำเหมือนกัน
ในทางปฏิบัติ ความเบี่ยงเบนอาจมาจาก Trotterization ความคลาดเคลื่อนจากการสุ่มตัวอย่าง และความไม่เสถียรเชิงตัวเลขของเมทริกซ์การทับซ้อน

เราสังเกตว่าพลังงานลู่เข้าอย่างไรเมื่อเราเพิ่มมิติของปริภูมิย่อย Krylov
...
ส่วนก่อนหน้าใช้โมเดล 12 คิวบิตเพื่อให้การจำลอง statevector สามารถใช้เป็นเครื่องมือวินิจฉัยได้ ตอนนี้เราจะขยายขนาดขั้นตอนการทำงาน KQD เดียวกันไปยังโซ่ Heisenberg 30 คิวบิต และเตรียมภาระงานสำหรับการรันบนฮาร์ดแวร์ IBM Quantum

### ขั้นตอนที่ 1-4 ถูกบีบอัดเป็นบล็อกโค้ดเดียว {#steps-1-4-compressed-into-a-single-code-block}

ที่นี่เราจะรวมรายละเอียดทั้งหมดเหล่านี้เข้าด้วยกันเป็นขั้นตอนการทำงานเดียวในระดับที่ใหญ่ขึ้น ซึ่งจากนั้นจะรันบนฮาร์ดแวร์ควอนตัมจริงของเรา ในส่วนนี้ เราจะใช้การตั้งค่าการลดข้อผิดพลาดที่สมจริงเพื่อปรับปรุงความน่าเชื่อถือของผลลัพธ์ เนื่องจากองค์ประกอบเมทริกซ์ที่สอดคล้องกับค่า $d$ ที่แตกต่างกันสามารถประเมินผลแบบขนานได้ เราจึงใช้โหมด `Batch` เพื่อรันอย่างมีประสิทธิภาพ
...
## ภาคผนวก: มุมมองฟังก์ชัน Hamiltonian (spectral-filter) {#appendix-the-hamiltonian-function-spectral-filter-viewpoint}

ขั้นตอนการทำงานหลักนำเสนอ KQD ในเชิงปฏิบัติการ: สร้างฐาน Krylov จากสถานะที่ผ่านวิวัฒนาการเวลาจริง ประมาณค่าเมทริกซ์ที่ถูกฉาย $\mathcal{H}$ และ $\mathcal{S}$ และแก้ GEVP
ภาคผนวกนี้ทบทวนการคำนวณ *เดียวกัน* จากมุมมองเสริมที่อธิบาย**ว่าทำไม** KQD จึงทำงานได้: มุมมอง *ฟังก์ชัน Hamiltonian* หรือ *spectral-filter* [\[3\]](#references), [\[5\]](#references)
มันใช้โมเดล 12 คิวบิต ขั้นเวลา $\Delta t$ และผลเฉลย Krylov ที่ได้มาแล้วข้างต้นซ้ำอีกครั้ง ไม่จำเป็นต้องรันวงจรใหม่

### สถานะอ้างอิงในฐานะการกระจายพลังงาน {#the-reference-state-as-an-energy-distribution}

ให้ Hamiltonian มีการแยกส่วนค่าเฉพาะ (eigendecomposition)
...
ด้วยสถานะเฉพาะพลังงาน $|E_m\rangle$
สถานะอ้างอิงใดๆ สามารถขยายในฐานเฉพาะ (eigenbasis) นี้ได้
...
ดังนั้นมันจึงมี **น้ำหนักสเปกตรัม (spectral weight)** $p_m=|a_m|^2$ ที่แต่ละพลังงาน $E_m$
พลังงานอ้างอิงคือค่าเฉลี่ยของการกระจายนี้ $\langle H\rangle_{0}=\sum_m p_m E_m$

การแยกส่วนค่าเฉพาะของ Hamiltonian แบบทั่วไปที่มี $n$ คิวบิตมีค่าใช้จ่ายที่เพิ่มขึ้นแบบเลขชี้กำลัง ดังนั้นภาพนี้จึงเป็นเพียงเครื่องมือวินิจฉัยเท่านั้น ซึ่ง *ไม่ใช่* ส่วนหนึ่งของอัลกอริทึม
อย่างไรก็ตาม ในที่นี้เราสามารถคำนวณมันได้อย่างประหยัดสำหรับปัญหา $n=12$ *เดียวกัน*: Heisenberg Hamiltonian รักษาจำนวนการกระตุ้นทั้งหมดไว้ และสถานะอ้างอิง $|000001000000\rangle$ มีการกระตุ้นเดียว ดังนั้นเนื้อหาสเปกตรัมทั้งหมดของมันจึงอยู่ในปริภูมิย่อยการกระตุ้นเดียวซึ่งมิติเติบโตเชิงเส้นตาม $n$ เท่านั้น
เราจึงใช้บล็อกการกระตุ้นเดียวที่แม่นยำ (ที่ใช้แล้วข้างต้นเป็นเกณฑ์เปรียบเทียบ) ซ้ำอีกครั้ง และอ่านค่าการกระจายอ้างอิง $\{(E_m, p_m)\}$ ภายในปริภูมิย่อยนั้น
...
### KQD เรียนรู้ตัวกรองที่ปรับรูปการกระจายนี้ {#kqd-learns-a-filter-that-reshapes-this-distribution}

**ฟังก์ชัน Hamiltonian** $f(H)$ ถูกกำหนดผ่านแคลคูลัสสเปกตรัม
...
หรือกล่าวอีกนัยหนึ่งคือ ผลรวมถ่วงน้ำหนักของตัวฉายค่าเฉพาะ (eigenprojector)
การใช้มันกับสถานะอ้างอิงจะปรับรูปแอมพลิจูดสเปกตรัมแต่ละตัว $a_m \to a_m f(E_m)$:
...
ถ้า $f$ มีจุดสูงสุดแหลมชันที่พลังงานต่ำสุด ($f(E_0)=1$ และ $f(E_m)\approx 0$ ในกรณีอื่น) แล้ว $f(H)$ จะทำหน้าที่เป็นตัวฉายสถานะพื้น และผลลัพธ์ที่ทำให้เป็นบรรทัดฐานแล้วจะ (เกือบ) เป็นสถานะพื้น
ดังนั้น **spectral filter** แบบ low-pass ที่ดีในเชิงพลังงานจึงเป็นสิ่งที่เราต้องการอย่างแท้จริง

KQD ไม่ได้กำหนด $f$ ไว้ล่วงหน้า แต่จะขยายตัวกรองในฐานวิวัฒนาการเวลาจริงแทน
...
ฟังก์ชัน *ตรีโกณมิติ* ของพลังงานซึ่งสัมประสิทธิ์ $\{c_\ell\}$ ของมันเป็นเวกเตอร์เฉพาะ (eigenvector) ของ GEVP ที่แก้ไว้ข้างต้นพอดี
การทำให้ Rayleigh quotient $\mathbf{c}^\dagger\mathcal{H}\mathbf{c}/\mathbf{c}^\dagger\mathcal{S}\mathbf{c}$ น้อยที่สุดจึงเหมือนกับการ *เรียนรู้* ตัวกรองที่ระงับน้ำหนักสถานะกระตุ้นของสถานะอ้างอิงได้ดีที่สุด
มิติ Krylov $r$ ที่มากขึ้นให้ตัวกรองมีองศาความอิสระมากขึ้นและมีจุดสูงสุดที่แหลมชันกว่าที่พลังงานสถานะพื้น

ตัวช่วยด้านล่างประเมินตัวกรองที่เรียนรู้แล้วนี้บนแกนพลังงาน จากนั้นเราจะใช้มันกับการกระจายอ้างอิงที่ได้มาข้างต้น
...
### แสดงภาพตัวกรองและความยืดหยุ่นของมัน {#visualize-the-filter-and-its-flexibility}

อันดับแรก เราแสดงตัวกรองที่เรียนรู้แล้วที่มิติ Krylov เต็มที่ใช้ข้างต้น จากนั้นติดตามว่ามันแหลมชันขึ้นอย่างไรเมื่อมิติ $r$ เพิ่มขึ้น

แท่งกราฟแสดงน้ำหนักสเปกตรัมอ้างอิง $p_m$ (ก่อน) และน้ำหนักที่ผ่านการกรองแล้ว $p_m|f_{\rm KQD}(E_m)|^2$ (หลัง) พร้อมด้วยความเข้มของตัวกรองที่เรียนรู้แล้ว $|f_{\rm KQD}(E)|^2$ บนแกนพลังงานต่อเนื่อง
ตัวกรองรวมน้ำหนักไปที่พลังงานต่ำสุดของปริภูมิย่อยการกระตุ้นเดียว &mdash; พลังงานเดียวกับที่ค่าประมาณ KQD ลู่เข้าในตัวอย่างขนาดเล็ก
โปรดสังเกตว่านี่คือสถานะพื้น *ภายในภาคการกระตุ้นเดียว* ซึ่งเป็นเป้าหมายที่เกี่ยวข้องสำหรับสถานะอ้างอิงที่รักษาการกระตุ้นนี้ ไม่ใช่สถานะพื้นแบบโกลบอล
...
### การเพิ่มมิติ Krylov: ความยืดหยุ่นของฟังก์ชันที่เรียนรู้แล้ว {#increasing-the-krylov-dimension-flexibility-of-the-learned-function}

โปรดจำไว้ว่าตัวกรองที่เรียนรู้แล้วเป็นพหุนามตรีโกณมิติในพลังงานที่มีสัมประสิทธิ์ $r$ ตัว
...
มิติ Krylov $r$ คือจำนวนสัมประสิทธิ์อิสระพอดี ดังนั้นมันจึงควบคุม**ความยืดหยุ่น**ของฟังก์ชัน
$r$ ที่เล็กสามารถสร้างได้เพียงตัวกรองที่กว้างและแปรผันอย่างนุ่มนวลซึ่งรั่วน้ำหนักเข้าไปในสถานะกระตุ้นระดับต่ำ เมื่อ $r$ เพิ่มขึ้น ตัวกรองสามารถสร้างจุดสูงสุดที่แคบกว่าที่พลังงานเป้าหมาย และระงับน้ำหนักสถานะกระตุ้นที่เหลืออยู่ได้อย่างมีประสิทธิภาพมากขึ้น
นี่คือคู่เทียบเชิง spectral-filter ของการลู่เข้าของพลังงานที่สังเกตได้ในตัวอย่างขนาดเล็ก: เมื่อ $r$ เพิ่มขึ้น การกระจายที่ผ่านการกรองแล้วจะยุบตัวลงสู่สถานะพื้นของปริภูมิย่อย และพลังงานที่ประมาณได้จะลดลงเข้าใกล้มัน

เราใช้เมทริกซ์ที่ถูกฉายซึ่งประมาณค่าไว้แล้วข้างต้นซ้ำอีกครั้ง และเพียงแค่แก้ GEVP ที่แต่ละบล็อก $r\times r$ ที่นำหน้า จากนั้นประเมินและพล็อตตัวกรองที่สอดคล้องกัน
