...
ในรูป เส้นและพื้นที่สีเทาแสดงขอบเขต เส้นด้านนอกสุด (เส้นประสลับจุด) แสดงขอบเขตควอนตัม ($\pm 2\sqrt{2}$) ส่วนเส้นด้านใน (เส้นประ) แสดงขอบเขตคลาสสิก ($\pm 2$) คุณจะเห็นว่ามีบางบริเวณที่ปริมาณ CHSH witness เกินขอบเขตคลาสสิก ยินดีด้วย! คุณได้แสดงให้เห็นการละเมิดอสมการ CHSH ในระบบควอนตัมจริงสำเร็จแล้ว!
