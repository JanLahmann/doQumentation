...
* สาธิตการใช้ [operator backpropagation (OBP)](https://qiskit.github.io/qiskit-addon-obp/) เพื่อลดความลึกของ Circuit เทคนิคนี้ตัดการดำเนินการออกจากปลาย Circuit โดยแลกกับการวัด operator มากขึ้น
...
ถัดไป ยืนยันตัวตนโดยใช้ API key จากแดชบอร์ด [IBM Quantum Platform](http://quantum.cloud.ibm.com/) จากนั้นเลือก Qiskit Function ดังนี้ (สำหรับความปลอดภัย แนะนำให้ [บันทึก credentials ไว้ในสภาพแวดล้อมโลคัล](/guides/functions-get-started#install-qiskit-functions-catalog-client) หากอยู่บนเครื่องที่เชื่อถือได้ เพื่อไม่ต้องกรอก API key ทุกครั้งที่ยืนยันตัวตน)
...
ตอนนี้เราจะใช้ operator backpropagation (OBP) (ดูเอกสาร [OBP](https://qiskit.github.io/qiskit-addon-obp/) สำหรับรายละเอียดเพิ่มเติมเกี่ยวกับ OBP Qiskit addon) เราจะสร้างฟังก์ชันที่สร้าง circuit slices สำหรับการ backpropagation:
