...
ตัวเลือกแบบกำหนดเองสำหรับตัวเรียนรู้สัญญาณรบกวนก็สามารถส่งได้เช่นกัน ซึ่งเป็นไปตามคำนิยามที่ใช้ใน `qiskit-ibm-runtime` [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options):
