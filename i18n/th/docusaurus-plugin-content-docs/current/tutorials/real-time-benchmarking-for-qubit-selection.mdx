...
ไม่ใช่ทุกการรันที่จะแสดงการปรับปรุงประสิทธิภาพจากการ characterization แบบ real-time - และเมื่อความยาวของ chain เพิ่มขึ้น ทำให้มีอิสระในการเลือกคิวบิตทางกายภาพน้อยลง ความสำคัญของข้อมูลอุปกรณ์ที่อัปเดตก็จะลดลง อย่างไรก็ตาม เป็นแนวปฏิบัติที่ดีที่จะเก็บข้อมูลใหม่เกี่ยวกับคุณสมบัติของอุปกรณ์เพื่อทำความเข้าใจประสิทธิภาพของมัน บางครั้ง transient two-level system อาจส่งผลต่อประสิทธิภาพของคิวบิตบางตัว ข้อมูล real-time สามารถแจ้งให้เราทราบเมื่อเหตุการณ์เช่นนี้เกิดขึ้น และช่วยให้เราหลีกเลี่ยงความล้มเหลวของการทดลองในกรณีเช่นนี้ได้
<Admonition type="note" title="เรียกร้องให้ลงมือทำ">
ลองนำวิธีนี้ไปใช้กับการรันของคุณ และดูว่าคุณได้ประโยชน์มากแค่ไหน! คุณยังสามารถลองดูว่าคุณได้รับการปรับปรุงมากแค่ไหนจาก backend ที่แตกต่างกัน
</Admonition>
...
[ลิงก์ไปยังแบบสำรวจ](https://your.feedback.ibm.com/jfe/form/SV_0w6FZ9QrWkKfTQq)
