...
ผลลัพธ์จากการรันฟังก์ชันมีรูปแบบเดียวกับ [Estimator](/guides/estimator-input-output)
