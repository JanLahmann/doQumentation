...
> **หมายเหตุ:** แบบสำรวจนี้จัดทำโดย **IBM Quantum** และครอบคลุม **เนื้อหาบทช่วยสอน** (เขียนโดย IBM) doQumentation เป็นผู้ให้บริการเว็บไซต์ การแปล และการรันโค้ด — หากต้องการให้ข้อเสนอแนะเกี่ยวกับสิ่งเหล่านั้น โปรด [เปิด GitHub issue](https://github.com/JanLahmann/doQumentation/issues)
