---
description: 'ตัวอย่างเชิงปฏิบัติของการใช้ IBM Quantum Estimator primitive'
...
- [ระบุตัวเลือกรันไทม์ขั้นสูง](runtime-options-overview)
- ฝึกฝนกับ primitives โดยศึกษา [บทเรียนฟังก์ชันต้นทุน](/learning/courses/variational-algorithm-design/cost-functions) ใน IBM Quantum&reg; Learning
- เรียนรู้วิธีการแปล (transpile) ในเครื่องได้ที่ส่วน [Transpile](/guides/transpile/)
- ลองใช้คู่มือ [เปรียบเทียบการตั้งค่าตัวแปลง](/guides/circuit-transpilation-settings)
- ทำความเข้าใจ [ขีดจำกัดของงาน](/guides/job-limits) เมื่อส่งงานไปยัง QPU ของ IBM&reg;
</Admonition>
