...
ดูตัวอย่างการใช้ Qiskit Code Assistant สำหรับ [Circuit](/guides/circuit-library) [การกำหนดค่า error suppression](/guides/error-mitigation-and-suppression-techniques) และ [การ transpile ด้วย pass managers](/guides/transpile-with-pass-managers)
</Admonition>
