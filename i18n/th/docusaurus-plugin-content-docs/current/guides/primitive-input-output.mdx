---
description: 'ทำความเข้าใจรูปแบบอินพุตและเอาต์พุต (รวมถึง Primitive Unified Blocs หรือ PUBs) ของ Qiskit SDK primitives'
...
เมื่อ PUB หนึ่งตัวหรือมากกว่านั้นถูกส่งไปยัง QPU เพื่อรัน และงานเสร็จสมบูรณ์ ข้อมูลจะถูกส่งกลับมาเป็นอ็อบเจ็กต์คอนเทนเนอร์ [`PrimitiveResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PrimitiveResult) `PrimitiveResult` มีรายการที่วนซ้ำได้ของอ็อบเจ็กต์ [`PubResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PubResult) ที่มีผลลัพธ์การรันสำหรับแต่ละ PUB ตัวอย่างเช่น งานที่ส่งด้วย 20 PUB จะส่งกลับอ็อบเจ็กต์ `PrimitiveResult` ที่มีรายการของ `PubResults` 20 รายการ แต่ละรายการสอดคล้องกับแต่ละ PUB
...
<Admonition type="tip" title="คำแนะนำ">
  ...
  -  ดู [Qiskit SDK primitives](https://docs.quantum.ibm.com/api/qiskit/primitives) API

  -  ดู API ของ [Qiskit Aer primitives](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html)

  -  เรียนรู้เพิ่มเติมเกี่ยวกับ [IBM Quantum primitives](/guides/qiskit-runtime-primitives)

  -  ดู [`qiskit-ibm-runtime` Estimator](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2) API

  -  ดู [`qiskit-ibm-runtime` Sampler](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2) API
</Admonition>
