...
<Admonition type="tip">
**Qiskit Serverless กำลังได้รับการอัปเกรด และฟีเจอร์ต่าง ๆ กำลังเปลี่ยนแปลงอย่างรวดเร็ว** ในช่วงการพัฒนานี้ สามารถค้นหา release notes และเอกสารล่าสุดได้ที่หน้า [Qiskit Serverless GitHub](https://qiskit.github.io/qiskit-serverless/index.html)
</Admonition>
...
ตรวจสอบให้แน่ใจว่าคุณได้ทำตามขั้นตอนใน [เขียนโปรแกรม Qiskit Serverless แรกของคุณ](/guides/serverless-first-program) ก่อนเริ่มต้น

## แสดงรายการโปรแกรมที่มี {#list-programs-available}

คุณสามารถใช้ `QiskitServerless.list()` เพื่อดึงรายการโปรแกรมที่มีสำหรับรันด้วย Qiskit Serverless ซึ่งรวมถึง [`transpile_remote_serverless`](/guides/serverless-first-program) ที่อัปโหลดไว้ก่อนหน้า
...
- สำรวจ[เครื่องมือจัดการการคำนวณและข้อมูล](/guides/serverless-manage-resources) ที่มีสำหรับโปรแกรมของคุณ รวมถึงการประมวลผลแบบขนาน
