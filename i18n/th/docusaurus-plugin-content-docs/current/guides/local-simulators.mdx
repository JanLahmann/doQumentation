---
description: 'ย้ายจาก IBM Quantum cloud simulators มาใช้ `qiskit-ibm-runtime` local testing mode'
title: 'ย้ายไปใช้ local simulators'
---

{/* doqumentation-source-hash: 9db328b8 */}

# ย้ายจาก cloud simulators ไปสู่ local simulators {#migrate-to-local-simulators}
...
<Accordion>
<AccordionItem title="ตัวจำลองมีข้อจำกัด">
...
<AccordionItem title="การใช้ฮาร์ดแวร์ควอนตัมสร้างทักษะที่เป็นเอกลักษณ์">
...
<AccordionItem title="อัลกอริทึมควรถูกปรับให้เหมาะกับฮาร์ดแวร์ควอนตัม">
...
## ย้ายไปใช้ local simulators {#migrate-to-local-simulators-1}
