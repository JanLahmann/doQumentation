...
*ดู [เอกสารอ้างอิง API](https://docs.quantum.ibm.com/api/functions/kipu-optimization)*

<Admonition type="note" title="หมายเหตุ">
* Qiskit Functions เป็นฟีเจอร์ทดลองที่ใช้ได้เฉพาะกับผู้ใช้ IBM Quantum&reg; Premium Plan, Flex Plan และ On-Prem Plan (ผ่าน IBM Quantum Platform API) เท่านั้น ฟีเจอร์นี้อยู่ในสถานะ preview release และอาจมีการเปลี่ยนแปลงได้
</Admonition>
