...
## Input และ Output {#inputs-and-outputs}
...
### เนื้อหา result dictionary {#result-dictionary-contents}
...
#### การ execution มาตรฐาน {#standard-execution}
...
#### การวิเคราะห์ transpile {#transpilation-analysis}
