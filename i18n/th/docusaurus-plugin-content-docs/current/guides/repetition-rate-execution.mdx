...
## ระบุ `rep_delay` สำหรับ primitive job {#specify-rep-delay-for-a-primitive-job}

<Admonition type="note" title="ตรวจสอบค่า rep_delay สำหรับ QPU">
...
<Admonition type="tip" title="คำแนะนำ">
  ...
  - ทบทวนวิธี [เริ่มต้นใช้งาน Estimator](/guides/get-started-with-estimator)
  - ทบทวนวิธี [เริ่มต้นใช้งาน Sampler](/guides/get-started-with-sampler)
</Admonition>
