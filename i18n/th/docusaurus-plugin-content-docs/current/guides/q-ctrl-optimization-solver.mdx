...
- การแทนปัญหาเฉพาะประเภทด้วย Graph ควรสร้าง graph โดยใช้ library networkx ใน Python แล้วแปลงเป็น string ด้วยฟังก์ชัน networkx `[nx.readwrite.json_graph.adjacency_data](http://nx.readwrite.json_graph.adjacency_data.)`
...
![ผลลัพธ์ของ code cell ก่อนหน้า](/docs/images/guides/q-ctrl-optimization-solver/extracted-outputs/0a7255e1-0.svg)
...
![ผลลัพธ์ของ code cell ก่อนหน้า](/docs/images/guides/q-ctrl-optimization-solver/extracted-outputs/c2ce65e3-0.svg)
