...
4. หาก `twirling` เปิดใช้งาน จะใช้ผลคูณของ `num_randomizations` และ `shots_per_randomization` ตามที่ระบุเป็น [`twirling` options](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-twirling-options)
