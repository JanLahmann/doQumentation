...
## คำศัพท์ fair-share {#fair-share-terms}

* **Account:** บุคคลและองค์กรใช้ IBM Cloud&reg; account เพื่อเข้าถึง IBM Quantum&reg; Platform และ IBM Quantum Compute Service
...
## การจัดสรรและการบริหาร {#allocation-and-administration}
...
## วิธีการทำงานของ fair-share scheduler {#how-the-fair-share-scheduler-works}
