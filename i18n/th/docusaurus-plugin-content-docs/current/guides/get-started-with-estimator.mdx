---
description: 'คู่มือเริ่มต้นอย่างรวดเร็วเกี่ยวกับวิธีใช้ IBM Quantum Estimator primitive'
...
### 3. เริ่มต้น IBM Quantum Estimator {#3-initialize-the-ibm-quantum-estimator}
