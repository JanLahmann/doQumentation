...
สำหรับตัวอย่างฉบับสมบูรณ์ ดูหน้า [ตัวอย่าง Estimator](/guides/estimator-examples)
...
:::tip[Transpile to ISA circuits and observables]
  ...
  ขั้นตอนการทำงานของ IBM Quantum primitives ต้องการให้ Circuit ถูกแปลงให้ใช้เฉพาะคำสั่งที่รองรับโดย QPU (เรียกว่า ISA circuits) Reference primitives ยังคงรับคำสั่งแบบ abstract ได้ เนื่องจากพึ่งพาการจำลอง statevector แบบ local แต่การ transpile Circuit อาจยังเป็นประโยชน์ในแง่ของการปรับแต่ง Circuit
...
สำหรับตัวอย่างฉบับสมบูรณ์ ดูหน้า [ตัวอย่าง Sampler](/guides/sampler-examples)
