...
ตัวอย่างเหล่านี้ใช้ `FakeSherbrooke` mock backend จาก `qiskit_ibm_runtime` แต่คุณสามารถลองใช้กับ Backend จริงหรือ fake ใดๆ ที่เข้ากันได้กับ Qiskit ผลลัพธ์ของคุณอาจแตกต่างออกไป
</Admonition>
