...
* การเตรียมสถานะควอนตัมอย่างมีประสิทธิภาพ เช่น [GHZ state](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339), [W-state](https://arxiv.org/abs/2403.07604) (สำหรับข้อมูลเพิ่มเติมเกี่ยวกับ W-state สามารถดูได้ที่ ["State preparation by shallow circuits using feed forward"](https://arxiv.org/abs/2307.14840)) และกลุ่มที่กว้างขวางของ [matrix product states](https://arxiv.org/abs/2404.16083)

* [การพัวพันระยะไกลอย่างมีประสิทธิภาพ](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339) ระหว่างคิวบิตบนชิปเดียวกันโดยใช้วงจรตื้น

* [การสุ่มตัวอย่างวงจรแบบ IQP อย่างมีประสิทธิภาพ](https://arxiv.org/pdf/2505.04705)
Qiskit รองรับโครงสร้างควบคุมการไหล 4 แบบสำหรับ classical feedforward ซึ่งแต่ละแบบถูกนำไปใช้เป็นเมธอดบน [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit) โครงสร้างเหล่านี้และเมธอดที่สอดคล้องกันมีดังนี้:
...
แต่ละ method เหล่านี้ return [context manager](https://docs.python.org/3/reference/datamodel.html#with-statement-context-managers) และมักใช้ใน `with` statement คู่มือนี้จะอธิบาย construct แต่ละอย่างและวิธีใช้งาน

<Admonition type="caution">
  มีข้อจำกัดบางประการของ classical feedforward และ control flow operations บนฮาร์ดแวร์ควอนตัมที่อาจส่งผลต่อโปรแกรมของคุณ สำหรับข้อมูลเพิ่มเติม ดูที่ [Execute dynamic circuits](/guides/execute-dynamic-circuits)
</Admonition>
...
โมดูล classical expression ของ Qiskit [`qiskit.circuit.classical`](https://docs.quantum.ibm.com/api/qiskit/circuit_classical) ประกอบด้วยการแสดงผลเชิงทดลองของการดำเนินการ runtime บนค่า classical ระหว่างการรัน Circuit
