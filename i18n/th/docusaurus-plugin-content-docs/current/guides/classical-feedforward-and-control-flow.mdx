...
Qiskit รองรับ control flow constructs สำหรับ classical feedforward สี่รูปแบบ แต่ละรูปแบบถูก implement เป็น method บน [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit) โดย constructs และ method ที่เกี่ยวข้องได้แก่:
