...
จากนั้น authenticate โดยใช้ [IBM Quantum&reg; API key](http://quantum.cloud.ibm.com/) และสมมติว่าคุณได้ [บันทึกบัญชีของคุณ](/guides/functions-get-started#install-qiskit-functions-catalog-client) ในสภาพแวดล้อมในเครื่องแล้ว เลือก Qiskit Function ดังนี้:
...
ตัวอย่างนี้ใช้ 16 Qubits กับ 8 orbitals ของ basis sto3g สำหรับโมเลกุล NH3
...
โปรดทราบว่าการใช้งาน Qiskit Function นี้จำกัดเฉพาะปัญหาที่ต้องใช้ Qubits ไม่เกิน 20 ตัว เว้นแต่จะได้รับใบอนุญาตที่อนุญาตให้ใช้จำนวนสูงกว่า

ส่งอีเมลไปที่ [qiskit.support@qunovacomputing.com](mailto:qiskit.support@qunovacomputing.com) สำหรับข้อสอบถามเกี่ยวกับ license

### ตัวอย่างการใช้ function ที่มี license {#example-of-licensed-function-use}

ผู้ใช้ที่มี license จะได้รับ license token และต้องใช้ wrapper library เพื่อส่ง license token ของตนไปยัง function
สามารถติดตั้ง wrapper library ได้ [จาก PyPI](https://pypi.org/project/hivqe-qiskit-function-utils/) ด้วย `pip install hivqe-qiskit-function-utils`
ตัวอย่างด้านล่างแสดงวิธีใช้ library นี้เพื่อส่ง license token เมื่อเรียกใช้ function
