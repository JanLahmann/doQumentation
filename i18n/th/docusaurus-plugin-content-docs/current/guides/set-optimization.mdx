...
การปรับระดับการปรับแต่งสามารถเปลี่ยนแปลงด้านอื่นๆ ของ Circuit ได้เช่นกัน ไม่ใช่แค่จำนวน ECR Gate สำหรับตัวอย่างว่าการตั้งค่าระดับการปรับแต่งเปลี่ยน layout อย่างไร ดู [การแสดงคอมพิวเตอร์ควอนตัม](/guides/represent-quantum-computers)
