...
# สร้างและรัน Qiskit Function template สำหรับการจำลองโครงสร้างอิเล็กทรอนิกส์ด้วยโมเดล implicit solvent {#build-and-run-a-qiskit-function-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
สำหรับคำอธิบายทีละขั้นตอนของ workflow เดียวกันนี้พร้อมตัวอย่างที่ทำเสร็จแล้ว ดูบทช่วยสอน [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations)
...
#### 1. รวบรวม input และ map ปัญหา {#1-collect-input-and-map-the-problem}
...
#### 2. Optimize Circuit {#2-optimize-the-circuit}
...
#### 3. รัน Circuit {#3-execute-the-circuit}
...
#### 4. Post-process ด้วย SQD {#4-post-process-by-using-sqd}
...
<Accordion>
<AccordionItem title="คลิกเพื่อขยายดูรายละเอียดเพิ่มเติมเกี่ยวกับ options ที่จำเป็น:">
...
<Accordion>
<AccordionItem title="คลิกเพื่อขยายดูข้อมูลเพิ่มเติมเกี่ยวกับการกำหนดค่า SQD options:">
...
## การอ้างอิงโปรเจกต์นี้ {#cite-this-project}

หากคุณใช้ SQD IEF-PCM template ในงานวิจัยของคุณ โปรดดู [repository](https://github.com/qiskit-community/qiskit-function-templates/tree/main/chemistry/sqd_pcm#citing-this-project) สำหรับข้อมูลการอ้างอิงโดยละเอียด

## ขั้นตอนถัดไป {#next-steps}

<Admonition type="info" title="คำแนะนำ">

- ทำตามบทช่วยสอน [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations) สำหรับตัวอย่างที่ทำเสร็จแล้วของ workflow เดียวกันนี้

- อ่านคู่มือการสร้าง function template สำหรับ [Hamiltonian simulation](/guides/function-template-hamiltonian-simulation)
