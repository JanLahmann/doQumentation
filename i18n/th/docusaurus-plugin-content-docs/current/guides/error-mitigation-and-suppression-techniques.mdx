...
### เปิดใช้ TREX โดยใช้ตัวเลือก `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### เปิดใช้ TREX โดยใช้ตัวเลือก `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### เปิดใช้ ZNE โดยใช้ตัวเลือก `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}
...
### เปิดใช้ ZNE โดยใช้ตัวเลือก `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- สำรวจ[ตัวเลือก](/guides/runtime-options-overview)อื่นๆ สำหรับ Qiskit Runtime primitives
