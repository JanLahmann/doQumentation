...
<AccordionItem title="**ขั้นตอน Layout**">
...
<AccordionItem title="**ขั้นตอน Optimization**">
...
<AccordionItem title="**ขั้นตอน Scheduling**">
...
<AccordionItem title="**การรัน Transpiler**">
...
<Admonition type="tip" title="คำแนะนำ">
    ...
    - เรียนรู้วิธี [ตั้งค่าระดับการปรับแต่งเมื่อใช้ Qiskit Runtime](/guides/runtime-options-overview)
