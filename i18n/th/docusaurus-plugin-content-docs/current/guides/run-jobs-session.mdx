---
description: 'วิธีรันงานคอมพิวเตอร์ควอนตัมใน IBM Quantum Compute Service session'
...
ก่อนเริ่ม session ต้อง[ตั้งค่า IBM Quantum Compute client](/guides/install-qiskit-runtime) และ initialize เป็น service ก่อน:
...
สำหรับภาพรวมที่ครอบคลุมเกี่ยวกับการกำหนดค่าและสถานะของ Session หนึ่ง ๆ ให้ใช้  `session.details() method`.
