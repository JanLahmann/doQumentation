...
# ภาพรวม Sample-based quantum diagonalization (SQD) {#sample-based-quantum-diagonalization-sqd-overview}
...
## ติดตั้งแพ็กเกจ SQD {#install-the-sqd-package}
...
<Accordion>
<AccordionItem title="คลิกที่นี่เพื่ออ่านวิธีติดตั้งแพ็กเกจนี้ด้วยตัวเอง">
