---
description: 'ตัวอย่างการใช้งาน Executor primitive ใน qiskit-ibm-runtime อย่างเป็นรูปธรรม'
...
### ตั้งค่า circuit {#set-up-the-circuit-1}
...
### รัน circuits {#execute-the-circuits-1}
