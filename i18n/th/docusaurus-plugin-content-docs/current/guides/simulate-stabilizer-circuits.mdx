...
[การจำลองแบบแม่นยำและมีสัญญาณรบกวนด้วย Qiskit Aer primitives](simulate-with-qiskit-aer) แสดงวิธีใช้ [Qiskit Aer](https://qiskit.org/ecosystem/aer/) เพื่อทำการจำลองที่แม่นยำและมีสัญญาณรบกวนของวงจรควอนตัมทั่วไป ลองพิจารณาวงจรตัวอย่างที่ใช้ในบทความนั้น ซึ่งเป็นวงจร 8 คิวบิตที่สร้างขึ้นโดยใช้ [efficient_su2](../api/qiskit/qiskit.circuit.library.efficient_su2):
