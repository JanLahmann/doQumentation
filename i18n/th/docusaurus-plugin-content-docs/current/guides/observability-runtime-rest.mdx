---
description: 'เรียนรู้เกี่ยวกับเหตุการณ์ติดตามกิจกรรมสำหรับ IBM Quantum Compute Service'
title: 'เหตุการณ์ติดตามกิจกรรมสำหรับ IBM Quantum Compute Service'
---

{/* doqumentation-source-hash: 94aed435 */}

# เหตุการณ์ติดตามกิจกรรมสำหรับ IBM Quantum Compute Service {#activity-tracking-events-for-ibm-quantum-compute-service}

บริการ IBM Cloud&reg; อย่าง IBM Quantum&reg; Compute Service จะสร้างเหตุการณ์ติดตามกิจกรรม
...
IBM Quantum Compute Service ส่งเหตุการณ์ติดตามกิจกรรมในภูมิภาคต่อไปนี้:
...
## การดูเหตุการณ์ติดตามกิจกรรมสำหรับ IBM Quantum Compute Service {#viewing-activity-tracking-events-for-ibm-quantum-compute-service}
