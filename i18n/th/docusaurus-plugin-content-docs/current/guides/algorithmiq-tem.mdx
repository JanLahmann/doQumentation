...
ยืนยันตัวตนด้วย [IBM Quantum Platform API key](http://quantum.cloud.ibm.com/) และเลือกฟังก์ชัน TEM ดังนี้ (ตัวอย่างนี้สมมติว่า[บันทึกบัญชีของคุณ](/guides/functions-get-started#install-qiskit-functions-catalog-client)ไว้ในสภาพแวดล้อม local แล้ว)
