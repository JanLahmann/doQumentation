---
description: 'ตัวอย่างการใช้งาน IBM Quantum Sampler primitive'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'ตัวอย่าง Sampler'
title: 'ตัวอย่าง Sampler'
---
...
ใช้ Sampler เพื่อส่งคืนผลการวัดเป็น bitstrings หรือ counts ของ circuit เดียว
...
ใช้ Sampler เพื่อส่งคืนผลการวัดเป็น bitstrings หรือ counts ของหลาย circuits ในงานเดียว
...
รันหลายการทดลองในงานเดียว โดยใช้ค่า parameter เพื่อเพิ่มความสามารถในการนำ circuit กลับมาใช้ซ้ำ
...
## ใช้ batches และ advanced options {#use-batches-and-advanced-options}

สำรวจ [execution mode](/guides/execution-modes) แบบ batch และ advanced options เพื่อ optimize ประสิทธิภาพ circuit บน QPUs
...
- [ระบุ advanced runtime options](runtime-options-overview)
...
- ลองทำคู่มือ [Compare transpiler settings](/guides/circuit-transpilation-settings)
