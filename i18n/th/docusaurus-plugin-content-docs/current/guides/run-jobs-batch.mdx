---
description: 'วิธีรันงานคอมพิวเตอร์ควอนตัมในโหมด batch โดยใช้ IBM Quantum Compute Service'
...
ก่อนเริ่ม batch ต้อง[ตั้งค่า IBM Quantum Compute client](/guides/install-qiskit) และ initialize เป็น service ก่อน:
...
สำหรับภาพรวมที่ครอบคลุมเกี่ยวกับการกำหนดค่าและสถานะของ batch หนึ่ง ๆ รวมถึง interactive และ max TTL ของมัน ให้ใช้  `batch.details() method`.
