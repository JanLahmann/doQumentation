...
Qiskit primitives มีสองประเภท: base classes และ implementations ต่างๆ Estimator และ Sampler primitives ถูกนิยามโดย primitive base class แบบ open-source ที่อยู่ใน Qiskit SDK (ใน module [`qiskit.primitives`](https://docs.quantum.ibm.com/api/qiskit/primitives)) Providers (เช่น IBM Quantum Compute Service) สามารถใช้ base classes เหล่านี้เพื่อพัฒนา Sampler และ Estimator ของตนเอง ผู้ใช้ส่วนใหญ่จะโต้ตอบกับ provider implementations ไม่ใช่ base primitives โดยตรง
...
- เรียนรู้เกี่ยวกับ [IBM Quantum primitives](/guides/qiskit-runtime-primitives) ที่ใช้สำหรับรัน circuits บน IBM QPUs
</Admonition>
