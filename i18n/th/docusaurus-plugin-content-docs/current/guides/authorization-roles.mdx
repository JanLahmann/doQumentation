---
description: 'เรียนรู้เกี่ยวกับ authorization roles และ permissions ที่มีสำหรับ IBM Quantum REST APIs'
title: บทบาทการอนุญาตสิทธิ์
---

{/* doqumentation-source-hash: b02b9c49 */}

# บทบาทการอนุญาตสิทธิ์ {#authorization-roles}

ทบทวนบทบาทที่มีและการดำเนินการที่แม็ปกับแต่ละบทบาทเพื่อช่วยให้คุณมอบสิทธิ์การเข้าถึง ดู [IAM roles and actions](https://cloud.ibm.com/docs/iam?topic=iam-iam-service-roles-actions#service-roles-table155) บน IBM Cloud&reg; สำหรับข้อมูลเพิ่มเติม
