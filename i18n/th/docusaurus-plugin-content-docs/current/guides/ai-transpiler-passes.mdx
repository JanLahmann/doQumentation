...
ดูที่ [Qiskit Transpiler Service documentation](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) เพื่อข้อมูลเพิ่มเติมเกี่ยวกับขีดจำกัดที่ใช้กับ AI transpiler passes

## การอ้างอิง {#citation}

ถ้าใช้ฟีเจอร์ AI จาก Qiskit Transpiler Service ในงานวิจัย ให้ใช้ [การอ้างอิงที่แนะนำ](/guides/qiskit-transpiler-service#citation)
