...
### Visualize the SLC for manual inspection {#visualize-the-slc-for-manual-inspection-3}
...
#### b.ii. คำนวณ `local_scales` สำหรับการรันบน hardware {#bii-compute-the-local-scales-for-the-hardware-execution}
