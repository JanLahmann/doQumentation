...
# Použití Qiskit Code Assistant v JupyterLab {#use-qiskit-code-assistant-in-jupyterlab}
...
Podívej se na příklady použití Qiskit Code Assistant pro [Circuit](/guides/circuit-library), [konfiguraci potlačení chyb](/guides/error-mitigation-and-suppression-techniques) a [transpilaci s pass managery.](/guides/transpile-with-pass-managers)
</Admonition>
