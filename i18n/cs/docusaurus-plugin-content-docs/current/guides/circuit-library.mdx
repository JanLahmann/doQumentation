...
Knihovna Circuit také zahrnuje Circuit, o nichž se předpokládá, že je obtížné klasicky simulovat, jako jsou Circuit okamžitých kvantových polynomů (iqp). Tyto Circuit vkládají určité diagonální Gate (ve výpočetní bázi) mezi bloky Hadamardových Gate.
...
<Admonition type="tip" title="Doporučení">
  -  Nauč se pokročilé metody vytváření Circuit v tématu [Sestavení Circuit](/guides/construct-circuits).
