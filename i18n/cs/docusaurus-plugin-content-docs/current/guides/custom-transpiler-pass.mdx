...
<Accordion>
<AccordionItem title="Pozadí: reprezentace pomocí DAG">
...
Funkci `qiskit.tools.visualization.dag_drawer()` použij k zobrazení DAG tohoto obvod. Existují tři druhy uzlů grafu: uzly qubit/clbit (zelené), uzly operací (modré) a výstupní uzly (červené). Každá hrana znázorňuje tok dat (nebo závislost) mezi dvěma uzly.
