...
# Migrace z cloudových simulátorů na lokální simulátory {#migrate-from-cloud-simulators-to-local-simulators}
...
<Accordion>
<AccordionItem title="<a>Simulátory mají omezení</a>">
...
<AccordionItem title="<a>Práce s kvantovým hardwarem rozvíjí jedinečné dovednosti</a>">
...
<AccordionItem title="<a>Algoritmy by měly být přizpůsobeny kvantovému hardwaru</a>">
...
Lokální testovací režim nemá vestavěné potlačování ani zmírňování chyb. Místo toho musíš tyto možnosti zadat explicitně. Podrobnosti najdeš v části [Konfigurace zmírňování chyb pro Qiskit Runtime](/guides/error-mitigation-and-suppression-techniques).
</Admonition>
...
Protože Cliffordovy Circuit lze efektivně simulovat s ověřitelnými výsledky, je Cliffordova simulace velmi užitečným nástrojem. Podrobný příklad najdeš v části [Efektivní simulace stabilizátorových Circuit s primitivy Qiskit Aer](/guides/simulate-stabilizer-circuits).
