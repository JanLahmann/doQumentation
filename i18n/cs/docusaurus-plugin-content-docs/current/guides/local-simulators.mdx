---
description: 'Migrace z cloudových simulátorů IBM Quantum na lokální testovací režim `qiskit-ibm-runtime`.'
title: 'Migrace na lokální simulátory'
---

{/* doqumentation-source-hash: 9db328b8 */}

# Migrace z cloudových simulátorů na lokální simulátory {#migrate-to-local-simulators}
...
## Proč jsou cloudové simulátory vyřazovány z provozu? {#why-are-the-cloud-simulators-being-retired}

Cloudové simulátory jsou vyřazovány z provozu z několika důvodů:

<Accordion>
<AccordionItem title="Simulátory mají omezení">
...
<AccordionItem title="Používání kvantového hardwaru buduje jedinečné dovednosti">
...
<AccordionItem title="Algoritmy by měly být přizpůsobeny kvantovému hardwaru">
...
## Kdy by se měly simulátory používat? {#when-should-simulators-be-used}
...
## Migrace na lokální simulátory {#migrate-to-local-simulators-1}
...
### Pokyny pro výběr simulátoru {#guidance-for-choosing-a-simulator}
...
### Cliffordova simulace {#clifford-simulation}
