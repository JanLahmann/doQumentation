...
![Najetí myší na výstup zobrazuje informace jako čas začátku, konce a trvání.](/docs/images/guides/visualize-circuit-timing/image_1.svg 'Příklad vygenerovaného grafu')
