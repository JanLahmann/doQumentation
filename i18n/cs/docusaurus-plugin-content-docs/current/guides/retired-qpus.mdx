...
## Tabulka vyřazených cloudových QPU {#table-of-retired-cloud-qpus}
...
## Vyřazené rodiny procesorů {#retired-processor-families}
...
## Načtení úlohy z vyřazeného QPU {#retrieve-a-job-from-a-retired-qpu}
