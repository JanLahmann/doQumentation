...
Při vytváření kvantových Circuit musíš také zvážit, jaký typ dat chceš po provedení vrátit. Qiskit poskytuje dva způsoby vrácení dat: můžeš získat výstup vzorkování pro sadu Qubit, které se rozhodneš měřit, nebo můžeš získat střední hodnotu pozorovatelné veličiny. Připrav svoji úlohu k měření Circuit jedním z těchto dvou způsobů pomocí Qiskit primitiv (podrobně vysvětleno v [Kroku 3](#step-3-execute-using-the-quantum-primitives)).
