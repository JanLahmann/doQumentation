...
# Přehled diagonalizace kvantových systémů na základě vzorků (SQD) {#sample-based-quantum-diagonalization-sqd-overview}
...
<Accordion>
<AccordionItem title="Klikni sem a zjisti, jak nainstalovat tento balíček ručně">
...
Uprav možnosti podle svých potřeb.
