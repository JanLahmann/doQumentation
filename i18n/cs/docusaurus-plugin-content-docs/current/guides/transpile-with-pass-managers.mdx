...
## Co je (staged) pass manager? {#what-is-a-staged-pass-manager}
...
## Vygenerování přednastavených staged pass managerů {#generate-a-preset-staged-pass-manager}
...
## Vytvoření vlastního pass manageru {#create-your-own-pass-manager}
...
## Vytvoření staged pass manageru {#create-a-staged-pass-manager}
