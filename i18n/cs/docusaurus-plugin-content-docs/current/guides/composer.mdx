...
![kvantový circuit](/docs/images/guides/composer/58f83286-9707-4e43-893e-2bd161c744cd.avif "Obvod skládající se ze sloupce Hadamardových hradel, která vytvoří rovnoměrnou superpozici stavů výpočetní báze, následovaný dvouqubitovým řízeným hradlem CZ (controlled-Z).")

![pohled pravděpodobností měření](/docs/images/guides/composer/4d79349d-dadd-4e9c-8571-4617601d22f3.avif "Kvantový obvod a jeho pohled pravděpodobností.")
...
Přetáhni modifikátor řízení na hradlo a přidej tak řídicí prvek. Nad a pod hradlem se na vodičích qubitů zobrazí tečky, které mohou být cíly řízení; kliknutím na jednu nebo více teček přiřaď cíl jednomu nebo více qubitům. Řídicí prvek lze také přidat kliknutím pravým tlačítkem myši na Gate.
