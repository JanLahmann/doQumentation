...
Tato šablona zapouzdřuje pracovní postup pro simulaci časového vývoje počátečního stavu vůči uživatelsky definovanému spinovému hamiltonovánu a vrací sadu zadaných střední hodnot pomocí doplňku Qiskit [AQC-Tensor](https://qiskit.github.io/qiskit-addon-aqc-tensor/).
...
Nejprve napiš šablonu funkce pro simulaci hamiltonovánu, která využívá [doplněk AQC-Tensor pro Qiskit](https://qiskit.github.io/qiskit-addon-aqc-tensor/) k mapování popisu problému na Circuit se sníženou hloubkou pro spuštění na hardwaru.
