---
title: "Efektivní simulace stabilizátorových Circuit s primitivami Qiskit Aer"
sidebar_label: "Efektivní simulace stabilizátorových Circuit s primitivami Qiskit Aer"
...
<Admonition type="tip" title="Doporučení">
  - Pokud chceš simulovat Circuit s Qiskit Aer, viz [Přesná a zašuměná simulace s primitivami Qiskit Aer](/guides/simulate-with-qiskit-sdk-primitives).
