...
4. Pokud je povoleno `twirling`, použije se součin `num_randomizations` a `shots_per_randomization`, zadaný jako [možnosti `twirling`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-twirling-options).
