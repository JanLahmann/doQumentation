...
Argument `fold` nastavuje maximální šířku výstupu. V rendereru `text` toto nastavuje délku řádků diagramu, než se zalomí na další řádek. Při použití rendereru 'mpl' jde o počet (vizuálních) vrstev, než dojde k zalomení na další řádek.
