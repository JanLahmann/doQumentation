...
<Tabs>
  ...
  Další poznámky:
  - Twirling Gate lze na dynamické obvody aplikovat, ale pouze na hradlo, které nejsou uvnitř podmíněných bloků.
  ...
  Další poznámky:
  - Twirling Gate lze na dynamické obvody aplikovat, ale pouze na hradlo, které nejsou uvnitř podmíněných bloků. Twirling měření lze aplikovat pouze na terminální měření.
