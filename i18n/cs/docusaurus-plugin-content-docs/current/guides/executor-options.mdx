...
<Tabs>
  ...
  Nekompatibilní s:
  - ZNE skládáním hradel
  - PEA
  - PEC
  - Dynamickým odpřahováním

  Další poznámky:
  - Twirling hradel lze na dynamické obvody aplikovat, ale pouze na hradla, která nejsou uvnitř podmíněných bloků.
  ...
  - Kompatibilní se zlomkovými hradly při použití `qiskit-ibm-runtime` v0.42.0 nebo novějšího.
  ...
  <TabItem value="Fractional" label="Zlomková hradla">
  Nekompatibilní s:
  - Twirling hradel
  - PEA
  - PEC
  ...
  <TabItem value="ZNE" label="ZNE se skládáním hradel">
    Nekompatibilní s:
  - Dynamickými obvody
  - PEA
  - PEC

  Nemusí fungovat při použití vlastních hradel.
  </TabItem>
  <TabItem value="Twirling" label="Twirling hradel">
  Nekompatibilní se zlomkovými hradly nebo se stretchi.

  Další poznámky:
  - Twirling hradel lze na dynamické obvody aplikovat, ale pouze na hradla, která nejsou uvnitř podmíněných bloků. Twirling měření lze aplikovat pouze na terminální měření.
  - Nefunguje s ne-Cliffordovými provazujícími hradly (entanglery).
