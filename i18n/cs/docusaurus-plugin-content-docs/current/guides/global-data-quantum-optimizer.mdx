...
Autentizuj se pomocí svého [API klíče](https://quantum.cloud.ibm.com/) a vyber Qiskit Function takto. (Tento úryvek předpokládá, že sis již [uložil(a) účet](/guides/functions-get-started#install-qiskit-functions-catalog-client) do svého lokálního prostředí.)
...
Pro Tailored Ansatz byla zvolená velikost populace založena na předchozích experimentech ukazujících, že tato hodnota poskytuje stabilní a efektivní optimalizaci.
...
![Vizualizace řešení optimalizace](/docs/images/guides/global-data-quantum-optimizer/cost_distribution.avif)
