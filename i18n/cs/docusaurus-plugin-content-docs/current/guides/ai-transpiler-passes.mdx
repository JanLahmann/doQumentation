...
Více informací o limitech, které se vztahují na transpilerové průchody s podporou AI, najdeš v [dokumentaci Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service).

## Citace {#citation}

Pokud ve svém výzkumu používáš jakoukoli funkci s podporou AI ze Qiskit Transpiler Service, použij [doporučenou citaci](/guides/qiskit-transpiler-service#citation).
