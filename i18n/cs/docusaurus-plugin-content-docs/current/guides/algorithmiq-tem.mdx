...
Proveď autentizaci pomocí svého [klíče IBM Quantum Platform API](http://quantum.cloud.ibm.com/) a vyber funkci TEM takto. (Tento úryvek předpokládá, že sis již [uložil svůj účet](/guides/functions-get-started#install-qiskit-functions-catalog-client) do lokálního prostředí.)
