...
Efektivně vypočítávej a interpretuj očekávané hodnoty kvantových operátorů potřebných pro mnoho algoritmů pomocí Estimator. Prozkoumej použití v molekulárním modelování, strojovém učení a složitých optimalizačních problémech.

## Spuštění jednoho experimentu {#run-a-single-experiment}

Pomocí Estimator zjistíš očekávanou hodnotu jednoho páru Circuit-observable.
...
Pomocí Estimator zjistíš očekávané hodnoty více párů Circuit-observable.
...
- Pochop [omezení úloh](/guides/job-limits) při odesílání úlohy na IBM&reg; QPU.
</Admonition>
