...
description: "Praktické příklady použití primitivu Estimator v Qiskit Runtime."
...
Příklady v této sekci ilustrují některé běžné způsoby použití Estimator. Před spuštěním těchto příkladů postupuj podle pokynů v části [Instalace Qiskit.](install-qiskit)

<Admonition type="note">
Všechny tyto příklady používají primitiva z Qiskit Runtime, ale místo nich bys mohl použít základní primitiva.
</Admonition>
...
- Přečti si o [Migraci na primitiva V2](/guides/v2-primitives).
- Seznam se s [omezeními úloh](/guides/job-limits) při odesílání úlohy na IBM&reg; QPU.
</Admonition>
