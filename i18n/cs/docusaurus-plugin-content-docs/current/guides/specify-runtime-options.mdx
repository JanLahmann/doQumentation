...
## Nastavení voleb primitiva {#set-primitive-options}
...
### Zvláštní případy {#special-cases}

#### Úroveň odolnosti (pouze Estimator) {#resilience-level-estimator-only}
...
## Často používané volby {#commonly-used-options}
...
### Maximální doba spuštění {#maximum-execution-time}
...
## Vypnutí veškeré chybové mitigace a potlačení chyb {#turn-off-all-error-mitigation-and-error-suppression}
