...
### 2. Vytvoření obvodu a pozorovatele {#2-create-a-circuit-and-an-observable}
...
- Zjistěte, jak transpilovat lokálně v sekci [Transpilace](/guides/transpile/).
- Vyzkoušej průvodce [Porovnat nastavení transpileru](/guides/circuit-transpilation-settings#compare-transpiler-settings).
- Zjistěte, jak [používat možnosti primitiv](runtime-options-overview).
