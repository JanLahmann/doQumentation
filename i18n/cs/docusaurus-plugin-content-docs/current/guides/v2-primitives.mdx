---
title: Migrace na primitiva Qiskit Runtime V2
...
- Dozvěz se více o nastavování možností v průvodcích [Možnosti Sampleru](/guides/sampler-options), [Možnosti Estimatoru](/guides/estimator-options) a [Možnosti Executoru](/guides/executor-options).
- Dozvěz se více podrobností o [vstupech a výstupech Primitiv](/guides/primitive-input-output#pubs).
