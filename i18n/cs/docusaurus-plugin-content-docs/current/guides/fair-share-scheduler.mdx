...
# Plánovač fair-share {#fair-share-scheduler}
...
## Pojmy plánovače fair-share {#fair-share-terms}

* **Účet:** Jednotlivci a organizace používají účet IBM Cloud&reg; pro přístup k IBM Quantum&reg; Platform a IBM Quantum Compute Service.
...
## Přidělení a správa {#allocation-and-administration}
...
## Jak plánovač fair-share funguje {#how-the-fair-share-scheduler-works}
