---
description: 'Odpovědi na nejčastěji kladené otázky o režimech spouštění'
...
<Accordion>
  <AccordionItem title="Podporuje lokální testovací režim `qiskit-ibm-runtime` různé režimy spouštění?">
