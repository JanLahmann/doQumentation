...
Pokud vstupní matice není dělitelná do qubitových podsystémů, bude uložena jako jednoqubitový operátor. Například pro matici $6\times6$:
...
<Admonition type="tip" title="Doporučení">
  - Nauč se, jak [specifikovat pozorovatelné veličiny v Pauliho bázi](/guides/specify-observables-pauli).
  ...
  - Přečti si [podrobnější popis třídy Operator](/guides/operator-class).
