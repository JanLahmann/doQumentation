---
description: 'Praktické příklady použití primitivu Sampler IBM Quantum.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Příklady použití Sampler'
title: 'Příklady použití Sampler'
---
...
Pomocí Sampler vrátíš výsledky měření jako bitové řetězce nebo počty z jednoho Circuit.
...
Pomocí Sampler vrátíš výsledky měření jako bitové řetězce nebo počty z více obvodů v jedné úloze.
...
Spusť několik experimentů v jedné úloze a využij hodnoty parametrů ke zvýšení znovupoužitelnosti obvodů.
