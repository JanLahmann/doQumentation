---
title: "Vizualizace kvantových stavů"
sidebar_label: "Vizualizace kvantových stavů"
...
<TabItem value="Pauli vector" label="Pauli vector">
  ...
  Tenzorové součiny Pauliho matic jsou vesměs pozorovatelné veličiny, jejichž výsledky jsou +1 nebo -1. Tento graf zobrazuje střední hodnoty stavu pro různé Pauliho operátory jako sloupcový graf. Všechny hustotní matice lze zapsat jako součet těchto Pauliho matic, vážených jejich středními hodnotami.
