...
# Inicializace účtu služby Qiskit Runtime {#initialize-your-qiskit-runtime-service-account}
...
## Propojení Qiskit s instancí služby Qiskit Runtime {#connect-qiskit-with-your-qiskit-runtime-service-instance}
...
### Lokální testování s Qiskit Runtime {#local-testing-with-qiskit-runtime}
