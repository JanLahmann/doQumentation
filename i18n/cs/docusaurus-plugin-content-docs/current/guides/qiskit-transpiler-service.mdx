...
## Instalace balíčku qiskit-ibm-transpiler {#install-the-qiskit-ibm-transpiler-package}
...
## Možnosti transpilace qiskit-ibm-transpiler {#qiskit-ibm-transpiler-transpile-options}
...
- Maximální počet dvoukubitových Gate na obvod v transpilační úloze v jakémkoli režimu `ai` je 1 milion.
