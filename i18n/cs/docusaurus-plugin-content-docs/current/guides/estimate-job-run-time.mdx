...
* Režim úlohy nebo dávky: Pokud k selhání nebo zrušení došlo z důvodu systémové chyby, nahlášené využití je nula. U úloh, které selhaly z důvodu chyby uživatele nebo které uživatel zrušil, je nahlášené využití rovno spotřebě, která nastala do daného okamžiku.
