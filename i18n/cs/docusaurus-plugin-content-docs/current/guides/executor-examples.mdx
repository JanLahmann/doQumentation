---
description: 'Praktické příklady použití primitivu Executor v qiskit-ibm-runtime.'
...
### Nastavení obvodu {#set-up-the-circuit-1}
...
### Spuštění obvodů {#execute-the-circuits-1}
