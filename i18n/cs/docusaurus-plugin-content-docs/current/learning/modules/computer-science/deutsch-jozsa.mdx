...
Protože byl qubit 0 v superpozičním stavu, obvod vyhodnotil funkci *současně* pro $x=0$ i $x=1$ — něco, co klasické počítače neumějí! Háček ale nastane, když chceme zjistit informace o funkci $f(x)$ — při měření qubitů dochází k zániku jejich stavu. Pokud zvolíš „shots = 1" a obvod spustíš jen jednou, uvidíš v histogramu pouze jeden sloupec a informace o funkci budou neúplné.
