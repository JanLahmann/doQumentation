...
Když spouštíme výpočet na skutečném kvantovém počítači, nezáleží nám jen na logice kvantového obvodu. Záleží nám také na tom, jaké operace může daný kvantový počítač vůbec provést a kde na kvantovém počítači se nacházejí qubity, které používáme. Jsou hned vedle sebe? Nebo daleko od sebe? Proto je dalším krokem přepis našeho obvodu pomocí hradel, která jsou pro daný kvantový počítač přirozená, a to s ohledem na rozmístění qubitů. Toho se dosáhne pomocí `transpilace` – po tomto procesu uvidíš, jak je náš jednoduchý ansatz převeden do jiné sady hradel, a naše abstraktní qubity budou namapovány na fyzické qubity na skutečném kvantovém počítači.
...
### Krok 1: Mapování problému na kvantové obvody a operátory {#step-1-map-the-problem-to-quantum-circuits-and-operators}
