...
- Krok 3: Spusť svůj úkol na kvantových počítačích IBM pomocí primitiv IBM Quantum
...
„Sampler" (vzorkovač) je primitivum navržené k vzorkování možných stavů vznikajících z kvantového obvodu a ke sběru statistik o tom, jaké stavy mohou být naměřeny a s jakou pravděpodobností. Zde importujeme Sampler IBM Quantum:
...
### Krok 1: Namapuj svůj problém na kvantový obvod {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Krok 3: Spuštění {#step-3-execute-1}
