...
2. Je na počátečním provázaném stavu mezi Alice a Bobem $\frac{1}{\sqrt{2}}\left(|0\rangle_B|0\rangle_A+|1\rangle_B|1\rangle_A\right)$ něco jedinečného? Pokud ano, co je na něm jedinečného? Pokud ne, jaké jiné provázané stavy bychom mohli použít?
