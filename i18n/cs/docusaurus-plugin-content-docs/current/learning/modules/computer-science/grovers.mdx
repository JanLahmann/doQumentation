...
Abychom mohli aplikovat Groverův algoritmus, museli jsme sestavit Groverův operátor, což znamená, že musíme být schopni převrátit fázi stavů splňujících naše kritéria řešení. Tím vyvstává otázka: pokud svou množinu řešení známe tak dobře, že jsme schopni navrhnout kvantový obvod, který každé řešení označí, co vlastně hledáme?! Odpověď je trojí a budeme se k ní vracet po celém tutoriálu:
