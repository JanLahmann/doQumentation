...
kde $\sigma_+$ je Pauliho operátor $X + iY$ a $\sigma_{-}$ je $X - iY.$ Jakmile máme Hamiltonián zapsaný v tomto formátu, nejtěžší část fáze zobrazení je za námi a Hamiltonián lze nyní snadno zapsat do obvod pomocí Pauliho operátorů.
## Závěr {#conclusion}
