...
* **Měřítko** – Měřeno **počtem qubitů**, což udává množství informací, které lze v kvantovém počítači zakódovat.
...
<Accordion>
<AccordionItem title="Pravda nebo lež: Quantum Volume označuje velikost kryogenních chladniček, v nichž jsou umístěny kvantové počítače IBM.">
