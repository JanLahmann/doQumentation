...
Pravda. Quantum Circuit je abstraktní reprezentace sady instrukcí, které tvoří kvantový algoritmus. K vytváření Quantum circuits můžeme použít vizuální nástroj jako IBM [Composer](https://quantum.cloud.ibm.com/composer) nebo programovací jazyk jako [Qiskit](/guides/tools-intro).
