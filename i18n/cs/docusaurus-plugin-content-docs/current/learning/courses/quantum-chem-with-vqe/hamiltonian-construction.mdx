...
{/* doqumentation-source-hash: c7024ee7 */}
...
* [The Bravyi-Kitaev transformation for quantum computation of electronic structure, Seeley a kol](https://arxiv.org/pdf/1208.5986.pdf).
...
__rhf__ jako v __mf__ = scf.RHF(mol), kde mf je řešič, který používá výpočet Restricted Hartree Fock. Jádro tohoto výpočtu (E, níže) je celková energie, včetně jaderného odpuzování a molekulárních orbitalů.
...
Chceme hamiltonián, a ten je často rozdělen na energii elektronového jádra (ecore, které se nepodílí na minimalizaci), jednoelektronové operátory (h1e) a dvouelektronové energie (h2e). Ty jsou explicitně extrahovány níže v posledních dvou řádcích.
