...
- [cobyla](https://docs.scipy.org/doc/scipy/reference/optimize.minimize-cobyla.html#optimize-minimize-cobyla): algoritmus Optimization BY Linear Approximation (COBYLA).
