...
Nyní se podívejme, co se stane, když spustíme náš obvod na stavu $\vert\psi\rangle$ (společně s inicializovanými pracovními qubit).
...
Protože náš obvod vždy dává výstup $0$ pro stav $\vert\psi\rangle,$ musí platit $\vert\gamma_1\rangle = 0,$ a tedy
