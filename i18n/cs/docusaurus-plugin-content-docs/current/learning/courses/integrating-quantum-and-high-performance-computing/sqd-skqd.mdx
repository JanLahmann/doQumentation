...
Nazvi množinu všech bázových výpočetních stavů, které tvoří tvůj ansatz, A. Nazvi množinu všech bázových výpočetních stavů, které tvoří skutečný základní stav tvého systému, G. Který z následujících odpovídá 'dobrému' ansatzu? Vyber všechny, které platí:
...
### Provedení (`execution.py` a `execution.sh`) {#execution-executionpy-and-executionsh}
