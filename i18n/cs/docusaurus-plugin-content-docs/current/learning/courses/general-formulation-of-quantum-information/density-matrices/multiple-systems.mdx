...
sidebar_label: 'Vícenásobné systémy a redukované stavy'
title: 'Vícenásobné systémy a redukované stavy'
---
...
Pokud $\rho$ je matice hustoty, pak $\rho_{\mathsf{A}}$ a $\rho_{\mathsf{B}}$ budou nutně také matice hustoty.

Tyto pojmy lze přirozeně zobecnit na libovolný počet systémů namísto dvou.
Obecně můžeme do dolního indexu matice hustoty $\rho$ umístit názvy libovolných systémů, které si vybereme, abychom popsali redukovaný stav právě těchto systémů.
...
a podobně pro jiné volby systémů.
