...
### 4.1 Protokol kvantové teleportace {#41-the-protocol-of-quantum-teleportation}
...
### 4.2 Kvantový obvod simulující kvantovou teleportaci {#42-quantum-circuit-simulating-the-quantum-teleportation}
