...
### 2.1 Konstrukce RZZ(-$\pi$ / 2) {#21-construct-rzz-pi-2}
...
### 2.2 Obarvení mapy vazeb {#22-color-the-coupling-map}
...
### 4.1 Krok 1: Mapování {#41-step-1-map}
...
### 4.2 Kroky 2 a 3: Optimalizace a spuštění (simulátor) {#42-steps-2-and-3-optimize-and-execute-simulator}
...
### 4.3 Kroky 2 a 3: Optimalizace a spuštění (falešné zařízení) {#43-steps-2-and-3-optimize-and-execute-fake-device}
...
### 4.4 Krok 4: Zpracování výsledků {#44-step-4-post-process}
...
### 5.1 Krok 1: Mapování {#51-step-1-map}
...
### 5.2 Kroky 2 a 3: Optimalizace a spuštění {#52-steps-2-and-3-optimize-and-execute}
...
### 5.3 Zpracování výsledků {#53-post-process}
