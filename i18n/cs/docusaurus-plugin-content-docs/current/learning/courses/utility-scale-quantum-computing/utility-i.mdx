...
Konkrétně máš za úkol sestavit a spustit obvod odpovídající obrázku 4b v článku a vykreslit „nezmírněné“ body vlastní. Jak vidíš, jedná se o obvod s 127 qubity $\times$ 60 vrstev (20 Trotterových kroků) s pozorovatelnou veličinou $\langle Z_{62} \rangle$.
...
Nejprve si všimni, že RZZ hradlo obecně vyžaduje dva $CX$ hradla.
...
Nyní předvedeme menší verzi utility experimentu. Sestavíme obvod o 27 qubitech $\times$ 6 vrstev (2 Trotterovy kroky) s $\langle Z_{13} \rangle$ jako pozorovatelná veličina a spustíme jej jak na AerSimulatoru, tak na falešném zařízení.
