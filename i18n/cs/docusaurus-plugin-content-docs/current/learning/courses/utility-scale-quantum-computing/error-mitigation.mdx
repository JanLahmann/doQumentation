...
### 2.1 Sestavení testovacího obvodu {#21-build-a-test-circuit}
...
### 2.2 Sestavení modelu šumu {#22-build-a-noise-model}
...
### 2.3 Sestavení zašuměného sampleru s modelem šumu {#23-build-a-noisy-sampler-with-the-noise-model}
...
### 2.4 Spuštění kvantových obvodů na zašuměném sampleru {#24-run-quantum-circuits-on-the-noisy-sampler}
...
### 2.5 Vykreslení výsledků {#25-plot-results}
...
### 2.6 Ideální simulace {#26-ideal-simulation}
...
### 2.8 Realističtější zašuměná simulace {#28-more-realistic-noisy-simulation}
...
### 3.1 Sestavení obvodů {#31-build-circuits}
...
### 3.2 Transpilace obvodů {#32-transpile-the-circuits}
...
### 3.3 Spuštění pomocí Estimatoru (s různými úrovněmi odolnosti) {#33-execute-using-estimator-with-different-resilience-levels}
...
### 3.4 Vykreslení výsledků {#34-plot-results}
