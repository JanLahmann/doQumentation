...
Nastavení úrovně odolnosti (`estimator.options.resilience_level`) je nejjednodušší způsob, jak při použití Qiskit Estimatoru aplikovat zmírnění chyb. Estimator podporuje následující úrovně odolnosti (ke dni 28. 6. 2024). Další podrobnosti najdeš v příručce [Configure error mitigation](/guides/configure-error-mitigation).
...
- [Konfigurace zmírnění chyb](/guides/configure-error-mitigation)
