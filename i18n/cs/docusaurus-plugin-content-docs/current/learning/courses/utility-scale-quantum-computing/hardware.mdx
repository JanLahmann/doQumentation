...
Nyní nakreslíme coupling map zařízení. Jak vidíš, uzly jsou qubity s číselnými označeními. Hrany označují páry, na které lze přímo aplikovat dvoukubitové entanglující hradlo. Tato topologie se nazývá „heavy-hex lattice".
...
## 3. Vlastnosti qubitů {#3-qubit-properties}

Zařízení Eagle má 127 qubitů. Pojďme získat vlastnosti některých z nich.
...
Vypočítejme medián dob T1 qubitů. Porovnej výsledek s hodnotou zobrazenou pro dané zařízení na [IBM Quantum Platform.](https://quantum.cloud.ibm.com/)
...
Vypočítej medián dob T2 qubitů. Zkus to sám/sama, níže je přidán kód, pomocí kterého si můžeš odpověď ověřit.
...
### 3.2 Chyby hradel a readoutu {#32-gate-and-readout-errors}

Nyní se zaměříme na chyby hradel. Nejprve prozkoumáme datovou strukturu instance Target. Jde o slovník, jehož klíče jsou názvy operací.
...
Teď, když rozumíme datovým strukturám, můžeme vypočítat mediánové chyby pro hradla 'sx' a 'ecr'. Porovnej výsledky s hodnotami zobrazenými pro dané zařízení na [IBM Quantum Platform.](https://quantum.cloud.ibm.com/)
...
Oblíbenou funkcí Qiskit jsou jeho vizualizační možnosti. Zahrnují vizualizéry obvodů, stavů a distribucí a vizualizér Target. První dva jsi již použil/a v předchozích jupyter noteboocích. Pojďme využít některé funkce vizualizéru Target.
