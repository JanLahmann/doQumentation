...
### 2.1 Případ 1: Podprostor obsahuje základní stav {#21-case-1-subspace-includes-ground-state}
...
### 2.2 Případ 2: Podprostor vylučuje některé nebo všechny vektory základního stavu {#22-case-2-subspace-excludes-some-or-all-ground-state-vectors}
...
### 2.3 Případ 3: Podprostor obsahuje jak základní stav, tak vektory mimo základní stav {#23-case-3-subspace-includes-both-ground-state-and-non-ground-state-vectors}
...
### 3.1 Poznámky k nosiči základního stavu {#31-notes-on-ground-state-support}
...
### 3.2 Případ proti uniformnímu vzorkování {#32-a-case-against-uniform-sampling}
