...
* [Základní koncepty kvantové výpočetní techniky](/learning/courses/basics-of-quantum-information), včetně Bellových stavů, propletení a kvantových bran;
...
* Základní znalost [Qiskit SDK](https://docs.quantum.ibm.com/guides) a [Qiskit Runtime](/guides/compute-services#qiskit-runtime) a přístup k [účtu IBM Quantum&reg;](/guides/cloud-setup).
## Pozadí {#background}
...
Před spuštěním na skutečném QPU ověříme, že obvod produkuje Bellův pár, a to otestováním na bezešumném simulátoru se čtyř-qubitovým řetězcem `[0, 1, 2, 3]`. Použijeme Qiskit Runtime `Sampler` s `AerSimulator` jako režimem backendu ke spuštění obvodů.
