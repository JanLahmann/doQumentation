...
Definuj svoje přihlašovací údaje pro [IBM Quantum Platform](https://quantum.cloud.ibm.com/), které budou použity v celém tutoriálu k ověření identity v Qiskit Runtime a Qiskit Functions.
