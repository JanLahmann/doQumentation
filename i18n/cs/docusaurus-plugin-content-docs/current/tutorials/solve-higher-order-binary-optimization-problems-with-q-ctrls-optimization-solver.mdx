...
Solver nalezl správné řešení, které bylo ověřeno pomocí klasického optimalizačního softwaru. Složitost tohoto problému ve škále utility vyžaduje pro klasické řešení pokročilý optimalizační software, jako je [IBM ILOG CPLEX Optimization Studio (CPLEX)](https://www.ibm.com/products/ilog-cplex-optimization-studio) nebo [Gurobi Optimization](https://www.gurobi.com/).
