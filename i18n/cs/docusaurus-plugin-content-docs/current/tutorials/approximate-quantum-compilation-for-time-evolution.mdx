...
Hlavním cílem je simulovat časovou evoluci pro modelový Hamiltonián při snížené hloubce obvodu. Toho se dosahuje pomocí doplňku Qiskit **AQC-Tensor**, [qiskit-addon-aqc-tensor](https://github.com/Qiskit/qiskit-addon-aqc-tensor), který využívá tenzorové sítě, konkrétně maticové součinové stavy (MPS), ke kompresi a optimalizaci počátečního obvodu. Prostřednictvím iterativních úprav si komprimovaný ansatz obvod zachovává věrnost vůči původnímu obvodu a zároveň zůstává proveditelný na krátkodobém kvantovém hardwaru. Více informací najdeš v [dokumentaci](https://qiskit.github.io/qiskit-addon-aqc-tensor/).
