...
Tato sekce používá systém s 10 místy k ilustraci pracovního postupu AQC-Tensor krok za krokem. Simulujeme dynamiku 10místného XXZ spinového řetězce, což je široce studovaný model pro zkoumání spinových interakcí a magnetických vlastností.
