...
## Nastavení {#setup}
Nejprve se autentizuj pomocí svého [IBM Quantum API klíče](http://quantum.cloud.ibm.com/). Poté vyber Qiskit Function takto. (Tento kód předpokládá, že sis již [uložil/a svůj účet](/guides/functions-get-started#install-qiskit-functions-catalog-client) do místního prostředí.)
