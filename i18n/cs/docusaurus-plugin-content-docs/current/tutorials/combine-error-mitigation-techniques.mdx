---
description: 'Kombinuj možnosti zmírnění chyb pro experimenty na úrovni utility využívající IBM Quantum QPU s 100+ qubity a primitiv Estimator IBM Quantum.'
...
Tento tutoriál zkoumá možnosti potlačení a zmírnění chyb dostupné s primitivem Estimator IBM Quantum. Tento tutoriál ukazuje, jak implementovat každou z následujících metod samostatně:
...
Odešleš pět samostatných úloh, počínaje bez potlačení nebo zmírnění chyb, a postupně budeš povolovat různé možnosti potlačení a zmírnění chyb dostupné v IBM Quantum Compute Service. Pro informace o možnostech se podívej na následující stránky:
...
Protože tyto úlohy lze spouštět nezávisle na sobě, můžeš použít [dávkový režim](/guides/run-jobs-batch) a umožnit tak Quantum Compute optimalizovat načasování jejich spuštění.
