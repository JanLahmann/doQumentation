...
#### Vytvoření řezů obvodu pro zpětnou propagaci {#create-circuit-slices-to-backpropagate}
...
#### Omezení maximálního nárůstu operátoru během zpětné propagace {#constrain-how-large-the-operator-can-grow-during-backpropagation}
...
#### Zpětná propagace řezů z obvodu {#backpropagate-slices-from-the-circuit}
...
#### Transpilace obvodu do sady bazových bran {#transpile-the-circuits-into-the-basis-gate-set}
...
### Krok 4: Následné zpracování a vrácení výsledku do požadovaného klasického formátu {#step-4-post-process-and-return-result-in-desired-classical-format}
...
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop), rustově akcelerovaný balíček pro propagaci Pauliho operátorů, s tutoriály pokrývajícími OBP, klasický odhad střední hodnoty a simulaci se šumem
</Admonition>
