...
Po dokončení úloh můžeme z metadat výsledků úloh načíst dobu trvání Circuit a vizualizovat informace o harmonogramu Circuit. Více o vizualizaci informací o plánování Circuit najdeš na [této stránce](/guides/qiskit-runtime-circuit-timing).
