...
{/* doqumentation-source-hash: b53d4926 */}
...
Zaznamenej metriky (hloubka, počet Gates, čas) pro každý obvod po transpilaci.
...
Tento graf zvýrazňuje jednotlivé výsledky pro každý obvod (`qc_1` až `qc_10`) napříč různými metodami syntézy:
