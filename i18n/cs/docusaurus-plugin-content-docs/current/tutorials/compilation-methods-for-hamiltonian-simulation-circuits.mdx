...
Circuity použité v tomto benchmarku pocházejí z [repozitáře Hamlib](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation), který obsahuje realistické úlohy simulace Hamiltoniánů.
