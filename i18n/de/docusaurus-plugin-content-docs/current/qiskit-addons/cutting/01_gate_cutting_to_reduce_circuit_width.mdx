...
![Quantencircuit-Diagramm](/img/qiskit-addons/cutting/01-gate-cutting-to-reduce-circuit-width/output_1.png)
...
**Hinweis:** Das ``observables``-Kwarg von `partition_problem` ist vom Typ `PauliList`. Koeffizienten und Phasen der Observablen-Terme werden bei der Zerlegung des Problems und der Ausführung der Subexperimente ignoriert. Sie können bei der Rekonstruktion des Erwartungswerts wieder angewendet werden.
...
![Quantencircuit-Diagramm](/img/qiskit-addons/cutting/01-gate-cutting-to-reduce-circuit-width/output_2.png)

```python
subcircuits["B"].draw("mpl", scale=0.8)
```

![Quantencircuit-Diagramm](/img/qiskit-addons/cutting/01-gate-cutting-to-reduce-circuit-width/output_3.png)
