...
Als Nächstes erstellen wir den Ansatz. Der ``LUCJ``-Ansatz ist ein parametrisierter Quantum Circuit, und wir initialisieren ihn mit `t2`- und `t1`-Amplituden, die aus einer CCSD-Berechnung stammen.
