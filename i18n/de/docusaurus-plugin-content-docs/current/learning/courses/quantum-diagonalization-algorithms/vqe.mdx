...
![Ein Bild atomarer Orbitale und ein Bild eines Netzwerks mit vielen Knoten und Verbindungen.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig1.svg)
...
![Ein Bild eines Quanten-Circuits mit variationellen Parametern, die mit „theta" bezeichnet sind.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig2.svg)
...
![Ein Bild einer gebogenen Linie, die die Energie darstellt, mit mehreren Punkten, an denen der Wert getestet wird, um das Minimum zu finden.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig3.svg)
...
![Eine Tabelle verschiedener Pauli-Strings, von denen einige kommutieren und andere nicht.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig4.svg)
