---
title: "Stichprobenbasierte Quantendiagonalisierung (SQD)"
sidebar_label: "Stichprobenbasierte Quantendiagonalisierung (SQD)"
description: "Die wichtigsten Komponenten der stichprobenbasierten Quantendiagonalisierung (SQD) werden erläutert, ebenso wie bewährte Vorgehensweisen. Die Methode wird in der folgenden Lektion implementiert."
...
# Stichprobenbasierte Quantendiagonalisierung (SQD) {#sample-based-quantum-diagonalization-sqd}
...
<IBMVideo id="134325501" title="In diesem Video gibt Chris Porter einen Überblick über die Unterraum-Quantendiagonalisierung. Er beschreibt, welche Faktoren ihre Effizienz und Nützlichkeit beeinflussen, und erklärt, was sie gegenüber anderen Ansätzen schneller macht. Der nachfolgende Text geht näher auf die Details ein."/>
...
![Diagramme guter und schlechter Ansatz-Träger. Ein guter Ansatz hat einen Träger, der den Grundzustandsträger vollständig enthält. Ein schlechter Ansatz enthält nur einen Teil oder keinen Teil des Grundzustandsträgers.](/learning/images/courses/quantum-diagonalization-algorithms/sqd1/sqd1-fig3.svg)
