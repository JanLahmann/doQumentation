...
Hier optimieren wir die Schaltung für die Ausführung auf einem echten Backend, indem wir das optimization_level festlegen und Dynamical Decoupling hinzufügen. Der folgende Code erzeugt einen Pass Manager unter Verwendung voreingestellter Pass Manager aus qiskit.transpiler.
...
## Qiskit-Patterns Schritt 3: Ausführung mit IBM Quantum-Primitiven {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
## Scaling and running on real quantum computers {#scaling-and-running-on-real-quantum-computers}

### Data {#data}

Beginnen wir damit, die Größe unserer Bilder zu erhöhen. An der Wahl eines 6×6-Gitters ist nichts Besonderes, außer dass es die Anzahl der Qubits (32) übersteigt, die wir für Schaltkreise mit Nicht-Clifford-Gattern simulieren können.
...
## Qiskit Patterns Schritt 2: Problem für die Quantenausführung optimieren {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution-1}
Wir beginnen mit der Auswahl eines Backends für die Ausführung. In diesem Fall verwenden wir das am wenigsten ausgelastete Backend.
...
## Qiskit-Patterns Schritt 3: Ausführung mit IBM Quantum-Primitiven {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
