...
All diese Elemente werden zusammengeführt, um VQE-Berechnungen auf IBM Quantum Primitives aufzubauen, hauptsächlich mit Estimator. Informationen zu Primitives findest du in der [Dokumentation](/guides/primitives). Beim Aufbau einer VQE-Berechnung folgen wir dem standardmäßigen Qiskit-Patterns-Framework:

* Klassische Eingaben auf ein Quantenproblem abbilden

* Problem für die Quantenausführung optimieren

* Mit IBM Quantum Primitives ausführen
