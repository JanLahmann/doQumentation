...
![Ein Bild, das zeigt, dass jeder Rechenknoten viele verschiedene Ressourcentypen enthalten könnte.](/learning/images/courses/integrating-quantum-and-high-performance-computing/compute-resources/resources.svg)
...
* Bei der Job-Einreichung über Qiskit Runtime tritt der Job in die Warteschlange für die ausgewählte QPU ein. Der Benutzer hat keine Kontrolle über die Warteschlangenzeit, obwohl dies bei dedizierten Systemen anders sein könnte.
