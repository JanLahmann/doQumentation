...
![Ein Quantum-Circuit-Diagramm mit Qubits als horizontale Linien und Quantum Gates als Kästen oder Verbindungen zwischen Qubits.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/circuit.avif)
...
![Ein modellartiges Histogramm der Ergebnisse des Samplers. Manche Zustände werden sehr wahrscheinlich gemessen, andere sehr unwahrscheinlich.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/sampler.avif)
...
Wie viele Qubits enthält der folgende Circuit? ![Ein Circuit-Diagramm mit vier horizontalen Linien und vielen Gates.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/checkin-circuit.avif)
...
* Der Hauptkontrollfluss des Programms wird durch den Rang (Rank) des Prozesses bestimmt. Dies ist das SPMD-Prinzip in Aktion: Das Programm verwendet bedingte Logik (zum Beispiel if (rank == 0)), um sicherzustellen, dass nur bestimmte, parallelisierte Codeabschnitte von den Worker-Prozessen ausgeführt werden, während ein Master-Prozess (oft Rang 0) die Initialisierung und die abschließende Aggregation übernimmt.
...
![Ein Diagramm von Rechenaufgaben, die in einem Workflow organisiert sind, in dem einige Prozesse parallel und andere sequentiell ausgeführt werden.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/workflow.avif)
...
![Eine schematische Darstellung des Workflows speziell für Sample-based Quantum Diagonalization. Die Schritte umfassen einen variationellen Quantum Circuit, die Verwendung von Messungen zur Projektion des Hamiltonoperators in einen Unterraum, die Verwendung eines klassischen Optimierers zur Aktualisierung variativer Parameter im Circuit und Wiederholung.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/sqd-workflow.avif)
