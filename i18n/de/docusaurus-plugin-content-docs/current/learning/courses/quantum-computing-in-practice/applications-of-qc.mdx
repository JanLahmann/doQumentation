...
1.	Naturphänomen-Simulationen. Aktuelle klassische Methoden der atomaren und molekularen Simulation sind durch ineffiziente mathematische Beschreibungen der atomaren Struktur begrenzt. Das Speichern und Manipulieren eines Quantenzustands erfordert auf einem klassischen Computer exponentiell viele Ressourcen, lässt sich auf einem Quantencomputer jedoch effizient durchführen. Dies könnte zu Fortschritten bei der Kohlendioxid-Sequestrierung, alternativen Batterien oder der Entwicklung neuer Medikamente führen. Einige Algorithmen, die in diesem Bereich besonders relevant sind, sind: der Variational Quantum Eigensolver (VQE), der zur Abschätzung bestimmter Eigenschaften eines Materials verwendet wird, etwa Gleichgewichts- oder Minimalenergiezustände; der Time Dynamics Simulation (TDS)-Algorithmus, der zur Abschätzung von Antwortfunktionen oder spektralen Eigenschaften von Materialien verwendet wird; und ein Neuling, die [Sample-based Quantum Diagonalization (SQD)](/learning/courses/quantum-diagonalization-algorithms/sqd-overview), von der wir glauben, dass wir in naher Zukunft noch viel mehr hören werden.


2.	Optimierung. Dieser Bereich ist im Computing allgegenwärtig, daher sind die Anwendungsfälle zahlreich und vielfältig. Einige Beispiele, von denen wir häufig hören, sind Portfolio-Optimierung im Finanzwesen, Industriedesign sowie Vertrieb und Lieferkette. Der gebräuchlichste Algorithmus, von dem du im Zusammenhang mit dem Finanzwesen wahrscheinlich hören wirst, ist derjenige, den wir bereits ausführlicher behandelt haben: der Quantum Approximate Optimization Algorithm, oder QAOA.


3.	Quantum Machine Learning. Dieser Bereich hat in den letzten Jahren für große Begeisterung gesorgt, aber es ist wahrscheinlich, dass QML nicht so bald nützlich sein wird wie die Simulation. Dennoch werden einige beeindruckende Algorithmen entwickelt, um einige sehr wichtige Anwendungsfälle zu adressieren. Zu diesen möglichen Anwendungsfällen gehören die Verarbeitung natürlicher Sprache, die Analyse des Netzwerkverkehrs und sogar die Betrugserkennung bei Finanztransaktionen. Relevante Algorithmen in diesem Bereich sind die Quantum Support Vector Machine (QSVM), Quantum Neural Networks (QNN) und Quantum Generative Adversarial Networks.
