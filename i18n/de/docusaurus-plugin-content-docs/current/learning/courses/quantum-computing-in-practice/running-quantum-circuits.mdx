...
<IBMVideo id="134063416" title="In diesem Video erklärt Olivia Lanes Quantencircuits und Primitives. Sie behandelt die Qiskit Runtime Estimator und Sampler Primitives."/>
...
Jetzt sind wir bereit, das Quantenprogramm auszuführen. Die Qiskit Runtime Primitives stellen eine Schnittstelle zur IBM-Quantum-Hardware bereit und abstrahieren auch Error Suppression und Mitigation vom Nutzer. Es stehen zwei Primitives zur Auswahl: Sampler und Estimator.
