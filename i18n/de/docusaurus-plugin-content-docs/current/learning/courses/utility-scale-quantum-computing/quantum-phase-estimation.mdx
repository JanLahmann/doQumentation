...
# Quantenalgorithmen: Phasenschätzung {#quantum-algorithms-phase-estimation}
...
## 2. Grundlagen der Quanten-Fourier-Transformation (QFT) {#2-basic-of-quantum-fourier-transformation-qft}
...
### 2.1. Intuition <a id="intuition"></a> {#21-intuition}
...
## 3. Grundlagen der Quantenphasenschätzung (QPE) {#3-basics-of-quantum-phase-estimation-qpe}
...
#### Lösung der Übung: $\theta = 1/3$ {#solution-of-the-exercise-theta-13}
...
## 4. Ausführung mit dem IBM Quantum Sampler Primitive {#4-execution-using-the-ibm-quantum-sampler-primitive}
