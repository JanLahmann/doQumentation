...
![Ausgabe der vorherigen Codezelle](/learning/images/courses/utility-scale-quantum-computing/quantum-circuit-optimization/extracted-outputs/485b8ce6-0.avif)

Wir transpilieren die Schaltung ohne Optimierung (`optimization_level=0`) und mit Optimierung (`optimization_level=2`).
Wie du sehen kannst, gibt es einen großen Unterschied in der Länge der transpilierten Schaltungen.
...
![Ausgabe der vorherigen Codezelle](/learning/images/courses/utility-scale-quantum-computing/quantum-circuit-optimization/extracted-outputs/87b861e2-1.avif)

```text
optimization_level=2:
```

![Ausgabe der vorherigen Codezelle](/learning/images/courses/utility-scale-quantum-computing/quantum-circuit-optimization/extracted-outputs/87b861e2-3.avif)
...
![Ausgabe der vorherigen Codezelle](/learning/images/courses/utility-scale-quantum-computing/quantum-circuit-optimization/extracted-outputs/7527976e-0.avif)
