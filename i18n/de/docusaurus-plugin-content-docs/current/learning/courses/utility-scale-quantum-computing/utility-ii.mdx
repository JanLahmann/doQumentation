...
# Utility-scale-Experiment II {#utility-scale-experiment-ii}
...
#### Den Hamiltonian definieren {#define-the-hamiltonian-1}
...
Hier konstruieren wir einen Schaltkreis für einen einzelnen Zeitschritt mithilfe von Lie–Trotter.
Genau wie im Fall mit 20 Qubits ist die Lie-Produktformel (erster Ordnung) in der Klasse [LieTrotter](https://docs.quantum.ibm.com/api/qiskit/qiskit.synthesis.LieTrotter) implementiert. Auch hier besteht die Formel erster Ordnung aus der oben genannten Näherung:
...
#### Die zu messenden Operatoren festlegen {#set-the-operators-to-be-measured-1}
...
#### Zeitentwicklungs-Simulation durchführen {#perform-time-evolution-simulation-1}
