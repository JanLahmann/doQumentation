...
Richtig. Ein Quantum-Circuit ist eine abstrakte Darstellung eines Satzes von Anweisungen, die einen Quantenalgorithmus ausmachen. Wir können ein visuelles Tool wie den [IBM Quantum Composer](https://quantum.cloud.ibm.com/composer) oder ein Software Development Kit (SDK) wie [Qiskit](/guides/tools-intro) verwenden, um Quantum-Circuits zu konstruieren.
