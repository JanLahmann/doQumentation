...
Um auf einem echten IBM Quantencomputer auszuführen, benötigst du außerdem ein (kostenloses) [**IBM Quantum&reg; Platform-Konto**](https://quantum.cloud.ibm.com/signin?redirectTo=%2F). Du kannst eine Instanz über den Open Plan öffnen und erhältst 10 Minuten Zeit auf einer Quantum Processor Unit (QPU) in einem rollierenden 28-Tage-Fenster – das ist tatsächlich recht viel! *Wenn du Probleme mit deinem Konto hast, schau dir die [Support-Seite](/guides/support) an.*
...
Öffne den Composer [hier](https://quantum.cloud.ibm.com/composer).
...
Welche zwei Bitstrings sollten in einem idealen Simulator das Histogramm dominieren?
<Accordion>
<AccordionItem title="Antwort">
...
Warum hätte ein perfekter Simulator nicht immer genau dieselbe Anzahl an 00-Zählungen wie an 11-Zählungen?
<Accordion>
<AccordionItem title="Antwort">
Auch wenn ein Simulator „perfekt“ ist und zu einem perfekten Bell-Zustand führt, simuliert er dennoch einen von Natur aus zufälligen Prozess, sodass statistische Schwankungen weiterhin auftreten. Es ist wie beim 1000-maligen Werfen einer Münze: Auch wenn die Chance genau 50:50 steht, dass die Münze auf Kopf oder Zahl landet, bedeutet das nicht, dass du immer genau 500 Mal Kopf und 500 Mal Zahl erhältst.
</AccordionItem>
</Accordion>

Warum könnte ein echter Quantencomputer einige 01- oder 10-Ergebnisse zeigen, obwohl der Simulator das nicht getan hat?
<Accordion>
<AccordionItem title="Antwort">
Weil echte Geräte Rauschen aufweisen. Gates und Messungen sind nicht perfekt, was gelegentlich Fehler verursachen kann.
</AccordionItem>
</Accordion>
