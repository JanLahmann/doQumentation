...
Um unser Experiment auf einem echten Quantencomputer auszuführen, müssen wir den IBM Quantum Compute Service laden und einen Quantencomputer (oder ein „Backend") auswählen. Im Folgenden wählen wir einfach den am wenigsten ausgelasteten Quantencomputer aus, der uns zur Verfügung steht.
