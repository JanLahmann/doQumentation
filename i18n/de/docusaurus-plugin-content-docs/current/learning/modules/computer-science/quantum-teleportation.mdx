...
# Quantenteleportation {#quantum-teleportation}
...
<IBMVideo id="134413680" title="Katie McCormick entmystifiziert Quantenteleportation und führt uns durch einige Beispiele mit Qiskit."/>

## Einführung und Hintergrund {#introduction-and-background}

Quantenteleportation ist eine Technik der Quantenphysik, die es erlaubt, Quanteninformation von einem Ort zu einem anderen zu übertragen, ohne dass Teilchen physisch bewegt werden. Anders als beim Science-Fiction-Konzept der Teleportation wird dabei keine Materie transportiert. Stattdessen beruht sie auf dem Prinzip der Quantenverschränkung, bei dem zwei Teilchen unabhängig von ihrer Entfernung miteinander verbunden sind. Durch eine Reihe präziser Messungen und klassischer Kommunikation kann der Quantenzustand eines Teilchens in einem anderen, weit entfernten Teilchen wiederhergestellt werden, wodurch die Quanteninformation effektiv „teleportiert" wird. In diesem Modul sehen wir, wie das mathematisch funktioniert, und implementieren anschließend die Quantenteleportation auf einem echten Quantencomputer. Die Einführung hier fällt bewusst kurz aus; für mehr Hintergrundwissen zu Quanteninformation und eine ausführlichere Erklärung der Teleportation empfehlen wir John Watrous' Kurs zu den [Grundlagen der Quanteninformation](/learning/courses/basics-of-quantum-information), insbesondere den Abschnitt zur [Teleportation](/learning/courses/basics-of-quantum-information/entanglement-in-action/quantum-teleportation).
...
Daraus ergibt sich die Bedingung $|\alpha_0|^2+|\alpha_1|^2 = 1$.
...
manchmal auch einfach abgekürzt zu
...
- Schritt 3: Job auf IBM-Quantencomputern mit IBM Quantum-Primitiven ausführen
...
Ein „Sampler" ist ein Primitive, das mögliche Zustände eines Quantum Circuits abtastet, Statistiken darüber sammelt, welche Zustände gemessen werden könnten, und mit welcher Wahrscheinlichkeit. Wir importieren hier den IBM Quantum Sampler:
...
### Schritt 1: Problem auf einen Quantum Circuit abbilden {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
Normalerweise ist es sinnvoll, ```optimization_level = 3``` zu setzen, wenn wir den Pass Manager verwenden, um unsere Schaltungen zu transpilieren und zu optimieren, weil wir möchten, dass unsere Schaltungen so effizient wie möglich sind. In diesem Fall gibt es keinen rechnerischen Grund dafür, Zustände von den Qubits 6 und 7 auf die Qubits 1 und 12 zu übertragen. Das haben wir nur getan, um die Teleportation über eine Distanz zu demonstrieren. Wenn wir den Pass Manager bitten, unsere Schaltung zu optimieren, erkennt er, dass es keinen logischen Grund für diese Swap-Gates gibt, und entfernt sie, um die Gate-Operationen auf benachbarten Qubits auszuführen. Für diesen speziellen Fall verwenden wir daher ```optimization_level = 0```.
...
### Schritt 3: Ausführen {#step-3-execute-1}
...
### Wahr/Falsch-Fragen {#truefalse-questions}
