---
title: "Fehlerminderung mit der IBM Circuit Function"
sidebar_label: "Fehlerminderung mit der IBM Circuit Function"
...
---
{/* doqumentation-source-hash: 7fef2946 */}
...
Das Ergebnis der Funktionsausführung hat dasselbe Format wie der [Estimator](/guides/estimator-input-output).
...
> **Hinweis:** Diese Umfrage wird von **IBM Quantum** bereitgestellt und bezieht sich auf den **Tutorial-Inhalt** (verfasst von IBM). doQumentation stellt die Website, Übersetzungen und Code-Ausführung bereit – für Feedback dazu bitte [ein GitHub-Issue öffnen](https://github.com/JanLahmann/doQumentation/issues).
