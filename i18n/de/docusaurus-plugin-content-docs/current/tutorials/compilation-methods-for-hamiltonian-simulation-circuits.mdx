...
Die in diesem Benchmark verwendeten Schaltungen stammen aus dem [Hamlib-Benchmark-Repository](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation), das realistische Hamilton-Simulations-Workloads enthält.
