...
---
{/* doqumentation-source-hash: ffd3937e */}
...
Dieses Tutorial setzt allgemeine Kenntnisse über QML-Methoden voraus. Für eine weitergehende Erkundung von QML empfehlen wir den Kurs [Quantum machine learning](/learning/courses/quantum-machine-learning) auf IBM Quantum Learning.
...
Die wichtigsten Bausteine projizierter Quantenkerne sind die reduzierten Dichtematrizen (RDMs), die durch projektive Messungen der Quanten-Feature-Map gewonnen werden. In diesem Schritt ermitteln wir alle Einzel-Qubit-reduzierten Dichtematrizen (1-RDMs), die anschließend in die klassische Exponentialkernfunktion eingehen.
