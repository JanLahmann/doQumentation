...
description: "Verwende den stichprobenbasierten Quantendiagonalisierungsalgorithmus, um das Einzelstörstellen-Anderson-Modell mit verrauschter Quantenhardware zu simulieren."
...
Nachdem wir die Schaltkreise erstellt haben, können wir sie für eine Ziel-Hardware optimieren. Wir wählen die am wenigsten ausgelastete QPU mit mindestens 127 Qubits. Weitere Informationen findest du in der [Qiskit IBM&reg; Runtime-Dokumentation](/guides/get-started-with-primitives#get-started-with-sampler).
...
Nun führen wir den SQD-Algorithmus mit der Funktion `diagonalize_fermionic_hamiltonian` aus. Erläuterungen zu den Argumenten dieser Funktion findest du in der [API-Dokumentation](https://qiskit.github.io/qiskit-addon-sqd/apidocs/qiskit_addon_sqd.fermion.html#qiskit_addon_sqd.fermion.diagonalize_fermionic_hamiltonian).
