...
Beachte, dass es zwei Arten von Schnitten gibt – das Durchtrennen der Leitung eines Circuits (genannt `wire cutting`) oder das Ersetzen eines 2-Qubit-Gates durch mehrere Ein-Qubit-Operationen (genannt `gate cutting`). In diesem Notebook konzentrieren wir uns auf Gate Cutting. Weitere Details zu Gate Cutting findest du in den <a href="https://qiskit.github.io/qiskit-addon-cutting/explanation/index.html">Erläuterungen</a> in `qiskit-addon-cutting` sowie den entsprechenden Referenzen. Weitere Details zu Wire Cutting findest du im Tutorial [Wire Cutting zur Schätzung von Erwartungswerten](/tutorials/wire-cutting) oder in den Tutorials unter <a href='https://qiskit.github.io/qiskit-addon-cutting/tutorials/index.html'>qiskit-addon-cutting</a>.
