...
In der Abbildung grenzen die Linien und grauen Bereiche die Grenzen ab; die äußersten (strichpunktierten) Linien begrenzen die Quantengrenzen ($\pm 2\sqrt{2}$), während die inneren (gestrichelten) Linien die klassischen Grenzen ($\pm 2$) begrenzen. Du kannst sehen, dass es Bereiche gibt, in denen die CHSH-Zeugengröße die klassischen Grenzen überschreitet. Herzlichen Glückwunsch! Du hast erfolgreich die Verletzung der CHSH-Ungleichung in einem echten Quantensystem demonstriert!
