...
- Beginne mit den Tutorials im Abschnitt [Erste Schritte](#get-started), wenn du zum ersten Mal Code auf einem Quantencomputer ausführst.

- Der Abschnitt zu [Workflows auf dem Weg zum Quantenvorteil](#explore-workflows-toward-advantage) enthält End-to-End-Beispiele für die Verwendung eines Quantencomputers zur Lösung realer Probleme. Diese Tutorials konzentrieren sich auf Algorithmen, die vielversprechende Kandidaten dafür sind, einen Rechenvorteil eines Quantencomputers gegenüber einem klassischen Computer zu erzielen.

- Der Abschnitt zu [Qiskit-Funktionen](#leverage-qiskit-capabilities) enthält Beispiele, die die neuesten und fortschrittlichsten Techniken im Qiskit-Ökosystem nutzen, um einen Teil oder den gesamten Ablauf eines bestimmten Workflows zu verbessern.
...
<Accordion>
<AccordionItem title="**Verifizierbare Sampling-Algorithmen**">
...
* [QAOA mit dem Optimization Mapper Qiskit-Addon mit einem Warmstart versehen](/tutorials/warm-start-qaoa)


* [Pauli-Korrelationscodierung zur Reduzierung von Max-Cut-Anforderungen](/tutorials/pauli-correlation-encoding-for-qaoa)


* [Implizite Lösungsmittelberechnungen mit Qiskit Serverless](/tutorials/implicit-solvent-calculations)


</AccordionItem>

<AccordionItem title="**Schätzung von Observablen**">
...
* [Neutronenstreuung in Quantenmaterialien mit Quantenschaltungen simulieren](/tutorials/simulate-neutron-scattering)


* [Neutronenstreuung mit einem AQC + Trotter-Dynamics-Serverless-Workflow simulieren](/tutorials/simulate-neutron-scattering-with-a-serverless-workflow)
...
* [Beobachtung robuster und kohärenter nicht-abelscher Hadronendynamik auf verrauschten Quantenprozessoren](/tutorials/loop-string-hadron-dynamics)


</AccordionItem>

<AccordionItem title="**Fehlertolerante Algorithmen**">
...
<Accordion>
<AccordionItem title="**Workload-Optimierung**">
...
* [Quantenkernel mit Fractional Gates](/tutorials/fractional-gates)


* [Einführung in den Qiskit AI-gestützten Transpiler](/tutorials/ai-transpiler-introduction)


* [Transpilationsoptimierung mit SABRE](/tutorials/transpilation-optimizations-with-sabre)
...
- Entwirf neue Algorithmen mit **Circuit Functions** &mdash; mit vorgefertigten Pipelines für Transpilation, Fehlerunterdrückung und Fehlerminderung.
  ...
  * [Simulation eines Kicked-Ising-Modells mit der TEM-Funktion](/tutorials/simulate-kicked-ising-tem)


  * [QFT+M-Prozessgüte mit Orbit benchmarken, einer Qiskit Function von Quantum Elements](/tutorials/quantum-elements-orbit-qft-with-dynamic-circuits)


- Experimentiere mit domänenspezifischen Problemen mit **Application Functions** &mdash; mit vertrauten Ein- und Ausgaben für klassische Solver.


  * [Dynamische Portfolio-Optimierung mit dem Portfolio-Optimizer von Global Data Quantum](/tutorials/global-data-quantum-optimizer)
  ...
  * [Hybride quantengestützte Ensemble-Klassifikation (Netzstabilitäts-Workflow)](/tutorials/sml-classification)
...
<AccordionItem title="**Fehlerminderung**">
...
* [Probabilistische Fehlerauslöschung mit schattierten Lichtkegeln](/tutorials/pec-with-shaded-lightcones)

  
* [Erwartungswerte mit propagierter Rauschabsorption (PNA) verbessern](/tutorials/propagated-noise-absorption)


* [Echtzeit-Benchmarking zur Qubit-Auswahl](/tutorials/real-time-benchmarking-for-qubit-selection)


* [Backend-Eigenschaften mit Echtzeit-Benchmarking aktualisieren](/tutorials/refresh-backend-properties-with-real-time-benchmarking)


</AccordionItem>

<AccordionItem title="**Fehlererkennung**">
...
* [Fehlererkennung mit geringem Overhead durch Raumzeit-Codes](/tutorials/spacetime-codes)
