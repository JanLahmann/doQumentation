...
sidebar_position: 1
description: Durchsuchen Sie die IBM Quantum Tutorials — ausführbar auf RasQberry, über Binder oder auf Ihrem eigenen Jupyter-Server.
---

# Tutorials

Nutzen Sie diese Tutorials, um zu lernen, wie Sie Qiskit auf gängige Anwendungsfälle im Quantencomputing anwenden können.

- Beginnen Sie mit den Tutorials im Abschnitt [Erste Schritte](#erste-schritte), wenn Sie zum ersten Mal Code auf einem Quantencomputer ausführen.
...
- Entwerfen Sie neue Algorithmen mit **Circuit Functions** -- mit vorgefertigten Pipelines für Transpilation, Fehlerunterdrückung und Fehlerminderung.
...
- Experimentieren Sie mit domänenspezifischen Problemen mit **Application Functions** -- mit vertrauten Ein- und Ausgaben für klassische Solver.
...
Addons ermöglichen fortgeschrittene Schaltungsmanipulation, wie das Schneiden, Rückpropagieren von Observablen oder Approximieren von Schaltungen, die es Benutzern ermöglichen, Hardwarebeschränkungen zu umgehen, auf Kosten erhöhten klassischen Rechenaufwands.
