...
* Die Verwendung von [Operator-Rückwärtspropagation (OBP)](https://qiskit.github.io/qiskit-addon-obp/) demonstrieren, um die Circuit-Tiefe zu reduzieren. Diese Technik kürzt Operationen am Circuit-Ende auf Kosten von mehr Operator-Messungen.
...
Nun verwenden wir Operator-Rückwärtspropagation (OBP). (Weitere Details zum OBP-Qiskit-Addon findest du in der [OBP](https://qiskit.github.io/qiskit-addon-obp/)-Dokumentation.) Wir erstellen eine Funktion, die die Circuit-Scheiben für die Rückwärtspropagation generiert:
