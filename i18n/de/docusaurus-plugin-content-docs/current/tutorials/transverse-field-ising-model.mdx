...
## Einrichtung {#setup}
Authentifiziere dich zunächst mit deinem [IBM Quantum API-Schlüssel](http://quantum.cloud.ibm.com/). Wähle dann die Qiskit-Funktion wie folgt aus. (Dieser Code setzt voraus, dass du dein Konto bereits [gespeichert hast](/guides/functions-get-started#install-qiskit-functions-catalog-client) in deiner lokalen Umgebung.)
...
### Einzel-Qubit-Magnetisierungen $\langle Z_i \rangle$ schätzen {#estimate-single-qubit-magnetizations-langle-z-i-rangle}
