...
Bevor wir auf dem echten QPU ausführen, überprüfen wir, dass sowohl der dynamische als auch der unitäre Circuit einen idealen Bell-Zustand auf einem rauschfreien Simulator erzeugen. Wir verwenden den IBM Quantum `Sampler` mit `AerSimulator` als Backend-Modus, bei einem kleinen Abstand von 6.
