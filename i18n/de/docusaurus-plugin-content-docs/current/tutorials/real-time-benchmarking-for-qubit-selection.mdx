...
{/* doqumentation-source-hash: 03369019 */}
...
#### Charakterisierung von Zustandspräparations- und Messfehlern (SPAM) {#state-preparation-and-measurement-spam-error-characterization}
...
#### Einzel-Qubit- und Zwei-Qubit-Randomized-Benchmarking {#single-qubit-and-two-qubit-randomized-benchmarking}
...
Nicht bei jedem Lauf zeigt sich durch die Echtzeit-Charakterisierung eine Leistungsverbesserung – und mit zunehmender Kettenlänge, und damit weniger Freiheit bei der Wahl der physischen Qubits, wird die Bedeutung aktualisierter Geräteinformationen geringer. Dennoch ist es eine gute Praxis, aktuelle Daten zu den Geräteeigenschaften zu sammeln, um dessen Leistung zu verstehen. Gelegentlich können transiente Zwei-Niveau-Systeme die Leistung einiger Qubits beeinträchtigen. Echtzeitdaten können uns informieren, wenn solche Ereignisse auftreten, und uns helfen, experimentelle Fehlschläge in solchen Fällen zu vermeiden.
<Admonition type="note" title="Handlungsaufforderung">
Versuche, diese Methode auf deine eigenen Ausführungen anzuwenden, und ermittle, wie stark du davon profitierst! Du kannst auch ausprobieren, wie viel Verbesserung du bei unterschiedlichen Backends erzielst.
</Admonition>
...
> **Hinweis:** Diese Umfrage stammt von **IBM Quantum** und bezieht sich auf den **Tutorial-Inhalt** (verfasst von IBM). doQumentation stellt die Website, die Übersetzungen und die Codeausführung bereit — für Feedback dazu kannst du gerne [ein GitHub-Issue eröffnen](https://github.com/JanLahmann/doQumentation/issues).
