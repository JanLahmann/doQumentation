---
title: Zu den Qiskit Runtime V2-Primitiven migrieren
...
# Zu den Qiskit Runtime V2-Primitiven migrieren {#migrate-to-the-qiskit-runtime-v2-primitives}
...
- Erfahre mehr über das Festlegen von Optionen in den Leitfäden [Sampler-Optionen](/guides/sampler-options), [Estimator-Optionen](/guides/estimator-options) und [Executor-Optionen](/guides/executor-options).
- Lerne mehr über [Primitive-Eingaben und -Ausgaben](/guides/primitive-input-output#pubs).
