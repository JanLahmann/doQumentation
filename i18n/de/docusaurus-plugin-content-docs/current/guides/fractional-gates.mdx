...
description: "Verwenden Sie fraktionale Gates zur Ausführung von Ein- und Zwei-Qubit-Rotationen"
...
Zeigen Sie die Zeitachse des Schaltkreises unter Verwendung der beiden Gate-Typen an.
...
Lesen Sie den Leitfaden zu [Primitive-Optionen](/guides/runtime-options-overview), um mehr über die Anpassung der Fehlermilderungs- und Fehlerunterdrückungstechniken für einen bestimmten Quanten-Workload zu erfahren.
...
<Admonition type="tip" title="Empfehlungen">
  ...
  -  Lesen Sie über das [Schreiben eines benutzerdefinierten Transpiler-Passes](/guides/custom-transpiler-pass).
  -  Verstehen Sie, wie Sie [Fehlerminderung konfigurieren](/guides/configure-error-mitigation) für Qiskit Runtime.
</Admonition>
