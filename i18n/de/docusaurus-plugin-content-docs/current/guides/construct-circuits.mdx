...
description: "So erstellst und visualisierst du Quantenschaltkreise in Qiskit."
...
Diese Seite wirft einen genaueren Blick auf die [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit) Klasse im Qiskit SDK, einschließlich einiger fortgeschrittener Methoden, die du zum Erstellen von Quantenschaltkreisen verwenden kannst.
...
Du kannst den Index und das Register eines Qubits finden, indem du die [`find_bit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#qiskit.circuit.QuantumCircuit.find_bit) Methode des Schaltkreises und deren Attribute verwendest.
...
Der einfachste Weg, diese Information zu betrachten, ist über die [`draw`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#draw) Methode, die eine Visualisierung eines Schaltkreises zurückgibt. Siehe [Schaltkreise visualisieren](/guides/visualize-circuits) für verschiedene Möglichkeiten zur Darstellung von Quantenschaltkreisen.
...
Um zu sehen, was vor sich geht, kannst du die [`decompose`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#decompose) Methode verwenden, um jede Instruktion in ihre Definition zu erweitern.
...
Messungen werden verwendet, um die Zustände einzelner Qubits zu sampeln und die Ergebnisse in ein klassisches Register zu übertragen. Beachte, dass, wenn du Schaltkreise an ein [Sampler](/guides/get-started-with-sampler) Primitive übermittelst, Messungen erforderlich sind. Schaltkreise, die an ein [Estimator](/guides/get-started-with-estimator) Primitive übermittelt werden, dürfen jedoch keine Messungen enthalten.
...
<CodeAssistantAdmonition tagLine="Methodennamen vergessen? Frag den Qiskit Code Assistant." />
## Nächste Schritte {#next-steps}

<Admonition type="tip" title="Empfehlungen">
  -  Um mehr über kurzfristige Quantenalgorithmen zu erfahren, nimm am Kurs [Variational Algorithm Design](/learning/courses/variational-algorithm-design) teil.
  -  Sieh ein Beispiel für die Verwendung von Schaltkreisen im [Grover's Algorithm](/tutorials/grovers-algorithm) Tutorial.
  -  Arbeite mit einfachen Schaltkreisen unter Verwendung von [IBM Quantum Composer](/guides/composer).
</Admonition>
