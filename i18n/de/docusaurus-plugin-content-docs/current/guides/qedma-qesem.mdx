...
notebook_path: "docs/guides/qedma-qesem.ipynb"
---
...
<OpenInLabBanner notebookPath="docs/guides/qedma-qesem.ipynb" />
...
- One [PubResult](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PubResult) object. It can be indexed directly from the `PrimitiveResult`.
