...
# Qiskit Code Assistant in VS Code verwenden {#use-qiskit-code-assistant-in-vs-code}
...
Sieh dir Beispiele für die Verwendung von Qiskit Code Assistant für [Circuits](/guides/circuit-library), [die Konfiguration der Fehlerunterdrückung](/guides/error-mitigation-and-suppression-techniques) und [Transpiling mit Pass Managers](/guides/transpile-with-pass-managers) an.
</Admonition>
