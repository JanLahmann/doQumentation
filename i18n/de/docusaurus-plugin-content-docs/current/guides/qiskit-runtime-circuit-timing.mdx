...
- Diese Funktion gilt nur für IBM Quantum Sampler-Jobs.
...
### Timings visualisieren {#visualize-the-timings}
...
![Beim Hovern über die Ausgabe werden Informationen wie Start, Ende und Dauer angezeigt.](/docs/images/guides/visualize-circuit-timing/image_1.avif 'Beispiel einer generierten Abbildung')
