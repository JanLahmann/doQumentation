---
description: 'Verwende die Neat-Klasse aus dem Debugging-Tools-Modul von qiskit-ibm-runtime, um Jobs zu debuggen und zu analysieren.'
notebook_path: guides/debug-qiskit-runtime-jobs.ipynb
sidebar_label: 'Jobs mit NEAT debuggen'
title: 'Jobs mit NEAT debuggen'
---
...
Importiere zunächst die relevanten Pakete und [authentifiziere dich beim IBM Quantum Compute Service](/guides/cloud-setup).
...
![Ausgabe der vorherigen Code-Zelle](/docs/images/guides/debug-qiskit-runtime-jobs/extracted-outputs/a9018f3a-0.svg)
...
![Ausgabe der vorherigen Code-Zelle](/docs/images/guides/debug-qiskit-runtime-jobs/extracted-outputs/67152273-0.svg)
...
- Erfahre mehr über [verfügbare IBM Quantum Compute-Optionen](/guides/runtime-options-overview).
...
- Erfahre, [wie Circuits transpiliert werden](/guides/circuit-transpilation-settings#compare-transpiler-settings) als Teil von Qiskit-Patterns-Workflows.
