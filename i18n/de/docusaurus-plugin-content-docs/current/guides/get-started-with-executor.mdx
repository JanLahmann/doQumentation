---
description: 'So verwendest du das Executor-Primitive in qiskit-ibm-runtime.'
...
Da der IBM Quantum Compute Service ein verwalteter Dienst ist, musst du zunächst dein Konto initialisieren. Du kannst dann den QPU auswählen, den du zur Berechnung des Erwartungswerts verwenden möchtest.
...
Das Ergebnis ist vom Typ [`QuantumProgramResult`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/results-quantum-program-result). Unter [Executor-Eingabe und -Ausgabe](/guides/executor-input-output) erfährst du mehr über das Ergebnisobjekt.
