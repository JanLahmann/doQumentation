...
<Accordion>
<AccordionItem title="**QPU (`Backend`) Parameter**">
...
<AccordionItem title="**Layout- und Topologie-Parameter**">
...
<Accordion>
<AccordionItem title="**Initialisierungsstufe**">
...
<AccordionItem title="**Layout-Stufe**">
...
<AccordionItem title="**Routing-Stufe**">
...
<AccordionItem title="**Übersetzungsstufe**">
...
<AccordionItem title="**Optimierungsstufe**">
...
<AccordionItem title="**Scheduling-Stufe**">
...
<AccordionItem title="**Transpiler-Ausführung**">
...
- Überprüfe weitere [häufig verwendete Parameter](common-parameters).
- Erfahre, wie du [das Optimierungslevel festlegst](/guides/runtime-options-overview).
- Besuche das Thema [Transpilieren mit Pass-Managern](/guides/transpile-with-pass-managers).
- Beispiele findest du unter [Quantencomputer darstellen](/guides/represent-quantum-computers).
- Erfahre, [wie du Schaltungen transpilierst](/guides/circuit-transpilation-settings) als Teil des Qiskit-Patterns-Workflows.
