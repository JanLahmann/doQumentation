---
description: 'So führst du einen Quantencomputing-Job in einer IBM Quantum Compute Service-Session aus.'
...
Bevor du eine Session startest, musst du [den IBM Quantum Compute-Client einrichten](/guides/install-qiskit-runtime) und ihn als Service initialisieren:
...
Für einen umfassenden Überblick über die Konfiguration und den Status einer Session, verwende die  `session.details() method`.
