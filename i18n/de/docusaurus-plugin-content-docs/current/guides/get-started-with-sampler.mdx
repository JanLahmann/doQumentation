---
description: 'Ein Schnellstart-Guide zur Verwendung des IBM Quantum Sampler-Primitives.'
...
## Schritte zur Verwendung des Sampler Primitive {#steps-to-use-the-sampler-primitive}

### 1. Konto initialisieren {#1-initialize-the-account}

Du musst zuerst dein Konto initialisieren. Anschließend kannst du den QPU auswählen, den du zur Berechnung des Erwartungswerts verwenden möchtest.
...
### 2. Einen Circuit erstellen {#2-create-a-circuit}
...
### 4. Sampler aufrufen und Ergebnisse abrufen {#4-invoke-sampler-and-get-results}
