...
Wie bereits erwähnt, ist die Eingabe für ein Executor-Primitive ein [`QuantumProgram`](https://qiskit.github.io/qiskit-ibm-runtime/stubs/QuantumProgram.html#QuantumProgram), das ein Iterable von [`QuantumProgramItem`](https://qiskit.github.io/qiskit-ibm-runtime/stubs/QuantumProgramItem.html)-Objekten ist. Diese Objekte können zwei Typen haben:
...
Die Ausgabe des Executors ist ein [`QuantumProgramResult`](https://qiskit.github.io/qiskit-ibm-runtime/stubs/QuantumProgramResult.html#QuantumProgramResult), das iterierbar ist. Es enthält einen Eintrag pro eingegebenem `QuantumProgramItem` in derselben Reihenfolge wie die Eingabeelemente. Jedes dieser Ausgabeelemente ist ein Dictionary, dessen Schlüssel Zeichenketten sind, die den Namen der klassischen Register in den Eingabe-Circuits entsprechen (unter anderem), sodass du dir diese Namen nicht mehr merken musst wie bei der Sampler-Ausgabe. Die Dictionary-Werte haben den Typ `np.ndarray`.
