...
## Eingaben: Quantenprogramme {#inputs-quantum-programs}
...
### Beispiel: Ein `QuantumProgram` mit zwei verschiedenen Aufgaben erstellen {#example-create-a-quantumprogram-with-two-different-tasks}
...
### Ein `CircuitItem` anhängen {#append-a-circuititem}
...
### Ein `SamplexItem` anhängen {#append-a-samplexitem}
...
### `CircuitItem`-Ergebnis {#circuititem-result}
...
### `SamplexItem`-Ergebnis {#samplexitem-result}
