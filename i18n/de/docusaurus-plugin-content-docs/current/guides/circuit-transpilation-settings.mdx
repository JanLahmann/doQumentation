...
description: "In diesem Tutorial erkunden wir die Transpiler-Pipeline und führen dich durch den vollständigen Prozess der Erstellung, Transpilierung und Einreichung von Schaltkreisen."
...
Du kannst dies bestätigen, indem du die [Hellinger-Fidelity](https://docs.quantum.ibm.com/api/qiskit/quantum_info) zwischen jedem Ergebnissatz und der idealen Verteilung berechnest (höher ist besser, und 1 ist perfekte Fidelity).
