---
description: 'Das Eingabe- und Ausgabeformat (einschließlich Primitive Unified Blocs oder PUBs) der Qiskit SDK-Primitives verstehen'
...
<Admonition type="tip" title="Empfehlungen">
  ...
  -  Die [Qiskit SDK-Primitives](https://docs.quantum.ibm.com/api/qiskit/primitives)-API ansehen.

  -  Die [Qiskit Aer Primitives](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html)-API ansehen.

  -  Mehr über die [IBM Quantum Primitives](/guides/qiskit-runtime-primitives) erfahren.

  -  Die [`qiskit-ibm-runtime` Estimator](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2)-API ansehen.

  -  Die [`qiskit-ibm-runtime` Sampler](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2)-API ansehen.
</Admonition>
