...
Mehr über die [Phasenscheiben-Visualisierung](#phase-disk) erfährst du hier.
...
![ein Quantum Circuit](/docs/images/guides/composer/2H-circuit.svg "Ein Circuit, bestehend aus einer Spalte von Hadamard-Gates, die eine gleichmäßige Superposition der Berechnungsbasisszustände erzeugt, gefolgt von einem Zwei-Qubit-Controlled-Z-Gate (CZ).")

![Wahrscheinlichkeitsansicht des vorherigen Circuits](/docs/images/guides/composer/probabilities.svg "Wahrscheinlichkeitsansicht des vorherigen Circuits.")

Der Circuit versetzt die beiden Qubits in den Zustand $|\psi\rangle = (|00\rangle + |01\rangle+ |10\rangle-|11\rangle) / 2$. Die Basiszustände der Rechenbasis sind $|00\rangle, |10\rangle, |01\rangle$ und $|11\rangle$. Die Wahrscheinlichkeit für jeden der Basiszustände beträgt 1/4.
...
![ein Quantum Circuit](/docs/images/guides/composer/2H-circuit.svg)

![Q-Sphären-Ansicht](/docs/images/guides/composer/q-sphere.avif)
...
![Zustandsvektor-Ansicht](/docs/images/guides/composer/state-vector.svg "Der Zustandsvektor am Ende des obigen Circuits. Das Farbrad ordnet Phasenwinkel Farben zu. Der Ausgabezustand wird als Liste komplexer Zahlen ausgedrückt.")
...
### Klassische Gates {#classical-gates}
...
### Nicht-unitäre Operatoren und Modifikatoren {#non-unitary-operators-and-modifiers}
