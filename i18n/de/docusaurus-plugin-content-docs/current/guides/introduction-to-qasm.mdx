...
Weitere Informationen findest du in der [OpenQASM Live Specification.](https://openqasm.com/)
...
- Erfahre, wie du OpenQASM-Code im Leitfaden [IBM Quantum Composer](/guides/composer) generierst.
- Lies die [OpenQASM 3 Feature-Tabelle](qasm-feature-table).
- Lies die [OpenQASM 3 Qiskit API](https://docs.quantum.ibm.com/api/qiskit/qasm3)-Referenz.
- Lies die [OpenQASM 2 Qiskit API](https://docs.quantum.ibm.com/api/qiskit/qasm2)-Referenz.
