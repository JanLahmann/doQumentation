...
{/* doqumentation-source-hash: 348b23bb */}
...
* **Account:** Einzelpersonen und Organisationen verwenden ein IBM Cloud&reg;-Konto, um auf die IBM Quantum&reg; Platform und den IBM Quantum Compute Service zuzugreifen.

* **Instanz:** Das grundlegende Konstrukt, dem Zeit vom übergeordneten Account für eine Reihe von QPUs zugewiesen wird und dem Benutzer direkt zugeordnet werden. Instanzen sind mit einer bestimmten Region und einem [Plan](/guides/plans-overview) verbunden. Weitere Informationen findest du im Leitfaden [Instanzen](/guides/instances).
...
- Probiere das Tutorial [Grover-Algorithmus](/tutorials/grovers-algorithm) aus.
- Lerne, wie du [einen Workload überwachst](/guides/monitor-job).
</Admonition>
