...
{/* doqumentation-source-hash: f372e24e */}
...
Wenn du diese Seite herunterlädst und sie lokal in einem Notebook-Editor öffnest, wirst du sehen, dass einige Code-Zellen den [Magic Command](https://ipython.readthedocs.io/en/stable/interactive/magics.html#cellmagic-writefile) `%%writefile` enthalten. Dieser Magic Command speichert den Code in `./source_files/template_hamiltonian_simulation.py` – das ist die Function-Vorlage, die du in Qiskit Serverless hochladen und remote ausführen kannst.
