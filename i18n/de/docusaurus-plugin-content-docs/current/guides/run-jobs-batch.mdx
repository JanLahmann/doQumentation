---
description: 'Wie man Quantencomputing-Jobs im Batch-Modus mit dem IBM Quantum Compute Service ausführt.'
...
Bevor du einen Batch startest, musst du [den IBM Quantum Compute-Client einrichten](/guides/install-qiskit) und ihn als Service initialisieren:
...
Für einen umfassenden Überblick über die Konfiguration und den Status eines Batches, einschließlich seiner interactive und max TTL, verwende die  `batch.details() method`.
