...
# Executor-Broadcasting {#executor-broadcasting}
...
## Schnellstart-Beispiel {#quickstart-example}
...
## Intrinsische und extrinsische Achsen {#intrinsic-and-extrinsic-axes}
...
## Ausgabe-Array-Formen {#output-array-shapes}
...
## Randomisierung und der Parameter `shape` {#randomization-and-the-shape-parameter}
...
### Keine expliziten Randomisierungsachsen {#no-explicit-randomization-axes}
...
### Einzelne Randomisierungsachse {#single-randomization-axis}
...
### Mehrere Randomisierungsachsen {#multiple-randomization-axes}
...
### Wie `shape` und Eingabeformen interagieren {#how-shape-and-input-shapes-interact}
...
### In Ergebnisse indexieren {#index-into-results}
...
### Einen einzelnen Parameter sweepen {#sweep-a-single-parameter}
...
### Einen 2D-Raster-Sweep erstellen {#creating-a-2d-grid-sweep}
...
### Mehrere Eingaben kombinieren {#combining-multiple-inputs}
