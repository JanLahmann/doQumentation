...
Die Beta-Version eines neuen Ausführungsmodells ist jetzt verfügbar. Das Directed Execution Model bietet mehr Flexibilität bei der Anpassung deines Fehlerkorrektur-Workflows. Weitere Informationen findest du im [Directed execution model](/guides/directed-execution-model)-Guide.
</Admonition>
{/*
