...
description: "Erklärung der über Qiskit Runtime verfügbaren Fehlerminderungs- und Fehlerunterdrückungstechniken"
...
Fehlerminderungs- und Fehlerunterdrückungstechniken werden verwendet, um die Ergebnisqualität beim Skalieren auf größere Workloads zu verbessern. Diese Seite bietet High-Level-Erklärungen der über Qiskit Runtime verfügbaren Fehlerunterdrückungs- und Fehlerminderungs-Techniken.
...
### TREX mit der Option `measure_mitigation` aktivieren {#enable-trex-by-using-the-measure_mitigation-option}
...
### TREX mit der Option `resilience_level` aktivieren {#enable-trex-by-using-the-resilience_level-option}
...
### ZNE mit der Option `zne_mitigation` aktivieren {#enable-zne-by-using-the-zne_mitigation-option}
...
### ZNE mit der Option `resilience_level` aktivieren {#enable-zne-by-using-the-resilience_level-option}
...
- Erkunde andere [Optionen](/guides/runtime-options-overview) für die Qiskit Runtime-Primitive.
