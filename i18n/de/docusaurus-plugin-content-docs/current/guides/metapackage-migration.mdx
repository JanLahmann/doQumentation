...
# Die grundlegenden Paketänderungen verstehen {#understand-the-breaking-package-changes}
...
<Accordion>
<AccordionItem title="**Zum Erweitern klicken, um das Glossar dieser Seite zu lesen**">
...
Wenn du die Pakete installieren möchtest, die zuvor im Qiskit-Metapaket enthalten waren, besuche das [Qiskit-Ökosystem](https://www.ibm.com/quantum/ecosystem), um eine Reihe von Paketen zu finden, die deinen Anforderungen entsprechen. Du kannst auch den [v1.0-Migrationsleitfaden](/guides/qiskit-1.0-installation) lesen, um mehr Informationen darüber zu erhalten, wie du die neue Distribution installierst.
