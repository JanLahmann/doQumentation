...
{/* doqumentation-source-hash: 8f9614ed */}
...
- `DenseLayout`: Findet den Subgraphen des Geräts mit der größten Konnektivität, der die gleiche Anzahl an Qubits wie der Circuit hat  (wird für Optimization Level 1 verwendet, wenn im Circuit Kontrollfluss-Operationen (wie IfElseOp) vorhanden sind).
...
![Ausgabe der vorherigen Code-Zelle](/docs/images/guides/transpiler-stages/extracted-outputs/62479697-cef1-4a89-ac2a-20051dd294f4-1.svg)
...
![Ausgabe der vorherigen Code-Zelle](/docs/images/guides/transpiler-stages/extracted-outputs/ab89c4ea-06c4-4320-b493-feb691b3570d-0.svg)
...
![Ausgabe der vorherigen Code-Zelle](/docs/images/guides/transpiler-stages/extracted-outputs/f6a3a92a-8656-4518-ba2c-c3b0b038f507-0.svg)
...
Beim Schreiben eines Quantum-Circuits kannst du beliebige Quantum-Gates (unitäre Operationen) verwenden, zusammen mit einer Reihe von Nicht-Gate-Operationen wie Qubit-Messung oder Reset-Anweisungen. Die meisten Quantengeräte unterstützen jedoch nur eine Handvoll Quantum-Gates und Nicht-Gate-Operationen nativ. Diese nativen Gates sind Teil der Definition der [ISA](/guides/transpile#instruction-set-architecture) eines Targets, und diese Phase der vordefinierten `PassManagers` übersetzt (oder *entrollt*) die im Circuit angegebenen Gates in die nativen Basis-Gates eines bestimmten Backends. Dies ist ein wichtiger Schritt, da er dem Backend die Ausführung des Circuits ermöglicht, aber typischerweise zu einer Zunahme der Tiefe und Anzahl der Gates führt.
...
![Ausgabe der vorherigen Code-Zelle](/docs/images/guides/transpiler-stages/extracted-outputs/d4d1f65a-3336-4d70-9189-65ba010f2366-1.svg)
...
![Ausgabe der vorherigen Code-Zelle](/docs/images/guides/transpiler-stages/extracted-outputs/4552b367-75e9-4faa-a59d-8317e25ac145-0.svg)
...
![Ausgabe der vorherigen Code-Zelle](/docs/images/guides/transpiler-stages/extracted-outputs/2700405a-f559-45d3-99a9-5b4447621743-0.svg)
...
![Ausgabe der vorherigen Code-Zelle](/docs/images/guides/transpiler-stages/extracted-outputs/ae2d9390-5c26-46f3-9418-a684ba8a406a-0.svg)
...
![timeline.draw()-Ansicht desselben Circuits](/docs/images/guides/transpiler-stages/transpiler-17.svg)
