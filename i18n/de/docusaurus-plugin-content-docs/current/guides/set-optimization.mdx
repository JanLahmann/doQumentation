...
Zuerst transpilieren wir mit Optimierungsstufe 0.
...
Das Anpassen der Optimierungsstufe kann auch andere Aspekte des Schaltkreises verändern, nicht nur die Anzahl der ECR-Gates. Beispiele dafür, wie das Festlegen der Optimierungsstufe das Layout verändert, findest du unter [Quantencomputer darstellen](/guides/represent-quantum-computers).
