---
description: 'Ein Schnellstart-Guide zur Verwendung des IBM Quantum Estimator-Primitives.'
...
Du musst zunächst dein Konto initialisieren. Danach kannst du den QPU auswählen, den du zur Berechnung des Erwartungswerts verwenden möchtest.
