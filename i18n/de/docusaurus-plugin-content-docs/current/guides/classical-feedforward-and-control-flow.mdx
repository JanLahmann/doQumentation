...
Die neue Version dynamischer Schaltungen ist jetzt für alle Benutzer auf allen Backends verfügbar. Du kannst dynamische Schaltungen nun im Utility-Maßstab ausführen. Weitere Einzelheiten findest du in [der Ankündigung](/announcements/product-updates/2025-09-25-new-dynamic-circuits).
</Admonition>
...
- Die neue Version dynamischer Schaltungen ist jetzt für alle Benutzer auf allen Backends verfügbar. Weitere Einzelheiten findest du in [der Ankündigung](/announcements/product-updates/2025-09-25-new-dynamic-circuits).
...
Da Estimator keine dynamischen Schaltungen unterstützt, kannst du stattdessen Sampler verwenden und deine eigenen Messschaltungen erstellen. Alternativ kannst du die [Executor-Primitive verwenden,](/guides/directed-execution-model#executor-primitive) die dynamische Schaltungen unterstützt.

Um das Verhalten von Estimator nachzubilden, folge diesem Prozess:

1. Gruppiere die Terme aller Observablen in eine Partition. Dies kann beispielsweise mit der [`PauliList`-API](https://docs.quantum.ibm.com/api/qiskit/qiskit.quantum_info.PauliList#group_qubit_wise_commuting) erfolgen.
     <Admonition type="note">
      Du kannst das [`BitArray`](https://quantum.cloud.ibm.com/docs/en/api/qiskit/qiskit.primitives.BitArray#expectation_values)-Primitive-Attribut verwenden, um die Erwartungswerte der bereitgestellten Observablen zu berechnen.
     </Admonition>
2. Führe eine Basiswechsel-Schaltung pro Partition aus (welcher Basiswechsel auch immer für jede Partition durchgeführt werden muss). Siehe das Measurement Bases Addon-Utility [`measurement_bases`-Modul](https://github.com/Qiskit/qiskit-addon-utils/blob/38ea05431f2e9830adf4ec9265f6d19758a32096/qiskit_addon_utils/exp_vals/measurement_bases.py) für weitere Informationen. [Erste Schritte mit Utilities.](/guides/qiskit-addons-utils#get-started-with-utilities)
...
- Erfahre mehr über die kürzeren [Mid-Circuit-Messungen](/guides/measure-qubits#mid-circuit-measurements), die die Schaltungszeit reduzieren.
- Verwende [Circuit-Schedule-Visualisierung](/guides/visualize-circuit-timing#qiskit-runtime-support) zur Fehlersuche und Optimierung deiner dynamischen Schaltungen.
</Admonition>
