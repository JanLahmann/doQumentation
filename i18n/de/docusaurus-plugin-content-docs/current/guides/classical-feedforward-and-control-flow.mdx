...
* Effiziente Vorbereitung von Quantenzuständen, wie zum Beispiel dem [GHZ state](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339), dem [W-state](https://arxiv.org/abs/2403.07604) (weitere Informationen zum W-state findest du auch in ["State preparation by shallow circuits using feed forward"](https://arxiv.org/abs/2307.14840)), sowie einer breiten Klasse von [matrix product states](https://arxiv.org/abs/2404.16083)

* [Effiziente Verschränkung über große Distanzen](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339) zwischen Qubits auf demselben Chip durch die Verwendung flacher Circuits

* Effizientes [Sampling von IQP-ähnlichen Circuits](https://arxiv.org/pdf/2505.04705)
Qiskit unterstützt vier Kontrollfluss-Konstrukte für klassisches Feedforward, die jeweils als Methode auf [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit) implementiert sind. Die Konstrukte und ihre entsprechenden Methoden sind:
