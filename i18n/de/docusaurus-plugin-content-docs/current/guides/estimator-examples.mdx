---
title: "Estimator-Beispiele"
sidebar_label: "Estimator-Beispiele"
description: "Praktische Beispiele zur Verwendung des Estimator-Primitives in Qiskit Runtime."
...
Die Beispiele in diesem Abschnitt zeigen einige gängige Verwendungsweisen des Estimator. Bevor du diese Beispiele ausführst, folge den Anweisungen unter [Qiskit installieren.](install-qiskit)
...
- Übe mit Primitives durch die [Lektion zu Kostenfunktionen](/learning/courses/variational-algorithm-design/cost-functions) in IBM Quantum&reg; Learning.
