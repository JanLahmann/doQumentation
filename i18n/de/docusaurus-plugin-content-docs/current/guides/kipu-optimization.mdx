...
*Siehe die [API-Referenz](https://docs.quantum.ibm.com/api/functions/kipu-optimization)*
...
So könntest du Iskay mit verschiedenen Einstellungen konfigurieren:
...
Das folgende Beispiel führt die MaxCut-Instanz mit 150 Knoten aus.
...
- Besuche die [API-Referenz](https://docs.quantum.ibm.com/api/functions/kipu-optimization) für diese Qiskit Function.
