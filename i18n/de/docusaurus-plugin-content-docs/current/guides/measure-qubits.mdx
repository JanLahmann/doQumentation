...
### `QuantumCircuit.measure_all` Methode {#quantumcircuitmeasure-all-method}
...
### `QuantumCircuit.measure_active` Methode {#quantumcircuitmeasure-active-method}
...
- [Mid-circuit measurements](/guides/execute-dynamic-circuits#midcircuit) (Nur verfügbar bei Verwendung von IBM Quantum Compute Service.)
</Admonition>
