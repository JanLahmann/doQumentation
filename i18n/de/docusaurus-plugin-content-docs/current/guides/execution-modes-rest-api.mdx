...
Diese Dokumentation verwendet das Python-`requests`-Modul, um die Qiskit Runtime REST-API zu demonstrieren. Dieser Workflow kann jedoch mit jeder Sprache oder jedem Framework ausgeführt werden, das die Arbeit mit REST-APIs unterstützt. Details findest du in der [API-Referenzdokumentation](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/tags/jobs).
</Admonition>
