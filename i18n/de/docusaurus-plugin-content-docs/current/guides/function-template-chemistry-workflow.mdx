...
# Erstellen und Ausführen einer Qiskit Function-Vorlage für Elektronenstruktursimulation mit einem impliziten Lösungsmittelmodell {#build-and-run-a-qiskit-function-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
<Accordion>
<AccordionItem title="Klicke zum Aufklappen für weitere Details zu den erforderlichen Optionen:">
...
<Accordion>
<AccordionItem title="Klicke zum Aufklappen für weitere Informationen zur Konfiguration der SQD-Optionen:">
