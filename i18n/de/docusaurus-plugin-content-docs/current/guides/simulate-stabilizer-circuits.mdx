...
[Exact and noisy simulation with Qiskit Aer primitives](simulate-with-qiskit-aer) zeigt, wie du mit [Qiskit Aer](https://qiskit.org/ecosystem/aer/) exakte und verrauschte Simulationen generischer Quantum Circuits durchführst. Betrachte den in diesem Artikel verwendeten Beispiel-Circuit, einen 8-Qubit-Circuit, der mit [efficient_su2](../api/qiskit/qiskit.circuit.library.efficient_su2) erstellt wurde:
