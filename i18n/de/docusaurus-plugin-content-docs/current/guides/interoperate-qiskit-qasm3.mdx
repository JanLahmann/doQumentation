...
## Importieren eines OpenQASM 3-Programms in Qiskit {#import-an-openqasm-3-program-into-qiskit}

Um diese Funktion zu verwenden, musst du das Paket `qiskit_qasm3_import ` installieren. Installiere es mit dem folgenden Befehl.
...
## Exportieren nach OpenQASM 3 {#export-to-openqasm-3}
...
### Beispiel mit `dumps()` {#example-with-dumps}
...
### Beispiel mit `dump()` {#example-with-dump}
...
Weitere Informationen findest du im Abschnitt [Exporting to OpenQASM 3](https://docs.quantum.ibm.com/api/qiskit/qasm3#exporting-to-openqasm-3) der API-Referenz.
...
- Besuche das Thema [Überprüfe dein Programm](/guides/debugging-tools).
- Lies die [OpenQASM Live Specification](https://openqasm.com/).
</Admonition>
