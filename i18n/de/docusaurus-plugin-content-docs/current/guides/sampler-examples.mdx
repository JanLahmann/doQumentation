---
description: 'Praktische Beispiele zur Verwendung des IBM Quantum Sampler-Primitivs.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: Sampler-Beispiele
title: Sampler-Beispiele
---
...
Der Code auf dieser Seite wurde mit den folgenden Abhängigkeiten entwickelt.
...
## Einzelnes Experiment ausführen {#run-a-single-experiment}

Verwende den Sampler, um das Messergebnis eines einzelnen Circuits als Bitstrings oder Zählungen zurückzugeben.
...
Verwende den Sampler, um das Messergebnis mehrerer Circuits als Bitstrings oder Zählungen in einem einzigen Job zurückzugeben.
...
Führe mehrere Experimente in einem einzigen Job aus und nutze dabei Parameterwerte, um die Wiederverwendbarkeit von Circuits zu erhöhen.
...
## Batches und erweiterte Optionen verwenden {#use-batches-and-advanced-options}

Erkunde den Batch-[Ausführungsmodus](/guides/execution-modes) und erweiterte Optionen, um die Circuit-Performance auf QPUs zu optimieren.
...
- Übe mit Primitiven, indem du die [Lektion zu Kostenfunktionen](/learning/courses/variational-algorithm-design/cost-functions) im IBM Quantum Learning durcharbeitest.
- Lerne, wie du lokal transpilierst, im Abschnitt [Transpilieren](/guides/transpile/).
