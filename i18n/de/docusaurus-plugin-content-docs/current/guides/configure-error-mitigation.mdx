...
description: "So konfigurierst du die Fehlerminderung mit Qiskit Runtime."
...
Du kannst Resilience Levels verwenden, um Fehlerminderungstechniken anzugeben, oder du kannst benutzerdefinierte Techniken einzeln festlegen, wie in [Benutzerdefinierte Fehlereinstellungen](#advanced-error) beschrieben.
...
Du kannst einzelne Fehlerminderungs- und Unterdrückungsmethoden ein- und ausschalten, einschließlich Dynamical Decoupling, Gate- und Messungs-Twirling, Messfehlerminderung, PEC und ZNE. Eine Erläuterung zu jeder Technik findest du unter [Fehlerminderungs- und Unterdrückungstechniken](error-mitigation-and-suppression-techniques).

<Admonition type="note" title="Hinweise">
- Nicht alle Optionen sind für beide Primitives verfügbar. Die Liste der verfügbaren Optionen findest du in der [Verfügbare-Optionen-Tabelle](runtime-options-overview#options-table).
- Nicht alle Methoden funktionieren zusammen bei allen Arten von Schaltkreisen. Details findest du in der [Feature-Kompatibilitätstabelle](runtime-options-overview#options-compatibility-table).
</Admonition>
...
Anweisungen zum Ausschalten der gesamten Fehlerminderung findest du im Abschnitt [Gesamte Fehlerunterdrückung und -minderung ausschalten](specify-runtime-options#no-error-mitigation).

## Nächste Schritte {#next-steps}

<Admonition type="tip" title="Empfehlungen">
  - Geh ein Beispiel durch, das Fehlerminderung in der [Kostenfunktions-Lektion](/learning/courses/variational-algorithm-design/cost-functions) in IBM Quantum Learning verwendet.
  - Erfahre mehr über [Fehlerminderungs- und Fehlerunterdrückungstechniken](error-mitigation-and-suppression-techniques).
  - [Konfiguriere die Fehlerunterdrückung](configure-error-suppression).
