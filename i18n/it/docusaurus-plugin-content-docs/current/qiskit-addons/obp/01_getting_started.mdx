...
Per una discussione più dettagliata sul suddividere i circuito in slice, consulta questa [guida how-to](https://qiskit.github.io/qiskit-addon-utils/how_tos/create_circuit_slices.html) del pacchetto [qiskit-addon-utils](https://qiskit.github.io/qiskit-addon-utils/index.html).
