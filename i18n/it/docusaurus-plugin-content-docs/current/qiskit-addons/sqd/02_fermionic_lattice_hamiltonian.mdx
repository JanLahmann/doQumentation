...
### Passo 1: Mappa il problema a un circuito quantistico {#step-1-map-problem-to-a-quantum-circuit}
...
### Passo 2: Ottimizza il problema {#step-2-optimize-the-problem}
...
### Passo 3: Esegui gli esperimenti {#step-3-execute-experiments}
...
### Passo 4: Post-elabora i risultati {#step-4-post-process-the-results}
