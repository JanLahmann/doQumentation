...
- Passo 3: Esegui usando le primitive di IBM Quantum
...
Per eseguire il nostro esperimento su un vero computer quantistico, dobbiamo caricare il servizio IBM Quantum Compute e selezionare un computer quantistico (o un "backend"). Di seguito, selezioniamo semplicemente il computer quantistico meno occupato a nostra disposizione.
...
### Passo 3: Esegui usando le primitive di IBM Quantum {#step-3-execute-using-ibm-quantum-primitives}
...
### Passo 1: tradurre gli input classici in un problema quantistico {#step-1-map-classical-inputs-to-a-quantum-problem-1}
...
Supponi di partire con una particella in uno stato di spin

$$
|\psi\rangle = \begin{pmatrix}\sqrt{3/5} \\ \sqrt{2/5}\end{pmatrix}.
$$

(a) Cosa ottieni se agisci con l'operatore $S_z$ su questo vettore di stato? (b) Cosa ottieni se fai una singola misurazione della componente $z$ dello spin di questa particella? (c) Cosa ottieni se prepari molte particelle identiche a questo stato e fai migliaia di misurazioni della componente $z$ dello spin?
...
[1] Di Tatoute - Opera propria, CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=34095239
