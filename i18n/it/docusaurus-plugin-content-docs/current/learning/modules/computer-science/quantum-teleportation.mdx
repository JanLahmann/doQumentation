...
- Passo 3: Esegui il tuo job sui computer quantistici IBM usando le primitive di IBM Quantum
...
Un "Sampler" è una primitiva progettata per campionare i possibili stati risultanti da un circuito quantistico e raccogliere statistiche su quali stati potrebbero essere misurati e con quale probabilità. Importiamo qui il Sampler di IBM Quantum:
...
### Passo 1: Mappa il tuo problema su un circuito quantistico {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Passo 3: Esegui {#step-3-execute-1}
