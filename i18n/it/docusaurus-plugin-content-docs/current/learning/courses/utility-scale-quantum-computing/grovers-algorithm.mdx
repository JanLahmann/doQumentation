...
### Passo 2: ottimizzare per l'hardware target {#step-2-optimize-for-target-hardware-1}
...
### Passo 3: esecuzione del circuito. {#step-3-executing-the-circuit-1}
...
### Passo 4: post-elaborazione dei risultati. {#step-4-post-processing-the-results-1}
