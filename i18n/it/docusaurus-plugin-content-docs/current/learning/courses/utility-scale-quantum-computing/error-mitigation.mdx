...
Per fare una simulazione rumorosa, dobbiamo specificare `NoiseModel`. Mostriamo come costruire `NoiseModel` in questa sezione.
Dobbiamo prima definire gli errori quantistici (o di lettura) da aggiungere a un modello di rumore.
...
- [Configura la mitigazione degli errori](/guides/error-mitigation-and-suppression-techniques)
