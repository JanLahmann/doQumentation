...
### 2.2 Attività 2 {#22-activity-2}

#### Definisci l'Hamiltoniano {#define-the-hamiltonian-1}
...
Esattamente come nel caso a 20 qubit, la formula del prodotto di Lie (primo ordine) è implementata nella classe [LieTrotter](https://docs.quantum.ibm.com/api/qiskit/qiskit.synthesis.LieTrotter). Ancora una volta, la formula del primo ordine consiste nell'approssimazione indicata sopra:
...
### 2.5 Attività 5 {#25-activity-5}

#### Imposta gli operatori da misurare {#set-the-operators-to-be-measured-1}
...
### 2.6 Attività 6 {#26-activity-6}

#### Esegui la simulazione dell'evoluzione temporale {#perform-time-evolution-simulation-1}
...
#### Passo 4: Elaborazione post-esecuzione dei risultati {#step-4-post-process-results}
...
Utilizzeremo questi dati per il confronto più avanti. Prima però, vediamo se riusciamo a ottimizzare ulteriormente i nostri circuiti.
...
Complimenti! Hai fatto un altro passo avanti nel tuo percorso nel quantum computing su scala di utilità. Manca solo una lezione!
