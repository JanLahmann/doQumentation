...
Concretamente, ti viene chiesto di costruire ed eseguire il circuito corrispondente alla Figura 4b dell'articolo, e tracciare i punti "non mitigati" per conto tuo.  Come puoi vedere, è un circuito da 127 qubit $\times$ 60 livelli (20 passi di Trotter) con $\langle Z_{62} \rangle$ come osservabile.
![image.png](/learning/images/courses/utility-scale-quantum-computing/utility-i/utility1.avif)
Sembra impegnativo?  &nbsp; Non preoccuparti. Le ultime tre lezioni di questo corso forniscono i passaggi intermedi. Per iniziare, dimostreremo un esperimento su scala più piccola, che consiste nel costruire ed eseguire su un dispositivo fittizio un circuito da 27 qubit $\times$ 6 livelli (2 passi di Trotter) con $\langle Z_{13} \rangle$ come osservabile.
...
Esercitiamoci con queste routine.  Dovresti vedere un circuito di 27 qubit $\times$ 15 livelli (5 passi di Trotter). Poiché il dispositivo fittizio ha 28 archi, dovrebbero esserci 28*5 Gate di entanglement.
...
Quando lo stesso utente ha eseguito la cella successiva con lo stesso ambiente di cui sopra, ci sono voluti 2min 19s in Wall Time.  Eseguire un circuito su un dispositivo fittizio richiama una simulazione rumorosa che richiede molto più tempo rispetto a una simulazione esatta.   Ti consigliamo di non eseguire un circuito più grande (come uno da 27 qubit $\times$ 9 livelli con 3 passi di Trotter) su un dispositivo fittizio.
