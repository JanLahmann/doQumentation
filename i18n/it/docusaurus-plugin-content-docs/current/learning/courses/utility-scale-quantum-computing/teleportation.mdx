...
### Stima del valore $r_z$ {#estimate-r-z-value}
...
### Esercizio 1: Stima del valore $r_x$ {#exercise-1-estimate-r-x-value}
...
### Esercizio 2: Stima del valore $r_y$ {#exercise-2-estimate-r-y-value}
