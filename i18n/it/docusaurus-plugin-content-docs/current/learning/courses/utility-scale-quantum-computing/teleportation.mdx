...
3. Alice invia a Bob i risultati della sua misurazione ("00", "01", "10" o "11")
...
Alice invia a Bob i risultati della sua misurazione ("00", "01", "10" o "11"), e Bob esegue un operatore di correzione basato sui due bit di informazione di Alice sulla sua parte dell'e-bit condiviso. Poi, la parte di Bob diventa $|\psi \rangle$.
