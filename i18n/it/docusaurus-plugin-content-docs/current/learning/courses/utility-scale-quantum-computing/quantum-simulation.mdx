...
## 3. Esercizio 1. Eseguire la simulazione con Suzuki–Trotter del secondo ordine {#3-exercise-1-perform-simulation-using-second-order-suzukitrotter}
...
### 3.3 Tracciare i risultati di Suzuki–Trotter del secondo ordine {#33-plot-the-second-order-suzukitrotter-results}
...
### 4.3 Passo 3. Esecuzione con le primitive IBM Quantum {#43-step-3-execute-with-ibm-quantum-primitives}
