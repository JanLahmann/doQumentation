...
Il potenziale del quantum computing di contribuire alla scoperta di nuovi materiali progettati per migliorare la generazione, il trasferimento e l'immagazzinamento di energia è uno dei motivi per cui bp si sta alleando con IBM Quantum per raggiungere i suoi obiettivi di net-zero.
