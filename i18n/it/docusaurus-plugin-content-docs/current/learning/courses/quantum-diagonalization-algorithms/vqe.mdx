...
![Un'immagine di orbitali atomici e un'immagine di una rete con molti nodi e connessioni tra di essi.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig1.svg)
...
![Un'immagine di un circuito quantistico con parametri variazionali etichettati "theta".](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig2.svg)
...
![Un'immagine che mostra una curva che rappresenta l'energia con diversi punti in cui il valore viene testato per trovare il minimo.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig3.svg)
...
![Una tabella di diverse stringhe di Pauli, alcune delle quali commutano e altre no.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig4.svg)
...
![Due immagini di una curva con un valore minimo. In una, i punti vengono controllati casualmente nella ricerca del minimo; nell'altra, il gradiente viene stimato tracciando una retta tra due punti adiacenti.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig5.svg)
...
* Spesso si usa il configuration recovery [\[16\]](#references) e la symmetry postselection [\[15\]](#references) come tecnica di post-elaborazione.
