---
title: "Diagonalizzazione quantistica di Krylov"
sidebar_label: "Diagonalizzazione quantistica di Krylov"
description: "Viene descritta la diagonalizzazione quantistica di Krylov (KQD), a partire dai metodi di Krylov classici. Vengono discusse la convergenza e l'intensità delle risorse necessarie."
...
Supponi che un collega ricercatore stia dimostrando il metodo Krylov applicato a una piccola matrice giocattolo. C'è qualcosa di sbagliato nella scelta della matrice $A$ e del vettore iniziale $|\psi\rangle$?
...
![Un autovettore vero etichettato x, una stima etichettata x 0 e una rappresentazione grafica dell'errore tra i due.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig2.svg)
...
![Un autovettore vero e un aggiornamento alla stima iniziale. La stima aggiornata è più vicina al vero autovettore.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig3.svg)
