...
- __Eseguire ottimizzazioni del Circuit__ per ridurre la profondità del circuito e il numero di gate. Questa ottimizzazione può essere applicata anche prima, sul circuito virtuale, prima che i qubit siano assegnati a connessioni hardware specifiche.
