...
Falso. La maggior parte dei problemi di machine learning viene risolta in modo molto efficiente da algoritmi classici e gli algoritmi quantistici difficilmente offriranno un vantaggio significativo in termini di velocità. L'obiettivo nel QML è trovare dataset con caratteristiche ben descritte da stati quantistici e/o trovare mappature delle caratteristiche dei dati che ottimizzino l'accuratezza dei modelli.
...
5. Implementare metodi del kernel quantistico e classificatori quantistici variazionali usando le primitive di IBM Quantum e seguendo i pattern Qiskit.
