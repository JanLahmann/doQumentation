...
---
{/* doqumentation-source-hash: f983da09 */}
...
Nota che semplicemente aumentare il numero di passi di ottimizzazione probabilmente non migliorerà i risultati del simulatore, poiché tutte le ottimizzazioni sono in realtà già converge alla tolleranza richiesta in meno del numero massimo di iterazioni.
