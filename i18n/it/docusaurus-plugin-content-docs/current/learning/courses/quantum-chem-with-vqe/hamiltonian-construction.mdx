...
__basis__ si riferisce alle funzioni usate per modellare gli orbitali molecolari. Qui 'sto-6g' è una comune base minimale, il cui nome deriva dall'adattamento di orbitali di tipo Slater usando 6 orbitali gaussiani primitivi.
...
__symmetry__ - il gruppo di simmetria puntuale della molecola, specificato con una stringa oppure rilevato automaticamente impostando "symmetry = True". Qui "Dooh" è il gruppo di simmetria appropriato per molecole biatomiche con due specie atomiche uguali.
