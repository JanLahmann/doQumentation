...
Il codice seguente mostra un esempio di set di input vettorizzati per la primitiva `Sampler` e li esegue su un backend IBM&reg; come un singolo oggetto `RuntimeJobV2 `.
...
I risultati dei job [`SamplerV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2) eseguiti in IBM Quantum Compute Service contengono informazioni di temporizzazione dell'esecuzione nei loro metadati.
