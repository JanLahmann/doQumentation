---
description: 'Risposte alle domande più frequenti sulle modalità di esecuzione'
...
<Accordion>
  <AccordionItem title="La modalità di test locale di `qiskit-ibm-runtime` supporta le diverse modalità di esecuzione?">
