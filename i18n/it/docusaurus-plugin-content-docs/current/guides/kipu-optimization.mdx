...
### 1. Crea la funzione obiettivo {#1-create-the-objective-function-1}
...
### 2. Esegui l'Optimizer {#2-run-the-optimizer-1}
...
### 3. Recupera il risultato {#3-retrieve-the-result-1}
