...
di simulazione più avanzate ([usando Qiskit Aer](/guides/simulate-stabilizer-circuits)) o di eseguire su dispositivi reali ([primitive di Qiskit Runtime](primitives)).
