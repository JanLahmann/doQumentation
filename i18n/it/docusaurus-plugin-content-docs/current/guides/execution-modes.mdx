---
title: Introduzione alle modalità di esecuzione di Qiskit Runtime
...
# Introduzione alle modalità di esecuzione di Qiskit Runtime {#introduction-to-qiskit-runtime-execution-modes}
