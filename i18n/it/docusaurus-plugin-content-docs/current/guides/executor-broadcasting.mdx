...
## Esempio di avvio rapido {#quickstart-example}
...
## Assi intrinseci ed estrinseci {#intrinsic-and-extrinsic-axes}
...
## Forme degli array di output {#output-array-shapes}
...
## Randomizzazione e il parametro `shape` {#randomization-and-the-shape-parameter}
...
### Nessun asse di randomizzazione esplicito {#no-explicit-randomization-axes}
...
### Asse di randomizzazione singolo {#single-randomization-axis}
...
### Assi di randomizzazione multipli {#multiple-randomization-axes}
...
### Come `shape` e le forme di input interagiscono {#how-shape-and-input-shapes-interact}
...
### Indicizza i risultati {#index-into-results}
...
### Sweep di un singolo parametro {#sweep-a-single-parameter}
...
### Creare uno sweep su griglia 2D {#creating-a-2d-grid-sweep}
...
### Combinare più input {#combining-multiple-inputs}
