...
<Admonition type="note">
Questi esempi usano il target del mock backend [`FakeSherbrooke`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/fake-provider-fake-sherbrooke#fakesherbrooke) di `qiskit_ibm_runtime`. Tuttavia, puoi provarli su qualsiasi backend reale o fittizio compatibile con Qiskit. I risultati potrebbero essere diversi.
</Admonition>
...
Questo argomento mostra diversi esempi di come passare informazioni al transpiler.
