...
Autenticati usando la tua [chiave API di IBM Quantum Platform](http://quantum.cloud.ibm.com/), e seleziona la funzione TEM come segue. (Questo frammento presuppone che tu abbia già [salvato il tuo account](/guides/functions-get-started#install-qiskit-functions-catalog-client) nell'ambiente locale.)
