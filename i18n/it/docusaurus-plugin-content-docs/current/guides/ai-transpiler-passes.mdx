...
Consulta la [documentazione del Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) per maggiori informazioni sui limiti che si applicano ai pass del transpiler potenziati dall'AI.

## Citazione {#citation}

Se utilizzi qualsiasi funzionalità potenziata dall'AI del Qiskit Transpiler Service nella tua ricerca, usa [la citazione consigliata](/guides/qiskit-transpiler-service#citation).
