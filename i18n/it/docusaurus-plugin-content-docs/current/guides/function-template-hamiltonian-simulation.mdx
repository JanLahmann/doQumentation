...
#### 1. Raccolta degli input e mappatura del problema {#collecting-input-and-mapping-the-problem}
...
#### 2. Preparare i circuiti generati per l'esecuzione {#prepare-the-generated-circuits-for-execution}
