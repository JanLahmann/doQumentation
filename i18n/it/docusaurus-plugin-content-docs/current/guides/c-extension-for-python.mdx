...
<Admonition type="warning">
  L'API C di Qiskit è ancora sperimentale e non si è ancora impegnata a fornire un'interfaccia di programmazione o binaria completamente stabile. I moduli di estensione compilati contro Qiskit sono garantiti per funzionare solo con la versione di Qiskit usata nella compilazione.
</Admonition>
