...
- Per la simulazione esatta di piccoli circuiti quantistici, puoi usare le primitive di riferimento incluse in Qiskit SDK. Consulta [Simulazione esatta con le primitive Qiskit SDK](/guides/simulate-with-qiskit-sdk-primitives).
...
- [Debug dei job con NEAT](/guides/debug-qiskit-runtime-jobs).
</Admonition>
