---
title: Introduzione
description: Introduzione all'uso dei simulatori per il testing e il debug di circuiti quantistici in Qiskit.
---
...
- Per la simulazione esatta di piccoli circuiti quantistici, puoi usare le primitive di riferimento incluse in Qiskit. Consulta [Simulazione esatta con le primitive di Qiskit](/guides/simulate-with-qiskit-sdk-primitives).
...
- Per costruire modelli di rumore personalizzati, usa il modulo [`noise`](https://qiskit.org/ecosystem/aer/apidocs/aer_noise.html) di Qiskit Aer. Consulta [Costruire modelli di rumore](/guides/build-noise-models).
...
- L'unico requisito per eseguire Qiskit è un ambiente Python funzionante. Per i dettagli, consulta la sezione [Supporto del sistema operativo](/guides/install-qiskit#operating-system-support).
...
- Scopri [Simulazione esatta e rumorosa con le primitive di Qiskit Aer](/guides/simulate-with-qiskit-aer).
- Consulta la documentazione sulla [visualizzazione dei circuiti](/guides/visualize-circuits).
- Consulta la documentazione sulla [visualizzazione dei tempi dei circuiti](/guides/visualize-circuit-timing).
- [Debug dei job di Qiskit Runtime](/guides/debug-qiskit-runtime-jobs).
</Admonition>
