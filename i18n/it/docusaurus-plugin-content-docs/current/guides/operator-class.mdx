...
Questa pagina mostra come usare la classe [`Operator`](https://docs.quantum.ibm.com/api/qiskit/qiskit.quantum_info.Operator). Per una panoramica di alto livello delle rappresentazioni degli operatori in Qiskit, inclusa la classe `Operator` e altre, consulta [Panoramica delle classi operatore](/guides/operators-overview).
