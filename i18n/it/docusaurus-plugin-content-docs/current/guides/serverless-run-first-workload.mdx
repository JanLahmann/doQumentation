...
Assicurati di esserti autenticato a Qiskit Serverless usando la tua [chiave API](https://quantum.cloud.ibm.com/) (consulta [Deploy su IBM Quantum Platform](/guides/serverless-first-program#deploy-to-ibm-quantum-platform) per le istruzioni).
