...
## Importare un programma OpenQASM 2 in Qiskit {#import-an-openqasm-2-program-into-qiskit}
...
### Importare programmi semplici {#import-simple-programs}

Per la maggior parte dei programmi OpenQASM 2, puoi usare semplicemente `qasm2.load` e `qasm2.loads` con un singolo argomento.

#### Esempio: importare un programma OpenQASM 2 come stringa {#example-import-an-openqasm-2-program-as-a-string}
...
#### Esempio: importare un programma OpenQASM 2 da file {#example-import-an-openqasm-2-program-from-a-file}
...
### Collegare i gate OpenQASM 2 ai gate di Qiskit {#link-openqasm-2-gates-with-qiskit-gates}
...
#### Esempio: importare un programma creato dall'esportatore legacy di Qiskit {#example-import-a-program-created-by-qiskits-legacy-exporter}
...
#### Esempio: usare una classe gate specifica nell'importazione di un programma OpenQASM 2 {#example-use-a-particular-gate-class-when-importing-an-openqasm-2-program}
...
#### Esempio: definire un nuovo gate integrato in un programma OpenQASM 2 {#example-define-a-new-built-in-gate-in-an-openqasm-2-program}
...
### Definire funzioni classiche personalizzate {#define-custom-classical-functions}
...
#### Esempio: usare istruzioni classiche personalizzate {#example-use-custom-classical-instructions}
...
## Esportare un circuito Qiskit in OpenQASM 2 {#export-a-qiskit-circuit-to-openqasm-2}
...
### Esempio: esportare un circuito in OpenQASM 2 {#example-export-a-circuit-to-openqasm-2}
