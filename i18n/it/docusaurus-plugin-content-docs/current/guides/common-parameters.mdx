...
## Grado di approssimazione {#approximation-degree}
...
## Seed del generatore di numeri casuali {#random-number-generator-seed}
...
## Layout iniziale {#initial-layout}
...
## Opzioni per le fasi e i plugin del transpiler {#transpiler-stage-and-plugin-options}

Queste opzioni hanno il suffisso `_method`. Influenzano il modo in cui il transpiler funziona e vengono usate per cercare di ottenere un output migliore, diverso o specifico dal transpiler.
