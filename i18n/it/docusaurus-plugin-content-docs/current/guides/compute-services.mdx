...
Il Qiskit Transpiler Service ([nome pacchetto `qiskit-ibm-transpiler`](https://pypi.org/project/qiskit-ibm-transpiler/)) è un nuovo servizio sperimentale che fornisce funzionalità di transpilazione remota nel cloud agli utenti del Premium Plan, Flex Plan e On-Prem (tramite IBM Quantum Platform API) Plan di IBM Quantum. Oltre alle funzionalità locali del Transpiler di Qiskit SDK, le tue attività di transpilazione possono beneficiare sia delle risorse cloud di IBM Quantum che dei passi del Transpiler basati sull'IA utilizzando questo servizio. Per saperne di più su come integrare la transpilazione basata su cloud nel tuo flusso di lavoro Qiskit, puoi [consultare la documentazione](/guides/qiskit-transpiler-service).
