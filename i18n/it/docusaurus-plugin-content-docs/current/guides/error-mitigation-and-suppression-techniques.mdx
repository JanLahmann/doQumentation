...
### Abilitare TREX usando l'opzione `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### Abilitare TREX usando l'opzione `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### Abilitare ZNE usando l'opzione `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}
...
### Abilitare ZNE usando l'opzione `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- Esplora le altre [opzioni](/guides/runtime-options-overview) per le primitive di Qiskit Runtime.
