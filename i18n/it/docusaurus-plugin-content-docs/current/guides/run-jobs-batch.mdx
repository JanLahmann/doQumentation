---
description: 'Come eseguire job di quantum computing in modalità batch con IBM Quantum Compute Service.'
...
Prima di avviare un batch, devi [configurare il client IBM Quantum Compute](/guides/install-qiskit) e inizializzarlo come servizio:
...
Per una panoramica completa della configurazione e dello stato di un batch, incluso il suo TTL interattivo e massimo, usa il  `batch.details() method`.
...
<Admonition type="tip" title="Raccomandazioni">
  - Prova un esempio nel tutorial [Combinare le opzioni di mitigazione degli errori con la primitiva Estimator](/tutorials/combine-error-mitigation-techniques).
