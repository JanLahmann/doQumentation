---
description: "Migra dall'utilizzo dei simulatori cloud di IBM Quantum all'utilizzo della modalità di test locale `qiskit-ibm-runtime`."
title: 'Migra ai simulatori locali'
---

{/* doqumentation-source-hash: 9db328b8 */}

# Migra dai simulatori cloud ai simulatori locali {#migrate-to-local-simulators}
...
<Accordion>
<AccordionItem title="I simulatori hanno limitazioni">
...
<AccordionItem title="L'uso dell'hardware quantistico sviluppa competenze uniche">
...
<AccordionItem title="Gli algoritmi dovrebbero essere adattati per l'hardware quantistico">
...
## Migra ai simulatori locali {#migrate-to-local-simulators-1}
