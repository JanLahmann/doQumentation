---
description: 'Esempi pratici di utilizzo della primitiva IBM Quantum Estimator.'
...
## Esegui un singolo esperimento {#run-a-single-experiment}
...
## Esegui più esperimenti in un singolo job {#run-multiple-experiments-in-a-single-job}
...
## Esegui Circuit parametrizzati {#run-parameterized-circuits}
...
## Usa batch e opzioni avanzate {#use-batches-and-advanced-options}
