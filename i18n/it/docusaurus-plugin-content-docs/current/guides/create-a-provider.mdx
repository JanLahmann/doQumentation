...
Consulta la [documentazione API](../api/qiskit/primitives) di `qiskit.primitives`, nonché le implementazioni di riferimento [`BackendEstimatorV2`](../api/qiskit/qiskit.primitives.BackendEstimatorV2) e [`BackendSampleV2`](../api/qiskit/qiskit.primitives.BackendSamplerV2) per maggiori informazioni.
