---
title: "Rappresentare graficamente gli stati quantistici"
sidebar_label: "Rappresentare graficamente gli stati quantistici"
description: "Visualizza statevector e matrici di densità con Qiskit"
notebook_path: "guides/plot-quantum-states.ipynb"
---
{/* doqumentation-source-hash: 16f628c3 */}
...
<TabItem value="City" label="City">
  ...
  Questo grafico mostra le parti reale e immaginaria di ogni elemento della matrice di densità in due grafici a barre tridimensionali. Si chiama grafico "city" (città) perché le barre ricordano i grattacieli di una città. Lo stato che stiamo rappresentando ha la seguente matrice di densità.
...
<TabItem value="Pauli vector" label="Pauli vector">
  ...
  I prodotti tensoriali delle matrici di Pauli sono osservabili che restituiscono +1 o -1. Questo grafico mostra i valori di aspettazione dello stato su diversi operatori di Pauli come grafico a barre. Ogni matrice di densità può essere scritta come somma di queste matrici di Pauli, pesate dai rispettivi valori di aspettazione.
