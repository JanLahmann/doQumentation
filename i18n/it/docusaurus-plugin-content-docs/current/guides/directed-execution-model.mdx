...
4. Esegui il template circuit e il samplex con la primitiva [Executor](#executor-primitive), che genererà ed eseguirà le varianti del circuito come indicato.
