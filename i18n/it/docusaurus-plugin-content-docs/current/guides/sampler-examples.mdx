---
description: 'Esempi pratici di utilizzo della primitiva IBM Quantum Sampler.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Esempi di Sampler'
title: 'Esempi di Sampler'
---
...
Usa Sampler per restituire il risultato della misura come bitstring o conteggi di un singolo Circuit.
...
Usa Sampler per restituire il risultato della misura come bitstring o conteggi di più Circuit in un solo job.
