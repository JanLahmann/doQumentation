...
## Impostare le opzioni delle primitive {#set-primitive-options}
...
#### Livello di resilienza (solo Estimator) {#resilience-level-estimator-only}
...
#### Precisione (solo Estimator) {#precision-estimator-only}
...
## Opzioni comunemente usate {#commonly-used-options}
...
### Tempo massimo di esecuzione {#maximum-execution-time}
...
## Disattivare tutta la mitigazione e la soppressione degli errori {#turn-off-all-error-mitigation-and-error-suppression}
