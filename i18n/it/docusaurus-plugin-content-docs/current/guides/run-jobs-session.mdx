---
description: 'Come eseguire un job di calcolo quantistico in una sessione di IBM Quantum Compute Service.'
...
Prima di avviare una sessione, devi [configurare il client IBM Quantum Compute](/guides/install-qiskit-runtime) e inizializzarlo come servizio:
...
Per una panoramica completa della configurazione e dello stato di una sessione, usa il  `session.details() method`.
