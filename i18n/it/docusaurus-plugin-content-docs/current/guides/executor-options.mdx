...
Il ritardo tra una misurazione e il Circuit quantistico successivo.
...
<Tabs>
  ...
  Incompatibile con i Circuit dinamici.
  ...
  Compatibile con i Circuit dinamici quando si usa `qiskit-ibm-runtime` v0.42.0 o versioni successive.
