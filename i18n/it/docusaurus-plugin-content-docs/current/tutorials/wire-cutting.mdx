...
#### Tagliare il circuito in sottocircuiti più piccoli {#cut-the-circuit-into-smaller-subcircuits}
...
#### Creare ed espandere le osservabili {#create-and-expand-the-observables}
...
#### Traspilare ogni subexperiment {#transpile-each-subexperiment}
...
#### Verifica incrociata {#cross-verify}
...
## Part II. Aumentare la scala! {#part-ii-scale-it-up}
...
## Appendice: considerazioni sulla scalabilità delle risorse {#appendix-resource-scaling-consideration}
...
### Un esempio di circuito adatto e non adatto al taglio {#one-example-of-cut-friendly-and-cut-unfriendly-circuits-each}

#### Circuito adatto al taglio {#cut-friendly-circuit}
...
#### Circuito non adatto al taglio {#cut-unfriendly-circuit}
