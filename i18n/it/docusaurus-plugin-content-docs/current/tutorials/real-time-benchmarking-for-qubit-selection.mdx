...
> **Nota:** Questo sondaggio è di **IBM Quantum** e riguarda il **contenuto del tutorial** (scritto da IBM). doQumentation fornisce il sito web, le traduzioni e l'esecuzione del codice — per feedback su questi aspetti, [apri un problema su GitHub](https://github.com/JanLahmann/doQumentation/issues).

[Link al sondaggio](https://your.feedback.ibm.com/jfe/form/SV_0w6FZ9QrWkKfTQq)
