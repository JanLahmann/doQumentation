---
description: 'Esplora i tutorial IBM Quantum — eseguibili su RasQberry, tramite Binder o sul tuo server Jupyter.'
...
- Inizia con l'insieme di tutorial nella sezione [Per iniziare](#get-started) se è la tua prima volta che esegui codice su un computer quantistico.

- La sezione sui [flussi di lavoro verso il vantaggio](#explore-workflows-toward-advantage) contiene esempi end-to-end dell'uso di un computer quantistico per risolvere problemi del mondo reale. Questi tutorial si concentrano su algoritmi che sono candidati promettenti per raggiungere il vantaggio computazionale di un computer quantistico rispetto a un computer classico.

- La sezione su [funzionalità di Qiskit](#leverage-qiskit-capabilities) contiene esempi che utilizzano le tecniche più recenti e avanzate dell'ecosistema Qiskit per migliorare parte o l'intero di un particolare workflow.
...
<Accordion>
<AccordionItem title="**Algoritmi di campionamento verificabile**">
...
* [Warm-start QAOA con il Qiskit addon Optimization Mapper](/tutorials/warm-start-qaoa)


* [Pauli correlation encoding per ridurre i requisiti max-cut](/tutorials/pauli-correlation-encoding-for-qaoa)


* [Calcoli di solvente implicito usando Qiskit Serverless](/tutorials/implicit-solvent-calculations)


</AccordionItem>

<AccordionItem title="**Stima di osservabili**">
...
* [Simulare lo scattering di neutroni in materiali quantistici con circuiti quantistici](/tutorials/simulate-neutron-scattering)


* [Simulare lo scattering di neutroni con un workflow Serverless AQC + dinamica di Trotter](/tutorials/simulate-neutron-scattering-with-a-serverless-workflow)
...
* [Osservazione di dinamiche robuste e coerenti di adroni non abeliani su processori quantistici rumorosi](/tutorials/loop-string-hadron-dynamics)


</AccordionItem>

<AccordionItem title="**Algoritmi fault-tolerant**">
...
<Accordion>
<AccordionItem title="**Ottimizzazione del carico di lavoro**">
...
* [Kernel quantistici con fractional gate](/tutorials/fractional-gates)


* [Introduzione al transpiler AI-powered di Qiskit](/tutorials/ai-transpiler-introduction)


* [Ottimizzazione di transpilation con SABRE](/tutorials/transpilation-optimizations-with-sabre)
...
- Progetta nuovi algoritmi con le **circuito functions** &mdash; con pipeline di transpilation, error suppression e error mitigation precostruite.
  ...
  * [Simula un modello Ising kicked con la funzione TEM](/tutorials/simulate-kicked-ising-tem)


  * [Benchmark della fedeltà del processo QFT+M con Orbit, una Qiskit Function di Quantum Elements](/tutorials/quantum-elements-orbit-qft-with-dynamic-circuits)


- Sperimenta con problemi specifici del dominio con le **Application functions** &mdash; con input e output familiari ai risolutori classici.


  * [Ottimizzazione dinamica del portfolio con Portfolio Optimizer di Global Data Quantum](/tutorials/global-data-quantum-optimizer)
...
* [Cancellazione probabilistica degli errori con lightcone ombreggiati](/tutorials/pec-with-shaded-lightcones)

  
* [Migliorare i valori di aspettazione con l'assorbimento del rumore propagato (PNA)](/tutorials/propagated-noise-absorption)


* [Benchmarking in tempo reale per la selezione dei qubit](/tutorials/real-time-benchmarking-for-qubit-selection)


* [Aggiornare le proprietà del backend con il benchmarking in tempo reale](/tutorials/refresh-backend-properties-with-real-time-benchmarking)
...
* [Error detection a basso overhead con codici spaziotemporali](/tutorials/spacetime-codes)
