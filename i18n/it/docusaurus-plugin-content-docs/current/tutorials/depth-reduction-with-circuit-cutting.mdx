...
Questo tutorial dimostra come costruire un `Qiskit pattern` per tagliare i gate in un circuito quantistico per ridurre la profondità del circuito. Per una discussione più approfondita sul circuit cutting, visita la [documentazione dell'addon Qiskit per il circuit cutting](https://qiskit.github.io/qiskit-addon-cutting/).
...
> **Nota:** Questo sondaggio è di **IBM Quantum** e riguarda il **contenuto del tutorial** (scritto da IBM). doQumentation fornisce il sito web, le traduzioni e l'esecuzione del codice — per feedback su questi aspetti, [apri un issue su GitHub](https://github.com/JanLahmann/doQumentation/issues).

[Link al sondaggio](https://your.feedback.ibm.com/jfe/form/SV_2ftYFf9t72yFNIO)
