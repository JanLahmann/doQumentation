...
Prima di eseguire sulla QPU reale, verifichiamo che sia i circuiti dinamici che quelli unitari producano uno stato di Bell ideale su un simulatore privo di rumore. Usiamo il `Sampler` IBM Quantum con `AerSimulator` come modalità backend, con una piccola distanza di 6.
