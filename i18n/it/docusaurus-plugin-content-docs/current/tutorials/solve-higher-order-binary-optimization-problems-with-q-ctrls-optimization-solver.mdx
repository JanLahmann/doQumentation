...
Dovrete anche ottenere l'accesso alla funzione Optimization Solver. [Compilate il modulo](https://quantum.cloud.ibm.com/functions?id=q-ctrl-optimization-solver) per richiedere l'accesso.
