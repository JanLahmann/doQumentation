...
Definisci le tue credenziali della [IBM Quantum Platform](https://quantum.cloud.ibm.com/), che saranno utilizzate durante tutto il tutorial per autenticarsi su IBM Quantum Compute Service e Qiskit Functions.
