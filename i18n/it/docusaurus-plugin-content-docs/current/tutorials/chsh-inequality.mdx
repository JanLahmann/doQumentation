...
Nella figura, le linee e le aree grigie delimitano i limiti; le linee più esterne (tratto-punto) delimitano i limiti quantistici ($\pm 2$), mentre le linee interne (tratteggiate) delimitano i limiti classici ($\pm 2\sqrt{2}$). Puoi vedere che ci sono regioni in cui le quantità witness CHSH superano i limiti classici. Congratulazioni! Hai dimostrato con successo la violazione della disuguaglianza di CHSH in un sistema quantistico reale!
