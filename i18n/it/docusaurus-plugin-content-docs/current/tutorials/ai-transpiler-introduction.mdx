...
### Caratteristiche principali dei pass AI {#key-features-of-ai-passes}
...
### Perché utilizzare l'AI per la transpilazione dei circuiti quantistici? {#why-use-ai-for-quantum-circuit-transpilation}
...
### Brevi risultati di benchmarking {#brief-benchmarking-results}
...
# Parte I. Pattern di Qiskit {#part-i-qiskit-patterns}
...
### Scegliere un backend {#choose-a-backend}
...
### Creare pass manager AI e tradizionali {#create-ai-and-traditional-pass-managers}
...
## Passo 3: Eseguire utilizzando i primitive di Qiskit {#step-3-execute-using-qiskit-primitives}
...
# Parte II. Analizzare e fare benchmark dei circuiti transpilati {#part-ii-analyze-and-benchmark-the-transpiled-circuits}
...
## Quando gli utenti dovrebbero scegliere la transpilazione basata su AI? {#when-should-users-choose-ai-powered-transpilation}
...
# Parte III. Esplorare la sintesi di reti di permutazione basata su AI {#part-iii-explore-ai-powered-permutation-network-synthesis}
