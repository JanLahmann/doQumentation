...
### Calcolare i valori di aspettazione esatti {#plot-trotter-simulation-results}
...
### Tracciare i valori di aspettazione medi su tutti i qubit virtuali per ciascun valore di parametro {#plot-extrapolation-results-for-individual-qubits}
...
### Tracciare i valori di aspettazione per singoli qubit

Potete anche tracciare i valori di aspettazione per singoli qubit per vedere come si comportano individualmente. Questo codice traccia i risultati per i primi quattro qubit virtuali.
