...
L'amplificazione di ampiezza è un problema di campionamento adatto per l'esecuzione con la primitiva [`Sampler`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2) del runtime.
