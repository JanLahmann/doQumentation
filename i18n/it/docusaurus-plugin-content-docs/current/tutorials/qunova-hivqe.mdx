...
### Tracciare la curva di dissociazione per Li\_2S
...
#### Inviate il calcolo per d(Fe-N) = 1.75 $\AA$.
...
#### Inviate il calcolo per d(Fe-N) = 2.00 $\AA$.
...
#### Inviate il calcolo per d(Fe-N) = 5.00 $\AA$.
