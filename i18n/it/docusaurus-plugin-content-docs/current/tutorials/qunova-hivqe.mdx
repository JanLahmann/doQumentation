...
Nota che per eseguire la funzione sul sistema FeP-NO con le impostazioni mostrate in questo esempio, è necessaria una licenza che consenta l'utilizzo della funzione con almeno 44 qubit. Invia un'email a [qiskit.support@qunovacomputing.com](mailto:qiskit.support@qunovacomputing.com) per informazioni su come ottenere una licenza.
...
### Passo 2 e 3: Ottimizzare il problema per l'esecuzione su hardware quantistico ed eseguire utilizzando la funzione HiVQE Chemistry {#step-2-and-3-optimize-problem-for-quantum-hardware-execution-and-execute-using-the-hivqe-chemistry-function}
...
### Passo 4: Post-elaborare e confrontare con i metodi classici {#step-4-post-process-and-compare-with-classical-methods}
