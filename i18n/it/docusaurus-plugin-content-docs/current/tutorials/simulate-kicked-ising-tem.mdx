...
Possono essere passate anche opzioni personalizzate per il noise learner. Seguono le definizioni utilizzate in `qiskit-ibm-runtime` [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options):
