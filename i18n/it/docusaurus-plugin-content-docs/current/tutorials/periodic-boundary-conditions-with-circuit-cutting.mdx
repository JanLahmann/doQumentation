...
- circuito cutting Qiskit addon v.9.0 o successiva (`pip install qiskit-addon-cutting`)
...
#### Selezionare il backend e il layout iniziale {#select-backend-and-initial-layout}
...
#### Costruire l'entangler map per il circuito TwoLocal {#build-the-entangler-map-for-the-twolocal-circuit}
...
#### Selezionare le osservabili {#select-observables}
...
#### Trasporre il circuito {#transpile-the-circuit}
...
#### Tagliare le connettività periodiche a lungo raggio {#cut-the-long-range-periodic-connectivities}
...
#### Trasporre i sottoesperimenti {#transpile-the-subexperiments}
...
### Verifica incrociata: Ottenere il valore di aspettazione non tagliato {#cross-verify-obtain-uncut-expectation-value}
...
> **Nota:** questo sondaggio è di **IBM Quantum** e riguarda il **contenuto del tutorial** (scritto da IBM). doQumentation fornisce il sito web, le traduzioni e l'esecuzione del codice — per feedback su questi aspetti, [apri una issue su GitHub](https://github.com/JanLahmann/doQumentation/issues).

[Link al sondaggio](https://your.feedback.ibm.com/jfe/form/SV_3fQQYAIjTxvIChg)
