...
description: "Segui un esempio di costruzione ed esecuzione di un workflow utilizzando la funzione IBM Circuit."
...
Visita la documentazione per un'[introduzione alle Qiskit Functions](/guides/functions) e impara come iniziare con la [funzione IBM Circuit](/guides/ibm-circuit-function).
## Contesto {#background}
...
Il risultato dall'esecuzione della funzione ha lo stesso formato dell'[Estimator](/guides/estimator-input-output).
