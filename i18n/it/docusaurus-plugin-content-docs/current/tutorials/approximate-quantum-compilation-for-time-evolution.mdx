...
### Hamiltoniano modello e osservabile {#model-hamiltonian-and-observable}
...
#### Configurare l'hamiltoniano e l'osservabile {#set-up-the-hamiltonian-and-observable}
...
#### Determinare la porzione di evoluzione temporale da simulare classicamente {#determine-the-portion-of-time-evolution-to-simulate-classically}
...
#### Scegliere il tempo di divisione {#choose-the-split-time}
...
#### Generare un ansatz e parametri iniziali da un circuito Trotter con meno passi {#generate-an-ansatz-and-initial-parameters-from-a-trotter-circuit-with-fewer-steps}
...
#### Ottimizzare i parametri dell'ansatz utilizzando calcoli MPS {#optimize-the-parameters-of-the-ansatz-using-mps-calculations}
