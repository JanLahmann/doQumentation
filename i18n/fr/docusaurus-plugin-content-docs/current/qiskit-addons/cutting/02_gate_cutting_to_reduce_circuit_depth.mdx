...
### Remplacer les Gates distantes par des `TwoQubitQPDGate`s en spécifiant leurs indices {#replace-distant-gates-with-twoqubitqpdgates-by-specifying-their-indices}
...
### Montrer que les sous-expériences QPD seront plus légères après la découpe des Gates distantes {#demonstrate-that-the-qpd-subexperiments-will-be-shallower-after-cutting-distant-gates}
