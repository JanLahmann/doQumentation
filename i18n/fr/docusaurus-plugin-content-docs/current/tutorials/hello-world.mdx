...
**Ignorez cette cellule** si vous avez enregistré vos identifiants dans [Paramètres](/jupyter-settings#ibm-quantum) ou activé le mode simulateur — ils sont injectés automatiquement lorsque vous cliquez sur Exécuter. Exécuter cette cellule avec les valeurs par défaut écrasera votre configuration.
