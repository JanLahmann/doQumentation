...
description: "Utiliser l'addon d'atténuation des erreurs de lecture M3 avec la primitive Sampler"
...
Cela s'explique aisément si tu te rappelles que la lecture nécessite de détecter un état
...
Pour les détails techniques sur M3, tu peux consulter [*Scalable Mitigation of Measurement Errors on Quantum Computers*](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.2.040326).
...
Nous voyons que la bonne chaîne de bits du décalage caché est trouvée. De plus, les neuf chaînes de bits les plus probables suivantes ne diffèrent que par une seule position.
