---
description: 'Parcourez les tutoriels IBM Quantum — exécutables sur RasQberry, via Binder ou sur ton propre serveur Jupyter.'
...
- Commence par l'ensemble des tutoriels de la section [Commencer](#get-started) si c'est la première fois que tu exécutes du code sur un ordinateur quantique.

- La section sur les [flux de travail vers l'avantage quantique](#explore-workflows-toward-advantage) contient des exemples de bout en bout d'utilisation d'un ordinateur quantique pour résoudre des problèmes du monde réel. Ces tutoriels se concentrent sur des algorithmes qui sont des candidats prometteurs pour atteindre un avantage computationnel d'un ordinateur quantique sur un ordinateur classique.

- La section sur les [capacités de Qiskit](#leverage-qiskit-capabilities) contient des exemples qui utilisent les techniques les plus récentes et les plus avancées de l'écosystème Qiskit pour améliorer une partie ou l'ensemble d'un flux de travail particulier.
...
<Accordion>
<AccordionItem title="**Algorithmes d'échantillonnage vérifiables**">
...
* [Démarrage à chaud de QAOA avec le module complémentaire Qiskit Optimization Mapper](/tutorials/warm-start-qaoa)


* [Encodage par corrélation de Pauli pour réduire les exigences de Maxcut](/tutorials/pauli-correlation-encoding-for-qaoa)


* [Calculs de solvant implicite avec Qiskit Serverless](/tutorials/implicit-solvent-calculations)


</AccordionItem>

<AccordionItem title="**Estimation d'observables**">
...
* [Simuler la diffusion de neutrons dans des matériaux quantiques avec des circuits quantiques](/tutorials/simulate-neutron-scattering)


* [Simuler la diffusion de neutrons avec un flux de travail Serverless AQC + dynamique de Trotter](/tutorials/simulate-neutron-scattering-with-a-serverless-workflow)
...
* [Observation d'une dynamique de hadrons non abéliens robuste et cohérente sur des processeurs quantiques bruités](/tutorials/loop-string-hadron-dynamics)


</AccordionItem>

<AccordionItem title="**Algorithmes tolérants aux fautes**">
...
<Accordion>
<AccordionItem title="**Optimisation de la charge de travail**">
...
* [Noyaux quantiques avec portes fractionnaires](/tutorials/fractional-gates)


* [Introduction à la transpilation assistée par IA de Qiskit](/tutorials/ai-transpiler-introduction)


* [Optimisation de transpilation avec SABRE](/tutorials/transpilation-optimizations-with-sabre)
...
- Conçois de nouveaux algorithmes avec les **fonctions de circuit** &mdash; avec des pipelines de transpilation, de suppression d'erreurs et d'atténuation d'erreurs pré-construits.
  ...
  * [Simuler un modèle d'Ising perturbé avec la fonction TEM](/tutorials/simulate-kicked-ising-tem)


  * [Évaluer la fidélité du processus QFT+M avec Orbit, une fonction Qiskit de Quantum Elements](/tutorials/quantum-elements-orbit-qft-with-dynamic-circuits)


- Expérimente avec des problèmes spécifiques à un domaine avec les **fonctions d'application** &mdash; avec des entrées et sorties familières pour les solveurs classiques.
...
<AccordionItem title="**Extensions Qiskit (addons)**">
...
<AccordionItem title="**Atténuation d'erreurs**">
...
* [Annulation probabiliste des erreurs avec des cônes de lumière ombrés](/tutorials/pec-with-shaded-lightcones)

  
* [Améliorer les valeurs d'espérance avec l'absorption de bruit propagé (PNA)](/tutorials/propagated-noise-absorption)


* [Évaluation en temps réel pour la sélection de qubits](/tutorials/real-time-benchmarking-for-qubit-selection)


* [Actualiser les propriétés du backend avec le benchmarking en temps réel](/tutorials/refresh-backend-properties-with-real-time-benchmarking)


</AccordionItem>

<AccordionItem title="**Détection d'erreurs**">
...
* [Détection d'erreurs à faible surcharge avec les codes spatio-temporels](/tutorials/spacetime-codes)
