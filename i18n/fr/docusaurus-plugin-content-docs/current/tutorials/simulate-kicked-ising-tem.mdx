...
Des options personnalisées pour l'apprentisseur de bruit peuvent également être passées. Elles suivent les définitions utilisées dans `qiskit-ibm-runtime` [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options) :
