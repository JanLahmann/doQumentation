...
## Configuration {#setup}
Tout d'abord, authentifie-toi à l'aide de ta [clé API IBM Quantum](http://quantum.cloud.ibm.com/). Ensuite, sélectionne la fonction Qiskit comme suit. (Ce code suppose que tu as déjà [enregistré ton compte](/guides/functions#install-qiskit-functions-catalog-client) dans ton environnement local.)
