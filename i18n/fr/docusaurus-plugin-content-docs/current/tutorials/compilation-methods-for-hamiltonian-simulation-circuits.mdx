...
Les circuits utilisés dans ce benchmark sont issus du [dépôt de benchmarks Hamlib](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/hamlib), qui contient des charges de travail réalistes de simulation hamiltonienne.
