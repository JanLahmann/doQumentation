...
Pour caractériser plus rigoureusement l'ordre à longue portée, vous pouvez examiner la corrélation moyenne à deux points $f$, définie comme
$$
...
Pour déterminer le point critique de la transition de phase de Nishimori, vous pouvez examiner la variance normalisée de $M^2 / N$, définie comme
$$
