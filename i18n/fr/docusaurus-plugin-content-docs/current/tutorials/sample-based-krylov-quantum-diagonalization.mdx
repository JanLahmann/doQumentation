...
Maintenant que nous avons créé les circuits, nous pouvons les optimiser pour un matériel cible. Nous sélectionnons le QPU le moins occupé disposant d'au moins 127 qubits. Consulte la [documentation Qiskit IBM&reg; Runtime](/guides/get-started-with-primitives#get-started-with-sampler) pour plus d'informations.
