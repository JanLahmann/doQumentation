...
## Configuration {#setup}
Commence par t'authentifier avec ta [clé API IBM Quantum](http://quantum.cloud.ibm.com/). Ensuite, sélectionne la Qiskit Function comme suit. (Ce code suppose que tu as déjà [enregistré ton compte](/guides/functions#install-qiskit-functions-catalog-client) dans ton environnement local.)
