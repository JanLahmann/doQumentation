...
## Partie I : Chaîne de spins de Heisenberg à petite échelle
...
#### Maintenant que nous avons notre ansatz réduit et nos observables étendus, nous pouvons transpiler nos expériences vers le backend.
