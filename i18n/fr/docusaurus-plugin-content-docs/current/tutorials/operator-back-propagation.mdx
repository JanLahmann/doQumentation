...
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop), un package accéléré par Rust pour la propagation de Pauli, avec des tutoriels couvrant l'OBP, l'estimation classique des valeurs attendues et la simulation bruitée
</Admonition>
