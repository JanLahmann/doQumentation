...
Définis tes identifiants [IBM Quantum Platform](https://quantum.cloud.ibm.com/), qui seront utilisés tout au long du tutoriel pour l'authentification auprès de Qiskit Runtime et des fonctions Qiskit.
