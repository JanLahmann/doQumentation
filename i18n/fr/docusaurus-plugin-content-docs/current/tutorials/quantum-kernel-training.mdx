...
*Estimation d'utilisation : moins d'une minute sur un processeur Eagle r3 (REMARQUE : Il s'agit uniquement d'une estimation. Ton temps d'exécution peut varier.)*
## Contexte {#background}
