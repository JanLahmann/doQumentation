...
### Traçage de la courbe de dissociation pour Li\_2S
...
#### Soumettre le calcul pour d(Fe-N) = 1.75 $\AA$.
...
#### Soumettre le calcul pour d(Fe-N) = 2.00 $\AA$.
...
#### Soumettre le calcul pour d(Fe-N) = 5.00 $\AA$.
