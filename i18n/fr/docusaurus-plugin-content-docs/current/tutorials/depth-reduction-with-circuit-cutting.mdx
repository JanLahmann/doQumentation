---
description: 'Construire un Qiskit pattern pour couper des portes dans un circuit quantique afin de réduire la profondeur du circuit.'
...
{/* doqumentation-source-hash: 372c0614 */}
...
![Carte de couplage montrant les qubits qui devront être échangés par des portes SWAP](/docs/images/tutorials/depth-reduction-with-circuit-cutting/swaps.avif)
...
*En revanche, la coupe entraîne un besoin d'échantillonnage supplémentaire*. Ici, nous coupons trois portes CNOT, d'où un surcoût d'échantillonnage de $9^3$. Pour en savoir plus sur le surcoût d'échantillonnage engendré par la coupe de circuits, consulte la [documentation du Circuit Knitting Toolbox](https://qiskit-extensions.github.io/circuit-knitting-toolbox/circuit_cutting/explanation/index.html).
...
Réponds à ce court sondage pour nous faire part de tes commentaires sur ce tutoriel. Tes retours nous aideront à améliorer notre contenu et l'expérience utilisateur.

> **Remarque :** Ce sondage est réalisé par **IBM Quantum** et couvre le **contenu du tutoriel** (rédigé par IBM). doQumentation fournit le site web, les traductions et l'exécution de code — pour tout commentaire à ce sujet, veuillez [ouvrir un ticket GitHub](https://github.com/JanLahmann/doQumentation/issues).

[Lien vers le sondage](https://your.feedback.ibm.com/jfe/form/SV_2ftYFf9t72yFNIO)
