...
#### Créer et étendre les observables {#create-and-expand-the-observables}
...
#### Transpiler chaque sous-expérience {#transpile-each-subexperiment}
...
#### Vérification croisée {#cross-verify}
...
## Annexe : considérations sur la mise à l'échelle des ressources {#appendix-resource-scaling-consideration}
...
### Un exemple de circuit adapté et un exemple de circuit inadapté à la découpe {#one-example-of-cut-friendly-and-cut-unfriendly-circuits-each}

#### Circuit adapté à la découpe {#cut-friendly-circuit}
...
#### Circuit inadapté à la découpe {#cut-unfriendly-circuit}
