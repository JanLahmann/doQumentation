...
{/* doqumentation-source-hash: 7c1045a7 */}
...
**Référence** : Y. Kim et al. *Evidence for the utility of quantum computing before fault tolerance.* [Nature 618.7965 (2023)](https://www.nature.com/articles/s41586-023-06096-3)
...
- Choisir une disposition de qubits qui mappe les qubits virtuels de ton circuit vers les qubits physiques du matériel.
...
* __extrapolated_noise_factors__ : Spécifie une ou plusieurs valeurs de facteurs de bruit auxquelles évaluer les
