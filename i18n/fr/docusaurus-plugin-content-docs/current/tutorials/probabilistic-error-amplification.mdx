...
---
{/* doqumentation-source-hash: 05e9de47 */}
...
*Estimation d'utilisation : 16 minutes sur un processeur Heron r2 (REMARQUE : ceci n'est qu'une estimation. Ton temps d'exécution peut varier.)*
## Contexte {#background}
...
Réponds à cette courte enquête pour nous faire part de tes commentaires sur ce tutoriel. Tes observations nous aideront à améliorer nos contenus et l'expérience utilisateur.
