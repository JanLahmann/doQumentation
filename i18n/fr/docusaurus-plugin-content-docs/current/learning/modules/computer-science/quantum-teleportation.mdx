...
__Alice intrique les qubits A et Q :__ Alice agit maintenant avec une porte CNOT avec son propre qubit comme contrôle et Q comme cible, puis applique une porte Hadamard à Q. Calculons l'état à trois qubits après cette opération :
