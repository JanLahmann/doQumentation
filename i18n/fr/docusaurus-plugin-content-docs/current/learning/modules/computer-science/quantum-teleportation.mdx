...
- Étape 3 : Exécuter ton job sur les ordinateurs quantiques IBM en utilisant les primitives IBM Quantum
...
Un « Sampler » est une primitive conçue pour échantillonner les états possibles résultant d'un circuit quantique, et collecter des statistiques sur les états qui pourraient être mesurés et avec quelle probabilité. On importe ici le Sampler d'IBM Quantum :
...
### Étape 1 : Transformer ton problème en circuit quantique {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Étape 3 : Exécuter {#step-3-execute-1}
