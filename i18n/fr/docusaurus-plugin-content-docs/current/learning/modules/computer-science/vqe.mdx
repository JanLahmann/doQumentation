...
(b) Calcule la valeur attendue de l'hamiltonien $\hat{H}$ donné par $$ \hat{H} = -\frac{\hbar^2}{2m} \frac{d^2}{dx^2} + V(x)$$ où $V(x)  = \frac{1}{2}m\omega^2x^2$, ce qui correspond à un potentiel d'oscillateur harmonique simple.
