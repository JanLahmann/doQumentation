...
{/* doqumentation-source-hash: aedaeccb */}
...
Il serait intéressant de distinguer expérimentalement entre les options d'Einstein et de Born. Quelles expériences donneraient les mêmes résultats indépendamment de l'option qui est vraie ? Peux-tu penser à une expérience qui donnerait des résultats différents pour les deux options ?
...
$H$ Porte Hadamard : Crée un état de superposition. Porte à un seul qubit.
$$
