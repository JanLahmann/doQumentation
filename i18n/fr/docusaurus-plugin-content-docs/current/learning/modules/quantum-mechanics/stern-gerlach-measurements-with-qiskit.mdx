...
- Étape 3 : Exécuter à l'aide des primitives IBM Quantum
...
Pour exécuter notre expérience sur un vrai ordinateur quantique, nous devons charger IBM Quantum Compute Service et sélectionner un ordinateur quantique (ou un « backend »). Ci-dessous, nous sélectionnons simplement l'ordinateur quantique le moins occupé à notre disposition.
...
### Étape 3 : Exécuter à l'aide des primitives IBM Quantum {#step-3-execute-using-ibm-quantum-primitives}
...
### Étape 1 : Transformer les entrées classiques en un problème quantique {#step-1-map-classical-inputs-to-a-quantum-problem-1}
