...
et l'effet d'appliquer $G$ sur cet état est de le faire tourner d'un angle $2\theta$ dans l'espace engendré par $\vert A_0\rangle$ et $\vert A_1\rangle$.
Donc, par exemple, nous avons
