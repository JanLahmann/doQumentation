...
(b) S'assurer que trouver la cible sur un GPU arrête le processus sur les autres GPU pour les libérer pour le prochain problème.
(c) Diviser l'espace de recherche en régions pour chacun de tes (disons 10) GPU à explorer
