...
<IBMVideo id="132984196" title="Katie Pizzolato, Vice-Présidente, IBM Quantum Platform chez IBM Quantum, dissipe plusieurs mythes sur l'informatique quantique en 60 secondes. Elle souligne que les ordinateurs quantiques existent déjà et qu'il y a certains problèmes pour lesquels les ordinateurs quantiques ne seront probablement pas utiles."/>
...
<IBMVideo id="133345142" title="Le Directeur de la Recherche chez IBM, Darío Gil, oppose l'unité principale d'information classique (le bit) à l'unité principale d'information quantique (le qubit)"/>
...
<IBMVideo id="134056407" title="Antonio Corcoles-Gonzales explique la superposition et son lien avec les résultats probabilistes des mesures."/>
...
<IBMVideo id="133345141" title="Dario Gil décrit les circuits quantiques et les portes qui les composent. Il illustre la valeur commerciale des ordinateurs quantiques en montrant les états computationnels pouvant être réalisés simultanément sur un ordinateur quantique."/>
...
<IBMVideo id="134056416" title="Une courte vidéo qui couvre la prononciation de Qiskit et certaines de ses fonctionnalités clés."/>
