...
True. A quantum circuit is an abstract representation of a set of instructions that make up a quantum algorithm. We can use a visual tool like the IBM [Composer](https://quantum.cloud.ibm.com/composer) or a programming language like [Qiskit](https://docs.quantum.ibm.com/guides) to construct quantum circuits.
