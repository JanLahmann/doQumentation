...
* **[Dynamical Decoupling](https://docs.quantum.ibm.com/api/qiskit/qiskit.transpiler.passes.PadDynamicalDecoupling)** : On peut appliquer une séquence de Gates aux Qubits inactifs. Cela annule certaines interactions indésirables avec l'environnement.
  Consulte la documentation liée pour plus d'informations sur l'optimisation des Circuits. Le code ci-dessous génère un gestionnaire de masse en utilisant des pass managers prédéfinis issus de `qiskit.transpiler`.
