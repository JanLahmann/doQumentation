...
# Hamiltoniens pour la chimie quantique {#hamiltonians-for-quantum-chemistry}
...
Générer un hamiltonien de chimie quantique pour une utilisation sur les QPU IBM Quantum&reg; implique les étapes suivantes :
