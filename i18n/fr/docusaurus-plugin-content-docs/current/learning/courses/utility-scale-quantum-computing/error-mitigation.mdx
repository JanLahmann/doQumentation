...
Définir le niveau de résilience (`estimator.options.resilience_level`) est la façon la plus simple d'appliquer l'atténuation des erreurs lors de l'utilisation de Qiskit Estimator. Estimator prend en charge les niveaux de résilience suivants (au 28/06/2024). Consulte le guide [Configurer l'atténuation des erreurs](/guides/error-mitigation-and-suppression-techniques) pour plus de détails.
...
- [Configurer l'atténuation des erreurs](/guides/error-mitigation-and-suppression-techniques)
