...
<IBMVideo id="134063416" title="Dans cette vidéo, Olivia Lanes explique les circuits quantiques et les primitives. Elle couvre les primitives Qiskit Runtime : l'estimateur et l'échantillonneur."/>
...
* **EPLG,** ou « erreurs par porte en couche ». C'est une mesure de la qualité des qubits et des portes quantiques. Elle mesure l'erreur moyenne que chaque porte introduit dans un circuit qui intrique des qubits voisins dans une chaîne de 100 qubits. Tu veux que ce soit aussi petit que possible.
