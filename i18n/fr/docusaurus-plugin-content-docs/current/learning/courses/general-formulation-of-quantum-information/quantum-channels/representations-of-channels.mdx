...
<DefinitionTooltip definition="Karl Kraus (1938 – 1988) était un physicien théorique spécialisé dans les fondements de la mécanique quantique. Grande partie du formalisme mathématique discuté dans cette leçon a été expliqué dans ses notes de cours de 1983 (States, effects, and operations: fundamental notions of quantum theory)." align="top-left">Kraus,</DefinitionTooltip> et
...
## Représentations de Stinespring {#stinespring-representations}
...
La figure suivante représente une telle implémentation, sous forme de diagramme de circuit, pour un canal dont les systèmes d'entrée et de sortie sont le même système, $\mathsf{X}.$
...
En général, les systèmes d'entrée et de sortie d'un canal n'ont pas besoin d'être les mêmes.
...
###  Canal complètement déphasant {#completely-dephasing-channel}
...
### Canal complètement déphasant (alternative) {#completely-dephasing-channel-alternative}
...
### Canal de réinitialisation de qubit {#qubit-reset-channel}
...
## Représentations de Kraus {#kraus-representations}
...
### Canal complètement déphasant {#completely-dephasing-channel-1}
...
### Canal de réinitialisation de qubit {#qubit-reset-channel-1}
...
### Canal complètement dépolarisant {#completely-depolarizing-channel}
...
### Canaux unitaires {#unitary-channels}
...
## Représentations de Choi {#choi-representations}
...
### L'état de Choi d'un canal {#the-choi-state-of-a-channel}
...
### Canal complètement déphasant {#completely-dephasing-channel-2}
...
### Canal complètement dépolarisant {#completely-depolarizing-channel-1}
...
### Canal de réinitialisation de qubit {#qubit-reset-channel-2}
...
### Le canal identité {#the-identity-channel}
