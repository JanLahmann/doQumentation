...
La probabilité de retournement peut être $|x[i] - avg\_occupancy[i]|$ pour la `i`-ème orbitale de spin. Dans [\[2\]](#references), les auteurs ont utilisé une probabilité de retournement pondérée en utilisant une fonction ReLU modifiée.
