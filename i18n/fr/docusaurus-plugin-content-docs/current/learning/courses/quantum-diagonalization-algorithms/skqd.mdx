...
## 0. L'espace de Krylov {#0-the-krylov-space}
...
## 1. Mapper le problème en circuits quantiques et opérateurs {#1-map-problem-to-quantum-circuits-and-operators}
...
<Accordion>
<AccordionItem title="Que pourrait-on faire pour améliorer la convergence dans le graphique ci-dessus ?">
...
<AccordionItem title="Quels sont les principaux avantages de SKQD par rapport à (a) SQD, et (b) KQD ?">
