...
2. Quel que soit le résultat $k$ produit par la mesure, l'état de $\mathsf{X}$ devient
...
2. Quel que soit le résultat $a$ produit par la mesure, l'état de $\mathsf{X}$ devient
