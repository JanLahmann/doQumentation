...
<IBMVideo id="134355930" title="Dans cette vidéo, Chris Porter donne un aperçu de l'apprentissage automatique quantique. Il décrit les facteurs qui influencent son efficacité et son utilité. Il explique ce qui le rend prometteur par rapport aux approches classiques. Le texte ci-dessous donne plus de détails."/>
