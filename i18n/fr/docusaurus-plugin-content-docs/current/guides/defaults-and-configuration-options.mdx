...
{/* doqumentation-source-hash: c328cf28 */}
...
<AccordionItem title="**Paramètres de layout et de topologie**">
...
<AccordionItem title="**Exécution du transpileur**">
...
- Apprends à [définir le niveau d'optimisation avec Qiskit Runtime](/guides/runtime-options-overview).
