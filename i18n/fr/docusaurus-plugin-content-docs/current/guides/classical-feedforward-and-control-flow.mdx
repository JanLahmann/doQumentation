...
sidebar_label: 'Anticipation classique et flux de contrôle (circuits dynamiques)'
title: 'Anticipation classique et flux de contrôle (circuits dynamiques)'
---
...
* Préparation efficace d'états quantiques, tels que l'[état GHZ](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339), l'[état W](https://arxiv.org/abs/2403.07604) (pour plus d'informations sur l'état W, voir aussi [« State preparation by shallow circuits using feed forward »](https://arxiv.org/abs/2307.14840)), et une large classe d'[états produits matriciels](https://arxiv.org/abs/2404.16083)

* [Intrication à longue portée efficace](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339) entre des qubits sur la même puce en utilisant des circuits peu profonds

* [Échantillonnage efficace de circuits de type IQP](https://arxiv.org/pdf/2505.04705)
Qiskit prend en charge quatre constructions de flux de contrôle pour la rétroaction classique, chacune implémentée comme une méthode sur [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit). Les constructions et leurs méthodes correspondantes sont :
...
L'instruction `with` peut recevoir une cible d'affectation qui est elle-même un gestionnaire de contexte pouvant être stocké et utilisé ensuite pour créer un bloc else, qui est exécuté chaque fois que le contenu du bloc `if` n'est *pas* exécuté.
