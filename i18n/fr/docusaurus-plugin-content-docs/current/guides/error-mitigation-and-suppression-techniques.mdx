...
### Activer TREX via l'option `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### Activer TREX via l'option `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### Activer la ZNE via l'option `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}
...
### Activer la ZNE via l'option `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- Explorer d'autres [options](/guides/runtime-options-overview) pour les primitives Qiskit Runtime.
