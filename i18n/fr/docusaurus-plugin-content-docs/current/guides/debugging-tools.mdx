...
- Pour la simulation exacte de petits circuits quantiques, tu peux utiliser les primitives de référence incluses avec Qiskit. Voir [Simulation exacte avec les primitives Qiskit](/guides/simulate-with-qiskit-sdk-primitives).
...
- [Déboguer les tâches Qiskit Runtime](/guides/debug-qiskit-runtime-jobs).
</Admonition>
