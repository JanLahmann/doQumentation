---
description: "Comprendre le format d'entrée et de sortie (y compris les Primitive Unified Blocs ou PUBs) des primitives Qiskit SDK"
...
Une fois qu'un ou plusieurs PUB sont envoyés à un QPU pour exécution et qu'un job se termine avec succès, les données sont renvoyées sous la forme d'un objet conteneur [`PrimitiveResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PrimitiveResult). Le `PrimitiveResult` contient une liste itérable d'objets [`PubResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PubResult) qui contiennent les résultats d'exécution pour chaque PUB. Par exemple, un job soumis avec 20 PUB renverra un objet `PrimitiveResult` qui contient une liste de 20 `PubResults`, chacun correspondant à un PUB.
...
<Admonition type="tip" title="Recommandations">
  ...
  -  Consulte l'API des [primitives Qiskit SDK](https://docs.quantum.ibm.com/api/qiskit/primitives).

  -  Consulte l'API des [primitives Qiskit Aer](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html).

  -  En savoir plus sur les [primitives IBM Quantum](/guides/qiskit-runtime-primitives).

  -  Consulte l'API de l'[Estimator `qiskit-ibm-runtime`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2).

  -  Consulte l'API du [Sampler `qiskit-ibm-runtime`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2).
</Admonition>
