...
sidebar_label: "Transpile circuits remotely with the Qiskit Transpiler Service"
description: "What is the Qiskit Transpiler Service and how to use it"
notebook_path: "docs/guides/qiskit-transpiler-service.ipynb"
---
...
<OpenInLabBanner notebookPath="docs/guides/qiskit-transpiler-service.ipynb" />
...
<Admonition type="danger" title="Transpiler Service migration">
     As of 18 July 2025, the service is being migrated to support the new IBM Quantum&reg; Platform and is not available. For AI passes, you can use [local mode](/guides/ai-transpiler-passes#run-the-ai-transpiler-passes-locally-or-on-the-cloud).
...
The package automatically authenticates using your [IBM Quantum Platform credentials](/guides/cloud-setup) aligned with how [Qiskit Runtime manages it](/guides/initialize-account):
...
For more information about the available `qiskit-ibm-transpiler` methods, see the [qiskit-ibm-transpiler API reference](https://docs.quantum.ibm.com/api/qiskit-ibm-transpiler). To learn more about the service API, see the [Qiskit Transpiler Service REST API documentation.](https://docs.quantum.ibm.com/api/qiskit-transpiler-service-rest)
...
<Admonition type="tip" title="Recommendations">
    ...
    - Review the [Qiskit Transpiler Service Python client](https://docs.quantum.ibm.com/api/qiskit-ibm-transpiler) documentation.
</Admonition>