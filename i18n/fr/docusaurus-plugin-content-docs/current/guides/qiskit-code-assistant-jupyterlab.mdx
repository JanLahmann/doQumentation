...
Consulte des exemples pour utiliser Qiskit Code Assistant pour les [circuits](/guides/circuit-library), la [configuration de la suppression d'erreurs](/guides/error-mitigation-and-suppression-techniques) et la [transpilation avec des pass managers](/guides/transpile-with-pass-managers).
</Admonition>
