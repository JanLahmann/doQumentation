---
description: "Réponses aux questions fréquemment posées sur les modes d'exécution"
...
<Accordion>
  <AccordionItem title="Le mode de test local de `qiskit-ibm-runtime` prend-il en charge les différents modes d'exécution ?">
