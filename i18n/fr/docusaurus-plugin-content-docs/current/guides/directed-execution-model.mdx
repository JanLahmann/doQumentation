...
4. Exécute le circuit modèle et le samplex avec la primitive [Executor](#executor), qui générera et exécutera les variantes de circuits selon les instructions.
