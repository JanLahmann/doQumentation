---
description: "Exemples pratiques d'utilisation de la primitive IBM Quantum Sampler."
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Exemples Sampler'
title: 'Exemples Sampler'
---
...
## Exécuter plusieurs expériences en un seul job {#run-multiple-experiments-in-a-single-job}
...
## Utiliser les lots et les options avancées {#use-batches-and-advanced-options}

Explore le [mode d'exécution](/guides/execution-modes) par lots et les options avancées pour optimiser les performances des circuits sur les QPU.
...
- [Spécifier des options d'exécution avancées](runtime-options-overview).
...
- Comprends les [limites de job](/guides/job-limits) lors de l'envoi d'un job à une QPU IBM&reg;.
</Admonition>
