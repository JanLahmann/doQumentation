...
Ces paramètres de précision servent uniquement à spécifier la précision _cible_, et les résultats ne sont pas garantis d'atteindre la précision spécifiée.
</Admonition>
