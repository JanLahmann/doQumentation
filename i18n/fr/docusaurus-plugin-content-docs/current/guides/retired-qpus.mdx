---
description: 'Une liste des unités de traitement quantique (QPU) IBM qui sont désormais retirées'
notebook_path: guides/retired-qpus.ipynb
sidebar_label: 'QPU cloud retirés'
title: 'QPU cloud retirés'
---
...
Les unités de traitement quantique (QPU) IBM&reg; suivantes ont été retirées. Pour la liste complète des QPU disponibles, consulte la page [Ressources de calcul](https://quantum.cloud.ibm.com/computers).

<Admonition type="note">
Pour récupérer des jobs depuis un QPU retiré, consulte [ces instructions](#retrieve).
</Admonition>

## Tableau des QPU cloud retirés {#table-of-retired-cloud-qpus}
