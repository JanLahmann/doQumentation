...
---
{/* doqumentation-source-hash: 9fd38a3a */}
...
Ce compte contient plusieurs **utilisateurs** et **instances de service** (comme IBM Qiskit Runtime). Chaque instance de service existe dans une **région** spécifique et possède un seul **plan**, donc si tu souhaites proposer plusieurs plans à tes utilisateurs, tu auras plusieurs instances de service, chacune associée à un plan différent.
