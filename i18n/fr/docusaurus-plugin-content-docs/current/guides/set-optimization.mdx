...
Commençons par transpiler avec le niveau d'optimisation 0.
...
Ajuster le niveau d'optimisation peut modifier d'autres aspects du circuit, pas seulement le nombre de portes ECR. Pour des exemples illustrant comment le niveau d'optimisation influe sur le layout, consulte [Représenter les ordinateurs quantiques](/guides/represent-quantum-computers).
