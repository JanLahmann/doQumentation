...
- **Outils de construction de circuits** ([`qiskit.circuit`](https://docs.quantum.ibm.com/api/qiskit/circuit)) - Pour initialiser et manipuler des registres, circuits, instructions, gates, paramètres et objets de flux de contrôle.

- **Bibliothèque de circuits** ([`qiskit.circuit.library`](https://docs.quantum.ibm.com/api/qiskit/circuit_library)) - Un vaste ensemble de circuits, d'instructions et de gates — des blocs de construction essentiels pour les calculs quantiques à base de circuits.
