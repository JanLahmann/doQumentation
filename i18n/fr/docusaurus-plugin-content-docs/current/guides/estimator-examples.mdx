---
title: "Exemples Estimator"
sidebar_label: "Exemples Estimator"
description: "Exemples pratiques d'utilisation de la primitive Estimator dans Qiskit Runtime."
...
Les exemples de cette section illustrent quelques façons courantes d'utiliser Estimator. Avant d'exécuter ces exemples, suis les instructions dans [Installer Qiskit.](install-qiskit)
...
## Utiliser les batches et les options avancées {#use-batches-and-advanced-options}

Explore le [mode d'exécution](/guides/execution-modes) batch et les options avancées pour optimiser les performances des circuits sur les QPU.
...
- [Spécifier les options d'exécution avancées](runtime-options-overview).
