...
title: "Diffusion (broadcasting) dans l'Executor"
---

{/* doqumentation-source-hash: 272aa1f8 */}
{/* cspell:ignore broadcastable */}

# Diffusion (broadcasting) dans l'Executor {#executor-broadcasting}
...
## Exemple de démarrage rapide {#quickstart-example}
...
### Accéder aux résultats par indexation {#index-into-results}
