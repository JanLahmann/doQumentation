---
description: 'Migrer des simulateurs cloud IBM Quantum vers le mode de test local de `qiskit-ibm-runtime`.'
...
<Accordion>
<AccordionItem title="Les simulateurs ont des limites">
...
<AccordionItem title="Utiliser le matériel quantique développe des compétences uniques">
...
<AccordionItem title="Les algorithmes doivent être adaptés au matériel quantique">
...
## Migrer vers les simulateurs locaux {#migrate-to-local-simulators-1}
...
| **Modèle de bruit** | Applique automatiquement le modèle de bruit des snapshots QPU | Personnalisé ou basé sur les données de calibration d'un QPU réel | Idéal pour les simulations sans bruit              |
...
Tu peux utiliser le mode de test local avec des simulateurs de [Qiskit Aer](/guides/simulate-with-qiskit-aer), qui offre une simulation plus performante, capable de gérer des circuits plus grands et des [modèles de bruit personnalisés](/guides/build-noise-models). Il prend également en charge le mode de simulation de Clifford, qui permet de simuler efficacement des circuits de Clifford avec un grand nombre de qubits.
