...
À mesure que les besoins du développement de QPU ont évolué, la liste des fonctionnalités d'OpenQASM s'est étoffée en conséquence ; la dernière version, [OpenQASM 3](https://arxiv.org/abs/2104.14722), intègre des extensions telles que le contrôle de flux classique par anticipation, les modificateurs de portes et les implémentations par impulsions.
