...
4. Si `twirling` est activé, alors le produit de `num_randomizations` et de `shots_per_randomization`, tel que spécifié dans les [options `twirling`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-twirling-options), est utilisé.
...
<Accordion>
  <AccordionItem title="Circuits dynamiques">
    Incompatible avec :
  ...
  <AccordionItem title="Découplage dynamique">
    Incompatible avec :
  - Circuits dynamiques
  </AccordionItem>
  <AccordionItem title="Portes fractionnaires">
    Incompatible avec :
  - Twirling de portes

  Compatible avec les circuits dynamiques lors de l'utilisation de `qiskit-ibm-runtime` v0.42.0 ou ultérieur.
  </AccordionItem>
  <AccordionItem title="Twirling de portes">
    Incompatible avec :
