...
<Admonition type="tip">
**Qiskit Serverless est en cours de mise à niveau, et ses fonctionnalités évoluent rapidement.** Pendant cette phase de développement, tu trouveras les notes de version et la documentation la plus récente sur la page [Qiskit Serverless GitHub](https://qiskit.github.io/qiskit-serverless/index.html).
</Admonition>
...
- Il s'agit uniquement d'un stockage plat `/data`, et il ne peut pas avoir de sous-répertoires `/data/folder/`


Le code ci-dessous montre comment uploader des fichiers. Assure-toi d'avoir authentifié Qiskit Serverless avec ton compte IBM Quantum (voir [Uploader sur Qiskit Serverless](/guides/serverless-first-program#upload-to-qiskit-serverless) pour les instructions).
...
- Consulte un exemple complet qui [porte du code existant vers Qiskit Serverless](/guides/serverless-port-code).
