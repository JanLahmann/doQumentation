...
Tu peux exécuter tes charges de travail basées sur les primitives Qiskit via des API REST dans l'un des trois modes d'exécution disponibles, selon tes besoins : job, session et batch. Cette page présente ces différents modes.
