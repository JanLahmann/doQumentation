...
la modélisation du bruit des appareils, mais elles sont utiles pour prototyper rapidement des algorithmes avant de se pencher sur des techniques de simulation plus avancées ([avec Qiskit Aer](/guides/simulate-stabilizer-circuits)) ou d'exécuter sur de vrais appareils ([les primitives Qiskit Runtime](primitives)).
