...
Par exemple, consulte les rubriques [Options d'Estimator](/guides/estimator-options) et [Options de Sampler](/guides/sampler-options) pour les options des primitives IBM Quantum, ou les [références API de Qiskit Aer](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html) pour les options des primitives Qiskit Aer.
...
aux capacités matérielles avancées d'un fournisseur donné. Par exemple, avec les primitives IBM Quantum,
...
- Découvre les [primitives IBM Quantum](/guides/qiskit-runtime-primitives), utilisées pour exécuter des circuits sur les QPU IBM.
</Admonition>
