...
Consulte la [documentation du Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) pour plus d'informations sur les limites qui s'appliquent aux passes de transpilation assistées par IA.

## Citation {#citation}

Si tu utilises une fonctionnalité assistée par IA du Qiskit Transpiler Service dans ta recherche, utilise [la citation recommandée](/guides/qiskit-transpiler-service#citation).
