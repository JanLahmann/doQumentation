...
où les indices $\langle i, j\rangle$ parcourent les spins en interaction et les spins sont soumis à un champ transverse en $X$.
...
où la somme parcourt tous les termes de Pauli $n$-qubit possibles et $\mathrm{Tr}(\cdot)$ est la trace d'une matrice, qui joue le rôle de produit scalaire. Le facteur $1/2^n$ tient compte de la normalisation de Hilbert-Schmidt des chaînes de Pauli à $n$ qubits.
