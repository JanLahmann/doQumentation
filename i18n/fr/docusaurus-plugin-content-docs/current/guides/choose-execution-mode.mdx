---
description: "Choisir le bon mode d'exécution pour les sessions, les traitements par lots ou les jobs individuels d'IBM Quantum Compute."
...
# Choisir le bon mode d'exécution {#choose-the-right-execution-mode}
...
## Recommandations et bonnes pratiques {#recommendations-and-best-practices}
