...
## 1. Kryterium 1 – Skalowalne, dobrze scharakteryzowane qubit {#1-criterion-1-scalable-well-characterized-qubits}
...
### Ćwiczenie 1b: Uruchomienie na prawdziwym komputerze kwantowym IBM {#exercise-1b-run-on-real-ibm-quantum-computer}
...
### Ćwiczenie 2: Przygotowanie określonego stanu {#exercise-2-prepare-a-specific-state}
...
### Ćwiczenie 4: Dekompozycja bramki Toffoli {#exercise-4-decompose-a-toffoli-gate}
...
## 5. Kryterium 5 – Pomiar Qubita {#5-criterion-5-qubit-measurement}
...
## Kryteria komunikacji kwantowej (latające Qubity) {#quantum-communication-criteria-flying-qubits}
...
### Zalecana aktywność: Skorzystaj z modułu *Teleportacja kwantowa* w Qiskit w salach lekcyjnych {#recommended-activity-take-the-qiskit-in-classrooms-quantum-teleportation-module}
...
## Podsumowanie i wnioski {#conclusion-summary}
