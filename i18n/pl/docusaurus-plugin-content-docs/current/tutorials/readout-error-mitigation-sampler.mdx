...
- Szacując ${M}$, zakładaliśmy, że wystąpiły wyłącznie błędy odczytu. W szczególności
  ...
  lub przynajmniej że zostały one w inny sposób zniwelowane.
  ...
  nadal zawiera efekty wszelkich błędów, które nie zostały w inny sposób zniwelowane.
...
$$
 ...
 Funkcja iloczynu skalarnego ma właściwość samodualności $\tilde{f}=f$.
...
### Wykres skalowania czasu CPU wymaganego przez M3 względem liczby shotów {#plot-how-cpu-time-required-by-m3-scales-with-shots}
...
Powyższy wykres pokazuje, że czas potrzebny do zastosowania korekcji M3 skaluje się liniowo względem liczby shotów.
