...
* Zademonstrujemy użycie [propagacji wstecznej operatorów (OBP)](https://qiskit.github.io/qiskit-addon-obp/) w celu zmniejszenia głębokości Circuitu. Technika ta usuwa operacje z końca Circuitu kosztem większej liczby pomiarów operatorów.
