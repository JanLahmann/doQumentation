...
## Krok 1: Ustaw właściwości rozwiązywanego problemu {#step-1-set-properties-of-the-problem-to-solve}
...
na QPU IBM® za pomocą QUICK-PDE, danego:

$$\frac{\partial u}{\partial t} + u\frac{\partial u}{\partial x} = 0.$$

Warunek początkowy dla tego problemu jest ustawiony jako funkcja liniowa:
$u(t=0,x) = ax + b,\text{ with }a,b\in\mathbb{R},$
gdzie $a$ i $b$ to dowolne stałe wpływające na kształt rozwiązania. Możesz zmieniać $a$ i $b$, obserwując jak wpływają na proces rozwiązywania i na wynik. Dla tego wyboru warunku początkowego, równanie dopuszcza następujące rozwiązanie analityczne:

$$u(t, x) = \frac{ax + b}{at + 1},$$

co obowiązuje, dopóki nie powstał żaden wstrząs, czyli dla $t < -1/a$, gdy $a < 0$.
...
## Krok 2 (jeśli potrzeba): Zoptymalizuj problem pod kątem wykonania na sprzęcie kwantowym {#step-2-if-needed-optimize-problem-for-quantum-hardware-execution}
