...
#### Wybierz Backend i układ początkowy {#select-backend-and-initial-layout}
...
#### Zbuduj entangler map dla obwodu TwoLocal {#build-the-entangler-map-for-the-twolocal-circuit}
...
#### Wybierz obserwable {#select-observables}
...
> **Uwaga:** Ta ankieta pochodzi od **IBM Quantum** i dotyczy **treści samouczka** (napisanej przez IBM). doQumentation dostarcza witrynę, tłumaczenia i wykonywanie kodu — w sprawie opinii na ten temat prosimy [otworzyć zgłoszenie na GitHub](https://github.com/JanLahmann/doQumentation/issues).
