...
> **Uwaga:** Ta ankieta pochodzi od **IBM Quantum** i dotyczy **treści samouczka** (napisanej przez IBM). doQumentation zapewnia stronę internetową, tłumaczenia i wykonywanie kodu — aby przekazać opinię na ich temat, [otwórz zgłoszenie na GitHub](https://github.com/JanLahmann/doQumentation/issues).
