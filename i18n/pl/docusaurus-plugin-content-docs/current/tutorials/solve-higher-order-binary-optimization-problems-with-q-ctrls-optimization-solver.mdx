---
title: "Binarystyczna optymalizacja wyższego rzędu z Optimization Solver Q-CTRL"
sidebar_label: "Binarystyczna optymalizacja wyższego rzędu z Optimization Solver Q-CTRL"
...
Zdefiniuj swoje dane uwierzytelniające do [IBM Quantum Platform](https://quantum.cloud.ibm.com/), które będą używane w całym samouczku do uwierzytelniania w Qiskit Runtime i Qiskit Functions.
...
## Krok 1: Zdefiniowanie problemu jako funkcji celu {#krok-1-zdefiniowanie-problemu-jako-funkcji-celu}
