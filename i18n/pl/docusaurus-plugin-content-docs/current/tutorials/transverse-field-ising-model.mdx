...
## Konfiguracja {#setup}
Najpierw uwierzytelnij się przy użyciu swojego [klucza API IBM Quantum](http://quantum.cloud.ibm.com/). Następnie wybierz Qiskit Function w następujący sposób. (Ten kod zakłada, że już [zapisałeś swoje konto](/guides/functions-get-started#install-qiskit-functions-catalog-client) w lokalnym środowisku.)
...
### Szacowanie jednoQubitowych magnetyzacji $\langle Z_i \rangle$ {#estimate-single-qubit-magnetizations-langle-z-i-rangle}
