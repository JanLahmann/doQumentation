...
3. Dekompozycja Circuit:
   Każda operacja permutacji jest dekomponowana do natywnych zestawów bramek kompatybilnych z docelowym sprzętem kwantowym. Analizujemy głębokość i liczbę bramek dwuqubitowych (bramek nielokalnych) dla każdego zdekomponowanego Circuit.
