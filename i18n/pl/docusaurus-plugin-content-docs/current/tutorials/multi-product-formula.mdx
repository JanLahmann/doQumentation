...
- Zapisz Hamiltonian $H$ jako $H=\sum_{a=1}^d F_a,$ gdzie $F_a$ są operatorami hermitowskimi takimi, że każdy odpowiadający im operator unitarny może być efektywnie zaimplementowany na urządzeniu kwantowym.
