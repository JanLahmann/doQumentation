...
> **Uwaga:** Ta ankieta pochodzi od **IBM Quantum** i dotyczy **treści samouczka** (napisanej przez IBM). doQumentation dostarcza stronę internetową, tłumaczenia i wykonywanie kodu — w sprawie opinii na ich temat prosimy [zgłosić problem na GitHubie](https://github.com/JanLahmann/doQumentation/issues).
