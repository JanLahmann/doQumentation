...
Niestandardowe opcje dla uczonego szumu można również przekazać. Podążają one za definicjami używanymi w `qiskit-ibm-runtime` [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options):
