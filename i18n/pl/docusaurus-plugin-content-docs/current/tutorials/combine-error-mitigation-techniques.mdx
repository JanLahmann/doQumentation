---
description: 'Łącz opcje łagodzenia błędów w eksperymentach w skali użytkowej z użyciem procesorów kwantowych IBM 100Q+ oraz prymitywu Estimator z IBM Quantum.'
...
Ten samouczek bada opcje tłumienia błędów i łagodzenia błędów dostępne w prymitywie IBM Quantum Estimator. Samouczek pokazuje, jak implementować każdą z poniższych metod indywidualnie:
...
Tutaj prześlesz pięć osobnych zadań, zaczynając od braku tłumienia lub łagodzenia błędów, a następnie stopniowo włączając różne opcje tłumienia i łagodzenia błędów dostępne w IBM Quantum Compute Service. Aby uzyskać informacje o opcjach, zapoznaj się z następującymi stronami:
...
Ponieważ te zadania mogą działać niezależnie od siebie, możesz użyć [trybu batch](/guides/run-jobs-batch), aby umożliwić Quantum Compute optymalizację harmonogramu ich wykonania.
