...
* Podstawowa znajomość [Qiskit SDK](https://docs.quantum.ibm.com/guides) i [IBM Quantum® Compute Service](/guides/compute-services#qiskit-runtime) oraz dostęp do [konta IBM Quantum](/guides/cloud-setup).
...
Przed uruchomieniem na prawdziwym QPU sprawdzamy, czy układ wytwarza parę Bella, testując go na bezszumowym symulatorze z czterokubitowym łańcuchem `[0, 1, 2, 3]`. Używamy IBM Quantum `Sampler` z `AerSimulator` jako trybem backendu do wykonania układów.
