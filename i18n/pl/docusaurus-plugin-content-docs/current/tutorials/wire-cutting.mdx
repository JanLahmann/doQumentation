...
Zauważamy, że wartość oczekiwana uzyskana za pomocą cięcia przewodów jest bliższa idelanej wartości $+1$ niż ta z nieciętego obwodu. Teraz skalujmy rozmiar problemu w górę.
