...
### Eksperymenty charakteryzacji {#characterization-experiments}
...
#### Charakteryzacja błędów przygotowania stanu i pomiaru (SPAM) {#state-preparation-and-measurement-spam-error-characterization}
...
#### Jednobitowe i dwubitowe randomizowane benchmarki {#single-qubit-and-two-qubit-randomized-benchmarking}
...
### Właściwości QPU w czasie {#qpu-properties-over-time}
