...
Circuity używane w tym benchmarku pochodzą z [repozytorium benchmarku Hamlib](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/hamlib), które zawiera realistyczne zadania symulacji hamiltonianów.
