...
Wtyczka Rustiq zapewnia zaawansowane techniki syntezy specjalnie dla operacji `PauliEvolutionGate`, które reprezentują rotacje Pauliego powszechnie używane w dynamice Trotteryzowanej. Jest zaprojektowana do tworzenia dekompozycji obwodów o niskiej głębokości dla zadań symulacji Hamiltoniana. Więcej szczegółów znajdziesz w [\[4\]](https://arxiv.org/abs/2404.03280).
