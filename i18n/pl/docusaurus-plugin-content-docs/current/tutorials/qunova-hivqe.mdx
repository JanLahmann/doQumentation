...
### Wykres krzywej dysocjacji dla Li\_2S {#plotting-the-dissociation-curve-for-li-2s}
...
### Krok 1: Odwzorowanie klasycznych danych wejściowych na problem kwantowy {#step-1-map-classical-inputs-to-a-quantum-problem-1}
...
### Kroki 2 i 3: Optymalizacja problemu pod kątem wykonania na sprzęcie kwantowym i uruchomienie za pomocą funkcji HiVQE Chemistry {#step-2-and-3-optimize-problem-for-quantum-hardware-execution-and-execute-using-the-hivqe-chemistry-function-1}

Na podstawie konfiguracji HiVQE i geometrii uzyskaj wyniki sekwencyjnie.

#### Prześlij obliczenia dla d(Fe-N) = 1.75 $\AA$. {#submit-dfe-n-175-aa-calculation}
...
#### Prześlij obliczenia dla d(Fe-N) = 2.00 $\AA$. {#submit-dfe-n-200-aa-calculation}
...
#### Prześlij obliczenia dla d(Fe-N) = 5.00 $\AA$. {#submit-dfe-n-500-aa-calculation}
...
### Krok 4: Przetwarzanie końcowe i porównanie z metodami klasycznymi {#step-4-post-process-and-compare-with-classical-methods-1}
...
> **Uwaga:** Ta ankieta jest przygotowana przez **IBM Quantum** i dotyczy **treści samouczka** (napisanej przez IBM). doQumentation dostarcza witrynę, tłumaczenia i wykonywanie kodu — aby przekazać opinię na ich temat, [zgłoś problem na GitHubie](https://github.com/JanLahmann/doQumentation/issues).
