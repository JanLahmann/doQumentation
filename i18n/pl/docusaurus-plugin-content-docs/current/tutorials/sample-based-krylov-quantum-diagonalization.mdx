...
description: "Użyj algorytmu kwantowej diagonalizacji opartej na próbkowaniu, aby symulować jednodomieszkowymodel Andersona na zaszumionym sprzęcie kwantowym."
notebook_path: "tutorials/sample-based-krylov-quantum-diagonalization.ipynb"
---
{/* doqumentation-source-hash: ce8b6883 */}
{/* doqumentation-source-hash: XXXX */}
...
### Jednodomieszkowymodel Andersona (SIAM) {#single-impurity-anderson-model-siam}
...
- [Kwantowa diagonalizacja oparta na próbkowaniu hamiltonowskiego chemicznego](/tutorials/sample-based-quantum-diagonalization) - powiązany samouczek używający heurystycznego variacyjnego ansatzu zamiast obwodów Trottera
