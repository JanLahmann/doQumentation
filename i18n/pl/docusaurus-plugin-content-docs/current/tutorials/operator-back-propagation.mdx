...
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop), pakiet przyspieszony przez Rust do propagacji Pauliego, z samouczkami obejmującymi OBP, klasyczne szacowanie wartości oczekiwanych i zaszumioną symulację
</Admonition>
