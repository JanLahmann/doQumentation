...
### Krok 1: Mapowanie problemu na obwód kwantowy {#step-1-map-problem-to-a-quantum-circuit}
...
### Krok 4: Przetwarzanie wyników po stronie klasycznej {#step-4-post-process-the-results}
