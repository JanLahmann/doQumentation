...
![Diagram obwodu kwantowego](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_1.png)

```python
circuits[-1].draw("mpl", scale=0.4, fold=-1)
```

![Diagram obwodu kwantowego](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_2.png)
...
![Diagram obwodu kwantowego](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_3.png)
...
![Wyjście wykresu](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_4.png)
