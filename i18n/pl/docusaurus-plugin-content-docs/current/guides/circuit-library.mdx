...
<Admonition type="tip" title="Zalecenia">
  -  Poznaj zaawansowane metody tworzenia układów w temacie [Construct circuits](/guides/construct-circuits).
