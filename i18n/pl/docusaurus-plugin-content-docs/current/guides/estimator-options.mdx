...
Opcje możesz ustawiać podczas inicjalizacji Estimatora, po jego inicjalizacji lub aktualizować je po inicjalizacji. Aby zapoznać się z instrukcjami dotyczącymi tych technik, zobacz temat [Wprowadzenie do opcji](/guides/runtime-options-overview#options-precedence).

Dodatkowo możesz ustawiać wartość `precision` w metodzie `run()`, co zostało opisane w poniższej sekcji.
...
<Tabs>
  ...
  - Nie działa z niecoraz-Cliffordowymi splątaczami.
