---
description: 'Jak uruchomić zadanie obliczeń kwantowych w sesji IBM Quantum Compute Service.'
...
Przed uruchomieniem sesji musisz [skonfigurować klienta IBM Quantum Compute](/guides/install-qiskit-runtime) i zainicjować go jako usługę:
...
Aby uzyskać pełny przegląd konfiguracji i stanu sesji, użyj metody `session.details() method`.
