...
* `optimization_level` - Określa, ile optymalizacji wykonać na obwód dla komponentów heurystycznych PassManager.
...
Zapoznaj się z [dokumentacją Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service), aby uzyskać więcej informacji o limitach mających zastosowanie do pasów Transpilatora zasilanych przez AI.

## Cytowanie {#citation}

Jeśli używasz dowolnej funkcji zasilanej przez AI z Qiskit Transpiler Service w swoich badaniach, skorzystaj z [zalecanego cytowania](/guides/qiskit-transpiler-service#citation).
