---
description: 'Odpowiedzi na najczęściej zadawane pytania dotyczące trybów wykonania'
...
<Accordion>
  <AccordionItem title="Czy lokalny tryb testowania `qiskit-ibm-runtime` obsługuje różne tryby wykonania?">
