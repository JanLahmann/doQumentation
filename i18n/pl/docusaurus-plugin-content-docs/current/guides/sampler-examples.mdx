---
description: 'Praktyczne przykłady użycia prymitywu IBM Quantum Sampler.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Przykłady Sampler'
title: 'Przykłady Sampler'
---
...
## Przeprowadzanie pojedynczego eksperymentu {#run-a-single-experiment}

Używaj Sampler, aby zwracać wynik pomiaru jako ciągi bitów lub zliczenia dla pojedynczego obwodu.
...
## Przeprowadzanie wielu eksperymentów w jednym zadaniu {#run-multiple-experiments-in-a-single-job}

Używaj Sampler, aby zwracać wynik pomiaru jako ciągi bitów lub zliczenia dla wielu obwodów w jednym zadaniu.
...
Przeprowadzaj kilka eksperymentów w jednym zadaniu, wykorzystując wartości parametrów do zwiększenia możliwości ponownego użycia obwodu.
...
## Używanie trybów wsadowych i zaawansowanych opcji {#use-batches-and-advanced-options}

Zapoznaj się z [trybem wykonania](/guides/execution-modes) wsadowego i zaawansowanymi opcjami, aby zoptymalizować wydajność obwodów na QPU.
...
- [Określanie zaawansowanych opcji środowiska uruchomieniowego](runtime-options-overview).
...
- Zapoznaj się z [Limitami zadań](/guides/job-limits) podczas wysyłania zadania do QPU IBM®.
</Admonition>
