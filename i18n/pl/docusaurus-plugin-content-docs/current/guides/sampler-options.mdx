...
4. Jeśli `twirling` jest włączony, używany jest iloczyn `num_randomizations` i `shots_per_randomization`, określony jako [opcje `twirling`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-twirling-options).
