...
<span id="start-sampler"></span>
## Prymityw Sampler z REST API {#sampler-primitive-with-rest-api}
...
### 3. Uruchom kwantowy Circuit za pomocą API Sampler V2 {#3-run-the-quantum-circuit-using-sampler-v2-api}
...
### 5. Praca z opcjami Runtime {#5-work-with-runtime-options}
...
## Primitive Sampler z REST API i parametryzowanymi Circuit {#sampler-primitive-with-rest-api-and-parameterized-circuits}
...
### 5. Uruchom Circuit kwantowy za pomocą API Sampler V2 {#5-run-the-quantum-circuit-using-sampler-v2-api}
