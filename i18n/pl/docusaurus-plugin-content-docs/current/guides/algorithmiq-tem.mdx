...
Uwierzytelnij się za pomocą [klucza API IBM Quantum Platform](http://quantum.cloud.ibm.com/) i wybierz funkcję TEM w następujący sposób. (Ten fragment kodu zakłada, że masz już [zapisane konto](/guides/functions-get-started#install-qiskit-functions-catalog-client) w środowisku lokalnym.)
