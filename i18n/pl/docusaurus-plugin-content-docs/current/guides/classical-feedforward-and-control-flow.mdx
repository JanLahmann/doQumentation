...
* Wydajne przygotowanie stanu kwantowego, takie jak [stan GHZ](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339), [stan W](https://arxiv.org/abs/2403.07604) (więcej informacji o stanie W znajdziesz również w [„State preparation by shallow circuits using feed forward”](https://arxiv.org/abs/2307.14840)) oraz szeroka klasa [stanów produktu macierzowego](https://arxiv.org/abs/2404.16083)

* [Wydajne dalekozasięgowe splątanie](https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.5.030339) między qubitami na tym samym chipie dzięki użyciu płytkich obwodów

* Wydajne [próbkowanie obwodów podobnych do IQP](https://arxiv.org/pdf/2505.04705)
Qiskit obsługuje cztery konstrukcje sterowania przepływem dla klasycznego sprzężenia w przód, z których każda jest zaimplementowana jako metoda w [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit). Konstrukcje i odpowiadające im metody to:
