---
description: 'Praktyczne przykłady użycia prymitywu Executor w qiskit-ibm-runtime.'
...
### Konfiguracja obwodu {#set-up-the-circuit-1}
...
### Wykonanie obwodów {#execute-the-circuits-1}
