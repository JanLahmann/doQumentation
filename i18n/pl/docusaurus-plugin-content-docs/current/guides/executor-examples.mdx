...
4. Analiza: Post-przetwarzanie i analizowanie wyników.
...
- Ich zawartość jest równa, z dokładnością do jednobitowych bramek.
...
Na koniec post-przetwarzaj wyniki, aby estymować wartości oczekiwane jednobitowych operatorów Pauliego-Z działających na każdym z dziesięciu aktywnych qubitów (oczekiwana wartość: `1.0`).
