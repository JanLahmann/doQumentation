...
**Możliwe wartości**: Liczba całkowita sekund w zakresie [1, 10800]
...
Czy resetować kubity do stanu podstawowego przed każdym powtórzeniem (shot).
...
**Możliwe wartości**: Wartość w zakresie podanym przez `backend.rep_delay_range`
...
**Możliwe wartości**: `classified`, `kerneled`, `avg_kerneled`
...
<Tabs>
  ...
  Inne uwagi:
  - Twirling bramek można stosować do obwodów dynamicznych, ale tylko do bramek znajdujących się poza blokami warunkowymi.
  ...
  Niekompatybilne z bramkami ułamkowymi lub ze stretchami (stretch).

  Inne uwagi:
  - Twirling bramek można stosować do obwodów dynamicznych, ale tylko do bramek znajdujących się poza blokami warunkowymi. Twirling pomiarów można stosować tylko do pomiarów końcowych.
  - Nie działa z bramkami splątającymi spoza grupy Clifforda.
