...
### Włącz TREX za pomocą opcji `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### Włącz ZNE za pomocą opcji `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}

ZNE można włączyć, ustawiając `zne_mitigation` na `True` w [opcjach odporności Qiskit Runtime](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-resilience-options-v2) dla Estimator.
...
### Włącz ZNE za pomocą opcji `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- Poznaj inne [opcje](/guides/runtime-options-overview) prymitywów Qiskit Runtime.
