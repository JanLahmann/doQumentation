---
description: 'Poznaj format wejścia i wyjścia (w tym Primitive Unified Blocs, czyli PUB) prymitywów Qiskit SDK'
...
Gdy jeden lub więcej PUB zostanie wysłanych do QPU w celu wykonania i zadanie zakończy się pomyślnie, dane są zwracane jako obiekt kontenera [`PrimitiveResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PrimitiveResult). `PrimitiveResult` zawiera iterowalną listę obiektów [`PubResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PubResult), które zawierają wyniki wykonania dla każdego PUB. Na przykład zadanie wysłane z 20 PUB zwróci obiekt `PrimitiveResult` zawierający listę 20 `PubResults`, po jednym dla każdego PUB.
...
<Admonition type="tip" title="Zalecenia">
  ...
  -  Zapoznaj się z API [prymitywów Qiskit SDK](https://docs.quantum.ibm.com/api/qiskit/primitives).

  -  Zapoznaj się z API [prymitywów Qiskit Aer](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html).

  -  Dowiedz się więcej o [prymitywach IBM Quantum](/guides/qiskit-runtime-primitives).

  -  Zapoznaj się z API [`qiskit-ibm-runtime` Estimator](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2).

  -  Zapoznaj się z API [`qiskit-ibm-runtime` Sampler](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2).
</Admonition>
