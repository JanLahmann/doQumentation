...
*Zobacz [dokumentację API](https://docs.quantum.ibm.com/api/functions/kipu-optimization)*
...
- Odwiedź [dokumentację API](https://docs.quantum.ibm.com/api/functions/kipu-optimization) dla tej funkcji Qiskit.
