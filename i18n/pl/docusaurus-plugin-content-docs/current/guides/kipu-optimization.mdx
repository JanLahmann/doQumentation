...
*Zobacz [dokumentację referencyjną API](https://docs.quantum.ibm.com/api/functions/kipu-optimization)*

<Admonition type="note" title="Uwaga">
* Funkcje Qiskit są funkcją eksperymentalną dostępną wyłącznie dla użytkowników planów IBM Quantum&reg; Premium Plan, Flex Plan i On-Prem (poprzez IBM Quantum Platform API). Są w statusie wydania przedpremierowego (preview) i mogą ulec zmianie.
</Admonition>
...
### 1. Utwórz funkcję celu {#1-create-the-objective-function-1}
...
### 2. Uruchom Optimizer {#2-run-the-optimizer-1}
...
### 3. Pobierz wynik {#3-retrieve-the-result-1}
