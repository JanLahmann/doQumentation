---
description: 'Migracja z symulatorów chmurowych IBM Quantum do lokalnego trybu testowania `qiskit-ibm-runtime`.'
title: 'Migracja do lokalnych symulatorów'
---

{/* doqumentation-source-hash: 9db328b8 */}

# Migracja z symulatorów chmurowych do lokalnych symulatorów {#migrate-to-local-simulators}
...
<Accordion>
<AccordionItem title="Symulatory mają ograniczenia">
...
<AccordionItem title="Korzystanie ze sprzętu kwantowego buduje unikalne umiejętności">
...
<AccordionItem title="Algorytmy powinny być dostosowane do sprzętu kwantowego">
...
## Migracja do lokalnych symulatorów {#migrate-to-local-simulators-1}
