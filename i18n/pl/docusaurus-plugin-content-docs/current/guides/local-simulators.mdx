...
# Migracja z symulatorów chmurowych do lokalnych symulatorów {#migrate-from-cloud-simulators-to-local-simulators}
...
<Accordion>
<AccordionItem title="<a>Symulatory mają ograniczenia</a>">
...
<AccordionItem title="<a>Korzystanie ze sprzętu kwantowego buduje unikalne umiejętności</a>">
...
<AccordionItem title="<a>Algorytmy powinny być dostosowane do sprzętu kwantowego</a>">
...
Lokalny tryb testowania nie ma wbudowanego tłumienia ani łagodzenia błędów. Zamiast tego musisz określić te opcje jawnie. Szczegóły znajdziesz w [Configure error mitigation for Qiskit Runtime](/guides/error-mitigation-and-suppression-techniques).
</Admonition>
