---
description: 'Jak uruchamiać zadania obliczeniowe w trybie wsadowym przy użyciu IBM Quantum Compute Service.'
...
Przed rozpoczęciem wsadu musisz [skonfigurować klienta IBM Quantum Compute](/guides/install-qiskit) i zainicjować go jako usługę:
...
Aby uzyskać pełny przegląd konfiguracji i stanu batcha, w tym jego interaktywnego i maksymalnego TTL, użyj metody `batch.details() method`.
