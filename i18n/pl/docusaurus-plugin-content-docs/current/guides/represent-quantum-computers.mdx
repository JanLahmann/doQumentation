...
Każdy komputer kwantowy obsługuje ograniczony zestaw instrukcji zwany _bramkami bazowymi_. Każda bramka w obwodzie musi być przetłumaczona na elementy tego zestawu. Zestaw ten powinien składać się z bramek jedno- i dwu-Qubitowych tworzących uniwersalny zestaw bramek, co oznacza, że dowolną operację kwantową można rozłożyć na te bramki. Wykonuje to [BasisTranslator](https://docs.quantum.ibm.com/api/qiskit/qiskit.transpiler.passes.BasisTranslator), a bramki bazowe można określić jako argument słowa kluczowego w Transpilerze, aby przekazać te informacje.
