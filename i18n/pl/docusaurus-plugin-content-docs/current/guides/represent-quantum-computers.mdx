...
# Reprezentacja komputerów kwantowych dla Transpilera {#representing-quantum-computers-for-the-transpiler}
{/*
...
## Współczynniki błędów urządzenia {#device-error-rates}
