...
Grupowanie instrukcji w bloki i ich adnotowanie to podstawowy sposób określania intencji. W poniższym przykładzie używamy `generate_boxing_pass_manager` i jego parametrów twirlingowych do grupowania dwukukubitowych bramek i pomiarów w bloki oraz stosowania adnotacji twirlingowej.
