...
<Admonition type="tip" title="Zalecenia">
    - Zapoznaj się z przewodnikiem dotyczącym tworzenia [własnego przebiegu Transpilera](/guides/custom-transpiler-pass)
    - Dowiedz się, jak [tworzyć i transpilować dla własnych Backendów](/guides/custom-backend)
