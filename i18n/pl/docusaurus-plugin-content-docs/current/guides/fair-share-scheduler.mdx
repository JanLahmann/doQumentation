...
# Harmonogram fair-share {#fair-share-scheduler}
...
* **Konto:** Osoby fizyczne i organizacje używają konta IBM Cloud&reg; do uzyskiwania dostępu do IBM Quantum&reg; Platform i IBM Quantum Compute Service.
