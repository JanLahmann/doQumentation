---
description: 'Wybierz odpowiedni tryb wykonania dla sesji, batch lub pojedynczych zadań IBM Quantum Compute.'
...
# Wybierz odpowiedni tryb wykonania {#choose-the-right-execution-mode}
