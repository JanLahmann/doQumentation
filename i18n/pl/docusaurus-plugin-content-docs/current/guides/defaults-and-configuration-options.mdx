...
- Dowiedz się, jak [ustawić poziom optymalizacji](/guides/runtime-options-overview).
...
- Dowiedz się, [jak transpilować Circuit](/guides/circuit-transpilation-settings) w ramach przepływu pracy wzorców Qiskit.
