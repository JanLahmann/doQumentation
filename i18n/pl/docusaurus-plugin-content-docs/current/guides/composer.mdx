...
Aby wyeksportować obraz Circuit, wybierz Plik → Eksportuj obraz Circuit. Zostanie otwarte okno Opcje eksportu, w którym możesz wybrać motyw (jasny, ciemny, biały na czarnym lub czarny na białym), format (.svg lub .png) oraz to, czy chcesz zastosować zawijanie linii. Po wybraniu opcji kliknij Eksportuj.
