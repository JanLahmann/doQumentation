---
title: "Przykłady użycia Estimator"
sidebar_label: "Przykłady użycia Estimator"
description: "Praktyczne przykłady użycia prymitywu Estimator w Qiskit Runtime."
...
Przykłady w tej sekcji ilustrują typowe sposoby używania Estimator. Przed uruchomieniem tych przykładów postępuj zgodnie z instrukcjami w [Instalacja Qiskit.](install-qiskit)

<Admonition type="note">
Wszystkie te przykłady używają prymitywów z Qiskit Runtime, ale możesz zamiast nich używać prymitywów bazowych.
</Admonition>

Efektywnie obliczaj i interpretuj wartości oczekiwane operatorów kwantowych wymaganych przez wiele algorytmów za pomocą Estimator. Odkryj zastosowania w modelowaniu molekularnym, uczeniu maszynowym i złożonych problemach optymalizacyjnych.

## Uruchamianie pojedynczego eksperymentu {#run-a-single-experiment}

Używaj Estimator do wyznaczania wartości oczekiwanej pojedynczej pary obwód-obserwabla.
...
Używaj Estimator do wyznaczania wartości oczekiwanych wielu par obwód-obserwabla.
...
## Uruchamianie sparametryzowanych obwodów {#run-parameterized-circuits}

Używaj Estimator do uruchamiania trzech eksperymentów w jednym zadaniu, korzystając z wartości parametrów w celu zwiększenia możliwości ponownego użycia obwodów.
...
## Używanie wsadów i zaawansowanych opcji {#use-batches-and-advanced-options}

Eksploruj [tryb wykonania](/guides/execution-modes) wsadowego i zaawansowane opcje w celu optymalizacji wydajności obwodów na QPU.
...
- Ćwicz z prymitywami, pracując przez [lekcję funkcji kosztu](/learning/courses/variational-algorithm-design/cost-functions) w IBM Quantum&reg; Learning.
- Dowiedz się, jak transpilować lokalnie w sekcji [Transpilacja](/guides/transpile/).
- Wypróbuj przewodnik [Porównanie ustawień transpilatora](/guides/circuit-transpilation-settings).
- Przeczytaj [Migracja do prymitywów V2](/guides/v2-primitives).
- Zrozum [limity zadań](/guides/job-limits) podczas wysyłania zadania do QPU IBM&reg;.
</Admonition>
