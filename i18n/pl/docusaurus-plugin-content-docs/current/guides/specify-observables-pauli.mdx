...
gdzie suma przebiega po wszystkich możliwych $n$-qubitowych składowych Pauliego, a $\mathrm{Tr}(\cdot)$ jest śladem macierzy, który pełni rolę iloczynu skalarnego. Współczynnik $1/2^n$ uwzględnia normalizację Hilberta-Schmidta ciągów Pauliego o $n$ qubitach.
