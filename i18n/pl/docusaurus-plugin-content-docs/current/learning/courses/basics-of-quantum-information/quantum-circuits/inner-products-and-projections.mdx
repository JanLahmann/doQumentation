...
W ten sposób $\mathsf{Y}$ przechowuje kopię wyniku pomiaru, a $\mathsf{X}$ zmienia się dokładnie tak, jakby pomiar rzutowy opisany przez $\{\Pi_0,\ldots,\Pi_{m-1}\}$ został wykonany bezpośrednio na $\mathsf{X}.$
