...
* **EPLG,** czyli „errors per layered gate" (błędy na bramkę warstwową). Jest to miara jakości kubitów i bramka'ów kwantowych. Mierzy średni błąd wprowadzany przez każdą bramkę w obwodzie splątującym sąsiednie kubity w łańcuchu 100 kubitów. Im mniejsza ta wartość, tym lepiej.
