...
## Qiskit Patterns Krok 3: Wykonanie z użyciem prymitywów IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
## Qiskit Patterns krok 2: Optymalizacja problemu pod kątem wykonania kwantowego {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution-1}
Zaczynamy od wyboru zaplecza (backendu) do wykonania. W tym przypadku użyjemy najmniej obciążonego zaplecza.
...
## Qiskit Patterns Krok 3: Wykonanie z użyciem prymitywów IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
