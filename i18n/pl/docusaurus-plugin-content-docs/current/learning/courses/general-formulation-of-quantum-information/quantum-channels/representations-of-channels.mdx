...
### Kanał całkowicie dephasing {#completely-dephasing-channel-1}
...
### Kanał resetu kubitu {#qubit-reset-channel-1}
...
### Kanał całkowicie defazujący {#completely-dephasing-channel-2}

Reprezentacja Choi kanału całkowicie defazującego $\Delta$ to
...
### Kanał całkowicie depolaryzujący {#completely-depolarizing-channel-1}

Reprezentacja Choi kanału całkowicie depolaryzującego to
...
### Kanał resetu kubitu {#qubit-reset-channel-2}
...
### Kanał całkowicie depolarizing {#the-identity-channel}

Reprezentacja Choi kanału tożsamości kubitu $\operatorname{Id}$ to
...
Zwróć szczególną uwagę na to, że $J(\operatorname{Id})$ nie jest macierzą tożsamości.
Reprezentacja Choi nie opisuje bezpośrednio działania kanału w zwykły sposób, w jaki macierz reprezentuje odwzorowanie liniowe.
