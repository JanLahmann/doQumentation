...
3. Fidelity między stanami jest niemalejąca pod działaniem dowolnego kanału. To znaczy, jeśli $\rho$ i $\sigma$ są macierzami gęstości, a $\Phi$ jest kanałem, który może przyjąć te dwa stany jako wejście, to musi zachodzić
   ...
   $$
4. *Nierówności Fuchsa–van de Graafa* ustalają bliski (choć nie dokładny) związek między fidelity a odległością śladu: dla dowolnych dwóch stanów $\rho$ i $\sigma$ mamy
   $$
