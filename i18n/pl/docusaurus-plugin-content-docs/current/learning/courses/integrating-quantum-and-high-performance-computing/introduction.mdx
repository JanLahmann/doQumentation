...
Stos obejmuje warstwę aplikacyjną, która rozkłada problemy na komponenty klasyczne i kwantowe, oprogramowanie pośredniczące łączące klasyczne modele programowania z generowaniem Circuit kwantowych (na przykład poprzez zaktualizowane interfejsy Qiskit) oraz warstwę orkiestracji systemowej zarządzającą harmonogramowaniem zasobów hybrydowych przy użyciu narzędzi takich jak Quantum Resource Management Interface (QRMI).
