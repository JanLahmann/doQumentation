...
## 0. The Krylov space {#0-the-krylov-space}
...
<Accordion>
<AccordionItem title="Co można by zrobić, aby poprawić zbieżność na powyższym wykresie?">
...
<AccordionItem title="Jakie są główne zalety SKQD w porównaniu do (a) SQD i (b) KQD?">

__Answer:__

Jakie są główne zalety SKQD w porównaniu z (a) SQD i (b) KQD?

   (a) SKQD oferuje gwarancje zbieżności, których nie ma SQD. W SQD trzeba albo dokonać bardzo dobrego odgadnięcia dla swojego ansatzu, który ma doskonałe pokrycie ze wsparciem stanu podstawowego w bazie obliczeniowej, albo trzeba wprowadzić komponent wariacyjny do obliczeń, aby próbkować rodzinę ansatzów.
