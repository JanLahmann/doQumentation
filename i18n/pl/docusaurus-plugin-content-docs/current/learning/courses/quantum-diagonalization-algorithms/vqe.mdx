...
![Obraz orbitali atomowych i obraz sieci wielu węzłów oraz połączeń między nimi.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig1.svg)
...
![Obraz obwodu kwantowego z parametrami wariacyjnymi oznaczonymi jako „theta".](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig2.svg)
...
![Obraz przedstawiający zakrzywioną linię reprezentującą energię z kilkoma punktami, w których testowana jest wartość w celu znalezienia minimum.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig3.svg)
...
![Tabela różnych ciągów Pauli, z których niektóre komutują, a inne nie.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig4.svg)
...
![Dwa obrazy zakrzywionej linii z wartością minimalną. W jednym punkty są losowo sprawdzane w poszukiwaniu minimum, w drugim gradient jest szacowany poprzez narysowanie linii między dwoma sąsiednimi punktami.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig5.svg)
