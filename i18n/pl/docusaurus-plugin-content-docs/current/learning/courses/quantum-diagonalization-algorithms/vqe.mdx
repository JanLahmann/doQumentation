...
Słowo „ansatz” w języku niemieckim oznacza „podejście”. Poprawna liczba mnoga w języku niemieckim to „ansätze”, choć często spotyka się formy „ansatzes” lub „ansatze”. W kontekście VQE ansatz to obwód kwantowy używany do stworzenia wielokubitowej funkcji falowej, która najlepiej przybliża stan podstawowy badanego układu i tym samym daje najniższą wartość oczekiwaną twojego operatora. Ten obwód kwantowy będzie zawierał parametry wariacyjne (często zebrane razem w wektorze zmiennych $\vec{\theta}$).
...
### 1.5 Zasada wariacyjna {#15-the-variational-principle}
...
## 2. Porównanie z klasycznym przepływem pracy {#2-comparison-with-classical-workflow}
...
### 2.1 Klasyczny przepływ pracy {#21-classical-workflow}
...
### 2.2 Kwantowy przepływ pracy i komutujące grupy Pauli {#22-quantum-workflow-and-commuting-pauli-groups}
...
### 2.3 Czynniki determinujące koszt obliczeniowy {#23-factors-that-determine-computational-cost}
...
Okazuje się, że istnieją ansätze, które są wysoce zoptymalizowane pod kątem kontekstów chemicznych. Liczba wyrazów w hamiltonianie, a tym samym liczba wymaganych pomiarów, zazwyczaj powoduje więcej problemów.

</AccordionItem>
</Accordion>

## 3. Przykładowy Hamiltonian {#3-example-hamiltonian}
...
### 3.1 Krok 1: Odwzorowanie problemu na obwody kwantowe i operatory {#31-step-1-map-the-problem-to-quantum-circuits-and-operators}
...
### 3.2 Krok 2: Optymalizacja pod docelowy sprzęt {#32-step-2-optimize-for-target-hardware}
...
### 3.3 Krok 3: Uruchomienie na docelowym sprzęcie {#33-step-3-execute-on-target-hardware}

#### 3.3.1 Raportowanie wartości {#331-reporting-out-values}
...
### 3.4 Krok 4: Przetwarzanie końcowe wyników {#34-step-4-post-process-results}
...
## 4. Związek VQE z innymi metodami {#4-vqes-relationship-to-other-methods}
...
### 4.1 Mocne i słabe strony VQE {#41-the-strengths-and-weaknesses-of-vqe}
...
### 4.2 Związek z innymi podejściami {#42-relationship-to-other-approaches}
