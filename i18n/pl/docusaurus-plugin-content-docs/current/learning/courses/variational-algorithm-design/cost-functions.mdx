...
---
{/* doqumentation-source-hash: 053dd3b6 */}
...
\end{array}
$$
### Korzystanie z opcji łagodzenia błędów i tłumienia w Qiskit Runtime {#using-qiskit-runtimes-mitigation-and-suppression-options}

Oto jak obliczyć wartość oczekiwaną przy jednoczesnym użyciu łagodzenia i tłumienia błędów w Qiskit Runtime. Możemy wykorzystać dokładnie ten sam obwód i obserwablę co poprzednio, ale tym razem utrzymując poziom optymalizacji na poziomie 2, a teraz dostrajając _odporność_ lub stosowane techniki łagodzenia błędów. Ten proces łagodzenia błędów odbywa się wielokrotnie w całej pętli optymalizacji.
...
- Jak wykorzystać prymitywy Qiskit Runtime do łagodzenia i tłumienia szumu
