...
Kolejnym krytycznym elementem, na który zwracamy uwagę, oceniając postęp komputerów kwantowych, jest szybkość. Do pomiaru szybkości używamy czegoś zwanego Circuit Layer Operations per Second (CLOPS). CLOPS uwzględnia zarówno czas uruchomienia obwodu, jak i klasyczne obliczenia w czasie rzeczywistym i prawie rzeczywistym, co umożliwia mu służenie jako całościowa pojedyncza miara szybkości.
