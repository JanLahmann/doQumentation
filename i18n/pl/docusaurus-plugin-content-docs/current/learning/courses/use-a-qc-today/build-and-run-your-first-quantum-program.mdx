...
Otwórz Composer [tutaj](https://quantum.cloud.ibm.com/composer).

Po załadowaniu uruchom samouczek z menu: **Help | Build your first circuit**. Przechodź przez niego we własnym tempie. Zwracaj uwagę na to, jak każdy bramka zmienia to, czego oczekujesz w pomiarze.

Samouczek przeprowadza przez budowanie obwodu „Hello World". Jest on zwizualizowany w postaci diagramu Circuit, gdzie qubit'y są reprezentowane przez poziome linie, a Gate'y działające na tych qubit'ach — przez pudełka lub inne symbole na liniach. Ten obwód wprowadza kilka kluczowych właściwości qubit'ów i komputerów kwantowych:
...
Dlaczego idealny symulator nie zawsze miałby dokładnie taką samą liczbę zliczeń 00, jak zliczeń 11?
<Accordion>
<AccordionItem title="Odpowiedź">
Chociaż symulator jest „idealny” i prowadzi do idealnego stanu Bella, nadal symuluje z natury losowy proces, więc nadal będą występować fluktuacje statystyczne. To jak rzucanie monetą 1000 razy: nawet jeśli szansa na wyrzucenie orła lub reszki wynosi dokładnie 50-50, nie oznacza to, że zawsze otrzymasz dokładnie 500 orłów i 500 reszek.
</AccordionItem>
</Accordion>
...
Jaka jest jedna praktyczna różnica między symulatorami a rzeczywistymi komputerami kwantowymi poza szumem?
<Accordion>
<AccordionItem title="Odpowiedź">
Komputery kwantowe mogą wiązać się z czasem oczekiwania w kolejce, ograniczoną dostępnością oraz ograniczeniami specyficznymi dla urządzenia, które wpływają na sposób wykonywania obwodów.
</AccordionItem>
</Accordion>
