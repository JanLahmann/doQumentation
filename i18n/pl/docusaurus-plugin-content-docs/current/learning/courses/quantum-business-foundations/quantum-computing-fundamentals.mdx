...
Prawda. Obwód kwantowy to abstrakcyjna reprezentacja zestawu instrukcji składających się na algorytm kwantowy. Do tworzenia obwodów kwantowych możemy używać wizualnego narzędzia, takiego jak IBM [Composer](https://quantum.cloud.ibm.com/composer), lub języka programowania, takiego jak [Qiskit](/guides/tools-intro).
