---
description: 'Rozróżniaj bramki kwantowe, obwody kwantowe i komputery kwantowe'
...
*   Rozróżniać bramki kwantowe, obwody kwantowe i komputery kwantowe


## Czym są obliczenia kwantowe — i czym nie są {#what-quantum-computing-isand-what-it-isnt}
...
Wyobraź sobie dwoje przyjaciół z dwiema bardzo cienkimi, zwiewnymi chustami, niemal przezroczystymi. Jedna chusta jest czerwona, a druga niebieska. Kiedy przyjaciele nakładają chusty na siebie, razem wydają się fioletowe. Jeśli trzymają te dwie chusty rozciągnięte między sobą, stan dwójki przyjaciół trzymających coś fioletowego jest pewny, choć gdyby się rozdzielili, nie wiadomo, który trzymałby niebieską, a który czerwoną chustę. Kwantowe **splątanie** jest podobne. Stan całego układu ma właściwości, które są znane (jak wspólny kolor dwóch chust), ale poszczególne elementy nie mają dobrze określonych właściwości (jak każdy z przyjaciół, z których żaden nie trzyma chusty o wyraźnie określonym kolorze). Ta metafora jest niedoskonała, ponieważ każdy z przyjaciół mógłby z góry zdecydować, że będzie trzymał jedną chustę mocniej lub puści jedną z nich, gdy się rozejdą. W układzie kwantowym właściwości części są naprawdę nieokreślone aż do momentu wykonania pomiarów.

### Interferencja {#interference}

**Interferencja** to właściwość układów kwantowych, w której stany o przeciwnych fazach mogą się wzmacniać lub znosić. Jednym ze sposobów wyobrażenia sobie interferencji jest zastanowienie się, jak działają soczewki polaryzacyjne w okularach przeciwsłonecznych. Jeśli położysz dwie soczewki polaryzacyjne na sobie i zaczniesz obracać jedną z nich, zauważysz zarówno konstruktywną, jak i destruktywną interferencję — mniej lub więcej światła jest blokowane.
...
(b)   Dwa systemy, które są zbyt oddalone od siebie, aby mogły wzajemnie na siebie wpływać, są w jakiś sposób silnie skorelowane.

(c)   Możliwe jest istnienie stanu w systemie kwantowym, który nie może być opisany jako iloczyn niezależnych składowych kubitów tworzących ten stan.
...
Poprawna odpowiedź brzmi „Wszystkie powyższe.” Pierwsza idea odnosi się do probabilistycznej natury kubitów. Kolejne dwie idee pojawiają się w systemach splątanych.
...
Obwody kwantowe to zestaw instrukcji umożliwiających manipulowanie qubitami w celu wykorzystania superpozycji, splątania i interferencji do rozwiązywania złożonych problemów. Obejrzyj poniższy film, aby zobaczyć, jak obwody klasyczne i kwantowe wypadają w porównaniu oraz jak obwody kwantowe mogą przynosić wartość twojej firmie.

<IBMVideo id="133345141" title="Dario Gil opisuje obwody kwantowe i tworzące je bramki kwantowe. Motywuje wartość biznesową komputerów kwantowych, pokazując stany obliczeniowe, które można jednocześnie realizować na komputerze kwantowym."/>
...
*   Kwantowa superpozycja jest potężniejsza od klasycznego probabilizmu, ale słabsza od wykładniczej równoległości.
