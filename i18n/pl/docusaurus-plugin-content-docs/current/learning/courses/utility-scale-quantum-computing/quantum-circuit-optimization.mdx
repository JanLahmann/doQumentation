...
### 4.4 Ogólna dekompozycja bramki 1-kubitowej {#44-general-1-qubit-gate-decomposition}
...
### 4.5 Optymalizacja bloku jednokubitowego {#45-one-qubit-block-optimization}
...
### 4.6 Dekompozycja bramki Toffoli {#46-toffoli-decomposition}
...
### 4.7 Dekompozycja bramki CU {#47-cu-gate-decomposition}
...
### 4.8 CX, ECR, CZ są równe z dokładnością do lokalnych bramek Clifforda {#48-cx-ecr-cz-equal-up-to-local-cliffords}
