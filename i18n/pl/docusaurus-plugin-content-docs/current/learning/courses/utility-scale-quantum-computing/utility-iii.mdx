...
Opcje tłumienia błędów można ustawić w Sampler V2. Zajrzyj do przewodnika [Zarządzanie szumem w Sampler](/guides/sampler-noise-management) oraz do dokumentacji API [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2), aby uzyskać więcej informacji.
