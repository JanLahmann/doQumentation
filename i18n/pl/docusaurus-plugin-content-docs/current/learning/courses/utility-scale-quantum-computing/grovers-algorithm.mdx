...
3. **Operator dyfuzji**: zastosowanie serii operacji w celu wzmocnienia prawdopodobieństwa stanu oznaczonego.
...
### Krok 3: Wykonanie obwodu. {#step-3-executing-the-circuit-1}
...
### Krok 4: Przetwarzanie końcowe wyników. {#step-4-post-processing-the-results-1}
