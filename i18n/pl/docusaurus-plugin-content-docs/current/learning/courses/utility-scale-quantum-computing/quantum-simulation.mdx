...
### 2.2 Ustawienie parametrów symulacji ewolucji czasowej {#22-set-the-parameters-of-the-time-evolution-simulation}
...
### 2.3 Przygotowanie obwodu kwantowego 1 (Stan początkowy) {#23-prepare-the-quantum-circuit-1-initial-state}
...
### 2.4 Przygotowanie obwodu kwantowego 2 (Pojedynczy obwód ewolucji czasowej) {#24-prepare-the-quantum-circuit-2-single-circuit-for-time-evolution}
...
### 2.5 Ustawienie operatorów do pomiaru {#25-set-the-operators-to-measure}
...
### 2.6 Wykonanie symulacji ewolucji czasowej {#26-perform-time-evolution-simulation}
...
### 2.7 Wykres ewolucji czasowej obserwabli {#27-plot-the-time-evolution-of-the-observables}
...
## 3. Ćwiczenie 1. Wykonanie symulacji z wykorzystaniem Suzuki–Trottera drugiego rzędu {#3-exercise-1-perform-simulation-using-second-order-suzukitrotter}
...
### 3.3 Wykres wyników Suzuki–Trottera drugiego rzędu {#33-plot-the-second-order-suzukitrotter-results}
...
### 4.3 Krok 3. Wykonanie z użyciem prymitywów IBM Quantum {#43-step-3-execute-with-ibm-quantum-primitives}
