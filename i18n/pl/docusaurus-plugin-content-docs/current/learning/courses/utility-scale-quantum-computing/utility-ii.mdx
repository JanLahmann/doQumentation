...
## 2. Definiowanie hamiltonianu Isinga w poprzecznym polu {#2-defining-the-transverse-field-ising-hamiltonian}
...
#### Zdefiniuj Hamiltonian {#define-the-hamiltonian-1}
...
#### Ustaw operatory do pomiaru {#set-the-operators-to-be-measured-1}
...
#### Wykonanie symulacji ewolucji w czasie {#perform-time-evolution-simulation-1}
