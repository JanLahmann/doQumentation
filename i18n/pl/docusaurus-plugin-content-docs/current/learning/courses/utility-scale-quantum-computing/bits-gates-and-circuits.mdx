...
Jeśli nie masz zainstalowanego `qiskit-ibm-runtime`, najpierw musisz go zainstalować. Więcej informacji znajdziesz w [dokumentacji API](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/runtime-service).
