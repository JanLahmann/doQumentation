...
### Od eksperymentu fizycznego do obwód kwantowych {#from-physical-experiment-to-quantum-circuits}

Na podstawie działania tych bramka'ów możemy dostrzec, że kety w wyrażeniach na $P_{++}$:
$$
