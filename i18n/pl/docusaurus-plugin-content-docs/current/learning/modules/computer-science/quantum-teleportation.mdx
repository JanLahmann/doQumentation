...
- Krok 3: Wykonaj zadanie na komputerach kwantowych IBM przy użyciu prymitywów IBM Quantum
...
Sampler to prymityw zaprojektowany do próbkowania możliwych stanów wynikających z obwodu kwantowego oraz zbierania statystyk dotyczących tego, jakie stany mogą być zmierzone i z jakim prawdopodobieństwem. Importujemy tutaj IBM Quantum Sampler:
...
### Krok 1: Odwzorowanie problemu na obwód {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Krok 3: Wykonanie {#step-3-execute-1}
