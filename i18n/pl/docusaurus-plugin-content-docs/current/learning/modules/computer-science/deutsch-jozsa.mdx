...
<Accordion>
<AccordionItem title="Ile razy musimy uruchomić powyższy algorytm, aby poznać funkcję $f(x)$? Czy jest to lepsze niż w przypadku klasycznym? Czy wolisz mieć klasyczny, czy kwantowy komputer do rozwiązania tego problemu?">
