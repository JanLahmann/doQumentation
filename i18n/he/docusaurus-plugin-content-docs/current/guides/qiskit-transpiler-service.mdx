...
<Admonition type="danger" title="העברת שירות Transpiler">
    ...
    אם יש לך משוב או שאתה רוצה לפנות לצוות הפיתוח, השתמש בערוץ [Qiskit Slack Workspace](https://qiskit.slack.com/archives/C06KF8YHUAU) הזה.
</Admonition>
...
<Admonition type="tip" title="המלצות">
    ...
    - ראה בתיעוד [לקוח Python של שירות Qiskit Transpiler](https://docs.quantum.ibm.com/api/qiskit-ibm-transpiler).
</Admonition>
