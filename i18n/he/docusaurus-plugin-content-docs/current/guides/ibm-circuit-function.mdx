...
| mitigation_level |  |  | כמה דיכוי ומיתון שגיאות להחיל. ראה בסעיף [רמת מיתון](#mitigation-level) למידע נוסף על השיטות המשמשות בכל רמה. | 1 / 2 / 3 | 1 |
...
| dynamical_decoupling | enable |  | האם לאפשר dynamical decoupling. ראה ב-[טכניקות דיכוי ומיתון שגיאות](/guides/error-mitigation-and-suppression-techniques#dynamical-decoupling) להסבר על השיטה.  | True/False | True |
...
|  | pec_mitigation |  | האם להפעיל שיטת מיתון שגיאות Probabilistic Error Cancellation. ראה ב-[טכניקות דיכוי ומיתון שגיאות](/guides/error-mitigation-and-suppression-techniques#probabilistic-error-cancellation-pec) להסבר על השיטה.  | True/False | False |
