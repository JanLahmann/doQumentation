...
שים לב שעבור כל משתנה של הפונקציה, אנחנו מציינים את מספר ה-Qubit (איתו אתה יכול להתנסות). על ידי שכבוב 10 Circuit זהים והערכת 10 אובזרבבלים זהים על Qubit שונים לאורך Circuit גדול אחד, אתה יכול להפחית רעש בתוך תהליך האופטימיזציה של CMA, תוך הסתמכות על שיטת לומד הרעש, ולהפחית משמעותית את מספר ה-shots הנדרשים.
## קלט/פלט {#inputoutput}
...
| optimizer_options | `Optional[dict[str, Any]]`                           | אפשרויות להעברה למייעל. פרטי קלט זה תלויים במייעל המשמש; לפרטים ספציפיים, ראה בתיעוד המייעל המשמש                                                                                              | MD                | `{"maxiter": 50 }`       |
