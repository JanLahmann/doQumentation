...
כלי SQD יכול לטפל בהמילטוניאנים המבוטאים כצירופים ליניאריים של אופרטורי פאולי או אופרטורים פרמיוניים בכימות שני. דגימות הקלט מתקבלות מ-Circuit-ים קוונטיים המוגדרים על ידי המשתמש, שמאמינים שהם ייצוגים טובים של מצבים עצמיים (לדוגמה, מצב היסוד) של אופרטור יעד. קצב ההתכנסות של SQD כפונקציה של מספר הדגימות משתפר עם דלילות מצב היעד.
