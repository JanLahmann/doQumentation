...
מעגל קוונטי פשוט הוא אוסף של קיוביטים ורשימת הוראות שפועלות על אותם קיוביטים. להדגמה, התא הבא יוצר מעגל חדש עם שני קיוביטים חדשים, ולאחר מכן מציג את התכונה [`qubits`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#qubits) של המעגל, שהיא רשימה של [`Qubits`](https://docs.quantum.ibm.com/api/qiskit/circuit#qiskit.circuit.Qubit) בסדר מהביט הפחות משמעותי $q_0$ עד הביט המשמעותי ביותר $q_n$.
...
הדרך הקלה ביותר להציג מידע זה היא באמצעות שיטת [`draw`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#draw), שמחזירה המחשה ויזואלית של Circuit. ראה [המחשת Circuit](/guides/visualize-circuits) לדרכים שונות להצגת Circuit קוונטיים.
...
מדידות משמשות לדגימת מצבי qubit בודדים ולהעברת התוצאות לרגיסטר קלאסי. שים לב שאם אתה שולח Circuit ל-primitive מסוג [Sampler](/guides/get-started-with-sampler), מדידות הן חובה. עם זאת, Circuit הנשלחים ל-primitive מסוג [Estimator](/guides/get-started-with-estimator) אסור שיכילו מדידות.

ניתן למדוד qubit בשלוש שיטות: [`measure`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#qiskit.circuit.QuantumCircuit.measure), [`measure_all`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#measure_all) ו-[`measure_active`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#measure_active). כדי ללמוד כיצד להמחיש תוצאות מדידה, ראה את דף [המחשת תוצאות](/guides/visualize-results).
