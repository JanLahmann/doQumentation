...
שער Pauli Z פועל כזהות על המצב $\left|0\right\rangle$ ומכפיל את הסימן של המצב $\left|1\right\rangle$ ב--1. לכן הוא הופך את המצבים $\left|+\right\rangle$ ו-$\left|-\right\rangle$. בבסיס +/-, הוא ממלא את אותו תפקיד כמו שער NOT בבסיס $\left|0\right\rangle$/$\left|1\right\rangle$.
