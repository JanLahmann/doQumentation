...
המעגל מכניס את שני ה-qubit-ים למצב $|\psi\rangle = (|00\rangle + |01\rangle+ |10\rangle-|11\rangle) / 2$. מצבי הבסיס החישוביים הם $|00\rangle, |10\rangle, |01\rangle$, וכן $|11\rangle$. ההסתברות לכל אחד מהמצבים החישוביים היא 1/4.
