...
- למד כיצד [להגדיר את רמת האופטימיזציה](/guides/runtime-options-overview).
- כנס לנושא [Transpile עם pass managers](/guides/transpile-with-pass-managers).
- לדוגמאות, ראה [ייצוג Qubit יחידים](/guides/represent-quantum-computers).
- למד [כיצד לבצע transpile של Circuits](/guides/circuit-transpilation-settings) כחלק מתהליך העבודה של Qiskit patterns.
- ראה ב[תיעוד ה-API של Transpiler](https://docs.quantum.ibm.com/api/qiskit/transpiler).
</Admonition>
