...
# הגדרות ברירת מחדל ואפשרויות תצורה של ה-Transpiler {#transpilation-default-settings-and-configuration-options}
{/*
...
<Admonition type="tip" title="המלצות">
    ...
    - כנס לנושא [טרנספילציה עם pass managers](transpile-with-pass-managers).
