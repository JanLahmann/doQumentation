...
| max_parallel_jobs | int      | מספר מקסימלי של עבודות QPU המורצות במקביל  | לא       | 3             |
...
<Admonition type="note" title="הערה">
ודא עמידה במגבלות עבודות Qiskit Runtime.
...
ראה את המדריך [מגבלות עבודה](/guides/job-limits) לפרטים נוספים.
</Admonition>
# פלט {#output}
...
## מילוני פלט: {#output-dictionaries}
...
### תיאור מילון ה-`metadata` {#description-of-the-metadata-dictionary}
...
### תיאור מילון ה-`all_samples_metrics` {#description-of-the-all-samples-metrics-dictionary}
