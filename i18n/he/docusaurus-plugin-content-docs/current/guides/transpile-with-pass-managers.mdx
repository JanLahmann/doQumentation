...
ה-mock backend‏ `FakeSherbrooke` מ-`qiskit_ibm_runtime` משמש בדוגמאות אלה, אך ניתן לנסות זאת על כל backend אמיתי או מדומה התואם ל-Qiskit. התוצאות שלך עשויות להיות שונות.
</Admonition>
