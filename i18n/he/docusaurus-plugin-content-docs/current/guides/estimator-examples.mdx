---
title: "דוגמאות Estimator"
sidebar_label: "דוגמאות Estimator"
description: "דוגמאות מעשיות לשימוש ב-primitive של Estimator ב-Qiskit Runtime."
...
הדוגמאות בחלק זה ממחישות כמה דרכים נפוצות לשימוש ב-Estimator. לפני הרצת דוגמאות אלה, עקוב אחר ההוראות ב[התקנת Qiskit.](install-qiskit)
...
- תרגל עם primitives באמצעות עבודה על [שיעור פונקציית עלות](/learning/courses/variational-algorithm-design/cost-functions) בלימוד IBM Quantum&reg;.
