...
<Admonition type="tip" title="המלצות">
    ...
    - כנס לנושא [טרנספיל עם מנהלי מעבר](transpile-with-pass-managers).
    ...
    - ראה ב[תיעוד ה-API של כלי הדיבוג.](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/debug-tools)
</Admonition>
