...
- למדו על [אפשרויות Qiskit Runtime הזמינות](/guides/runtime-options-overview).
...
- למדו [כיצד לבצע טרנספיל של Circuit](/guides/circuit-transpilation-settings#compare-transpiler-settings) כחלק מתהליכי עבודה של Qiskit patterns באמצעות Qiskit Runtime.
