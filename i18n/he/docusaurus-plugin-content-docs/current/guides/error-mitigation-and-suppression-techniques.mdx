...
### הפעלת TREX באמצעות אפשרות `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### הפעלת TREX באמצעות אפשרות `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### הפעלת ZNE באמצעות אפשרות `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}

ניתן להפעיל ZNE על ידי הגדרת `zne_mitigation` ל-`True` ב[אפשרויות העמידות של Qiskit Runtime](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-resilience-options-v2) עבור Estimator.
...
### הפעלת ZNE באמצעות אפשרות `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- חקור [אפשרויות](/guides/runtime-options-overview) נוספות עבור ה-primitives של Qiskit Runtime.
