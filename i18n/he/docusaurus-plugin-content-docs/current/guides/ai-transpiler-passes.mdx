...
ראה ב[תיעוד שירות Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) למידע נוסף על המגבלות החלות על מעברי ה-Transpiler המבוססים על בינה מלאכותית.

## ציטוט {#citation}

אם אתה משתמש בתכונה כלשהי מבוססת בינה מלאכותית מ-Qiskit Transpiler Service במחקר שלך, השתמש ב[ציטוט המומלץ](/guides/qiskit-transpiler-service#citation).
