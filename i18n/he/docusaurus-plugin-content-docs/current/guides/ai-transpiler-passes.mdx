...
כדי להשתמש במעברי ה-AI Transpiler, קודם [התקן את חבילת `qiskit-ibm-transpiler`](/guides/qiskit-transpiler-service#install-transpiler-service). כנס ל[תיעוד ה-API של qiskit-ibm-transpiler](https://docs.quantum.ibm.com/api/qiskit-ibm-transpiler) לקבלת מידע נוסף על האפשרויות השונות הזמינות.
...
ראה ב[תיעוד שירות Qiskit Transpiler Service](./qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) למידע נוסף על המגבלות החלות על מעברי ה-Transpiler המבוססים על בינה מלאכותית.
