...
* אם נתקלת בבעיות בהתקנה או ייבוא של Qiskit 1.0, ראה בסעיף [פתרון בעיות](#troubleshooting).

אם אתה מעוניין להבין את מבנה החבילה הישן ומדוע הוא השתנה, ראה ב[סקירה של שינויי האריזה השוברים](./metapackage-migration).
...
3. התקן חבילות לפי הצורך.
   ...
   אם נתקלת בבעיות, ראה בסעיף [פתרון בעיות](#troubleshooting), או שאל ב-[Qiskit Slack](https://qisk.it/join-slack). אם אתה חושב שיש באג, תוכל [לפתוח סוגיה עבור Qiskit](https://github.com/Qiskit/qiskit/issues/new/choose).
...
אנחנו ממליצים שהחבילה שלך תדרוש `qiskit>=0.45,<1` (או גבול תחתון מתאים אחר) אם אינך בטוח האם החבילה תואמת ל-Qiskit 1.0.
...
לאחר שחרור מועמדי השחרור של Qiskit, ולאחר שכל התלויות של החבילה שלך תומכות ב-Qiskit 1.0, *אנחנו כן ממליצים* להגן על ענפים בהצלחה מול מועמד השחרור האחרון, כדי להבטיח שהחבילה נשארת תואמת ל-Qiskit 1.0.
...
שים לב שזה לוקח זמן; תן למפתחים כחודש לקראת גרסאות חדשות של ההפצות שלהם!
...
* התלות היא חבילה שמתוחזקת באופן פעיל, אך עדיין אינה תומכת ב-Qiskit 1.0.
  ...
  במקרה זה, תצטרך לחכות למפתחים לשחרר גרסה תואמת - היה סבלני!
