...
# התקנת חבילת Qiskit v1.0 החדשה {#install-the-new-qiskit-v10-package}
...
### המלצות לבדיקה מול Qiskit v1.0 {#recommendations-for-testing-against-qiskit-v10}
...
#### יצירת סביבה עובדת ל-Qiskit v1.0 {#create-a-working-environment-for-qiskit-v10}
...
#### יצירת סביבה עובדת ל-Qiskit 0.45 או 0.46 {#create-a-working-environment-for-qiskit-045-or-046}
