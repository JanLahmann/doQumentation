...
המטרה הכוללת של דוגמה זו היא לדמות אבולוציית זמן של ה-Hamiltonian המודלי. אנחנו עושים זאת כאן באמצעות אבולוציית Trotter, שתחולק לשני חלקים.
...
נבחר לתת למערכת להתפתח עד זמן $t_f=5$ ונשתמש ב-AQC-Tensor לדחיסת אבולוציית הזמן עד $t=4$, ולאחר מכן לאבולוציה בצעדי Trotter רגילים עד $t_f$.
