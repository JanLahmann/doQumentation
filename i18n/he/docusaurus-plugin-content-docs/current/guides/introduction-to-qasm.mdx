...
OpenQASM היא פורמט ה-interchange הנפוץ בין כלי תוכנה קוונטיים עצמאיים. עבור מפתחים המעדיפים כלי אחד לבניית Circuit, כלי אחר ל-transpilation, וכן הלאה, OpenQASM היא ה-*lingua franca* המשמשת כגשר ביניהם.
 ...
 ה-Qiskit SDK מספק דרכים להמרה בין OpenQASM לבין המחלקה [`QuantumCircuit`](../api/qiskit/qiskit.circuit.QuantumCircuit) (ראה [OpenQASM 2 ו-Qiskit](interoperate-qiskit-qasm2) ו-[OpenQASM 3 ו-Qiskit](interoperate-qiskit-qasm3) להוראות).
