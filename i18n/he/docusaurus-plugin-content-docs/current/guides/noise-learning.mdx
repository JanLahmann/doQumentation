...
תוצאת עבודת `NoiseLearnerV3` מכילה רשימה של אובייקטים מסוג [`NoiseLearnerV3Result`](https://qiskit.github.io/qiskit-ibm-runtime/stubs/qiskit_ibm_runtime.noise_learner_v3.NoiseLearnerV3Result.html), אחד לכל הוראת קלט.
