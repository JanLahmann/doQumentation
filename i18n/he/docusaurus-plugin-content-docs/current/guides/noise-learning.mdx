...
<Admonition type="tip" title="המלצות">
    ...
    - ראה כיצד [לציין אפשרויות](specify-runtime-options) עבור ה-primitives של Qiskit Runtime.
