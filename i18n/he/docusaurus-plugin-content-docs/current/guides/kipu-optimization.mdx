...
הקוד הבא מניח שכבר שמרת את פרטי ההתחברות שלך. אם לא עשית זאת, עקוב אחר ההוראות ב[שמירת חשבון IBM Cloud שלך](/guides/functions#install-qiskit-functions-catalog-client) כדי לאמת עם מפתח ה-API שלך.
</Admonition>
