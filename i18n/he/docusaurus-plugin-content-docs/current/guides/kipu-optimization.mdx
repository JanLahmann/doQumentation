...
*ראה את [API reference](https://docs.quantum.ibm.com/api/functions/kipu-optimization)*

<Admonition type="note" title="הערה">
* Qiskit Functions הן תכונה ניסיונית הזמינה רק למשתמשי IBM Quantum&reg; Premium Plan, Flex Plan, ו-On-Prem (דרך IBM Quantum Platform API) Plan. הן במעמד גרסת תצוגה מקדימה וכפופות לשינויים.
</Admonition>
...
כך ניתן להגדיר את Iskay עם הגדרות שונות:
...
### 1. יצירת פונקציית המטרה {#1-create-the-objective-function-1}
...
### 2. הרצת המייעל {#2-run-the-optimizer-1}
...
### 3. שליפת התוצאה {#3-retrieve-the-result-1}
...
הדוגמה הבאה מריצה את מקרה ה-Maxcut עם 150 צמתים.
...
- בקר ב[הפניית ה-API](https://docs.quantum.ibm.com/api/functions/kipu-optimization) עבור Qiskit Function זו.
