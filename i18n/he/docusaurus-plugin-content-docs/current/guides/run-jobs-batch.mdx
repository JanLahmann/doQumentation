...
<Admonition type="tip">
אם אתם לא משתמשים במנהל הקשר, סגרו את ה-batch ידנית. אם תשאירו את ה-batch פתוח ותשלחו אליו עבודות נוספות מאוחר יותר, ה-TTL המקסימאלי עלול להגיע לסיומו לפני שהעבודות הבאות יתחילו לרוץ, מה שיגרום לביטולן. אפשר לסגור את ה-batch מיד לאחר שסיימתם לשלוח אליו עבודות. כשסוגרים batch עם `batch.close()`, הוא לא מקבל עוד עבודות חדשות, אבל העבודות שכבר נשלחו ימשיכו לרוץ עד לסיום ואפשר לאחזר את תוצאותיהן.
</Admonition>
