...
## מידת הקירוב {#approximation-degree}
...
## זרע מחולל המספרים האקראיים {#random-number-generator-seed}
...
## אפשרויות שלב ופלאגין של הטרנספיילר {#transpiler-stage-and-plugin-options}
...
- ראה בנושא [אפשרויות ברירות מחדל והגדרות תצורה](defaults-and-configuration-options).
...
- ראה ב[תיעוד ה-API של הטרנספיילר](https://docs.quantum.ibm.com/api/qiskit/transpiler).
