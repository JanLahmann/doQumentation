...
אנחנו ממליצים להשתמש בגרסאות אלו או בחדשות יותר.
...
:::tip[Transpile ל-ISA circuits ו-observables]


  זרימת העבודה של IBM Quantum primitives דורשת ש-Circuit וה-observables יומרו לשימוש רק בהוראות הנתמכות על ידי ה-QPU (המכונות מעגלי *instruction set architecture (ISA)* ו-observables). ה-primitives הייחוסיים עדיין מקבלים הוראות מופשטות, מכיוון שהם מסתמכים על סימולציות statevector מקומיות, אך Transpile של ה-Circuit עשוי עדיין להיות מועיל מבחינת אופטימיזציית ה-Circuit.
...
לדוגמה מלאה, ראה את הדף [דוגמאות Estimator](/guides/estimator-examples).
...
:::tip[Transpile ל-ISA circuits ו-observables]
  ...
  זרימת העבודה של IBM Quantum primitives דורשת ש-Circuit יומרו לשימוש רק בהוראות הנתמכות על ידי ה-QPU (המכונות ISA circuits). ה-primitives הייחוסיים עדיין מקבלים הוראות מופשטות, מכיוון שהם מסתמכים על סימולציות statevector מקומיות, אך Transpile של ה-Circuit עשוי עדיין להיות מועיל מבחינת אופטימיזציית ה-Circuit.
...
לדוגמה מלאה, ראה את הדף [דוגמאות Sampler](/guides/sampler-examples).
