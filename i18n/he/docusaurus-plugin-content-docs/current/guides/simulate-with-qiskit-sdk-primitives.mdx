...
במידול רעש של המכשיר, אך הן שימושיות לאב-טיפוס מהיר של אלגוריתמים לפני שמתבוננים בטכניקות סימולציה מתקדמות יותר ([שימוש ב-Qiskit Aer](/guides/simulate-stabilizer-circuits)) או בהרצה על מכשירים אמיתיים ([Qiskit Runtime primitives](primitives)).
