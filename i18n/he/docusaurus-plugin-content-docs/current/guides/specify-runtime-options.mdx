...
אפשר להגדיר אפשרויות בעת אתחול הפרימיטיב, לאחר אתחולו, או במתודה `run()`. ראו בסעיף [כללי עדיפות](runtime-options-overview#options-precedence) כדי להבין מה קורה כשאותה אפשרות מצוינת במספר מקומות.
