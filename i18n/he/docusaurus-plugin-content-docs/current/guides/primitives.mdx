...
לדוגמה, עיין בנושאי [אפשרויות Estimator](/guides/estimator-options) ו[אפשרויות Sampler](/guides/sampler-options) כדי ללמוד על אפשרויות פרימיטיבי IBM Quantum, או ראה את [עזרי ה-API של Qiskit Aer](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html) לאפשרויות פרימיטיבי Qiskit Aer.

## יתרונות פרימיטיבי Qiskit {#benefits-of-qiskit-primitives}

עם פרימיטיבים, משתמשי Qiskit יכולים לכתוב קוד קוונטי עבור QPU ספציפי מבלי לנהל כל פרט באופן מפורש. כמו כן, בשל שכבת ההפשטה הנוספת, ייתכן שתוכל לגשת ביתר קלות ליכולות החומרה המתקדמות של ספק נתון. לדוגמה, עם פרימיטיבי IBM Quantum, תוכל לנצל את ההתקדמות האחרונה בהפחתה ודיכוי שגיאות על ידי שינוי אפשרויות כגון [`resilience_level`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-estimator-options#resilience_level) של הפרימיטיב, במקום לבנות מימוש משלך של טכניקות אלה.
...
- למד על [פרימיטיבי IBM Quantum](/guides/qiskit-runtime-primitives), המשמשים להרצת Circuits על QPU של IBM.
</Admonition>
