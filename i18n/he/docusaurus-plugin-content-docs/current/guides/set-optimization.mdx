...
ראשית, נבצע transpile באמצעות רמת אופטימיזציה 0.
...
כוונון רמת האופטימיזציה יכול לשנות היבטים אחרים של המעגל גם כן, לא רק את מספר ה-Gate ECR. לדוגמאות של כיצד הגדרת רמת האופטימיזציה משנה את ה-layout, ראה [ייצוג מחשבים קוונטיים](/guides/represent-quantum-computers).
