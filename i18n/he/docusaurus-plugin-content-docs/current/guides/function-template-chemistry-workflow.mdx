...
# פריסה והפעלה של תבנית לסימולציה אלקטרונית עם מודל ממס משתמע {#deploy-and-run-a-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
<details>
<summary> לחץ לפרטים נוספים על האפשרויות הנדרשות: </summary>
...
<details>
<summary> לחץ למידע נוסף על קביעת אפשרויות SQD:</summary>
...
- ראו במדריך לבניית תבנית פונקציה עבור [סימולציית המילטוניאן](./function-template-hamiltonian-simulation)
