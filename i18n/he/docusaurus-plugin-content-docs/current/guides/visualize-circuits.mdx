...
הארגומנט `fold` קובע רוחב מקסימלי לפלט. ב-renderer מסוג `text`, זה קובע את אורך השורות של הדיאגרמה לפני שהיא עוברת לשורה הבאה. כאשר משתמשים ב-renderer מסוג 'mpl', זהו מספר השכבות (הוויזואליות) לפני המעבר לשורה הבאה.
...
<Admonition type="tip" title="המלצות">
  ...
  -  ראו ב[תיעוד API של ויזואליזציות Qiskit.](https://docs.quantum.ibm.com/api/qiskit/visualization)
</Admonition>
