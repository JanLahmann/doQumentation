...
## ייבוא תוכנית OpenQASM 2 אל Qiskit {#import-an-openqasm-2-program-into-qiskit}
...
```
ראה את [OpenQASM 2 Qiskit API](https://docs.quantum.ibm.com/api/qiskit/qasm2) למידע נוסף.
...
#### דוגמה: ייבוא תוכנית OpenQASM 2 כמחרוזת {#example-import-an-openqasm-2-program-as-a-string}
...
### קישור שערי OpenQASM 2 עם שערי Qiskit {#link-openqasm-2-gates-with-qiskit-gates}
...
#### דוגמה: ייבוא תוכנית שנוצרה על-ידי המייצא הישן של Qiskit {#example-import-a-program-created-by-qiskits-legacy-exporter}
...
### הגדרת פונקציות קלאסיות מותאמות אישית {#define-custom-classical-functions}
...
כאן אנחנו מספקים שתי פונקציות קלאסיות מותאמות אישית.
...
## ייצוא Circuit של Qiskit אל OpenQASM 2 {#export-a-qiskit-circuit-to-openqasm-2}
...
- למד איך ליצור קוד OpenQASM במדריך [IBM Quantum Composer](/guides/composer).
- ראה את [OpenQASM 2 Qiskit API](https://docs.quantum.ibm.com/api/qiskit/qasm2) reference.
- עיין בנושא [Verify your program](/guides/debugging-tools).
- בקר ב-[OpenQASM Live Specification](https://openqasm.com/).
</Admonition>
