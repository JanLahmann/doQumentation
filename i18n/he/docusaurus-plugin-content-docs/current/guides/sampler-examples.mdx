---
description: 'דוגמאות מעשיות לשימוש ב-primitive של Sampler של IBM Quantum.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'דוגמאות Sampler'
title: 'דוגמאות Sampler'
---
...
השתמש ב-Sampler כדי להחזיר את תוצאת המדידה כ-bitstrings או ספירות של מעגל בודד.
...
השתמש ב-Sampler כדי להחזיר את תוצאת המדידה כ-bitstrings או ספירות של מעגלים מרובים בעבודה אחת.
...
## הרצת מעגלים פרמטריים {#run-parameterized-circuits}

הרץ מספר ניסויים בעבודה בודדת, ממנף ערכי פרמטרים כדי להגדיל את שימוש חוזר במעגלים.
...
## שימוש ב-batches ואפשרויות מתקדמות {#use-batches-and-advanced-options}

חקור את [מצב ההרצה](/guides/execution-modes) batch ואפשרויות מתקדמות לאופטימיזציה של ביצועי מעגלים על QPUs.
...
- נסה את מדריך [השוואת הגדרות Transpiler](/guides/circuit-transpilation-settings).
- הבן את [מגבלות העבודה](/guides/job-limits) בעת שליחת עבודה ל-IBM&reg; QPU.
</Admonition>
