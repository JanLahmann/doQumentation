---
description: 'הבנת פורמט הכניסה והיציאה (כולל Primitive Unified Blocs או PUBs) של פרימיטיבי Qiskit SDK'
...
ברגע ש-PUB אחד או יותר נשלחים ל-QPU לביצוע ועבודה מסתיימת בהצלחה, הנתונים מוחזרים כאובייקט מיכל [`PrimitiveResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PrimitiveResult). ה-`PrimitiveResult` מכיל רשימה איטרבילית של אובייקטי [`PubResult`](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.PubResult) שמכילים את תוצאות הביצוע עבור כל PUB. לדוגמה, עבודה שהוגשה עם 20 PUBs תחזיר אובייקט `PrimitiveResult` המכיל רשימה של 20 `PubResults`, אחד המתאים לכל PUB.
...
<Admonition type="tip" title="המלצות">
  ...
  -  עיין ב-API של [פרימיטיבי Qiskit SDK](https://docs.quantum.ibm.com/api/qiskit/primitives).

  -  עיין ב-API של [פרימיטיבי Qiskit Aer](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html).

  -  למד עוד על [פרימיטיבי IBM Quantum](/guides/qiskit-runtime-primitives).

  -  עיין ב-API של [`qiskit-ibm-runtime` Estimator](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2).

  -  עיין ב-API של [`qiskit-ibm-runtime` Sampler](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2).
</Admonition>
