...
title: 'הפחתת שגיאות באמצעות רשתות טנסור (TEM) - Algorithmiq'
---
...
התחבר באמצעות [מפתח ה-API של IBM Quantum Platform](http://quantum.cloud.ibm.com/), ובחר את פונקציית ה-TEM באופן הבא. (קטע קוד זה מניח שכבר [שמרת את חשבונך](/guides/functions-get-started#install-qiskit-functions-catalog-client) בסביבה המקומית שלך.)
