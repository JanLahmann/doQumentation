...
* *IBM Quantum Compute Service*: מעגל המכיל את תכונת Qiskit המתאימה יכול להתבצע בהצלחה על חומרה דרך IBM Quantum Compute Service.
...
אם אינך משתמש ב-OpenQASM 3 ישירות, תוכל להשתמש בבטחה בתכונות שנתמכות לייצוג ב-Qiskit SDK, ייצוא ל-OpenQASM 3 והגשה ל-IBM Quantum Compute Service.
...
- ראה את תיעוד ה-[OpenQASM 3 Qiskit API](https://docs.quantum.ibm.com/api/qiskit/qasm3).
- ראה את תיעוד ה-[OpenQASM 2 Qiskit API](https://docs.quantum.ibm.com/api/qiskit/qasm2).
- עיין בנושא [אמת את התוכנית שלך](/guides/debugging-tools).
