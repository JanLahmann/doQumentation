---
description: 'איך להשתמש ב-primitive של Executor ב-qiskit-ibm-runtime.'
...
מכיוון ש-IBM Quantum Compute Service הוא שירות מנוהל, קודם צריך לאתחל את החשבון שלך. לאחר מכן אפשר לבחור את ה-QPU שרוצים להשתמש בו לחישוב ערך הציפייה.
