...
קבלו את מידע ה-`target` מה-`backend` ושמרו את שמות הפעולות בתור `basis_gates`, כיוון שיהיה צורך לשנות את ה-`target` כדי להוסיף מידע תזמון עבור ה-gates המשמשים ב-dynamical decoupling.

<Admonition type="note">
ה-backend המדומה `FakeSherbrooke` מ-`qiskit_ibm_runtime` משמש בדוגמאות אלו, אך ניתן לנסות זאת על כל backend אמיתי או מדומה התואם ל-Qiskit. התוצאות שלכם עשויות להיות שונות.
</Admonition>
...
![פלט של תא הקוד הקודם](/docs/images/guides/dynamical-decoupling-pass-manager/extracted-outputs/9479a60c-d5d0-45c7-a93e-a2a488ba8985-0.svg)
...
![פלט של תא הקוד הקודם](/docs/images/guides/dynamical-decoupling-pass-manager/extracted-outputs/7a552621-a96f-4bb8-ae9b-4ab5a65bbb64-0.svg)
...
![פלט של תא הקוד הקודם](/docs/images/guides/dynamical-decoupling-pass-manager/extracted-outputs/f0f4b29d-1c95-47d2-a7ad-8e130eaff74a-0.svg)
