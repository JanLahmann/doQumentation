...
הטבלה הבאה מתעדת אפשרויות מהגרסה האחרונה של `qiskit-ibm-runtime`. כדי לראות גרסאות אפשרויות ישנות יותר, כנס ל-[`qiskit-ibm-runtime` API reference](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime) ובחר גרסה קודמת.
