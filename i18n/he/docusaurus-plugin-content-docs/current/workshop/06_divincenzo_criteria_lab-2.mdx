...
## 1. קריטריון 1 – qubit-ים ניתנים לסקאלינג ומאופיינים היטב {#1-criterion-1-scalable-well-characterized-qubits}
...
## 3. קריטריון 3 – זמן קוהרנטיות ארוך (דקוהרנטיות מול זמן שער) {#3-criterion-3-long-coherence-time-decoherence-vs-gate-time}
...
## 4. קריטריון 4 – קבוצה אוניברסלית של שערים קוונטיים {#4-criterion-4-universal-set-of-quantum-gates}
