...
ראשית, ניצור את המילטוניאנים חד-גופיים ודו-גופיים המתארים את מודל אנדרסון חד-ממדי עם אי-טוהר בודד (SIAM) עם ``7`` אתרי אמבט (``8`` אלקטרונים ב-``8`` מסלולים). מודל זה משמש לתיאור אטומי אי-טוהר מגנטיים המשובצים במתכות.
...
***הערה: [Qiskit Aer](https://qiskit.github.io/qiskit-aer/index.html) נדרש לדמות דגימות מ-Circuit שעברו Transpile.***
