...
כאן אנחנו משתמשים בסימולטור רשת טנסורית המבוסס על [quimb](http://quimb.readthedocs.io/). בדוגמה זו אנחנו משתמשים בסימולטור מצב מכפלת מטריצות (MPS) של quimb, ואנחנו משתמשים ב-[JAX](https://docs.jax.dev/en/latest/) לדיפרנציאציה אוטומטית. ראו את [תיעוד ה-API](../stubs/qiskit_addon_aqc_tensor.simulation.quimb.QuimbSimulator.rst) למידע נוסף על אופן השימוש בסימולטור quimb.
