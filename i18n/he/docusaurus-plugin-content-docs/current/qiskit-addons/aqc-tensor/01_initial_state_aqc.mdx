...
### הגדרת המילטוניאן מודל ואובזרבל {#set-up-a-model-hamiltonian-and-observable}
...
בשלב 2 של [תבנית Qiskit](https://quantum.cloud.ibm.com/docs/guides/intro-to-patterns), אנחנו מבצעים Transpile לה-Circuit ולכל האובזרבל/ים הרצויים לביצוע על מכשיר יעד. כאן אנחנו משתמשים ב-Backend מדומה שמסופק על ידי `qiskit-ibm-runtime`.
