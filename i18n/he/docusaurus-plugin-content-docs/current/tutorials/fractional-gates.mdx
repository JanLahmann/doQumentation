...
בנוסף, ישנה בעיה ידועה ב-Qiskit בה השינוי של שערי RZZ עשוי להיכשל בתרחישים מסוימים. לפתרון בעיה, ראה בסעיף [פתרון בעיות](#troubleshooting).
מדריך זה מדגים כיצד להשתמש בשערים שבריים באמצעות הגישה השנייה דרך דוגמה בהשראת שיטת הגרעין הקוונטי.
כדי להבין טוב יותר היכן גרעינים קוונטיים צפויים להיות שימושיים, אנחנו ממליצים לקרוא את [Liu, Arunachalam & Temme (2021).](https://www.nature.com/articles/s41567-021-01287-z)
...
בחלק זה, אנחנו מדגימים כיצד לבצע אופטימיזציה לשערי U באמצעות שערי RX שבריים, תוך התבססות על אותו מעגל שהוצג בחלק הקודם.
...
כדי להבטיח טיפול נאות בזוויות RZZ עבור שערים שבריים, אנחנו ממליצים תמיד להשתמש באופציה `backend` במקום.
