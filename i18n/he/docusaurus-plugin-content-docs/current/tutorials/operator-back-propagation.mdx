...
- [`pauli-prop`](https://github.com/Qiskit/pauli-prop), חבילה מואצת ב-Rust להפצת Pauli, עם [הדרכות](https://github.com/Qiskit/pauli-prop/tree/main/docs/tutorials) המכסות OBP, הערכת ערך-ציפייה קלאסית, וסימולציה רועשת
</Admonition>
