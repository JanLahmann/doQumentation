...
* Qiskit SDK גרסה 2.0 ואילך, עם תמיכה ב[ויזואליזציה](https://docs.quantum.ibm.com/api/qiskit/visualization)
...
פרק זה משתמש במערכת בת 10 אתרים כדי להמחיש את זרימת העבודה של AQC-Tensor שלב אחר שלב. אנחנו מדמים את הדינמיקה של שרשרת ספין XXZ בת 10 אתרים, מודל שנחקר רבות לבחינת אינטראקציות ספין ותכונות מגנטיות.
