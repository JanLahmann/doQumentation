...
המעגלים המשמשים בבנצ'מרק זה נלקחו מ-[מאגר הבנצ'מרק Hamlib](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/hamlib), המכיל עומסי עבודה ריאליסטיים של סימולציית המילטון.
