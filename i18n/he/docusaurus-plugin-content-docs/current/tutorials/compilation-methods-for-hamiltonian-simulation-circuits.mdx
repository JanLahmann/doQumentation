...
שלב זה מתמקד אך ורק בביצוע הטרנספילציה ורישום מדדי המעגל המתקבלים, כולל עומק, מספר שערים וזמן ריצת הטרנספילציה. על ידי ניתוח תוצאות אלה, אנו שואפים לקבוע את היעילות של כל שיטת טרנספילציה עבור סוג זה של מעגל.
טרנספל ולכוד מדדים:
