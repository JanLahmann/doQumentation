...
לאחר מכן, אנחנו בונים את המעגל עבור כל פס של 16 קיוביטים. השגרה עושה את הדברים הבאים עבור כל שרשרת:
...
כעת אנחנו יכולים להריץ את הניסוי על המכשיר הקוונטי. אנחנו משתמשים ב-Qiskit Runtime ובפרימיטיב Sampler שלו כדי לבצע את אצוות המעגלים ביעילות.
