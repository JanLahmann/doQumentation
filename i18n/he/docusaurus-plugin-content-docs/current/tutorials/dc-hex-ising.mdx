...
לאחר שהעבודות הושלמו, אנחנו יכולים לשלוף את משך המעגל ממטא-נתוני תוצאות העבודה ולהציג את מידע לוח הזמנים של המעגל. לקריאה נוספת על הצגת מידע התזמון של מעגל, ראו ב-[דף זה](/guides/visualize-circuit-timing#qiskit-runtime-support).
