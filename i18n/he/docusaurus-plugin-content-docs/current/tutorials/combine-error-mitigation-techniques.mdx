---
description: 'שילוב אפשרויות הפחתת שגיאות עבור ניסויים בקנה מידה שירותי באמצעות מעבדי קוונטים IBM Quantum בעלי 100+ קיוביטים וה-Estimator primitive של IBM Quantum.'
...
אנו מציעים שמשתמשים יכירו את הנושאים הבאים לפני שיעברו על מדריך זה:
...
לאחר שיעברו על מדריך זה, משתמשים אמורים להבין:
...
מדריך זה חוקר את אפשרויות דיכוי השגיאות והפחתת השגיאות הזמינות עם ה-Estimator primitive של IBM Quantum. מדריך זה מראה כיצד ליישם כל אחת מהשיטות הבאות בנפרד:
...
כאן תגישו חמש משימות נפרדות, החל מללא דיכוי או הפחתת שגיאות, ובאופן עוקב תפעילו אפשרויות דיכוי והפחתת שגיאות שונות הזמינות ב-IBM Quantum Compute Service. למידע על האפשרויות, ראו בעמודים הבאים:
...
מכיוון שמשימות אלה יכולות לרוץ באופן עצמאי זו מזו, תוכלו להשתמש ב-[batch mode](/guides/run-jobs-batch) כדי לאפשר ל-Quantum Compute לבצע אופטימיזציה של תזמון הביצוע שלהן.
