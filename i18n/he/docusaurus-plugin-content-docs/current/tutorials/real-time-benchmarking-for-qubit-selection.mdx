...
$T_1$ הוא הזמן האופייני שלוקח ל-qubit מעורר ליפול למצב הקרקע עקב תהליכי דה-קוהרנטיות של דעיכת אמפליטודה. ב[ניסוי $T_1$](https://qiskit-community.github.io/qiskit-experiments/manuals/characterization/t1.html), אנחנו מודדים qubit מעורר לאחר השהיה. ככל שזמן ההשהיה גדול יותר, כך
...
בסעיף זה, נחקור את החשיבות של קבלת מידע מעודכן על מאפייני qubit של המעבד הקוונטי לתוצאות אופטימליות. ראשית, נבצע חבילה מלאה של ניסויי אפיון מעבד קוונטי ($T_1$, $T_2$, SPAM, RB חד-qubit ו-RB דו-qubit), שנוכל להשתמש בהם לאחר מכן לעדכון מאפייני ה-backend. זה מאפשר למנהל ה-pass לבחור qubit לביצוע על בסיס מידע טרי על המעבד הקוונטי, ואולי לשפר את ביצועי הביצוע. שנית, אנחנו מבצעים את מעגל זוג ה-Bell ואנו משווים את הנאמנות שהושגה לאחר בחירת ה-qubit עם מאפייני מעבד קוונטי מעודכנים לנאמנות שהשגנו קודם לכן כאשר אנחנו משתמשים במאפיינים המדווחים ברירת המחדל לבחירת qubit.
...
לא בכל ריצה יופיע שיפור בביצועים בשל האפיון בזמן אמת - וככל שאורך השרשרת גדל, ולכן יש פחות חופש לבחירת קיוביטים פיזיים, החשיבות של מידע עדכני על המכשיר פוחתת. עם זאת, מומלץ לאסוף נתונים עדכניים על תכונות המכשיר כדי להבין את ביצועיו. לעיתים, מערכות דו-רמתיות חולפות עשויות להשפיע על ביצועי כמה מהקיוביטים. נתונים בזמן אמת יכולים ליידע אותנו מתי אירועים כאלה מתרחשים ולעזור לנו למנוע כשלים ניסיוניים במקרים כאלה.
<Admonition type="note" title="קריאה לפעולה">
נסו ליישם שיטה זו על ההרצות שלכם ובדקו כמה תועלת אתם מקבלים! אתם יכולים גם לנסות ולראות כמה שיפורים אתם מקבלים מ-backends שונים.
</Admonition>

## סקר מדריך {#tutorial-survey}

קחו את הסקר הקצר הזה כדי לספק משוב על מדריך זה. התובנות שלכם יעזרו לנו לשפר את הצעות התוכן וחוויית המשתמש שלנו.

> **הערה:** סקר זה מגיע מ-**IBM Quantum** ומכסה את **תוכן המדריך** (שנכתב על ידי IBM). doQumentation מספקת את האתר, התרגומים, והרצת הקוד — למשוב על אלה, נא [לפתוח issue ב-GitHub](https://github.com/JanLahmann/doQumentation/issues).
