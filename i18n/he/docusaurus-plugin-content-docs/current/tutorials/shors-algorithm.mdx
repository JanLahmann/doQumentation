...
שימו לב שמאוחר יותר במדריך זה, נריץ את המעגל הזה על ה-backend `ibm_marrakish`. כדי לעשות זאת, אנחנו מתרגמים את המעגל בהתאם ל-backend ספציפי זה ומדווחים על עומק המעגל ומספר השערים.
