...
מדריך זה מדגים כיצד לבנות `תבנית Qiskit` לחיתוך שערים במעגל קוונטי להפחתת עומק המעגל. לדיון מעמיק יותר על חיתוך מעגלים, כנסו ל[תיעוד התוסף Qiskit לחיתוך מעגלים](https://qiskit.github.io/qiskit-addon-cutting/).
## דרישות {#requirements}
