...
למידע נוסף על QEC, ראה ב-[Quantum Error Correction for Beginners.](https://arxiv.org/abs/0905.2794)
...
מלא סקר קצר זה כדי לספק משוב על מדריך זה. התובנות שלך יעזרו לנו לשפר את תוכן ההצעות שלנו וחוויית המשתמש.

> **הערה:** הסקר הזה הוא מאת **IBM Quantum** ומתייחס ל**תוכן המדריך** (שנכתב על ידי IBM). doQumentation מספקת את האתר, התרגומים והרצת הקוד — למשוב על אלה, פתח [פניה ב-GitHub](https://github.com/JanLahmann/doQumentation/issues).
