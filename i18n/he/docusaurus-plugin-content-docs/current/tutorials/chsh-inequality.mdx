...
אם ברצונך ללמוד עוד תיאוריה, ראה ב-[Entanglement in Action](/learning/courses/basics-of-quantum-information/entanglement-in-action/chsh-game) עם John Watrous.
...
כעת נדרשות צפיות לחישוב ערכי הציפייה. במקרה שלנו אנחנו מסתכלים על בסיסים אורתוגונליים לכל קיוביט, ומאפשרים לסיבוב ה-$Y$ הפרמטרי של הקיוביט הראשון לסרוק את בסיס המדידה כמעט ברציפות ביחס לבסיס הקיוביט השני. לכן נבחר את הצפיות $ZZ$, $ZX$, $XZ$, ו-$XX$.
...
מלא סקר קצר זה כדי לספק משוב על מדריך זה. התובנות שלך יסייעו לנו לשפר את תכני הלמידה וחוויית המשתמש.
