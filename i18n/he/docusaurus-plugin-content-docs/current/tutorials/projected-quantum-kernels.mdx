...
מדריך זה מניח גם היכרות כללית עם שיטות QML. לחקירה נוספת של QML, ראו בקורס [Quantum machine learning](/learning/courses/quantum-machine-learning) ב-IBM Quantum Learning.
### דרישות {#requirements}
