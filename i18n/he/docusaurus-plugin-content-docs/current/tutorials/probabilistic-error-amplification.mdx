...
- את התיאוריה מאחורי *אקסטרפולציה לאפס רעש* (ZNE), השיטות השונות להגברת רעש, ומדוע *הגברת שגיאות הסתברותית* (PEA) עדיפה לניסויים בקנה מידה של שירות.
...
- את [שיעור Utility-I](/learning/courses/utility-scale-quantum-computing/utility-i) של קורס *Utility-scale quantum computing* לרקע נוסף על הניסוי בקנה מידה של שירות המשמש כדוגמה במדריך זה.
## רקע {#background}
...
## הגדרה {#setup}
בתא הבא, מייבאים חבילות רלוונטיות ויוצרים מספר פונקציות עזר לבניית ה-Circuits עבור התפתחות הזמן ב-Trotter של מודל איזינג הרוחבי דו-ממדי, בהתאמה לטופולוגיית ה-Backend.
...
- שיעורים נוספים המכסים ניסויים בקנה מידה של שירות: [Utility II](/learning/courses/utility-scale-quantum-computing/utility-ii) ו-[Utility III](/learning/courses/utility-scale-quantum-computing/utility-iii).
</Admonition>
