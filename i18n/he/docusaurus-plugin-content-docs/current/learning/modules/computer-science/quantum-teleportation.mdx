...
- שלב 3: הרצת המשימה שלך על מחשבים קוונטיים של IBM באמצעות IBM Quantum primitives
...
### שלב 1: מיפוי הבעיה שלך ל-Circuit קוונטי {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
2. האם יש משהו ייחודי במצב השזור ההתחלתי בין אליס לבוב: $\frac{1}{\sqrt{2}}\left(|0\rangle_B|0\rangle_A+|1\rangle_B|1\rangle_A\right)?$ אם כן, מה ייחודי בו? אם לא, באילו מצבים שזורים אחרים יכולנו להשתמש?
