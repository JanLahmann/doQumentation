...
יהיה נהדר להבחין בין אפשרויות איינשטיין ובורן באופן ניסיוני. אילו ניסויים היו מניבים את אותן תוצאות ללא קשר לאיזו אפשרות נכונה? האם אתם יכולים לחשוב על ניסוי שהיה מניב תוצאות שונות עבור שתי האפשרויות?
...
### בדקו את ההבנה שלכם {#check-your-understanding-4}
...
$$
ככל הנראה יכללו Hadamard Gate כדי לקבל את הסופרפוזיציה, ו-CNOT Gate כדי ליצור את השזירה.
...
### בדקו את ההבנה שלכם {#check-your-understanding-6}
...
4. האם ניתן היה לחקור את אי-השוויון של בל רק עם 3 צירים מרווחים באופן שווה $a$, $b$, ו-$c$? האם ניתן לעשות זאת עם מספר צירים אחר? איך זה היה נראה? האם זה עדיין היה מניב הבדל בהסתברויות שנחזה על ידי משתנים חבויים לעומת מכניקה קוונטית הסתברותית?
