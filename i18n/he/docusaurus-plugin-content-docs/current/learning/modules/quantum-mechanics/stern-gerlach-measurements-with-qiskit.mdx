...
Stern ו-Gerlach לא ידעו על גורם $g$, אבל אפילו עם הנוכחותו בביטוי, יש לנו כוח השווה לכמה קבועים ידועים או ניתנים למדידה כפול תנע זווית. כך, באמצעות שדה מגנטי עם גרדיאנט ידוע, ומדידת סטיית חלקיק בעת מעברו דרך השדה, אנחנו אמורים לקבל מידע על תנע הזווית. זוהי עיקרה של ניסוי Stern-Gerlach.
...
כדי להריץ את הניסוי שלנו על מחשב קוונטי אמיתי, עלינו לטעון את IBM Quantum Compute Service, ולבחור מחשב קוונטי (או "Backend"). למטה, אנחנו פשוט בוחרים את המחשב הקוונטי הפנוי ביותר הזמין לנו.
...
### בדקו את ההבנה שלכם {#check-your-understanding-3}

נניח שאתם מתחילים עם חלקיק במצב ספין

$$
|\psi\rangle = \begin{pmatrix}\sqrt{3/5} \\ \sqrt{2/5}\end{pmatrix}.
$$

(א) מה מתקבל אם פועלים עם האופרטור $S_z$ על וקטור המצב הזה? (ב) מה מתקבל אם מבצעים מדידה בודדת של רכיב ה-$z$ של הספין של החלקיק הזה? (ג) מה מתקבל אם מכינים חלקיקים רבים זהים למצב הזה ומבצעים אלפי מדידות של רכיב ה-$z$ של הספין?
