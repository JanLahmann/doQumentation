...
זהו הטבע המדהים של מודל המשחקים הלא-מקומיים.
...
בדיאגרמה זו אנחנו רואים שני שערים מבוקרים רגילים, אחד עבור $U_{-\pi/8}$ למעלה ואחד עבור $U_{\pi/4}$ למטה.
...
### ניתוח מקרה-אחר-מקרה {#case-by-case-analysis}
 ...
 - Case 2:  $(x,y) = (0,1)$.
  ...
  $$
   ...
   שוב, ניתן לקבל את ההסתברויות ש-$a=b$ ו-$a\neq b$ על ידי סיכום.
...
בעקבות אותו סוג הניתוח שעברנו לעיל, אך עם $\alpha$ ו-$\beta$ כמשתנים, אנחנו מוצאים את הדברים הבאים:
...
בפרט, כאשר $(x,y) = (0,0)$, אליס ובוב בוחרים $\alpha = 0$ ו-$\beta = \pi/8$, ועל ידי הכלת הבסיסים שלהם אנחנו מקבלים את האיור הזה:
...
כאשר $(x,y) = (0,1)$, אליס ובוב בוחרים $\alpha = 0$ ו-$\beta = -\pi/8$, ועל ידי הכלת הבסיסים שלהם אנחנו מקבלים את האיור הזה:
...
כאשר $(x,y) = (1,0)$, אליס ובוב בוחרים $\alpha = \pi/4$ ו-$\beta = \pi/8$, ועל ידי הכלת הבסיסים שלהם אנחנו מקבלים את האיור הזה:
...
כאשר $(x,y) = (1,1)$, אליס ובוב בוחרים $\alpha = \pi/4$ ו-$\beta = -\pi/8$. כאשר אנחנו מכלילים את הבסיסים שלהם, אנחנו רואים שקרה משהו שונה:
...
פרס נובל לפיזיקה לשנת 2022 מכיר בחשיבות קו עבודה זה: הפרס הוענק לאלן אספה, לג'ון קלאוזר (ה-C ב-CHSH) ולאנטון זיילינגר על תצפית בשזירה באמצעות מבחני בל על פוטונים משוזרים.
