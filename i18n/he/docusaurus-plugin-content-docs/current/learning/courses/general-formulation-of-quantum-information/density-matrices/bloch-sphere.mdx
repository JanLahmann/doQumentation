...
במילים, אם נחשוב על כדור ככדור הארץ, זווית הקוטב $\theta$ היא כמה נסובב דרומה מהקוטב הצפוני כדי להגיע לנקודה המתוארת, מ-$0$ עד $\pi = 180^{\circ},$ בעוד שהזווית האזימוטלית $\phi$ היא כמה נסובב מזרחה ממרידיאן היסוד, מ-$0$ עד $2\pi = 360^{\circ}.$
