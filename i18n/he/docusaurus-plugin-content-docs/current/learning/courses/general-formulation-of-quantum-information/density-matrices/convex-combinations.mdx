...
אנחנו רואים גם שניתן, יתרה מכך, לבחור את המצבים הטהורים להיות *אורתוגונליים*.
פירוש הדבר, בפרט, שאין אנחנו זקוקים למספר $n$ גדול יותר מגודל קבוצת המצבים הקלאסיים של $\mathsf{X}.$
