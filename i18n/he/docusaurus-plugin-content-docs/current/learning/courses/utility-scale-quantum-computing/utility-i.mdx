...
באופן קונקרטי, אתה מתבקש לבנות ולהריץ את המעגל המתאים לאיור 4b של המאמר, ולשרטט את הנקודות "הלא-מוקזזות" בעצמך. כפי שאתה רואה, מדובר במעגל של 127 Qubit $\times$ 60 שכבות (20 צעדי טרוטר) עם $\langle Z_{62} \rangle$ כאובזרבל.
![image.png](/learning/images/courses/utility-scale-quantum-computing/utility-i/utility1.avif)
נשמע מאתגר? &nbsp; אל דאגה. שלושת השיעורים האחרונים של קורס זה מספקים אבני דרך. להתחלה, נדגים ניסוי בסדר גודל קטן יותר — בניה והרצה על מכשיר מדומה של מעגל 27 Qubit $\times$ 6 שכבות (2 צעדי טרוטר) עם $\langle Z_{13} \rangle$ כאובזרבל.
