...
#### פתרון התרגיל: $\theta = 1/3$ {#solution-of-the-exercise-theta-13}
...
## 4. הרצה באמצעות ה-Sampler primitive של IBM Quantum {#4-execution-using-the-ibm-quantum-sampler-primitive}
