...
מהתיאור לעיל, אולי לא ברור כיצד לבנות Circuit של QFT. לעת עתה, פשוט שים לב שאנחנו מצפים לשלושה qubits שיהיו להם פאזות המתפתחות בקצבים "שונים". ההבנה של כיצד זה מתורגם ל-Circuit נשארת כתרגיל לקורא. ישנם מספר דיאגרמות ודוגמאות ב-PDF של ההרצאה. משאבים נוספים כוללים [שיעור זה](/learning/courses/fundamentals-of-quantum-algorithms/phase-estimation-and-factoring/introduction) מקורס יסודות האלגוריתמים הקוונטיים.
