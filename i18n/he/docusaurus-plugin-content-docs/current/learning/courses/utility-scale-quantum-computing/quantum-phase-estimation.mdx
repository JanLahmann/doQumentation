...
בבסיס החישוב, אנחנו מאחסנים מספרים בבינארי באמצעות המצבים $|0\rangle$ ו-$|1\rangle$.
...
(לעיתים קרובות אנחנו מסמנים מצבים בבסיס פורייה באמצעות טילדה (~)).

בבסיס פורייה, אנחנו מאחסנים מספרים באמצעות סיבובים שונים סביב ציר ה-Z:
