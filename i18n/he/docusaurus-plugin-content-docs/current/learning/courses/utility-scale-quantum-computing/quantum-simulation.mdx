...
היום נלמד את האבולוציה בזמן של [מודל איזינג](https://en.wikipedia.org/wiki/Ising_model) על סריגים לינאריים עם $N=2$ ו-$N=6$ אתרים. סריגים אלו מורכבים ממערך של ספינים $\sigma_i$ המקיימים אינטראקציה רק עם שכניהם הקרובים ביותר. לספינים אלו יכולות להיות שתי אוריינטציות: $\uparrow$ ו-$\downarrow$, המתאימות למגנטיזציה של $+1$ ו-$-1$ בהתאמה.
...
לאחר מכן נבצע Transpile לל-Circuit עבור ה-Backend שנבחר.
