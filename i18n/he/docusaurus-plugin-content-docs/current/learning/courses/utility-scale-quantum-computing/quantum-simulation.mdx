...
## 3. תרגיל 1. ביצוע סימולציה באמצעות Suzuki–Trotter מסדר שני {#3-exercise-1-perform-simulation-using-second-order-suzuki-trotter}
...
### 3.3 הצגת תוצאות Suzuki–Trotter מסדר שני {#33-plot-the-second-order-suzuki-trotter-results}
...
## 4. הרצה על חומרת הקוואנטום {#executing-on-the-quantum-hardware}
...
### 4.1  שלב 1. מיפוי קלטים קלאסיים לבעיה קוואנטית {#step-1-map-classical-inputs-to-a-quantum-problem}
...
### 4.2 שלב 2. אופטימיזציה לחומרת היעד {#step-2-optimize-for-target-hardware}
ציין Backend.
...
### 4.3 שלב 3. הרצה עם פרימיטיביות Qiskit Runtime {#step-3-execute-with-qiskit-runtime-primitives}
...
### 4.4 שלב 4. עיבוד תוצאות לאחר מדידה {#step-4-post-process-results}
