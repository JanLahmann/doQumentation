...
### שלב 2: אופטימיזציה לחומרת המטרה {#step-2-optimize-for-target-hardware-1}
...
### שלב 3: הרצת ה-Circuit. {#step-3-executing-the-circuit-1}
...
### שלב 4: עיבוד התוצאות. {#step-4-post-processing-the-results-1}
