...
## 3. אסטרטגיה 2. עץ מאוזן של qubits {#3-strategy-2-balanced-tree-of-qubits}
...
### 3.2 בחירת צומת שורש שונה ידנית {#32-select-a-different-root-node-manually}
...
ניתן להגדיר את אפשרויות דיכוי השגיאות ב-Sampler V2. ראה במדריך [ניהול רעש ב-Sampler](/guides/sampler-noise-management) ובתיעוד ה-API של [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) למידע נוסף.
