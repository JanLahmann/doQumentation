...
ניתן להגדיר את אפשרויות דיכוי השגיאות ב-Sampler V2. ראה במדריך [הגדרת מיתון שגיאות](/guides/configure-error-mitigation#advanced-error) ובתיעוד ה-API של [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) למידע נוסף.
...
כל הכבוד על סיום הקורס! הקדש רגע לעזור לנו לשפר את הקורס שלנו על ידי מילוי [הסקר הקצר](https://your.feedback.ibm.com/jfe/form/SV_5vvmdT5yFFetkgK) הבא. המשוב שלך ישמש לשיפור תוכן הקורסים שלנו וחוויית המשתמש. תודה!
