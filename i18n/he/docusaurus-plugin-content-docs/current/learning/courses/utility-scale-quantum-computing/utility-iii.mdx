...
זוהי התוצאה של Circuit ה-GHZ בן 6 ה-Qubit. כפי שניתן לראות, המצבים של כל $|0\rangle$ וכל $|1\rangle$ אכן שולטים, אך השגיאות משמעותיות. בואו ננסה לראות עד כמה גדול Circuit GHZ ניתן לבנות עם מכשיר Eagle, תוך שמירה על תוצאות שבהן המצבים הנכונים הם לפחות יותר מ-50% סבירים.
...
זהו תרגיל עצמאי שבו תנצל את מה שלמדת עד כה בקורס זה.
...
בנה Circuit GHZ עבור 20 Qubits או יותר כך שתוצאת המדידה תעמוד בקריטריונים: הנאמנות של מצב ה-GHZ שלך > 0.5.
