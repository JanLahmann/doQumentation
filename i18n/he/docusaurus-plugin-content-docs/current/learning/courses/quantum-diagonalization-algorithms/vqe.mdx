...
![תמונה של אורביטלים אטומיים ותמונה של רשת של צמתים ועיתים רבות ביניהם.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig1.svg)
...
![תמונה של Circuit קוונטי עם פרמטרים ווריאציוניים שמסומנים "theta".](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig2.svg)
...
![תמונה המציגה קו מעוקל המייצג אנרגיה עם מספר נקודות בהן הערך נבדק כדי למצוא את המינימום.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig3.svg)
...
![טבלה של מחרוזות פאולי שונות, חלקן מתחלפות וחלקן לא.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig4.svg)
...
![שתי תמונות של קו מעוקל עם ערך מינימלי. באחת, נקודות נבדקות באקראיות בחיפוש אחר מינימום, בשנייה גרדיאנט מוערך על ידי ציור קו בין שתי נקודות סמוכות.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig5.svg)
...
![טבלה המשווה גישות ווריאציוניות קלאסיות וקוונטיות. שתיהן דורשות ניחושים התחלתיים טובים. קלאסית, העלות מתרחבת כמו ממד המטריצה בריבוע, ובגישה הקוונטית היא תלויה בכמה קבוצות של אופרטורי פאולי מתחלפים יש לך.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig6.svg)
