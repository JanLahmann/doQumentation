...
![וקטור עצמי אמיתי המסומן x, ניחוש המסומן x 0 וייצוג גרפי של השגיאה בין השניים.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig2.svg)
...
![וקטור עצמי אמיתי ועדכון לניחוש הראשוני. הניחוש המעודכן קרוב יותר לוקטור העצמי האמיתי.](/learning/images/courses/quantum-diagonalization-algorithms/krylov/kqd-fig3.svg)
