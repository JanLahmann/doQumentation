...
* החוסן המובנה של Estimator: כמו אופטימיזציה, ל-Estimator יש הגדרות מובנות לחוסן מול שגיאות, התואמות לגישות שונות למיתון שגיאות. כדי ללמוד על הגדרות רמת החוסן, ראה ב[תיעוד](/guides/configure-error-mitigation).
