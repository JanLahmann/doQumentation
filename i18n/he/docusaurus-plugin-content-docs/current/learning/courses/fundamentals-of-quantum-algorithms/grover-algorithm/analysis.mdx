...
משמעות הדבר היא שאם היינו מחליפים את הפונקציה $f$ בפונקציה $g,$ אלגוריתם גרובר לא היה פועל באופן שונה — כי המצבים שמתקבלים מהאלגוריתם בשני המקרים שקולים בהכרח עד כדי מופע גלובלי (פאזה גלובלית).
...
## פעולת אופרטור גרובר {#action-of-the-grover-operation}
