...
לצורך יצירת מטריצת ליבה, אנחנו מתעניינים בעיקר בהסתברות למדוד את המצב $|0\rangle^{\otimes N}$, שבו כל $N$ ה-Qubits נמצאים במצב $|0\rangle$. כדי לראות מדוע, נשים לב שה-Circuit האחראי לקידוד ומיפוי של וקטור נתונים אחד $\vec{x}_i$ ניתן לכתיבה כ-$\Phi(\vec{x}_i)$, וזה האחראי לקידוד ומיפוי של $\vec{x}_j$ הוא $\Phi(\vec{x}_j)$, ונסמן את המצבים הממופים
$$
...
התהליך הזה עבור איבר בודד במטריצת הגרעין ניתן לחזור עליו עבור זוגות נתונים אחרים במערך כדי לקבל את מטריצת הגרעין המלאה. מימד מטריצת הגרעין נקבע לפי מספר הנקודות בנתוני האימון שלך, לא לפי מספר התכונות. לכן עלות החישוב של עיבוד מטריצת הגרעין לדגם חיזוי אינה גדלה עם מספר התכונות או ה-Qubit-ים. אפילו עבור מערכי נתונים קטנים יחסית עם מספר גדול של תכונות, הנתונים עדיין צריכים להיות ממופים למפת תכונות שמניבה סיווג אפקטיבי.
