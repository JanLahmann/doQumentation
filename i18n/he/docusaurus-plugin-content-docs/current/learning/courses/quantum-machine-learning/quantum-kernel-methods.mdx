...
נתחיל בשקלול מערך נתונים עם מעט מאפיינים, נניח 10. מערך הנתונים יכול להיות גדול כרצונכם, מאחר שאנו מחשבים את איברי מטריצת הליבה אחד בכל פעם. אנחנו זקוקים לפחות לשתי נקודות, אז נתחיל בכך (בדוגמה הבאה נייבא מערך נתונים מלא). בואו נייבא כמה חבילות נחוצות:
