...
*Nutzungsschätzung: Nün Sekunde uf emm Heron r2 Prozessor (HINWEIS: Des isch nur e Schätzung. Ihri Laufzeit ka variiere.)*
...
Beachde Se, dass dr Hamiltonian e spezifische Instanz vum generische Wechselwirkungs-Elektronen-Hamiltonian isch,
...
Stell Se vor Beginn vun dem Tutorial sicher, dass Se Folgendes installiert hän:
...
Für e detailliertere Beschreibung vun dem Modell und wie d Schaltkreise entworfe worde sind, luage Se ["Quantum-Centric Algorithm for Sample-Based Krylov Diagonalization"](https://arxiv.org/abs/2501.09702).
...
Nachdem mir d Schaltkreise erstellt hän, köne mir sie für e Ziel-Hardware optimiere. Mir wähle d am wenigste ausgelastete QPU mit mindestens 127 Qubits. Weitere Informationen finde Se in dr [Qiskit IBM&reg; Runtime-Dokumentation](/guides/get-started-with-primitives#get-started-with-sampler).
