...
### Fluxo de trabalho para sombreamento de cone de luz, aprendizado de ruído e injeção de antirruído {#workflow-for-lightcone-shading-noise-learning-and-anti-noise-injection-1}
...
#### Visualizar o SLC para inspeção manual {#visualize-the-slc-for-manual-inspection-1}
...
#### Visualizar o SLC para inspeção manual {#visualize-the-slc-for-manual-inspection-2}
...
### Visualizar o SLC para inspeção manual {#visualize-the-slc-for-manual-inspection-3}
