...
![Diagrama do circuito quântico](./_02_fermionic_lattice_hamiltonian_imgs/output_1.png)

```python
circuits[-1].draw("mpl", scale=0.4, fold=-1)
```

![Diagrama do circuito quântico](./_02_fermionic_lattice_hamiltonian_imgs/output_2.png)
...
![Diagrama do circuito quântico](./_02_fermionic_lattice_hamiltonian_imgs/output_3.png)
...
![Saída do gráfico](./_02_fermionic_lattice_hamiltonian_imgs/output_4.png)
