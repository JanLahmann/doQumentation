---
title: "Aprimorando a estimativa de energia de um modelo de rede fermiônico com SQD"
sidebar_label: "Aprimorando a estimativa de energia de um modelo de rede fermiônico com SQD"
...
![Diagrama do circuito quântico](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_1.png)

```python
circuits[-1].draw("mpl", scale=0.4, fold=-1)
```

![Diagrama do circuito quântico](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_2.png)
...
***Nota: O [Qiskit Aer](https://qiskit.github.io/qiskit-aer/index.html) é necessário para simular amostras a partir de circuitos transpilados.***
...
![Diagrama do circuito quântico](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_3.png)

### Etapa 4: Pós-processar os resultados {#step-4-post-process-the-results}
...
![Saída do gráfico](/img/qiskit-addons/sqd/02-fermionic-lattice-hamiltonian/output_4.png)
