...
# O variational quantum eigensolver (VQE) {#the-variational-quantum-eigensolver-vqe}
...
![Uma imagem de orbitais atômicos e uma imagem de uma rede com muitos nós e conexões entre eles.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig1.svg)
...
![Uma imagem de um circuito quântico com parâmetros variacionais rotulados como "theta".](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig2.svg)
...
![Uma imagem mostrando uma linha curva representando a energia com vários pontos nos quais o valor está sendo testado para encontrar o mínimo.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig3.svg)
...
![Uma tabela de diferentes strings de Pauli, algumas das quais comutam e outras não.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig4.svg)
...
![Duas imagens de uma linha curva com um valor mínimo. Em uma, pontos são verificados aleatoriamente na busca pelo mínimo; na outra, um gradiente é estimado traçando uma linha entre dois pontos adjacentes.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig5.svg)
