...
![Um diagrama dos componentes quântico e clássico do SQD. No lado quântico, você prepara e amostra a partir do suporte alvo; no lado clássico, você projeta sua matriz no subespaço amostrado e diagonaliza a matriz projetada.](/learning/images/courses/quantum-diagonalization-algorithms/sqd1/sqd1-fig1.svg)
...
![Diagramas de suportes de ansatz bom e ruim. Um bom ansatz tem suporte que contém completamente o suporte do estado fundamental. Um ansatz ruim contém apenas parte ou nenhum do suporte do estado fundamental.](/learning/images/courses/quantum-diagonalization-algorithms/sqd1/sqd1-fig3.svg)
