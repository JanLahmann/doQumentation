...
## 3. O papel do quantum no SQD {#3-role-of-quantum-in-sqd}
...
### 3.1 Notas sobre o suporte do estado fundamental {#31-notes-on-ground-state-support}
...
### 3.2 Um argumento contra a amostragem uniforme {#32-a-case-against-uniform-sampling}
...
## 4. SQD e a esparsidade da função de onda {#4-sqd-and-sparsity-of-the-wave-function}
