...
# Diagonalização Quântica de Krylov Baseada em Amostras (SKQD) {#sample-based-krylov-quantum-diagonalization-skqd}
...
<Accordion>
<AccordionItem title="O que poderia ser feito para melhorar a convergência no gráfico acima?">
...
<AccordionItem title="Quais são as principais vantagens do SKQD sobre (a) SQD e (b) KQD?">

__Answer:__

Quais são as principais vantagens do SKQD em relação a (a) SQD e (b) KQD?

   (a) O SKQD vem com garantias de convergência que o SQD não tem. No SQD, você precisa fazer uma suposição muito boa para seu ansatz que tenha excelente sobreposição com o suporte do estado fundamental na base computacional, ou precisa introduzir um componente variacional no cálculo para amostrar uma família de ansaetze.
