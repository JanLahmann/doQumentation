...
$$
Aqui $P_\alpha$ é uma string de Pauli da forma $P_\alpha \sim IZIXII...YZXIX$ ou um conjunto de tais strings de Pauli que comutam entre si. Dado que podemos escrever $H$ como tal soma de operadores mensuráveis, as seguintes expressões para os elementos de matriz de $\tilde{H}$ podem ser realizadas usando o primitivo Estimator do Qiskit Runtime.
