...
# Introdução ao Aprendizado de Máquina Quântico {#introduction-to-quantum-machine-learning}
...
Falso. A maioria dos problemas de aprendizado de máquina é resolvida de forma muito eficiente por algoritmos clássicos, e os algoritmos quânticos provavelmente não oferecerão nenhuma aceleração substancial. O objetivo em QML é encontrar conjuntos de dados com recursos bem descritos por estados quânticos e/ou encontrar mapeamentos de recursos de dados que otimizem a precisão dos modelos.
...
5. Implementar métodos de kernel quântico e classificadores quânticos variacionais usando primitivas do IBM Quantum e seguindo os padrões Qiskit.
...
No processo acima, calculamos uma entrada da matriz de kernel para o 14º e o 19º pontos de dados. Que valor devemos obter se usarmos o mesmo ponto de dados duas vezes, aqui (como o 14º e o 14º novamente)? Em outras palavras, o que devem ser as entradas diagonais na matriz de kernel? Responda a essa pergunta na ausência de ruído, mas observe que desvios da sua resposta são possíveis na presença de ruído.

<Accordion>
<AccordionItem title="Resposta">

As diagonais devem ser 1.0. Esse processo deve calcular o produto interno normalizado de um vetor consigo mesmo, que deve sempre ser um.
