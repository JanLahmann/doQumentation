...
# Circuitos Quânticos Variacionais e Redes Neurais Quânticas {#quantum-variational-circuits-and-quantum-neural-networks}
...
Aqui otimizamos o circuito para execução em um backend real, especificando o optimization_level e adicionando desacoplamento dinâmico. O código abaixo gera um gerenciador de passes usando gerenciadores de passes predefinidos de qiskit.transpiler.
...
## Qiskit Patterns Passo 3: Executar usando primitivas do IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
## Qiskit Patterns Etapa 2: Otimizar o problema para execução quântica {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution-1}
Começamos selecionando um backend para a execução. Neste caso, vamos usar o backend menos ocupado.
...
## Qiskit Patterns Passo 3: Executar usando primitivas do IBM Quantum {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
