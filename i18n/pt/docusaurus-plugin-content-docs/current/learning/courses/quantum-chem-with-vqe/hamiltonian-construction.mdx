...
__symmetry__ - o grupo de simetria pontual da molécula, especificado com uma string ou detectado automaticamente ao definir "symmetry = True". Aqui, "Dooh" é o grupo de simetria apropriado para moléculas diatômicas com dois átomos da mesma espécie.
...
__rhf__ como em __mf__ = scf.RHF(mol) em mf é um solver que usa o cálculo Restricted Hartree Fock. O kernel disso (E, abaixo) é a energia total, incluindo repulsão nuclear e orbitais moleculares.
