...
O potencial da computação quântica para ajudar na descoberta de novos materiais projetados para melhorar a geração, transferência e armazenamento de energia é uma das razões pelas quais a bp está se aliando à IBM Quantum para alcançar suas metas de zero líquido.
