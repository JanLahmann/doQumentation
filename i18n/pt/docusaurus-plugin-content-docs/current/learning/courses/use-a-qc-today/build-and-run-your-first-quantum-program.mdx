...
Para executar em um computador quântico real da IBM, você também precisará de uma (gratuita) [**conta na IBM Quantum&reg; Platform**](https://quantum.cloud.ibm.com/signin?redirectTo=%2F). Você pode abrir uma instância usando o Open Plan para obter 10 minutos de tempo de unidade de processamento quântico (QPU) por janela móvel de 28 dias, o que na verdade é bastante! *Se tiver problemas com sua conta, consulte a [página de suporte](/guides/support).*
...
Abra o Composer [aqui](https://quantum.cloud.ibm.com/composer).
