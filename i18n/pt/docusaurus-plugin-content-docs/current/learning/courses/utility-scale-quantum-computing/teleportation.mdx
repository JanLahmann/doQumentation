...
sidebar_label: "Teletransporte"
description: "Ao longo desta lição, você vai aprender como mover informação quântica de um lugar para outro por meio do teletransporte quântico"
...
# Teletransporte quântico e codificação superdensa {#quantum-teleportation-and-superdense-coding}
...
Isso também é trabalhado com mais detalhes em [Fundamentos de Informação Quântica](/learning/courses/basics-of-quantum-information/entanglement-in-action/introduction). Mas a situação ficará mais clara quando implementarmos isso no Qiskit.
...
Lembre-se de que na notação little endian, o qubit 2 é o qubit mais à esquerda (ou o mais abaixo, nos rótulos de coluna). Note que o qubit mais à esquerda e mais abaixo nos rótulos de coluna é 0 para todos os resultados possíveis. Isso mostra que temos 100% de chance de medir $q_2$ no estado $|0\rangle$. Este é o resultado esperado e indica que o protocolo de teletransporte funcionou corretamente.
