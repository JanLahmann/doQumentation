...
### Estimar o valor de $r_z$ {#estimate-r-z-value}
...
### Exercício 1: Estimar o valor de $r_x$ {#exercise-1-estimate-r-x-value}
...
### Exercício 2: Estimar o valor de $r_y$ {#exercise-2-estimate-r-y-value}
