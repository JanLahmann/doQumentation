...
## 3. Exercício 1: Realizar simulação usando Suzuki–Trotter de segunda ordem {#3-exercise-1-perform-simulation-using-second-order-suzukitrotter}
...
Use product_formula_st2 (SuzukiTrotter(order=2)) e construa um circuito para um único passo de tempo usando Suzuki–Trotter de segunda ordem. Além disso, conte o número de portas e a profundidade do circuito e compare com Lie–Trotter.
...
### 3.3 Plotar os resultados do Suzuki–Trotter de segunda ordem {#33-plot-the-second-order-suzukitrotter-results}
...
## 4. Executando no hardware quântico {#4-executing-on-the-quantum-hardware}
...
### 4.1 Passo 1. Mapear entradas clássicas para um problema quântico {#41-step-1-map-classical-inputs-to-a-quantum-problem}
...
### 4.3 Passo 3. Executar com primitivas do IBM Quantum {#43-step-3-execute-with-ibm-quantum-primitives}
...
### 4.4 Passo 4. Pós-processar os resultados {#44-step-4-post-process-results}
...
Use product_formula_st4 (SuzukiTrotter(order=4)) e construa um circuito para um único passo de tempo usando Suzuki–Trotter de quarta ordem. Além disso, conte o número de portas e a profundidade do circuito e compare com Lie–Trotter e Suzuki–Trotter de segunda ordem.
