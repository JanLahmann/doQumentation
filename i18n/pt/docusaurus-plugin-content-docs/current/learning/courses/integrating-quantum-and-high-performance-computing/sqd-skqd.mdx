...
#### Etapa 1: Preparar o estado Ansatz {#step-1-prepare-the-ansatz-state}
...
#### Etapa 2: Amostrar o subespaço {#step-2-sample-the-subspace}
...
#### Etapa 3: Projetar e diagonalizar classicamente {#step-3-project-and-diagonalize-classically}
...
#### Etapa 4: Otimizar o ansatz (opcional) {#step-4-optimize-the-ansatz-optional}
...
#### Etapa 1: Construir o subespaço de Krylov com evolução temporal {#step-1-construct-the-krylov-subspace-with-time-evolution}
...
#### Etapa 2: Amostrar dos estados da base de Krylov {#step-2-sample-from-the-krylov-basis-states}
