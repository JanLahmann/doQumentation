...
Chame o conjunto de todos os estados de base computacional que compõem seu ansatz de A. Chame o conjunto de todos os estados de base computacional que compõem o verdadeiro estado fundamental do seu sistema de G. Qual das seguintes opções corresponde a um 'bom' ansatz? Selecione todas as que se aplicam:
...
#### Passo 3: Projetar e diagonalizar classicamente {#step-3-project-and-diagonalize-classically-1}
