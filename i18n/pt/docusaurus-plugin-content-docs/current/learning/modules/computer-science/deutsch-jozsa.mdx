...
Vamos começar carregando alguns pacotes necessários, incluindo os primitivos da IBM Quantum. Também selecionaremos o computador quântico menos ocupado disponível para nós.
...
## O algoritmo de Deutsch-Jozsa {#the-deutsch-jozsa-algorithm-1}
