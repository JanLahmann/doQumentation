...
Portanto, na prática, aplicar a porta Hadamard é o análogo a lançar uma moeda. E, assim como lançamos a moeda 1000 vezes para observar as estatísticas de ela cair com a cara para cima ou para baixo, podemos fazer algo similar no Qiskit com nossa "moeda quântica". Podemos usar uma primitiva chamada `Sampler`, que repetirá um circuito várias vezes para amostrar as estatísticas do estado resultante.

Primeiro, carregamos o IBM Quantum Compute Service e as primitivas, depois selecionamos um backend no qual executar o circuito.
...
#### Tente você mesmo: {#try-it-yourself}
