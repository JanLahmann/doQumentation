...
Seria ótimo distinguir entre as opções de Einstein e Born experimentalmente. Quais são alguns experimentos que produziriam os mesmos resultados independentemente de qual opção é verdadeira? Você consegue pensar em um experimento que produziria resultados diferentes para as duas opções?
...
### Verifique sua compreensão {#check-your-understanding-6}
...
4. A desigualdade de Bell poderia ser explorada apenas com 3 eixos igualmente espaçados $a$, $b$ e $c$? Poderia ser feita com qualquer outro número de eixos? Como isso seria? Ainda produziria uma diferença nas probabilidades previstas por variáveis ocultas versus mecânica quântica probabilística?
