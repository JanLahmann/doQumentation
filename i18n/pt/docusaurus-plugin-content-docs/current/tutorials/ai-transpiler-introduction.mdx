...
### Características principais dos passes de IA {#key-features-of-ai-passes}
...
### Por que usar IA para transpilação de circuitos quânticos? {#why-use-ai-for-quantum-circuit-transpilation}
...
### Breves resultados de benchmarking {#brief-benchmarking-results}
...
# Parte I. Padrões Qiskit {#part-i-qiskit-patterns}
...
### Escolher um backend {#choose-a-backend}
...
### Criar gerenciadores de passes com IA e tradicionais {#create-ai-and-traditional-pass-managers}
...
# Parte II. Analisar e fazer benchmark dos circuitos transpilados {#part-ii-analyze-and-benchmark-the-transpiled-circuits}
...
## Quando os usuários devem escolher a transpilação com IA? {#when-should-users-choose-ai-powered-transpilation}
...
# Parte III. Explore a síntese de redes de permutação com IA {#part-iii-explore-ai-powered-permutation-network-synthesis}
