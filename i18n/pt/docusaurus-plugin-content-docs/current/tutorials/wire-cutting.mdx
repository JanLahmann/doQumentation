...
#### Criar e expandir os observáveis {#create-and-expand-the-observables}
...
#### Verificar cruzadamente {#cross-verify}
...
## Parte II. Aumentando a escala! {#part-ii-scale-it-up}
...
#### Verificação cruzada {#cross-verify}
...
## Apêndice: consideração sobre escala de recursos {#appendix-resource-scaling-consideration}
...
### Um exemplo de circuito amigável a cortes e não amigável a cortes {#one-example-of-cut-friendly-and-cut-unfriendly-circuits-each}

#### Circuito amigável a cortes {#cut-friendly-circuit}
...
#### Circuito não amigável a cortes {#cut-unfriendly-circuit}
