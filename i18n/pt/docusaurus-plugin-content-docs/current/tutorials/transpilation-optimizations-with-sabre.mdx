...
# Otimizações de Transpilação com SABRE {#transpilation-optimizations-with-sabre}
...
### Por que usar o SABRE? {#why-use-sabre}
...
### O que você aprenderá {#what-youll-learn}
...
## Parte I. Usando SABRE com padrões Qiskit {#part-i-using-sabre-with-qiskit-patterns}
...
#### Por que tamanho e profundidade do circuito são importantes? {#why-are-circuit-size-and-depth-important}
...
#### Parâmetros-chave {#key-parameters}
...
#### Configurações neste tutorial {#configurations-in-this-tutorial}
...
## Parte II. Configurando a heurística no SABRE e usando Serverless {#part-ii-configuring-the-heuristic-in-sabre-and-using-serverless}
...
### Como Alterar a Heurística de Roteamento {#how-to-change-the-routing-heuristic}
...
### Resultados sem runtime serverless (1 tentativa de layout): {#results-without-serverless-runtime-1-layout-trial}
...
### Resultados com runtime serverless (múltiplas tentativas de layout) {#results-with-serverless-runtime-multiple-layout-trials}
