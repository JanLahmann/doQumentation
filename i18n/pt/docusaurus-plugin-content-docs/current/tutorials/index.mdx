...
- Comece com o conjunto de tutoriais na seção [Primeiros passos](#get-started) se for a sua primeira vez executando código em um computador quântico.

- A seção sobre [fluxos de trabalho rumo à vantagem](#explore-workflows-toward-advantage) contém exemplos completos do uso de um computador quântico para resolver problemas do mundo real. Esses tutoriais se concentram em algoritmos que são candidatos promissores para alcançar vantagem computacional de um computador quântico sobre um computador clássico.

- A seção sobre [capacidades do Qiskit](#leverage-qiskit-capabilities) contém exemplos que usam as técnicas mais recentes e avançadas do ecossistema Qiskit para melhorar parte ou a totalidade de um determinado fluxo de trabalho.
...
* [Início a quente do QAOA com o Optimization Mapper Qiskit addon](/tutorials/warm-start-qaoa)
...
* [Simule o espalhamento de nêutrons em materiais quânticos com circuitos quânticos](/tutorials/simulate-neutron-scattering)


* [Simule o espalhamento de nêutrons com um fluxo de trabalho Serverless de dinâmica AQC + Trotter](/tutorials/simulate-neutron-scattering-with-a-serverless-workflow)
...
* [Observação de dinâmica robusta e coerente de hádrons não abelianos em processadores quânticos ruidosos](/tutorials/loop-string-hadron-dynamics)
...
* [Kernels quânticos com portas fracionárias](/tutorials/fractional-gates)
...
- Projete novos algoritmos com **Funções de circuito** &mdash; com pipelines de transpilação, supressão de erros e mitigação de erros pré-construídos.
  ...
  * [Avalie a fidelidade do processo QFT+M com o Orbit, uma Qiskit Function da Quantum Elements](/tutorials/quantum-elements-orbit-qft-with-dynamic-circuits)
...
* [Cancelamento probabilístico de erro com cones de luz sombreados](/tutorials/pec-with-shaded-lightcones)

  
* [Melhore os valores esperados com absorção de ruído propagado (PNA)](/tutorials/propagated-noise-absorption)


* [Benchmarking em tempo real para seleção de qubits](/tutorials/real-time-benchmarking-for-qubit-selection)


* [Atualize as propriedades do backend com benchmarking em tempo real](/tutorials/refresh-backend-properties-with-real-time-benchmarking)
...
* [Detecção de erros de baixa sobrecarga com códigos espaço-temporais](/tutorials/spacetime-codes)
