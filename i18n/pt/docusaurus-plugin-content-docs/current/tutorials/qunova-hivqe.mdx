...
### Passo 2 e 3: Otimizar o problema para execução em hardware quântico e executar usando a função HiVQE Chemistry {#step-2-and-3-optimize-problem-for-quantum-hardware-execution-and-execute-using-the-hivqe-chemistry-function}
...
> **Nota:** Esta pesquisa é do **IBM Quantum** e abrange o **conteúdo do tutorial** (escrito pela IBM). O doQumentation fornece o site, as traduções e a execução de código — para feedback sobre esses aspectos, por favor [abra um issue no GitHub](https://github.com/JanLahmann/doQumentation/issues).
