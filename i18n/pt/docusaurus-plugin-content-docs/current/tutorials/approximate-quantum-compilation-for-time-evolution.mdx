...
Esta seção usa um sistema de 10 sítios para ilustrar o fluxo de trabalho AQC-Tensor passo a passo. Simulamos a dinâmica de uma cadeia de spins XXZ de 10 sítios, um modelo amplamente estudado para examinar interações de spin e propriedades magnéticas.
