...
Antes de executar na QPU real, verificamos que o circuito produz um par de Bell testando-o em um simulador sem ruído com uma cadeia de quatro qubits `[0, 1, 2, 3]`. Usamos o `Sampler` do Qiskit Runtime com `AerSimulator` como modo de backend para executar os circuitos.
