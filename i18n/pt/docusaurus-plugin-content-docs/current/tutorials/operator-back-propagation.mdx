...
## Parte I: Cadeia de spins de Heisenberg em pequena escala {#part-i-small-scale-heisenberg-spin-chain}
...
#### Agora que temos nosso ansatz reduzido e observáveis expandidos, podemos transpilar nossos experimentos para o backend. {#now-that-we-have-our-reduced-ansatz-and-expanded-observables-we-can-transpile-our-experiments-to-the-backend}
...
#### Calcular valor esperado {#calculate-expectation-value}
...
### Passo 4: Pós-processar e retornar resultado no formato clássico desejado {#step-4-post-process-and-return-result-to-desired-classical-format}
...
## Parte B: Ampliando a escala! {#part-b-scale-it-up}
