...
> **Nota:** Esta pesquisa é da **IBM Quantum** e cobre o **conteúdo do tutorial** (escrito pela IBM). O doQumentation fornece o site, as traduções e a execução de código — para feedback sobre esses aspectos, [abra uma issue no GitHub](https://github.com/JanLahmann/doQumentation/issues).
