...
> **Nota:** Esta pesquisa é fornecida pela **IBM Quantum** e abrange o **conteúdo do tutorial** (escrito pela IBM). O doQumentation fornece o site, as traduções e a execução de código — para feedback sobre esses aspectos, por favor [abra uma issue no GitHub](https://github.com/JanLahmann/doQumentation/issues).
