...
Antes de executar no QPU real, verificamos que tanto os circuitos dinâmicos quanto os unitários produzem um estado de Bell ideal em um simulador sem ruído. Usamos o `Sampler` da IBM Quantum com `AerSimulator` como modo de backend, a uma distância pequena de 6.
