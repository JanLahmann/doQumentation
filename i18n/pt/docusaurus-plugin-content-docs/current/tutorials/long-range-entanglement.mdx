...
### (iii) Medir pares de qubits vizinhos na base de Bell {#iii-measure-neighboring-qubit-pairs-in-the-bell-basis}
...
### (iv) Em seguida, aplicar correções de feedforward para corrigir operadores de subproduto de Pauli {#iv-next-apply-feedforward-corrections-to-correct-pauli-byproduct-operators}
...
### (v) Finalmente, medir qubits de controle e alvo {#v-finally-measure-control-and-target-qubits}
