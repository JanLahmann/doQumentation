...
### Construir a implementação com circuitos dinâmicos {#build-dynamic-circuit-implementation}
...
#### Desacoplamento dinâmico (DD) e suporte à duração `stretch` {#dynamical-decoupling-dd-and-support-for-stretch-duration}
...
## Etapa 2: Otimizar o problema para execução em hardware {#step-2-optimize-problem-for-hardware-execution}
...
#### Transpilação usando `MidCircuitMeasure` {#transpile-using-midcircuitmeasure}
