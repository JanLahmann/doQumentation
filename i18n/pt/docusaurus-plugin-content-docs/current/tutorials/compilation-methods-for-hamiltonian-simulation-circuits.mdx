...
#### 1. **Transpiler do Qiskit com SABRE** {#1-qiskit-transpiler-with-sabre}
...
#### 2. **Transpiler de IA** {#2-ai-transpiler}
...
## Parte 1: Circuito SU2 Eficiente {#part-1-efficient-su2-circuit}
...
#### Transpilar e capturar métricas {#transpile-and-capture-metrics}
...
#### Análise dos resultados de compilação de circuitos SU2 {#analysis-of-su2-circuit-compilation-results}
...
## Parte 2: Circuito de simulação Hamiltoniana {#part-2-hamiltonian-simulation-circuit}

### Passo 1: Investigar circuitos com `PauliEvolutionGate` {#step-1-investigate-circuits-with-paulievolutiongate}
...
#### Hamiltonianos usados no benchmark {#hamiltonians-used-in-the-benchmark}
...
#### Fonte do benchmark: Hamlib e Benchpress {#benchmark-source-hamlib-and-benchpress}

Os circuitos usados neste benchmark são extraídos do [repositório de benchmark Hamlib](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation), que contém cargas de trabalho realistas de simulação Hamiltoniana.
...
#### Análise dos resultados de compilação de circuitos Hamiltonianos {#analysis-of-hamiltonian-circuit-compilation-results}
