...
### O desafio da Divisão de Mercado {#the-market-split-challenge}
...
### O que torna a abordagem do Iskay única? {#what-makes-iskays-approach-unique}
...
### Configure as credenciais do IBM Quantum {#configure-ibm-quantum-credentials}
...
## Passo 1: Mapeie entradas clássicas para um problema quântico {#step-1-map-classical-inputs-to-a-quantum-problem}
...
### Conecte ao Otimizador Quântico Iskay {#connect-to-iskay-quantum-optimizer}
...
### Carregue e formule o problema {#load-and-formulate-the-problem}

#### Compreenda o formato dos dados do problema {#understand-the-problem-data-format}
...
#### Transformação QUBO {#qubo-transformation}

## Das restrições ao QUBO: a transformação matemática {#from-constraints-to-qubo-the-mathematical-transformation}
...
### Implemente funções de carregamento de dados e conversão QUBO {#implement-data-loading-and-qubo-conversion-functions}
...
### Carregue a instância do problema {#load-the-problem-instance}
...
### Converta para o formato QUBO {#convert-to-qubo-format}
...
### Converta QUBO para o formato Iskay {#convert-qubo-to-iskay-format}
...
### Entenda o algoritmo bf-DCQO {#understand-the-bf-dcqo-algorithm}
...
#### O que é bf-DCQO? {#what-is-bf-dcqo}
...
#### Estrutura matemática {#mathematical-framework}
...
#### O papel dos termos contradiabáticos {#the-role-of-counterdiabatic-terms}
...
#### Otimização iterativa por campo de viés {#bias-field-iterative-optimization}
...
#### Pós-processamento clássico integrado {#integrated-classical-post-processing}
...
#### Por que o bf-DCQO se destaca no hardware atual {#why-bf-dcqo-excels-on-current-hardware}
...
### Configure a otimização {#configure-the-optimization}
...
#### Opções avançadas (opcional) {#advanced-options-optional}
...
### Monitorar status do trabalho {#monitor-job-status}
...
### Aguardar conclusão {#wait-for-completion}
...
### Analisar resultados {#analyze-results}

#### Entenda a estrutura do resultado {#understand-the-result-structure}
...
#### Validação da solução {#solution-validation}
...
#### Interpretar os resultados da validação {#interpret-the-validation-results}
...
#### Avaliação da qualidade da solução {#solution-quality-assessment}
...
### O que realizamos {#what-we-accomplished}
