---
description: 'Respostas para perguntas comuns sobre os modos de execução'
...
<Accordion>
  <AccordionItem title="O modo de teste local `qiskit-ibm-runtime` oferece suporte a diferentes modos de execução?">
