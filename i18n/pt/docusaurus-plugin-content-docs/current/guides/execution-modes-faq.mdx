...
<details>
  <summary>
    Quantos jobs podem ser executados em paralelo para um backend específico? {#how-many-jobs-can-run-in-parallel-for-a-specific-backend}
  </summary>
...
<details>
  <summary>
    Como o uso é reportado para jobs que falharam ou foram cancelados? {#how-is-usage-reported-for-failed-or-canceled-jobs}
  </summary>
...
<details>
  <summary>
    O que acontece com meus jobs se uma sessão for encerrada? {#what-happens-to-my-jobs-if-a-session-is-closed}
  </summary>
...
<details>
  <summary>
    Se estou usando o modo de sessão e espero que meu experimento leve muitas horas, há alguma forma de solicitar calibrações? {#if-i-am-using-session-mode-and-expect-my-experiment-to-take-many-hours-is-there-a-way-to-ask-for-calibrations-to-happen}
  </summary>
...
<details>
  <summary>
    Existe um tempo limite interativo (TTL interativo) no modo de sessão? {#is-there-an-interactive-timeout-interactive-ttl-with-session-mode}
  </summary>
...
<details>
  <summary>
    Posso alterar o TTL interativo ou o TTL máximo de uma sessão? {#can-i-change-the-interactive-ttl-or-the-maximum-ttl-of-a-session}
  </summary>
...
<details>
  <summary>
    Como o uso de sessões impacta os membros da IBM Quantum Network que não são cobrados por uso? {#how-does-session-usage-impact-ibm-quantum-network-members-who-are-not-billed-by-usage}
  </summary>
...
<details>
  <summary>
    Tenho o mesmo paralelismo no modo de sessão que no modo de lote? {#do-i-get-the-same-parallelism-in-session-mode-that-i-get-with-batch-mode}
  </summary>
...
<details>
  <summary>
    As sessões podem ser interrompidas por atualizações ou calibrações do QPU? {#can-sessions-be-interrupted-by-qpu-upgrades-or-calibrations}
  </summary>
...
<details>
  <summary>
    O tempo de compilação é contabilizado como uso no modo de sessão? {#is-compilation-time-counted-as-usage-in-session-mode}
  </summary>
...
<details>
  <summary>
    Quantos jobs são executados em paralelo no modo de lote? {#how-many-jobs-run-in-parallel-in-batch-mode}
  </summary>
...
<details>
  <summary>
    Qual é a diferença entre executar _N_ PUBs no modo de job e executar _N_ jobs com um único PUB no modo de lote? {#how-is-running-n-pubs-in-job-mode-different-from-running-n-single-pub-jobs-in-batch-mode}
  </summary>
...
<details>
  <summary>
    Quantos jobs posso enviar em um lote? {#how-many-jobs-i-can-submit-in-a-batch}
  </summary>
...
<details>
  <summary>
    Quando meus jobs no modo de lote seriam executados em paralelo com os jobs de outros usuários? {#when-would-my-batch-mode-jobs-run-in-parallel-with-other-users-jobs}
  </summary>
...
<details>
  <summary>
    Todos os meus jobs em lote precisam aguardar na fila? {#do-all-of-my-batch-jobs-need-to-wait-in-the-queue}
  </summary>
...
<details>
  <summary>
    Um lote é encerrado automaticamente quando o último job associado termina? {#does-a-batch-end-automatically-when-the-last-associated-job-ends}
  </summary>
...
<details>
  <summary>
    Os lotes podem ser interrompidos por calibrações ou atualizações de software {#can-batches-be-interrupted-by-calibrations-or-software-upgrades}
  </summary>
...
<details>
  <summary>
    O tempo de compilação é contabilizado como uso no modo de lote? {#is-compilation-time-counted-as-usage-in-batch-mode}
  </summary>
