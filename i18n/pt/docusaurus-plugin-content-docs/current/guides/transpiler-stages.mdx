...
- `DenseLayout`: Encontra o subgrafo do dispositivo com a maior conectividade e que tem o mesmo número de qubits que o circuito (usado para o nível de otimização 1 se houver operações de fluxo de controle (como IfElseOp) presentes no circuito).
