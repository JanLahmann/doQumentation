...
Cada porta no Qiskit pode interpretar uma lista de qubits à sua própria maneira, mas
...
Para desenhar um circuito com qubits em ordem invertida (ou seja, qubit $0$ na
