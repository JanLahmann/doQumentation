...
múltiplos observáveis em um circuito quântico com sobrecarga de amostragem mínima. O
...
inverte completamente todo o circuito ruidoso usando redes tensoriais para representar as
camadas ruidosas.
...
Autentique-se usando sua [chave de API do IBM Quantum Platform](http://quantum.cloud.ibm.com/), e selecione a função TEM como a seguir. (Este trecho assume que você já [salvou sua conta](/guides/functions-get-started#install-qiskit-functions-catalog-client) em seu ambiente local.)
...
O trecho a seguir mostra um exemplo em que o TEM é usado para calcular os valores esperados de um observável dado um circuito quântico simples.
...
<Admonition type="info">
  O valor esperado para o circuito sem ruído para o operador dado deve ser em torno de `0.18409094298943401`.
</Admonition>
