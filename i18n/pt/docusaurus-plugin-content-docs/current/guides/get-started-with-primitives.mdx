...
### 2. Criar um circuito e um observável {#2-create-a-circuit-and-an-observable}
...
### 3. Inicializar o Qiskit Runtime Estimator {#3-initialize-qiskit-runtime-estimator}
...
### 4. Invocar o Estimator e obter resultados {#4-invoke-the-estimator-and-get-results}
...
### 3. Inicializar o Qiskit Runtime Sampler {#3-initialize-the-qiskit-runtime-sampler}
...
### 4. Invocar o Sampler e obter resultados {#4-invoke-the-sampler-and-get-results}
...
### Exemplo: BackendEstimator {#example-backendestimator}
...
### Exemplo: BackendSampler {#example-backendsampler}
