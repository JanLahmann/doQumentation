...
- Embora as primitivas do Qiskit Aer implementem as interfaces de primitivas, elas não fornecem as mesmas opções que as primitivas do IBM Quantum. O nível de resiliência, por exemplo, não está disponível com as primitivas do Qiskit Aer.
...
<Admonition type="tip" title="Recomendações">
  - Para simular circuitos pequenos e simples, consulte [Simulação exata com primitivas do Qiskit SDK](/guides/simulate-with-qiskit-sdk-primitives).
