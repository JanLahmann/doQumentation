---
title: "Exemplos do Estimator"
sidebar_label: "Exemplos do Estimator"
description: "Exemplos práticos de uso da primitiva Estimator no Qiskit Runtime."
...
Os exemplos nesta seção ilustram algumas maneiras comuns de usar o Estimator. Antes de executar esses exemplos, siga as instruções em [Instalar Qiskit.](install-qiskit)
...
Use o Estimator para executar três experimentos em um único job, aproveitando os valores de parâmetros para aumentar a reutilização do Circuit.
...
Explore o [modo de execução](/guides/execution-modes) em lote e opções avançadas para otimizar o desempenho do Circuit nas QPUs.
