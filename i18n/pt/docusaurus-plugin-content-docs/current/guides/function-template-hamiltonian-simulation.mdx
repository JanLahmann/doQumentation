...
# Criar um template de função para simulação hamiltoniana {#build-a-function-template-for-hamiltonian-simulation}
...
<details>
<summary><b>Código-fonte completo do programa</b></summary>
