---
description: 'Migre dos simuladores em nuvem do IBM Quantum para o modo de teste local do `qiskit-ibm-runtime`.'
...
<Accordion>
<AccordionItem title="Simuladores têm limitações">
...
<AccordionItem title="Usar hardware quântico desenvolve habilidades únicas">
...
<AccordionItem title="Algoritmos devem ser adaptados para hardware quântico">
...
## Migrar para simuladores locais {#migrate-to-local-simulators-1}
