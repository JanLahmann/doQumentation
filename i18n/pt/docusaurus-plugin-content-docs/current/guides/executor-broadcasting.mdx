...
## Exemplo de início rápido {#quickstart-example}
...
## Eixos intrínsecos e extrínsecos {#intrinsic-and-extrinsic-axes}
...
## Formas dos arrays de saída {#output-array-shapes}
...
## Randomização e o parâmetro `shape` {#randomization-and-the-shape-parameter}
...
### Sem eixos de randomização explícitos {#no-explicit-randomization-axes}
...
### Eixo de randomização único {#single-randomization-axis}
...
### Múltiplos eixos de randomização {#multiple-randomization-axes}
...
### Como `shape` e as formas de entrada interagem {#how-shape-and-input-shapes-interact}
...
### Indexar nos resultados {#index-into-results}
...
### Varrer um único parâmetro {#sweep-a-single-parameter}
...
### Criar uma varredura em grade 2D {#creating-a-2d-grid-sweep}
...
### Combinar múltiplas entradas {#combining-multiple-inputs}
