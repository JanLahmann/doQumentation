---
description: 'Opções disponíveis para usar com as primitivas do IBM Quantum'
...
Você pode usar opções para personalizar as primitivas do IBM Quantum de acordo com suas necessidades.
