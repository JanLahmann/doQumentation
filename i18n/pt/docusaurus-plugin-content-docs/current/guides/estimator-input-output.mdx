...
- Uma coleção de valores de parâmetros para vincular o Circuit. Isso pode ser especificado como um único objeto semelhante a array onde o último índice é sobre os objetos `Parameter` do Circuit ou omitido (ou equivalentemente, definido como `None`) se o Circuit não tiver objetos `Parameter`.
