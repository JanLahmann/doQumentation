...
# Crie e execute um template de Qiskit Function para simulação de estrutura eletrônica com modelo de solvente implícito {#build-and-run-a-qiskit-function-template-for-electronic-structure-simulation-with-an-implicit-solvent-model}
...
Para um passo a passo detalhado deste mesmo workflow com um exemplo elaborado, consulte o tutorial [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations).
...
<Accordion>
<AccordionItem title="Clique para expandir e ver mais detalhes sobre as opções obrigatórias:">
...
<Accordion>
<AccordionItem title="Clique para expandir para mais informações sobre como configurar as opções SQD:">
...
## Cite este projeto {#cite-this-project}

Se você usar o modelo SQD IEF-PCM em sua pesquisa, consulte o [repositório](https://github.com/qiskit-community/qiskit-function-templates/tree/main/chemistry/sqd_pcm#citing-this-project) para informações detalhadas de citação.

## Próximos passos {#next-steps}

<Admonition type="info" title="Recomendações">

- Siga o tutorial [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations) para um exemplo elaborado deste mesmo workflow

- Consulte o guia sobre como construir um template de função para [simulação de Hamiltoniano](/guides/function-template-hamiltonian-simulation)

- Confira os arquivos de origem deste modelo no [GitHub](https://github.com/qiskit-community/qiskit-function-templates/tree/main/chemistry/sqd_pcm)
