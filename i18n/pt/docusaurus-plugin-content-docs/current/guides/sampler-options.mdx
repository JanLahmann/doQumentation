...
4. Se `twirling` estiver habilitado, então o produto de `num_randomizations` e `shots_per_randomization`, conforme especificado nas [opções de `twirling`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-twirling-options), é usado.
