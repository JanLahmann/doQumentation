...
Antes de iniciar uma sessão, você deve [configurar o cliente do IBM Quantum Compute](/guides/install-qiskit-runtime) e inicializá-lo como serviço:
...
Para uma visão geral abrangente da configuração e do status de uma sessão, use o método `session.details() method`.
