...
## Importar um programa OpenQASM 2 para o Qiskit {#import-an-openqasm-2-program-into-qiskit}
...
#### Exemplo: importar um programa OpenQASM 2 como string {#example-import-an-openqasm-2-program-as-a-string}
...
#### Exemplo: importar um programa OpenQASM 2 a partir de um arquivo {#example-import-an-openqasm-2-program-from-a-file}
...
### Vincular gates OpenQASM 2 com gates do Qiskit {#link-openqasm-2-gates-with-qiskit-gates}
...
#### Exemplo: importar um programa criado pelo exportador legado do Qiskit {#example-import-a-program-created-by-qiskits-legacy-exporter}
...
#### Exemplo: usar uma classe de gate específica ao importar um programa OpenQASM 2 {#example-use-a-particular-gate-class-when-importing-an-openqasm-2-program}
...
#### Exemplo: definir um novo gate integrado em um programa OpenQASM 2 {#example-define-a-new-built-in-gate-in-an-openqasm-2-program}
...
### Definir funções clássicas personalizadas {#define-custom-classical-functions}
...
## Exportar um circuito Qiskit para OpenQASM 2 {#export-a-qiskit-circuit-to-openqasm-2}
...
### Exemplo: exportar um circuito para OpenQASM 2 {#example-export-a-circuit-to-openqasm-2}
...
<Admonition type="tip" title="Recomendações">
    ...
    - Revise o tópico [Verificar seu programa](/guides/debugging-tools).
