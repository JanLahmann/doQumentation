...
# Configurar funções personalizadas {#set-up-custom-roles}
...
1. Em [Manage → IAM → Roles](https://cloud.ibm.com/iam/roles), clique em `Create` (visível apenas para administradores de conta).

2. Insira um nome, ID, descrição e selecione `Quantum Compute` para o serviço.
...
1. Vá para [Manage → IAM → Roles](https://cloud.ibm.com/iam/roles) no IBM Cloud. Selecione Quantum Compute no menu suspenso para ver as funções que existem atualmente para esse serviço.
...
6. No menu suspenso Service, escolha Quantum Compute. Uma tabela é exibida com todas as ações que você pode mapear para a função.
...
10. Em Service, selecione Quantum Compute e clique em Next.
