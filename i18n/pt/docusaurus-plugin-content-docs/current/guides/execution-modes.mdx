---
title: Introdução aos modos de execução do Qiskit Runtime
...
# Introdução aos modos de execução do Qiskit Runtime {#introduction-to-qiskit-runtime-execution-modes}
