...
### Habilite o TREX usando a opção `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### Habilite o TREX usando a opção `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### Habilite a ZNE usando a opção `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}
...
### Habilite a ZNE usando a opção `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- Explore outras [opções](/guides/runtime-options-overview) para as primitivas do Qiskit Runtime.
