...
## Suporte ao Qiskit Runtime {#qiskit-runtime-support}
...
- Esta é uma função experimental. Ela está em status de versão prévia e, portanto, sujeita a alterações.
...
### Habilitar a recuperação de dados de tempo {#enable-timing-data-retrieval}
...
### Acessar os dados de tempo do Circuit {#access-the-circuit-timing-data}
...
#### Entender os dados de tempo brutos {#understand-the-raw-timing-data}
...
### Visualizar os tempos {#visualize-the-timings}
...
### Exemplo completo {#end-to-end-example}
...
Por fim, você pode visualizar e salvar o tempo:
...
<Admonition type="tip" title="Recomendações">
  - [Feedforward clássico e fluxo de controle](/guides/classical-feedforward-and-control-flow) (circuits dinâmicos)
