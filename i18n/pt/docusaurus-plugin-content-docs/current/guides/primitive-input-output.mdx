---
description: 'Entenda o formato de entrada e saída (incluindo os Primitive Unified Blocs ou PUBs) dos primitivos Qiskit SDK'
...
<Admonition type="tip" title="Recomendações">
  ...
  -  Consulte a API dos [primitivos do Qiskit SDK](https://docs.quantum.ibm.com/api/qiskit/primitives).

  -  Consulte a API dos [primitivos do Qiskit Aer](https://qiskit.github.io/qiskit-aer/apidocs/aer_primitives.html).

  -  Saiba mais sobre os [primitivos do IBM Quantum](/guides/qiskit-runtime-primitives).

  -  Consulte a API do [Estimator do `qiskit-ibm-runtime`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2).

  -  Consulte a API do [Sampler do `qiskit-ibm-runtime`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2).
</Admonition>
