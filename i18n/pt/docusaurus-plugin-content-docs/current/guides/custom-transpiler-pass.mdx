---
title: "Escreva um passo de transpilação personalizado"
sidebar_label: "Escreva um passo de transpilação personalizado"
...
<Accordion>
  <AccordionItem title="Contexto: representação em DAG">
