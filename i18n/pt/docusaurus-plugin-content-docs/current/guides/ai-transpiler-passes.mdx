...
Consulte a [documentação do Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) para obter mais informações sobre os limites que se aplicam aos passes de transpilador com IA.

## Citação {#citation}

Se você usar algum recurso com IA do Qiskit Transpiler Service em sua pesquisa, use [a citação recomendada](/guides/qiskit-transpiler-service#citation).
