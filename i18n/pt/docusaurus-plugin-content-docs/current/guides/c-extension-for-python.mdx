...
Conclua as instruções no tópico [Instalar](/guides/install-c-api) para instalar o seguinte:

- O conjunto de ferramentas padrão do compilador C para sua plataforma

- Uma versão do Python que inclua seus headers de API C. 


Você também deve estar familiarizado com, ou preparado para consultar, as funções e objetos disponíveis
na [API C do Qiskit](https://docs.quantum.ibm.com/api/qiskit-c), e deve ter alguma familiaridade com programação em C.
...
Defina a versão de runtime do Qiskit em
