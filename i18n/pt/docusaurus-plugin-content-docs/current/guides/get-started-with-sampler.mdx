...
### 2. Criar um Circuit {#2-create-a-circuit}
...
Em seguida, invoque o método `run()` para gerar a saída. O Circuit e os conjuntos opcionais de valores de parâmetros são fornecidos como tuplas de *bloco unificado primitivo* (PUB).
