...
To find the native gates and operations of a backend, use [this code](/guides/get-qpu-information#native-gates-with-qiskit). You can see all native gates and operations in [this table](/guides/qpu-information#native-gates).
</Admonition>
