...
<Admonition type="tip" title="Recomendações">
  ...
  - Aprenda como usar [códigos de espaço-tempo](/tutorials/spacetime-codes) para uma abordagem de baixa sobrecarga para detecção de erros
</Admonition>
