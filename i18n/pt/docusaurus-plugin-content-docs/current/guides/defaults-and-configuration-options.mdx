...
- Aprenda como [Definir o nível de otimização](/guides/runtime-options-overview).
...
- Aprenda [como transpilar circuitos](/guides/circuit-transpilation-settings) como parte do fluxo de trabalho de padrões do Qiskit.
