...
* As Qiskit Functions são um recurso experimental disponível apenas para usuários dos planos IBM Quantum&reg; Premium Plan, Flex Plan e On-Prem (via IBM Quantum Platform API). Elas estão em status de lançamento prévio e sujeitas a alterações.
</Admonition>
...
### 1. Criar a função objetivo {#1-create-the-objective-function-1}
...
### 2. Executar o Optimizer {#2-run-the-optimizer-1}
...
### 3. Recuperar o resultado {#3-retrieve-the-result-1}
