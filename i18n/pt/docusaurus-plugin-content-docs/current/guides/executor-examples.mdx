---
description: 'Exemplos práticos do uso da primitiva Executor no qiskit-ibm-runtime.'
...
### Configurar o circuito {#set-up-the-circuit-1}
...
### Executar os circuitos {#execute-the-circuits-1}
