...
- Consulte o guia sobre como criar um [passe personalizado do transpilador](/guides/custom-transpiler-pass)
- Aprenda como [Criar e transpilar com backends personalizados](/guides/custom-backend)
