---
description: 'Use a classe Neat do módulo de ferramentas de depuração do qiskit-ibm-runtime para depurar e analisar jobs.'
notebook_path: guides/debug-qiskit-runtime-jobs.ipynb
sidebar_label: 'Depure jobs com o NEAT'
title: 'Depure jobs com o NEAT'
---
...
Antes de enviar uma carga de trabalho intensiva para execução em hardware, você pode usar a classe [NEAT (Noisy Estimator Analyzer Tool)](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/debug-tools-neat#neat) do IBM Quantum Compute para verificar se a sua carga de trabalho do Estimator está configurada corretamente, é provável que retorne resultados precisos, usa as opções mais adequadas para o problema especificado e muito mais.
...
Primeiro, importe os pacotes relevantes e [autentique-se no IBM Quantum Compute Service](/guides/cloud-setup).
...
- Saiba mais sobre as [opções disponíveis do IBM Quantum Compute](/guides/runtime-options-overview).
...
- Saiba [como transpilar circuitos](/guides/circuit-transpilation-settings#compare-transpiler-settings) como parte dos fluxos de trabalho de padrões do Qiskit.
