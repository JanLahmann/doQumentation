...
Você pode usar a classe `Neat` para analisar o impacto do ruído em uma carga de trabalho do Estimator. Para verificação de sintaxe, use o [Modo de teste local](/guides/local-testing-mode).
## Uso da classe `Neat` {#neat-class-usage}
...
- Leia uma visão geral das [ferramentas de depuração do Qiskit](/guides/debugging-tools).
