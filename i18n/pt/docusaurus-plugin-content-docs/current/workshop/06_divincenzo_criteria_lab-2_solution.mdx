...
Ao completar os exercícios deste notebook, você não apenas viu as definições dos critérios de DiVincenzo, mas os *tocou* por meio do código, construindo intuição sobre o que cada requisito significa para o hardware e os algoritmos quânticos reais. Sinta-se à vontade para estender esses experimentos, e boa computação quântica!
