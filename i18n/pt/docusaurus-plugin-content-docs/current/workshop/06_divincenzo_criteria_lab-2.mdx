...
![Diagrama do circuito quântico](/img/workshop/06-divincenzo-criteria-lab-2/output_1.png)
...
![Saída do código](/img/workshop/06-divincenzo-criteria-lab-2/output_2.png)
...
![Diagrama do circuito quântico](/img/workshop/06-divincenzo-criteria-lab-2/output_3.png)
...
![Diagrama do circuito quântico](/img/workshop/06-divincenzo-criteria-lab-2/output_4.png)
...
Ao concluir os exercícios deste notebook, você não apenas viu as definições dos critérios de DiVincenzo, mas os *tocou* por meio de código; construindo intuição sobre o que cada requisito significa para hardware e algoritmos quânticos reais. Sinta-se à vontade para estender esses experimentos, e bons cálculos quânticos!
