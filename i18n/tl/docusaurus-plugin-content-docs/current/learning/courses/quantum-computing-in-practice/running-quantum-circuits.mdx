...
<IBMVideo id="134063416" title="Sa video na ito, ipinapaliwanag ni Olivia Lanes ang quantum circuits at primitives. Sumasaklaw niya ang IBM Quantum Estimator at Sampler primitives."/>
...
Bawat processor ay maaaring makilala gamit ang tatlong pangunahing performance metric na naglalarawan sa kanyang scale, kalidad, at bilis: programmable qubits, qubit operations, at maximum circuits per second.

* **Programmable qubits:** Ito ang mga qubit na direktang makokontrol at maisasama ng mga user sa mga quantum algorithm. Sinusukat ng metric na ito ang computational scale na magagamit para sa mga application.


* **Qubit operations (QuOps):** Inilalarawan ng metric na ito kung ilan sa mga pinaka-mapaghamong quantum operation ang maaasahang maisasagawa ng isang processor bago mahadlangan ng naipong mga error ang computation. Ito ay nagsisilbing sukatan ng computational quality at kakayahan.


* **Maximum circuits per second:** Sinusukat ng metric na ito ang circuit throughput, o kung ilang quantum circuit ang maisasagawa ng isang system kada segundo. Ang mas mataas na throughput ay nagbibigay-daan sa mas maraming kapaki-pakinabang na gawain na makumpleto sa isang naibigay na dami ng oras.


Maaari mo ring makasalubong ang mga karagdagang processor metric sa technical documentation, benchmarking studies, at performance report:

EPLG (Errors Per Layered Gate). Isang sukatan ng average na error na dulot ng layered entangling-gate operations. Ang mas mababang EPLG ay karaniwang nagpapahiwatig ng mas mataas na kalidad ng gate at mas mababang akumulasyon ng error.

CLOPS (Circuit Layer Operations Per Second). Isang benchmark na sumusukat kung gaano kabilis maisasagawa ng isang quantum system ang isang standardized workload na kinabibilangan ng parehong quantum operations at kaugnay na classical processing.

Ang mga karagdagang metric na ito ay nagbibigay ng mas detalyadong impormasyon tungkol sa hardware behavior, habang ang programmable qubits, qubit operations, at maximum circuits per second ay nagbibigay ng mas mataas na antas ng pagtingin sa scale, kalidad, at bilis ng isang system.
...
## Software: Qiskit at IBM Quantum Compute Service {#software-qiskit-and-ibm-quantum-compute-service}

Para gawing mga tagubilin para sa isang quantum computer ang iyong quantum na problema, gagamit ka ng Qiskit, ang open-source software development kit na idinisenyo para sa trabaho sa mga quantum computer na binuo ng IBM. Mayroon ding Qiskit Ecosystem — isang koleksyon ng mga software tutorial at function na nagtatayo o nagpapalawak sa mga core na functionality ng Qiskit — at Quantum Compute — isang quantum computing service at programming model na nagpapahintulot sa mga gumagamit na magdisenyo at mag-optimize ng kanilang mga quantum workload at mabisang i-execute ang mga ito sa pamamagitan ng paggamit ng IBM Quantum primitives.
...
3.	**Execute.** Ang mga IBM Quantum primitive ay nagbibigay ng interface sa IBM Quantum hardware na nagpapahintulot sa mga transpiled na circuit na mapatakbo. Kasama rin sa hakbang na ito ang paggamit ng mga teknik ng error suppression at mitigation, na halos maaaring i-abstract mula sa gumagamit.
...
Susunod, kailangan nating pumili ng isang quantum processor na may sapat na mga qubit ng sapat na kalidad para mapatakbo natin ang ating quantum circuit. Gumawa ng mga desisyong ito ayon sa tatlong pangunahing sukatan na tinalakay sa seksyon ng hardware: programmable qubits, qubit operations, at maximum circuits per second. Depende sa application, ang mga karagdagang metric tulad ng EPLG at CLOPS ay maaari ring magbigay ng kapaki-pakinabang na impormasyon tungkol sa inaasahang kalidad ng circuit at execution performance.
...
Handa na tayong i-execute ang quantum program. Ang mga IBM Quantum primitive ay nagbibigay ng interface sa IBM Quantum hardware, at inaabstract din nila ang error suppression at mitigation mula sa gumagamit. Mayroong dalawang primitive na mapagpipilian: ang Sampler at ang Estimator.
...
Mayroong maraming teknik na maaari nating ipatupad para sa error mitigation. Tatalakayin natin ang tatlo, sa pataas na pagkakasunud-sunod ng katatagan laban sa mga error, ngunit din, dahil dito, sa pataas na pagkakasunud-sunod ng computational na gastos. Gayunpaman, alamin na ito ay isang aktibong larangan ng pananaliksik — kaya malamang na patuloy tayong magiimbento ng mga bago at magpapabuti sa mga luma.
...
Ang isang tiyak na uri ng ZNE ay tinatawag na Probabilistic Error Amplification (PEA). Kapag natuto na tayo ng noise model para sa isang gate, ang PEA ay gumagana sa pamamagitan ng pag-sample ng mga error mula sa noise model na iyon at sadyang naglalagay ng mga ito sa circuit. Hindi pa ito available sa Qiskit, ngunit magiging available ito bago matapos ang taon.

Ang panghuling anyo ng error mitigation na tatalakayin natin ay Probabilistic Error Cancellation (PEC). Sa halip na nasa 3rd resilience level, ang PEC ay isang espesyal na kakayahan na kailangan mong i-turn on nang mano-mano sa Qiskit, dahil ang mga kinakailangang computational resources ay hindi nagsca-scale nang maayos kumpara sa iba pang mga teknik ng error mitigation. Nagsisimula ka sa pag-aaral tungkol sa noise na nakakaapekto sa iyong circuit — magpatakbo ng mga noise-learning o noise-characterization circuit para sa bawat natatanging layer ng dalawang-qubit na gate sa iyong circuit. Ang mga resultang ito ay nagpapahintulot sa iyo na ilarawan ang noise sa mga tuntunin ng mga Pauli operator. Kapag alam mo na ang mga noise term na ito, maaari mong baguhin ang iyong mga circuit para epektibong nakapaloob na rito ang kabaligtarang mga Pauli gate na kakansela sa mga noise channel na ito. Sa ilang paraan, ang proseso ay katulad ng paraan ng pagtatrabaho ng noise-cancelling headphone. Gayunpaman, ang ganitong paraan ng pag-undo ng noise ay napaka-mahal, na may oras para patakbuhin na lumalaki nang mabilis at exponentially sa bilang ng mga gate, kaya maaaring hindi ito ang pinakamainam na pagpipilian para sa isang napakalaking circuit.
