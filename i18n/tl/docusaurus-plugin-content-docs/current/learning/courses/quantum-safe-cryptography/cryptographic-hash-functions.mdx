...
Ang katotohanan na ang laki ng input domain $Σ^*$ ng $H$ ay walang hangganan habang ang co-domain $\{0,1\}^n$ ay may hangganan ay nangangahulugang ang $H$ ay kinakailangang isang many-to-one na pagmamapa na nag-iipon ng walang hanggang maraming input sa anumang n-bit na string.

Ang mga katangian ng uniformity at determinismo ay magandang nakapaloob sa <DefinitionTooltip definition="Isang idealisadong kriptograpikong modelo na madalas gamitin sa mga teoretikal na talakayan at pagsusuri ng mga kriptograpikong protocol at pamamaraan; nagbibigay-daan sa malinaw at mahigpit na pagsusuri ng mga katangian ng seguridad.">*modelo ng random oracle*</DefinitionTooltip> ng cryptographic hashing.
...
Dahil sa isang CHF $H$ at digest $g$, dapat na hindi maaari sa komputasyon na mahanap ang anumang input $m$ mula sa pre-image ng $g$ kung saan $H(m) = g$.
