...
![Isang larawan ng mga atomic orbital at isang larawan ng isang network na may maraming node at koneksyon sa pagitan ng mga ito.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig1.svg)
...
![Isang larawan ng isang quantum circuit na may mga variational parameter na may label na "theta".](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig2.svg)
...
![Isang larawan na nagpapakita ng isang kurba na linya na kumakatawan sa enerhiya na may ilang mga punto kung saan tinutukoy ang halaga upang mahanap ang minimum.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig3.svg)
...
Ngunit hindi natin maaaring sukatin ang lahat ng mga Pauli operator nang sabay-sabay. Ang mga Pauli operator (hindi kasama ang I) ay hindi nagko-commute sa isa't isa kung sila ay nauugnay sa parehong qubit. Halimbawa, maaari nating sukatin ang `IZIZ` at `ZZXZ` nang sabay-sabay, dahil maaari nating sukatin ang I at Z nang sabay-sabay para sa ikatlong qubit, at maaari nating malaman ang I at X nang sabay-sabay para sa unang qubit. Ngunit hindi natin maaaring sukatin ang `ZZZZ` at `ZZZX` nang sabay-sabay, dahil ang Z at X ay hindi nagko-commute, at ang pareho ay kumikilos sa ika-0 na qubit. Maaaring maalala ng mga may karanasang mambabasa na ang dalawang grupo ng mga Pauli operator ay maaaring magcommute bilang isang set kahit na ang mga pagsukat ng bawat indibidwal na qubit ay hindi nagco-commute. Ang Estimator ay gumagamit ng tensor-product Pauli measurements (sa pamamagitan ng basis rotations), na naaayon sa pagpapangkat ng mga operator na qubit-wise commuting. Kaya, upang sabay na matantya ang dalawang string (A at B) ng mga Pauli operator gamit ang Estimator, ang mga Pauli operator ng bawat qubit sa A at B ay dapat na magcommute. Ibig sabihin nito ay hindi rin natin maaaring sukatin ang `ZZZZ` at `ZZXX` nang sabay-sabay.

![Isang talahanayan ng iba't ibang Pauli string, ang ilan sa kanila ay nagko-commute at ang iba ay hindi.](/learning/images/courses/quantum-diagonalization-algorithms/vqe/vqe-fig4.svg)
...
Maaaring gawin sa 4 grupo. Pansinin na ang mga ganitong solusyon ay karaniwang hindi natatangi.
...
* Kadalasang ginagamit ang configuration recovery [\[16\]](#references) at symmetry postselection [\[15\]](#references) bilang teknik sa post-processing.
