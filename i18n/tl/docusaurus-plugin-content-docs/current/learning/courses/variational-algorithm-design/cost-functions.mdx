...
- I-define ang isang *cost function* na $C(\vec\theta)$. Ito ay isang function na naka-depende sa problema na nagtatakda ng layunin ng problema para mapakinabangan (o mapalaki) ng optimizer
