...
## Hakbang 3 ng Qiskit Patterns: Mag-execute gamit ang IBM Quantum primitives {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives}
...
## Qiskit Patterns Hakbang 2: I-optimize ang problema para sa quantum execution {#qiskit-patterns-step-2-optimize-problem-for-quantum-execution-1}
Magsisimula tayo sa pagpili ng backend para sa execution. Sa kasong ito, gagamitin natin ang pinaka-hindi abala na backend.
...
## Qiskit Patterns Hakbang 3: Mag-execute gamit ang IBM Quantum primitives {#qiskit-patterns-step-3-execute-using-ibm-quantum-primitives-1}
