...
{/* doqumentation-source-hash: 2a01c8f1 */}
...
# Introduksyon sa Quantum Machine Learning {#introduction-to-quantum-machine-learning}
...
Mali. Karamihan sa mga machine learning problem ay lubos na mahusay na nalulutas ng mga classical algorithm at ang mga quantum algorithm ay hindi malamang na mag-aalok ng anumang malaking speed-up. Ang layunin sa QML ay ang paghahanap ng mga dataset na may mga feature na mahusay na inilarawan ng mga quantum state at/o paghahanap ng mga mapping ng mga feature ng data na nag-o-optimize sa katumpakan ng mga modelo.
...
5. Ipatupad ang mga quantum kernel method at variational quantum classifier gamit ang IBM Quantum primitives at sumusunod sa Qiskit patterns.
...
* Hakbang 3: Isagawa gamit ang IBM Quantum primitives
...
Sa proseso sa itaas, kinalkula natin ang isang kernel matrix entry para sa ika-14 at ika-19 na data point. Anong halaga ang dapat nating makuha kung gagamitin natin ang parehong data point nang dalawang beses, dito (tulad ng ika-14 at ika-14 muli)? Sa madaling salita, ano ang dapat na diagonal entries sa kernel matrix? Sagutin ang tanong na ito sa kawalan ng noise, ngunit tandaan na posible ang mga paglihis mula sa iyong sagot sa presensya ng noise.

<Accordion>
<AccordionItem title="Answer">

Dapat 1.0 ang mga diagonal. Dapat kalkulahin ng proseso na ito ang normalized inner product ng isang vector sa kanyang sarili, na palaging dapat isa.
