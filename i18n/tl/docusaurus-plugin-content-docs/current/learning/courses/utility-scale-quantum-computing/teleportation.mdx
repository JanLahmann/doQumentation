...
### Tantiyahin ang halagang $r_z$ {#estimate-r-z-value}
...
### Ehersisyo 1: Tantiyahin ang halagang $r_x$ {#exercise-1-estimate-r-x-value}
...
### Ehersisyo 2: Tantiyahin ang halagang $r_y$ {#exercise-2-estimate-r-y-value}
...
### 4.1 Ang protokol ng Quantum teleportation {#41-the-protocol-of-quantum-teleportation}
...
### 4.2 Quantum circuit na nagsi-simulate ng quantum teleportation {#42-quantum-circuit-simulating-the-quantum-teleportation}

Tulad ng dati, gagamitin natin ang Qiskit patterns framework. Ang subseksyong ito ay nakatuon lamang sa mapping.

### Hakbang 1: I-map ang problema sa quantum circuits at operators {#step-1-map-problem-to-quantum-circuits-and-operators}
...
### 4.3 Isagawa ito at kumpirmahin ang resulta sa pamamagitan ng pag-apply ng U inverse {#43-execute-it-and-confirm-the-result-by-applying-u-inverse}
...
### 4.4 Teleportation sa isang tunay na quantum computer {#44-teleportation-on-a-real-quantum-computer}
...
### Ehersisyo 3: Buuin ang teleportation circuit {#exercise-3-build-the-teleportation-circuit}
...
### Hakbang 2: I-optimize para sa target hardware {#step-2-optimize-for-target-hardware}
...
### Hakbang 3: Isagawa ang circuit. {#step-3-execute-the-circuit}
...
### Hakbang 4: Post-process ang mga resulta {#step-4-post-process-the-results}
...
### 4.5 Mga pangunahing aral sa quantum teleportation {#45-key-takeaways-on-quantum-teleportation}
...
### 5.1 Ang protokol ng superdense coding {#51-the-protocol-of-superdense-coding}
...
### 5.2 Quantum circuit na nagsi-simulate ng superdense coding {#52-quantum-circuit-simulating-the-superdense-coding}
