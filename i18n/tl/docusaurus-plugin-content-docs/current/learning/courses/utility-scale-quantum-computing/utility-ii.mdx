...
## 2. Pagtukoy sa transverse-field Ising Hamiltonian {#2-defining-the-transverse-field-ising-hamiltonian}
...
Susubaybayan natin ang magnetisasyon (expectation value ng magnetization operator). Gagamitin natin ang Statevector at MPS simulator at ikukumpara ang mga resulta.
...
### 2.2 Aktibidad 2 {#22-activity-2}

#### Tukuyin ang Hamiltonian {#define-the-hamiltonian-1}
...
Dito tayo bumubuo ng circuit para sa iisang time step gamit ang Lie–Trotter.
Tulad mismo sa 20-qubit na kaso, ang Lie product formula (first order) ay ipinapatupad sa [LieTrotter](https://docs.quantum.ibm.com/api/qiskit/qiskit.synthesis.LieTrotter) class. Muli, ang first-order formula ay binubuo ng approximation na nasabi sa itaas:
...
### 2.5 Aktibidad 5 {#25-activity-5}

#### Itakda ang mga operator na susukatin {#set-the-operators-to-be-measured-1}
...
### 2.6 Aktibidad 6 {#26-activity-6}

#### Isagawa ang time-evolution simulation {#perform-time-evolution-simulation-1}
...
Kailangan na nating i-extract ang mga expectation value mula sa mga resultang ito.
...
Binabati kita! Isa ka nang hakbang na mas malayo sa iyong utility-scale quantum journey. Iisang aralin na lang ang natitira!
