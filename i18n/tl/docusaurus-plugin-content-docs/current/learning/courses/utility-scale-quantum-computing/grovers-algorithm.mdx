...
### Hakbang 2: I-optimize para sa target na hardware {#step-2-optimize-for-target-hardware-1}
...
### Hakbang 3: Pagpapatakbo ng circuit. {#step-3-executing-the-circuit-1}
...
### Hakbang 4: Post-processing ng mga resulta. {#step-4-post-processing-the-results-1}
