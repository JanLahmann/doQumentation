...
Muli, hindi masyadong malalim ang transpiled two-qubit depth. Ngunit para makagawa ng GHZ state na may mas maraming qubit, malinaw na kailangan mong isipin ang pag-optimize ng circuit. Patakbuhin natin ito gamit ang ```Sampler``` at tingnan kung ano ang ibinabalik ng tunay na quantum computer.
...
Sa notebook na ito, maglalapat tayo ng tatlong estratehiya sa paglikha ng magagandang GHZ state gamit ang 16 na qubit at 30 na qubit. Ang mga diskarteng ito ay nakabatay sa mga estratehiyang alam mo na mula sa mga nakaraang aralin.
...
Mas mababa na ngayon nang malaki ang depth ng circuit kaysa sa chain structure.
...
Nakakagulat, kahit tumaas ang tree depth mula 5 tungo sa 6, bumaba ang two-qubit depth mula 9 tungo sa 8! Kaya gamitin natin ang huli na circuit.
...
Maaari kang magtakda ng mga opsyon sa pag-suppress ng error sa Sampler V2. Tingnan ang gabay na [Sampler noise management](/guides/sampler-noise-management) at ang [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) API reference para sa karagdagang impormasyon.
...
Binabati kita sa pagtatapos ng kursong ito! Mangyari lamang na maglaan ng sandali upang matulungan kaming mapabuti ang aming kurso sa pamamagitan ng pagsagot sa sumusunod na [mabilis na survey](https://your.feedback.ibm.com/jfe/form/SV_5vvmdT5yFFetkgK). Ang iyong feedback ay gagamitin upang mapahusay ang aming nilalaman at karanasan ng gumagamit. Salamat!
