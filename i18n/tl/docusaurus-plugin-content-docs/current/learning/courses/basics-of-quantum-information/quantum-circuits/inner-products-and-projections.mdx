...
kung saan ang huling pagkakapantay-pantay ay sumusunod mula sa obserbasyon na $\langle a \vert a \rangle = 1$ at $\langle a \vert b \rangle = 0$ para sa mga classical state na $a$ at $b$ na tumutugon sa $a\neq b$.
...
Ang mga matrix na tumutugon sa unang kondisyon — na katumbas sila ng sarili nilang conjugate transpose — ay tinatawag na *Hermitian matrix*, at ang mga matrix na tumutugon sa ikalawang kondisyon — na ang pag-square sa kanila ay nag-iiwan sa kanila na walang pagbabago — ay tinatawag na *idempotent* na mga matrix.

Bilang babala, ang salitang *projection* ay minsan ginagamit para tumukoy sa anumang matrix na tumutugon lamang sa ikalawang kondisyon ngunit hindi kinakailangan ang una, at kapag ganito, ang terminong *orthogonal projection* ay karaniwang ginagamit para tumukoy sa mga matrix na tumutugon sa parehong kondisyon.
Sa konteksto ng quantum information at computation, gayunman, ang mga terminong *projection* at *projection matrix* ay mas karaniwang tumutukoy sa mga matrix na tumutugon sa parehong kondisyon.
