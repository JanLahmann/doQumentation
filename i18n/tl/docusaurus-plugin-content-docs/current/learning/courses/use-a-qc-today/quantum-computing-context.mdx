...
Sa sumusunod na video, gagabayan ka ni Olivia Lanes sa nilalaman ng araling ito. Bilang alternatibo, maaari mong buksan ang [YouTube video](https://youtu.be/y_1SiE1tlTk?si=xzEYyCLSlFHDLdRz) para sa araling ito sa hiwalay na window.
...
Sinimulan mo ang kursong ito sa pamamagitan ng direktang pagpapatakbo ng iyong unang quantum circuit, at pagkatuto kung paano ginagamit ang mga batas ng quantum mechanics para lumikha ng mga quantum state, gate, at circuit. Ngayon, mag-zoom out tayo nang bahagya. Sa seksyong ito, gagalugarin natin ang quantum computing sa pamamagitan ng iba't ibang framework na tutulong sa iyo na mag-navigate sa mga usapan, headline, at artikulo tungkol sa quantum computing nang may mas kritikal na mata.
...
Isa pang karaniwang maling akala ay kung mas maraming qubit ang mayroon ang isang quantum computer, mas malakas ito dapat. Bagama't mahalaga ang computational scale, ang bilang ng qubit lamang ay hindi nagbibigay ng kompletong larawan ng performance ng quantum computing. Ang modernong quantum hardware ay karaniwang sinusuri sa tatlong dimensyon: scale, kalidad, at bilis.

Sinusukat ang scale sa pamamagitan ng bilang ng programmable qubits na available sa mga user. Ito ang mga qubit na maaaring direktang kontrolin, manipulahin, sukatin, at isama sa mga quantum algorithm. Ang pagdaragdag ng bilang ng programmable qubits ay nagpapalawak ng laki ng mga problemang maaaring galugarin sa quantum hardware.

Sinusukat ang kalidad sa pamamagitan ng qubit operations (QuOps), na naglalarawan kung ilan sa mga pinaka-mapaghamong quantum operation ang maaasahang maisasagawa ng isang system bago madaig ng naipong mga error ang computation. Ang mga pagpapabuti sa coherence times, gate fidelities, calibration procedures, at architecture ay nag-aambag lahat sa mas mataas na computational quality. Ang coherence at dephasing times (karaniwang tinutukoy bilang $T_1$ at $T_2$) ay nananatiling mahahalagang indikator ng performance ng qubit.

Sinusukat ang bilis sa pamamagitan ng maximum circuits per second, na kilala rin bilang circuit throughput. Sinusukat ng metric na ito kung gaano karaming kapaki-pakinabang na computation ang maisasagawa ng isang quantum system sa paglipas ng panahon at sumasalamin sa parehong quantum at sumusuportang classical processing.

Maaari mo ring makasalubong ang mga karagdagang benchmarking metric tulad ng CLOPS (Circuit Layer Operations Per Second) at EPLG (Errors Per Layered Gate). Sinusukat ng CLOPS ang bilis ng pagpapatupad ng isang standardized benchmark workload, habang nagbibigay ang EPLG ng pananaw sa gate-layer error rates at processor fidelity. Ang mga metric na ito ay nananatiling mahalaga para sa pag-unawa sa mga tiyak na katangian ng hardware at workload, ngunit ang programmable qubits, qubit operations, at maximum circuits per second ay nagbibigay ng mas malawak na framework para sa paghahambing ng mga system.
