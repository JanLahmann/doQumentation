...
Tawagin ang set ng lahat ng computational basis states na bumubuo sa iyong ansatz na A. Tawagin ang set ng lahat ng computational basis states na bumubuo sa tunay na ground state ng iyong system na G. Alin sa mga sumusunod ang tumutugma sa 'mabuting' ansatz? Piliin ang lahat na naaangkop:
...
#### Hakbang 3: I-project at i-diagonalize nang klasikal {#step-3-project-and-diagonalize-classically-1}
