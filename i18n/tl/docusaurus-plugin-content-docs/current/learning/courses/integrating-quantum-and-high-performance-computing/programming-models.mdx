...
Ilang qubit ang nasa circuit sa ibaba? ![A circuit diagram with four horizontal lines and many gates.](/learning/images/courses/integrating-quantum-and-high-performance-computing/programming-models/checkin-circuit.avif)
...
Ipagpalagay na ikaw ay nagmomodelo ng mga electron sa isang molecule. Nais mong tantiyahin ang (a) ground state energy ng molecule, at (b) kung aling mga computational basis states ang pinakadominante sa ground state ng molecule. Sa bawat kaso, gagamitin mo ba ang Estimator o Sampler primitive?
...
* Ang pangunahing control flow ng programa ay itinatakda ng rank ng proseso. Ito ang SPMD principle sa aksyon: ang programa ay gumagamit ng conditional logic (halimbawa, if (rank == 0)) upang tiyakin na tanging ang ilang parallelized na seksyon ng code lamang ang isasagawa ng mga worker processes, habang ang master process (kadalasang Rank 0) ay humahawak ng initialization at final aggregation.
