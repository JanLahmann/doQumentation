...
Kaya, sa katunayan, ang pag-apply ng Hadamard gate ay katumbas ng paghagis ng barya. At tulad ng paghagis ng barya nang 1000 beses upang tingnan ang mga istatistika ng barya na nahuhulog nang ulo pataas o pababa, maaari tayong gumawa ng katulad na bagay sa Qiskit gamit ang ating "quantum coin." Maaari tayong gumamit ng primitive na tinatawag na `Sampler`, na uulitin ang isang circuit nang ilang beses upang i-sample ang mga istatistika ng resultang estado.

Una, ini-load natin ang IBM Quantum Compute Service at mga primitive, pagkatapos ay pumipili tayo ng Backend kung saan iri-run ang circuit.
...
## Isa pang (mas magandang) analohiya ng barya gamit ang $\sqrt{\text{NOT}}$ gate {#another-better-coin-analogy-using-the-sqrttextnot-gate}
