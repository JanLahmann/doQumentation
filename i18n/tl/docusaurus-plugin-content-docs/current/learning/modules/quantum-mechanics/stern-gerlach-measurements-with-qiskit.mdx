...
Para patakbuhin ang ating eksperimento sa isang tunay na quantum computer, kailangan nating i-load ang IBM Quantum Compute Service, at pumili ng isang quantum computer (o isang "backend"). Sa ibaba, pinipili natin ang pinaka-hindi abala na quantum computer na available sa atin.
...
### Hakbang 1: I-map ang mga classical na input sa isang quantum na problema {#step-1-map-classical-inputs-to-a-quantum-problem-1}
