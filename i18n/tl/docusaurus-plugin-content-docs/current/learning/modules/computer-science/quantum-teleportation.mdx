...
- Hakbang 3: Isagawa ang iyong trabaho sa mga IBM quantum computer gamit ang IBM Quantum primitives
...
Ang "Sampler" ay isang primitive na idinisenyo upang mag-sample ng mga posibleng estado na nagmumula sa isang quantum circuit, at mag-kolekta ng istatistika tungkol sa kung anong mga estado ang maaaring sukatin at sa anong probabilidad. Dito natin ini-import ang IBM Quantum Sampler:
...
### Hakbang 1: I-map ang iyong problema sa isang quantum circuit {#step-1-map-your-problem-to-a-quantum-circuit-1}
...
### Hakbang 3: Isagawa {#step-3-execute-1}
