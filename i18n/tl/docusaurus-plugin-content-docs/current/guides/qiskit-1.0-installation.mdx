...
#### Gumawa ng gumaganang environment para sa Qiskit 1.0 {#debug-venv-for-1.0} {#create-a-working-environment-for-qiskit-10}
...
#### Gumawa ng gumaganang environment para sa Qiskit 0.45 o 0.46 {#debug-venv-for-0.45} {#create-a-working-environment-for-qiskit-045-or-046}
