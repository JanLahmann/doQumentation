...
Sumangguni sa [dokumentasyon ng Qiskit Transpiler Service](/guides/qiskit-transpiler-service#limits-of-the-qiskit-transpiler-service) para sa higit pang impormasyon tungkol sa mga limitasyon na naaangkop sa mga AI-powered transpiler pass.

## Citation {#citation}

Kung gumagamit ka ng anumang AI-powered na feature mula sa Qiskit Transpiler Service sa iyong pananaliksik, gamitin ang [inirerekomendang citation](/guides/qiskit-transpiler-service#citation).
