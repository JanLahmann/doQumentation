...
Ang sumusunod ay nagpapakita kung paano mag-upload ng mga file. Tiyaking na-authenticate ka na sa Qiskit Serverless gamit ang iyong IBM Quantum account (tingnan ang [I-upload sa Qiskit Serverless](/guides/serverless-first-program#upload-to-qiskit-serverless) para sa mga tagubilin).
...
- Tingnan ang isang kumpletong halimbawa na [nagpo-port ng existing na code sa Qiskit Serverless](/guides/serverless-port-code).
