---
description: 'Mga praktikal na halimbawa ng paggamit ng IBM Quantum Sampler primitive.'
notebook_path: guides/sampler-examples.ipynb
sidebar_label: 'Mga halimbawa ng Sampler'
title: 'Mga halimbawa ng Sampler'
---
...
Gamitin ang Sampler para ibalik ang resulta ng pagsukat bilang mga bitstring o count ng isang circuit.
...
Gamitin ang Sampler para ibalik ang resulta ng pagsukat bilang mga bitstring o count ng maraming circuit sa isang job.
...
Magpatakbo ng ilang eksperimento sa isang job, gamit ang mga halaga ng parameter para mapataas ang muling paggamit ng circuit.
...
- Magsanay sa mga primitive sa pamamagitan ng pagdaan sa [Cost function lesson](/learning/courses/variational-algorithm-design/cost-functions) sa IBM Quantum Learning.
