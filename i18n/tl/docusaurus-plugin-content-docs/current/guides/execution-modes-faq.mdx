---
description: 'Mga sagot sa mga karaniwang tanong tungkol sa mga execution mode'
...
<Accordion>
  <AccordionItem title="Sinusuportahan ba ng `qiskit-ibm-runtime` local testing mode ang iba't ibang execution mode?">
