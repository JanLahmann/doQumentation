...
These instructions use the standard Python distribution from [pypi.org](https://pypi.org/). However, you can use other Python distributions, such as [Anaconda](https://docs.anaconda.com/anaconda/) or [miniconda](https://docs.anaconda.com/miniconda/), along with other dependency management workflows like [Poetry](https://python-poetry.org/docs/).
    ...
    - Gamitin ang [Python virtual environments](https://docs.python.org/3.10/tutorial/venv.html) para ihiwalay ang Qiskit mula sa ibang applications.
    Ang Python virtual environment ay isang isolated na espasyo para magtrabaho gamit ang Python para sa isang tukoy na layunin — kaya maaari kang mag-install ng anumang packages na gusto mo, at mag-set up ng libraries, dependencies, at iba pa, nang hindi naaapektuhan ang "base" na Python environment sa iyong makina.
