---
title: "Mga halimbawa ng Primitives"
sidebar_label: "Mga halimbawa ng Primitives"
description: "Mga praktikal na halimbawa ng paggamit ng primitives sa Qiskit Runtime."
...
Ang mga halimbawa sa seksyong ito ay nagpapakita ng ilang karaniwang paraan ng paggamit ng primitives. Bago patakbuhin ang mga halimbawang ito, sundin ang mga tagubilin sa [Install and set up.](install-qiskit)

<Admonition type="note">
    Lahat ng halimbawang ito ay gumagamit ng primitives mula sa Qiskit Runtime, pero maaari ka ring gumamit ng base primitives.
</Admonition>

## Mga halimbawa ng Estimator {#estimator-examples}

Mahusay na kalkulahin at bigyang-kahulugan ang mga expectation value ng quantum operators na kailangan ng maraming algorithm gamit ang Estimator. Tuklasin ang mga gamit nito sa molecular modeling, machine learning, at mga kumplikadong optimization problem.

### Magpatakbo ng isang eksperimento {#run-a-single-experiment}

Gamitin ang Estimator para matukoy ang expectation value ng isang circuit-observable pair.
...
Gamitin ang Estimator para matukoy ang mga expectation value ng maraming circuit-observable pair.
...
### Magpatakbo ng mga parameterized circuit {#run-parameterized-circuits}

Gamitin ang Estimator para magpatakbo ng tatlong eksperimento sa iisang job, na ginagamit ang mga parameter value para mapataas ang reusability ng circuit.
...
### Gumamit ng sessions at advanced options {#use-sessions-and-advanced-options}

Tuklasin ang mga session at advanced options para ma-optimize ang performance ng circuit sa mga QPU.

<Admonition type="caution">
Ang sumusunod na code block ay magbabalik ng error para sa mga gumagamit ng Open Plan dahil gumagamit ito ng sessions. Ang mga workload sa Open Plan ay maaari lang tumakbo sa [job mode](/guides/execution-modes#job-mode) o [batch mode](/guides/execution-modes#batch-mode).
</Admonition>
...
## Mga halimbawa ng Sampler {#sampler-examples}

Gumawa ng mga kumpletong error-mitigated quasi-probability distribution na sinample mula sa mga output ng quantum circuit. Gamitin ang kakayahan ng Sampler para sa mga search at classification algorithm tulad ng Grover's at QVSM.

### Magpatakbo ng isang eksperimento {#run-a-single-experiment}

Gamitin ang Sampler para ibalik ang resulta ng pagsukat bilang mga bitstring o bilang counts mula sa isang circuit.
...
### Magpatakbo ng maraming eksperimento sa isang trabaho {#run-multiple-experiments-in-a-single-job}

Gamitin ang Sampler para ibalik ang resulta ng pagsukat bilang mga bitstring o counts mula sa maraming circuit sa iisang trabaho.
...
Magpatakbo ng ilang eksperimento sa iisang trabaho, gamit ang mga parameter value para mapataas ang reusability ng circuit.
...
I-explore ang mga session at advanced na opsyon para i-optimize ang performance ng circuit sa mga QPU.
...
<Admonition type="tip" title="Recommendations">
    - [Tukuyin ang mga advanced na opsyon sa runtime.](runtime-options-overview)
    - Magsanay sa primitives sa pamamagitan ng paggawa ng [Cost function lesson](/learning/courses/variational-algorithm-design/cost-functions) sa IBM Quantum Learning.
    ...
    - Unawain ang [Job limits](/guides/job-limits) kapag nagpapadala ng trabaho sa IBM&reg; QPU.
</Admonition>
