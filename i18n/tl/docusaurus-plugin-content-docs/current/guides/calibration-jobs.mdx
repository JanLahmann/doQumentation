...
Upang matiyak ang tuloy-tuloy na performance, madalas na minomonitor ang mga IBM&reg; quantum computer upang subaybayan ang mga parameter na maaaring lumihis sa paglipas ng panahon, magpatakbo ng mga calibration kung kinakailangan, at magsagawa ng araw-araw na benchmarking. Inilalarawan ng pahinang ito ang tatlong proseso — monitoring, calibrating, at benchmarking — na magkasamang nagtatrabaho upang matiyak na ang fleet ng mga IBM quantum computer ay mananatiling matatag, mahuhulaan, at available sa mga user hangga't maaari.

## Monitoring {#monitoring}

### Parameter monitoring {#parameter-monitoring}

Ang mga maikling parameter monitoring job ay isinasagawa nang humigit-kumulang isang beses sa isang oras, awtomatikong nagpapalitan sa pagitan ng mga user job, gamit ang buong IBM Quantum Compute Service software stack. Ang mga resulta ng mga job na ito ay sinusuri upang matukoy kung may parameter nang nagsimulang lumihis sa mga katanggap-tanggap na saklaw, na mainam na nakakakuha ng mga isyu bago pa man maging sapat na malaki upang maapektuhan ang performance sa kapansin-pansing antas.

Kasama sa ilan sa mga parameter na minomonitor ang sumusunod:
...
* Mga single- at two-qubit gate na operasyon, na nagpapatunay na kumikilos ang mga ito ayon sa inaasahan upang mapanatili ang mga tamang rotation angle at mabawasan ang mga phase at amplitude error.
...
Bukod sa mga job na minomonitor ang mga indibidwal na parameter ay ang mga job na minomonitor ang performance ng quantum computer nang mas holistic, tulad ng mga pagsubok na tinitingnan ang fidelity ng mga nabuong Bell state, pati na rin ang mga pagsubok ng mga fractional gate at dynamic circuit sa mga quantum computer na sumusuporta sa mga feature na iyon. Ang layunin ng mga pagsubok na ito, na tumatakbo rin sa pamamagitan ng buong Quantum Compute stack na nagpapalitan sa mga user job, ay mahusay na ma-validate ang pangkalahatang gawi ng hardware at software. Kung ang mga pagsubok na ito ay nakakakita ng malaking pagbaba sa performance, ang quantum computer ay awtomatikong mag-i-pause ng job queue hanggang sa malutas ang isyu, na tinitiyak na hindi tatakbo ang mga user job hanggang sa gumagana na muli ang device ayon sa inaasahan.
