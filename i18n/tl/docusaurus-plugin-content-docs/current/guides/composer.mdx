...
![isang quantum circuit](/docs/images/guides/composer/2H-circuit.svg "Isang circuit na binubuo ng isang kolum ng mga Hadamard na lumilikha ng pantay na superposition ng mga computational basis state, na sinusundan ng isang two-qubit controlled-Z (CZ) gate.")

![Probabilities view ng nakaraang circuit](/docs/images/guides/composer/probabilities.svg "Probabilities view ng nakaraang circuit.")
...
![isang quantum circuit](/docs/images/guides/composer/2H-circuit.svg)
...
![statevector view](/docs/images/guides/composer/state-vector.svg "Ang statevector sa dulo ng circuit sa itaas. Ang color wheel ay nagma-map ng phase angle sa kulay. Ang output state ay ipinahayag bilang isang listahan ng mga kumplikadong numero.")
