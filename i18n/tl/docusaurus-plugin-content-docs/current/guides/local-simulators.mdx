---
description: 'Mag-migrate mula sa paggamit ng IBM Quantum cloud simulators patungo sa `qiskit-ibm-runtime` local testing mode.'
title: 'Mag-migrate sa mga lokal na simulator'
---

{/* doqumentation-source-hash: 9db328b8 */}
...
Ino-retire ang mga cloud simulator dahil sa ilang dahilan:

<Accordion>
<AccordionItem title="May mga limitasyon ang mga simulator">
...
<AccordionItem title="Nagpapaunlad ng natatanging kasanayan ang paggamit ng quantum hardware">
...
- Ang direktang pakikipag-ugnayan sa quantum hardware ay nagpapatibay ng mga kasanayan dahil kailangang mag-implement o gumamit ng mga error mitigation o suppression na teknik para sa maaasahang computation.
...
<AccordionItem title="Dapat i-adapt ang mga algorithm para sa quantum hardware">
...
Local testing mode does not have built-in error suppression or mitigation.  Instead, you must specify those options explicitly. See [Configure error mitigation](/guides/error-mitigation-and-suppression-techniques) for details.
</Admonition>

## Mag-migrate sa mga lokal na simulator {#migrate-to-local-simulators-1}
...
Dahil episyenteng ma-si-simulate ang mga Clifford circuit at napapatunayan ang mga resulta nito, ang Clifford simulation ay isang napaka-kapaki-pakinabang na tool. Para sa isang malalim na halimbawa, tingnan ang [Episyenteng simulation ng mga stabilizer circuit gamit ang Qiskit Aer primitives](/guides/simulate-stabilizer-circuits).
