...
Maaari kang magtakda ng mga opsyon kapag nag-initialize ng Estimator, pagkatapos mag-initialize ng Estimator, o maaari kang mag-update ng mga opsyon pagkatapos na na-initialize ang Estimator. Para sa mga tagubilin sa paggamit ng mga diskarteng ito, tingnan ang paksa na [Panimula sa mga opsyon](/guides/runtime-options-overview#options-precedence).

Bukod dito, maaari kang magtakda ng halaga ng `precision` sa pamamaraan ng `run()`, tulad ng inilallarawan sa sumusunod na seksyon.
...
<Tabs>
  ...
  Maaaring hindi gumana kapag gumagamit ng custom gates.
  </TabItem>
  <TabItem value="Twirling" label="Gate twirling">
  Hindi compatible sa fractional gates o stretches.
