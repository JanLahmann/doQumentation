---
description: 'Pumili ng tamang execution mode para sa IBM Quantum Compute sessions, batch, o single jobs.'
...
# Pumili ng tamang execution mode {#choose-the-right-execution-mode}
