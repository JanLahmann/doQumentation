...
Ang iba't ibang setting ng transpiler ay nagbibigay ng iba't ibang uri ng optimization sa circuit, kadalasan ay kapalit ng mas matagal na classical processing time. Itinuturo ng gabay na ito ang buong proseso ng paglikha, pag-transpile, at pagsumite ng mga circuit para ipakita kung paano subukin ang performance ng iba't ibang setting.
...
Dahil ang mga CNOT ay karaniwang may mataas na error rate, ang circuit na na-transpile gamit ang `optimization_level=3` ay dapat na mas mahusay ang performance.
...
Sa puntong ito, mayroon kang listahan ng mga circuit na na-transpile gamit ang iba't ibang setting. Susunod, patakbuhin ang mga circuit na ito gamit ang Sampler primitive at iimbak (i-save) ang mga resulta sa `result`.
...
Panghuli, i-plot ang mga resulta mula sa mga pagpapatakbo ng device laban sa ideal na distribusyon. Makikita mo na ang mga resulta na may `optimization_level=3` ay mas malapit sa ideal na distribusyon dahil sa mas mababang bilang ng gate, at ang `optimization_level=3 + dd` ay mas lalong malapit dahil sa dynamical decoupling.
...
- Tuklasin ang ilang advanced na resources sa transpilation, tulad ng:
    ...
    - [Lumikha at mag-transpile para sa mga custom na backend](/guides/custom-backend)
