...
- Bagama't ipinapatupad ng mga Qiskit Aer primitive ang mga interface ng primitive, hindi sila nagbibigay ng parehong mga opsyon gaya ng mga IBM Quantum primitive. Ang resilience level, halimbawa, ay hindi available sa mga Qiskit Aer primitive.
...
<Admonition type="tip" title="Mga Rekomendasyon">
  - Para mag-simulate ng maliliit at simpleng circuit, tingnan ang [Eksaktong simulasyon gamit ang Qiskit SDK primitives](/guides/simulate-with-qiskit-sdk-primitives).
