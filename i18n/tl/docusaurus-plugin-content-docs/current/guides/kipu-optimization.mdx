...
### 1. Likhain ang objective function {#1-create-the-objective-function-1}
...
### 2. Patakbuhin ang Optimizer {#2-run-the-optimizer-1}
...
### 3. Kunin ang resulta {#3-retrieve-the-result-1}
