...
Mag-authenticate gamit ang iyong [API key](https://quantum.cloud.ibm.com/) at piliin ang Qiskit Function tulad ng sumusunod. (Ipinapalagay ng snippet na ito na nai-save mo na ang iyong [account](/guides/functions-get-started#install-qiskit-functions-catalog-client) sa iyong lokal na kapaligiran.)
...
![Visualization ng solusyon ng optimization](/docs/images/guides/global-data-quantum-optimizer/cost_distribution.avif)
...
* - Bisitahin ang [API reference](https://docs.quantum.ibm.com/api/functions/global-data-quantum-optimizer) para sa Qiskit Function na ito.
*   Humiling ng access sa function sa pamamagitan ng pagpuno ng [form na ito](https://globaldatum.io/qiskit-function/#form).
