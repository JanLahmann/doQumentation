...
Ang Qiskit Transpiler Service ([package name na `qiskit-ibm-transpiler`](https://pypi.org/project/qiskit-ibm-transpiler/)) ay isang bagong experimental na serbisyo na nagbibigay ng mga remote transpilation capability sa cloud para sa mga gumagamit ng IBM Quantum Premium Plan, Flex Plan, at On-Prem (sa pamamagitan ng IBM Quantum Platform API) Plan. Bukod sa mga lokal na kakayahan ng Qiskit SDK transpiler, ang iyong mga gawain sa transpilation ay maaaring makinabang mula sa parehong IBM Quantum cloud resource at mga AI-powered transpiler pass gamit ang serbisyong ito. Para matuto nang higit tungkol sa kung paano i-integrate ang cloud-based na transpilation sa iyong Qiskit workflow, [tingnan ang dokumentasyon](/guides/qiskit-transpiler-service).
