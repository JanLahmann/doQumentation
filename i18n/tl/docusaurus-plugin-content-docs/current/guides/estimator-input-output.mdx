...
Ipinapakita ng sumusunod na code ang isang halimbawang set ng vectorized na input sa `Estimator` primitive at isinasagawa ang mga ito sa isang IBM&reg; backend bilang isang solong `RuntimeJobV2 ` object.
