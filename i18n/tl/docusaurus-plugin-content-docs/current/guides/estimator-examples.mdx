---
title: "Mga halimbawa ng Estimator"
sidebar_label: "Mga halimbawa ng Estimator"
description: "Mga praktikal na halimbawa ng paggamit ng Estimator primitive sa Qiskit Runtime."
...
Ang mga halimbawa sa seksyong ito ay naglalarawan ng ilang karaniwang paraan ng paggamit ng Estimator. Bago patakbuhin ang mga halimbawang ito, sundin ang mga tagubilin sa [I-install ang Qiskit.](install-qiskit)

<Admonition type="note">
Ang lahat ng halimbawang ito ay gumagamit ng mga primitive mula sa Qiskit Runtime, ngunit maaari kang gumamit ng mga base primitive sa halip.
</Admonition>
...
## Magpatakbo ng maraming eksperimento sa isang job {#run-multiple-experiments-in-a-single-job}
...
## Magpatakbo ng mga parametrized na circuit {#run-parameterized-circuits}
...
## Gumamit ng mga batch at mga advanced na opsyon {#use-batches-and-advanced-options}

I-explore ang [execution mode](/guides/execution-modes) ng batch at mga advanced na opsyon para i-optimize ang pagganap ng circuit sa mga QPU.
...
- [Tukuyin ang mga advanced na opsyon ng runtime](runtime-options-overview).
- Magsanay sa mga primitive sa pamamagitan ng paggawa ng [Cost function lesson](/learning/courses/variational-algorithm-design/cost-functions) sa IBM Quantum&reg; Learning.
...
- Unawain ang [Mga limitasyon ng job](/guides/job-limits) kapag nagpapadala ng job sa isang IBM&reg; QPU.
</Admonition>
