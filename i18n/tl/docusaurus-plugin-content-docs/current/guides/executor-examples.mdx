---
description: 'Mga praktikal na halimbawa ng paggamit ng Executor primitive sa qiskit-ibm-runtime.'
...
### I-set up ang circuit {#set-up-the-circuit-1}
...
### Isabuhay ang mga circuit {#execute-the-circuits-1}
