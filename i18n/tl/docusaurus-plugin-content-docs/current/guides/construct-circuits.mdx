...
Ang isang simpleng quantum circuit ay isang koleksyon ng mga qubit at isang listahan ng mga instruction na kumikilos sa mga qubit na iyon. Bilang halimbawa, ang sumusunod na cell ay lumilikha ng bagong circuit na may dalawang bagong qubit, pagkatapos ay ipinapakita ang [`qubits`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#qubits) attribute ng circuit, na isang listahan ng mga [`Qubits`](https://docs.quantum.ibm.com/api/qiskit/circuit#qiskit.circuit.Qubit) ayon sa pagkakasunod-sunod mula sa least significant bit na $q_0$ hanggang sa most significant bit na $q_n$.
...
Kung ang iyong circuit ay unitary, maaari mo itong i-convert sa isang [`Gate`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.Gate) sa pamamagitan ng paggamit ng [`to_gate`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#to_gate) method. Ang mga [`Gate`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.Gate) object ay mga espesipikong uri ng instruction na may ilang extra na feature, tulad ng [`control`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.Gate#control) method, na nagdaragdag ng quantum control.
...
Ginagamit ang mga measurement para sampulin ang mga estado ng mga indibidwal na qubit at ilipat ang mga resulta sa isang classical register. Tandaan na kung nagsusumite ka ng mga circuit sa isang primitive na [Sampler](/guides/get-started-with-sampler), kailangan ang mga measurement. Gayunpaman, ang mga circuit na isinumite sa isang primitive na [Estimator](/guides/get-started-with-estimator) ay hindi dapat maglaman ng mga measurement.

Maaaring sukatin ang mga qubit gamit ang tatlong pamamaraan: [`measure`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#qiskit.circuit.QuantumCircuit.measure), [`measure_all`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#measure_all) at [`measure_active`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit#measure_active). Para malaman kung paano i-visualize ang mga nasukat na resulta, tingnan ang pahina na [Visualize results](/guides/visualize-results).
