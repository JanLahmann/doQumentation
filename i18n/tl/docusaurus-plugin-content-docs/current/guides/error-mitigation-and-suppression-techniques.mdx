...
### I-enable ang TREX gamit ang opsyon na `measure_mitigation` {#enable-trex-by-using-the-measure_mitigation-option}
...
### I-enable ang TREX gamit ang opsyon na `resilience_level` {#enable-trex-by-using-the-resilience_level-option}
...
### I-enable ang ZNE gamit ang opsyon na `zne_mitigation` {#enable-zne-by-using-the-zne_mitigation-option}
...
### I-enable ang ZNE gamit ang opsyon na `resilience_level` {#enable-zne-by-using-the-resilience_level-option}
...
- Tuklasin ang iba pang [mga opsyon](/guides/runtime-options-overview) para sa mga Qiskit Runtime primitive.
