...
<Admonition type="tip" title="Mga Rekomendasyon">
  ...
  - Alamin kung paano gamitin ang [primitive interface](/guides/primitives) upang pasimplehin ang quantum programming.
</Admonition>
