...
Ang `FakeSherbrooke` mock backend mula sa `qiskit_ibm_runtime` ay ginagamit sa mga halimbawang ito, ngunit maaari mo itong subukan sa anumang Qiskit-compatible na tunay o pekeng backend. Ang iyong mga resulta ay maaaring mag-iba.
</Admonition>

Una, i-transpile natin gamit ang optimization level 0.
...
Ang pag-aayos ng optimization level ay maaari ring magbago ng iba pang aspeto ng circuit, hindi lamang ang bilang ng ECR gate. Para sa mga halimbawa ng kung paano binabago ng optimization level ang layout, tingnan ang [Paglalarawan ng mga quantum computer](/guides/represent-quantum-computers).
