...
# Gamitin ang Qiskit Code Assistant sa JupyterLab {#use-qiskit-code-assistant-in-jupyterlab}
...
Tingnan ang mga halimbawa ng paggamit ng Qiskit Code Assistant para sa [mga circuit](/guides/circuit-library), [pag-configure ng error suppression](/guides/error-mitigation-and-suppression-techniques), at [pag-transpile gamit ang mga pass manager](/guides/transpile-with-pass-managers).
</Admonition>
