...
- Alamin kung paano [Itakda ang optimization level](/guides/runtime-options-overview).
...
- Alamin [kung paano i-transpile ang mga circuit](/guides/circuit-transpilation-settings) bilang bahagi ng Qiskit patterns workflow.
