...
# Gamitin ang Qiskit Code Assistant sa VS Code {#use-qiskit-code-assistant-in-vs-code}
...
Tingnan ang mga halimbawa para gamitin ang Qiskit Code Assistant para sa [mga circuit](/guides/circuit-library), [pag-configure ng error suppression](/guides/error-mitigation-and-suppression-techniques), at [pag-transpile gamit ang pass managers](/guides/transpile-with-pass-managers).
</Admonition>
