...
- Para sa eksaktong simulation ng maliliit na quantum circuit, maaari mong gamitin ang mga reference primitive na kasama ng Qiskit. Tingnan ang [Exact simulation with Qiskit primitives](/guides/simulate-with-qiskit-sdk-primitives).
...
- Para mapakinabangan nang husto ang iyong hardware, gamitin ang lokal na stabilizer (Clifford) circuit simulation kung posible. Tingnan ang [Clifford simulation with Qiskit Runtime local testing mode](local-testing-mode#clifford-simulation) o [Efficient simulation of stabilizer circuits with Qiskit Aer primitives](/guides/simulate-stabilizer-circuits) para sa mga halimbawa.
...
- [I-debug ang mga Qiskit Runtime job](/guides/debug-qiskit-runtime-jobs).
</Admonition>
