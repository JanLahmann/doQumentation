---
description: 'Panimula sa paggamit ng mga simulator para sa pagsubok at pag-debug ng mga quantum circuit sa Qiskit.'
title: Panimula
---
...
- Para sa eksaktong simulation ng maliliit na quantum circuit, maaari mong gamitin ang mga reference primitive na kasama ng Qiskit. Tingnan ang [Exact simulation with Qiskit SDK primitives](/guides/simulate-with-qiskit-sdk-primitives).
...
- Para bumuo ng mga custom na noise model, gamitin ang [`noise`](https://qiskit.org/ecosystem/aer/apidocs/aer_noise.html) module ng Qiskit Aer. Tingnan ang [Building noise models](/guides/build-noise-models).
...
- Ang tanging kinakailangan para patakbuhin ang Qiskit ay isang gumaganang Python environment. Para sa mga detalye, tingnan ang seksyong [Operating system support](/guides/install-qiskit#operating-system-support).
...
- Para mapakinabangan nang husto ang iyong hardware, gamitin ang lokal na stabilizer (Clifford) circuit simulation kung posible. Tingnan ang [Clifford simulation with `qiskit-ibm-runtime` local testing mode](local-testing-mode#clifford-simulation) o [Efficient simulation of stabilizer circuits with Qiskit Aer primitives](/guides/simulate-stabilizer-circuits) para sa mga halimbawa.
...
- Suriin ang dokumentasyon ng [circuit visualization](/guides/visualize-circuits).
- Suriin ang dokumentasyon ng [circuit timing visualization](/guides/visualize-circuit-timing).
- [I-debug ang mga job gamit ang NEAT](/guides/debug-qiskit-runtime-jobs).
</Admonition>
