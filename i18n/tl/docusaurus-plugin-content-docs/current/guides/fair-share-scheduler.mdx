...
Ang IBM&reg; ay nagtatalaga ng allocation ng quantum computing capacity sa IBM Cloud account ng bawat organisasyon, batay sa kapasidad na nakasaad sa ilalim ng kanilang plano. Ang mga account administrator naman ang magpapasya kung anong bahagi ng allocation na ito ang itatalaga sa bawat instance. Ginagamit ng fair-share scheduler ang allocation at kasalukuyang paggamit ng mga instance para mag-iskedyul ng mga workload sa paraang patas na ipinamamahagi ang mga resources sa bawat instance.

Halimbawa, ipagpalagay na dalawang instance lamang ang nagpapanatili ng mga workload sa queue ng isang quantum computer. Kung pareho ang lahat ng ibang salik, ang instance na may doble ang bilang ng minuto ay makakapag-execute ng doble ang dami ng workload.
