...
{/* doqumentation-source-hash: 2c028f4b */}
...
- Alamin kung paano magpasa ng mga input at patakbuhin ang iyong programa nang remote sa paksa na [Patakbuhin ang iyong unang Qiskit Serverless workload nang remote](/guides/serverless-run-first-workload).
