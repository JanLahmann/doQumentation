---
description: 'Paano magpatakbo ng mga quantum computing job sa batch mode gamit ang IBM Quantum Compute Service.'
...
Bago magsimula ng batch, kailangan mong [i-set up ang IBM Quantum Compute client](/guides/install-qiskit) at i-initialize ito bilang isang serbisyo:
...
<Admonition type="tip" title="Mga rekomendasyon">
  ...
  - Alamin ang [Mga limitasyon sa job](/guides/job-limits) kapag nagpapadala ng job sa IBM&reg; QPU.
