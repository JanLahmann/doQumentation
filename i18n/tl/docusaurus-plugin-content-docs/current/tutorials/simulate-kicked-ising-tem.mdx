...
{/* doqumentation-source-hash: fbeea6aa */}
...
Maaari ring ipasa ang mga custom na opsyon para sa noise learner. Sumusunod ang mga ito sa mga kahulugan na ginagamit sa `qiskit-ibm-runtime` [`NoiseLearnerOptions`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-noise-learner-options):
