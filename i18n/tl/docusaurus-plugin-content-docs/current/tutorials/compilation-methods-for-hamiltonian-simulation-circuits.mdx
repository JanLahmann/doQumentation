...
Ang mga circuit na ginamit sa benchmark na ito ay nakuha mula sa [Hamlib benchmark repository](https://github.com/SRI-International/QC-App-Oriented-Benchmarks/tree/master/qedcbench/hamiltonian_simulation), na naglalaman ng mga realistikong Hamiltonian simulation workload.
