---
description: 'Pagsamahin ang mga opsyon sa error mitigation para sa utility-scale na mga eksperimento gamit ang 100Q+ IBM Quantum QPUs at ang IBM Quantum Estimator primitive.'
...
{/* doqumentation-source-hash: c10e2f34 */}
...
Ang tutorial na ito ay nagsusuri sa mga opsyon sa error suppression at error mitigation na magagamit sa IBM Quantum Estimator primitive. Ipinapakita ng tutorial na ito kung paano ipatupad ang bawat isa sa mga sumusunod na paraan nang isa-isa:
...
Ang walkthrough na ito ay umaasa na ang classical problem ay nai-map na sa quantum. Magsimula sa pamamagitan ng pagbuo ng circuit at observable na susukatin. Bagaman ang mga teknikang ginagamit dito ay naaangkop sa maraming uri ng circuits, para sa kaginhawahan, ang walkthrough na ito ay gumagamit ng [`efficient_su2`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.library.efficient_su2) circuit na kasama sa Qiskit circuit library.
...
Kailangan ninyong piliin ang hardware device na gagamitin bago ninyo i-optimize ang inyong circuit. Ang sumusunod na code cell ay humihiling ng pinaka-hindi-abalang (least-busy) device na may hindi bababa sa 127 qubits.
...
Dito ay magsusumite kayo ng limang hiwalay na jobs, simula sa walang error suppression o mitigation, at sunud-sunod na paganahin ang iba't ibang opsyon sa error suppression at mitigation na available sa IBM Quantum Compute Service. Para sa impormasyon tungkol sa mga opsyon, tingnan ang mga sumusunod na pahina:
...
Dahil ang mga job na ito ay maaaring tumakbo nang nakapag-iisa sa isa't isa, maaari ninyong gamitin ang [batch mode](/guides/run-jobs-batch) upang pahintulutan ang Quantum Compute na i-optimize ang timing ng kanilang pagsasagawa.
