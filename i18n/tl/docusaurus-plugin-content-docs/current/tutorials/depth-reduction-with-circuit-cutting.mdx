...
*Tinantyang paggamit: Walong minuto sa isang Eagle processor (PAUNAWA: Ito ay tantiya lamang. Maaaring mag-iba ang iyong runtime.)*
...
Mangyaring sagutin ang maikling survey na ito upang magbigay ng feedback sa tutorial na ito. Ang iyong mga pananaw ay makakatulong sa amin na mapabuti ang aming mga content offering at karanasan ng user.

> **Tandaan:** Ang survey na ito ay mula sa **IBM Quantum** at sumasaklaw sa **tutorial content** (isinulat ng IBM). Ang doQumentation ay nagbibigay ng website, mga translation, at code execution — para sa feedback tungkol dito, mangyaring [magbukas ng GitHub issue](https://github.com/JanLahmann/doQumentation/issues).
