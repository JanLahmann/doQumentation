...
*Tinatayang paggamit: mas mababa sa 1 minuto sa isang Heron processor (TANDAAN: Ito ay isang tantiya lamang. Maaaring mag-iba ang iyong runtime.)*
...
Para sa karagdagang impormasyon tungkol sa QEC, tingnan ang [Quantum Error Correction for Beginners.](https://arxiv.org/abs/0905.2794)
...
Makikita mo na ang bit flip code ay nakadetekta at nakapagwasto ng maraming error, na nagresulta sa mas kaunting error sa kabuuan.
...
Sagutin ang maikling survey na ito upang magbigay ng feedback sa tutorial na ito. Ang iyong mga pananaw ay makakatulong sa amin na mapabuti ang aming mga content offering at karanasan ng user.

[Link to survey](https://your.feedback.ibm.com/jfe/form/SV_5onAlfA2Y7ac1FA)

> **Tandaan:** Ang survey na ito ay ibinibigay ng IBM Quantum at nauukol sa orihinal na nilalaman sa Ingles. Upang magbigay ng feedback sa website, mga pagsasalin, o code execution ng doQumentation, [magbukas ng GitHub issue](https://github.com/JanLahmann/doQumentation/issues).
