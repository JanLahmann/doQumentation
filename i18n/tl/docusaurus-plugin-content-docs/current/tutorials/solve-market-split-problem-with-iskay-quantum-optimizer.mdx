...
*Tinantyang paggamit: 20 segundo sa isang Heron r2 processor. (PAALALA: Ito ay tantya lamang. Maaaring mag-iba ang iyong runtime.)*
...
3. Pag-unawa sa bf-DCQO algorithm na maglulutas nito
...
Sa adiabatic quantum optimization, pina-evolve natin ang system ayon sa time-dependent Hamiltonian:
