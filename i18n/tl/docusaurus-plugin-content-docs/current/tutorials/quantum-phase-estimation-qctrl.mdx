...
*Tinatayang paggamit: 40 segundo sa Heron r2 processor. (PAALALA: Ito ay tantiya lamang. Maaaring mag-iba ang iyong runtime.)*
...
## Setup {#setup}
Una, mag-authenticate gamit ang inyong [IBM Quantum API key](http://quantum.cloud.ibm.com/). Pagkatapos, piliin ang Qiskit Function tulad ng sumusunod. (Ipinapalagay ng code na ito na [nai-save ninyo na ang inyong account](/guides/functions-get-started#install-qiskit-functions-catalog-client) sa inyong lokal na kapaligiran.)
...
Mangyaring maglaan ng isang minuto upang magbigay ng feedback sa tutorial na ito. Ang iyong mga insight ay tutulong sa amin na mapabuti ang aming mga content offering at karanasan ng user.
