...
*Tinatayang paggamit: Limang minuto sa isang Eagle processor (TANDAAN: Tantiya lamang ito. Maaaring mag-iba ang iyong runtime.)*
...
### Modelo ng Hamiltonian at Observable {#model-hamiltonian-and-observable}
...
#### I-set up ang Hamiltonian at Observable {#set-up-the-hamiltonian-and-observable}
...
#### Tukuyin ang Bahagi ng Time Evolution na Isisimulahin nang Klasikal {#determine-the-portion-of-time-evolution-to-simulate-classically}
...
#### Pumili ng Split Time {#choose-the-split-time}
...
#### Bumuo ng Ansatz at mga Paunang Parameter mula sa isang Trotter Circuit na may Mas Kaunting Hakbang {#generate-an-ansatz-and-initial-parameters-from-a-trotter-circuit-with-fewer-steps}
...
#### Pumili ng mga Setting para sa Tensor Network Simulation {#choose-settings-for-tensor-network-simulation}
...
#### I-optimize ang mga Parameter ng Ansatz Gamit ang mga Kalkulasyon ng MPS {#optimize-the-parameters-of-the-ansatz-using-mps-calculations}
...
## Bahagi II: Palakihin ang sistema {#part-ii-scale-it-up}
...
Mangyari pong sagutin ang maikling survey na ito upang magbigay ng feedback sa tutorial na ito. Ang iyong mga pananaw ay makakatulong sa amin na mapabuti ang aming mga nilalaman at karanasan ng gumagamit.
