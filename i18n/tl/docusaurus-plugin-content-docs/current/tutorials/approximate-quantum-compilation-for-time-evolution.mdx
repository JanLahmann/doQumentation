...
Ginagabayan ka ng tutorial na ito sa buong state-preparation AQC-Tensor workflow: pagtukoy ng isang Hamiltonian, pagbuo ng mga Trotter circuit, pag-compress sa mga ito sa pamamagitan ng tensor-network optimization, at pagpapatupad ng resulta sa IBM Quantum&reg; hardware.
...
Ang seksyong ito ay gumagamit ng 10-site system upang ilarawan ang AQC-Tensor workflow nang hakbang-hakbang. Sina-simulate natin ang dynamics ng isang 10-site XXZ spin chain, isang malawak na pinag-aralan na modelo para sa pagsusuri ng spin interactions at magnetic properties.
