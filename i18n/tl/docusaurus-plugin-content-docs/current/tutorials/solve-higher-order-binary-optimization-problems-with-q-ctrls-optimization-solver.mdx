...
*Tinatayang paggamit: 24 na minuto sa isang Heron r2 processor. (PAALALA: Ito ay tantiya lamang. Ang iyong runtime ay maaaring mag-iba.)*
...
Tukuyin ang inyong [IBM Quantum Platform](https://quantum.cloud.ibm.com/) credentials, na gagamitin sa buong tutorial upang mag-authenticate sa IBM Quantum Compute Service at Qiskit Functions.
...
Ang Solver ay nagbabalik ng dictionary na may solusyon at kaugnay na metadata, tulad ng solution bitstring, bilang ng iterations, at pagmamapa ng mga variable sa bitstring. Para sa buong kahulugan ng mga input at output ng Solver, tingnan ang [dokumentasyon](https://docs.quantum.ibm.com/api/functions/q-ctrl-optimization-solver).
...
Dahil ang layunin ng optimization algorithm na ito ay hanapin ang minimum ground state ng Ising model, ang mas mababang halaga ay nagpapahiwatig ng mas mahusay na solusyon. Kaya naman, malinaw na nakikita na ang mga solusyong nabuo ng Fire Opal Optimization Solver ay lubos na natatalo ang random selection.
