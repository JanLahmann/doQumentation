...
## 1. Criterion 1 – Scalable, Well-Characterized qubits {#1-criterion-1-scalable-well-characterized-qubits}
...
## 2. Criterion 2 – qubit Initialization {#2-criterion-2-qubit-initialization}
...
## 3. Criterion 3 – Long Coherence Time (Decoherence vs gate Time) {#3-criterion-3-long-coherence-time-decoherence-vs-gate-time}
...
## 4. Criterion 4 – Universal Set of Quantum gates {#4-criterion-4-universal-set-of-quantum-gates}
...
## 5. Criterion 5 – qubit Measurement {#5-criterion-5-qubit-measurement}
...
## Quantum Communication Criteria (Flying qubits) {#quantum-communication-criteria-flying-qubits}
