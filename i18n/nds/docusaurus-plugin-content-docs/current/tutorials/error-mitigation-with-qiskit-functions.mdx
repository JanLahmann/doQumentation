...
#### Den Schaltkreis konstrueren {#construct-the-circuit}
...
#### Dat Observable konstrueren {#construct-the-observable}
...
#### De global Magnetisierung berekenen {#compute-the-global-magnetization}
