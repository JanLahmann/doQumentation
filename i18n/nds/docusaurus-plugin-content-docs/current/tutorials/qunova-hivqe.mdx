---
title: "Dissoziationskurven mit Qunova HiVQE"
sidebar_label: "Dissoziationskurven mit Qunova HiVQE"
description: "Bruuk Qunova HiVQE för't Utreknen vun Dissoziations-Potentialenergieflächen (PES)."
...
<Admonition type="note" title="Opgeven">
Qiskit Functions sünd en experimentell Funkschoon, de blots för IBM Quantum&reg; Premium Plan, Flex Plan un On-Prem (över IBM Quantum Platform API) Plan Brukers verfögbar is. Se sünd in'n Vörschau-Status un köönt sik noch ännern.
</Admonition>
...
## Deel 1: Li2S (20Q) {#part-1-li2s-20q}

### Schritt 1: Klassische Ingaven op en Quantenproblem affbilden {#step-1-map-classical-inputs-to-a-quantum-problem}

Defineer $Li_2S$ Geometrien in Dictionary-Format för verscheden Bindungsafstänn vun Li-S för't Utreknen vun de PES-Kurv. Disse Geometrien sünd optimeert mit B3LYP/631g Reken.
...
### Schritt 2 un 3: Optimeer dat Problem för Quantenhardware-Utföhrung un föhr dat ut mit de HiVQE Chemistry Funkschoon {#step-2-and-3-optimize-problem-for-quantum-hardware-execution-and-execute-using-the-hivqe-chemistry-function}
...
De gesampte QPU-Looptied, de in'n Job bruukt worrn is, kann verfolgt warrn dör't Inloggen op [IBM Quantum Platform](https://quantum.cloud.ibm.com/) un't Ankieken vun inreekte Jobs mit't `qunova-chemistry-hivqe` Tag.
### Schritt 4: Naverarbeidung un Verglieken mit klassische Methoden {#step-4-post-process-and-compare-with-classical-methods}
...
### Dat Plotten vun de Dissoziationskurv för Li\_2S {#plotting-the-dissociation-curve-for-li_2s}

Laat us plotten un HiVQE Resultaten mit HF un CASCI verglieken.
Du kannst sehn, dat all HiVQE Reken good mit't klassische Referenzresultat (CASCI) övereenstemmt.
...
## Deel 2: FeP-NO (44Q) {#part-2-fep-no-44q}

### Schritt 1: Klassische Ingaven op en Quantenproblem affbilden {#step-1-map-classical-inputs-to-a-quantum-problem-1}
...
### Schritt 2 un 3: Optimeer dat Problem för Quantenhardware-Utföhrung un föhr dat ut mit de HiVQE Chemistry Funkschoon {#step-2-and-3-optimize-problem-for-quantum-hardware-execution-and-execute-using-the-hivqe-chemistry-function-1}

Op Basis vun't Setup vun HiVQE un de Geometrien, krigg de Resultaten sequenziell.
#### Reek d(Fe-N) = 1.75 $\AA$ Reken in. {#submit-dfe-n-175-aa-calculation}
...
Verfolg den Job un roop dat Resultat av för d(Fe-N) = 1.75 $\AA$ Reken.
...
#### Reek d(Fe-N) = 2.00 $\AA$ Reken in. {#submit-dfe-n-200-aa-calculation}
...
Verfolg den Job un roop dat Resultat av för d(Fe-N) = 2.00 $\AA$ Reken.
...
#### Reek d(Fe-N) = 5.00 $\AA$ Reken in. {#submit-dfe-n-500-aa-calculation}
...
Verfolg den Job un roop dat Resultat av för d(Fe-N) = 5.00 $\AA$ Reken.
...
### Schritt 4: Naverarbeidung un Verglieken mit klassische Methoden {#step-4-post-process-and-compare-with-classical-methods-1}
...
## Tutorial Ömfraag {#tutorial-survey}
...
[Link to de Ömfraag](https://your.feedback.ibm.com/jfe/form/SV_9AizRyKFHEGzVs2)
