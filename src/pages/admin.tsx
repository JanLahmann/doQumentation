...
ibmcloud ce app update --name ce-doqumentation-01 --max-scale 1`}</CodeBlock>
        ...
        <Section title="Infrastructure">
          <LinkList items={[
            ...
            { label: 'Binder (QuBins 2.5-xl)', url: 'https://mybinder.org/v2/gh/QuBins/qiskit-images/2.5-xl' },
          ...
          <h3>Binder Federation (cache check)</h3>
          ...
          <LinkList items={[
            { label: '2i2c (primary, ~70% traffic)', url: 'https://2i2c.mybinder.org/v2/gh/QuBins/qiskit-images/2.5-xl' },
            { label: 'BIDS (UC Berkeley)', url: 'https://bids.mybinder.org/v2/gh/QuBins/qiskit-images/2.5-xl' },
          ]} />
