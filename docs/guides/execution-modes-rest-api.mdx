...
Alternatively, you can submit a batch job by specifying the `mode` in the request payload. Batch mode can help shorten processing time if all jobs can be provided at the outset. Learn about batch mode in the [introduction to execution modes](/guides/execution-modes#batch-mode) guide.
...
- Review detailed [Sampler](/guides/sampler-rest-api) primitives examples using REST API.
- Review detailed [Estimator](/guides/estimator-rest-api) primitives examples using REST API.
