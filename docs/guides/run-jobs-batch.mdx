...
description: "How to run quantum computing jobs in batch mode using IBM Quantum Compute Service."
...
Before starting a batch, you must [set up the IBM Quantum Compute client](/guides/install-qiskit) and initialize it as a service:
