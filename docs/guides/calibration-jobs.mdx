...
* [Randomized benchmarking](/guides/qpu-information#median-sx-error) (RB) in batched groups  
* Coherence times for [$T_1$](/guides/qpu-information#t1) and [$T_2$](/guides/qpu-information#t2)
* [Measurement-fidelity metrics](/guides/qpu-information#median-readout-error)  

### Two-qubit performance

* [CZ and RZZ fractional gate EPG (Heron), ECR (Eagle)](/guides/qpu-information#2q-error-median) as measured by RB on those gates 

### System-level metrics

* [Layer fidelity (EPLG)](/guides/qpu-information#2q-error-layered), for the best 100-qubit length string
