...
For a step-by-step walkthrough of this same workflow with a worked example, see the [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations) tutorial.
...
If you use the SQD IEF-PCM template in your research, please refer to the [repository](https://github.com/qiskit-community/qiskit-function-templates/tree/main/chemistry/sqd_pcm#citing-this-project) for detailed citation information.
## Next steps

<Admonition type="info" title="Recommendations">

- Follow the [Implicit solvent calculations using Qiskit Serverless](/tutorials/implicit-solvent-calculations) tutorial for a worked example of this same workflow
