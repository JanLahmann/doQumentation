...
[`transpile`](https://docs.quantum.ibm.com/api/qiskit/compiler#transpile) and
[`run`](https://docs.quantum.ibm.com/api/qiskit/qiskit.providers.BackendV2#run) functions in Qiskit.
Instead of `qiskit.execute`, use the
[`transpile`](https://docs.quantum.ibm.com/api/qiskit/compiler#transpile) function followed by
...
[`qasm2.dump`](https://docs.quantum.ibm.com/api/qiskit/qasm2#dump) or
...
For example, for a [`DiagonalGate`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.library.DiagonalGate):
...
[`DAGCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.dagcircuit.DAGCircuit). As the legacy
...
constructor methods (or the [`qiskit.qasm2`](https://docs.quantum.ibm.com/api/qiskit/qasm2) module), then
convert that `QuantumCircuit` into a
[`DAGCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.dagcircuit.DAGCircuit) with
...
([`qiskit.circuit.library`](https://docs.quantum.ibm.com/api/qiskit/circuit_library)). To migrate to the
...
The classes moved to [`qiskit.circuit.library`](https://docs.quantum.ibm.com/api/qiskit/circuit_library) are:
...
The most notable change in the [`qiskit.primitives`](https://docs.quantum.ibm.com/api/qiskit/primitives) module is the
...
2. [Sampler](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.BaseSamplerV2): The V2 sampler now
...
* Implicit conversion from a dense `BaseOperator` to a
  ...
  [`Estimator`](https://docs.quantum.ibm.com/api/qiskit/1.4/qiskit.primitives.Estimator) observable arguments
...
* Using a [`PauliList`](https://docs.quantum.ibm.com/api/qiskit/qiskit.quantum_info.PauliList) in
...
the [`quantum_info`](https://docs.quantum.ibm.com/api/qiskit/quantum_info) module.
...
different [`quantum_info`](https://docs.quantum.ibm.com/api/qiskit/quantum_info) classes. This is not a
...
* Support for running pulse jobs on backends from
  [`qiskit.providers.fake_provider`](https://docs.quantum.ibm.com/api/qiskit/providers_fake_provider) has
...
[`qiskit.pulse.builder.call`](https://docs.quantum.ibm.com/api/qiskit/1.4/pulse#call) is no longer possible.
...
Similarly, a [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit) can
...
[`Sawtooth`](https://docs.quantum.ibm.com/api/qiskit/1.4/qiskit.pulse.library.Sawtooth) and
[`Square`](https://docs.quantum.ibm.com/api/qiskit/1.4/qiskit.pulse.library.Square) is defined such
...
been superseded by the [`qiskit.qasm2`](https://docs.quantum.ibm.com/api/qiskit/qasm2) module, which
...
outputs a [`QuantumCircuit`](https://docs.quantum.ibm.com/api/qiskit/qiskit.circuit.QuantumCircuit) object.
...
locations in the codebase, mostly [`qiskit.synthesis`](https://docs.quantum.ibm.com/api/qiskit/synthesis).
...
the [`qiskit.utils`](https://docs.quantum.ibm.com/api/qiskit/utils#parallel_map) module. It can be used
...
[`BackendV2`](https://docs.quantum.ibm.com/api/qiskit/qiskit.providers.BackendV2) interface.
...
[`BackendV2`](https://docs.quantum.ibm.com/api/qiskit/qiskit.providers.BackendV2) interface). There is
...
was moved to [`qiskit.visualization`](https://docs.quantum.ibm.com/api/qiskit/visualization) in Qiskit
...
[`VF2Layout`](https://docs.quantum.ibm.com/api/qiskit/qiskit.transpiler.passes.VF2Layout) and
...
[`FlowControllerLinear`](https://docs.quantum.ibm.com/api/qiskit/qiskit.passmanager.FlowControllerLinear), and
[`DoWhileController`](https://docs.quantum.ibm.com/api/qiskit/qiskit.passmanager.DoWhileController) classes
