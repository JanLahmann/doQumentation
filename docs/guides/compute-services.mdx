...
See the [installation page](/guides/install-qiskit) to set up a development environment for building quantum programs.
...
Find more details in the [Qiskit Functions documentation](/guides/functions).
