...
This guide describes how to set a cost limit on your Pay-As-You-Go Plan instance.  You can also manage cost by [minimizing a workload's QPU usage](/guides/minimize-time), and setting a [maximum execution time](/guides/max-execution-time) on your workloads.
...
* **API**: [Set the instance limit in seconds](https://docs.quantum.ibm.com/api/qiskit-runtime-rest/tags/instances#tags__instances__operations__replace_instance_data).
...
* **API**:
   ...
   ```
   See the [REST API documentation](https://docs.quantum.ibm.com/api/qiskit-runtime-rest/tags/instances).
...
* **API**: [Set the instance limit to `null`](https://docs.quantum.ibm.com/api/qiskit-runtime-rest/tags/instances).
...
- Review the [plans](/guides/plans-overview) available to IBM Quantum users.
- Review suggestions to [minimize job QPU usage](/guides/minimize-time).
- Learn how to set a [maximum execution time](/guides/max-execution-time) on jobs.
</Admonition>
