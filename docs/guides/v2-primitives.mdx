...
The original primitives (referred to as the V1 primitives), [V1 Sampler](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/0.26/sampler-v1) and [V1 Estimator](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/0.26/estimator-v1), have been deprecated in `qiskit-ibm-runtime` 0.23.
...
For information about the changes to the Qiskit reference primitives (now called *statevector* primitives), see [the qiskit.primitives section](qiskit-1.0-features#qiskit.primitives) in the Qiskit 1.0 feature changes page.  See [StatevectorSampler](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.StatevectorSampler) and [StatevectorEstimator](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.StatevectorEstimator) for V2 primitive reference implementations.

## Overview

Version 2 of the primitives is introduced with a new base class for both Sampler and Estimator ([BaseSamplerV2](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.BaseSamplerV2) and [BaseEstimatorV2](https://docs.quantum.ibm.com/api/qiskit/qiskit.primitives.BaseEstimatorV2)), along with new types for their inputs and outputs.
...
See the [EstimatorV2 API reference](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/estimator-v2) and [SamplerV2 API reference](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/sampler-v2) for full details.
...
See the [API reference](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options) for the list of available options.
...
- Learn more about setting options in the [Sampler options](/guides/sampler-options), [Estimator options](/guides/estimator-options), and [Executor options](/guides/executor-options) guides.
- Learn more details about [Primitive inputs and outputs](/guides/primitive-input-output#pubs).
- Experiment with the [CHSH inequality](/tutorials/chsh-inequality) tutorial.
</Admonition>
