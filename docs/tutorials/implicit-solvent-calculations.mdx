...
{/* cspell:ignore avas AVAS hcore textit TRIC dmas mocore ncore ncas mocas fermilevel ecore orbts iiter IITER edup textcoords xytext fontsize fontweight frameon electrocatalysis */}
## Learning outcomes
...
Understanding how solvents affect molecular properties is relevant to sustainability research, including carbon capture, electrocatalysis, and battery electrolyte design. The methylamine-in-water example introduces a workflow for combining quantum electronic-structure calculations with an implicit solvent model, providing a starting point for exploring molecular behavior in these broader applications.
...
<Admonition type="tip" title="Recommendations">
  ...
  * [Sample-based quantum diagonalization (SQD) overview](https://docs.quantum.ibm.com/addons/qiskit-addon-sqd)
