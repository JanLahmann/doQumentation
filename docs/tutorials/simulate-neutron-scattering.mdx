...
Neutron scattering helps researchers characterize materials relevant to sustainability, including battery electrodes. This tutorial explores how quantum circuits can simulate magnetic excitations and connect theoretical models to scattering measurements. Its quantum-magnet example develops methods for studying material behavior, contributing to the broader research toolkit for materials discovery.
