...
You can set the error suppression options in Sampler V2. Refer to the [Sampler noise management](/guides/sampler-noise-management) guide and the [`ExecutionOptionsV2`](https://docs.quantum.ibm.com/api/qiskit-ibm-runtime/options-execution-options-v2) API reference for more information.
