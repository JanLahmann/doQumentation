...
All these elements are brought together to build VQE calculations on IBM Quantum primitives, primarily Estimator. For information about primitives see the [documentation](/guides/primitives). In setting up a VQE calculation, we will follow the standard Qiskit patterns framework:

* Map classical inputs to a quantum problem
* Optimize problem for quantum execution
* Execute using IBM Quantum primitives
